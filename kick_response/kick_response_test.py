...
for p in planes:
    for r in rings:
        ...
        graph_2014_pol, ele = getGraphMADX('madx.%s.%surad_polefaceangles_added/' % ('2015', kick), opts.CORR, kick, p, r, '2014')
        graph_2014_pol_hgap_fint0p4, ele = getGraphMADX('madx.%s.%surad_polefaceangles_hgap_fint0p4/' % ('2015', kick), opts.CORR, kick, p, r, '2014')
        graph_2014_pol_hgap_fint0p5, ele = getGraphMADX('madx.%s.%surad_polefaceangles_hgap_fint0p5/' % ('2015', kick), opts.CORR, kick, p, r, '2014')
        graph_2014_pol_hgap_fint0p7, ele = getGraphMADX('madx.%s.%surad_polefaceangles_hgap_fint0p7/' % ('2015', kick), opts.CORR, kick, p, r, '2014')
        graph_2014_pol_hgap_fint1p0, ele = getGraphMADX('madx.%s.%surad_polefaceangles_hgap_fint1p0/' % ('2015', kick), opts.CORR, kick, p, r, '2014')
        graph_2014_test_angle, ele = getGraphMADX('madx.%s.%surad_test_angle/' % ('2015', kick), opts.CORR, kick, p, r, '2014')

        root.SetOwnership(graph_2014_pol,False)
        root.SetOwnership(graph_2014_pol_hgap_fint0p4,False)
        root.SetOwnership(graph_2014_pol_hgap_fint0p5,False)
        root.SetOwnership(graph_2014_pol_hgap_fint0p7,False)
        root.SetOwnership(graph_2014_pol_hgap_fint1p0,False)
        root.SetOwnership(graph_2014_test_angle,False)

        graph_2014_pol.SetLineColor(629)#root.kViolet+4)
        graph_2014_pol.SetLineStyle(1)
        graph_2014_pol.SetLineWidth(3)

        graph_2014_pol_hgap_fint0p4.SetLineColor(root.kAzure+2)
        graph_2014_pol_hgap_fint0p4.SetLineStyle(2)
        graph_2014_pol_hgap_fint0p4.SetLineWidth(3)

        graph_2014_pol_hgap_fint0p5.SetLineColor(root.kOrange+2)
        graph_2014_pol_hgap_fint0p5.SetLineStyle(2)
        graph_2014_pol_hgap_fint0p5.SetLineWidth(3)

        graph_2014_pol_hgap_fint0p7.SetLineColor(root.kGray+2)
        graph_2014_pol_hgap_fint0p7.SetLineStyle(2)
        graph_2014_pol_hgap_fint0p7.SetLineWidth(3)

        graph_2014_pol_hgap_fint1p0.SetLineColor(root.kBlack)
        graph_2014_pol_hgap_fint1p0.SetLineStyle(2)
        graph_2014_pol_hgap_fint1p0.SetLineWidth(3)

        graph_2014_test_angle.SetLineColor(root.kBlue)
        graph_2014_test_angle.SetLineStyle(2)
        graph_2014_test_angle.SetLineWidth(3)
        ...
        dict_graphs_sim[p][r].append ( graph_2014_pol ) 
        dict_graphs_sim[p][r].append ( graph_2014_pol_hgap_fint0p4 ) 
        dict_graphs_sim[p][r].append ( graph_2014_pol_hgap_fint0p5 ) 
        dict_graphs_sim[p][r].append ( graph_2014_pol_hgap_fint0p7 ) 
        dict_graphs_sim[p][r].append ( graph_2014_pol_hgap_fint1p0 ) 
        dict_graphs_sim[p][r].append ( graph_2014_test_angle ) 
...
for p in planes:
    for r in rings:
        ...
        graph_2014_pol = dict_graphs_sim[p][r][0]
        graph_2014_pol_hgap_fint0p4 = dict_graphs_sim[p][r][1]
        graph_2014_pol_hgap_fint0p5 = dict_graphs_sim[p][r][2]
        graph_2014_pol_hgap_fint0p7 = dict_graphs_sim[p][r][3]
        graph_2014_pol_hgap_fint1p0 = dict_graphs_sim[p][r][4]
        graph_2014_test_angle       = dict_graphs_sim[p][r][5]

        if (graph_hw_av.GetN() != graph_2014_pol.GetN() and not opts.NOBIXBPM):
            print "ERROR (main): graphs have different number of points %d != %d" % (graph_hw_av.GetN(), graph_2014_pol.GetN()) 
            exit(-1)
        

        graph_2014_pol.Draw("L")
        #graph_2014_pol_hgap_fint0p4.Draw("L")
        #graph_2014_pol_hgap_fint0p5.Draw("L")
        #graph_2014_pol_hgap_fint0p7.Draw("L")
        #graph_2014_pol_hgap_fint1p0.Draw("L")
        graph_2014_test_angle.Draw("L")

        max      = getMax(graph_hw_av)
        max_2014 = getMax(graph_2014_pol)
        ...
        leg = root.TLegend(0.15, 0.71, 0.75, 0.88)
        leg.SetBorderSize(1)
        leg.SetFillColor(0)
        ...
        leg.AddEntry(graph_2014_pol,   " MADX Sim. 2015 pfa (%d #murad)"    % kick, "l")
        #leg.AddEntry(graph_2014_pol_hgap_fint0p4,   " MADX Sim. 2015 pfa, hgap, fint=0.4 (%d #murad)"    % kick, "l")
        #leg.AddEntry(graph_2014_pol_hgap_fint0p5,   " MADX Sim. 2015 pfa, hgap, fint=0.5 (%d #murad)"    % kick, "l")
        #leg.AddEntry(graph_2014_pol_hgap_fint0p7,   " MADX Sim. 2015 pfa, hgap, fint=0.7 (%d #murad)"    % kick, "l")
        #leg.AddEntry(graph_2014_pol_hgap_fint1p0,   " MADX Sim. 2015 pfa, hgap, fint=1.0 (%d #murad)"    % kick, "l")
        leg.AddEntry(graph_2014_test_angle,   " MADX Sim. 2015 pfa, hgap, fint=0.7 (%d #murad)"    % kick, "l")
        leg.Draw()
