 ...
 n = new TNode("NODE00013","NODE00013",s,  6.376226338935908E-017 ,
  0.299720410220329      ,   7.70194257212519      ,m);
 
 //cout<<          14 <<" BT2.BTV10               "<<endl;
 
 //cout<<          15 <<" DRIFT_6                 "<<endl;
 s = new TTUBE("DRIFT00015","DRIFT00015","void",  5.000000000000000E-002 ,
  4.975025999999971E-002 );
 s->SetLineColor(          18 );
 rotmatrix[0] =    1.00000000000000      ;
 rotmatrix[1] =  -1.778769189234030E-019 ;
 rotmatrix[2] =  -1.474514954580286E-017 ;
 ...
 n = new TNode("NODE00015","NODE00015",s,  6.952647707189445E-017 ,
  0.300986722592592      ,   8.09284999675914      ,m);
 ...
 n = new TNode("NODE00017","NODE00017",s,  7.384329461457879E-017 ,
  0.301935063470319      ,   8.38560042572713      ,m);
 ...
 n = new TNode("NODE00018","NODE00018",s,  7.984479865246437E-017 ,
  0.303253505019144      ,   8.79259999524138      ,m);
 
 //cout<<          19 <<" DRIFT_8                 "<<endl;
 s = new TTUBE("DRIFT00019","DRIFT00019","void",  5.000000000000000E-002 ,
  8.650089541789008E-002 );
 s->SetLineColor(          18 );
 rotmatrix[0] =    1.00000000000000      ;
 rotmatrix[1] =  -1.778769189234030E-019 ;
 rotmatrix[2] =  -1.474514954580286E-017 ;
 ...
 n = new TNode("NODE00019","NODE00019",s,  8.353859677880003E-017 ,
  0.304064977758642      ,   9.04309957631320      ,m);
 ...
 n = new TNode("NODE00020","NODE00020",s,  8.826557421576956E-017 ,
 ...
 n = new TNode("NODE00036","NODE00036",s,  2.222241247846658E-016 ,
  0.402022849943638      ,   17.1791041840537      ,m);
 ...
 n = new TNode("NODE00038","NODE00038",s,  2.361331462984627E-016 ,
  0.476500495493243      ,   18.1813548097597      ,m);
 ...
 n = new TNode("NODE00039","NODE00039",s,  2.462992529934064E-016 ,
 ...
 n = new TNode("NODE00042","NODE00042",s,  2.643783353046853E-016 ,
 ...
 n = new TNode("NODE00043","NODE00043",s,  2.745210008905003E-016 ,
 ...
 n = new TNode("NODE00044","NODE00044",s,  2.831744730523060E-016 ,
 ...
 n = new TNode("NODE00046","NODE00046",s,  2.880758460626005E-016 ,
 ...
 n = new TNode("NODE00048","NODE00048",s,  3.217298936652112E-016 ,
  0.689608286500701      ,   24.0473511900198      ,m);
 ...
 n = new TNode("NODE00049","NODE00049",s,  3.467354561390559E-016 ,
 ...
 n = new TNode("NODE00050","NODE00050",s,  3.509307008389806E-016 ,
  0.700326099870226      ,   26.0275999519322      ,m);
 ...
 n = new TNode("NODE00052","NODE00052",s,  3.589156832352661E-016 ,
 ...
 n = new TNode("NODE00053","NODE00053",s,  3.637081362687844E-016 ,
  0.705015907499955      ,   26.8940999955684      ,m);
 ...
 n = new TNode("NODE00054","NODE00054",s,  3.726309353901728E-016 ,
  0.708290916137480      ,   27.4991984028752      ,m);
 ...
 n = new TNode("NODE00058","NODE00058",s,  4.053379621963763E-016 ,
  0.717889183402810      ,   29.6626000125029      ,m);
 ...
 n = new TNode("NODE00062","NODE00062",s,  4.297449860926273E-016 ,
  0.719999987196207      ,   31.2176000043951      ,m);
 ...
 n = new TNode("NODE00063","NODE00063",s,  4.334525617788244E-016 ,
  0.719999987195732      ,   31.4550750043951      ,m);
 ...
 n = new TNode("NODE00064","NODE00064",s,  4.373951054156574E-016 ,
  0.719999987195227      ,   31.7076000043951      ,m);
 
 //cout<<          65 <<" DRIFT_29                "<<endl;
 s = new TTUBE("DRIFT00065","DRIFT00065","void",  5.000000000000000E-002 ,
  9.022499999999845E-002 );
 s->SetLineColor(          18 );
 rotmatrix[0] =    1.00000000000000      ;
 rotmatrix[1] =  -1.682215250679896E-019 ;
 rotmatrix[2] =  -1.561248841434759E-017 ;
 ...
 n = new TNode("NODE00065","NODE00065",s,  4.424422326078055E-016 ,
  0.719999987194581      ,   32.0308750043951      ,m);
 ...
 n = new TNode("NODE00066","NODE00066",s,  4.464113174749430E-016 ,
  0.719999987194072      ,   32.2851000043951      ,m);
 ...
 n = new TNode("NODE00067","NODE00067",s,  4.523635786829129E-016 ,
  0.719999987193310      ,   32.6663500043951      ,m);
