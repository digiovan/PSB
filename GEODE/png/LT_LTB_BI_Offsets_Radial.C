...
//=========  (Tue Mar 31 15:12:56 2015) by ROOT version5.34/21
   ...
   gre->Draw("p");
   TLatex *   tex = new TLatex(3.197242,-0.001295547,"LT.QFN10");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.052127,-0.003522267,"LT.QDN12");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(8.508955,-0.003259109,"LT.QFN20");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(14.9443,-0.001295547,"LT.QDN32");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(18.72379,-0.0009919028,"LT.QFN40");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(21.0732,-0.0001821862,"LT.QDN42");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(36.2933,-0.00194332,"LT.QDN55");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(48.44896,-0.0002226721,"LT.QFW70");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(42.32006,0.002004049,"LT.QDN75");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(59.07238,0.00111336,"LTB.QFN10");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(70.1044,0.003076923,"LTB.QFW30");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(70.00225,0.005647773,"LTB.QFW50");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(83.07724,0.005607288,"LTB.QDW60");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(94.41571,0.004534413,"BI.QNO10");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(94.41571,0.003319838,"BI.QNO20");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(99.82957,0.00257085,"BI.QNO30");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(108.3079,0.002813765,"BI.QNO40");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(116.1733,-0.00145749,"BI.QNO50");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(119.8506,0.001012146,"BI.QNO60");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(130.6784,0.0003441296,"PSB.BRMB1620");
   tex->SetTextSize(0.015);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   gre->SetPointError(11,0,0);
   gre->SetPoint(12,124.243,-0.001072875);
   gre->SetPointError(12,0,0);
   gre->SetPoint(13,126.8989,-0.001578947);
   gre->SetPointError(13,0,0);
   
   TH1F *Graph_Graph9 = new TH1F("Graph_Graph9","Graph",100,0,139.4592);
   Graph_Graph9->SetMinimum(-0.0023275);
   Graph_Graph9->SetMaximum(0.0065825);
