...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_4->Range(-1050,3.75831,1050,4.599716);
   ...
   gre->SetPoint(0,-700,4.08862);
   gre->SetPointError(0,0,0.1438721);
   gre->SetPoint(1,-500,4.0811);
   gre->SetPointError(1,0,0.1273455);
   gre->SetPoint(2,-300,4.20212);
   gre->SetPointError(2,0,0.2573619);
   gre->SetPoint(3,-100,4.04966);
   gre->SetPointError(3,0,0.07602825);
   gre->SetPoint(4,100,4.17848);
   gre->SetPointError(4,0,0.279936);
   gre->SetPoint(5,300,4.03378);
   gre->SetPointError(5,0,0.06282136);
   gre->SetPoint(6,500,4.18072);
   gre->SetPointError(6,0,0.06921036);
   gre->SetPoint(7,700,4.18922);
   gre->SetPointError(7,0,0.05344435);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(3.84245);
   Graph_Graph49->SetMaximum(4.515576);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.396773);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001057038);
   linear_fit->SetParError(0,7.337106e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.088834);
   linear_fit->SetParError(1,0.03720958);
