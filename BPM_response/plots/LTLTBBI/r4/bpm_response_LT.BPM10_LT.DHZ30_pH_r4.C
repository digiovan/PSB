...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.684213,1050,2.005856);
   ...
   gre->SetPoint(0,-700,1.78236);
   gre->SetPointError(0,0,0.003279263);
   gre->SetPoint(1,-500,1.8729);
   gre->SetPointError(1,0,0.003880915);
   gre->SetPoint(2,-300,1.80792);
   gre->SetPointError(2,0,0.07010018);
   gre->SetPoint(3,-100,1.93106);
   gre->SetPointError(3,0,0.02118839);
   gre->SetPoint(4,100,1.81786);
   gre->SetPointError(4,0,0.01736087);
   gre->SetPoint(5,300,1.89436);
   gre->SetPointError(5,0,0.01225122);
   gre->SetPoint(6,500,1.8533);
   gre->SetPointError(6,0,0.02472631);
   gre->SetPoint(7,700,1.80636);
   gre->SetPointError(7,0,0.007462336);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.716377);
   Graph_Graph43->SetMaximum(1.973691);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(362.3652);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.526269e-05);
   linear_fit->SetParError(0,5.257616e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.833835);
   linear_fit->SetParError(1,0.003225774);
