...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-7.780976,1050,-7.152813);
   ...
   gre->SetPoint(0,-700,-7.40898);
   gre->SetPointError(0,0,0.151473);
   gre->SetPoint(1,-500,-7.63224);
   gre->SetPointError(1,0,0.04329855);
   gre->SetPoint(2,-300,-7.56948);
   gre->SetPointError(2,0,0.04965774);
   gre->SetPoint(3,-100,-7.51854);
   gre->SetPointError(3,0,0.07814138);
   gre->SetPoint(4,100,-7.5115);
   gre->SetPointError(4,0,0.03822042);
   gre->SetPoint(5,300,-7.58834);
   gre->SetPointError(5,0,0.08794193);
   gre->SetPoint(6,500,-7.57952);
   gre->SetPointError(6,0,0.03399123);
   gre->SetPoint(7,700,-7.46618);
   gre->SetPointError(7,0,0.04237487);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.718159);
   Graph_Graph44->SetMaximum(-7.21563);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.084193);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.403965e-05);
   linear_fit->SetParError(0,3.989584e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.558755);
   linear_fit->SetParError(1,0.01815664);
