...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.4569223,1050,-0.3830587);
   ...
   gre->SetPoint(0,-700,-0.413);
   gre->SetPointError(0,0,0.00613185);
   gre->SetPoint(1,-500,-0.4167);
   gre->SetPointError(1,0,0.001080672);
   gre->SetPoint(2,-300,-0.42458);
   gre->SetPointError(2,0,0.02003172);
   gre->SetPoint(3,-100,-0.40974);
   gre->SetPointError(3,0,0.009963744);
   gre->SetPoint(4,100,-0.40256);
   gre->SetPointError(4,0,0.007190726);
   gre->SetPoint(5,300,-0.41282);
   gre->SetPointError(5,0,0.008779665);
   gre->SetPoint(6,500,-0.40854);
   gre->SetPointError(6,0,0.00640308);
   gre->SetPoint(7,700,-0.41868);
   gre->SetPointError(7,0,0.02103805);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.449536);
   Graph_Graph46->SetMaximum(-0.390445);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.091925);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.526193e-06);
   linear_fit->SetParError(0,4.808981e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4121692);
   linear_fit->SetParError(1,0.002391312);
