...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-0.8594716,1050,7.735244);
   ...
   gre->SetPoint(0,-700,6.18786);
   gre->SetPointError(0,0,0.08405603);
   gre->SetPoint(1,-500,5.4445);
   gre->SetPointError(1,0,0.1287036);
   gre->SetPoint(2,-300,4.70118);
   gre->SetPointError(2,0,0.1020841);
   gre->SetPoint(3,-100,3.76394);
   gre->SetPointError(3,0,0.1907401);
   gre->SetPoint(4,100,3.19786);
   gre->SetPointError(4,0,0.3175863);
   gre->SetPoint(5,300,2.31326);
   gre->SetPointError(5,0,0.02443898);
   gre->SetPoint(6,500,1.4347);
   gre->SetPointError(6,0,0.04042018);
   gre->SetPoint(7,700,0.3186);
   gre->SetPointError(7,0,0.08524727);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(0);
   Graph_Graph52->SetMaximum(6.875772);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.87131);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004045423);
   linear_fit->SetParError(0,6.160197e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.478873);
   linear_fit->SetParError(1,0.02527744);
