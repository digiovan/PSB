...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,-0.8063115,1050,2.161876);
   ...
   gre->SetPoint(0,-700,-0.18592);
   gre->SetPointError(0,0,0.1256936);
   gre->SetPoint(1,-500,-0.1651);
   gre->SetPointError(1,0,0.06942083);
   gre->SetPoint(2,-300,0.24584);
   gre->SetPointError(2,0,0.0854041);
   gre->SetPoint(3,-100,0.3084);
   gre->SetPointError(3,0,0.1583467);
   gre->SetPoint(4,100,0.53348);
   gre->SetPointError(4,0,0.1684871);
   gre->SetPoint(5,300,1.02396);
   gre->SetPointError(5,0,0.07395322);
   gre->SetPoint(6,500,0.92026);
   gre->SetPointError(6,0,0.1977084);
   gre->SetPoint(7,700,1.60626);
   gre->SetPointError(7,0,0.06091776);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-0.5094928);
   Graph_Graph50->SetMaximum(1.865057);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.0371);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001384377);
   linear_fit->SetParError(0,6.372477e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5933481);
   linear_fit->SetParError(1,0.03256076);
