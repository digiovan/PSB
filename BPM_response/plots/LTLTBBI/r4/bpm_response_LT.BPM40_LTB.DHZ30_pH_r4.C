...
//=========  (Wed Apr  1 22:35:27 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.4372463,1050,-0.3648135);
   ...
   gre->SetPoint(0,-700,-0.39496);
   gre->SetPointError(0,0,0.006672405);
   gre->SetPoint(1,-500,-0.39766);
   gre->SetPointError(1,0,0.004712572);
   gre->SetPoint(2,-300,-0.4197);
   gre->SetPointError(2,0,0.005474173);
   gre->SetPoint(3,-100,-0.39626);
   gre->SetPointError(3,0,0.00475381);
   gre->SetPoint(4,100,-0.38564);
   gre->SetPointError(4,0,0.008754389);
   gre->SetPoint(5,300,-0.40196);
   gre->SetPointError(5,0,0.009377851);
   gre->SetPoint(6,500,-0.397);
   gre->SetPointError(6,0,0.01160349);
   gre->SetPoint(7,700,-0.39912);
   gre->SetPointError(7,0,0.02219417);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.430003);
   Graph_Graph46->SetMaximum(-0.3720568);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.00546);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.724629e-06);
   linear_fit->SetParError(0,7.166831e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3998184);
   linear_fit->SetParError(1,0.002920115);
