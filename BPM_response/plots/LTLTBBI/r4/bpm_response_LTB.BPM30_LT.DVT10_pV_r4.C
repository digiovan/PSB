...
//=========  (Wed Apr  1 22:34:19 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,-4.395159,1050,9.047731);
   ...
   gre->SetPoint(0,-700,-2.09204);
   gre->SetPointError(0,0,0.06263718);
   gre->SetPoint(1,-500,-0.08336);
   gre->SetPointError(1,0,0.03962181);
   gre->SetPoint(2,-300,1.1448);
   gre->SetPointError(2,0,0.1292601);
   gre->SetPoint(3,-100,2.36548);
   gre->SetPointError(3,0,0.1188227);
   gre->SetPoint(4,100,3.70318);
   gre->SetPointError(4,0,0.05290067);
   gre->SetPoint(5,300,4.92054);
   gre->SetPointError(5,0,0.03672669);
   gre->SetPoint(6,500,6.08112);
   gre->SetPointError(6,0,0.04716575);
   gre->SetPoint(7,700,6.75044);
   gre->SetPointError(7,0,0.0568092);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-3.05087);
   Graph_Graph50->SetMaximum(7.703442);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(224.8566);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006251541);
   linear_fit->SetParError(0,4.036466e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.893235);
   linear_fit->SetParError(1,0.0187978);
