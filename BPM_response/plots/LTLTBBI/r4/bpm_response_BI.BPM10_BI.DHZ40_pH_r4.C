...
//=========  (Wed Apr  1 22:36:20 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-4.814078,1050,-3.926562);
   ...
   gre->SetPoint(0,-700,-4.22168);
   gre->SetPointError(0,0,0.08224663);
   gre->SetPoint(1,-500,-4.2276);
   gre->SetPointError(1,0,0.1204419);
   gre->SetPoint(2,-300,-4.37032);
   gre->SetPointError(2,0,0.2958387);
   gre->SetPoint(3,-100,-4.21108);
   gre->SetPointError(3,0,0.04943982);
   gre->SetPoint(4,100,-4.35392);
   gre->SetPointError(4,0,0.2250585);
   gre->SetPoint(5,300,-4.24728);
   gre->SetPointError(5,0,0.08665671);
   gre->SetPoint(6,500,-4.33554);
   gre->SetPointError(6,0,0.08925962);
   gre->SetPoint(7,700,-4.31022);
   gre->SetPointError(7,0,0.05190738);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-4.725326);
   Graph_Graph52->SetMaximum(-4.015314);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.306854);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.131292e-05);
   linear_fit->SetParError(0,5.827987e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.249753);
   linear_fit->SetParError(1,0.0290716);
