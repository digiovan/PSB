...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,-5.694926,1050,8.016223);
   ...
   gre->SetPoint(0,-700,-3.39112);
   gre->SetPointError(0,0,0.01861436);
   gre->SetPoint(1,-500,-2.0193);
   gre->SetPointError(1,0,0.05947102);
   gre->SetPoint(2,-300,-0.7368);
   gre->SetPointError(2,0,0.0214947);
   gre->SetPoint(3,-100,0.49014);
   gre->SetPointError(3,0,0.03511283);
   gre->SetPoint(4,100,1.7432);
   gre->SetPointError(4,0,0.01476984);
   gre->SetPoint(5,300,2.95134);
   gre->SetPointError(5,0,0.02270843);
   gre->SetPoint(6,500,4.40252);
   gre->SetPointError(6,0,0.01147105);
   gre->SetPoint(7,700,5.72328);
   gre->SetPointError(7,0,0.007751577);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(-4.323811);
   Graph_Graph48->SetMaximum(6.645108);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(76.41601);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006512327);
   linear_fit->SetParError(0,1.199226e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.146411);
   linear_fit->SetParError(1,0.006827296);
