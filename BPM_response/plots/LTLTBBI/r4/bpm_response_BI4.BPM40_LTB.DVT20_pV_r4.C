...
//=========  (Wed Apr  1 22:35:22 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-14.33557,1050,8.312657);
   ...
   gre->SetPoint(0,-700,4.29834);
   gre->SetPointError(0,0,0.2396131);
   gre->SetPoint(1,-500,1.00052);
   gre->SetPointError(1,0,0.1024166);
   gre->SetPoint(2,-300,-0.38108);
   gre->SetPointError(2,0,0.480517);
   gre->SetPoint(3,-100,-2.98084);
   gre->SetPointError(3,0,0.5803524);
   gre->SetPoint(4,100,-4.47056);
   gre->SetPointError(4,0,0.4044549);
   gre->SetPoint(5,300,-5.32846);
   gre->SetPointError(5,0,0.1791069);
   gre->SetPoint(6,500,-8.1615);
   gre->SetPointError(6,0,0.1233491);
   gre->SetPoint(7,700,-10.39218);
   gre->SetPointError(7,0,0.1686836);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-12.07075);
   Graph_Graph55->SetMaximum(6.047835);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(62.24441);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009448234);
   linear_fit->SetParError(0,0.0001202391);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.403889);
   linear_fit->SetParError(1,0.06229421);
