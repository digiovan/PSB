...
//=========  (Wed Apr  1 22:34:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-14.1051,1050,-1.141405);
   ...
   gre->SetPoint(0,-700,-11.83818);
   gre->SetPointError(0,0,0.1063003);
   gre->SetPoint(1,-500,-10.89086);
   gre->SetPointError(1,0,0.06094384);
   gre->SetPoint(2,-300,-9.65018);
   gre->SetPointError(2,0,0.1292019);
   gre->SetPoint(3,-100,-8.45118);
   gre->SetPointError(3,0,0.01366467);
   gre->SetPoint(4,100,-7.16154);
   gre->SetPointError(4,0,0.03657203);
   gre->SetPoint(5,300,-6.07668);
   gre->SetPointError(5,0,0.06905377);
   gre->SetPoint(6,500,-4.98502);
   gre->SetPointError(6,0,0.03870119);
   gre->SetPoint(7,700,-3.35184);
   gre->SetPointError(7,0,0.04981959);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-12.80873);
   Graph_Graph44->SetMaximum(-2.437774);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.89977);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006065903);
   linear_fit->SetParError(0,4.22462e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.838244);
   linear_fit->SetParError(1,0.011322);
