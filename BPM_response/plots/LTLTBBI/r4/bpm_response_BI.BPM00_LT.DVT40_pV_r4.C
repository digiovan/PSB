...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-5.431688,1050,3.222497);
   ...
   gre->SetPoint(0,-700,1.76078);
   gre->SetPointError(0,0,0.01935275);
   gre->SetPoint(1,-500,0.95332);
   gre->SetPointError(1,0,0.0312607);
   gre->SetPoint(2,-300,0.11416);
   gre->SetPointError(2,0,0.01714232);
   gre->SetPoint(3,-100,-0.7306);
   gre->SetPointError(3,0,0.06733605);
   gre->SetPoint(4,100,-1.44686);
   gre->SetPointError(4,0,0.08003464);
   gre->SetPoint(5,300,-2.25082);
   gre->SetPointError(5,0,0.01423295);
   gre->SetPoint(6,500,-3.09712);
   gre->SetPointError(6,0,0.01294307);
   gre->SetPoint(7,700,-3.96322);
   gre->SetPointError(7,0,0.02610404);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-4.56627);
   Graph_Graph51->SetMaximum(2.357078);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.71508);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004042431);
   linear_fit->SetParError(0,1.523065e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.073686);
   linear_fit->SetParError(1,0.007276493);
