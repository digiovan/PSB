...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.440491,1050,-0.3773549);
   ...
   gre->SetPoint(0,-700,-0.40526);
   gre->SetPointError(0,0,0.007869099);
   gre->SetPoint(1,-500,-0.4066);
   gre->SetPointError(1,0,0.01065196);
   gre->SetPoint(2,-300,-0.42302);
   gre->SetPointError(2,0,0.006948278);
   gre->SetPoint(3,-100,-0.4172);
   gre->SetPointError(3,0,0.008506286);
   gre->SetPoint(4,100,-0.419);
   gre->SetPointError(4,0,0.007060992);
   gre->SetPoint(5,300,-0.39946);
   gre->SetPointError(5,0,0.01158243);
   gre->SetPoint(6,500,-0.41336);
   gre->SetPointError(6,0,0.003240782);
   gre->SetPoint(7,700,-0.41676);
   gre->SetPointError(7,0,0.009846672);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.4341773);
   Graph_Graph46->SetMaximum(-0.3836685);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.689135);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.160553e-06);
   linear_fit->SetParError(0,5.329628e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.413702);
   linear_fit->SetParError(1,0.002484716);
