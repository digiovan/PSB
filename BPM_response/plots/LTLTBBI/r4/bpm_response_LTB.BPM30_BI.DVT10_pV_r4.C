...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,3.008168,1050,3.481787);
   ...
   gre->SetPoint(0,-700,3.23366);
   gre->SetPointError(0,0,0.04424539);
   gre->SetPoint(1,-500,3.20744);
   gre->SetPointError(1,0,0.02432851);
   gre->SetPoint(2,-300,3.22928);
   gre->SetPointError(2,0,0.0788614);
   gre->SetPoint(3,-100,3.29198);
   gre->SetPointError(3,0,0.07383919);
   gre->SetPoint(4,100,3.24036);
   gre->SetPointError(4,0,0.0288442);
   gre->SetPoint(5,300,3.37162);
   gre->SetPointError(5,0,0.03123097);
   gre->SetPoint(6,500,3.2475);
   gre->SetPointError(6,0,0.04283164);
   gre->SetPoint(7,700,3.13688);
   gre->SetPointError(7,0,0.04977501);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(3.05553);
   Graph_Graph50->SetMaximum(3.434426);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.18615);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.056545e-05);
   linear_fit->SetParError(0,2.997418e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.250314);
   linear_fit->SetParError(1,0.0133063);
