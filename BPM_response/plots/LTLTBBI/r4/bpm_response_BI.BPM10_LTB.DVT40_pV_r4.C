...
//=========  (Wed Apr  1 22:35:43 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-11.14128,1050,17.46678);
   ...
   gre->SetPoint(0,-700,-6.28694);
   gre->SetPointError(0,0,0.08632989);
   gre->SetPoint(1,-500,-3.58332);
   gre->SetPointError(1,0,0.05587255);
   gre->SetPoint(2,-300,-0.75144);
   gre->SetPointError(2,0,0.05429774);
   gre->SetPoint(3,-100,1.8137);
   gre->SetPointError(3,0,0.0682924);
   gre->SetPoint(4,100,4.3359);
   gre->SetPointError(4,0,0.04185031);
   gre->SetPoint(5,300,6.80786);
   gre->SetPointError(5,0,0.1092048);
   gre->SetPoint(6,500,9.53538);
   gre->SetPointError(6,0,0.1099186);
   gre->SetPoint(7,700,12.59888);
   gre->SetPointError(7,0,0.09988822);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-8.280474);
   Graph_Graph52->SetMaximum(14.60597);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.40586);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01323986);
   linear_fit->SetParError(0,6.41081e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.071892);
   linear_fit->SetParError(1,0.02413194);
