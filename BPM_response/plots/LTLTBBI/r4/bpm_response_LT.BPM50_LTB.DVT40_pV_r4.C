...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-0.4096636,1050,-0.2565039);
   ...
   gre->SetPoint(0,-700,-0.34262);
   gre->SetPointError(0,0,0.01448754);
   gre->SetPoint(1,-500,-0.3189);
   gre->SetPointError(1,0,0.03686944);
   gre->SetPoint(2,-300,-0.34306);
   gre->SetPointError(2,0,0.0193149);
   gre->SetPoint(3,-100,-0.3215);
   gre->SetPointError(3,0,0.02451698);
   gre->SetPoint(4,100,-0.3609);
   gre->SetPointError(4,0,0.02323699);
   gre->SetPoint(5,300,-0.3276);
   gre->SetPointError(5,0,0.02810272);
   gre->SetPoint(6,500,-0.34084);
   gre->SetPointError(6,0,0.01051018);
   gre->SetPoint(7,700,-0.35454);
   gre->SetPointError(7,0,0.01758128);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-0.3943476);
   Graph_Graph47->SetMaximum(-0.2718199);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.402407);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.635497e-06);
   linear_fit->SetParError(0,1.243002e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3415683);
   linear_fit->SetParError(1,0.006430188);
