...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.093564,1050,1.465364);
   ...
   gre->SetPoint(0,-700,1.2075);
   gre->SetPointError(0,0,0.03809141);
   gre->SetPoint(1,-500,1.29602);
   gre->SetPointError(1,0,0.04250103);
   gre->SetPoint(2,-300,1.21248);
   gre->SetPointError(2,0,0.05694968);
   gre->SetPoint(3,-100,1.31422);
   gre->SetPointError(3,0,0.01864207);
   gre->SetPoint(4,100,1.28774);
   gre->SetPointError(4,0,0.07059669);
   gre->SetPoint(5,300,1.31834);
   gre->SetPointError(5,0,0.01645619);
   gre->SetPoint(6,500,1.2617);
   gre->SetPointError(6,0,0.02651274);
   gre->SetPoint(7,700,1.36352);
   gre->SetPointError(7,0,0.0398772);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.130744);
   Graph_Graph43->SetMaximum(1.428184);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.19288);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.027554e-05);
   linear_fit->SetParError(0,2.667359e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.29435);
   linear_fit->SetParError(1,0.01024652);
