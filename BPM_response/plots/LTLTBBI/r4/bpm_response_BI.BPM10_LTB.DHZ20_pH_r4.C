...
//=========  (Wed Apr  1 22:35:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-12.23642,1050,2.320436);
   ...
   gre->SetPoint(0,-700,-9.73816);
   gre->SetPointError(0,0,0.07212031);
   gre->SetPoint(1,-500,-8.3168);
   gre->SetPointError(1,0,0.2058151);
   gre->SetPoint(2,-300,-6.88432);
   gre->SetPointError(2,0,0.1828666);
   gre->SetPoint(3,-100,-5.40168);
   gre->SetPointError(3,0,0.07185992);
   gre->SetPoint(4,100,-4.12472);
   gre->SetPointError(4,0,0.1070344);
   gre->SetPoint(5,300,-3.0415);
   gre->SetPointError(5,0,0.04631115);
   gre->SetPoint(6,500,-1.63174);
   gre->SetPointError(6,0,0.1628378);
   gre->SetPoint(7,700,-0.30764);
   gre->SetPointError(7,0,0.2019324);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-10.78074);
   Graph_Graph52->SetMaximum(0.8647497);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.9614);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006666526);
   linear_fit->SetParError(0,7.694028e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.959981);
   linear_fit->SetParError(1,0.03079288);
