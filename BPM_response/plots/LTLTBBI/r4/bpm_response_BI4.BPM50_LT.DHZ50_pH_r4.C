...
//=========  (Wed Apr  1 22:34:56 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_H_4->Range(-1050,-13.30918,1050,8.332331);
   ...
   gre->SetPoint(0,-700,-9.15446);
   gre->SetPointError(0,0,0.5477987);
   gre->SetPoint(1,-500,1.01374);
   gre->SetPointError(1,0,0.3682688);
   gre->SetPoint(2,-300,-1.80276);
   gre->SetPointError(2,0,0.3227349);
   gre->SetPoint(3,-100,3.69066);
   gre->SetPointError(3,0,0.1918255);
   gre->SetPoint(4,100,4.44376);
   gre->SetPointError(4,0,0.2816529);
   gre->SetPoint(5,300,1.11238);
   gre->SetPointError(5,0,0.6582956);
   gre->SetPoint(6,500,2.39656);
   gre->SetPointError(6,0,0.7512456);
   gre->SetPoint(7,700,3.6468);
   gre->SetPointError(7,0,0.1620608);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-11.14503);
   Graph_Graph56->SetMaximum(6.16818);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(534.1482);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003476496);
   linear_fit->SetParError(0,0.00021863);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.951246);
   linear_fit->SetParError(1,0.1060256);
