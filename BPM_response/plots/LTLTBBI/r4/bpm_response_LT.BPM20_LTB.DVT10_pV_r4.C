...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_4->Range(-1050,-7.015799,1050,-6.76126);
   ...
   gre->SetPoint(0,-700,-6.8636);
   gre->SetPointError(0,0,0.01648716);
   gre->SetPoint(1,-500,-6.87738);
   gre->SetPointError(1,0,0.01255662);
   gre->SetPoint(2,-300,-6.89002);
   gre->SetPointError(2,0,0.01149465);
   gre->SetPoint(3,-100,-6.81658);
   gre->SetPointError(3,0,0.01289653);
   gre->SetPoint(4,100,-6.8922);
   gre->SetPointError(4,0,0.06047684);
   gre->SetPoint(5,300,-6.92326);
   gre->SetPointError(5,0,0.006799962);
   gre->SetPoint(6,500,-6.92008);
   gre->SetPointError(6,0,0.05329561);
   gre->SetPoint(7,700,-6.90988);
   gre->SetPointError(7,0,0.02504521);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-6.990345);
   Graph_Graph44->SetMaximum(-6.786714);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(37.5908);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.738274e-05);
   linear_fit->SetParError(0,1.200907e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.89401);
   linear_fit->SetParError(1,0.004595392);
