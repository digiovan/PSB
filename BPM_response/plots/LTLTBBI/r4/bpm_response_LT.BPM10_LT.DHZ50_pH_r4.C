...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.650083,1050,1.98854);
   ...
   gre->SetPoint(0,-700,1.79196);
   gre->SetPointError(0,0,0.01992475);
   gre->SetPoint(1,-500,1.8923);
   gre->SetPointError(1,0,0.01170293);
   gre->SetPoint(2,-300,1.7316);
   gre->SetPointError(2,0,0.02510774);
   gre->SetPoint(3,-100,1.8893);
   gre->SetPointError(3,0,0.04283059);
   gre->SetPoint(4,100,1.90392);
   gre->SetPointError(4,0,0.01046641);
   gre->SetPoint(5,300,1.72356);
   gre->SetPointError(5,0,0.01491631);
   gre->SetPoint(6,500,1.85054);
   gre->SetPointError(6,0,0.00922848);
   gre->SetPoint(7,700,1.83474);
   gre->SetPointError(7,0,0.01437036);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.683928);
   Graph_Graph43->SetMaximum(1.954694);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(140.984);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.791248e-05);
   linear_fit->SetParError(0,1.099363e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.848874);
   linear_fit->SetParError(1,0.005082803);
