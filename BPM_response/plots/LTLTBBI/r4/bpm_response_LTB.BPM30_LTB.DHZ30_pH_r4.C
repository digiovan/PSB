...
//=========  (Wed Apr  1 22:35:27 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,-9.560551,1050,10.52994);
   ...
   gre->SetPoint(0,-700,-6.16568);
   gre->SetPointError(0,0,0.04645589);
   gre->SetPoint(1,-500,-4.11842);
   gre->SetPointError(1,0,0.06745507);
   gre->SetPoint(2,-300,-2.07246);
   gre->SetPointError(2,0,0.09897928);
   gre->SetPoint(3,-100,-0.1492);
   gre->SetPointError(3,0,0.03902199);
   gre->SetPoint(4,100,1.68012);
   gre->SetPointError(4,0,0.02542128);
   gre->SetPoint(5,300,3.49498);
   gre->SetPointError(5,0,0.1517147);
   gre->SetPoint(6,500,5.09416);
   gre->SetPointError(6,0,0.05011605);
   gre->SetPoint(7,700,7.07384);
   gre->SetPointError(7,0,0.107684);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-7.551502);
   Graph_Graph50->SetMaximum(8.52089);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(80.05803);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.009456462);
   linear_fit->SetParError(0,4.683513e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6526223);
   linear_fit->SetParError(1,0.01691781);
