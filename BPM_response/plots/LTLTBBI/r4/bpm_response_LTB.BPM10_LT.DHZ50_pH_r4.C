...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,-2.196425,1050,6.427183);
   ...
   gre->SetPoint(0,-700,-0.65404);
   gre->SetPointError(0,0,0.1051173);
   gre->SetPoint(1,-500,-0.61012);
   gre->SetPointError(1,0,0.08619589);
   gre->SetPoint(2,-300,1.37072);
   gre->SetPointError(2,0,0.1499312);
   gre->SetPoint(3,-100,0.9682);
   gre->SetPointError(3,0,0.1985139);
   gre->SetPoint(4,100,1.70866);
   gre->SetPointError(4,0,0.07433565);
   gre->SetPoint(5,300,3.73262);
   gre->SetPointError(5,0,0.1383613);
   gre->SetPoint(6,500,3.4601);
   gre->SetPointError(6,0,0.112412);
   gre->SetPoint(7,700,4.933);
   gre->SetPointError(7,0,0.05691468);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(-1.334064);
   Graph_Graph48->SetMaximum(5.564822);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(166.9022);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00422626);
   linear_fit->SetParError(0,6.488572e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.791658);
   linear_fit->SetParError(1,0.0345566);
