...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,2.122729,1050,3.672263);
   ...
   gre->SetPoint(0,-700,2.46394);
   gre->SetPointError(0,0,0.08295528);
   gre->SetPoint(1,-500,2.69342);
   gre->SetPointError(1,0,0.04161407);
   gre->SetPoint(2,-300,2.93432);
   gre->SetPointError(2,0,0.05338752);
   gre->SetPoint(3,-100,3.2369);
   gre->SetPointError(3,0,0.03065171);
   gre->SetPoint(4,100,3.22624);
   gre->SetPointError(4,0,0.01533682);
   gre->SetPoint(5,300,3.31048);
   gre->SetPointError(5,0,0.1035274);
   gre->SetPoint(6,500,3.23758);
   gre->SetPointError(6,0,0.08534525);
   gre->SetPoint(7,700,3.18942);
   gre->SetPointError(7,0,0.04946287);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(2.277682);
   Graph_Graph50->SetMaximum(3.51731);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(107.5412);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0005000288);
   linear_fit->SetParError(0,4.314195e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.138309);
   linear_fit->SetParError(1,0.01199454);
