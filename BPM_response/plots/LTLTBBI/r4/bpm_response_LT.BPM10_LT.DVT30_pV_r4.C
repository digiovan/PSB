...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.058866,1050,1.365844);
   ...
   gre->SetPoint(0,-700,1.22804);
   gre->SetPointError(0,0,0.04375404);
   gre->SetPoint(1,-500,1.21244);
   gre->SetPointError(1,0,0.03333769);
   gre->SetPoint(2,-300,1.2686);
   gre->SetPointError(2,0,0.03090206);
   gre->SetPoint(3,-100,1.18758);
   gre->SetPointError(3,0,0.0276402);
   gre->SetPoint(4,100,1.27212);
   gre->SetPointError(4,0,0.04256085);
   gre->SetPoint(5,300,1.2729);
   gre->SetPointError(5,0,0.02398765);
   gre->SetPoint(6,500,1.19118);
   gre->SetPointError(6,0,0.02607155);
   gre->SetPoint(7,700,1.19674);
   gre->SetPointError(7,0,0.0867109);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.089564);
   Graph_Graph43->SetMaximum(1.335146);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.71348);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.234364e-06);
   linear_fit->SetParError(0,2.910621e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.230646);
   linear_fit->SetParError(1,0.01142974);
