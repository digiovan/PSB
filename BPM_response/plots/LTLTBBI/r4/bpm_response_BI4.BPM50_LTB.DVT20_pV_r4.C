...
//=========  (Wed Apr  1 22:35:22 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-15.72523,1050,2.676479);
   ...
   gre->SetPoint(0,-700,-0.6462);
   gre->SetPointError(0,0,0.2557277);
   gre->SetPoint(1,-500,-3.3914);
   gre->SetPointError(1,0,0.1204802);
   gre->SetPoint(2,-300,-4.61832);
   gre->SetPointError(2,0,0.3621929);
   gre->SetPoint(3,-100,-6.3655);
   gre->SetPointError(3,0,0.5551461);
   gre->SetPoint(4,100,-7.70396);
   gre->SetPointError(4,0,0.2241549);
   gre->SetPoint(5,300,-8.10312);
   gre->SetPointError(5,0,0.1902215);
   gre->SetPoint(6,500,-10.61684);
   gre->SetPointError(6,0,0.1838664);
   gre->SetPoint(7,700,-12.44666);
   gre->SetPointError(7,0,0.2116153);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-13.88506);
   Graph_Graph56->SetMaximum(0.836308);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(49.60716);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007440759);
   linear_fit->SetParError(0,0.0001471202);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.792579);
   linear_fit->SetParError(1,0.07190192);
