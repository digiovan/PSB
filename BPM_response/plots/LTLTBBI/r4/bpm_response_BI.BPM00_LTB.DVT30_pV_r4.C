...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-4.287713,1050,2.05489);
   ...
   gre->SetPoint(0,-700,-3.20628);
   gre->SetPointError(0,0,0.02433275);
   gre->SetPoint(1,-500,-2.58726);
   gre->SetPointError(1,0,0.07342539);
   gre->SetPoint(2,-300,-1.9248);
   gre->SetPointError(2,0,0.02033958);
   gre->SetPoint(3,-100,-1.41078);
   gre->SetPointError(3,0,0.006953538);
   gre->SetPoint(4,100,-0.99468);
   gre->SetPointError(4,0,0.01310032);
   gre->SetPoint(5,300,-0.33428);
   gre->SetPointError(5,0,0.005817722);
   gre->SetPoint(6,500,0.23408);
   gre->SetPointError(6,0,0.01407686);
   gre->SetPoint(7,700,0.90514);
   gre->SetPointError(7,0,0.09264961);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-3.653453);
   Graph_Graph51->SetMaximum(1.42063);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(119.4128);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002765009);
   linear_fit->SetParError(0,1.514172e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.162948);
   linear_fit->SetParError(1,0.004320839);
