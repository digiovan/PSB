...
//=========  (Wed Apr  1 22:34:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,7.575394,1050,9.224029);
   ...
   gre->SetPoint(0,-700,7.86494);
   gre->SetPointError(0,0,0.01477321);
   gre->SetPoint(1,-500,8.33636);
   gre->SetPointError(1,0,0.03862433);
   gre->SetPoint(2,-300,8.3883);
   gre->SetPointError(2,0,0.008522754);
   gre->SetPoint(3,-100,8.31536);
   gre->SetPointError(3,0,0.05416997);
   gre->SetPoint(4,100,8.39658);
   gre->SetPointError(4,0,0.04350971);
   gre->SetPoint(5,300,8.75842);
   gre->SetPointError(5,0,0.07175742);
   gre->SetPoint(6,500,8.92108);
   gre->SetPointError(6,0,0.02817649);
   gre->SetPoint(7,700,8.84608);
   gre->SetPointError(7,0,0.03369203);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(7.740258);
   Graph_Graph53->SetMaximum(9.059165);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(271.6017);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0007526868);
   linear_fit->SetParError(0,1.957207e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.544528);
   linear_fit->SetParError(1,0.008733066);
