...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,2.315898,1050,3.035697);
   ...
   gre->SetPoint(0,-700,2.61436);
   gre->SetPointError(0,0,0.04668431);
   gre->SetPoint(1,-500,2.65912);
   gre->SetPointError(1,0,0.1725386);
   gre->SetPoint(2,-300,2.61658);
   gre->SetPointError(2,0,0.01398913);
   gre->SetPoint(3,-100,2.73322);
   gre->SetPointError(3,0,0.02436294);
   gre->SetPoint(4,100,2.84274);
   gre->SetPointError(4,0,0.07299086);
   gre->SetPoint(5,300,2.6859);
   gre->SetPointError(5,0,0.01798822);
   gre->SetPoint(6,500,2.6993);
   gre->SetPointError(6,0,0.0521212);
   gre->SetPoint(7,700,2.5795);
   gre->SetPointError(7,0,0.1436352);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(2.387878);
   Graph_Graph49->SetMaximum(2.963717);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.94199);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,9.776161e-05);
   linear_fit->SetParError(0,3.106906e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.668288);
   linear_fit->SetParError(1,0.009858736);
