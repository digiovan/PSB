...
//=========  (Wed Apr  1 22:36:20 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,-1.458051,1050,-1.134909);
   ...
   gre->SetPoint(0,-700,-1.36392);
   gre->SetPointError(0,0,0.037093);
   gre->SetPoint(1,-500,-1.32058);
   gre->SetPointError(1,0,0.04803224);
   gre->SetPoint(2,-300,-1.2897);
   gre->SetPointError(2,0,0.06860797);
   gre->SetPoint(3,-100,-1.25984);
   gre->SetPointError(3,0,0.01283499);
   gre->SetPoint(4,100,-1.29326);
   gre->SetPointError(4,0,0.104494);
   gre->SetPoint(5,300,-1.26086);
   gre->SetPointError(5,0,0.02728583);
   gre->SetPoint(6,500,-1.3442);
   gre->SetPointError(6,0,0.02828392);
   gre->SetPoint(7,700,-1.38972);
   gre->SetPointError(7,0,0.01447362);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-1.425736);
   Graph_Graph53->SetMaximum(-1.167223);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(28.76031);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-9.249635e-05);
   linear_fit->SetParError(0,1.917136e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.297577);
   linear_fit->SetParError(1,0.009046031);
