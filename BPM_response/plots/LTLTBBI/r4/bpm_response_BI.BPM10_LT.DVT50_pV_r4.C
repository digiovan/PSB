...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-20.67701,1050,27.72632);
   ...
   gre->SetPoint(0,-700,19.55902);
   gre->SetPointError(0,0,0.1000822);
   gre->SetPoint(1,-500,15.2555);
   gre->SetPointError(1,0,0.06534945);
   gre->SetPoint(2,-300,10.58772);
   gre->SetPointError(2,0,0.09773565);
   gre->SetPoint(3,-100,5.90834);
   gre->SetPointError(3,0,0.03613716);
   gre->SetPoint(4,100,1.1365);
   gre->SetPointError(4,0,0.1104057);
   gre->SetPoint(5,300,-3.26116);
   gre->SetPointError(5,0,0.08427879);
   gre->SetPoint(6,500,-7.66622);
   gre->SetPointError(6,0,0.06971771);
   gre->SetPoint(7,700,-12.51778);
   gre->SetPointError(7,0,0.09200485);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-15.83667);
   Graph_Graph52->SetMaximum(22.88599);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.13385);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02294422);
   linear_fit->SetParError(0,6.383984e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.645254);
   linear_fit->SetParError(1,0.0239932);
