...
//=========  (Wed Apr  1 22:36:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-2.143801,1050,-1.11619);
   ...
   gre->SetPoint(0,-700,-1.83548);
   gre->SetPointError(0,0,0.1370524);
   gre->SetPoint(1,-500,-1.3236);
   gre->SetPointError(1,0,0.0361414);
   gre->SetPoint(2,-300,-1.49594);
   gre->SetPointError(2,0,0.03463872);
   gre->SetPoint(3,-100,-1.42234);
   gre->SetPointError(3,0,0.06355892);
   gre->SetPoint(4,100,-1.60626);
   gre->SetPointError(4,0,0.1096669);
   gre->SetPoint(5,300,-1.46008);
   gre->SetPointError(5,0,0.04717586);
   gre->SetPoint(6,500,-1.51404);
   gre->SetPointError(6,0,0.08789375);
   gre->SetPoint(7,700,-1.72168);
   gre->SetPointError(7,0,0.1832451);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-2.04104);
   Graph_Graph53->SetMaximum(-1.218951);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.05094);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001126562);
   linear_fit->SetParError(0,5.779889e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.466058);
   linear_fit->SetParError(1,0.02222551);
