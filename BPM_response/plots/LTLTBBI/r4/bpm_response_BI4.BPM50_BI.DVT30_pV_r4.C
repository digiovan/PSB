...
//=========  (Wed Apr  1 22:36:15 2015) by ROOT version5.34/21
   ...
   gre->SetPoint(0,-700,-5.18286);
   gre->SetPointError(0,0,2.353593);
   gre->SetPoint(1,-500,-10.44296);
   gre->SetPointError(1,0,0.5204714);
   gre->SetPoint(2,-300,-8.11008);
   gre->SetPointError(2,0,0.5668063);
   gre->SetPoint(3,-100,-9.75762);
   gre->SetPointError(3,0,0.1380881);
   gre->SetPoint(4,100,-7.66032);
   gre->SetPointError(4,0,1.394559);
   gre->SetPoint(5,300,-8.32176);
   gre->SetPointError(5,0,0.4868549);
   gre->SetPoint(6,500,-7.5061);
   gre->SetPointError(6,0,0.1946932);
   gre->SetPoint(7,700,-4.36856);
   gre->SetPointError(7,0,2.532573);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: BI.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-11.87618);
   Graph_Graph56->SetMaximum(-0.923242);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.60648);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00312824);
   linear_fit->SetParError(0,0.0003447982);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.200063);
   linear_fit->SetParError(1,0.1078422);
