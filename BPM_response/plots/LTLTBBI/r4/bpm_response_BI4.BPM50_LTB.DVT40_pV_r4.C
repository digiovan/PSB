...
//=========  (Wed Apr  1 22:35:43 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-23.45434,1050,13.26434);
   ...
   gre->SetPoint(0,-700,-7.8682);
   gre->SetPointError(0,0,1.113347);
   gre->SetPoint(1,-500,-16.73152);
   gre->SetPointError(1,0,0.6030387);
   gre->SetPoint(2,-300,-12.2273);
   gre->SetPointError(2,0,0.3109777);
   gre->SetPoint(3,-100,-9.02754);
   gre->SetPointError(3,0,0.3535282);
   gre->SetPoint(4,100,-5.93688);
   gre->SetPointError(4,0,0.2511908);
   gre->SetPoint(5,300,-2.43104);
   gre->SetPointError(5,0,0.3858652);
   gre->SetPoint(6,500,2.1761);
   gre->SetPointError(6,0,0.2357376);
   gre->SetPoint(7,700,7.05414);
   gre->SetPointError(7,0,0.09041971);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-19.78247);
   Graph_Graph56->SetMaximum(9.592472);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(179.4916);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01950131);
   linear_fit->SetParError(0,0.0002176647);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.824077);
   linear_fit->SetParError(1,0.1313535);
