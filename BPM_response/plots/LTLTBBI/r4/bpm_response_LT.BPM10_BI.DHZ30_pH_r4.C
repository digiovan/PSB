...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.655407,1050,1.871632);
   ...
   gre->SetPoint(0,-700,1.77112);
   gre->SetPointError(0,0,0.01352469);
   gre->SetPoint(1,-500,1.76788);
   gre->SetPointError(1,0,0.03907967);
   gre->SetPoint(2,-300,1.79012);
   gre->SetPointError(2,0,0.03872605);
   gre->SetPoint(3,-100,1.80386);
   gre->SetPointError(3,0,0.03173432);
   gre->SetPoint(4,100,1.75264);
   gre->SetPointError(4,0,0.01901948);
   gre->SetPoint(5,300,1.70328);
   gre->SetPointError(5,0,0.01183526);
   gre->SetPoint(6,500,1.7829);
   gre->SetPointError(6,0,0.01035638);
   gre->SetPoint(7,700,1.75652);
   gre->SetPointError(7,0,0.00773715);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.67703);
   Graph_Graph43->SetMaximum(1.850009);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.51334);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.121976e-06);
   linear_fit->SetParError(0,1.030985e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.759123);
   linear_fit->SetParError(1,0.00585513);
