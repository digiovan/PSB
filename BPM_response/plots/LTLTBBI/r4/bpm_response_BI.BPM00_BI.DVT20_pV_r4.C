...
//=========  (Wed Apr  1 22:36:04 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-1.266046,1050,-0.8849255);
   ...
   gre->SetPoint(0,-700,-1.01722);
   gre->SetPointError(0,0,0.02987601);
   gre->SetPoint(1,-500,-1.1276);
   gre->SetPointError(1,0,0.03158032);
   gre->SetPoint(2,-300,-1.03806);
   gre->SetPointError(2,0,0.02485705);
   gre->SetPoint(3,-100,-1.16388);
   gre->SetPointError(3,0,0.03443704);
   gre->SetPoint(4,100,-1.0648);
   gre->SetPointError(4,0,0.02376026);
   gre->SetPoint(5,300,-1.15574);
   gre->SetPointError(5,0,0.04678598);
   gre->SetPoint(6,500,-0.97222);
   gre->SetPointError(6,0,0.02377442);
   gre->SetPoint(7,700,-1.08806);
   gre->SetPointError(7,0,0.04461735);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-1.227934);
   Graph_Graph51->SetMaximum(-0.9230375);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(33.08437);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.124703e-05);
   linear_fit->SetParError(0,2.431965e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.057077);
   linear_fit->SetParError(1,0.01052355);
