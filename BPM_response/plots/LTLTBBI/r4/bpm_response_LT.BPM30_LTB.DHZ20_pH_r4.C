...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-9.463081,1050,-9.070301);
   ...
   gre->SetPoint(0,-700,-9.25854);
   gre->SetPointError(0,0,0.04028746);
   gre->SetPoint(1,-500,-9.22794);
   gre->SetPointError(1,0,0.04813625);
   gre->SetPoint(2,-300,-9.2154);
   gre->SetPointError(2,0,0.02113585);
   gre->SetPoint(3,-100,-9.32138);
   gre->SetPointError(3,0,0.02374718);
   gre->SetPoint(4,100,-9.3402);
   gre->SetPointError(4,0,0.05741738);
   gre->SetPoint(5,300,-9.17568);
   gre->SetPointError(5,0,0.03991612);
   gre->SetPoint(6,500,-9.2464);
   gre->SetPointError(6,0,0.02857666);
   gre->SetPoint(7,700,-9.25028);
   gre->SetPointError(7,0,0.06416849);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-9.423803);
   Graph_Graph45->SetMaximum(-9.109579);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.85971);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.229426e-07);
   linear_fit->SetParError(0,3.041796e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.252826);
   linear_fit->SetParError(1,0.01175431);
