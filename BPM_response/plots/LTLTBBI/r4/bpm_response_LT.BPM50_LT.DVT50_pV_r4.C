...
//=========  (Wed Apr  1 22:35:00 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-1.287592,1050,1.358632);
   ...
   gre->SetPoint(0,-700,-0.81114);
   gre->SetPointError(0,0,0.03541491);
   gre->SetPoint(1,-500,-0.43658);
   gre->SetPointError(1,0,0.02716005);
   gre->SetPoint(2,-300,-0.08944);
   gre->SetPointError(2,0,0.02178165);
   gre->SetPoint(3,-100,0.14054);
   gre->SetPointError(3,0,0.01918003);
   gre->SetPoint(4,100,0.44788);
   gre->SetPointError(4,0,0.006175993);
   gre->SetPoint(5,300,0.66262);
   gre->SetPointError(5,0,0.008484636);
   gre->SetPoint(6,500,0.82308);
   gre->SetPointError(6,0,0.02443529);
   gre->SetPoint(7,700,0.90152);
   gre->SetPointError(7,0,0.01607461);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.02297);
   Graph_Graph47->SetMaximum(1.09401);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(312.7103);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001137084);
   linear_fit->SetParError(0,1.690851e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.2935503);
   linear_fit->SetParError(1,0.005092313);
