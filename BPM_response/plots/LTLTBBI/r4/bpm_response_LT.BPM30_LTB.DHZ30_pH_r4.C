...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-9.453431,1050,-9.030766);
   ...
   gre->SetPoint(0,-700,-9.28828);
   gre->SetPointError(0,0,0.03132981);
   gre->SetPoint(1,-500,-9.27276);
   gre->SetPointError(1,0,0.0109);
   gre->SetPoint(2,-300,-9.1292);
   gre->SetPointError(2,0,0.02799025);
   gre->SetPoint(3,-100,-9.29264);
   gre->SetPointError(3,0,0.0625114);
   gre->SetPoint(4,100,-9.3119);
   gre->SetPointError(4,0,0.07108648);
   gre->SetPoint(5,300,-9.262);
   gre->SetPointError(5,0,0.03116139);
   gre->SetPoint(6,500,-9.20938);
   gre->SetPointError(6,0,0.03890443);
   gre->SetPoint(7,700,-9.2581);
   gre->SetPointError(7,0,0.03942363);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-9.411164);
   Graph_Graph45->SetMaximum(-9.073032);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.87484);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.759199e-05);
   linear_fit->SetParError(0,2.249371e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.24806);
   linear_fit->SetParError(1,0.01111448);
