...
//=========  (Wed Apr  1 22:36:14 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,2.41999,1050,3.584281);
   ...
   gre->SetPoint(0,-700,2.79528);
   gre->SetPointError(0,0,0.1812415);
   gre->SetPoint(1,-500,3.35344);
   gre->SetPointError(1,0,0.03679229);
   gre->SetPoint(2,-300,3.17694);
   gre->SetPointError(2,0,0.02900073);
   gre->SetPoint(3,-100,3.25106);
   gre->SetPointError(3,0,0.05243749);
   gre->SetPoint(4,100,3.08828);
   gre->SetPointError(4,0,0.1338496);
   gre->SetPoint(5,300,3.2496);
   gre->SetPointError(5,0,0.0442824);
   gre->SetPoint(6,500,3.17548);
   gre->SetPointError(6,0,0.1210302);
   gre->SetPoint(7,700,2.9018);
   gre->SetPointError(7,0,0.186391);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: BI.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(2.536419);
   Graph_Graph50->SetMaximum(3.467852);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.31863);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.983389e-05);
   linear_fit->SetParError(0,5.990323e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.218563);
   linear_fit->SetParError(1,0.02159462);
