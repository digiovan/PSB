...
//=========  (Wed Apr  1 22:34:29 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-0.8268958,1050,2.294551);
   ...
   gre->SetPoint(0,-700,1.7348);
   gre->SetPointError(0,0,0.03950974);
   gre->SetPoint(1,-500,0.52348);
   gre->SetPointError(1,0,0.02702025);
   gre->SetPoint(2,-300,0.47412);
   gre->SetPointError(2,0,0.06509954);
   gre->SetPoint(3,-100,0.36334);
   gre->SetPointError(3,0,0.01946095);
   gre->SetPoint(4,100,0.20224);
   gre->SetPointError(4,0,0.05433851);
   gre->SetPoint(5,300,-0.04342);
   gre->SetPointError(5,0,0.02339318);
   gre->SetPoint(6,500,-0.25996);
   gre->SetPointError(6,0,0.04669471);
   gre->SetPoint(7,700,0.73488);
   gre->SetPointError(7,0,0.01633533);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-0.5147512);
   Graph_Graph47->SetMaximum(1.982406);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2009.174);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001530624);
   linear_fit->SetParError(0,2.008348e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5173247);
   linear_fit->SetParError(1,0.01005607);
