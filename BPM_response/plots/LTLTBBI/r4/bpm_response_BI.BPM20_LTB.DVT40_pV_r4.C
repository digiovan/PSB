...
//=========  (Wed Apr  1 22:35:43 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-10.29251,1050,8.036386);
   ...
   gre->SetPoint(0,-700,4.9386);
   gre->SetPointError(0,0,0.04297003);
   gre->SetPoint(1,-500,3.2118);
   gre->SetPointError(1,0,0.03989622);
   gre->SetPoint(2,-300,1.38142);
   gre->SetPointError(2,0,0.03902357);
   gre->SetPoint(3,-100,-0.29584);
   gre->SetPointError(3,0,0.0528624);
   gre->SetPoint(4,100,-1.93702);
   gre->SetPointError(4,0,0.04206016);
   gre->SetPoint(5,300,-3.54296);
   gre->SetPointError(5,0,0.06771984);
   gre->SetPoint(6,500,-5.29698);
   gre->SetPointError(6,0,0.05786072);
   gre->SetPoint(7,700,-7.19416);
   gre->SetPointError(7,0,0.04353367);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-8.45962);
   Graph_Graph53->SetMaximum(6.203496);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.905);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008592146);
   linear_fit->SetParError(0,3.487564e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.108032);
   linear_fit->SetParError(1,0.01644543);
