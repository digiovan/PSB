...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-1.552537,1050,-0.5529491);
   ...
   gre->SetPoint(0,-700,-1.36308);
   gre->SetPointError(0,0,0.02285888);
   gre->SetPoint(1,-500,-1.29984);
   gre->SetPointError(1,0,0.01603874);
   gre->SetPoint(2,-300,-1.20044);
   gre->SetPointError(2,0,0.04808799);
   gre->SetPoint(3,-100,-1.14414);
   gre->SetPointError(3,0,0.04887265);
   gre->SetPoint(4,100,-1.06064);
   gre->SetPointError(4,0,0.02557519);
   gre->SetPoint(5,300,-1.01272);
   gre->SetPointError(5,0,0.01457415);
   gre->SetPoint(6,500,-0.8791);
   gre->SetPointError(6,0,0.01087406);
   gre->SetPoint(7,700,-0.74524);
   gre->SetPointError(7,0,0.02569296);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-1.452578);
   Graph_Graph51->SetMaximum(-0.6529079);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.55342);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004147635);
   linear_fit->SetParError(0,1.452053e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.094553);
   linear_fit->SetParError(1,0.006957323);
