...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,-14.62309,1050,19.44513);
   ...
   gre->SetPoint(0,-700,-8.90056);
   gre->SetPointError(0,0,0.04449529);
   gre->SetPoint(1,-500,-5.6351);
   gre->SetPointError(1,0,0.03160097);
   gre->SetPoint(2,-300,-2.21444);
   gre->SetPointError(2,0,0.06634399);
   gre->SetPoint(3,-100,1.06398);
   gre->SetPointError(3,0,0.03594395);
   gre->SetPoint(4,100,4.3928);
   gre->SetPointError(4,0,0.02684163);
   gre->SetPoint(5,300,7.4431);
   gre->SetPointError(5,0,0.04252994);
   gre->SetPoint(6,500,10.52318);
   gre->SetPointError(6,0,0.04912895);
   gre->SetPoint(7,700,13.7157);
   gre->SetPointError(7,0,0.05139665);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(-11.21627);
   Graph_Graph49->SetMaximum(16.03831);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(108.355);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01624257);
   linear_fit->SetParError(0,3.391788e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.588703);
   linear_fit->SetParError(1,0.01388785);
