...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-31.16704,1050,27.73963);
   ...
   gre->SetPoint(0,-700,17.6349);
   gre->SetPointError(0,0,0.2869526);
   gre->SetPoint(1,-500,13.7852);
   gre->SetPointError(1,0,0.233176);
   gre->SetPoint(2,-300,5.98774);
   gre->SetPointError(2,0,0.1526458);
   gre->SetPoint(3,-100,-0.42734);
   gre->SetPointError(3,0,0.6930306);
   gre->SetPoint(4,100,-6.89596);
   gre->SetPointError(4,0,0.3015215);
   gre->SetPoint(5,300,-12.09242);
   gre->SetPointError(5,0,0.6106344);
   gre->SetPoint(6,500,-20.2828);
   gre->SetPointError(6,0,1.066461);
   gre->SetPoint(7,700,-10.2136);
   gre->SetPointError(7,0,2.561345);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-25.27637);
   Graph_Graph55->SetMaximum(21.84896);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(88.61417);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.03134677);
   linear_fit->SetParError(0,0.0004020921);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.234667);
   linear_fit->SetParError(1,0.1643532);
