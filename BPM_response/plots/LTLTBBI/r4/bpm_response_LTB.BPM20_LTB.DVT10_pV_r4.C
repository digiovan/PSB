...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,-13.38981,1050,18.67188);
   ...
   gre->SetPoint(0,-700,-7.99956);
   gre->SetPointError(0,0,0.04663831);
   gre->SetPoint(1,-500,-4.7277);
   gre->SetPointError(1,0,0.101765);
   gre->SetPoint(2,-300,-1.67128);
   gre->SetPointError(2,0,0.0404242);
   gre->SetPoint(3,-100,1.25266);
   gre->SetPointError(3,0,0.04761178);
   gre->SetPoint(4,100,4.16826);
   gre->SetPointError(4,0,0.01634091);
   gre->SetPoint(5,300,7.02354);
   gre->SetPointError(5,0,0.04372587);
   gre->SetPoint(6,500,10.29248);
   gre->SetPointError(6,0,0.04790599);
   gre->SetPoint(7,700,13.29462);
   gre->SetPointError(7,0,0.03364744);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(-10.18364);
   Graph_Graph49->SetMaximum(15.46571);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(53.42837);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01509539);
   linear_fit->SetParError(0,3.42429e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.680063);
   linear_fit->SetParError(1,0.01234402);
