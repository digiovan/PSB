...
//=========  (Wed Apr  1 22:35:06 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-9.982722,1050,-3.64012);
   ...
   gre->SetPoint(0,-700,-8.86738);
   gre->SetPointError(0,0,0.05824127);
   gre->SetPoint(1,-500,-8.2085);
   gre->SetPointError(1,0,0.2187727);
   gre->SetPoint(2,-300,-7.6262);
   gre->SetPointError(2,0,0.1053723);
   gre->SetPoint(3,-100,-7.00892);
   gre->SetPointError(3,0,0.0544659);
   gre->SetPoint(4,100,-6.33022);
   gre->SetPointError(4,0,0.06406449);
   gre->SetPoint(5,300,-5.90594);
   gre->SetPointError(5,0,0.02355621);
   gre->SetPoint(6,500,-5.40158);
   gre->SetPointError(6,0,0.06860887);
   gre->SetPoint(7,700,-4.83306);
   gre->SetPointError(7,0,0.1358395);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-9.348461);
   Graph_Graph51->SetMaximum(-4.27438);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.648613);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002898879);
   linear_fit->SetParError(0,5.387926e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.769104);
   linear_fit->SetParError(1,0.01962748);
