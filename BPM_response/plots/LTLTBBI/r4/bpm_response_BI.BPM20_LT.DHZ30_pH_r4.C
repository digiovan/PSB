...
//=========  (Wed Apr  1 22:34:35 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,2.462721,1050,13.83731);
   ...
   gre->SetPoint(0,-700,11.93236);
   gre->SetPointError(0,0,0.009186226);
   gre->SetPoint(1,-500,11.04686);
   gre->SetPointError(1,0,0.01260024);
   gre->SetPoint(2,-300,9.82202);
   gre->SetPointError(2,0,0.06038536);
   gre->SetPoint(3,-100,9.01886);
   gre->SetPointError(3,0,0.01567339);
   gre->SetPoint(4,100,7.83524);
   gre->SetPointError(4,0,0.05665582);
   gre->SetPoint(5,300,7.03008);
   gre->SetPointError(5,0,0.01837335);
   gre->SetPoint(6,500,5.9668);
   gre->SetPointError(6,0,0.01973842);
   gre->SetPoint(7,700,4.43708);
   gre->SetPointError(7,0,0.07859364);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(3.60018);
   Graph_Graph53->SetMaximum(12.69985);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(126.9615);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004975453);
   linear_fit->SetParError(0,1.387874e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.486632);
   linear_fit->SetParError(1,0.007551963);
