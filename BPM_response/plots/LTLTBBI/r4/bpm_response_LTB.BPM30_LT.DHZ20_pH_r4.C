...
//=========  (Wed Apr  1 22:34:24 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,0.1342975,1050,1.071357);
   ...
   gre->SetPoint(0,-700,0.84564);
   gre->SetPointError(0,0,0.06954025);
   gre->SetPoint(1,-500,0.67738);
   gre->SetPointError(1,0,0.1211537);
   gre->SetPoint(2,-300,0.55992);
   gre->SetPointError(2,0,0.06895752);
   gre->SetPoint(3,-100,0.55654);
   gre->SetPointError(3,0,0.122197);
   gre->SetPoint(4,100,0.4982);
   gre->SetPointError(4,0,0.1295666);
   gre->SetPoint(5,300,0.4319);
   gre->SetPointError(5,0,0.06555414);
   gre->SetPoint(6,500,0.39764);
   gre->SetPointError(6,0,0.107166);
   gre->SetPoint(7,700,0.62204);
   gre->SetPointError(7,0,0.06674432);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(0.2280034);
   Graph_Graph50->SetMaximum(0.9776509);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.49416);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.000181513);
   linear_fit->SetParError(0,5.86628e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5930161);
   linear_fit->SetParError(1,0.02944559);
