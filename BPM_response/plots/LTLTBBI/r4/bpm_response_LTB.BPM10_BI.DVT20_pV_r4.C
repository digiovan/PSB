...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,0.8927766,1050,1.242281);
   ...
   gre->SetPoint(0,-700,1.02534);
   gre->SetPointError(0,0,0.07431274);
   gre->SetPoint(1,-500,1.12516);
   gre->SetPointError(1,0,0.03429608);
   gre->SetPoint(2,-300,1.00056);
   gre->SetPointError(2,0,0.01816314);
   gre->SetPoint(3,-100,1.1621);
   gre->SetPointError(3,0,0.02125314);
   gre->SetPoint(4,100,1.0271);
   gre->SetPointError(4,0,0.04623069);
   gre->SetPoint(5,300,1.13422);
   gre->SetPointError(5,0,0.04980996);
   gre->SetPoint(6,500,0.99822);
   gre->SetPointError(6,0,0.01496179);
   gre->SetPoint(7,700,1.09246);
   gre->SetPointError(7,0,0.06780817);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(0.927727);
   Graph_Graph48->SetMaximum(1.20733);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(49.24992);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.885883e-05);
   linear_fit->SetParError(0,2.359362e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.050859);
   linear_fit->SetParError(1,0.0093559);
