...
//=========  (Wed Apr  1 22:34:19 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-5.482409,1050,1.875198);
   ...
   gre->SetPoint(0,-700,0.28664);
   gre->SetPointError(0,0,0.3622904);
   gre->SetPoint(1,-500,-1.2534);
   gre->SetPointError(1,0,0.1030636);
   gre->SetPoint(2,-300,-2.2456);
   gre->SetPointError(2,0,0.1923846);
   gre->SetPoint(3,-100,-2.38508);
   gre->SetPointError(3,0,0.2699956);
   gre->SetPoint(4,100,-3.94552);
   gre->SetPointError(4,0,0.3106208);
   gre->SetPoint(5,300,-3.27318);
   gre->SetPointError(5,0,0.3378307);
   gre->SetPoint(6,500,-2.60728);
   gre->SetPointError(6,0,0.3387856);
   gre->SetPoint(7,700,-2.9634);
   gre->SetPointError(7,0,0.07890139);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-4.746648);
   Graph_Graph55->SetMaximum(1.139437);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(65.83413);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001389633);
   linear_fit->SetParError(0,9.938136e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.103229);
   linear_fit->SetParError(1,0.05771357);
