...
//=========  (Wed Apr  1 22:34:30 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-25.3554,1050,12.33895);
   ...
   gre->SetPoint(0,-700,-18.66358);
   gre->SetPointError(0,0,0.4094303);
   gre->SetPoint(1,-500,-15.6502);
   gre->SetPointError(1,0,0.625144);
   gre->SetPoint(2,-300,-11.88126);
   gre->SetPointError(2,0,0.4556313);
   gre->SetPoint(3,-100,-8.4327);
   gre->SetPointError(3,0,0.9857112);
   gre->SetPoint(4,100,-4.7362);
   gre->SetPointError(4,0,0.07495314);
   gre->SetPoint(5,300,-0.85416);
   gre->SetPointError(5,0,0.3323491);
   gre->SetPoint(6,500,2.54388);
   gre->SetPointError(6,0,0.2365565);
   gre->SetPoint(7,700,5.98184);
   gre->SetPointError(7,0,0.07471832);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-21.58597);
   Graph_Graph56->SetMaximum(8.569515);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.911236);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01782443);
   linear_fit->SetParError(0,0.000150782);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.491141);
   linear_fit->SetParError(1,0.07510069);
