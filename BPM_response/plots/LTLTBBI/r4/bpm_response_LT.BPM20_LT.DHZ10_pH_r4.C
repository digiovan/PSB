...
//=========  (Wed Apr  1 22:34:13 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-9.795029,1050,-5.494437);
   ...
   gre->SetPoint(0,-700,-6.25472);
   gre->SetPointError(0,0,0.04351773);
   gre->SetPoint(1,-500,-6.94106);
   gre->SetPointError(1,0,0.02457789);
   gre->SetPoint(2,-300,-7.36246);
   gre->SetPointError(2,0,0.03123665);
   gre->SetPoint(3,-100,-7.6544);
   gre->SetPointError(3,0,0.1160387);
   gre->SetPoint(4,100,-7.95148);
   gre->SetPointError(4,0,0.04926455);
   gre->SetPoint(5,300,-8.58916);
   gre->SetPointError(5,0,0.06353118);
   gre->SetPoint(6,500,-8.80052);
   gre->SetPointError(6,0,0.02837926);
   gre->SetPoint(7,700,-9.01336);
   gre->SetPointError(7,0,0.06490374);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-9.36497);
   Graph_Graph44->SetMaximum(-5.924496);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(63.469);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001915562);
   linear_fit->SetParError(0,2.948633e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.847787);
   linear_fit->SetParError(1,0.01398032);
