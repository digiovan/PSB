...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-14.16471,1050,13.67056);
   ...
   gre->SetPoint(0,-700,-4.68872);
   gre->SetPointError(0,0,0.3423796);
   gre->SetPoint(1,-500,-8.85866);
   gre->SetPointError(1,0,0.1170993);
   gre->SetPoint(2,-300,-9.1056);
   gre->SetPointError(2,0,0.4198941);
   gre->SetPoint(3,-100,-7.54898);
   gre->SetPointError(3,0,0.4090189);
   gre->SetPoint(4,100,-5.59538);
   gre->SetPointError(4,0,0.3157984);
   gre->SetPoint(5,300,-1.20214);
   gre->SetPointError(5,0,0.02349409);
   gre->SetPoint(6,500,4.68096);
   gre->SetPointError(6,0,0.209772);
   gre->SetPoint(7,700,8.93736);
   gre->SetPointError(7,0,0.09399233);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-11.38118);
   Graph_Graph56->SetMaximum(10.88704);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3979.136);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01319166);
   linear_fit->SetParError(0,0.0001137229);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.723555);
   linear_fit->SetParError(1,0.03948998);
