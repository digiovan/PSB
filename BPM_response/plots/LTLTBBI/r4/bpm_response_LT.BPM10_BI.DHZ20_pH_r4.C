...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.673007,1050,1.827766);
   ...
   gre->SetPoint(0,-700,1.7685);
   gre->SetPointError(0,0,0.01815429);
   gre->SetPoint(1,-500,1.78504);
   gre->SetPointError(1,0,0.01693265);
   gre->SetPoint(2,-300,1.7505);
   gre->SetPointError(2,0,0.01475277);
   gre->SetPoint(3,-100,1.74684);
   gre->SetPointError(3,0,0.02279202);
   gre->SetPoint(4,100,1.7283);
   gre->SetPointError(4,0,0.01469314);
   gre->SetPoint(5,300,1.77394);
   gre->SetPointError(5,0,0.01809467);
   gre->SetPoint(6,500,1.7664);
   gre->SetPointError(6,0,0.009345896);
   gre->SetPoint(7,700,1.7175);
   gre->SetPointError(7,0,0.01870022);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.688482);
   Graph_Graph43->SetMaximum(1.81229);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.6655);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.217023e-05);
   linear_fit->SetParError(0,1.195887e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.75818);
   linear_fit->SetParError(1,0.005487111);
