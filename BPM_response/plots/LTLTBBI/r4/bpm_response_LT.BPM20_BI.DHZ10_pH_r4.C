...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-7.732273,1050,-7.317087);
   ...
   gre->SetPoint(0,-700,-7.56366);
   gre->SetPointError(0,0,0.01076905);
   gre->SetPoint(1,-500,-7.53102);
   gre->SetPointError(1,0,0.03560624);
   gre->SetPoint(2,-300,-7.52468);
   gre->SetPointError(2,0,0.1383952);
   gre->SetPoint(3,-100,-7.49936);
   gre->SetPointError(3,0,0.02846315);
   gre->SetPoint(4,100,-7.62766);
   gre->SetPointError(4,0,0.01807155);
   gre->SetPoint(5,300,-7.4339);
   gre->SetPointError(5,0,0.03278561);
   gre->SetPoint(6,500,-7.57138);
   gre->SetPointError(6,0,0.04358347);
   gre->SetPoint(7,700,-7.47996);
   gre->SetPointError(7,0,0.04495797);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.690754);
   Graph_Graph44->SetMaximum(-7.358606);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(36.7416);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.483865e-05);
   linear_fit->SetParError(0,1.79917e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.554177);
   linear_fit->SetParError(1,0.01007597);
