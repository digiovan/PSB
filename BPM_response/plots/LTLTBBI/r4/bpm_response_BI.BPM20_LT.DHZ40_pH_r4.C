...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,5.284494,1050,9.317411);
   ...
   gre->SetPoint(0,-700,8.2385);
   gre->SetPointError(0,0,0.03726579);
   gre->SetPoint(1,-500,8.62772);
   gre->SetPointError(1,0,0.01753775);
   gre->SetPoint(2,-300,8.32866);
   gre->SetPointError(2,0,0.02250635);
   gre->SetPoint(3,-100,8.55644);
   gre->SetPointError(3,0,0.02740621);
   gre->SetPoint(4,100,8.5468);
   gre->SetPointError(4,0,0.02127324);
   gre->SetPoint(5,300,8.3305);
   gre->SetPointError(5,0,0.04225676);
   gre->SetPoint(6,500,6.8604);
   gre->SetPointError(6,0,0.9037532);
   gre->SetPoint(7,700,8.38208);
   gre->SetPointError(7,0,0.05070348);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(5.687786);
   Graph_Graph53->SetMaximum(8.914119);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(191.4881);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.225094e-05);
   linear_fit->SetParError(0,2.937157e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.483883);
   linear_fit->SetParError(1,0.01157196);
