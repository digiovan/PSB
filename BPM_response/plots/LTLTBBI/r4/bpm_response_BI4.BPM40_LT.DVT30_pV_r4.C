...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-14.0349,1050,21.0529);
   ...
   gre->SetPoint(0,-700,-4.67638);
   gre->SetPointError(0,0,0.2856419);
   gre->SetPoint(1,-500,-8.05064);
   gre->SetPointError(1,0,0.1362964);
   gre->SetPoint(2,-300,-7.0989);
   gre->SetPointError(2,0,0.4275386);
   gre->SetPoint(3,-100,-4.1868);
   gre->SetPointError(3,0,0.3704101);
   gre->SetPoint(4,100,-1.42588);
   gre->SetPointError(4,0,0.225524);
   gre->SetPoint(5,300,4.04052);
   gre->SetPointError(5,0,0.02204792);
   gre->SetPoint(6,500,10.88994);
   gre->SetPointError(6,0,0.1493536);
   gre->SetPoint(7,700,15.14006);
   gre->SetPointError(7,0,0.06487083);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-10.52612);
   Graph_Graph55->SetMaximum(17.54412);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4498.313);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01998184);
   linear_fit->SetParError(0,0.0001055066);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.466808);
   linear_fit->SetParError(1,0.03899279);
