...
//=========  (Wed Apr  1 22:35:27 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,2.132267,1050,3.552329);
   ...
   gre->SetPoint(0,-700,2.60948);
   gre->SetPointError(0,0,0.09331716);
   gre->SetPoint(1,-500,2.69834);
   gre->SetPointError(1,0,0.03630503);
   gre->SetPoint(2,-300,3.16808);
   gre->SetPointError(2,0,0.1475717);
   gre->SetPoint(3,-100,2.66782);
   gre->SetPointError(3,0,0.1276952);
   gre->SetPoint(4,100,2.58722);
   gre->SetPointError(4,0,0.2182764);
   gre->SetPoint(5,300,2.81968);
   gre->SetPointError(5,0,0.1245048);
   gre->SetPoint(6,500,2.86426);
   gre->SetPointError(6,0,0.09291066);
   gre->SetPoint(7,700,2.73474);
   gre->SetPointError(7,0,0.142795);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(2.274273);
   Graph_Graph48->SetMaximum(3.410323);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.51142);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001220979);
   linear_fit->SetParError(0,7.054703e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.763868);
   linear_fit->SetParError(1,0.03538258);
