...
//=========  (Wed Apr  1 22:34:24 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,7.005625,1050,8.689473);
   ...
   gre->SetPoint(0,-700,7.3134);
   gre->SetPointError(0,0,0.02713351);
   gre->SetPoint(1,-500,7.59592);
   gre->SetPointError(1,0,0.0624997);
   gre->SetPoint(2,-300,7.81032);
   gre->SetPointError(2,0,0.02315792);
   gre->SetPoint(3,-100,7.73886);
   gre->SetPointError(3,0,0.03091327);
   gre->SetPoint(4,100,7.82596);
   gre->SetPointError(4,0,0.0371645);
   gre->SetPoint(5,300,8.24738);
   gre->SetPointError(5,0,0.02778757);
   gre->SetPoint(6,500,8.37846);
   gre->SetPointError(6,0,0.03037158);
   gre->SetPoint(7,700,7.66252);
   gre->SetPointError(7,0,0.02373152);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(7.17401);
   Graph_Graph54->SetMaximum(8.521088);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(691.9393);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003708788);
   linear_fit->SetParError(0,2.158765e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.803901);
   linear_fit->SetParError(1,0.01037638);
