...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_4->Range(-1050,-7.051063,1050,-6.718189);
   ...
   gre->SetPoint(0,-700,-6.9011);
   gre->SetPointError(0,0,0.06590006);
   gre->SetPoint(1,-500,-6.88268);
   gre->SetPointError(1,0,0.07584227);
   gre->SetPoint(2,-300,-6.80348);
   gre->SetPointError(2,0,0.02981169);
   gre->SetPoint(3,-100,-6.88162);
   gre->SetPointError(3,0,0.01609305);
   gre->SetPoint(4,100,-6.93828);
   gre->SetPointError(4,0,0.04657607);
   gre->SetPoint(5,300,-6.85048);
   gre->SetPointError(5,0,0.02419327);
   gre->SetPoint(6,500,-6.91566);
   gre->SetPointError(6,0,0.04270554);
   gre->SetPoint(7,700,-6.89638);
   gre->SetPointError(7,0,0.09920434);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.017776);
   Graph_Graph44->SetMaximum(-6.751477);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.172274);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.03233e-05);
   linear_fit->SetParError(0,3.950216e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.870887);
   linear_fit->SetParError(1,0.01104132);
