...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-0.480029,1050,-0.2263817);
   ...
   gre->SetPoint(0,-700,-0.3837);
   gre->SetPointError(0,0,0.05405442);
   gre->SetPoint(1,-500,-0.3357);
   gre->SetPointError(1,0,0.02884025);
   gre->SetPoint(2,-300,-0.38156);
   gre->SetPointError(2,0,0.01891582);
   gre->SetPoint(3,-100,-0.29616);
   gre->SetPointError(3,0,0.02368697);
   gre->SetPoint(4,100,-0.3234);
   gre->SetPointError(4,0,0.05474376);
   gre->SetPoint(5,300,-0.37376);
   gre->SetPointError(5,0,0.006664022);
   gre->SetPoint(6,500,-0.34316);
   gre->SetPointError(6,0,0.01648471);
   gre->SetPoint(7,700,-0.29826);
   gre->SetPointError(7,0,0.02513793);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-0.4546642);
   Graph_Graph47->SetMaximum(-0.2517464);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.9834);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.543667e-06);
   linear_fit->SetParError(0,1.942696e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.363586);
   linear_fit->SetParError(1,0.007014196);
