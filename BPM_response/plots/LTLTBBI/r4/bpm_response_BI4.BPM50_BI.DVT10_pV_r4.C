...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-14.19799,1050,-3.441142);
   ...
   gre->SetPoint(0,-700,-11.23648);
   gre->SetPointError(0,0,1.168701);
   gre->SetPoint(1,-500,-9.32274);
   gre->SetPointError(1,0,0.57036);
   gre->SetPoint(2,-300,-9.7898);
   gre->SetPointError(2,0,1.409014);
   gre->SetPoint(3,-100,-9.38408);
   gre->SetPointError(3,0,0.6617928);
   gre->SetPoint(4,100,-7.7256);
   gre->SetPointError(4,0,0.2109374);
   gre->SetPoint(5,300,-8.69134);
   gre->SetPointError(5,0,0.3074727);
   gre->SetPoint(6,500,-7.53104);
   gre->SetPointError(6,0,1.205083);
   gre->SetPoint(7,700,-5.63474);
   gre->SetPointError(7,0,0.4007899);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-13.1223);
   Graph_Graph56->SetMaximum(-4.516827);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.74897);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002916097);
   linear_fit->SetParError(0,0.0004809404);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.40876);
   linear_fit->SetParError(1,0.1667161);
