...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-1.547135,1050,0.7558639);
   ...
   gre->SetPoint(0,-700,-1.14768);
   gre->SetPointError(0,0,0.01562157);
   gre->SetPoint(1,-500,-1.0067);
   gre->SetPointError(1,0,0.005301718);
   gre->SetPoint(2,-300,-0.711);
   gre->SetPointError(2,0,0.007546147);
   gre->SetPoint(3,-100,-0.55612);
   gre->SetPointError(3,0,0.003515513);
   gre->SetPoint(4,100,-0.37356);
   gre->SetPointError(4,0,0.01037528);
   gre->SetPoint(5,300,-0.09294);
   gre->SetPointError(5,0,0.02916741);
   gre->SetPoint(6,500,0.05504);
   gre->SetPointError(6,0,0.01889125);
   gre->SetPoint(7,700,0.36466);
   gre->SetPointError(7,0,0.007370788);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-1.316835);
   Graph_Graph46->SetMaximum(0.525564);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(135.6224);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001110605);
   linear_fit->SetParError(0,6.867081e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4370725);
   linear_fit->SetParError(1,0.002538708);
