...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-6.343511,1050,-5.936566);
   ...
   gre->SetPoint(0,-700,-6.09374);
   gre->SetPointError(0,0,0.03961292);
   gre->SetPoint(1,-500,-6.0661);
   gre->SetPointError(1,0,0.06170995);
   gre->SetPoint(2,-300,-6.13308);
   gre->SetPointError(2,0,0.02843266);
   gre->SetPoint(3,-100,-6.18892);
   gre->SetPointError(3,0,0.04220546);
   gre->SetPoint(4,100,-6.23564);
   gre->SetPointError(4,0,0.03347048);
   gre->SetPoint(5,300,-6.13754);
   gre->SetPointError(5,0,0.04912353);
   gre->SetPoint(6,500,-6.0817);
   gre->SetPointError(6,0,0.02410474);
   gre->SetPoint(7,700,-6.2378);
   gre->SetPointError(7,0,0.0378866);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-6.302816);
   Graph_Graph51->SetMaximum(-5.97726);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.89081);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.688651e-05);
   linear_fit->SetParError(0,2.812295e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.141119);
   linear_fit->SetParError(1,0.01271382);
