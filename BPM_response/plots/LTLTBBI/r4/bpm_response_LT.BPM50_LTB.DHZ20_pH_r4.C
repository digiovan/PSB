...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-1.840818,1050,-1.718133);
   ...
   gre->SetPoint(0,-700,-1.78254);
   gre->SetPointError(0,0,0.006185416);
   gre->SetPoint(1,-500,-1.80484);
   gre->SetPointError(1,0,0.00859095);
   gre->SetPoint(2,-300,-1.81462);
   gre->SetPointError(2,0,0.005750239);
   gre->SetPoint(3,-100,-1.79398);
   gre->SetPointError(3,0,0.007482858);
   gre->SetPoint(4,100,-1.7542);
   gre->SetPointError(4,0,0.01561969);
   gre->SetPoint(5,300,-1.8067);
   gre->SetPointError(5,0,0.007691268);
   gre->SetPoint(6,500,-1.79572);
   gre->SetPointError(6,0,0.005940423);
   gre->SetPoint(7,700,-1.79876);
   gre->SetPointError(7,0,0.01891908);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.828549);
   Graph_Graph47->SetMaximum(-1.730401);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.513);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.283248e-06);
   linear_fit->SetParError(0,6.014434e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.798511);
   linear_fit->SetParError(1,0.00274332);
