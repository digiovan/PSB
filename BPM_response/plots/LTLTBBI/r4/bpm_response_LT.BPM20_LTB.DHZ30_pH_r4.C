...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-7.720087,1050,-7.286485);
   ...
   gre->SetPoint(0,-700,-7.53406);
   gre->SetPointError(0,0,0.02980691);
   gre->SetPoint(1,-500,-7.54442);
   gre->SetPointError(1,0,0.01873528);
   gre->SetPoint(2,-300,-7.3797);
   gre->SetPointError(2,0,0.02094834);
   gre->SetPoint(3,-100,-7.55292);
   gre->SetPointError(3,0,0.05024288);
   gre->SetPoint(4,100,-7.5817);
   gre->SetPointError(4,0,0.06612012);
   gre->SetPoint(5,300,-7.51902);
   gre->SetPointError(5,0,0.03235278);
   gre->SetPoint(6,500,-7.47136);
   gre->SetPointError(6,0,0.04846253);
   gre->SetPoint(7,700,-7.52278);
   gre->SetPointError(7,0,0.07089243);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.676727);
   Graph_Graph44->SetMaximum(-7.329845);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(42.52812);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.859714e-05);
   linear_fit->SetParError(0,2.944119e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.488014);
   linear_fit->SetParError(1,0.01344898);
