...
//=========  (Wed Apr  1 22:34:14 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-2.344139,1050,-1.058107);
   ...
   gre->SetPoint(0,-700,-2.12036);
   gre->SetPointError(0,0,0.009440669);
   gre->SetPoint(1,-500,-1.78426);
   gre->SetPointError(1,0,0.005950676);
   gre->SetPoint(2,-300,-1.70206);
   gre->SetPointError(2,0,0.01012171);
   gre->SetPoint(3,-100,-1.76022);
   gre->SetPointError(3,0,0.03810823);
   gre->SetPoint(4,100,-1.6816);
   gre->SetPointError(4,0,0.01127137);
   gre->SetPoint(5,300,-1.29174);
   gre->SetPointError(5,0,0.01929444);
   gre->SetPoint(6,500,-1.31022);
   gre->SetPointError(6,0,0.01856601);
   gre->SetPoint(7,700,-1.32224);
   gre->SetPointError(7,0,0.03180899);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-2.215536);
   Graph_Graph47->SetMaximum(-1.18671);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(684.1995);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0005292325);
   linear_fit->SetParError(0,1.120417e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.593922);
   linear_fit->SetParError(1,0.005404319);
