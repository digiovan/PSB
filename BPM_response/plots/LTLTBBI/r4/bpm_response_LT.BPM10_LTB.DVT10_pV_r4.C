...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.189848,1050,1.358522);
   ...
   gre->SetPoint(0,-700,1.25334);
   gre->SetPointError(0,0,0.00698284);
   gre->SetPoint(1,-500,1.2798);
   gre->SetPointError(1,0,0.009925024);
   gre->SetPoint(2,-300,1.27902);
   gre->SetPointError(2,0,0.01377861);
   gre->SetPoint(3,-100,1.23072);
   gre->SetPointError(3,0,0.01275928);
   gre->SetPoint(4,100,1.27834);
   gre->SetPointError(4,0,0.03238475);
   gre->SetPoint(5,300,1.28758);
   gre->SetPointError(5,0,0.007240132);
   gre->SetPoint(6,500,1.29438);
   gre->SetPointError(6,0,0.0360299);
   gre->SetPoint(7,700,1.29638);
   gre->SetPointError(7,0,0.01592975);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.206716);
   Graph_Graph43->SetMaximum(1.341655);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.36038);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.666576e-05);
   linear_fit->SetParError(0,8.283972e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.275505);
   linear_fit->SetParError(1,0.004175296);
