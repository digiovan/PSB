...
//=========  (Wed Apr  1 22:35:06 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,1.18666,1050,14.98119);
   ...
   gre->SetPoint(0,-700,12.61396);
   gre->SetPointError(0,0,0.06814582);
   gre->SetPoint(1,-500,11.1478);
   gre->SetPointError(1,0,0.04509607);
   gre->SetPoint(2,-300,9.79734);
   gre->SetPointError(2,0,0.04968307);
   gre->SetPoint(3,-100,8.33544);
   gre->SetPointError(3,0,0.02416435);
   gre->SetPoint(4,100,7.04352);
   gre->SetPointError(4,0,0.05805883);
   gre->SetPoint(5,300,5.93754);
   gre->SetPointError(5,0,0.1128122);
   gre->SetPoint(6,500,4.81792);
   gre->SetPointError(6,0,0.07856632);
   gre->SetPoint(7,700,3.54788);
   gre->SetPointError(7,0,0.06213047);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(2.566114);
   Graph_Graph54->SetMaximum(13.60174);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(79.76955);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006435593);
   linear_fit->SetParError(0,4.874166e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.813216);
   linear_fit->SetParError(1,0.01736321);
