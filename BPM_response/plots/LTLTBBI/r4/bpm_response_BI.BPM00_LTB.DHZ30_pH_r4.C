...
//=========  (Wed Apr  1 22:35:27 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-19.64421,1050,5.344568);
   ...
   gre->SetPoint(0,-700,-15.36388);
   gre->SetPointError(0,0,0.1155304);
   gre->SetPoint(1,-500,-12.79268);
   gre->SetPointError(1,0,0.08001995);
   gre->SetPoint(2,-300,-10.4399);
   gre->SetPointError(2,0,0.1586336);
   gre->SetPoint(3,-100,-7.71774);
   gre->SetPointError(3,0,0.04536939);
   gre->SetPoint(4,100,-5.37412);
   gre->SetPointError(4,0,0.1282108);
   gre->SetPoint(5,300,-3.3531);
   gre->SetPointError(5,0,0.1651596);
   gre->SetPoint(6,500,-1.42396);
   gre->SetPointError(6,0,0.1003789);
   gre->SetPoint(7,700,1.04394);
   gre->SetPointError(7,0,0.1358322);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-17.14533);
   Graph_Graph51->SetMaximum(2.84569);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(76.35107);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01159024);
   linear_fit->SetParError(0,8.701927e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.794967);
   linear_fit->SetParError(1,0.03237487);
