...
//=========  (Wed Apr  1 22:34:35 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-14.13891,1050,6.670406);
   ...
   gre->SetPoint(0,-700,3.14778);
   gre->SetPointError(0,0,0.0544056);
   gre->SetPoint(1,-500,1.19224);
   gre->SetPointError(1,0,0.0423492);
   gre->SetPoint(2,-300,-1.57122);
   gre->SetPointError(2,0,0.3842848);
   gre->SetPoint(3,-100,-3.18938);
   gre->SetPointError(3,0,0.1179952);
   gre->SetPoint(4,100,-5.61742);
   gre->SetPointError(4,0,0.02099879);
   gre->SetPoint(5,300,-7.00696);
   gre->SetPointError(5,0,0.0521134);
   gre->SetPoint(6,500,-8.87488);
   gre->SetPointError(6,0,0.08563088);
   gre->SetPoint(7,700,-10.58444);
   gre->SetPointError(7,0,0.0862539);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-12.05798);
   Graph_Graph52->SetMaximum(4.589474);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(482.0526);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01040452);
   linear_fit->SetParError(0,4.653028e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.309288);
   linear_fit->SetParError(1,0.01605504);
