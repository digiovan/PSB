...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-1.811202,1050,-1.686227);
   ...
   gre->SetPoint(0,-700,-1.74842);
   gre->SetPointError(0,0,0.02918377);
   gre->SetPoint(1,-500,-1.73068);
   gre->SetPointError(1,0,0.02362388);
   gre->SetPoint(2,-300,-1.75696);
   gre->SetPointError(2,0,0.03341315);
   gre->SetPoint(3,-100,-1.74172);
   gre->SetPointError(3,0,0.01182045);
   gre->SetPoint(4,100,-1.75178);
   gre->SetPointError(4,0,0.03015963);
   gre->SetPoint(5,300,-1.73914);
   gre->SetPointError(5,0,0.008583586);
   gre->SetPoint(6,500,-1.74662);
   gre->SetPointError(6,0,0.01027362);
   gre->SetPoint(7,700,-1.77008);
   gre->SetPointError(7,0,0.005496706);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.798705);
   Graph_Graph47->SetMaximum(-1.698724);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.052285);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.075802e-05);
   linear_fit->SetParError(0,1.094676e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.742585);
   linear_fit->SetParError(1,0.006070796);
