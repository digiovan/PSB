...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,-9.580688,1050,15.48579);
   ...
   gre->SetPoint(0,-700,-5.34812);
   gre->SetPointError(0,0,0.05482161);
   gre->SetPoint(1,-500,-2.69818);
   gre->SetPointError(1,0,0.1642818);
   gre->SetPoint(2,-300,-0.21126);
   gre->SetPointError(2,0,0.03355299);
   gre->SetPoint(3,-100,2.2026);
   gre->SetPointError(3,0,0.0156283);
   gre->SetPoint(4,100,4.3084);
   gre->SetPointError(4,0,0.03780028);
   gre->SetPoint(5,300,6.61004);
   gre->SetPointError(5,0,0.02049572);
   gre->SetPoint(6,500,8.75656);
   gre->SetPointError(6,0,0.05974421);
   gre->SetPoint(7,700,11.0847);
   gre->SetPointError(7,0,0.2233413);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-7.07404);
   Graph_Graph50->SetMaximum(12.97914);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(184.9609);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01147428);
   linear_fit->SetParError(0,4.102067e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.235097);
   linear_fit->SetParError(1,0.01070103);
