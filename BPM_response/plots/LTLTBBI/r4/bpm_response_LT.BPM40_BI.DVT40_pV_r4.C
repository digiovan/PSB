...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_4->Range(-1050,-8.236223,1050,-7.259517);
   ...
   gre->SetPoint(0,-700,-7.94242);
   gre->SetPointError(0,0,0.07945924);
   gre->SetPoint(1,-500,-7.92702);
   gre->SetPointError(1,0,0.03189991);
   gre->SetPoint(2,-300,-7.54426);
   gre->SetPointError(2,0,0.06613328);
   gre->SetPoint(3,-100,-8.03748);
   gre->SetPointError(3,0,0.01513261);
   gre->SetPoint(4,100,-7.98226);
   gre->SetPointError(4,0,0.03778005);
   gre->SetPoint(5,300,-7.54578);
   gre->SetPointError(5,0,0.123479);
   gre->SetPoint(6,500,-7.93016);
   gre->SetPointError(6,0,0.02752549);
   gre->SetPoint(7,700,-7.9269);
   gre->SetPointError(7,0,0.1465388);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-8.138553);
   Graph_Graph46->SetMaximum(-7.357187);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(76.51308);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.094253e-05);
   linear_fit->SetParError(0,3.676614e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.979321);
   linear_fit->SetParError(1,0.01137479);
