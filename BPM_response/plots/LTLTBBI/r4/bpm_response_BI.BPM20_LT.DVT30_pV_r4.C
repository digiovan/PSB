...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-10.88478,1050,7.881884);
   ...
   gre->SetPoint(0,-700,4.68596);
   gre->SetPointError(0,0,0.06814622);
   gre->SetPoint(1,-500,2.69574);
   gre->SetPointError(1,0,0.03452678);
   gre->SetPoint(2,-300,1.21892);
   gre->SetPointError(2,0,0.05167375);
   gre->SetPoint(3,-100,-0.57754);
   gre->SetPointError(3,0,0.04924809);
   gre->SetPoint(4,100,-2.17018);
   gre->SetPointError(4,0,0.04554023);
   gre->SetPoint(5,300,-3.91866);
   gre->SetPointError(5,0,0.02929767);
   gre->SetPoint(6,500,-5.93388);
   gre->SetPointError(6,0,0.09489073);
   gre->SetPoint(7,700,-7.67774);
   gre->SetPointError(7,0,0.07926586);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-9.008117);
   Graph_Graph53->SetMaximum(6.005217);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(53.90007);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008506887);
   linear_fit->SetParError(0,4.219185e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.425398);
   linear_fit->SetParError(1,0.01640909);
