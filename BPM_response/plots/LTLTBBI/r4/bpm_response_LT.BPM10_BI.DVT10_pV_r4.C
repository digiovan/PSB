...
//=========  (Wed Apr  1 22:35:52 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.091523,1050,1.330467);
   ...
   gre->SetPoint(0,-700,1.21682);
   gre->SetPointError(0,0,0.02062888);
   gre->SetPoint(1,-500,1.25914);
   gre->SetPointError(1,0,0.01472968);
   gre->SetPoint(2,-300,1.21192);
   gre->SetPointError(2,0,0.03290023);
   gre->SetPoint(3,-100,1.22528);
   gre->SetPointError(3,0,0.03505129);
   gre->SetPoint(4,100,1.24752);
   gre->SetPointError(4,0,0.04312342);
   gre->SetPoint(5,300,1.27128);
   gre->SetPointError(5,0,0.0173055);
   gre->SetPoint(6,500,1.23644);
   gre->SetPointError(6,0,0.01924264);
   gre->SetPoint(7,700,1.15848);
   gre->SetPointError(7,0,0.02713258);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.115418);
   Graph_Graph43->SetMaximum(1.306573);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.60938);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.216333e-05);
   linear_fit->SetParError(0,1.583663e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.23834);
   linear_fit->SetParError(1,0.007806608);
