...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,-3.321991,1050,8.411428);
   ...
   gre->SetPoint(0,-700,-1.30976);
   gre->SetPointError(0,0,0.05666101);
   gre->SetPoint(1,-500,0.01996);
   gre->SetPointError(1,0,0.1163122);
   gre->SetPoint(2,-300,0.96328);
   gre->SetPointError(2,0,0.08143031);
   gre->SetPoint(3,-100,2.27054);
   gre->SetPointError(3,0,0.09332655);
   gre->SetPoint(4,100,3.23904);
   gre->SetPointError(4,0,0.1524895);
   gre->SetPoint(5,300,4.1634);
   gre->SetPointError(5,0,0.03539048);
   gre->SetPoint(6,500,5.22224);
   gre->SetPointError(6,0,0.01958436);
   gre->SetPoint(7,700,6.43406);
   gre->SetPointError(7,0,0.02179811);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(-2.148649);
   Graph_Graph49->SetMaximum(7.238086);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.09903);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00546379);
   linear_fit->SetParError(0,3.631251e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.549616);
   linear_fit->SetParError(1,0.02031153);
