...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,4.042972,1050,9.939871);
   ...
   gre->SetPoint(0,-700,8.62098);
   gre->SetPointError(0,0,0.05469934);
   gre->SetPoint(1,-500,8.94014);
   gre->SetPointError(1,0,0.01691446);
   gre->SetPoint(2,-300,8.21532);
   gre->SetPointError(2,0,0.0365105);
   gre->SetPoint(3,-100,8.20892);
   gre->SetPointError(3,0,0.02742583);
   gre->SetPoint(4,100,7.91238);
   gre->SetPointError(4,0,0.02124973);
   gre->SetPoint(5,300,7.3021);
   gre->SetPointError(5,0,0.01267583);
   gre->SetPoint(6,500,5.7748);
   gre->SetPointError(6,0,0.7490118);
   gre->SetPoint(7,700,6.57558);
   gre->SetPointError(7,0,0.03936655);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(4.632662);
   Graph_Graph54->SetMaximum(9.350181);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(309.3433);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001892112);
   linear_fit->SetParError(0,2.227949e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.923544);
   linear_fit->SetParError(1,0.008171952);
