...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-0.3948006,1050,-0.2457218);
   ...
   gre->SetPoint(0,-700,-0.34046);
   gre->SetPointError(0,0,0.02949414);
   gre->SetPoint(1,-500,-0.30384);
   gre->SetPointError(1,0,0.01133196);
   gre->SetPoint(2,-300,-0.32464);
   gre->SetPointError(2,0,0.02807183);
   gre->SetPoint(3,-100,-0.3434);
   gre->SetPointError(3,0,0.008847303);
   gre->SetPoint(4,100,-0.30544);
   gre->SetPointError(4,0,0.03487174);
   gre->SetPoint(5,300,-0.32854);
   gre->SetPointError(5,0,0.01333681);
   gre->SetPoint(6,500,-0.3157);
   gre->SetPointError(6,0,0.007905637);
   gre->SetPoint(7,700,-0.34492);
   gre->SetPointError(7,0,0.008897726);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-0.3798927);
   Graph_Graph47->SetMaximum(-0.2606297);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.07083);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.027433e-05);
   linear_fit->SetParError(0,9.591862e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3261769);
   linear_fit->SetParError(1,0.004617709);
