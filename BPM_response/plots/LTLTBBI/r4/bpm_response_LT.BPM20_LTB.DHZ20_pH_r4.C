...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-7.731712,1050,-7.304368);
   ...
   gre->SetPoint(0,-700,-7.50758);
   gre->SetPointError(0,0,0.0458807);
   gre->SetPoint(1,-500,-7.49032);
   gre->SetPointError(1,0,0.0568625);
   gre->SetPoint(2,-300,-7.47184);
   gre->SetPointError(2,0,0.02544442);
   gre->SetPoint(3,-100,-7.5983);
   gre->SetPointError(3,0,0.02520476);
   gre->SetPoint(4,100,-7.59866);
   gre->SetPointError(4,0,0.061828);
   gre->SetPoint(5,300,-7.42552);
   gre->SetPointError(5,0,0.04992761);
   gre->SetPoint(6,500,-7.5069);
   gre->SetPointError(6,0,0.03178546);
   gre->SetPoint(7,700,-7.51026);
   gre->SetPointError(7,0,0.0554041);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.688978);
   Graph_Graph44->SetMaximum(-7.347103);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.97866);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.844255e-07);
   linear_fit->SetParError(0,3.331533e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.520087);
   linear_fit->SetParError(1,0.01310933);
