...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-13.06026,1050,10.54762);
   ...
   gre->SetPoint(0,-700,-9.01704);
   gre->SetPointError(0,0,0.1085712);
   gre->SetPoint(1,-500,-6.57368);
   gre->SetPointError(1,0,0.1062552);
   gre->SetPoint(2,-300,-4.39764);
   gre->SetPointError(2,0,0.03249611);
   gre->SetPoint(3,-100,-2.29448);
   gre->SetPointError(3,0,0.05808582);
   gre->SetPoint(4,100,-0.09848);
   gre->SetPointError(4,0,0.03418921);
   gre->SetPoint(5,300,1.95724);
   gre->SetPointError(5,0,0.07377306);
   gre->SetPoint(6,500,4.29368);
   gre->SetPointError(6,0,0.05716861);
   gre->SetPoint(7,700,6.59708);
   gre->SetPointError(7,0,0.01589589);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-10.69947);
   Graph_Graph53->SetMaximum(8.186835);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.08357);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01104546);
   linear_fit->SetParError(0,2.948418e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.149868);
   linear_fit->SetParError(1,0.01684258);
