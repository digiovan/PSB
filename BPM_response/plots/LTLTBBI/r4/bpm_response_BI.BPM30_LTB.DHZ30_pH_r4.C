...
//=========  (Wed Apr  1 22:35:27 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,-2.10866,1050,18.97794);
   ...
   gre->SetPoint(0,-700,15.35488);
   gre->SetPointError(0,0,0.05358151);
   gre->SetPoint(1,-500,13.06268);
   gre->SetPointError(1,0,0.08080816);
   gre->SetPoint(2,-300,10.79116);
   gre->SetPointError(2,0,0.07634073);
   gre->SetPoint(3,-100,8.709);
   gre->SetPointError(3,0,0.04358712);
   gre->SetPoint(4,100,6.68216);
   gre->SetPointError(4,0,0.03475482);
   gre->SetPoint(5,300,4.70916);
   gre->SetPointError(5,0,0.1081263);
   gre->SetPoint(6,500,2.9461);
   gre->SetPointError(6,0,0.07049679);
   gre->SetPoint(7,700,0.86642);
   gre->SetPointError(7,0,0.06610159);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(0);
   Graph_Graph54->SetMaximum(16.86928);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(89.42542);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01032988);
   linear_fit->SetParError(0,4.957493e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.841343);
   linear_fit->SetParError(1,0.0198598);
