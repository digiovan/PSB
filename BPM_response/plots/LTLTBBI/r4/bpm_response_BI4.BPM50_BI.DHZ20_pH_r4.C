...
//=========  (Wed Apr  1 22:35:59 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_H_4->Range(-1050,-18.87279,1050,-9.01138);
   ...
   gre->SetPoint(0,-700,-14.78814);
   gre->SetPointError(0,0,1.419005);
   gre->SetPoint(1,-500,-15.39708);
   gre->SetPointError(1,0,0.5561273);
   gre->SetPoint(2,-300,-15.54348);
   gre->SetPointError(2,0,1.18677);
   gre->SetPoint(3,-100,-16.26418);
   gre->SetPointError(3,0,0.9650433);
   gre->SetPoint(4,100,-15.7919);
   gre->SetPointError(4,0,0.9305766);
   gre->SetPoint(5,300,-14.916);
   gre->SetPointError(5,0,0.6615716);
   gre->SetPoint(6,500,-14.06154);
   gre->SetPointError(6,0,0.4356023);
   gre->SetPoint(7,700,-11.56006);
   gre->SetPointError(7,0,0.9051111);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-17.88665);
   Graph_Graph56->SetMaximum(-9.997521);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.29652);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001828749);
   linear_fit->SetParError(0,0.0005774787);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-14.88136);
   linear_fit->SetParError(1,0.2652818);
