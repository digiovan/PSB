...
//=========  (Wed Apr  1 22:34:25 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_H_4->Range(-1050,-8.862533,1050,9.777276);
   ...
   gre->SetPoint(0,-700,-4.65078);
   gre->SetPointError(0,0,1.105118);
   gre->SetPoint(1,-500,0.74688);
   gre->SetPointError(1,0,0.4147251);
   gre->SetPoint(2,-300,2.07896);
   gre->SetPointError(2,0,0.6234983);
   gre->SetPoint(3,-100,1.00528);
   gre->SetPointError(3,0,0.07920048);
   gre->SetPoint(4,100,1.36532);
   gre->SetPointError(4,0,0.6123455);
   gre->SetPoint(5,300,0.8145);
   gre->SetPointError(5,0,0.6843961);
   gre->SetPoint(6,500,3.21578);
   gre->SetPointError(6,0,0.4614941);
   gre->SetPoint(7,700,6.50094);
   gre->SetPointError(7,0,0.1697008);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-6.998552);
   Graph_Graph56->SetMaximum(7.913295);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(81.46352);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006185297);
   linear_fit->SetParError(0,0.0002140149);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.723262);
   linear_fit->SetParError(1,0.06894265);
