...
//=========  (Wed Apr  1 22:34:19 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,0.8090727,1050,1.981623);
   ...
   gre->SetPointError(0,0,0.03839804);
   gre->SetPoint(1,-500,1.41842);
   gre->SetPointError(1,0,0.02095893);
   gre->SetPoint(2,-300,1.39148);
   gre->SetPointError(2,0,0.08792019);
   gre->SetPoint(3,-100,1.40172);
   gre->SetPointError(3,0,0.04245457);
   gre->SetPoint(4,100,1.2682);
   gre->SetPointError(4,0,0.02234596);
   gre->SetPoint(5,300,1.21666);
   gre->SetPointError(5,0,0.02464822);
   gre->SetPoint(6,500,1.05992);
   gre->SetPointError(6,0,0.05542224);
   gre->SetPoint(7,700,1.301);
   gre->SetPointError(7,0,0.007232541);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(0.9263277);
   Graph_Graph48->SetMaximum(1.864368);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(122.0346);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001306122);
   linear_fit->SetParError(0,1.464802e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.375511);
   linear_fit->SetParError(1,0.009196167);
