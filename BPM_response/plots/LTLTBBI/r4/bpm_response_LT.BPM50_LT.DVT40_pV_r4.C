...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-17.39667,1050,17.81132);
   ...
   gre->SetPoint(0,-700,-11.5103);
   gre->SetPointError(0,0,0.01837385);
   gre->SetPoint(1,-500,-8.1289);
   gre->SetPointError(1,0,0.0151703);
   gre->SetPoint(2,-300,-4.60586);
   gre->SetPointError(2,0,0.02700507);
   gre->SetPoint(3,-100,-1.30216);
   gre->SetPointError(3,0,0.043383);
   gre->SetPoint(4,100,1.78542);
   gre->SetPointError(4,0,0.0181402);
   gre->SetPoint(5,300,4.91494);
   gre->SetPointError(5,0,0.02298295);
   gre->SetPoint(6,500,8.35662);
   gre->SetPointError(6,0,0.00943353);
   gre->SetPoint(7,700,11.91286);
   gre->SetPointError(7,0,0.03046042);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-13.87587);
   Graph_Graph47->SetMaximum(14.29052);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(226.221);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0165132);
   linear_fit->SetParError(0,1.295118e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.1210043);
   linear_fit->SetParError(1,0.006271885);
