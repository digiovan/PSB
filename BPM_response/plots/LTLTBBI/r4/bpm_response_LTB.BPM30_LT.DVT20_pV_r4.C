...
//=========  (Wed Apr  1 22:34:29 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,-4.270272,1050,9.326791);
   ...
   gre->SetPoint(0,-700,6.95026);
   gre->SetPointError(0,0,0.1103541);
   gre->SetPoint(1,-500,6.30444);
   gre->SetPointError(1,0,0.1379425);
   gre->SetPoint(2,-300,4.90956);
   gre->SetPointError(2,0,0.04894059);
   gre->SetPoint(3,-100,3.5701);
   gre->SetPointError(3,0,0.1397284);
   gre->SetPoint(4,100,2.27098);
   gre->SetPointError(4,0,0.1627454);
   gre->SetPoint(5,300,0.9346);
   gre->SetPointError(5,0,0.05064073);
   gre->SetPoint(6,500,-0.13076);
   gre->SetPointError(6,0,0.04263427);
   gre->SetPoint(7,700,-1.94828);
   gre->SetPointError(7,0,0.05581498);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-2.910566);
   Graph_Graph50->SetMaximum(7.967085);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(78.18446);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006482181);
   linear_fit->SetParError(0,5.464107e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.902834);
   linear_fit->SetParError(1,0.02572881);
