...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_4->Range(-1050,-8.916575,1050,-6.328191);
   ...
   gre->SetPoint(0,-700,-8.46118);
   gre->SetPointError(0,0,0.02399746);
   gre->SetPoint(1,-500,-8.12954);
   gre->SetPointError(1,0,0.03826367);
   gre->SetPoint(2,-300,-7.83016);
   gre->SetPointError(2,0,0.0458729);
   gre->SetPoint(3,-100,-7.65988);
   gre->SetPointError(3,0,0.1281355);
   gre->SetPoint(4,100,-7.3941);
   gre->SetPointError(4,0,0.1463691);
   gre->SetPoint(5,300,-7.28098);
   gre->SetPointError(5,0,0.0373627);
   gre->SetPoint(6,500,-7.10844);
   gre->SetPointError(6,0,0.03873953);
   gre->SetPoint(7,700,-6.7887);
   gre->SetPointError(7,0,0.02911204);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-8.657736);
   Graph_Graph46->SetMaximum(-6.587029);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.98183);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001152222);
   linear_fit->SetParError(0,2.321521e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.612647);
   linear_fit->SetParError(1,0.01347439);
