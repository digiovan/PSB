...
//=========  (Wed Apr  1 22:35:06 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-1.849185,1050,-1.728928);
   ...
   gre->SetPoint(0,-700,-1.7683);
   gre->SetPointError(0,0,0.01427938);
   gre->SetPoint(1,-500,-1.77822);
   gre->SetPointError(1,0,0.02924944);
   gre->SetPoint(2,-300,-1.79402);
   gre->SetPointError(2,0,0.01129135);
   gre->SetPoint(3,-100,-1.81516);
   gre->SetPointError(3,0,0.01398216);
   gre->SetPoint(4,100,-1.79868);
   gre->SetPointError(4,0,0.007899956);
   gre->SetPoint(5,300,-1.79124);
   gre->SetPointError(5,0,0.02248179);
   gre->SetPoint(6,500,-1.80654);
   gre->SetPointError(6,0,0.01380171);
   gre->SetPoint(7,700,-1.78376);
   gre->SetPointError(7,0,0.0094276);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.837159);
   Graph_Graph47->SetMaximum(-1.740953);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.971137);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.651235e-06);
   linear_fit->SetParError(0,1.000767e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.793197);
   linear_fit->SetParError(1,0.004456576);
