...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,2.861781,1050,4.697624);
   ...
   gre->SetPoint(0,-700,3.48374);
   gre->SetPointError(0,0,0.1236995);
   gre->SetPoint(1,-500,3.4422);
   gre->SetPointError(1,0,0.09876602);
   gre->SetPoint(2,-300,4.24042);
   gre->SetPointError(2,0,0.1512302);
   gre->SetPoint(3,-100,3.20854);
   gre->SetPointError(3,0,0.04078486);
   gre->SetPoint(4,100,3.3417);
   gre->SetPointError(4,0,0.05624342);
   gre->SetPoint(5,300,4.118);
   gre->SetPointError(5,0,0.1601614);
   gre->SetPoint(6,500,3.54382);
   gre->SetPointError(6,0,0.0390688);
   gre->SetPoint(7,700,3.48684);
   gre->SetPointError(7,0,0.2386073);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(3.045366);
   Graph_Graph52->SetMaximum(4.51404);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(78.57231);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0002025597);
   linear_fit->SetParError(0,6.711151e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.396534);
   linear_fit->SetParError(1,0.02456799);
