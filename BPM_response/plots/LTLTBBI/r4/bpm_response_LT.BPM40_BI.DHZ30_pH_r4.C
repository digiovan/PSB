...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.4440804,1050,-0.3816982);
   ...
   gre->SetPoint(0,-700,-0.40584);
   gre->SetPointError(0,0,0.002500748);
   gre->SetPoint(1,-500,-0.40776);
   gre->SetPointError(1,0,0.01065641);
   gre->SetPoint(2,-300,-0.40912);
   gre->SetPointError(2,0,0.006834575);
   gre->SetPoint(3,-100,-0.4003);
   gre->SetPointError(3,0,0.007543835);
   gre->SetPoint(4,100,-0.40658);
   gre->SetPointError(4,0,0.008051936);
   gre->SetPoint(5,300,-0.4259);
   gre->SetPointError(5,0,0.007783341);
   gre->SetPoint(6,500,-0.39862);
   gre->SetPointError(6,0,0.006524744);
   gre->SetPoint(7,700,-0.40262);
   gre->SetPointError(7,0,0.006215304);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.4378421);
   Graph_Graph46->SetMaximum(-0.3879364);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.904826);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.033697e-07);
   linear_fit->SetParError(0,3.628272e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4059611);
   linear_fit->SetParError(1,0.002164527);
