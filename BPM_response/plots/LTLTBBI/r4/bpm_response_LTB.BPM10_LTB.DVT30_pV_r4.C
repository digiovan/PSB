...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,0.9371851,1050,1.321796);
   ...
   gre->SetPoint(0,-700,1.08784);
   gre->SetPointError(0,0,0.02793219);
   gre->SetPoint(1,-500,1.09594);
   gre->SetPointError(1,0,0.09351988);
   gre->SetPoint(2,-300,1.06122);
   gre->SetPointError(2,0,0.008521876);
   gre->SetPoint(3,-100,1.13);
   gre->SetPointError(3,0,0.01622956);
   gre->SetPoint(4,100,1.21056);
   gre->SetPointError(4,0,0.0471345);
   gre->SetPoint(5,300,1.10306);
   gre->SetPointError(5,0,0.01483392);
   gre->SetPoint(6,500,1.1304);
   gre->SetPointError(6,0,0.02456026);
   gre->SetPoint(7,700,1.07654);
   gre->SetPointError(7,0,0.07525299);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(0.9756463);
   Graph_Graph48->SetMaximum(1.283335);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.01165);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.147471e-05);
   linear_fit->SetParError(0,2.010168e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.09475);
   linear_fit->SetParError(1,0.006680239);
