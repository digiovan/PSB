...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-8.115199,1050,-7.433687);
   ...
   gre->SetPoint(0,-700,-7.73276);
   gre->SetPointError(0,0,0.04692409);
   gre->SetPoint(1,-500,-7.89994);
   gre->SetPointError(1,0,0.02462008);
   gre->SetPoint(2,-300,-7.59726);
   gre->SetPointError(2,0,0.04109717);
   gre->SetPoint(3,-100,-7.91622);
   gre->SetPointError(3,0,0.08539405);
   gre->SetPoint(4,100,-7.93422);
   gre->SetPointError(4,0,0.02352712);
   gre->SetPoint(5,300,-7.57838);
   gre->SetPointError(5,0,0.03110731);
   gre->SetPoint(6,500,-7.8266);
   gre->SetPointError(6,0,0.01520045);
   gre->SetPoint(7,700,-7.84388);
   gre->SetPointError(7,0,0.03166268);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-8.047048);
   Graph_Graph44->SetMaximum(-7.501839);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(129.072);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.003972e-05);
   linear_fit->SetParError(0,2.23555e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.820262);
   linear_fit->SetParError(1,0.01038065);
