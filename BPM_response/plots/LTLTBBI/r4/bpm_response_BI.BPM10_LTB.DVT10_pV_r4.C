...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-20.53019,1050,26.73818);
   ...
   gre->SetPoint(0,-700,18.79236);
   gre->SetPointError(0,0,0.0677594);
   gre->SetPoint(1,-500,14.21672);
   gre->SetPointError(1,0,0.1401054);
   gre->SetPoint(2,-300,9.691);
   gre->SetPointError(2,0,0.03669624);
   gre->SetPoint(3,-100,5.3637);
   gre->SetPointError(3,0,0.03817156);
   gre->SetPoint(4,100,1.06408);
   gre->SetPointError(4,0,0.04368299);
   gre->SetPoint(5,300,-3.1086);
   gre->SetPointError(5,0,0.1308944);
   gre->SetPoint(6,500,-7.9862);
   gre->SetPointError(6,0,0.1187305);
   gre->SetPoint(7,700,-12.6097);
   gre->SetPointError(7,0,0.04242619);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-15.80335);
   Graph_Graph52->SetMaximum(22.01134);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(47.76437);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0223208);
   linear_fit->SetParError(0,4.501971e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.11559);
   linear_fit->SetParError(1,0.01855254);
