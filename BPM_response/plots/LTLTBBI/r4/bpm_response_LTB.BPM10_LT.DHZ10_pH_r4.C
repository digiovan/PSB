...
//=========  (Wed Apr  1 22:34:14 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,-3.411205,1050,7.907188);
   ...
   gre->SetPoint(0,-700,5.83572);
   gre->SetPointError(0,0,0.1850688);
   gre->SetPoint(1,-500,3.8378);
   gre->SetPointError(1,0,0.02533498);
   gre->SetPoint(2,-300,2.90948);
   gre->SetPointError(2,0,0.1471201);
   gre->SetPoint(3,-100,2.54768);
   gre->SetPointError(3,0,0.4123284);
   gre->SetPoint(4,100,1.8601);
   gre->SetPointError(4,0,0.1046051);
   gre->SetPoint(5,300,-0.48232);
   gre->SetPointError(5,0,0.2923547);
   gre->SetPoint(6,500,-0.86716);
   gre->SetPointError(6,0,0.09147528);
   gre->SetPoint(7,700,-1.33514);
   gre->SetPointError(7,0,0.1896665);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(-2.279366);
   Graph_Graph48->SetMaximum(6.775348);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(94.10987);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004489596);
   linear_fit->SetParError(0,7.503559e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.630486);
   linear_fit->SetParError(1,0.0367584);
