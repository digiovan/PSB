...
//=========  (Wed Apr  1 22:35:27 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_4->Range(-1050,4.555712,1050,5.811558);
   ...
   gre->SetPoint(0,-700,5.0057);
   gre->SetPointError(0,0,0.07880366);
   gre->SetPoint(1,-500,5.08902);
   gre->SetPointError(1,0,0.03042651);
   gre->SetPoint(2,-300,5.4698);
   gre->SetPointError(2,0,0.1324505);
   gre->SetPoint(3,-100,4.99808);
   gre->SetPointError(3,0,0.1125999);
   gre->SetPoint(4,100,4.91562);
   gre->SetPointError(4,0,0.1506005);
   gre->SetPoint(5,300,5.20582);
   gre->SetPointError(5,0,0.1081942);
   gre->SetPoint(6,500,5.2218);
   gre->SetPointError(6,0,0.07868266);
   gre->SetPoint(7,700,5.12214);
   gre->SetPointError(7,0,0.0720552);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(4.681296);
   Graph_Graph49->SetMaximum(5.685974);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.04718);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.116462e-05);
   linear_fit->SetParError(0,5.016462e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,5.122356);
   linear_fit->SetParError(1,0.02594561);
