...
//=========  (Wed Apr  1 22:34:29 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.032751,1050,1.392502);
   ...
   gre->SetPoint(0,-700,1.17208);
   gre->SetPointError(0,0,0.0793701);
   gre->SetPoint(1,-500,1.17984);
   gre->SetPointError(1,0,0.03120772);
   gre->SetPoint(2,-300,1.2039);
   gre->SetPointError(2,0,0.05087611);
   gre->SetPoint(3,-100,1.20214);
   gre->SetPointError(3,0,0.008947399);
   gre->SetPoint(4,100,1.2365);
   gre->SetPointError(4,0,0.09604352);
   gre->SetPoint(5,300,1.17812);
   gre->SetPointError(5,0,0.07234119);
   gre->SetPoint(6,500,1.2504);
   gre->SetPointError(6,0,0.0679767);
   gre->SetPoint(7,700,1.25726);
   gre->SetPointError(7,0,0.01778766);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.068727);
   Graph_Graph43->SetMaximum(1.356527);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(0.6741273);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.516282e-05);
   linear_fit->SetParError(0,2.17895e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.209513);
   linear_fit->SetParError(1,0.007524067);
