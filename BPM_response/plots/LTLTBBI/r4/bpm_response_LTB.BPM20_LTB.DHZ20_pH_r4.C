...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_4->Range(-1050,-1.001944,1050,11.52103);
   ...
   gre->SetPoint(0,-700,1.12818);
   gre->SetPointError(0,0,0.04296124);
   gre->SetPoint(1,-500,2.40528);
   gre->SetPointError(1,0,0.05162828);
   gre->SetPoint(2,-300,3.59516);
   gre->SetPointError(2,0,0.05155939);
   gre->SetPoint(3,-100,4.4375);
   gre->SetPointError(3,0,0.07263533);
   gre->SetPoint(4,100,5.37744);
   gre->SetPointError(4,0,0.04211957);
   gre->SetPoint(5,300,6.99018);
   gre->SetPointError(5,0,0.08198259);
   gre->SetPoint(6,500,8.09136);
   gre->SetPointError(6,0,0.09020363);
   gre->SetPoint(7,700,9.30396);
   gre->SetPointError(7,0,0.1299113);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(0.2503535);
   Graph_Graph49->SetMaximum(10.26874);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(79.49111);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005580788);
   linear_fit->SetParError(0,5.192714e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,5.083477);
   linear_fit->SetParError(1,0.0231823);
