...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,7.207621,1050,9.35308);
   ...
   gre->SetPoint(0,-700,7.57532);
   gre->SetPointError(0,0,0.01012259);
   gre->SetPoint(1,-500,7.83854);
   gre->SetPointError(1,0,0.05117328);
   gre->SetPoint(2,-300,7.95412);
   gre->SetPointError(2,0,0.05337117);
   gre->SetPoint(3,-100,8.18024);
   gre->SetPointError(3,0,0.04057633);
   gre->SetPoint(4,100,8.34288);
   gre->SetPointError(4,0,0.02541304);
   gre->SetPoint(5,300,8.55794);
   gre->SetPointError(5,0,0.01475697);
   gre->SetPoint(6,500,8.80502);
   gre->SetPointError(6,0,0.0434682);
   gre->SetPoint(7,700,8.9371);
   gre->SetPointError(7,0,0.05840379);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(7.422167);
   Graph_Graph53->SetMaximum(9.138534);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.821695);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0009831811);
   linear_fit->SetParError(0,1.5559e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.264631);
   linear_fit->SetParError(1,0.008678768);
