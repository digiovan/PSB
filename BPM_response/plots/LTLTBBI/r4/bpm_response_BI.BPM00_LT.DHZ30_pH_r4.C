...
//=========  (Wed Apr  1 22:34:35 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-10.28699,1050,-1.402614);
   ...
   gre->SetPoint(0,-700,-2.93252);
   gre->SetPointError(0,0,0.04917672);
   gre->SetPoint(1,-500,-3.75964);
   gre->SetPointError(1,0,0.04134713);
   gre->SetPoint(2,-300,-5.07452);
   gre->SetPointError(2,0,0.2482015);
   gre->SetPoint(3,-100,-5.7391);
   gre->SetPointError(3,0,0.08454893);
   gre->SetPoint(4,100,-6.9074);
   gre->SetPointError(4,0,0.05638245);
   gre->SetPoint(5,300,-7.39332);
   gre->SetPointError(5,0,0.04229205);
   gre->SetPoint(6,500,-8.1726);
   gre->SetPointError(6,0,0.0585952);
   gre->SetPoint(7,700,-8.7461);
   gre->SetPointError(7,0,0.06015936);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-9.398551);
   Graph_Graph51->SetMaximum(-2.291052);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(104.8203);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004342164);
   linear_fit->SetParError(0,4.042679e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.037442);
   linear_fit->SetParError(1,0.01965169);
