...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-7.741953,1050,-7.285066);
   ...
   gre->SetPoint(0,-700,-7.60946);
   gre->SetPointError(0,0,0.05634483);
   gre->SetPoint(1,-500,-7.575);
   gre->SetPointError(1,0,0.07541194);
   gre->SetPoint(2,-300,-7.4704);
   gre->SetPointError(2,0,0.1091865);
   gre->SetPoint(3,-100,-7.5937);
   gre->SetPointError(3,0,0.02590477);
   gre->SetPoint(4,100,-7.5292);
   gre->SetPointError(4,0,0.09712716);
   gre->SetPoint(5,300,-7.60234);
   gre->SetPointError(5,0,0.02581597);
   gre->SetPoint(6,500,-7.54504);
   gre->SetPointError(6,0,0.05235501);
   gre->SetPoint(7,700,-7.57288);
   gre->SetPointError(7,0,0.04492889);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.696264);
   Graph_Graph44->SetMaximum(-7.330754);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.733965);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.29212e-05);
   linear_fit->SetParError(0,3.971489e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.588393);
   linear_fit->SetParError(1,0.01550624);
