...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-20.47859,1050,8.513802);
   ...
   gre->SetPoint(0,-700,-15.24792);
   gre->SetPointError(0,0,0.3986061);
   gre->SetPoint(1,-500,-11.9123);
   gre->SetPointError(1,0,0.0543133);
   gre->SetPoint(2,-300,-9.17148);
   gre->SetPointError(2,0,0.09059844);
   gre->SetPoint(3,-100,-6.22944);
   gre->SetPointError(3,0,0.1288484);
   gre->SetPoint(4,100,-4.04848);
   gre->SetPointError(4,0,0.05755663);
   gre->SetPoint(5,300,-1.40336);
   gre->SetPointError(5,0,0.2571506);
   gre->SetPoint(6,500,1.2169);
   gre->SetPointError(6,0,0.08601826);
   gre->SetPoint(7,700,3.59726);
   gre->SetPointError(7,0,0.08447599);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-17.57935);
   Graph_Graph52->SetMaximum(5.614562);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.61802);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01299239);
   linear_fit->SetParError(0,6.967345e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.352289);
   linear_fit->SetParError(1,0.02990259);
