...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-18.34315,1050,25.22918);
   ...
   gre->SetPoint(0,-700,-10.94596);
   gre->SetPointError(0,0,0.1351371);
   gre->SetPoint(1,-500,-6.47412);
   gre->SetPointError(1,0,0.05308223);
   gre->SetPoint(2,-300,-2.69614);
   gre->SetPointError(2,0,0.06503119);
   gre->SetPoint(3,-100,1.57422);
   gre->SetPointError(3,0,0.07006746);
   gre->SetPoint(4,100,5.4069);
   gre->SetPointError(4,0,0.09987789);
   gre->SetPoint(5,300,9.62694);
   gre->SetPointError(5,0,0.06927169);
   gre->SetPoint(6,500,14.02686);
   gre->SetPointError(6,0,0.1066979);
   gre->SetPoint(7,700,17.8963);
   gre->SetPointError(7,0,0.0708266);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-13.98592);
   Graph_Graph52->SetMaximum(20.87195);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(28.11259);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02041139);
   linear_fit->SetParError(0,6.014214e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.580877);
   linear_fit->SetParError(1,0.02638668);
