...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-30.06533,1050,24.95673);
   ...
   gre->SetPoint(0,-700,-18.90764);
   gre->SetPointError(0,0,0.1660477);
   gre->SetPoint(1,-500,-19.7589);
   gre->SetPointError(1,0,1.136089);
   gre->SetPoint(2,-300,-13.47642);
   gre->SetPointError(2,0,0.448783);
   gre->SetPoint(3,-100,-4.90394);
   gre->SetPointError(3,0,0.06111387);
   gre->SetPoint(4,100,4.22954);
   gre->SetPointError(4,0,0.3055335);
   gre->SetPoint(5,300,12.24512);
   gre->SetPointError(5,0,0.3066839);
   gre->SetPoint(6,500,9.8259);
   gre->SetPointError(6,0,0.05704947);
   gre->SetPoint(7,700,15.22262);
   gre->SetPointError(7,0,0.5637693);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-24.56313);
   Graph_Graph54->SetMaximum(19.45453);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(842.2641);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02450908);
   linear_fit->SetParError(0,0.0001097796);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.241232);
   linear_fit->SetParError(1,0.04345364);
