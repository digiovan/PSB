...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_4->Range(-1050,-7.026479,1050,-6.321626);
   ...
   gre->SetPoint(0,-700,-6.7697);
   gre->SetPointError(0,0,0.04261839);
   gre->SetPoint(1,-500,-6.82864);
   gre->SetPointError(1,0,0.04207948);
   gre->SetPoint(2,-300,-6.51192);
   gre->SetPointError(2,0,0.07281818);
   gre->SetPoint(3,-100,-6.88638);
   gre->SetPointError(3,0,0.02262341);
   gre->SetPoint(4,100,-6.7693);
   gre->SetPointError(4,0,0.01649463);
   gre->SetPoint(5,300,-6.50994);
   gre->SetPointError(5,0,0.06013367);
   gre->SetPoint(6,500,-6.75502);
   gre->SetPointError(6,0,0.01952904);
   gre->SetPoint(7,700,-6.7546);
   gre->SetPointError(7,0,0.1149041);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-6.955994);
   Graph_Graph44->SetMaximum(-6.392112);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.2336);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.744859e-05);
   linear_fit->SetParError(0,2.986841e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.785855);
   linear_fit->SetParError(1,0.01040243);
