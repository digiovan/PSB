...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.191896,1050,2.083621);
   ...
   gre->SetPoint(0,-700,1.7735);
   gre->SetPointError(0,0,0.02871953);
   gre->SetPoint(1,-500,1.88176);
   gre->SetPointError(1,0,0.02386952);
   gre->SetPoint(2,-300,1.75394);
   gre->SetPointError(2,0,0.01987551);
   gre->SetPoint(3,-100,1.91546);
   gre->SetPointError(3,0,0.0195401);
   gre->SetPoint(4,100,1.91262);
   gre->SetPointError(4,0,0.01857596);
   gre->SetPoint(5,300,1.77638);
   gre->SetPointError(5,0,0.07869555);
   gre->SetPoint(6,500,1.54538);
   gre->SetPointError(6,0,0.2048633);
   gre->SetPoint(7,700,1.78028);
   gre->SetPointError(7,0,0.01086464);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.281068);
   Graph_Graph43->SetMaximum(1.994448);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(75.0499);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.393129e-05);
   linear_fit->SetParError(0,1.43546e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.83059);
   linear_fit->SetParError(1,0.00758127);
