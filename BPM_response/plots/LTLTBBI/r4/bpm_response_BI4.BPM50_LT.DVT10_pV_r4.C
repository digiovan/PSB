...
//=========  (Wed Apr  1 22:34:19 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-8.987318,1050,-3.180619);
   ...
   gre->SetPoint(0,-700,-4.48096);
   gre->SetPointError(0,0,0.332558);
   gre->SetPoint(1,-500,-5.8018);
   gre->SetPointError(1,0,0.1257443);
   gre->SetPoint(2,-300,-6.37514);
   gre->SetPointError(2,0,0.1332972);
   gre->SetPoint(3,-100,-6.2047);
   gre->SetPointError(3,0,0.3114682);
   gre->SetPoint(4,100,-7.41464);
   gre->SetPointError(4,0,0.6048944);
   gre->SetPoint(5,300,-6.54118);
   gre->SetPointError(5,0,0.342643);
   gre->SetPoint(6,500,-5.82632);
   gre->SetPointError(6,0,0.4578569);
   gre->SetPoint(7,700,-5.87044);
   gre->SetPointError(7,0,0.1108582);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-8.406648);
   Graph_Graph56->SetMaximum(-3.761289);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(40.84564);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.172527e-05);
   linear_fit->SetParError(0,0.0001220788);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.973469);
   linear_fit->SetParError(1,0.06513936);
