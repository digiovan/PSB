...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.4422208,1050,-0.3533505);
   ...
   gre->SetPoint(0,-700,-0.4052);
   gre->SetPointError(0,0,0.01110418);
   gre->SetPoint(1,-500,-0.4037);
   gre->SetPointError(1,0,0.01226507);
   gre->SetPoint(2,-300,-0.39496);
   gre->SetPointError(2,0,0.004733022);
   gre->SetPoint(3,-100,-0.379);
   gre->SetPointError(3,0,0.0108378);
   gre->SetPoint(4,100,-0.39778);
   gre->SetPointError(4,0,0.002858077);
   gre->SetPoint(5,300,-0.41812);
   gre->SetPointError(5,0,0.009289064);
   gre->SetPoint(6,500,-0.40068);
   gre->SetPointError(6,0,0.01007261);
   gre->SetPoint(7,700,-0.39624);
   gre->SetPointError(7,0,0.009786671);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.4333338);
   Graph_Graph46->SetMaximum(-0.3622375);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.709383);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.304592e-06);
   linear_fit->SetParError(0,7.163731e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3979889);
   linear_fit->SetParError(1,0.002126773);
