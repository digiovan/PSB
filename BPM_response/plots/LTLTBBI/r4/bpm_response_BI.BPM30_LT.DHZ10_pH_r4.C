...
//=========  (Wed Apr  1 22:34:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,7.433259,1050,8.557792);
   ...
   gre->SetPoint(0,-700,7.89282);
   gre->SetPointError(0,0,0.02099016);
   gre->SetPoint(1,-500,8.33616);
   gre->SetPointError(1,0,0.03421027);
   gre->SetPoint(2,-300,8.19106);
   gre->SetPointError(2,0,0.009856105);
   gre->SetPoint(3,-100,7.81158);
   gre->SetPointError(3,0,0.06652118);
   gre->SetPoint(4,100,7.73834);
   gre->SetPointError(4,0,0.06075258);
   gre->SetPoint(5,300,7.97048);
   gre->SetPointError(5,0,0.0478254);
   gre->SetPoint(6,500,7.945);
   gre->SetPointError(6,0,0.04734156);
   gre->SetPoint(7,700,7.64906);
   gre->SetPointError(7,0,0.0283786);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(7.545713);
   Graph_Graph54->SetMaximum(8.445339);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(411.314);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002611966);
   linear_fit->SetParError(0,2.19276e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.02566);
   linear_fit->SetParError(1,0.009509094);
