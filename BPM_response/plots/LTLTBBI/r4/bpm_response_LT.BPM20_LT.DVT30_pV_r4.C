...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_4->Range(-1050,-6.992011,1050,-6.592467);
   ...
   gre->SetPoint(0,-700,-6.84192);
   gre->SetPointError(0,0,0.04438982);
   gre->SetPoint(1,-500,-6.81012);
   gre->SetPointError(1,0,0.04264868);
   gre->SetPoint(2,-300,-6.88376);
   gre->SetPointError(2,0,0.02204586);
   gre->SetPoint(3,-100,-6.7782);
   gre->SetPointError(3,0,0.03579689);
   gre->SetPoint(4,100,-6.84386);
   gre->SetPointError(4,0,0.04867939);
   gre->SetPoint(5,300,-6.89748);
   gre->SetPointError(5,0,0.02794005);
   gre->SetPoint(6,500,-6.75874);
   gre->SetPointError(6,0,0.04063113);
   gre->SetPoint(7,700,-6.77602);
   gre->SetPointError(7,0,0.1169621);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-6.952056);
   Graph_Graph44->SetMaximum(-6.632422);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.27719);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.925564e-05);
   linear_fit->SetParError(0,3.453292e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.84593);
   linear_fit->SetParError(1,0.01297298);
