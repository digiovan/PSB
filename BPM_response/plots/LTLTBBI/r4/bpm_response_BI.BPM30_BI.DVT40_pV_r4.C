...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-2.853205,1050,2.138238);
   ...
   gre->SetPoint(0,-700,0.24118);
   gre->SetPointError(0,0,0.2022611);
   gre->SetPoint(1,-500,0.35236);
   gre->SetPointError(1,0,0.3194781);
   gre->SetPoint(2,-300,-1.75888);
   gre->SetPointError(2,0,0.2624176);
   gre->SetPoint(3,-100,1.1342);
   gre->SetPointError(3,0,0.1721309);
   gre->SetPoint(4,100,0.77);
   gre->SetPointError(4,0,0.1758449);
   gre->SetPoint(5,300,-1.2819);
   gre->SetPointError(5,0,0.3927854);
   gre->SetPoint(6,500,0.17774);
   gre->SetPointError(6,0,0.2089797);
   gre->SetPoint(7,700,0.31186);
   gre->SetPointError(7,0,0.5796309);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-2.35406);
   Graph_Graph54->SetMaximum(1.639094);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(108.1958);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001686963);
   linear_fit->SetParError(0,0.000207014);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.309339);
   linear_fit->SetParError(1,0.08386674);
