...
//=========  (Wed Apr  1 22:35:52 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-11.54109,1050,-10.75154);
   ...
   gre->SetPoint(0,-700,-11.09512);
   gre->SetPointError(0,0,0.09148143);
   gre->SetPoint(1,-500,-11.1858);
   gre->SetPointError(1,0,0.03787532);
   gre->SetPoint(2,-300,-11.16202);
   gre->SetPointError(2,0,0.1185068);
   gre->SetPoint(3,-100,-11.21246);
   gre->SetPointError(3,0,0.04536686);
   gre->SetPoint(4,100,-11.19208);
   gre->SetPointError(4,0,0.0897001);
   gre->SetPoint(5,300,-11.338);
   gre->SetPointError(5,0,0.0715001);
   gre->SetPoint(6,500,-11.1691);
   gre->SetPointError(6,0,0.03048276);
   gre->SetPoint(7,700,-11.02786);
   gre->SetPointError(7,0,0.1447243);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-11.46214);
   Graph_Graph45->SetMaximum(-10.8305);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.381865);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.315582e-06);
   linear_fit->SetParError(0,4.270327e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.18762);
   linear_fit->SetParError(1,0.01895944);
