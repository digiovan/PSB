...
//=========  (Wed Apr  1 22:36:20 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_H_4->Range(-1050,-25.64206,1050,-14.9063);
   ...
   gre->SetPoint(0,-700,-22.14082);
   gre->SetPointError(0,0,1.711947);
   gre->SetPoint(1,-500,-21.61144);
   gre->SetPointError(1,0,1.066048);
   gre->SetPoint(2,-300,-20.95802);
   gre->SetPointError(2,0,0.6846328);
   gre->SetPoint(3,-100,-19.75874);
   gre->SetPointError(3,0,1.505382);
   gre->SetPoint(4,100,-18.80028);
   gre->SetPointError(4,0,1.796696);
   gre->SetPoint(5,300,-17.58862);
   gre->SetPointError(5,0,0.42869);
   gre->SetPoint(6,500,-18.37114);
   gre->SetPointError(6,0,0.8108601);
   gre->SetPoint(7,700,-18.4046);
   gre->SetPointError(7,0,1.709008);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-24.56848);
   Graph_Graph55->SetMaximum(-15.97987);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.891406);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004064927);
   linear_fit->SetParError(0,0.0008230565);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-19.3739);
   linear_fit->SetParError(1,0.3105483);
