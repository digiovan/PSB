...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-17.00647,1050,9.954954);
   ...
   gre->SetPoint(0,-700,-11.87484);
   gre->SetPointError(0,0,0.6380561);
   gre->SetPoint(1,-500,-9.07714);
   gre->SetPointError(1,0,1.342623);
   gre->SetPoint(2,-300,-0.89076);
   gre->SetPointError(2,0,0.09901708);
   gre->SetPoint(3,-100,-6.60408);
   gre->SetPointError(3,0,0.5979833);
   gre->SetPoint(4,100,-4.16886);
   gre->SetPointError(4,0,0.8266633);
   gre->SetPoint(5,300,4.06122);
   gre->SetPointError(5,0,1.03711);
   gre->SetPoint(6,500,2.7787);
   gre->SetPointError(6,0,1.157905);
   gre->SetPoint(7,700,4.59204);
   gre->SetPointError(7,0,0.8693437);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-14.31032);
   Graph_Graph55->SetMaximum(7.258812);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(364.6244);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006917501);
   linear_fit->SetParError(0,0.0005934486);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6928497);
   linear_fit->SetParError(1,0.1897962);
