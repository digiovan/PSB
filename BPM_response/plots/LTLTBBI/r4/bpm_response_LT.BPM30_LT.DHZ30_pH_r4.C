...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-10.14176,1050,-8.772839);
   ...
   gre->SetPoint(0,-700,-9.75046);
   gre->SetPointError(0,0,0.007595465);
   gre->SetPoint(1,-500,-9.90474);
   gre->SetPointError(1,0,0.008863562);
   gre->SetPoint(2,-300,-9.6095);
   gre->SetPointError(2,0,0.1291824);
   gre->SetPoint(3,-100,-9.7908);
   gre->SetPointError(3,0,0.07060954);
   gre->SetPoint(4,100,-9.43022);
   gre->SetPointError(4,0,0.04811673);
   gre->SetPoint(5,300,-9.53666);
   gre->SetPointError(5,0,0.01789864);
   gre->SetPoint(6,500,-9.3129);
   gre->SetPointError(6,0,0.04919865);
   gre->SetPoint(7,700,-9.03994);
   gre->SetPointError(7,0,0.03894772);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-10.00486);
   Graph_Graph45->SetMaximum(-8.909731);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(454.7672);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003228203);
   linear_fit->SetParError(0,1.536885e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.609015);
   linear_fit->SetParError(1,0.009152572);
