...
//=========  (Wed Apr  1 22:36:04 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-16.4766,1050,9.33364);
   ...
   gre->SetPoint(0,-700,4.34948);
   gre->SetPointError(0,0,0.6824527);
   gre->SetPoint(1,-500,-0.25952);
   gre->SetPointError(1,0,0.5747332);
   gre->SetPoint(2,-300,-1.50448);
   gre->SetPointError(2,0,0.7568335);
   gre->SetPoint(3,-100,-3.89526);
   gre->SetPointError(3,0,0.4267246);
   gre->SetPoint(4,100,-6.0042);
   gre->SetPointError(4,0,0.8526339);
   gre->SetPoint(5,300,-8.0033);
   gre->SetPointError(5,0,0.3898404);
   gre->SetPoint(6,500,-7.09464);
   gre->SetPointError(6,0,0.8967051);
   gre->SetPoint(7,700,-11.85392);
   gre->SetPointError(7,0,0.3209771);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-13.89558);
   Graph_Graph55->SetMaximum(6.752616);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.65004);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01037364);
   linear_fit->SetParError(0,0.000384912);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.593364);
   linear_fit->SetParError(1,0.1907839);
