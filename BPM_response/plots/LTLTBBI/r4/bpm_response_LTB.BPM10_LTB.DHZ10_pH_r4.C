...
//=========  (Wed Apr  1 22:35:06 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,-1.550105,1050,6.378893);
   ...
   gre->SetPoint(0,-700,-0.12902);
   gre->SetPointError(0,0,0.09958512);
   gre->SetPoint(1,-500,0.75032);
   gre->SetPointError(1,0,0.3045737);
   gre->SetPoint(2,-300,1.67076);
   gre->SetPointError(2,0,0.01724922);
   gre->SetPoint(3,-100,2.66558);
   gre->SetPointError(3,0,0.1065887);
   gre->SetPoint(4,100,3.18286);
   gre->SetPointError(4,0,0.1292578);
   gre->SetPoint(5,300,3.81636);
   gre->SetPointError(5,0,0.2469681);
   gre->SetPoint(6,500,4.29694);
   gre->SetPointError(6,0,0.03383293);
   gre->SetPoint(7,700,4.87918);
   gre->SetPointError(7,0,0.1782132);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(-0.757205);
   Graph_Graph48->SetMaximum(5.585993);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.72847);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003345763);
   linear_fit->SetParError(0,4.44626e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.662095);
   linear_fit->SetParError(1,0.01604377);
