...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-13.16065,1050,4.928148);
   ...
   gre->SetPoint(0,-700,-10.0114);
   gre->SetPointError(0,0,0.1344524);
   gre->SetPoint(1,-500,-8.21814);
   gre->SetPointError(1,0,0.09202477);
   gre->SetPoint(2,-300,-7.09342);
   gre->SetPointError(2,0,0.08425882);
   gre->SetPoint(3,-100,-4.93414);
   gre->SetPointError(3,0,0.09728763);
   gre->SetPoint(4,100,-3.43384);
   gre->SetPointError(4,0,0.04014102);
   gre->SetPoint(5,300,-2.21532);
   gre->SetPointError(5,0,0.345014);
   gre->SetPoint(6,500,0.42168);
   gre->SetPointError(6,0,0.156635);
   gre->SetPoint(7,700,1.77314);
   gre->SetPointError(7,0,0.1402078);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-11.35177);
   Graph_Graph52->SetMaximum(3.119268);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(36.40092);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00845443);
   linear_fit->SetParError(0,9.463997e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.237621);
   linear_fit->SetParError(1,0.02971481);
