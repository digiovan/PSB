...
//=========  (Wed Apr  1 22:34:13 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.787422,1050,-0.05119261);
   ...
   gre->SetPoint(0,-700,-0.6541);
   gre->SetPointError(0,0,0.01061714);
   gre->SetPoint(1,-500,-0.6592);
   gre->SetPointError(1,0,0.001104255);
   gre->SetPoint(2,-300,-0.56514);
   gre->SetPointError(2,0,0.008220536);
   gre->SetPoint(3,-100,-0.43786);
   gre->SetPointError(3,0,0.002714371);
   gre->SetPoint(4,100,-0.38928);
   gre->SetPointError(4,0,0.01453642);
   gre->SetPoint(5,300,-0.37886);
   gre->SetPointError(5,0,0.004801503);
   gre->SetPoint(6,500,-0.28726);
   gre->SetPointError(6,0,0.01594736);
   gre->SetPoint(7,700,-0.18038);
   gre->SetPointError(7,0,0.006482484);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.7137991);
   Graph_Graph46->SetMaximum(-0.1248156);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(588.7342);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004117383);
   linear_fit->SetParError(0,3.641766e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4475524);
   linear_fit->SetParError(1,0.00169515);
