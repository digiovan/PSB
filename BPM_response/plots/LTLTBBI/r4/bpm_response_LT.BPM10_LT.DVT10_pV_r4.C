...
//=========  (Wed Apr  1 22:34:18 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,0.1688185,1050,2.277995);
   ...
   gre->SetPoint(0,-700,0.54796);
   gre->SetPointError(0,0,0.02761203);
   gre->SetPoint(1,-500,0.80094);
   gre->SetPointError(1,0,0.02271623);
   gre->SetPoint(2,-300,1.00158);
   gre->SetPointError(2,0,0.0737832);
   gre->SetPoint(3,-100,1.19896);
   gre->SetPointError(3,0,0.04360423);
   gre->SetPoint(4,100,1.37406);
   gre->SetPointError(4,0,0.03365176);
   gre->SetPoint(5,300,1.56944);
   gre->SetPointError(5,0,0.03847584);
   gre->SetPoint(6,500,1.70774);
   gre->SetPointError(6,0,0.02970469);
   gre->SetPoint(7,700,1.91804);
   gre->SetPointError(7,0,0.008425935);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(0.3797362);
   Graph_Graph43->SetMaximum(2.067078);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.84322);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.000948027);
   linear_fit->SetParError(0,1.453307e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.255831);
   linear_fit->SetParError(1,0.009251816);
