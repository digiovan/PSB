...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,-6.482408,1050,8.942558);
   ...
   gre->SetPoint(0,-700,-3.89224);
   gre->SetPointError(0,0,0.01934022);
   gre->SetPoint(1,-500,-2.4245);
   gre->SetPointError(1,0,0.0169646);
   gre->SetPoint(2,-300,-0.87628);
   gre->SetPointError(2,0,0.03839005);
   gre->SetPoint(3,-100,0.59954);
   gre->SetPointError(3,0,0.0793816);
   gre->SetPoint(4,100,1.9256);
   gre->SetPointError(4,0,0.07968883);
   gre->SetPoint(5,300,3.34108);
   gre->SetPointError(5,0,0.02116694);
   gre->SetPoint(6,500,4.844);
   gre->SetPointError(6,0,0.0138546);
   gre->SetPoint(7,700,6.34918);
   gre->SetPointError(7,0,0.02255016);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(-4.939911);
   Graph_Graph48->SetMaximum(7.400061);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.94986);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.007277319);
   linear_fit->SetParError(0,1.463749e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.211403);
   linear_fit->SetParError(1,0.007808284);
