...
//=========  (Wed Apr  1 22:36:09 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,0.770142,1050,0.9077534);
   ...
   gre->SetPoint(0,-700,0.84432);
   gre->SetPointError(0,0,0.0009799008);
   gre->SetPoint(1,-500,0.83898);
   gre->SetPointError(1,0,0.01481023);
   gre->SetPoint(2,-300,0.8201);
   gre->SetPointError(2,0,0.01692194);
   gre->SetPoint(3,-100,0.81676);
   gre->SetPointError(3,0,0.02368273);
   gre->SetPoint(4,100,0.86608);
   gre->SetPointError(4,0,0.01873816);
   gre->SetPoint(5,300,0.8474);
   gre->SetPointError(5,0,0.01163766);
   gre->SetPoint(6,500,0.83908);
   gre->SetPointError(6,0,0.02296023);
   gre->SetPoint(7,700,0.84574);
   gre->SetPointError(7,0,0.009911988);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(0.7839032);
   Graph_Graph50->SetMaximum(0.8939922);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.013244);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.417811e-07);
   linear_fit->SetParError(0,5.55074e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.844553);
   linear_fit->SetParError(1,0.003855404);
