...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,1.698259,1050,2.930478);
   ...
   gre->SetPoint(0,-700,2.16258);
   gre->SetPointError(0,0,0.03774766);
   gre->SetPoint(1,-500,2.25578);
   gre->SetPointError(1,0,0.07172888);
   gre->SetPoint(2,-300,2.3715);
   gre->SetPointError(2,0,0.3536083);
   gre->SetPoint(3,-100,2.34726);
   gre->SetPointError(3,0,0.1154228);
   gre->SetPoint(4,100,1.9686);
   gre->SetPointError(4,0,0.06497144);
   gre->SetPoint(5,300,2.5308);
   gre->SetPointError(5,0,0.1334232);
   gre->SetPoint(6,500,2.09018);
   gre->SetPointError(6,0,0.08147266);
   gre->SetPoint(7,700,2.389);
   gre->SetPointError(7,0,0.1062562);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(1.821481);
   Graph_Graph48->SetMaximum(2.807256);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.20839);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.128788e-05);
   linear_fit->SetParError(0,5.23093e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.177315);
   linear_fit->SetParError(1,0.02955229);
