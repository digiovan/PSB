...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,-18.43876,1050,22.81053);
   ...
   gre->SetPoint(0,-700,15.81102);
   gre->SetPointError(0,0,0.124628);
   gre->SetPoint(1,-500,12.33774);
   gre->SetPointError(1,0,0.03090157);
   gre->SetPoint(2,-300,8.85126);
   gre->SetPointError(2,0,0.0495851);
   gre->SetPoint(3,-100,4.86576);
   gre->SetPointError(3,0,0.03465908);
   gre->SetPoint(4,100,1.0845);
   gre->SetPointError(4,0,0.07351871);
   gre->SetPoint(5,300,-3.0795);
   gre->SetPointError(5,0,0.08874856);
   gre->SetPoint(6,500,-7.44024);
   gre->SetPointError(6,0,0.01306552);
   gre->SetPoint(7,700,-11.49696);
   gre->SetPointError(7,0,0.06692201);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-14.31384);
   Graph_Graph50->SetMaximum(18.6856);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(261.2769);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01996636);
   linear_fit->SetParError(0,2.790498e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.576131);
   linear_fit->SetParError(1,0.01309464);
