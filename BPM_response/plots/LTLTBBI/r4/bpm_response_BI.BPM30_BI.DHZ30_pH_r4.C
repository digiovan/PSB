...
//=========  (Wed Apr  1 22:36:09 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,-4.567637,1050,-1.329389);
   ...
   gre->SetPoint(0,-700,-4.01398);
   gre->SetPointError(0,0,0.01394889);
   gre->SetPoint(1,-500,-3.63192);
   gre->SetPointError(1,0,0.06751003);
   gre->SetPoint(2,-300,-3.25962);
   gre->SetPointError(2,0,0.02680962);
   gre->SetPoint(3,-100,-2.84956);
   gre->SetPointError(3,0,0.04115823);
   gre->SetPoint(4,100,-2.6445);
   gre->SetPointError(4,0,0.0261064);
   gre->SetPoint(5,300,-2.42052);
   gre->SetPointError(5,0,0.02367709);
   gre->SetPoint(6,500,-2.09346);
   gre->SetPointError(6,0,0.01763655);
   gre->SetPoint(7,700,-1.88746);
   gre->SetPointError(7,0,0.01836314);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-4.243812);
   Graph_Graph54->SetMaximum(-1.653214);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(76.68885);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00154302);
   linear_fit->SetParError(0,1.395577e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.888703);
   linear_fit->SetParError(1,0.007723066);
