...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_4->Range(-1050,-1.148149,1050,10.33334);
   ...
   gre->SetPoint(0,-700,8.27222);
   gre->SetPointError(0,0,0.09806681);
   gre->SetPoint(1,-500,6.47632);
   gre->SetPointError(1,0,0.1100141);
   gre->SetPoint(2,-300,6.16908);
   gre->SetPointError(2,0,0.1717978);
   gre->SetPoint(3,-100,4.1019);
   gre->SetPointError(3,0,0.3434847);
   gre->SetPoint(4,100,3.09556);
   gre->SetPointError(4,0,0.3817305);
   gre->SetPoint(5,300,2.88352);
   gre->SetPointError(5,0,0.2245051);
   gre->SetPoint(6,500,0.45206);
   gre->SetPointError(6,0,0.2246565);
   gre->SetPoint(7,700,0.31766);
   gre->SetPointError(7,0,0.09638492);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(0);
   Graph_Graph49->SetMaximum(9.185188);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(51.07951);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005596792);
   linear_fit->SetParError(0,8.723292e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.110291);
   linear_fit->SetParError(1,0.05164632);
