...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,-1.526494,1050,7.312271);
   ...
   gre->SetPoint(0,-700,-0.01608);
   gre->SetPointError(0,0,0.03728599);
   gre->SetPoint(1,-500,0.71714);
   gre->SetPointError(1,0,0.05699963);
   gre->SetPoint(2,-300,1.56438);
   gre->SetPointError(2,0,0.08099073);
   gre->SetPoint(3,-100,2.4093);
   gre->SetPointError(3,0,0.1271577);
   gre->SetPoint(4,100,3.0904);
   gre->SetPointError(4,0,0.1596265);
   gre->SetPoint(5,300,3.93512);
   gre->SetPointError(5,0,0.01790851);
   gre->SetPoint(6,500,4.81048);
   gre->SetPointError(6,0,0.01873269);
   gre->SetPoint(7,700,5.79714);
   gre->SetPointError(7,0,0.04200381);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(-0.642617);
   Graph_Graph49->SetMaximum(6.428395);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(31.18401);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004070149);
   linear_fit->SetParError(0,2.915655e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.767903);
   linear_fit->SetParError(1,0.01365803);
