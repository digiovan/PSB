...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,-12.45691,1050,17.53024);
   ...
   gre->SetPoint(0,-700,-7.39832);
   gre->SetPointError(0,0,0.06073427);
   gre->SetPoint(1,-500,-4.18082);
   gre->SetPointError(1,0,0.09615358);
   gre->SetPoint(2,-300,-1.16518);
   gre->SetPointError(2,0,0.04574603);
   gre->SetPoint(3,-100,1.75086);
   gre->SetPointError(3,0,0.02782984);
   gre->SetPoint(4,100,4.523);
   gre->SetPointError(4,0,0.03007471);
   gre->SetPoint(5,300,6.98468);
   gre->SetPointError(5,0,0.08517028);
   gre->SetPoint(6,500,9.82208);
   gre->SetPointError(6,0,0.1498572);
   gre->SetPoint(7,700,12.46636);
   gre->SetPointError(7,0,0.06602021);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-9.458198);
   Graph_Graph50->SetMaximum(14.53152);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(173.232);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01413722);
   linear_fit->SetParError(0,5.316274e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.020844);
   linear_fit->SetParError(1,0.01672521);
