...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.024529,1050,1.431956);
   ...
   gre->SetPoint(0,-700,1.17132);
   gre->SetPointError(0,0,0.04092768);
   gre->SetPoint(1,-500,1.26638);
   gre->SetPointError(1,0,0.05120689);
   gre->SetPoint(2,-300,1.20744);
   gre->SetPointError(2,0,0.008993849);
   gre->SetPoint(3,-100,1.30892);
   gre->SetPointError(3,0,0.02165861);
   gre->SetPoint(4,100,1.16512);
   gre->SetPointError(4,0,0.04782443);
   gre->SetPoint(5,300,1.30154);
   gre->SetPointError(5,0,0.06251197);
   gre->SetPoint(6,500,1.11668);
   gre->SetPointError(6,0,0.02424603);
   gre->SetPoint(7,700,1.23416);
   gre->SetPointError(7,0,0.06616195);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.065272);
   Graph_Graph43->SetMaximum(1.391214);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(37.46075);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.926401e-05);
   linear_fit->SetParError(0,2.628182e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.202304);
   linear_fit->SetParError(1,0.008924282);
