...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-16.54296,1050,1.776001);
   ...
   gre->SetPoint(0,-700,-11.34622);
   gre->SetPointError(0,0,0.6189896);
   gre->SetPoint(1,-500,-11.79902);
   gre->SetPointError(1,0,1.690779);
   gre->SetPoint(2,-300,-3.90796);
   gre->SetPointError(2,0,0.07043241);
   gre->SetPoint(3,-100,-9.17976);
   gre->SetPointError(3,0,0.962881);
   gre->SetPoint(4,100,-9.47678);
   gre->SetPointError(4,0,1.062722);
   gre->SetPoint(5,300,-2.32608);
   gre->SetPointError(5,0,1.048921);
   gre->SetPoint(6,500,-4.80682);
   gre->SetPointError(6,0,1.083817);
   gre->SetPoint(7,700,-3.89954);
   gre->SetPointError(7,0,0.7641589);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-14.71106);
   Graph_Graph56->SetMaximum(-0.05589505);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(210.9311);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001839838);
   linear_fit->SetParError(0,0.0005613342);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.529882);
   linear_fit->SetParError(1,0.1760845);
