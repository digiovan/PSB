...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-2.89438,1050,-0.5840797);
   ...
   gre->SetPoint(0,-700,-2.4972);
   gre->SetPointError(0,0,0.01212969);
   gre->SetPoint(1,-500,-2.0606);
   gre->SetPointError(1,0,0.01721738);
   gre->SetPoint(2,-300,-2.07774);
   gre->SetPointError(2,0,0.01379092);
   gre->SetPoint(3,-100,-1.62766);
   gre->SetPointError(3,0,0.008966512);
   gre->SetPoint(4,100,-1.40746);
   gre->SetPointError(4,0,0.01044733);
   gre->SetPoint(5,300,-1.45058);
   gre->SetPointError(5,0,0.01156957);
   gre->SetPoint(6,500,-1.0171);
   gre->SetPointError(6,0,0.009268818);
   gre->SetPoint(7,700,-0.98396);
   gre->SetPointError(7,0,0.01483032);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-2.66335);
   Graph_Graph47->SetMaximum(-0.8151097);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(737.6605);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001101509);
   linear_fit->SetParError(0,9.742705e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.620266);
   linear_fit->SetParError(1,0.00408587);
