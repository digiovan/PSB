...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_4->Range(-1050,-8.243432,1050,-7.618867);
   ...
   gre->SetPoint(0,-700,-7.8232);
   gre->SetPointError(0,0,0.1002388);
   gre->SetPoint(1,-500,-8.03954);
   gre->SetPointError(1,0,0.03053933);
   gre->SetPoint(2,-300,-7.7863);
   gre->SetPointError(2,0,0.0284787);
   gre->SetPoint(3,-100,-8.09246);
   gre->SetPointError(3,0,0.03400096);
   gre->SetPoint(4,100,-7.90514);
   gre->SetPointError(4,0,0.08944187);
   gre->SetPoint(5,300,-8.0523);
   gre->SetPointError(5,0,0.08703758);
   gre->SetPoint(6,500,-7.77932);
   gre->SetPointError(6,0,0.05539484);
   gre->SetPoint(7,700,-7.98314);
   gre->SetPointError(7,0,0.0985656);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-8.180975);
   Graph_Graph46->SetMaximum(-7.681324);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(70.64753);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.799824e-05);
   linear_fit->SetParError(0,4.824653e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.930599);
   linear_fit->SetParError(1,0.01849817);
