...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-16.97577,1050,18.99087);
   ...
   gre->SetPoint(0,-700,-10.96446);
   gre->SetPointError(0,0,0.0168674);
   gre->SetPoint(1,-500,-8.45532);
   gre->SetPointError(1,0,0.02072829);
   gre->SetPoint(2,-300,-4.85296);
   gre->SetPointError(2,0,0.01748809);
   gre->SetPoint(3,-100,-1.45862);
   gre->SetPointError(3,0,0.02039827);
   gre->SetPoint(4,100,1.95632);
   gre->SetPointError(4,0,0.03437552);
   gre->SetPoint(5,300,5.39992);
   gre->SetPointError(5,0,0.02049848);
   gre->SetPoint(6,500,8.94544);
   gre->SetPointError(6,0,0.03750228);
   gre->SetPoint(7,700,12.91444);
   gre->SetPointError(7,0,0.08198766);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-13.3791);
   Graph_Graph47->SetMaximum(15.3942);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1300.512);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01667691);
   linear_fit->SetParError(0,2.098428e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.3217371);
   linear_fit->SetParError(1,0.009347512);
