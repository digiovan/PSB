...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,-2.090685,1050,8.545278);
   ...
   gre->SetPoint(0,-700,6.73234);
   gre->SetPointError(0,0,0.04027775);
   gre->SetPoint(1,-500,5.61544);
   gre->SetPointError(1,0,0.1068301);
   gre->SetPoint(2,-300,4.49884);
   gre->SetPointError(2,0,0.1061177);
   gre->SetPoint(3,-100,3.54736);
   gre->SetPointError(3,0,0.09995137);
   gre->SetPoint(4,100,2.4908);
   gre->SetPointError(4,0,0.2197437);
   gre->SetPoint(5,300,1.5778);
   gre->SetPointError(5,0,0.04459567);
   gre->SetPoint(6,500,0.55342);
   gre->SetPointError(6,0,0.05611265);
   gre->SetPoint(7,700,-0.25244);
   gre->SetPointError(7,0,0.06558404);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-1.027088);
   Graph_Graph50->SetMaximum(7.481682);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.59173);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005070209);
   linear_fit->SetParError(0,4.184849e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.13668);
   linear_fit->SetParError(1,0.02256415);
