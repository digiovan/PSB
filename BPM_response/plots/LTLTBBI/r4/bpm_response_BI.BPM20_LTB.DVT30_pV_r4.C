...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-2.336753,1050,-0.3412702);
   ...
   gre->SetPoint(0,-700,-0.72684);
   gre->SetPointError(0,0,0.04444176);
   gre->SetPoint(1,-500,-0.82204);
   gre->SetPointError(1,0,0.1481893);
   gre->SetPoint(2,-300,-1.09822);
   gre->SetPointError(2,0,0.04047978);
   gre->SetPoint(3,-100,-1.17082);
   gre->SetPointError(3,0,0.03183609);
   gre->SetPoint(4,100,-1.16332);
   gre->SetPointError(4,0,0.01844462);
   gre->SetPoint(5,300,-1.42348);
   gre->SetPointError(5,0,0.02750218);
   gre->SetPoint(6,500,-1.64714);
   gre->SetPointError(6,0,0.04156479);
   gre->SetPoint(7,700,-1.82422);
   gre->SetPointError(7,0,0.1799525);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-2.137205);
   Graph_Graph53->SetMaximum(-0.5408185);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(46.02834);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0006704067);
   linear_fit->SetParError(0,4.029891e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.184093);
   linear_fit->SetParError(1,0.01209628);
