...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_4->Range(-1050,-7.055181,1050,-6.504302);
   ...
   gre->SetPoint(0,-700,-6.71658);
   gre->SetPointError(0,0,0.0122969);
   gre->SetPoint(1,-500,-6.83528);
   gre->SetPointError(1,0,0.07709506);
   gre->SetPoint(2,-300,-6.77176);
   gre->SetPointError(2,0,0.0107568);
   gre->SetPoint(3,-100,-6.90952);
   gre->SetPointError(3,0,0.04413597);
   gre->SetPoint(4,100,-6.70812);
   gre->SetPointError(4,0,0.005660284);
   gre->SetPoint(5,300,-6.87578);
   gre->SetPointError(5,0,0.08758771);
   gre->SetPoint(6,500,-6.61788);
   gre->SetPointError(6,0,0.02176455);
   gre->SetPoint(7,700,-6.7774);
   gre->SetPointError(7,0,0.09332029);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.000093);
   Graph_Graph44->SetMaximum(-6.55939);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(58.27336);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.708071e-05);
   linear_fit->SetParError(0,1.445779e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.716105);
   linear_fit->SetParError(1,0.004582465);
