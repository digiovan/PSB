...
//=========  (Wed Apr  1 22:35:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,-1.553481,1050,17.78435);
   ...
   gre->SetPoint(0,-700,14.53588);
   gre->SetPointError(0,0,0.02550217);
   gre->SetPoint(1,-500,12.53554);
   gre->SetPointError(1,0,0.04073448);
   gre->SetPoint(2,-300,10.72298);
   gre->SetPointError(2,0,0.04439319);
   gre->SetPoint(3,-100,9.13072);
   gre->SetPointError(3,0,0.01192884);
   gre->SetPoint(4,100,7.45264);
   gre->SetPointError(4,0,0.01500408);
   gre->SetPoint(5,300,5.47482);
   gre->SetPointError(5,0,0.03414982);
   gre->SetPoint(6,500,3.5971);
   gre->SetPointError(6,0,0.02211027);
   gre->SetPoint(7,700,1.70078);
   gre->SetPointError(7,0,0.03128853);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(0.3803024);
   Graph_Graph53->SetMaximum(15.85057);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(187.1722);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009080787);
   linear_fit->SetParError(0,2.156064e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.218915);
   linear_fit->SetParError(1,0.007449018);
