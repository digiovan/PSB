...
//=========  (Wed Apr  1 22:35:27 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-1.883731,1050,-1.708308);
   ...
   gre->SetPoint(0,-700,-1.78244);
   gre->SetPointError(0,0,0.01241147);
   gre->SetPoint(1,-500,-1.79252);
   gre->SetPointError(1,0,0.009158145);
   gre->SetPoint(2,-300,-1.83122);
   gre->SetPointError(2,0,0.02327407);
   gre->SetPoint(3,-100,-1.7746);
   gre->SetPointError(3,0,0.01487475);
   gre->SetPoint(4,100,-1.77564);
   gre->SetPointError(4,0,0.03809473);
   gre->SetPoint(5,300,-1.7913);
   gre->SetPointError(5,0,0.01751974);
   gre->SetPoint(6,500,-1.81522);
   gre->SetPointError(6,0,0.005343467);
   gre->SetPoint(7,700,-1.7934);
   gre->SetPointError(7,0,0.01663054);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.866189);
   Graph_Graph47->SetMaximum(-1.72585);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.849656);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.078759e-05);
   linear_fit->SetParError(0,7.94579e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.800069);
   linear_fit->SetParError(1,0.004015018);
