...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-8.143748,1050,-7.533548);
   ...
   gre->SetPoint(0,-700,-7.70176);
   gre->SetPointError(0,0,0.006624523);
   gre->SetPoint(1,-500,-7.8816);
   gre->SetPointError(1,0,0.00832011);
   gre->SetPoint(2,-300,-7.7612);
   gre->SetPointError(2,0,0.1259522);
   gre->SetPoint(3,-100,-7.9881);
   gre->SetPointError(3,0,0.05394833);
   gre->SetPoint(4,100,-7.78294);
   gre->SetPointError(4,0,0.03821746);
   gre->SetPoint(5,300,-7.9247);
   gre->SetPointError(5,0,0.02631169);
   gre->SetPoint(6,500,-7.82708);
   gre->SetPointError(6,0,0.05091202);
   gre->SetPoint(7,700,-7.7561);
   gre->SetPointError(7,0,0.01751324);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-8.082728);
   Graph_Graph44->SetMaximum(-7.594568);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(303.9963);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.70901e-05);
   linear_fit->SetParError(0,1.180832e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.809137);
   linear_fit->SetParError(1,0.00730545);
