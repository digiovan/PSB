...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,-14.04577,1050,10.85403);
   ...
   gre->SetPoint(0,-700,-9.88958);
   gre->SetPointError(0,0,0.006227526);
   gre->SetPoint(1,-500,-7.34858);
   gre->SetPointError(1,0,0.01037738);
   gre->SetPoint(2,-300,-4.88264);
   gre->SetPointError(2,0,0.01451284);
   gre->SetPoint(3,-100,-2.5029);
   gre->SetPointError(3,0,0.06463213);
   gre->SetPoint(4,100,-0.11938);
   gre->SetPointError(4,0,0.01601325);
   gre->SetPoint(5,300,2.25584);
   gre->SetPointError(5,0,0.008267586);
   gre->SetPoint(6,500,4.4942);
   gre->SetPointError(6,0,0.01301757);
   gre->SetPoint(7,700,6.6826);
   gre->SetPointError(7,0,0.02145979);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-11.55579);
   Graph_Graph53->SetMaximum(8.364047);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(615.4528);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0120232);
   linear_fit->SetParError(0,7.916999e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.416331);
   linear_fit->SetParError(1,0.00425784);
