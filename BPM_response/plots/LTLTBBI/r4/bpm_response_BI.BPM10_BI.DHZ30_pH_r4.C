...
//=========  (Wed Apr  1 22:36:09 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-4.722966,1050,-3.994298);
   ...
   gre->SetPoint(0,-700,-4.3181);
   gre->SetPointError(0,0,0.02802425);
   gre->SetPoint(1,-500,-4.3865);
   gre->SetPointError(1,0,0.1179998);
   gre->SetPoint(2,-300,-4.18676);
   gre->SetPointError(2,0,0.05911558);
   gre->SetPoint(3,-100,-4.2898);
   gre->SetPointError(3,0,0.1408795);
   gre->SetPoint(4,100,-4.45684);
   gre->SetPointError(4,0,0.02987424);
   gre->SetPoint(5,300,-4.55128);
   gre->SetPointError(5,0,0.05024124);
   gre->SetPoint(6,500,-4.21338);
   gre->SetPointError(6,0,0.09763758);
   gre->SetPoint(7,700,-4.39398);
   gre->SetPointError(7,0,0.0758174);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-4.650099);
   Graph_Graph52->SetMaximum(-4.067165);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.85168);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001309001);
   linear_fit->SetParError(0,3.730935e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.403282);
   linear_fit->SetParError(1,0.01818925);
