...
//=========  (Wed Apr  1 22:34:56 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-11.93601,1050,2.878393);
   ...
   gre->SetPoint(0,-700,0.3627);
   gre->SetPointError(0,0,0.04662504);
   gre->SetPoint(1,-500,-0.71404);
   gre->SetPointError(1,0,0.1180016);
   gre->SetPoint(2,-300,-2.8263);
   gre->SetPointError(2,0,0.08517179);
   gre->SetPoint(3,-100,-3.62694);
   gre->SetPointError(3,0,0.04728047);
   gre->SetPoint(4,100,-4.8886);
   gre->SetPointError(4,0,0.1582693);
   gre->SetPoint(5,300,-6.90088);
   gre->SetPointError(5,0,0.05799434);
   gre->SetPoint(6,500,-7.64604);
   gre->SetPointError(6,0,0.02990465);
   gre->SetPoint(7,700,-9.3166);
   gre->SetPointError(7,0,0.1503464);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-10.45457);
   Graph_Graph52->SetMaximum(1.396952);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetParameter(0,-0.006726474);
   linear_fit->SetParError(0,4.200544e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.393359);
   linear_fit->SetParError(1,0.01992266);
