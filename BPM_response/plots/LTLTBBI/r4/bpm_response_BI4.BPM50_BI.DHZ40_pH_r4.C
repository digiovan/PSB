...
//=========  (Wed Apr  1 22:36:20 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_H_4->Range(-1050,-19.51957,1050,-12.06588);
   ...
   gre->SetPoint(0,-700,-16.7508);
   gre->SetPointError(0,0,0.471951);
   gre->SetPoint(1,-500,-17.5399);
   gre->SetPointError(1,0,0.7373879);
   gre->SetPoint(2,-300,-17.24222);
   gre->SetPointError(2,0,0.4736925);
   gre->SetPoint(3,-100,-15.87502);
   gre->SetPointError(3,0,1.489721);
   gre->SetPoint(4,100,-15.6482);
   gre->SetPointError(4,0,2.34004);
   gre->SetPoint(5,300,-13.80818);
   gre->SetPointError(5,0,0.3834917);
   gre->SetPoint(6,500,-15.81834);
   gre->SetPointError(6,0,0.6959929);
   gre->SetPoint(7,700,-14.8611);
   gre->SetPointError(7,0,1.308534);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-18.7742);
   Graph_Graph56->SetMaximum(-12.81125);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.4351);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002549899);
   linear_fit->SetParError(0,0.0004822417);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-15.55501);
   linear_fit->SetParError(1,0.223482);
