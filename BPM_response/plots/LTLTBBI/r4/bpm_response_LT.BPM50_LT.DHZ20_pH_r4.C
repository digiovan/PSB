...
//=========  (Wed Apr  1 22:34:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-3.516756,1050,0.2069639);
   ...
   gre->SetPoint(0,-700,-0.44286);
   gre->SetPointError(0,0,0.02920383);
   gre->SetPoint(1,-500,-0.58878);
   gre->SetPointError(1,0,0.03558861);
   gre->SetPoint(2,-300,-0.9706);
   gre->SetPointError(2,0,0.02713781);
   gre->SetPoint(3,-100,-1.51132);
   gre->SetPointError(3,0,0.02458287);
   gre->SetPoint(4,100,-1.91012);
   gre->SetPointError(4,0,0.03238879);
   gre->SetPoint(5,300,-2.08286);
   gre->SetPointError(5,0,0.03190657);
   gre->SetPoint(6,500,-2.32502);
   gre->SetPointError(6,0,0.02919927);
   gre->SetPoint(7,700,-2.88658);
   gre->SetPointError(7,0,0.009556185);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-3.144384);
   Graph_Graph47->SetMaximum(-0.1654082);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(107.3619);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001799909);
   linear_fit->SetParError(0,1.543061e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.611395);
   linear_fit->SetParError(1,0.009132849);
