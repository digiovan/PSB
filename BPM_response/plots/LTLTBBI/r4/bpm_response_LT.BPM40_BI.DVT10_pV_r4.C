...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_4->Range(-1050,-8.121731,1050,-7.756114);
   ...
   gre->SetPoint(0,-700,-7.93362);
   gre->SetPointError(0,0,0.0510015);
   gre->SetPoint(1,-500,-7.90772);
   gre->SetPointError(1,0,0.03433978);
   gre->SetPoint(2,-300,-7.91014);
   gre->SetPointError(2,0,0.09308941);
   gre->SetPoint(3,-100,-7.9893);
   gre->SetPointError(3,0,0.01911046);
   gre->SetPoint(4,100,-7.98258);
   gre->SetPointError(4,0,0.07821514);
   gre->SetPoint(5,300,-7.99954);
   gre->SetPointError(5,0,0.01897615);
   gre->SetPoint(6,500,-7.96384);
   gre->SetPointError(6,0,0.01615338);
   gre->SetPoint(7,700,-7.8605);
   gre->SetPointError(7,0,0.02756744);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-8.08517);
   Graph_Graph46->SetMaximum(-7.792676);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.11159);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.871522e-05);
   linear_fit->SetParError(0,2.425103e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.965547);
   linear_fit->SetParError(1,0.01052356);
