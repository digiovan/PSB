...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.624006,1050,1.850521);
   ...
   gre->SetPoint(0,-700,1.74148);
   gre->SetPointError(0,0,0.01507209);
   gre->SetPoint(1,-500,1.745);
   gre->SetPointError(1,0,0.005346769);
   gre->SetPoint(2,-300,1.67214);
   gre->SetPointError(2,0,0.01038178);
   gre->SetPoint(3,-100,1.75404);
   gre->SetPointError(3,0,0.02073262);
   gre->SetPoint(4,100,1.77434);
   gre->SetPointError(4,0,0.03842845);
   gre->SetPoint(5,300,1.738);
   gre->SetPointError(5,0,0.02075249);
   gre->SetPoint(6,500,1.71616);
   gre->SetPointError(6,0,0.02372547);
   gre->SetPoint(7,700,1.74192);
   gre->SetPointError(7,0,0.0465188);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LTB.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.646657);
   Graph_Graph43->SetMaximum(1.827869);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(40.41012);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.178139e-05);
   linear_fit->SetParError(0,1.518009e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.723831);
   linear_fit->SetParError(1,0.007199446);
