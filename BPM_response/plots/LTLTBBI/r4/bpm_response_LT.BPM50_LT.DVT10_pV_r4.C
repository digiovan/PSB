...
//=========  (Wed Apr  1 22:34:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-5.756777,1050,7.977803);
   ...
   gre->SetPoint(0,-700,5.65758);
   gre->SetPointError(0,0,0.03112653);
   gre->SetPoint(1,-500,3.334);
   gre->SetPointError(1,0,0.01274763);
   gre->SetPoint(2,-300,2.16968);
   gre->SetPointError(2,0,0.05042548);
   gre->SetPoint(3,-100,0.99382);
   gre->SetPointError(3,0,0.02575236);
   gre->SetPoint(4,100,-0.35732);
   gre->SetPointError(4,0,0.004411426);
   gre->SetPoint(5,300,-1.69704);
   gre->SetPointError(5,0,0.02658497);
   gre->SetPoint(6,500,-3.15762);
   gre->SetPointError(6,0,0.04225761);
   gre->SetPoint(7,700,-3.45934);
   gre->SetPointError(7,0,0.008340109);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-4.383319);
   Graph_Graph47->SetMaximum(6.604345);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3639.275);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005718049);
   linear_fit->SetParError(0,1.111379e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.3141845);
   linear_fit->SetParError(1,0.003993719);
