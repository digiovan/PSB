...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-1.817864,1050,-1.708231);
   ...
   gre->SetPoint(0,-700,-1.7478);
   gre->SetPointError(0,0,0.005172971);
   gre->SetPoint(1,-500,-1.73596);
   gre->SetPointError(1,0,0.009456709);
   gre->SetPoint(2,-300,-1.74474);
   gre->SetPointError(2,0,0.009665976);
   gre->SetPoint(3,-100,-1.76146);
   gre->SetPointError(3,0,0.008079583);
   gre->SetPoint(4,100,-1.77066);
   gre->SetPointError(4,0,0.01460102);
   gre->SetPoint(5,300,-1.75884);
   gre->SetPointError(5,0,0.004459451);
   gre->SetPoint(6,500,-1.74458);
   gre->SetPointError(6,0,0.006309464);
   gre->SetPoint(7,700,-1.79346);
   gre->SetPointError(7,0,0.006131694);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.806901);
   Graph_Graph47->SetMaximum(-1.719194);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.81182);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.060365e-05);
   linear_fit->SetParError(0,4.686535e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.756787);
   linear_fit->SetParError(1,0.00236365);
