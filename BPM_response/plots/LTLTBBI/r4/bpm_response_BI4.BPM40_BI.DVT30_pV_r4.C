...
//=========  (Wed Apr  1 22:36:15 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-10.24693,1050,7.238087);
   ...
   gre->SetPoint(0,-700,-2.00292);
   gre->SetPointError(0,0,1.861073);
   gre->SetPoint(1,-500,-6.84706);
   gre->SetPointError(1,0,0.4857015);
   gre->SetPoint(2,-300,-4.32048);
   gre->SetPointError(2,0,0.585486);
   gre->SetPoint(3,-100,-4.35774);
   gre->SetPointError(3,0,0.1126896);
   gre->SetPoint(4,100,-2.52648);
   gre->SetPointError(4,0,1.328014);
   gre->SetPoint(5,300,-2.85964);
   gre->SetPointError(5,0,0.7599091);
   gre->SetPoint(6,500,-1.0634);
   gre->SetPointError(6,0,0.258742);
   gre->SetPoint(7,700,1.7531);
   gre->SetPointError(7,0,2.570818);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: BI.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-8.498429);
   Graph_Graph55->SetMaximum(5.489585);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.43875);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005235806);
   linear_fit->SetParError(0,0.0004036063);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.785287);
   linear_fit->SetParError(1,0.09891418);
