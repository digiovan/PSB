...
//=========  (Wed Apr  1 22:34:51 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-23.31995,1050,8.352875);
   ...
   gre->SetPoint(0,-700,2.98252);
   gre->SetPointError(0,0,0.09155016);
   gre->SetPoint(1,-500,-0.27702);
   gre->SetPointError(1,0,0.2560997);
   gre->SetPoint(2,-300,-2.51904);
   gre->SetPointError(2,0,0.2701636);
   gre->SetPoint(3,-100,-5.87198);
   gre->SetPointError(3,0,0.6746368);
   gre->SetPoint(4,100,-7.89342);
   gre->SetPointError(4,0,1.669699);
   gre->SetPoint(5,300,-10.64704);
   gre->SetPointError(5,0,0.1107311);
   gre->SetPoint(6,500,-13.164);
   gre->SetPointError(6,0,0.5717521);
   gre->SetPoint(7,700,-17.20668);
   gre->SetPointError(7,0,0.8344697);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-20.15267);
   Graph_Graph56->SetMaximum(5.185592);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.741472);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01362235);
   linear_fit->SetParError(0,0.000137921);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.603569);
   linear_fit->SetParError(1,0.0762205);
