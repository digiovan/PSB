...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,2.385011,1050,3.607157);
   ...
   gre->SetPoint(0,-700,3.16094);
   gre->SetPointError(0,0,0.04702937);
   gre->SetPoint(1,-500,3.18054);
   gre->SetPointError(1,0,0.06784855);
   gre->SetPoint(2,-300,2.64142);
   gre->SetPointError(2,0,0.05271792);
   gre->SetPoint(3,-100,3.35678);
   gre->SetPointError(3,0,0.04668602);
   gre->SetPoint(4,100,3.29856);
   gre->SetPointError(4,0,0.04615075);
   gre->SetPoint(5,300,2.81628);
   gre->SetPointError(5,0,0.1092566);
   gre->SetPoint(6,500,3.14488);
   gre->SetPointError(6,0,0.04062758);
   gre->SetPoint(7,700,3.20076);
   gre->SetPointError(7,0,0.1597612);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(2.507226);
   Graph_Graph50->SetMaximum(3.484942);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(129.7845);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.168709e-05);
   linear_fit->SetParError(0,4.544903e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.141359);
   linear_fit->SetParError(1,0.01952382);
