...
//=========  (Wed Apr  1 22:36:09 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,1.62006,1050,2.721821);
   ...
   gre->SetPoint(0,-700,2.2234);
   gre->SetPointError(0,0,0.04703709);
   gre->SetPoint(1,-500,2.23842);
   gre->SetPointError(1,0,0.1994924);
   gre->SetPoint(2,-300,2.06174);
   gre->SetPointError(2,0,0.1518061);
   gre->SetPoint(3,-100,1.9603);
   gre->SetPointError(3,0,0.1566133);
   gre->SetPoint(4,100,2.26986);
   gre->SetPointError(4,0,0.07502716);
   gre->SetPoint(5,300,2.4863);
   gre->SetPointError(5,0,0.05189377);
   gre->SetPoint(6,500,2.02826);
   gre->SetPointError(6,0,0.07554892);
   gre->SetPoint(7,700,2.26356);
   gre->SetPointError(7,0,0.05579064);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(1.730236);
   Graph_Graph48->SetMaximum(2.611644);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(33.43159);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.545922e-05);
   linear_fit->SetParError(0,4.64841e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.262536);
   linear_fit->SetParError(1,0.02510043);
