...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   gre->SetPoint(0,-700,-10.14952);
   gre->SetPointError(0,0,0.03954145);
   gre->SetPoint(1,-500,-7.55122);
   gre->SetPointError(1,0,0.01493334);
   gre->SetPoint(2,-300,-5.02602);
   gre->SetPointError(2,0,0.0993139);
   gre->SetPoint(3,-100,-2.61776);
   gre->SetPointError(3,0,0.006622608);
   gre->SetPoint(4,100,-0.12354);
   gre->SetPointError(4,0,0.07781938);
   gre->SetPoint(5,300,2.11792);
   gre->SetPointError(5,0,0.04227515);
   gre->SetPoint(6,500,4.28768);
   gre->SetPointError(6,0,0.02930052);
   gre->SetPoint(7,700,6.81754);
   gre->SetPointError(7,0,0.02353735);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-11.89208);
   Graph_Graph53->SetMaximum(8.544091);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(233.378);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01196996);
   linear_fit->SetParError(0,1.953226e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.466988);
   linear_fit->SetParError(1,0.005905116);
