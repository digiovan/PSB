...
//=========  (Wed Apr  1 22:34:13 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,0.7046018,1050,2.815846);
   ...
   gre->SetPoint(0,-700,1.07518);
   gre->SetPointError(0,0,0.01870421);
   gre->SetPoint(1,-500,1.40112);
   gre->SetPointError(1,0,0.008666181);
   gre->SetPoint(2,-300,1.60982);
   gre->SetPointError(2,0,0.01445962);
   gre->SetPoint(3,-100,1.74702);
   gre->SetPointError(3,0,0.0449038);
   gre->SetPoint(4,100,1.89546);
   gre->SetPointError(4,0,0.029678);
   gre->SetPoint(5,300,2.21936);
   gre->SetPointError(5,0,0.01992399);
   gre->SetPoint(6,500,2.32364);
   gre->SetPointError(6,0,0.01243038);
   gre->SetPoint(7,700,2.43114);
   gre->SetPointError(7,0,0.03283173);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(0.9157262);
   Graph_Graph43->SetMaximum(2.604721);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(77.24704);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0009550496);
   linear_fit->SetParError(0,1.232572e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.860495);
   linear_fit->SetParError(1,0.005910799);
