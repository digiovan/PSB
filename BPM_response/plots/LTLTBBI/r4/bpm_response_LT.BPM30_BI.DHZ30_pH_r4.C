...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-9.556721,1050,-9.136084);
   ...
   gre->SetPoint(0,-700,-9.3445);
   gre->SetPointError(0,0,0.02143486);
   gre->SetPoint(1,-500,-9.35294);
   gre->SetPointError(1,0,0.07397726);
   gre->SetPoint(2,-300,-9.41558);
   gre->SetPointError(2,0,0.07103509);
   gre->SetPoint(3,-100,-9.41298);
   gre->SetPointError(3,0,0.05520817);
   gre->SetPoint(4,100,-9.30852);
   gre->SetPointError(4,0,0.03928469);
   gre->SetPoint(5,300,-9.23462);
   gre->SetPointError(5,0,0.02842995);
   gre->SetPoint(6,500,-9.38446);
   gre->SetPointError(6,0,0.022004);
   gre->SetPoint(7,700,-9.302);
   gre->SetPointError(7,0,0.02273463);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-9.514658);
   Graph_Graph45->SetMaximum(-9.178148);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.43501);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.992456e-05);
   linear_fit->SetParError(0,1.97122e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.333255);
   linear_fit->SetParError(1,0.01096829);
