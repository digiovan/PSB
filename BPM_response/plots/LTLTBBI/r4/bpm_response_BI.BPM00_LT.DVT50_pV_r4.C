...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-9.864702,1050,7.920124);
   ...
   gre->SetPoint(0,-700,4.9356);
   gre->SetPointError(0,0,0.02038619);
   gre->SetPoint(1,-500,3.1686);
   gre->SetPointError(1,0,0.02234276);
   gre->SetPoint(2,-300,1.43406);
   gre->SetPointError(2,0,0.02549665);
   gre->SetPoint(3,-100,-0.2272);
   gre->SetPointError(3,0,0.01082566);
   gre->SetPoint(4,100,-1.92736);
   gre->SetPointError(4,0,0.0407961);
   gre->SetPoint(5,300,-3.50426);
   gre->SetPointError(5,0,0.01171176);
   gre->SetPoint(6,500,-5.11542);
   gre->SetPointError(6,0,0.01132467);
   gre->SetPoint(7,700,-6.8819);
   gre->SetPointError(7,0,0.01866458);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-8.08622);
   Graph_Graph51->SetMaximum(6.141641);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(94.59305);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008329684);
   linear_fit->SetParError(0,1.360924e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.006372);
   linear_fit->SetParError(1,0.005761527);
