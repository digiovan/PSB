...
//=========  (Wed Apr  1 22:35:38 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_H_4->Range(-1050,-14.23276,1050,10.51491);
   ...
   gre->SetPoint(0,-700,5.60916);
   gre->SetPointError(0,0,0.7811371);
   gre->SetPoint(1,-500,3.6432);
   gre->SetPointError(1,0,0.1303227);
   gre->SetPoint(2,-300,2.16222);
   gre->SetPointError(2,0,0.1720703);
   gre->SetPoint(3,-100,1.23288);
   gre->SetPointError(3,0,0.4063341);
   gre->SetPoint(4,100,1.4867);
   gre->SetPointError(4,0,0.2314989);
   gre->SetPoint(5,300,-1.79942);
   gre->SetPointError(5,0,0.6146098);
   gre->SetPoint(6,500,-5.5967);
   gre->SetPointError(6,0,0.5860235);
   gre->SetPoint(7,700,-9.49308);
   gre->SetPointError(7,0,0.6150704);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-11.758);
   Graph_Graph55->SetMaximum(8.040142);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(149.8042);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00722914);
   linear_fit->SetParError(0,0.0002982317);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.2371884);
   linear_fit->SetParError(1,0.1213766);
