...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.638046,1050,1.826738);
   ...
   gre->SetPoint(0,-700,1.73402);
   gre->SetPointError(0,0,0.02217902);
   gre->SetPoint(1,-500,1.72604);
   gre->SetPointError(1,0,0.02057925);
   gre->SetPoint(2,-300,1.7171);
   gre->SetPointError(2,0,0.009583098);
   gre->SetPoint(3,-100,1.77142);
   gre->SetPointError(3,0,0.01324858);
   gre->SetPoint(4,100,1.77366);
   gre->SetPointError(4,0,0.02162958);
   gre->SetPoint(5,300,1.69282);
   gre->SetPointError(5,0,0.02332501);
   gre->SetPoint(6,500,1.73192);
   gre->SetPointError(6,0,0.01568652);
   gre->SetPoint(7,700,1.7343);
   gre->SetPointError(7,0,0.02150797);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.656916);
   Graph_Graph43->SetMaximum(1.807869);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.58638);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.496525e-06);
   linear_fit->SetParError(0,1.452485e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.73475);
   linear_fit->SetParError(1,0.005749299);
