...
//=========  (Wed Apr  1 22:36:20 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,0.7421785,1050,0.9194615);
   ...
   gre->SetPoint(0,-700,0.8498);
   gre->SetPointError(0,0,0.01179785);
   gre->SetPoint(1,-500,0.83832);
   gre->SetPointError(1,0,0.02778502);
   gre->SetPoint(2,-300,0.81146);
   gre->SetPointError(2,0,0.02114147);
   gre->SetPoint(3,-100,0.82274);
   gre->SetPointError(3,0,0.006990037);
   gre->SetPoint(4,100,0.83082);
   gre->SetPointError(4,0,0.05909435);
   gre->SetPoint(5,300,0.826);
   gre->SetPointError(5,0,0.01188835);
   gre->SetPoint(6,500,0.85336);
   gre->SetPointError(6,0,0.03068244);
   gre->SetPoint(7,700,0.85144);
   gre->SetPointError(7,0,0.003536062);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(0.7599068);
   Graph_Graph50->SetMaximum(0.9017332);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.06839);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.821016e-05);
   linear_fit->SetParError(0,6.563821e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8363466);
   linear_fit->SetParError(1,0.003997026);
