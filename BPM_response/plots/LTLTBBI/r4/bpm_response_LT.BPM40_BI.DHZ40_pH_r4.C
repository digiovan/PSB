...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.4619476,1050,-0.3642191);
   ...
   gre->SetPoint(0,-700,-0.39032);
   gre->SetPointError(0,0,0.009812787);
   gre->SetPoint(1,-500,-0.41186);
   gre->SetPointError(1,0,0.006611617);
   gre->SetPoint(2,-300,-0.4246);
   gre->SetPointError(2,0,0.02105955);
   gre->SetPoint(3,-100,-0.40422);
   gre->SetPointError(3,0,0.007587903);
   gre->SetPoint(4,100,-0.41548);
   gre->SetPointError(4,0,0.0151898);
   gre->SetPoint(5,300,-0.40058);
   gre->SetPointError(5,0,0.002332008);
   gre->SetPoint(6,500,-0.4154);
   gre->SetPointError(6,0,0.005571025);
   gre->SetPoint(7,700,-0.40178);
   gre->SetPointError(7,0,0.01194146);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.4521748);
   Graph_Graph46->SetMaximum(-0.373992);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.18405);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.203931e-07);
   linear_fit->SetParError(0,5.946251e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4034196);
   linear_fit->SetParError(1,0.0022255);
