...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-11.49284,1050,-10.94438);
   ...
   gre->SetPoint(0,-700,-11.24248);
   gre->SetPointError(0,0,0.08670964);
   gre->SetPoint(1,-500,-11.34892);
   gre->SetPointError(1,0,0.05251374);
   gre->SetPoint(2,-300,-11.24266);
   gre->SetPointError(2,0,0.06473595);
   gre->SetPoint(3,-100,-11.32792);
   gre->SetPointError(3,0,0.05498315);
   gre->SetPoint(4,100,-11.11302);
   gre->SetPointError(4,0,0.07723027);
   gre->SetPoint(5,300,-11.31766);
   gre->SetPointError(5,0,0.02480925);
   gre->SetPoint(6,500,-11.22238);
   gre->SetPointError(6,0,0.0254022);
   gre->SetPoint(7,700,-11.24594);
   gre->SetPointError(7,0,0.03951061);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-11.438);
   Graph_Graph45->SetMaximum(-10.99923);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.12237);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.773335e-05);
   linear_fit->SetParError(0,3.864364e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.28532);
   linear_fit->SetParError(1,0.01745475);
