...
//=========  (Wed Apr  1 22:35:48 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-10.58241,1050,1.84712);
   ...
   gre->SetPoint(0,-700,-8.466);
   gre->SetPointError(0,0,0.04481809);
   gre->SetPoint(1,-500,-7.38036);
   gre->SetPointError(1,0,0.04041079);
   gre->SetPoint(2,-300,-6.2377);
   gre->SetPointError(2,0,0.2574424);
   gre->SetPoint(3,-100,-5.0001);
   gre->SetPointError(3,0,0.06787233);
   gre->SetPoint(4,100,-3.58558);
   gre->SetPointError(4,0,0.0687766);
   gre->SetPoint(5,300,-2.80496);
   gre->SetPointError(5,0,0.08576414);
   gre->SetPoint(6,500,-1.27304);
   gre->SetPointError(6,0,0.05453548);
   gre->SetPoint(7,700,-0.31924);
   gre->SetPointError(7,0,0.09477223);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-9.339453);
   Graph_Graph52->SetMaximum(0.6041673);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.28061);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005953939);
   linear_fit->SetParError(0,4.524676e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.34954);
   linear_fit->SetParError(1,0.02302627);
