...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-0.4686795,1050,-0.1632485);
   ...
   gre->SetPoint(0,-700,-0.36156);
   gre->SetPointError(0,0,0.02677249);
   gre->SetPoint(1,-500,-0.36232);
   gre->SetPointError(1,0,0.05545435);
   gre->SetPoint(2,-300,-0.35822);
   gre->SetPointError(2,0,0.0132711);
   gre->SetPoint(3,-100,-0.32152);
   gre->SetPointError(3,0,0.02091579);
   gre->SetPoint(4,100,-0.25988);
   gre->SetPointError(4,0,0.04572629);
   gre->SetPoint(5,300,-0.35798);
   gre->SetPointError(5,0,0.00621372);
   gre->SetPoint(6,500,-0.33598);
   gre->SetPointError(6,0,0.00664795);
   gre->SetPoint(7,700,-0.3402);
   gre->SetPointError(7,0,0.03402168);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-0.4381364);
   Graph_Graph47->SetMaximum(-0.1937916);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.75017);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.638068e-05);
   linear_fit->SetParError(0,1.407019e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3518902);
   linear_fit->SetParError(1,0.005682781);
