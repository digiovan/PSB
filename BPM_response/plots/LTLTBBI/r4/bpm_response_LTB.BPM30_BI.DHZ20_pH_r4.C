...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,0.737638,1050,0.9366884);
   ...
   gre->SetPoint(0,-700,0.84232);
   gre->SetPointError(0,0,0.009924874);
   gre->SetPoint(1,-500,0.84088);
   gre->SetPointError(1,0,0.01105718);
   gre->SetPoint(2,-300,0.78718);
   gre->SetPointError(2,0,0.01636697);
   gre->SetPoint(3,-100,0.84466);
   gre->SetPointError(3,0,0.05885334);
   gre->SetPoint(4,100,0.82278);
   gre->SetPointError(4,0,0.006986295);
   gre->SetPoint(5,300,0.84556);
   gre->SetPointError(5,0,0.003796546);
   gre->SetPoint(6,500,0.8515);
   gre->SetPointError(6,0,0.01719785);
   gre->SetPoint(7,700,0.86884);
   gre->SetPointError(7,0,0.02546543);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(0.757543);
   Graph_Graph50->SetMaximum(0.9167834);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.19649);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.262399e-05);
   linear_fit->SetParError(0,8.481673e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8381515);
   linear_fit->SetParError(1,0.003076069);
