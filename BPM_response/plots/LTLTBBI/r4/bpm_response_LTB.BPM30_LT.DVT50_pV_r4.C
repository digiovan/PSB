...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,-10.9835,1050,16.12768);
   ...
   gre->SetPoint(0,-700,-6.3905);
   gre->SetPointError(0,0,0.0744728);
   gre->SetPoint(1,-500,-3.77836);
   gre->SetPointError(1,0,0.04121871);
   gre->SetPoint(2,-300,-1.01366);
   gre->SetPointError(2,0,0.1221811);
   gre->SetPoint(3,-100,1.65018);
   gre->SetPointError(3,0,0.05114606);
   gre->SetPoint(4,100,4.29568);
   gre->SetPointError(4,0,0.03209054);
   gre->SetPoint(5,300,6.68436);
   gre->SetPointError(5,0,0.1317234);
   gre->SetPoint(6,500,8.9529);
   gre->SetPointError(6,0,0.06031445);
   gre->SetPoint(7,700,11.54518);
   gre->SetPointError(7,0,0.0639688);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-8.272385);
   Graph_Graph50->SetMaximum(13.41656);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(106.5417);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01286035);
   linear_fit->SetParError(0,4.726761e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.799977);
   linear_fit->SetParError(1,0.01903763);
