...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-11.51189,1050,-10.89561);
   ...
   gre->SetPoint(0,-700,-11.12764);
   gre->SetPointError(0,0,0.05120028);
   gre->SetPoint(1,-500,-11.22176);
   gre->SetPointError(1,0,0.1189594);
   gre->SetPoint(2,-300,-11.29514);
   gre->SetPointError(2,0,0.05692765);
   gre->SetPoint(3,-100,-11.30354);
   gre->SetPointError(3,0,0.1056362);
   gre->SetPoint(4,100,-11.19128);
   gre->SetPointError(4,0,0.1929538);
   gre->SetPoint(5,300,-11.28782);
   gre->SetPointError(5,0,0.05468412);
   gre->SetPoint(6,500,-11.3502);
   gre->SetPointError(6,0,0.04469875);
   gre->SetPoint(7,700,-11.14878);
   gre->SetPointError(7,0,0.05829645);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-11.45026);
   Graph_Graph45->SetMaximum(-10.95724);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.66873);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.057082e-05);
   linear_fit->SetParError(0,4.381509e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.24528);
   linear_fit->SetParError(1,0.02258162);
