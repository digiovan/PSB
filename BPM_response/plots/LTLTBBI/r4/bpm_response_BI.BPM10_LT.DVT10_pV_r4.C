...
//=========  (Wed Apr  1 22:34:19 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-2.086166,1050,9.796056);
   ...
   gre->SetPoint(0,-700,7.72876);
   gre->SetPointError(0,0,0.08692586);
   gre->SetPoint(1,-500,6.17404);
   gre->SetPointError(1,0,0.06207716);
   gre->SetPoint(2,-300,5.08924);
   gre->SetPointError(2,0,0.148992);
   gre->SetPoint(3,-100,4.02186);
   gre->SetPointError(3,0,0.1433858);
   gre->SetPoint(4,100,2.83616);
   gre->SetPointError(4,0,0.06534417);
   gre->SetPoint(5,300,1.82612);
   gre->SetPointError(5,0,0.05840581);
   gre->SetPoint(6,500,0.82174);
   gre->SetPointError(6,0,0.06531655);
   gre->SetPoint(7,700,-0.07664);
   gre->SetPointError(7,0,0.02915565);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-0.8979438);
   Graph_Graph52->SetMaximum(8.607834);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(51.1239);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005322091);
   linear_fit->SetParError(0,4.358273e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.577036);
   linear_fit->SetParError(1,0.02500836);
