...
//=========  (Wed Apr  1 22:34:24 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,-14.51159,1050,17.89924);
   ...
   gre->SetPoint(0,-700,-8.91954);
   gre->SetPointError(0,0,0.1902476);
   gre->SetPoint(1,-500,-6.67478);
   gre->SetPointError(1,0,0.09626905);
   gre->SetPoint(2,-300,-3.47626);
   gre->SetPointError(2,0,0.3322861);
   gre->SetPoint(3,-100,0.33104);
   gre->SetPointError(3,0,0.0856202);
   gre->SetPoint(4,100,3.81418);
   gre->SetPointError(4,0,0.09430703);
   gre->SetPoint(5,300,6.08448);
   gre->SetPointError(5,0,0.1827368);
   gre->SetPoint(6,500,8.43686);
   gre->SetPointError(6,0,0.0745413);
   gre->SetPoint(7,700,12.39918);
   gre->SetPointError(7,0,0.09825294);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(-11.27051);
   Graph_Graph48->SetMaximum(14.65815);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(211.7662);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01514799);
   linear_fit->SetParError(0,8.770282e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.486643);
   linear_fit->SetParError(1,0.03934307);
