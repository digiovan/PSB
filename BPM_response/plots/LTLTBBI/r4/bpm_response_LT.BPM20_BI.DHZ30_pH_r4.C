...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-7.765034,1050,-7.341125);
   ...
   gre->SetPoint(0,-700,-7.56584);
   gre->SetPointError(0,0,0.03252423);
   gre->SetPoint(1,-500,-7.56548);
   gre->SetPointError(1,0,0.07728785);
   gre->SetPoint(2,-300,-7.61634);
   gre->SetPointError(2,0,0.07804282);
   gre->SetPoint(3,-100,-7.62624);
   gre->SetPointError(3,0,0.06116529);
   gre->SetPoint(4,100,-7.51336);
   gre->SetPointError(4,0,0.04098759);
   gre->SetPoint(5,300,-7.4352);
   gre->SetPointError(5,0,0.02342351);
   gre->SetPoint(6,500,-7.58102);
   gre->SetPointError(6,0,0.01770039);
   gre->SetPoint(7,700,-7.5167);
   gre->SetPointError(7,0,0.01784661);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.722643);
   Graph_Graph44->SetMaximum(-7.383516);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(29.58483);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.266029e-05);
   linear_fit->SetParError(0,2.36703e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.539638);
   linear_fit->SetParError(1,0.01283995);
