...
//=========  (Wed Apr  1 22:36:14 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,1.970652,1050,3.02283);
   ...
   gre->SetPoint(0,-700,2.3045);
   gre->SetPointError(0,0,0.1584845);
   gre->SetPoint(1,-500,2.8135);
   gre->SetPointError(1,0,0.03396736);
   gre->SetPoint(2,-300,2.64776);
   gre->SetPointError(2,0,0.03169963);
   gre->SetPoint(3,-100,2.69206);
   gre->SetPointError(3,0,0.08591404);
   gre->SetPoint(4,100,2.49726);
   gre->SetPointError(4,0,0.1246676);
   gre->SetPoint(5,300,2.66142);
   gre->SetPointError(5,0,0.05324575);
   gre->SetPoint(6,500,2.63666);
   gre->SetPointError(6,0,0.1690771);
   gre->SetPoint(7,700,2.33036);
   gre->SetPointError(7,0,0.1424601);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: BI.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(2.07587);
   Graph_Graph49->SetMaximum(2.917613);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.47981);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001864369);
   linear_fit->SetParError(0,6.372698e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.648365);
   linear_fit->SetParError(1,0.02505485);
