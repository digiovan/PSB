...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_4->Range(-1050,-8.256345,1050,-7.7361);
   ...
   gre->SetPoint(0,-700,-7.94566);
   gre->SetPointError(0,0,0.1090222);
   gre->SetPoint(1,-500,-8.04626);
   gre->SetPointError(1,0,0.04369077);
   gre->SetPoint(2,-300,-7.91924);
   gre->SetPointError(2,0,0.09643249);
   gre->SetPoint(3,-100,-8.04648);
   gre->SetPointError(3,0,0.04596165);
   gre->SetPoint(4,100,-7.94768);
   gre->SetPointError(4,0,0.07602533);
   gre->SetPoint(5,300,-7.9837);
   gre->SetPointError(5,0,0.01465972);
   gre->SetPoint(6,500,-8.05954);
   gre->SetPointError(6,0,0.06655682);
   gre->SetPoint(7,700,-8.13186);
   gre->SetPointError(7,0,0.03777765);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-8.204321);
   Graph_Graph46->SetMaximum(-7.788124);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(16.23988);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.22961e-05);
   linear_fit->SetParError(0,3.98219e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.997919);
   linear_fit->SetParError(1,0.01516654);
