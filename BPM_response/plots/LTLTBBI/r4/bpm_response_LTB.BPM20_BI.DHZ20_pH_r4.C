...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_4->Range(-1050,3.864524,1050,4.573002);
   ...
   gre->SetPoint(0,-700,4.11268);
   gre->SetPointError(0,0,0.04195567);
   gre->SetPoint(1,-500,4.0628);
   gre->SetPointError(1,0,0.08019634);
   gre->SetPoint(2,-300,4.10012);
   gre->SetPointError(2,0,0.03813398);
   gre->SetPoint(3,-100,4.2523);
   gre->SetPointError(3,0,0.1565901);
   gre->SetPoint(4,100,4.2898);
   gre->SetPointError(4,0,0.08307953);
   gre->SetPoint(5,300,4.16082);
   gre->SetPointError(5,0,0.05166994);
   gre->SetPoint(6,500,4.1342);
   gre->SetPointError(6,0,0.04290578);
   gre->SetPoint(7,700,4.4035);
   gre->SetPointError(7,0,0.05142244);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(3.935372);
   Graph_Graph49->SetMaximum(4.502154);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.63776);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001331046);
   linear_fit->SetParError(0,3.686985e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.167184);
   linear_fit->SetParError(1,0.01859468);
