...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.4814777,1050,-0.3504899);
   ...
   gre->SetPoint(0,-700,-0.43182);
   gre->SetPointError(0,0,0.02782639);
   gre->SetPoint(1,-500,-0.38442);
   gre->SetPointError(1,0,0.009716783);
   gre->SetPoint(2,-300,-0.38814);
   gre->SetPointError(2,0,0.003719027);
   gre->SetPoint(3,-100,-0.40694);
   gre->SetPointError(3,0,0.008354243);
   gre->SetPoint(4,100,-0.39264);
   gre->SetPointError(4,0,0.004082737);
   gre->SetPoint(5,300,-0.37712);
   gre->SetPointError(5,0,0.004798835);
   gre->SetPoint(6,500,-0.39006);
   gre->SetPointError(6,0,0.003714274);
   gre->SetPoint(7,700,-0.4134);
   gre->SetPointError(7,0,0.00327034);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.4683789);
   Graph_Graph46->SetMaximum(-0.3635886);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(40.84538);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.650679e-05);
   linear_fit->SetParError(0,4.238239e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3910487);
   linear_fit->SetParError(1,0.001956154);
