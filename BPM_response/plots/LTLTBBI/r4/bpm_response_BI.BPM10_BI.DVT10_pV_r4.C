...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-2.796631,1050,9.860772);
   ...
   gre->SetPoint(0,-700,-0.57954);
   gre->SetPointError(0,0,0.1075237);
   gre->SetPoint(1,-500,0.58702);
   gre->SetPointError(1,0,0.04747763);
   gre->SetPoint(2,-300,1.7114);
   gre->SetPointError(2,0,0.1709679);
   gre->SetPoint(3,-100,2.74304);
   gre->SetPointError(3,0,0.1506274);
   gre->SetPoint(4,100,3.99808);
   gre->SetPointError(4,0,0.06106633);
   gre->SetPoint(5,300,4.98652);
   gre->SetPointError(5,0,0.04636266);
   gre->SetPoint(6,500,6.35756);
   gre->SetPointError(6,0,0.06262418);
   gre->SetPoint(7,700,7.66908);
   gre->SetPointError(7,0,0.08212492);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-1.530891);
   Graph_Graph52->SetMaximum(8.595032);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.4071);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005747014);
   linear_fit->SetParError(0,5.488567e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.416266);
   linear_fit->SetParError(1,0.02414676);
