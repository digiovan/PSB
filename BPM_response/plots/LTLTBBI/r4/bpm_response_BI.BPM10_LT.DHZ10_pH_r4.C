...
//=========  (Wed Apr  1 22:34:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_4->Range(-1050,-10.04036,1050,0.8383619);
   ...
   gre->SetPoint(0,-700,-8.1072);
   gre->SetPointError(0,0,0.1200393);
   gre->SetPoint(1,-500,-6.57068);
   gre->SetPointError(1,0,0.05743366);
   gre->SetPoint(2,-300,-5.65342);
   gre->SetPointError(2,0,0.04519455);
   gre->SetPoint(3,-100,-5.02694);
   gre->SetPointError(3,0,0.09554397);
   gre->SetPoint(4,100,-4.26682);
   gre->SetPointError(4,0,0.1217073);
   gre->SetPoint(5,300,-2.42168);
   gre->SetPointError(5,0,0.1835024);
   gre->SetPoint(6,500,-1.7156);
   gre->SetPointError(6,0,0.06419663);
   gre->SetPoint(7,700,-1.11962);
   gre->SetPointError(7,0,0.1448616);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-8.952487);
   Graph_Graph52->SetMaximum(-0.2495104);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(55.86409);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004870486);
   linear_fit->SetParError(0,6.797742e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.258969);
   linear_fit->SetParError(1,0.02870199);
