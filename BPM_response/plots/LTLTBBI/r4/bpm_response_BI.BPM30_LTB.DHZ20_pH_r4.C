...
//=========  (Wed Apr  1 22:35:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,-4.346869,1050,19.43078);
   ...
   gre->SetPoint(0,-700,15.40804);
   gre->SetPointError(0,0,0.05979899);
   gre->SetPoint(1,-500,12.9389);
   gre->SetPointError(1,0,0.09565876);
   gre->SetPoint(2,-300,10.70042);
   gre->SetPointError(2,0,0.08996226);
   gre->SetPoint(3,-100,8.67944);
   gre->SetPointError(3,0,0.02661293);
   gre->SetPoint(4,100,6.66652);
   gre->SetPointError(4,0,0.03140174);
   gre->SetPoint(5,300,4.2529);
   gre->SetPointError(5,0,0.04153152);
   gre->SetPoint(6,500,1.9704);
   gre->SetPointError(6,0,0.05484707);
   gre->SetPoint(7,700,-0.33306);
   gre->SetPointError(7,0,0.0508669);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LTB.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-1.969103);
   Graph_Graph54->SetMaximum(17.05302);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(55.99482);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01114989);
   linear_fit->SetParError(0,4.448046e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.602316);
   linear_fit->SetParError(1,0.0156479);
