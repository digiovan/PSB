...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,-11.87246,1050,17.57185);
   ...
   gre->SetPoint(0,-700,12.55338);
   gre->SetPointError(0,0,0.1110872);
   gre->SetPoint(1,-500,9.45176);
   gre->SetPointError(1,0,0.04654164);
   gre->SetPoint(2,-300,6.84968);
   gre->SetPointError(2,0,0.04513487);
   gre->SetPoint(3,-100,3.9603);
   gre->SetPointError(3,0,0.0354931);
   gre->SetPoint(4,100,1.54086);
   gre->SetPointError(4,0,0.09318934);
   gre->SetPoint(5,300,-1.22254);
   gre->SetPointError(5,0,0.08307146);
   gre->SetPoint(6,500,-4.21884);
   gre->SetPointError(6,0,0.0553997);
   gre->SetPoint(7,700,-6.93644);
   gre->SetPointError(7,0,0.02863345);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(-8.928028);
   Graph_Graph49->SetMaximum(14.62742);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.71629);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01371397);
   linear_fit->SetParError(0,3.502869e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.669323);
   linear_fit->SetParError(1,0.01743995);
