...
//=========  (Wed Apr  1 22:34:24 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,5.923335,1050,10.68443);
   ...
   gre->SetPoint(0,-700,9.88894);
   gre->SetPointError(0,0,0.001975777);
   gre->SetPoint(1,-500,9.59022);
   gre->SetPointError(1,0,0.0468955);
   gre->SetPoint(2,-300,9.18782);
   gre->SetPointError(2,0,0.01492448);
   gre->SetPoint(3,-100,8.59458);
   gre->SetPointError(3,0,0.02009236);
   gre->SetPoint(4,100,8.13788);
   gre->SetPointError(4,0,0.03854645);
   gre->SetPoint(5,300,7.93488);
   gre->SetPointError(5,0,0.0425293);
   gre->SetPoint(6,500,7.64082);
   gre->SetPointError(6,0,0.02439509);
   gre->SetPoint(7,700,6.73634);
   gre->SetPointError(7,0,0.01948846);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(6.399445);
   Graph_Graph53->SetMaximum(10.20832);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(353.5745);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002100351);
   linear_fit->SetParError(0,1.009736e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.420653);
   linear_fit->SetParError(1,0.006959005);
