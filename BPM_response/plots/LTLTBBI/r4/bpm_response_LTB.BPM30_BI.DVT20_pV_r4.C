...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_4->Range(-1050,2.866926,1050,3.520532);
   ...
   gre->SetPoint(0,-700,3.10716);
   gre->SetPointError(0,0,0.1089289);
   gre->SetPoint(1,-500,3.34704);
   gre->SetPointError(1,0,0.06455777);
   gre->SetPoint(2,-300,3.21214);
   gre->SetPointError(2,0,0.03580366);
   gre->SetPoint(3,-100,3.36748);
   gre->SetPointError(3,0,0.03619258);
   gre->SetPoint(4,100,3.22078);
   gre->SetPointError(4,0,0.09457174);
   gre->SetPoint(5,300,3.35754);
   gre->SetPointError(5,0,0.05273683);
   gre->SetPoint(6,500,3.03798);
   gre->SetPointError(6,0,0.06211963);
   gre->SetPoint(7,700,3.25126);
   gre->SetPointError(7,0,0.07211541);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(2.932287);
   Graph_Graph50->SetMaximum(3.455172);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(29.74318);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.725583e-05);
   linear_fit->SetParError(0,5.215891e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.266872);
   linear_fit->SetParError(1,0.01903391);
