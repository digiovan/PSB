...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-16.11157,1050,1.532468);
   ...
   gre->SetPoint(0,-700,-12.91226);
   gre->SetPointError(0,0,0.2586402);
   gre->SetPoint(1,-500,-10.86354);
   gre->SetPointError(1,0,0.04856703);
   gre->SetPoint(2,-300,-9.15064);
   gre->SetPointError(2,0,0.08119681);
   gre->SetPoint(3,-100,-7.37702);
   gre->SetPointError(3,0,0.09116007);
   gre->SetPoint(4,100,-6.04854);
   gre->SetPointError(4,0,0.03326558);
   gre->SetPoint(5,300,-4.47138);
   gre->SetPointError(5,0,0.1821696);
   gre->SetPoint(6,500,-2.90542);
   gre->SetPointError(6,0,0.07760766);
   gre->SetPoint(7,700,-1.48554);
   gre->SetPointError(7,0,0.07733461);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-14.34717);
   Graph_Graph51->SetMaximum(-0.2319359);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.51678);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.007877624);
   linear_fit->SetParError(0,6.164355e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.855185);
   linear_fit->SetParError(1,0.02249315);
