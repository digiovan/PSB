...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-0.4314383,1050,-0.2396827);
   ...
   gre->SetPoint(0,-700,-0.3247);
   gre->SetPointError(0,0,0.01013936);
   gre->SetPoint(1,-500,-0.33586);
   gre->SetPointError(1,0,0.02821049);
   gre->SetPoint(2,-300,-0.3515);
   gre->SetPointError(2,0,0.02000042);
   gre->SetPoint(3,-100,-0.3534);
   gre->SetPointError(3,0,0.046079);
   gre->SetPoint(4,100,-0.32846);
   gre->SetPointError(4,0,0.01460627);
   gre->SetPoint(5,300,-0.36054);
   gre->SetPointError(5,0,0.006494451);
   gre->SetPoint(6,500,-0.29372);
   gre->SetPointError(6,0,0.02207801);
   gre->SetPoint(7,700,-0.3418);
   gre->SetPointError(7,0,0.01566909);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-0.4122627);
   Graph_Graph47->SetMaximum(-0.2588583);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.35002);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.847885e-05);
   linear_fit->SetParError(0,1.010928e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3434396);
   linear_fit->SetParError(1,0.004591419);
