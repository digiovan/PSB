...
//=========  (Wed Apr  1 22:34:29 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-21.03142,1050,-1.717281);
   ...
   gre->SetPoint(0,-700,-17.68782);
   gre->SetPointError(0,0,0.1245788);
   gre->SetPoint(1,-500,-15.7973);
   gre->SetPointError(1,0,0.05971915);
   gre->SetPoint(2,-300,-13.90576);
   gre->SetPointError(2,0,0.08412672);
   gre->SetPoint(3,-100,-12.15946);
   gre->SetPointError(3,0,0.05871875);
   gre->SetPoint(4,100,-10.36266);
   gre->SetPointError(4,0,0.2183591);
   gre->SetPoint(5,300,-8.36954);
   gre->SetPointError(5,0,0.1606473);
   gre->SetPoint(6,500,-6.75366);
   gre->SetPointError(6,0,0.1032184);
   gre->SetPoint(7,700,-4.98628);
   gre->SetPointError(7,0,0.0499754);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-19.10001);
   Graph_Graph45->SetMaximum(-3.648695);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.342955);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.009013938);
   linear_fit->SetParError(0,5.46106e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.27101);
   linear_fit->SetParError(1,0.02763627);
