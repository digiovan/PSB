...
//=========  (Wed Apr  1 22:34:46 2015) by ROOT version5.34/21
   ...
   gre->SetPoint(0,-700,3.47302);
   gre->SetPointError(0,0,0.373734);
   gre->SetPoint(1,-500,2.60158);
   gre->SetPointError(1,0,0.7714767);
   gre->SetPoint(2,-300,2.1192);
   gre->SetPointError(2,0,0.05956767);
   gre->SetPoint(3,-100,3.44468);
   gre->SetPointError(3,0,0.3183229);
   gre->SetPoint(4,100,3.30976);
   gre->SetPointError(4,0,0.5601554);
   gre->SetPoint(5,300,0.0711);
   gre->SetPointError(5,0,0.647785);
   gre->SetPoint(6,500,2.61202);
   gre->SetPointError(6,0,0.2996734);
   gre->SetPoint(7,700,-5.5252);
   gre->SetPointError(7,0,0.4142196);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-6.920353);
   Graph_Graph56->SetMaximum(4.850849);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(270.1885);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0027894);
   linear_fit->SetParError(0,0.0002572037);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.371099);
   linear_fit->SetParError(1,0.08499188);
