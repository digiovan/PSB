...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,-16.69705,1050,10.35196);
   ...
   gre->SetPoint(0,-700,-12.16642);
   gre->SetPointError(0,0,0.02246131);
   gre->SetPoint(1,-500,-9.3927);
   gre->SetPointError(1,0,0.01893814);
   gre->SetPoint(2,-300,-6.69936);
   gre->SetPointError(2,0,0.03185339);
   gre->SetPoint(3,-100,-4.08798);
   gre->SetPointError(3,0,0.0540068);
   gre->SetPoint(4,100,-1.47876);
   gre->SetPointError(4,0,0.02366573);
   gre->SetPoint(5,300,1.06982);
   gre->SetPointError(5,0,0.01560409);
   gre->SetPoint(6,500,3.45916);
   gre->SetPointError(6,0,0.03071337);
   gre->SetPoint(7,700,5.83138);
   gre->SetPointError(7,0,0.01240875);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-13.99215);
   Graph_Graph54->SetMaximum(7.647056);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(538.7844);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0127858);
   linear_fit->SetParError(0,1.412469e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.97618);
   linear_fit->SetParError(1,0.007557197);
