...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.630018,1050,1.866687);
   ...
   gre->SetPoint(0,-700,1.79484);
   gre->SetPointError(0,0,0.03240199);
   gre->SetPoint(1,-500,1.78182);
   gre->SetPointError(1,0,0.0330861);
   gre->SetPoint(2,-300,1.7187);
   gre->SetPointError(2,0,0.04923741);
   gre->SetPoint(3,-100,1.77742);
   gre->SetPointError(3,0,0.02007076);
   gre->SetPoint(4,100,1.75352);
   gre->SetPointError(4,0,0.04557514);
   gre->SetPoint(5,300,1.78762);
   gre->SetPointError(5,0,0.01083911);
   gre->SetPoint(6,500,1.76768);
   gre->SetPointError(6,0,0.02724329);
   gre->SetPoint(7,700,1.76776);
   gre->SetPointError(7,0,0.02722422);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.653685);
   Graph_Graph43->SetMaximum(1.84302);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.006565);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.260925e-06);
   linear_fit->SetParError(0,2.195441e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.780563);
   linear_fit->SetParError(1,0.00860274);
