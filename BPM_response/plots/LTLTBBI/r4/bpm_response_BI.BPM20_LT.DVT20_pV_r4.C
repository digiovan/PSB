...
//=========  (Wed Apr  1 22:34:29 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-7.816799,1050,5.524413);
   ...
   gre->SetPoint(0,-700,3.254);
   gre->SetPointError(0,0,0.04687794);
   gre->SetPoint(1,-500,1.93622);
   gre->SetPointError(1,0,0.05296913);
   gre->SetPoint(2,-300,0.5663);
   gre->SetPointError(2,0,0.06379783);
   gre->SetPoint(3,-100,-0.74832);
   gre->SetPointError(3,0,0.06317196);
   gre->SetPoint(4,100,-2.06878);
   gre->SetPointError(4,0,0.1096812);
   gre->SetPoint(5,300,-3.38334);
   gre->SetPointError(5,0,0.09807588);
   gre->SetPoint(6,500,-4.47064);
   gre->SetPointError(6,0,0.06898027);
   gre->SetPoint(7,700,-5.57848);
   gre->SetPointError(7,0,0.01478375);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-6.482678);
   Graph_Graph53->SetMaximum(4.190292);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(29.99204);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006247465);
   linear_fit->SetParError(0,2.639261e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.221657);
   linear_fit->SetParError(1,0.01711607);
