...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,0.9853093,1050,1.196892);
   ...
   gre->SetPoint(0,-700,1.06336);
   gre->SetPointError(0,0,0.02743437);
   gre->SetPoint(1,-500,1.09312);
   gre->SetPointError(1,0,0.018724);
   gre->SetPoint(2,-300,1.07872);
   gre->SetPointError(2,0,0.0479203);
   gre->SetPoint(3,-100,1.0926);
   gre->SetPointError(3,0,0.01908603);
   gre->SetPoint(4,100,1.10882);
   gre->SetPointError(4,0,0.05280838);
   gre->SetPoint(5,300,1.10094);
   gre->SetPointError(5,0,0.008844399);
   gre->SetPoint(6,500,1.09088);
   gre->SetPointError(6,0,0.01324425);
   gre->SetPoint(7,700,1.03862);
   gre->SetPointError(7,0,0.01804687);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(1.006468);
   Graph_Graph48->SetMaximum(1.175734);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.44206);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.929406e-06);
   linear_fit->SetParError(0,1.535794e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.090825);
   linear_fit->SetParError(1,0.006665604);
