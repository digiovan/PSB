...
//=========  (Wed Apr  1 22:34:14 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,0.2228186,1050,0.8534641);
   ...
   gre->SetPoint(0,-700,0.55128);
   gre->SetPointError(0,0,0.07760804);
   gre->SetPoint(1,-500,0.3955);
   gre->SetPointError(1,0,0.06757382);
   gre->SetPoint(2,-300,0.44646);
   gre->SetPointError(2,0,0.074047);
   gre->SetPoint(3,-100,0.5081);
   gre->SetPointError(3,0,0.1745666);
   gre->SetPoint(4,100,0.55728);
   gre->SetPointError(4,0,0.1867047);
   gre->SetPoint(5,300,0.52846);
   gre->SetPointError(5,0,0.1350297);
   gre->SetPoint(6,500,0.5518);
   gre->SetPointError(6,0,0.05355321);
   gre->SetPoint(7,700,0.68024);
   gre->SetPointError(7,0,0.06811653);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(0.2858831);
   Graph_Graph50->SetMaximum(0.7903996);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.943207);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001249713);
   linear_fit->SetParError(0,5.361458e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5229506);
   linear_fit->SetParError(1,0.02842762);
