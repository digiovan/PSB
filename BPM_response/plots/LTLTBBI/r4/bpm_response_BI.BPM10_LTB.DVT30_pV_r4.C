...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-0.1377629,1050,6.500156);
   ...
   gre->SetPoint(0,-700,5.32348);
   gre->SetPointError(0,0,0.07035604);
   gre->SetPoint(1,-500,4.62462);
   gre->SetPointError(1,0,0.2473933);
   gre->SetPoint(2,-300,4.17178);
   gre->SetPointError(2,0,0.03901835);
   gre->SetPoint(3,-100,3.48622);
   gre->SetPointError(3,0,0.0218349);
   gre->SetPoint(4,100,2.78096);
   gre->SetPointError(4,0,0.04075735);
   gre->SetPoint(5,300,2.37488);
   gre->SetPointError(5,0,0.03820182);
   gre->SetPoint(6,500,1.83262);
   gre->SetPointError(6,0,0.07577051);
   gre->SetPoint(7,700,1.281);
   gre->SetPointError(7,0,0.3124431);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(0.526029);
   Graph_Graph52->SetMaximum(5.836364);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.36628);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00297152);
   linear_fit->SetParError(0,5.864675e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.207189);
   linear_fit->SetParError(1,0.01522236);
