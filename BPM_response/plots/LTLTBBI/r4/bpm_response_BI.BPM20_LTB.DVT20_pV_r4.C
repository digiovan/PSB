...
//=========  (Wed Apr  1 22:35:22 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-5.371399,1050,2.848096);
   ...
   gre->SetPoint(0,-700,-3.9688);
   gre->SetPointError(0,0,0.03268265);
   gre->SetPoint(1,-500,-3.088);
   gre->SetPointError(1,0,0.05734017);
   gre->SetPoint(2,-300,-2.48292);
   gre->SetPointError(2,0,0.1026693);
   gre->SetPoint(3,-100,-1.5101);
   gre->SetPointError(3,0,0.05875173);
   gre->SetPoint(4,100,-0.83754);
   gre->SetPointError(4,0,0.1214123);
   gre->SetPoint(5,300,-0.15844);
   gre->SetPointError(5,0,0.02400553);
   gre->SetPoint(6,500,0.57716);
   gre->SetPointError(6,0,0.02249143);
   gre->SetPoint(7,700,1.46636);
   gre->SetPointError(7,0,0.01182061);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-4.549449);
   Graph_Graph53->SetMaximum(2.026147);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.64905);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003864216);
   linear_fit->SetParError(0,2.155052e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.265624);
   linear_fit->SetParError(1,0.0131878);
