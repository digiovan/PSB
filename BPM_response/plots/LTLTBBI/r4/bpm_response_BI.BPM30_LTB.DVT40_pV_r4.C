...
//=========  (Wed Apr  1 22:35:43 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-26.54907,1050,22.42543);
   ...
   gre->SetPoint(0,-700,12.37502);
   gre->SetPointError(0,0,0.2631038);
   gre->SetPoint(1,-500,14.06608);
   gre->SetPointError(1,0,0.1969337);
   gre->SetPoint(2,-300,8.4744);
   gre->SetPointError(2,0,0.1964956);
   gre->SetPoint(3,-100,3.30698);
   gre->SetPointError(3,0,0.2228365);
   gre->SetPoint(4,100,-2.0278);
   gre->SetPointError(4,0,0.1821406);
   gre->SetPoint(5,300,-7.12414);
   gre->SetPointError(5,0,0.3201115);
   gre->SetPoint(6,500,-12.6991);
   gre->SetPointError(6,0,0.2438601);
   gre->SetPoint(7,700,-18.23368);
   gre->SetPointError(7,0,0.1529732);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-21.65162);
   Graph_Graph54->SetMaximum(17.52798);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(511.6234);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02495453);
   linear_fit->SetParError(0,0.000154911);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.05108512);
   linear_fit->SetParError(1,0.07400044);
