...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_V_4->Range(-1050,-25.83122,1050,17.5669);
   ...
   gre->SetPoint(0,-700,10.2686);
   gre->SetPointError(0,0,0.0652761);
   gre->SetPoint(1,-500,8.12722);
   gre->SetPointError(1,0,0.1702532);
   gre->SetPoint(2,-300,1.84918);
   gre->SetPointError(2,0,0.3941411);
   gre->SetPoint(3,-100,-4.6051);
   gre->SetPointError(3,0,0.2039761);
   gre->SetPoint(4,100,-9.6637);
   gre->SetPointError(4,0,0.7225795);
   gre->SetPoint(5,300,-13.49192);
   gre->SetPointError(5,0,1.171712);
   gre->SetPoint(6,500,-18.32748);
   gre->SetPointError(6,0,0.2707228);
   gre->SetPoint(7,700,-1.09366);
   gre->SetPointError(7,0,0.3044286);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-21.49141);
   Graph_Graph56->SetMaximum(13.22708);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3272.984);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01724661);
   linear_fit->SetParError(0,0.0001513652);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.987039);
   linear_fit->SetParError(1,0.09665376);
