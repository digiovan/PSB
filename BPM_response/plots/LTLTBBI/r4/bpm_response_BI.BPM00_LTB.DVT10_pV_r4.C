...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-9.154472,1050,6.497926);
   ...
   gre->SetPoint(0,-700,3.85134);
   gre->SetPointError(0,0,0.03785307);
   gre->SetPoint(1,-500,2.30872);
   gre->SetPointError(1,0,0.04719052);
   gre->SetPoint(2,-300,0.8659);
   gre->SetPointError(2,0,0.007439214);
   gre->SetPoint(3,-100,-0.49836);
   gre->SetPointError(3,0,0.01000211);
   gre->SetPoint(4,100,-1.8937);
   gre->SetPointError(4,0,0.0218667);
   gre->SetPoint(5,300,-3.3193);
   gre->SetPointError(5,0,0.03196117);
   gre->SetPoint(6,500,-4.94502);
   gre->SetPointError(6,0,0.01554674);
   gre->SetPoint(7,700,-6.53742);
   gre->SetPointError(7,0,0.008318731);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-7.589232);
   Graph_Graph51->SetMaximum(4.932686);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(233.8623);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007405551);
   linear_fit->SetParError(0,1.010238e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.30966);
   linear_fit->SetParError(1,0.004568813);
