...
//=========  (Wed Apr  1 22:36:04 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-5.433503,1050,2.430608);
   ...
   gre->SetPoint(0,-700,-4.07146);
   gre->SetPointError(0,0,0.05135805);
   gre->SetPoint(1,-500,-3.1265);
   gre->SetPointError(1,0,0.06754802);
   gre->SetPoint(2,-300,-2.5573);
   gre->SetPointError(2,0,0.05443021);
   gre->SetPoint(3,-100,-1.65642);
   gre->SetPointError(3,0,0.05864362);
   gre->SetPoint(4,100,-1.09968);
   gre->SetPointError(4,0,0.07230551);
   gre->SetPoint(5,300,-0.2359);
   gre->SetPointError(5,0,0.06436177);
   gre->SetPoint(6,500,0.0717);
   gre->SetPointError(6,0,0.05893904);
   gre->SetPoint(7,700,1.04314);
   gre->SetPointError(7,0,0.07678307);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-4.647092);
   Graph_Graph53->SetMaximum(1.644197);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(39.38138);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003545274);
   linear_fit->SetParError(0,4.757686e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.468129);
   linear_fit->SetParError(1,0.0219989);
