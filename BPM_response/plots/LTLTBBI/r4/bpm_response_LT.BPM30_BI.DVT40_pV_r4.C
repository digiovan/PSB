...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-11.59398,1050,-10.21834);
   ...
   gre->SetPoint(0,-700,-11.12142);
   gre->SetPointError(0,0,0.06027349);
   gre->SetPoint(1,-500,-11.23614);
   gre->SetPointError(1,0,0.0738838);
   gre->SetPoint(2,-300,-10.60206);
   gre->SetPointError(2,0,0.1544482);
   gre->SetPoint(3,-100,-11.32376);
   gre->SetPointError(3,0,0.04094537);
   gre->SetPoint(4,100,-11.11696);
   gre->SetPointError(4,0,0.02868579);
   gre->SetPoint(5,300,-10.62828);
   gre->SetPointError(5,0,0.1267474);
   gre->SetPoint(6,500,-11.11896);
   gre->SetPointError(6,0,0.06140101);
   gre->SetPoint(7,700,-11.0739);
   gre->SetPointError(7,0,0.1998019);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-11.45641);
   Graph_Graph45->SetMaximum(-10.3559);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(48.65906);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.740685e-05);
   linear_fit->SetParError(0,5.92232e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.15001);
   linear_fit->SetParError(1,0.01942798);
