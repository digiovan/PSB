...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-6.179969,1050,3.730629);
   ...
   gre->SetPoint(0,-700,-4.49754);
   gre->SetPointError(0,0,0.03066259);
   gre->SetPoint(1,-500,-3.26326);
   gre->SetPointError(1,0,0.02991733);
   gre->SetPoint(2,-300,-2.453);
   gre->SetPointError(2,0,0.02762736);
   gre->SetPoint(3,-100,-1.48954);
   gre->SetPointError(3,0,0.03497811);
   gre->SetPoint(4,100,-0.69968);
   gre->SetPointError(4,0,0.02984816);
   gre->SetPoint(5,300,0.21202);
   gre->SetPointError(5,0,0.01901904);
   gre->SetPoint(6,500,1.2307);
   gre->SetPointError(6,0,0.0512814);
   gre->SetPoint(7,700,2.06064);
   gre->SetPointError(7,0,0.01822236);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-5.188909);
   Graph_Graph51->SetMaximum(2.739569);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(72.01913);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004562342);
   linear_fit->SetParError(0,1.971465e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.126759);
   linear_fit->SetParError(1,0.009617118);
