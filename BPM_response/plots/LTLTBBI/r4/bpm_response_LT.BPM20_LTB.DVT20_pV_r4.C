...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_4->Range(-1050,-7.203427,1050,-6.586983);
   ...
   gre->SetPoint(0,-700,-6.80312);
   gre->SetPointError(0,0,0.05808183);
   gre->SetPoint(1,-500,-6.89446);
   gre->SetPointError(1,0,0.04582343);
   gre->SetPoint(2,-300,-6.76438);
   gre->SetPointError(2,0,0.07465651);
   gre->SetPoint(3,-100,-6.96532);
   gre->SetPointError(3,0,0.03134656);
   gre->SetPoint(4,100,-6.89618);
   gre->SetPointError(4,0,0.08831436);
   gre->SetPoint(5,300,-6.96404);
   gre->SetPointError(5,0,0.04063803);
   gre->SetPoint(6,500,-6.81954);
   gre->SetPointError(6,0,0.03627989);
   gre->SetPoint(7,700,-7.03446);
   gre->SetPointError(7,0,0.06622622);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.141782);
   Graph_Graph44->SetMaximum(-6.648627);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.98429);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.712765e-05);
   linear_fit->SetParError(0,3.942701e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.903705);
   linear_fit->SetParError(1,0.01652027);
