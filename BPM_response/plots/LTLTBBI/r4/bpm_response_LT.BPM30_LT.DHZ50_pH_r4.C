...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-9.857296,1050,-9.146797);
   ...
   gre->SetPoint(0,-700,-9.43372);
   gre->SetPointError(0,0,0.04314353);
   gre->SetPoint(1,-500,-9.66612);
   gre->SetPointError(1,0,0.0306462);
   gre->SetPoint(2,-300,-9.29862);
   gre->SetPointError(2,0,0.03295927);
   gre->SetPoint(3,-100,-9.67158);
   gre->SetPointError(3,0,0.05398161);
   gre->SetPoint(4,100,-9.70826);
   gre->SetPointError(4,0,0.0306196);
   gre->SetPoint(5,300,-9.29892);
   gre->SetPointError(5,0,0.03370627);
   gre->SetPoint(6,500,-9.60972);
   gre->SetPointError(6,0,0.02018503);
   gre->SetPoint(7,700,-9.54972);
   gre->SetPointError(7,0,0.03031144);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-9.786246);
   Graph_Graph45->SetMaximum(-9.217847);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(172.3178);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.450766e-05);
   linear_fit->SetParError(0,2.427693e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.5398);
   linear_fit->SetParError(1,0.01143124);
