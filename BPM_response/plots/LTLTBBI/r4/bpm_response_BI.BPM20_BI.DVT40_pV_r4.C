...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-2.248158,1050,-1.061345);
   ...
   gre->SetPoint(0,-700,-1.4985);
   gre->SetPointError(0,0,0.06431471);
   gre->SetPoint(1,-500,-1.46892);
   gre->SetPointError(1,0,0.07261057);
   gre->SetPoint(2,-300,-1.97494);
   gre->SetPointError(2,0,0.07541558);
   gre->SetPoint(3,-100,-1.29056);
   gre->SetPointError(3,0,0.03141277);
   gre->SetPoint(4,100,-1.3784);
   gre->SetPointError(4,0,0.04016644);
   gre->SetPoint(5,300,-1.88184);
   gre->SetPointError(5,0,0.09287248);
   gre->SetPoint(6,500,-1.5177);
   gre->SetPointError(6,0,0.04252201);
   gre->SetPoint(7,700,-1.48564);
   gre->SetPointError(7,0,0.155428);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-2.129476);
   Graph_Graph53->SetMaximum(-1.180026);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(101.9964);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.385251e-05);
   linear_fit->SetParError(0,5.220437e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.446955);
   linear_fit->SetParError(1,0.01841086);
