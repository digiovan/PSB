...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-1.851089,1050,-1.729351);
   ...
   gre->SetPoint(0,-700,-1.80908);
   gre->SetPointError(0,0,0.01880176);
   gre->SetPoint(1,-500,-1.76402);
   gre->SetPointError(1,0,0.01437927);
   gre->SetPoint(2,-300,-1.7829);
   gre->SetPointError(2,0,0.008764331);
   gre->SetPoint(3,-100,-1.78748);
   gre->SetPointError(3,0,0.02063304);
   gre->SetPoint(4,100,-1.80946);
   gre->SetPointError(4,0,0.01134011);
   gre->SetPoint(5,300,-1.78954);
   gre->SetPointError(5,0,0.02365154);
   gre->SetPoint(6,500,-1.7632);
   gre->SetPointError(6,0,0.007886159);
   gre->SetPoint(7,700,-1.81532);
   gre->SetPointError(7,0,0.01547947);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.838915);
   Graph_Graph47->SetMaximum(-1.741525);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.64267);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.971598e-06);
   linear_fit->SetParError(0,1.008625e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.783828);
   linear_fit->SetParError(1,0.004407964);
