...
//=========  (Wed Apr  1 22:36:04 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,2.892708,1050,4.109711);
   ...
   gre->SetPoint(0,-700,3.66494);
   gre->SetPointError(0,0,0.0894245);
   gre->SetPoint(1,-500,3.29194);
   gre->SetPointError(1,0,0.1019315);
   gre->SetPoint(2,-300,3.52462);
   gre->SetPointError(2,0,0.07754669);
   gre->SetPoint(3,-100,3.19696);
   gre->SetPointError(3,0,0.1014184);
   gre->SetPoint(4,100,3.46236);
   gre->SetPointError(4,0,0.1044647);
   gre->SetPoint(5,300,3.21074);
   gre->SetPointError(5,0,0.1076662);
   gre->SetPoint(6,500,3.82054);
   gre->SetPointError(6,0,0.08633684);
   gre->SetPoint(7,700,3.42926);
   gre->SetPointError(7,0,0.1222788);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(3.014408);
   Graph_Graph52->SetMaximum(3.98801);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(37.53678);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.942647e-05);
   linear_fit->SetParError(0,7.585771e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.484866);
   linear_fit->SetParError(1,0.03426807);
