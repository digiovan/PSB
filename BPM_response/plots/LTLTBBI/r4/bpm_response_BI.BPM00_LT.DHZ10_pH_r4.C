...
//=========  (Wed Apr  1 22:34:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-9.748805,1050,-3.140416);
   ...
   gre->SetPoint(0,-700,-8.57158);
   gre->SetPointError(0,0,0.07582672);
   gre->SetPoint(1,-500,-7.65956);
   gre->SetPointError(1,0,0.04907889);
   gre->SetPoint(2,-300,-7.07614);
   gre->SetPointError(2,0,0.02332536);
   gre->SetPoint(3,-100,-6.71302);
   gre->SetPointError(3,0,0.03820193);
   gre->SetPoint(4,100,-6.25862);
   gre->SetPointError(4,0,0.1286842);
   gre->SetPoint(5,300,-5.09612);
   gre->SetPointError(5,0,0.0694976);
   gre->SetPoint(6,500,-4.72724);
   gre->SetPointError(6,0,0.05010127);
   gre->SetPoint(7,700,-4.3382);
   gre->SetPointError(7,0,0.09638578);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LT.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-9.087966);
   Graph_Graph51->SetMaximum(-3.801255);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(62.52187);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002977302);
   linear_fit->SetParError(0,4.777207e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.241758);
   linear_fit->SetParError(1,0.01769064);
