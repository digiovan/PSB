...
//=========  (Wed Apr  1 22:36:09 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,-1.476741,1050,-1.165973);
   ...
   gre->SetPoint(0,-700,-1.38892);
   gre->SetPointError(0,0,0.008477258);
   gre->SetPoint(1,-500,-1.3524);
   gre->SetPointError(1,0,0.04429377);
   gre->SetPoint(2,-300,-1.27526);
   gre->SetPointError(2,0,0.01363745);
   gre->SetPoint(3,-100,-1.24702);
   gre->SetPointError(3,0,0.02925245);
   gre->SetPoint(4,100,-1.32142);
   gre->SetPointError(4,0,0.02114211);
   gre->SetPoint(5,300,-1.36442);
   gre->SetPointError(5,0,0.01437877);
   gre->SetPoint(6,500,-1.31564);
   gre->SetPointError(6,0,0.02046259);
   gre->SetPoint(7,700,-1.40726);
   gre->SetPointError(7,0,0.01768609);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-1.445664);
   Graph_Graph53->SetMaximum(-1.19705);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(77.50719);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.374515e-05);
   linear_fit->SetParError(0,1.068428e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.351083);
   linear_fit->SetParError(1,0.005844433);
