...
//=========  (Wed Apr  1 22:34:19 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_4->Range(-1050,-2.137835,1050,-0.1241294);
   ...
   gre->SetPoint(0,-700,-0.48172);
   gre->SetPointError(0,0,0.02197292);
   gre->SetPoint(1,-500,-0.64808);
   gre->SetPointError(1,0,0.03006829);
   gre->SetPoint(2,-300,-0.8347);
   gre->SetPointError(2,0,0.04361418);
   gre->SetPoint(3,-100,-1.0282);
   gre->SetPointError(3,0,0.03417152);
   gre->SetPoint(4,100,-1.21664);
   gre->SetPointError(4,0,0.02423159);
   gre->SetPoint(5,300,-1.37424);
   gre->SetPointError(5,0,0.03087523);
   gre->SetPoint(6,500,-1.50976);
   gre->SetPointError(6,0,0.02099794);
   gre->SetPoint(7,700,-1.79312);
   gre->SetPointError(7,0,0.00909771);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LT.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-1.936465);
   Graph_Graph51->SetMaximum(-0.3255);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.99086);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0009392178);
   linear_fit->SetParError(0,1.398163e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.120972);
   linear_fit->SetParError(1,0.00846809);
