...
//=========  (Wed Apr  1 22:34:56 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_H_4->Range(-1050,-15.10659,1050,10.27814);
   ...
   gre->SetPoint(0,-700,-10.3594);
   gre->SetPointError(0,0,0.5163984);
   gre->SetPoint(1,-500,0.16538);
   gre->SetPointError(1,0,0.2434168);
   gre->SetPoint(2,-300,-2.075);
   gre->SetPointError(2,0,0.3591529);
   gre->SetPoint(3,-100,4.52494);
   gre->SetPointError(3,0,0.09434359);
   gre->SetPoint(4,100,5.83922);
   gre->SetPointError(4,0,0.2081297);
   gre->SetPoint(5,300,1.2197);
   gre->SetPointError(5,0,0.4409799);
   gre->SetPoint(6,500,4.2623);
   gre->SetPointError(6,0,0.6812482);
   gre->SetPoint(7,700,2.32216);
   gre->SetPointError(7,0,0.2869655);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-12.56811);
   Graph_Graph55->SetMaximum(7.739665);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1201.833);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004051904);
   linear_fit->SetParError(0,0.0002637368);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.710952);
   linear_fit->SetParError(1,0.07560724);
