...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.164649,1050,1.383744);
   ...
   gre->SetPoint(0,-700,1.29108);
   gre->SetPointError(0,0,0.04897731);
   gre->SetPoint(1,-500,1.26358);
   gre->SetPointError(1,0,0.05001639);
   gre->SetPoint(2,-300,1.21506);
   gre->SetPointError(2,0,0.01389483);
   gre->SetPoint(3,-100,1.27734);
   gre->SetPointError(3,0,0.01140905);
   gre->SetPoint(4,100,1.32004);
   gre->SetPointError(4,0,0.02718831);
   gre->SetPoint(5,300,1.24748);
   gre->SetPointError(5,0,0.01959885);
   gre->SetPoint(6,500,1.32414);
   gre->SetPointError(6,0,0.01990308);
   gre->SetPoint(7,700,1.268);
   gre->SetPointError(7,0,0.05047296);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.186559);
   Graph_Graph43->SetMaximum(1.361835);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.16638);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.824955e-05);
   linear_fit->SetParError(0,2.28686e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.267451);
   linear_fit->SetParError(1,0.006987023);
