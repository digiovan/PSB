...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-9.520318,1050,-9.114725);
   ...
   gre->SetPoint(0,-700,-9.3685);
   gre->SetPointError(0,0,0.009614159);
   gre->SetPoint(1,-500,-9.33444);
   gre->SetPointError(1,0,0.02023649);
   gre->SetPoint(2,-300,-9.31506);
   gre->SetPointError(2,0,0.1327359);
   gre->SetPoint(3,-100,-9.30374);
   gre->SetPointError(3,0,0.03703586);
   gre->SetPoint(4,100,-9.43086);
   gre->SetPointError(4,0,0.02185952);
   gre->SetPoint(5,300,-9.22476);
   gre->SetPointError(5,0,0.03338181);
   gre->SetPoint(6,500,-9.3754);
   gre->SetPointError(6,0,0.03288255);
   gre->SetPoint(7,700,-9.2637);
   gre->SetPointError(7,0,0.03428176);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-9.479759);
   Graph_Graph45->SetMaximum(-9.155285);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.78962);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.194168e-05);
   linear_fit->SetParError(0,1.621313e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.344612);
   linear_fit->SetParError(1,0.009656848);
