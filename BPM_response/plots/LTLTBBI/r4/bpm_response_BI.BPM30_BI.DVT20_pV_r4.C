...
//=========  (Wed Apr  1 22:36:04 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-6.176713,1050,6.77364);
   ...
   gre->SetPoint(0,-700,-3.82954);
   gre->SetPointError(0,0,0.1887805);
   gre->SetPoint(1,-500,-1.83864);
   gre->SetPointError(1,0,0.2794856);
   gre->SetPoint(2,-300,-1.2596);
   gre->SetPointError(2,0,0.2227157);
   gre->SetPoint(3,-100,0.47766);
   gre->SetPointError(3,0,0.2209373);
   gre->SetPoint(4,100,1.02444);
   gre->SetPointError(4,0,0.3198293);
   gre->SetPoint(5,300,2.65156);
   gre->SetPointError(5,0,0.2124749);
   gre->SetPoint(6,500,2.16996);
   gre->SetPointError(6,0,0.2685919);
   gre->SetPoint(7,700,4.32506);
   gre->SetPointError(7,0,0.2901876);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: BI.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-4.881677);
   Graph_Graph54->SetMaximum(5.478604);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(36.1121);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005556374);
   linear_fit->SetParError(0,0.0001843289);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.4758488);
   linear_fit->SetParError(1,0.08607146);
