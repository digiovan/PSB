...
//=========  (Wed Apr  1 22:35:00 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_4->Range(-1050,-7.892591,1050,-7.333857);
   ...
   gre->SetPoint(0,-700,-7.77322);
   gre->SetPointError(0,0,0.02624888);
   gre->SetPoint(1,-500,-7.58926);
   gre->SetPointError(1,0,0.055085);
   gre->SetPoint(2,-300,-7.52808);
   gre->SetPointError(2,0,0.1011009);
   gre->SetPoint(3,-100,-7.48622);
   gre->SetPointError(3,0,0.03472672);
   gre->SetPoint(4,100,-7.5707);
   gre->SetPointError(4,0,0.03747855);
   gre->SetPoint(5,300,-7.51458);
   gre->SetPointError(5,0,0.0263597);
   gre->SetPoint(6,500,-7.56064);
   gre->SetPointError(6,0,0.0651849);
   gre->SetPoint(7,700,-7.53848);
   gre->SetPointError(7,0,0.02225857);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-7.836718);
   Graph_Graph46->SetMaximum(-7.38973);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.78958);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001457592);
   linear_fit->SetParError(0,2.283328e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.596792);
   linear_fit->SetParError(1,0.01209302);
