...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,0.09354884,1050,2.962348);
   ...
   gre->SetPoint(0,-700,2.4286);
   gre->SetPointError(0,0,0.05561496);
   gre->SetPoint(1,-500,1.7321);
   gre->SetPointError(1,0,0.02796661);
   gre->SetPoint(2,-300,1.61748);
   gre->SetPointError(2,0,0.02910796);
   gre->SetPoint(3,-100,1.3084);
   gre->SetPointError(3,0,0.03141943);
   gre->SetPoint(4,100,1.23722);
   gre->SetPointError(4,0,0.05059879);
   gre->SetPoint(5,300,1.00652);
   gre->SetPointError(5,0,0.04827061);
   gre->SetPoint(6,500,0.6918);
   gre->SetPointError(6,0,0.04472948);
   gre->SetPoint(7,700,0.618);
   gre->SetPointError(7,0,0.04631792);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(0.3804288);
   Graph_Graph48->SetMaximum(2.675468);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(74.33127);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001079962);
   linear_fit->SetParError(0,3.27798e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.282997);
   linear_fit->SetParError(1,0.01380832);
