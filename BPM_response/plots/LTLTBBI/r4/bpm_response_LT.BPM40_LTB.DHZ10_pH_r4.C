...
//=========  (Wed Apr  1 22:35:06 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.4485032,1050,-0.3613412);
   ...
   gre->SetPoint(0,-700,-0.3898);
   gre->SetPointError(0,0,0.004734907);
   gre->SetPoint(1,-500,-0.39904);
   gre->SetPointError(1,0,0.01819337);
   gre->SetPoint(2,-300,-0.39966);
   gre->SetPointError(2,0,0.001872724);
   gre->SetPoint(3,-100,-0.4236);
   gre->SetPointError(3,0,0.0103762);
   gre->SetPoint(4,100,-0.41138);
   gre->SetPointError(4,0,0.0124212);
   gre->SetPoint(5,300,-0.40808);
   gre->SetPointError(5,0,0.005447044);
   gre->SetPoint(6,500,-0.38882);
   gre->SetPointError(6,0,0.004005005);
   gre->SetPoint(7,700,-0.391);
   gre->SetPointError(7,0,0.0151318);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.439787);
   Graph_Graph46->SetMaximum(-0.3700574);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.74998);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.402641e-06);
   linear_fit->SetParError(0,4.191398e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3981514);
   linear_fit->SetParError(1,0.001645453);
