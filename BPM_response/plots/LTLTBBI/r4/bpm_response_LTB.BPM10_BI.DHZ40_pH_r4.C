...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_4->Range(-1050,1.66199,1050,2.740034);
   ...
   gre->SetPoint(0,-700,2.0464);
   gre->SetPointError(0,0,0.2047357);
   gre->SetPoint(1,-500,2.0505);
   gre->SetPointError(1,0,0.1356109);
   gre->SetPoint(2,-300,2.23642);
   gre->SetPointError(2,0,0.3239401);
   gre->SetPoint(3,-100,2.0382);
   gre->SetPointError(3,0,0.1104448);
   gre->SetPoint(4,100,2.18374);
   gre->SetPointError(4,0,0.3235255);
   gre->SetPoint(5,300,1.99454);
   gre->SetPointError(5,0,0.06794225);
   gre->SetPoint(6,500,2.17834);
   gre->SetPointError(6,0,0.09189006);
   gre->SetPoint(7,700,2.1989);
   gre->SetPointError(7,0,0.08300268);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: BI.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(1.769795);
   Graph_Graph48->SetMaximum(2.63223);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.882636);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001158155);
   linear_fit->SetParError(0,9.876287e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.060503);
   linear_fit->SetParError(1,0.04667265);
