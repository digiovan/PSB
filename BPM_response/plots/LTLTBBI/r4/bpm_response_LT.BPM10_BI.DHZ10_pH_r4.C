...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.656575,1050,1.838985);
   ...
   gre->SetPoint(0,-700,1.76632);
   gre->SetPointError(0,0,0.003674041);
   gre->SetPoint(1,-500,1.74946);
   gre->SetPointError(1,0,0.01667983);
   gre->SetPoint(2,-300,1.74778);
   gre->SetPointError(2,0,0.06080306);
   gre->SetPoint(3,-100,1.73642);
   gre->SetPointError(3,0,0.01583821);
   gre->SetPoint(4,100,1.79602);
   gre->SetPointError(4,0,0.009308232);
   gre->SetPoint(5,300,1.71368);
   gre->SetPointError(5,0,0.01508072);
   gre->SetPoint(6,500,1.77906);
   gre->SetPointError(6,0,0.02318031);
   gre->SetPoint(7,700,1.73592);
   gre->SetPointError(7,0,0.03722269);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.674816);
   Graph_Graph43->SetMaximum(1.820744);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.89083);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.284198e-06);
   linear_fit->SetParError(0,8.612579e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.764464);
   linear_fit->SetParError(1,0.005338295);
