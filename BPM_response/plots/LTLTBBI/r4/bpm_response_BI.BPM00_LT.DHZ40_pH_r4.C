...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-12.1959,1050,-0.136636);
   ...
   gre->SetPoint(0,-700,-10.06846);
   gre->SetPointError(0,0,0.1175604);
   gre->SetPoint(1,-500,-8.8982);
   gre->SetPointError(1,0,0.07591814);
   gre->SetPoint(2,-300,-8.08962);
   gre->SetPointError(2,0,0.06151604);
   gre->SetPoint(3,-100,-6.69978);
   gre->SetPointError(3,0,0.07974469);
   gre->SetPoint(4,100,-5.692);
   gre->SetPointError(4,0,0.03403434);
   gre->SetPoint(5,300,-4.8323);
   gre->SetPointError(5,0,0.2343511);
   gre->SetPoint(6,500,-2.45896);
   gre->SetPointError(6,0,0.2801634);
   gre->SetPoint(7,700,-2.23188);
   gre->SetPointError(7,0,0.08536706);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-10.98997);
   Graph_Graph51->SetMaximum(-1.342562);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.70598);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005640107);
   linear_fit->SetParError(0,7.371642e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.232367);
   linear_fit->SetParError(1,0.02431833);
