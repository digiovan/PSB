...
//=========  (Wed Apr  1 22:35:06 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,-6.605531,1050,7.420041);
   ...
   gre->SetPoint(0,-700,-4.20866);
   gre->SetPointError(0,0,0.05927604);
   gre->SetPoint(1,-500,-2.76332);
   gre->SetPointError(1,0,0.03854312);
   gre->SetPoint(2,-300,-1.38264);
   gre->SetPointError(2,0,0.07371051);
   gre->SetPoint(3,-100,0.06534);
   gre->SetPointError(3,0,0.03357977);
   gre->SetPoint(4,100,1.38324);
   gre->SetPointError(4,0,0.05146324);
   gre->SetPoint(5,300,2.56882);
   gre->SetPointError(5,0,0.1227405);
   gre->SetPoint(6,500,3.69054);
   gre->SetPointError(6,0,0.06258936);
   gre->SetPoint(7,700,5.02384);
   gre->SetPointError(7,0,0.05860536);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-5.202974);
   Graph_Graph50->SetMaximum(6.017484);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(53.35781);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006563159);
   linear_fit->SetParError(0,4.379231e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5797474);
   linear_fit->SetParError(1,0.01868153);
