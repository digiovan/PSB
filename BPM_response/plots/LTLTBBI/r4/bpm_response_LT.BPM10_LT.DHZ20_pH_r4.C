...
//=========  (Wed Apr  1 22:34:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_4->Range(-1050,1.6527,1050,2.030631);
   ...
   gre->SetPoint(0,-700,1.76784);
   gre->SetPointError(0,0,0.05215177);
   gre->SetPoint(1,-500,1.89122);
   gre->SetPointError(1,0,0.02989401);
   gre->SetPoint(2,-300,1.85736);
   gre->SetPointError(2,0,0.05851567);
   gre->SetPoint(3,-100,1.857);
   gre->SetPointError(3,0,0.006680292);
   gre->SetPoint(4,100,1.80556);
   gre->SetPointError(4,0,0.01922624);
   gre->SetPoint(5,300,1.8725);
   gre->SetPointError(5,0,0.0395424);
   gre->SetPoint(6,500,1.94396);
   gre->SetPointError(6,0,0.02368263);
   gre->SetPoint(7,700,1.75224);
   gre->SetPointError(7,0,0.02321624);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LT.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.690493);
   Graph_Graph43->SetMaximum(1.992838);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(42.361);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.18772e-05);
   linear_fit->SetParError(0,2.160709e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.851268);
   linear_fit->SetParError(1,0.005674387);
