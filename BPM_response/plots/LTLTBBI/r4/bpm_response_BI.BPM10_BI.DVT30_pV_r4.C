...
//=========  (Wed Apr  1 22:36:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,2.884514,1050,4.537721);
   ...
   gre->SetPoint(0,-700,4.04098);
   gre->SetPointError(0,0,0.2212067);
   gre->SetPoint(1,-500,3.23234);
   gre->SetPointError(1,0,0.07229155);
   gre->SetPoint(2,-300,3.49802);
   gre->SetPointError(2,0,0.0411218);
   gre->SetPoint(3,-100,3.38788);
   gre->SetPointError(3,0,0.1080319);
   gre->SetPoint(4,100,3.69134);
   gre->SetPointError(4,0,0.175423);
   gre->SetPoint(5,300,3.44988);
   gre->SetPointError(5,0,0.07053307);
   gre->SetPoint(6,500,3.51392);
   gre->SetPointError(6,0,0.1545019);
   gre->SetPoint(7,700,3.88532);
   gre->SetPointError(7,0,0.2996759);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: BI.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(3.049835);
   Graph_Graph52->SetMaximum(4.372401);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.82841);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001029442);
   linear_fit->SetParError(0,9.492221e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.475365);
   linear_fit->SetParError(1,0.03348632);
