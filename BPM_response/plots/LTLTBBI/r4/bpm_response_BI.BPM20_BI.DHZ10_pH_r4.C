...
//=========  (Wed Apr  1 22:35:48 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_4->Range(-1050,-8.587706,1050,5.990506);
   ...
   gre->SetPoint(0,-700,-6.13542);
   gre->SetPointError(0,0,0.02258404);
   gre->SetPoint(1,-500,-4.75134);
   gre->SetPointError(1,0,0.03343159);
   gre->SetPoint(2,-300,-3.4593);
   gre->SetPointError(2,0,0.1068082);
   gre->SetPoint(3,-100,-2.05324);
   gre->SetPointError(3,0,0.02641121);
   gre->SetPoint(4,100,-0.56068);
   gre->SetPointError(4,0,0.02388968);
   gre->SetPoint(5,300,0.73028);
   gre->SetPointError(5,0,0.05023835);
   gre->SetPoint(6,500,2.2151);
   gre->SetPointError(6,0,0.01759221);
   gre->SetPoint(7,700,3.53078);
   gre->SetPointError(7,0,0.03002387);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-7.129885);
   Graph_Graph53->SetMaximum(4.532685);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(16.92451);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006946036);
   linear_fit->SetParError(0,1.973924e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.287161);
   linear_fit->SetParError(1,0.0096766);
