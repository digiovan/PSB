...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-9.4708,1050,-9.183011);
   ...
   gre->SetPoint(0,-700,-9.39112);
   gre->SetPointError(0,0,0.03171483);
   gre->SetPoint(1,-500,-9.3753);
   gre->SetPointError(1,0,0.03342958);
   gre->SetPoint(2,-300,-9.34402);
   gre->SetPointError(2,0,0.02803602);
   gre->SetPoint(3,-100,-9.30574);
   gre->SetPointError(3,0,0.01911386);
   gre->SetPoint(4,100,-9.28658);
   gre->SetPointError(4,0,0.02226132);
   gre->SetPoint(5,300,-9.37354);
   gre->SetPointError(5,0,0.04283367);
   gre->SetPoint(6,500,-9.37486);
   gre->SetPointError(6,0,0.02536243);
   gre->SetPoint(7,700,-9.25464);
   gre->SetPointError(7,0,0.0236643);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-9.442021);
   Graph_Graph45->SetMaximum(-9.21179);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.49757);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.50455e-05);
   linear_fit->SetParError(0,2.153783e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.326331);
   linear_fit->SetParError(1,0.009268668);
