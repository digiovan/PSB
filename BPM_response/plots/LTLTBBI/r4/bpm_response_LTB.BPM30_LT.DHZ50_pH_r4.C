...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,-4.897197,1050,6.268233);
   ...
   gre->SetPoint(0,-700,4.3379);
   gre->SetPointError(0,0,0.06942824);
   gre->SetPoint(1,-500,3.12358);
   gre->SetPointError(1,0,0.06931075);
   gre->SetPoint(2,-300,2.16672);
   gre->SetPointError(2,0,0.07180564);
   gre->SetPoint(3,-100,0.87984);
   gre->SetPointError(3,0,0.1304272);
   gre->SetPoint(4,100,-0.09644);
   gre->SetPointError(4,0,0.1688735);
   gre->SetPoint(5,300,-0.86642);
   gre->SetPointError(5,0,0.06940632);
   gre->SetPoint(6,500,-2.03104);
   gre->SetPointError(6,0,0.08810703);
   gre->SetPoint(7,700,-2.96316);
   gre->SetPointError(7,0,0.0731321);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-3.780654);
   Graph_Graph50->SetMaximum(5.15169);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.31189);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005172237);
   linear_fit->SetParError(0,5.658081e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6135699);
   linear_fit->SetParError(1,0.02865217);
