...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-10.52899,1050,-6.044352);
   ...
   gre->SetPoint(0,-700,-9.39818);
   gre->SetPointError(0,0,0.08293844);
   gre->SetPoint(1,-500,-9.61996);
   gre->SetPointError(1,0,0.04333765);
   gre->SetPoint(2,-300,-9.3513);
   gre->SetPointError(2,0,0.03823105);
   gre->SetPoint(3,-100,-9.71914);
   gre->SetPointError(3,0,0.06241069);
   gre->SetPoint(4,100,-9.7082);
   gre->SetPointError(4,0,0.05628431);
   gre->SetPoint(5,300,-9.38882);
   gre->SetPointError(5,0,0.1484526);
   gre->SetPoint(6,500,-7.81644);
   gre->SetPointError(6,0,1.024648);
   gre->SetPoint(7,700,-9.40032);
   gre->SetPointError(7,0,0.03600503);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-10.08053);
   Graph_Graph45->SetMaximum(-6.492816);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(57.88054);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.083152e-05);
   linear_fit->SetParError(0,3.910664e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.494489);
   linear_fit->SetParError(1,0.0190629);
