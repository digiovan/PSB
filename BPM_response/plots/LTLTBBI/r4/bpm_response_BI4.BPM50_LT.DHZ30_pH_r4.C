...
//=========  (Wed Apr  1 22:34:35 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_H_4->Range(-1050,-1.744651,1050,6.16289);
   ...
   gre->SetPoint(0,-700,-0.121);
   gre->SetPointError(0,0,0.3057272);
   gre->SetPoint(1,-500,3.39056);
   gre->SetPointError(1,0,0.257132);
   gre->SetPoint(2,-300,1.42638);
   gre->SetPointError(2,0,0.1535144);
   gre->SetPoint(3,-100,4.26988);
   gre->SetPointError(3,0,0.5750864);
   gre->SetPoint(4,100,1.30622);
   gre->SetPointError(4,0,0.1459056);
   gre->SetPoint(5,300,2.4974);
   gre->SetPointError(5,0,0.3826912);
   gre->SetPoint(6,500,1.32006);
   gre->SetPointError(6,0,0.9986988);
   gre->SetPoint(7,700,2.07614);
   gre->SetPointError(7,0,0.07657198);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-0.9538965);
   Graph_Graph56->SetMaximum(5.372136);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(114.0252);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004683787);
   linear_fit->SetParError(0,0.0001239988);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.722945);
   linear_fit->SetParError(1,0.07119124);
