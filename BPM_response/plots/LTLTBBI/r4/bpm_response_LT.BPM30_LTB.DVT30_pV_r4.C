...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-11.63394,1050,-11.02612);
   ...
   gre->SetPoint(0,-700,-11.3269);
   gre->SetPointError(0,0,0.1241995);
   gre->SetPoint(1,-500,-11.30336);
   gre->SetPointError(1,0,0.1315071);
   gre->SetPoint(2,-300,-11.1818);
   gre->SetPointError(2,0,0.05437935);
   gre->SetPoint(3,-100,-11.30644);
   gre->SetPointError(3,0,0.02664628);
   gre->SetPoint(4,100,-11.41372);
   gre->SetPointError(4,0,0.09841884);
   gre->SetPoint(5,300,-11.2513);
   gre->SetPointError(5,0,0.04506251);
   gre->SetPoint(6,500,-11.36152);
   gre->SetPointError(6,0,0.06430219);
   gre->SetPoint(7,700,-11.33424);
   gre->SetPointError(7,0,0.1983965);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-11.57316);
   Graph_Graph45->SetMaximum(-11.0869);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.396285);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.558451e-05);
   linear_fit->SetParError(0,6.919429e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.29109);
   linear_fit->SetParError(1,0.01913794);
