...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_4->Range(-1050,-0.5343258,1050,-0.3746713);
   ...
   gre->SetPoint(0,-700,-0.41416);
   gre->SetPointError(0,0,0.00705202);
   gre->SetPoint(1,-500,-0.4746);
   gre->SetPointError(1,0,0.002347104);
   gre->SetPoint(2,-300,-0.4142);
   gre->SetPointError(2,0,0.007646443);
   gre->SetPoint(3,-100,-0.4913);
   gre->SetPointError(3,0,0.01010381);
   gre->SetPoint(4,100,-0.4942);
   gre->SetPointError(4,0,0.009537883);
   gre->SetPoint(5,300,-0.4206);
   gre->SetPointError(5,0,0.0141281);
   gre->SetPoint(6,500,-0.49892);
   gre->SetPointError(6,0,0.008796762);
   gre->SetPoint(7,700,-0.40722);
   gre->SetPointError(7,0,0.00593957);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LT.DHZ50 Plane: H Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-0.5183604);
   Graph_Graph46->SetMaximum(-0.3906368);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(218.2002);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.289119e-05);
   linear_fit->SetParError(0,4.428028e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4549585);
   linear_fit->SetParError(1,0.002261559);
