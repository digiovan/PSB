...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_4->Range(-1050,-6.988339,1050,-6.654276);
   ...
   gre->SetPoint(0,-700,-6.86492);
   gre->SetPointError(0,0,0.04314226);
   gre->SetPoint(1,-500,-6.89584);
   gre->SetPointError(1,0,0.0309227);
   gre->SetPoint(2,-300,-6.83932);
   gre->SetPointError(2,0,0.03149451);
   gre->SetPoint(3,-100,-6.90678);
   gre->SetPointError(3,0,0.02588168);
   gre->SetPoint(4,100,-6.76262);
   gre->SetPointError(4,0,0.05266695);
   gre->SetPoint(5,300,-6.90068);
   gre->SetPointError(5,0,0.01670508);
   gre->SetPoint(6,500,-6.84874);
   gre->SetPointError(6,0,0.02362582);
   gre->SetPoint(7,700,-6.84084);
   gre->SetPointError(7,0,0.01926827);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-6.954933);
   Graph_Graph44->SetMaximum(-6.687682);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.02279);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.414356e-05);
   linear_fit->SetParError(0,2.128164e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.875133);
   linear_fit->SetParError(1,0.009929818);
