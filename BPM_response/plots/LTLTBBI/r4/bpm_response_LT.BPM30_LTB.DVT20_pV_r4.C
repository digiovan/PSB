...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-11.94235,1050,-10.7347);
   ...
   gre->SetPoint(0,-700,-11.19526);
   gre->SetPointError(0,0,0.1043327);
   gre->SetPoint(1,-500,-11.33214);
   gre->SetPointError(1,0,0.08016186);
   gre->SetPoint(2,-300,-11.07742);
   gre->SetPointError(2,0,0.1414427);
   gre->SetPoint(3,-100,-11.43174);
   gre->SetPointError(3,0,0.08729759);
   gre->SetPoint(4,100,-11.35474);
   gre->SetPointError(4,0,0.1297944);
   gre->SetPoint(5,300,-11.43044);
   gre->SetPointError(5,0,0.08109353);
   gre->SetPoint(6,500,-11.17882);
   gre->SetPointError(6,0,0.07114336);
   gre->SetPoint(7,700,-11.6034);
   gre->SetPointError(7,0,0.137675);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-11.82158);
   Graph_Graph45->SetMaximum(-10.85547);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.45203);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.164726e-05);
   linear_fit->SetParError(0,7.475833e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.31756);
   linear_fit->SetParError(1,0.03354219);
