...
//=========  (Wed Apr  1 22:34:51 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-21.83898,1050,15.41275);
   ...
   gre->SetPoint(0,-700,9.10932);
   gre->SetPointError(0,0,0.09480822);
   gre->SetPoint(1,-500,5.13934);
   gre->SetPointError(1,0,0.3155936);
   gre->SetPoint(2,-300,1.98316);
   gre->SetPointError(2,0,0.321529);
   gre->SetPoint(3,-100,-2.09852);
   gre->SetPointError(3,0,0.7928357);
   gre->SetPoint(4,100,-4.3805);
   gre->SetPointError(4,0,1.569381);
   gre->SetPoint(5,300,-7.8922);
   gre->SetPointError(5,0,0.1070403);
   gre->SetPoint(6,500,-10.82826);
   gre->SetPointError(6,0,0.3749005);
   gre->SetPoint(7,700,-14.61668);
   gre->SetPointError(7,0,1.013681);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LT.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-18.11381);
   Graph_Graph55->SetMaximum(11.68758);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.935572);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01692892);
   linear_fit->SetParError(0,0.0001354114);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.804967);
   linear_fit->SetParError(1,0.07391091);
