...
//=========  (Wed Apr  1 22:35:48 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,-9.417016,1050,3.796185);
   ...
   gre->SetPoint(0,-700,-7.18396);
   gre->SetPointError(0,0,0.03085577);
   gre->SetPoint(1,-500,-5.89328);
   gre->SetPointError(1,0,0.03963447);
   gre->SetPoint(2,-300,-4.77132);
   gre->SetPointError(2,0,0.0964833);
   gre->SetPoint(3,-100,-3.509);
   gre->SetPointError(3,0,0.03937258);
   gre->SetPoint(4,100,-2.12344);
   gre->SetPointError(4,0,0.02501205);
   gre->SetPoint(5,300,-0.9456);
   gre->SetPointError(5,0,0.06243578);
   gre->SetPoint(6,500,0.37884);
   gre->SetPointError(6,0,0.02460625);
   gre->SetPoint(7,700,1.5623);
   gre->SetPointError(7,0,0.03168492);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: BI.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-8.095696);
   Graph_Graph54->SetMaximum(2.474865);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.20762);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006274438);
   linear_fit->SetParError(0,2.518603e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.787791);
   linear_fit->SetParError(1,0.0122041);
