...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,0.07973212,1050,1.240852);
   ...
   gre->SetPoint(0,-700,0.33472);
   gre->SetPointError(0,0,0.06146794);
   gre->SetPoint(1,-500,0.46798);
   gre->SetPointError(1,0,0.05980779);
   gre->SetPoint(2,-300,0.6488);
   gre->SetPointError(2,0,0.09875669);
   gre->SetPoint(3,-100,0.73362);
   gre->SetPointError(3,0,0.02606109);
   gre->SetPoint(4,100,0.80264);
   gre->SetPointError(4,0,0.04657073);
   gre->SetPoint(5,300,0.86112);
   gre->SetPointError(5,0,0.05916101);
   gre->SetPoint(6,500,0.8938);
   gre->SetPointError(6,0,0.05344271);
   gre->SetPoint(7,700,0.97866);
   gre->SetPointError(7,0,0.06867178);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LTB.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(0.1958441);
   Graph_Graph50->SetMaximum(1.12474);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.183733);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004318205);
   linear_fit->SetParError(0,4.742436e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7360611);
   linear_fit->SetParError(1,0.01709219);
