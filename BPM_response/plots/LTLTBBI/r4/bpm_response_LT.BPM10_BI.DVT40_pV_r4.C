...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,0.8509355,1050,1.399767);
   ...
   gre->SetPoint(0,-700,1.21422);
   gre->SetPointError(0,0,0.03555577);
   gre->SetPoint(1,-500,1.2269);
   gre->SetPointError(1,0,0.02736934);
   gre->SetPoint(2,-300,0.98234);
   gre->SetPointError(2,0,0.03993262);
   gre->SetPoint(3,-100,1.27746);
   gre->SetPointError(3,0,0.006062647);
   gre->SetPoint(4,100,1.22408);
   gre->SetPointError(4,0,0.01551982);
   gre->SetPoint(5,300,1.02566);
   gre->SetPointError(5,0,0.05418509);
   gre->SetPoint(6,500,1.1894);
   gre->SetPointError(6,0,0.01175883);
   gre->SetPoint(7,700,1.20796);
   gre->SetPointError(7,0,0.1003348);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(0.9058186);
   Graph_Graph43->SetMaximum(1.344884);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(93.46319);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.214594e-05);
   linear_fit->SetParError(0,1.832284e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.247598);
   linear_fit->SetParError(1,0.004892224);
