...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_4->Range(-1050,-8.297493,1050,-7.745468);
   ...
   gre->SetPoint(0,-700,-7.97962);
   gre->SetPointError(0,0,0.04792859);
   gre->SetPoint(1,-500,-7.9786);
   gre->SetPointError(1,0,0.09270279);
   gre->SetPoint(2,-300,-7.89588);
   gre->SetPointError(2,0,0.0584081);
   gre->SetPoint(3,-100,-8.02704);
   gre->SetPointError(3,0,0.01432152);
   gre->SetPoint(4,100,-8.14434);
   gre->SetPointError(4,0,0.0611484);
   gre->SetPoint(5,300,-8.0093);
   gre->SetPointError(5,0,0.05364952);
   gre->SetPoint(6,500,-8.0505);
   gre->SetPointError(6,0,0.0144612);
   gre->SetPoint(7,700,-7.96848);
   gre->SetPointError(7,0,0.1260714);
   
   TH1F *Graph_Graph46 = new TH1F("Graph_Graph46","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph46->SetMinimum(-8.24229);
   Graph_Graph46->SetMaximum(-7.80067);
   Graph_Graph46->SetDirectory(0);
   Graph_Graph46->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph46->SetLineColor(ci);
   Graph_Graph46->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.470005);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.486169e-05);
   linear_fit->SetParError(0,2.730944e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.025223);
   linear_fit->SetParError(1,0.0102592);
