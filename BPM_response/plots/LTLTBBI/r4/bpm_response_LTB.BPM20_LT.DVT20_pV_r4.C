...
//=========  (Wed Apr  1 22:34:29 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,-5.328648,1050,11.35551);
   ...
   gre->SetPoint(0,-700,8.42726);
   gre->SetPointError(0,0,0.1475566);
   gre->SetPoint(1,-500,6.81352);
   gre->SetPointError(1,0,0.09085775);
   gre->SetPoint(2,-300,5.15132);
   gre->SetPointError(2,0,0.09908141);
   gre->SetPoint(3,-100,3.45206);
   gre->SetPointError(3,0,0.0636555);
   gre->SetPoint(4,100,1.87974);
   gre->SetPointError(4,0,0.1862657);
   gre->SetPoint(5,300,0.2784);
   gre->SetPointError(5,0,0.08328958);
   gre->SetPoint(6,500,-1.0853);
   gre->SetPointError(6,0,0.0906198);
   gre->SetPoint(7,700,-2.50264);
   gre->SetPointError(7,0,0.04531473);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(-3.660232);
   Graph_Graph49->SetMaximum(9.687094);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.33911);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007699885);
   linear_fit->SetParError(0,6.00396e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.807079);
   linear_fit->SetParError(1,0.03103867);
