...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-2.452658,1050,-0.488212);
   ...
   gre->SetPoint(0,-700,-2.10374);
   gre->SetPointError(0,0,0.02150991);
   gre->SetPoint(1,-500,-1.78846);
   gre->SetPointError(1,0,0.025454);
   gre->SetPoint(2,-300,-1.89378);
   gre->SetPointError(2,0,0.01241596);
   gre->SetPoint(3,-100,-1.59818);
   gre->SetPointError(3,0,0.01412564);
   gre->SetPoint(4,100,-1.48338);
   gre->SetPointError(4,0,0.02315907);
   gre->SetPoint(5,300,-1.5541);
   gre->SetPointError(5,0,0.05212755);
   gre->SetPoint(6,500,-0.93512);
   gre->SetPointError(6,0,0.1195004);
   gre->SetPoint(7,700,-1.29792);
   gre->SetPointError(7,0,0.02038877);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: LT.DHZ40 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-2.256213);
   Graph_Graph47->SetMaximum(-0.6846566);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(171.6318);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0005843911);
   linear_fit->SetParError(0,1.839172e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.634221);
   linear_fit->SetParError(1,0.007517746);
