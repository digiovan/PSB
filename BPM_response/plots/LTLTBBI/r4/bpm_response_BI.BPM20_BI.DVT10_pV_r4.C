...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_4->Range(-1050,-3.928547,1050,0.9004965);
   ...
   gre->SetPoint(0,-700,0.02136);
   gre->SetPointError(0,0,0.07429593);
   gre->SetPoint(1,-500,-0.42868);
   gre->SetPointError(1,0,0.02802635);
   gre->SetPoint(2,-300,-0.82036);
   gre->SetPointError(2,0,0.1098624);
   gre->SetPoint(3,-100,-1.15594);
   gre->SetPointError(3,0,0.093966);
   gre->SetPoint(4,100,-1.66316);
   gre->SetPointError(4,0,0.03008634);
   gre->SetPoint(5,300,-1.94726);
   gre->SetPointError(5,0,0.04118129);
   gre->SetPoint(6,500,-2.5447);
   gre->SetPointError(6,0,0.05647594);
   gre->SetPoint(7,700,-3.06098);
   gre->SetPointError(7,0,0.06272607);
   
   TH1F *Graph_Graph53 = new TH1F("Graph_Graph53","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph53->SetMinimum(-3.445642);
   Graph_Graph53->SetMaximum(0.4175921);
   Graph_Graph53->SetDirectory(0);
   Graph_Graph53->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph53->SetLineColor(ci);
   Graph_Graph53->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.82836);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002087991);
   linear_fit->SetParError(0,3.850087e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.449926);
   linear_fit->SetParError(1,0.01608242);
