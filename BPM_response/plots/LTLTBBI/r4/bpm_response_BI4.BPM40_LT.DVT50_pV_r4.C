...
//=========  (Wed Apr  1 22:35:01 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM40_V_4->Range(-1050,-27.85335,1050,29.33433);
   ...
   gre->SetPoint(0,-700,19.74586);
   gre->SetPointError(0,0,0.05719313);
   gre->SetPoint(1,-500,16.76128);
   gre->SetPointError(1,0,0.3039429);
   gre->SetPoint(2,-300,8.3063);
   gre->SetPointError(2,0,0.4261965);
   gre->SetPoint(3,-100,0.08236);
   gre->SetPointError(3,0,0.1869155);
   gre->SetPoint(4,100,-6.68148);
   gre->SetPointError(4,0,0.712621);
   gre->SetPoint(5,300,-12.45672);
   gre->SetPointError(5,0,1.113224);
   gre->SetPoint(6,500,-18.2209);
   gre->SetPointError(6,0,0.1011726);
   gre->SetPoint(7,700,-4.40264);
   gre->SetPointError(7,0,0.7211132);
   
   TH1F *Graph_Graph55 = new TH1F("Graph_Graph55","Corr: LT.DVT50 Plane: V Ring: 4",100,-840,840);
   Graph_Graph55->SetMinimum(-22.13459);
   Graph_Graph55->SetMaximum(23.61557);
   Graph_Graph55->SetDirectory(0);
   Graph_Graph55->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph55->SetLineColor(ci);
   Graph_Graph55->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(909.0143);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.03136005);
   linear_fit->SetParError(0,9.429667e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.163389);
   linear_fit->SetParError(1,0.05922923);
