...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_4->Range(-1050,1.132991,1050,1.37257);
   ...
   gre->SetPoint(0,-700,1.25832);
   gre->SetPointError(0,0,0.02094975);
   gre->SetPoint(1,-500,1.28188);
   gre->SetPointError(1,0,0.007028438);
   gre->SetPoint(2,-300,1.24718);
   gre->SetPointError(2,0,0.01703922);
   gre->SetPoint(3,-100,1.31294);
   gre->SetPointError(3,0,0.01970045);
   gre->SetPoint(4,100,1.19938);
   gre->SetPointError(4,0,0.02645938);
   gre->SetPoint(5,300,1.30252);
   gre->SetPointError(5,0,0.01879719);
   gre->SetPoint(6,500,1.29498);
   gre->SetPointError(6,0,0.01502348);
   gre->SetPoint(7,700,1.25306);
   gre->SetPointError(7,0,0.01654497);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","Corr: LTB.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph43->SetMinimum(1.156949);
   Graph_Graph43->SetMaximum(1.348612);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph43->SetLineColor(ci);
   Graph_Graph43->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.63359);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.061468e-06);
   linear_fit->SetParError(0,1.091315e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.276804);
   linear_fit->SetParError(1,0.005310063);
