...
//=========  (Wed Apr  1 22:34:30 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-22.88456,1050,18.93595);
   ...
   gre->SetPoint(0,-700,7.2215);
   gre->SetPointError(0,0,0.164363);
   gre->SetPoint(1,-500,11.66202);
   gre->SetPointError(1,0,0.3038436);
   gre->SetPoint(2,-300,6.76486);
   gre->SetPointError(2,0,0.2101002);
   gre->SetPoint(3,-100,1.9482);
   gre->SetPointError(3,0,0.3308273);
   gre->SetPoint(4,100,-2.95514);
   gre->SetPointError(4,0,0.3647568);
   gre->SetPoint(5,300,-7.82508);
   gre->SetPointError(5,0,0.3408411);
   gre->SetPoint(6,500,-11.65754);
   gre->SetPointError(6,0,0.2440296);
   gre->SetPoint(7,700,-15.8456);
   gre->SetPointError(7,0,0.06887632);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LT.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-18.70251);
   Graph_Graph54->SetMaximum(14.7539);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1064.258);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01868697);
   linear_fit->SetParError(0,0.000107462);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.516515);
   linear_fit->SetParError(1,0.06848146);
