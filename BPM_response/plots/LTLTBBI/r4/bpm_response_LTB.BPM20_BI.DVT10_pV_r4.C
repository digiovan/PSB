...
//=========  (Wed Apr  1 22:35:53 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_4->Range(-1050,2.481862,1050,2.873169);
   ...
   gre->SetPoint(0,-700,2.65784);
   gre->SetPointError(0,0,0.0248103);
   gre->SetPoint(1,-500,2.70516);
   gre->SetPointError(1,0,0.02753927);
   gre->SetPoint(2,-300,2.68152);
   gre->SetPointError(2,0,0.07615311);
   gre->SetPoint(3,-100,2.71732);
   gre->SetPointError(3,0,0.04558958);
   gre->SetPoint(4,100,2.72858);
   gre->SetPointError(4,0,0.07937104);
   gre->SetPoint(5,300,2.7437);
   gre->SetPointError(5,0,0.01818486);
   gre->SetPoint(6,500,2.69352);
   gre->SetPointError(6,0,0.02193972);
   gre->SetPoint(7,700,2.58998);
   gre->SetPointError(7,0,0.04289985);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: BI.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(2.520993);
   Graph_Graph49->SetMaximum(2.834038);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.10101);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.641728e-05);
   linear_fit->SetParError(0,2.139695e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.699956);
   linear_fit->SetParError(1,0.01036388);
