...
//=========  (Wed Apr  1 22:35:32 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-2.836218,1050,3.343017);
   ...
   gre->SetPoint(0,-700,-1.61068);
   gre->SetPointError(0,0,0.1956655);
   gre->SetPoint(1,-500,-0.74896);
   gre->SetPointError(1,0,0.5981939);
   gre->SetPoint(2,-300,-0.72576);
   gre->SetPointError(2,0,0.1837729);
   gre->SetPoint(3,-100,0.00144);
   gre->SetPointError(3,0,0.1730209);
   gre->SetPoint(4,100,0.91232);
   gre->SetPointError(4,0,0.0910525);
   gre->SetPoint(5,300,1.01008);
   gre->SetPointError(5,0,0.1165542);
   gre->SetPoint(6,500,1.05484);
   gre->SetPointError(6,0,0.1799873);
   gre->SetPoint(7,700,1.59472);
   gre->SetPointError(7,0,0.7184243);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LTB.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-2.218294);
   Graph_Graph54->SetMaximum(2.725093);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.64707);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002494689);
   linear_fit->SetParError(0,0.0001771687);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.3353512);
   linear_fit->SetParError(1,0.05698141);
