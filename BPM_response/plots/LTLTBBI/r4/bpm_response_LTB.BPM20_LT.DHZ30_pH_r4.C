...
//=========  (Wed Apr  1 22:34:35 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_4->Range(-1050,-9.020928,1050,17.56025);
   ...
   gre->SetPoint(0,-700,-4.47564);
   gre->SetPointError(0,0,0.1150917);
   gre->SetPoint(1,-500,-2.46364);
   gre->SetPointError(1,0,0.1624957);
   gre->SetPoint(2,-300,0.77174);
   gre->SetPointError(2,0,0.2655897);
   gre->SetPoint(3,-100,2.38196);
   gre->SetPointError(3,0,0.265528);
   gre->SetPoint(4,100,5.54098);
   gre->SetPointError(4,0,0.4177173);
   gre->SetPoint(5,300,7.49134);
   gre->SetPointError(5,0,0.1081845);
   gre->SetPoint(6,500,10.01572);
   gre->SetPointError(6,0,0.1878648);
   gre->SetPoint(7,700,13.00706);
   gre->SetPointError(7,0,0.122992);
   
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph49->SetMinimum(-6.36281);
   Graph_Graph49->SetMaximum(14.90213);
   Graph_Graph49->SetDirectory(0);
   Graph_Graph49->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph49->SetLineColor(ci);
   Graph_Graph49->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.15816);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01239277);
   linear_fit->SetParError(0,0.000102683);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.017433);
   linear_fit->SetParError(1,0.05534664);
