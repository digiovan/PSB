...
//=========  (Wed Apr  1 22:35:58 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_4->Range(-1050,-7.670808,1050,-7.378996);
   ...
   gre->SetPoint(0,-700,-7.57306);
   gre->SetPointError(0,0,0.03654378);
   gre->SetPoint(1,-500,-7.58536);
   gre->SetPointError(1,0,0.03681299);
   gre->SetPoint(2,-300,-7.52926);
   gre->SetPointError(2,0,0.02912167);
   gre->SetPoint(3,-100,-7.51282);
   gre->SetPointError(3,0,0.04003441);
   gre->SetPoint(4,100,-7.4802);
   gre->SetPointError(4,0,0.02837294);
   gre->SetPoint(5,300,-7.58342);
   gre->SetPointError(5,0,0.037687);
   gre->SetPoint(6,500,-7.57676);
   gre->SetPointError(6,0,0.02809934);
   gre->SetPoint(7,700,-7.45914);
   gre->SetPointError(7,0,0.03150857);
   
   TH1F *Graph_Graph44 = new TH1F("Graph_Graph44","Corr: BI.DHZ20 Plane: H Ring: 4",100,-840,840);
   Graph_Graph44->SetMinimum(-7.641627);
   Graph_Graph44->SetMaximum(-7.408177);
   Graph_Graph44->SetDirectory(0);
   Graph_Graph44->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph44->SetLineColor(ci);
   Graph_Graph44->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.46157);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.795572e-05);
   linear_fit->SetParError(0,2.554851e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.535183);
   linear_fit->SetParError(1,0.01160589);
