...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_4->Range(-1050,0.75402,1050,1.278653);
   ...
   gre->SetPoint(0,-700,1.07496);
   gre->SetPointError(0,0,0.04645983);
   gre->SetPoint(1,-500,1.07646);
   gre->SetPointError(1,0,0.01837914);
   gre->SetPoint(2,-300,0.88364);
   gre->SetPointError(2,0,0.03244116);
   gre->SetPoint(3,-100,1.13374);
   gre->SetPointError(3,0,0.004255701);
   gre->SetPoint(4,100,1.09646);
   gre->SetPointError(4,0,0.01767156);
   gre->SetPoint(5,300,0.89108);
   gre->SetPointError(5,0,0.04962118);
   gre->SetPoint(6,500,1.04772);
   gre->SetPointError(6,0,0.01772868);
   gre->SetPoint(7,700,1.09474);
   gre->SetPointError(7,0,0.09647423);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph48->SetMinimum(0.8064833);
   Graph_Graph48->SetMaximum(1.22619);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph48->SetLineColor(ci);
   Graph_Graph48->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(106.4574);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.023999e-05);
   linear_fit->SetParError(0,2.200103e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.116418);
   linear_fit->SetParError(1,0.004284472);
