...
//=========  (Wed Apr  1 22:36:15 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-4.500507,1050,2.948448);
   ...
   gre->SetPoint(0,-700,-2.669);
   gre->SetPointError(0,0,0.5900143);
   gre->SetPoint(1,-500,-0.13874);
   gre->SetPointError(1,0,0.1542968);
   gre->SetPoint(2,-300,-0.39352);
   gre->SetPointError(2,0,0.1493539);
   gre->SetPoint(3,-100,0.3497);
   gre->SetPointError(3,0,0.2225938);
   gre->SetPoint(4,100,0.10332);
   gre->SetPointError(4,0,0.4148293);
   gre->SetPoint(5,300,1.11744);
   gre->SetPointError(5,0,0.1860113);
   gre->SetPoint(6,500,1.31754);
   gre->SetPointError(6,0,0.3006634);
   gre->SetPoint(7,700,0.94692);
   gre->SetPointError(7,0,0.7600353);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: BI.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-3.755611);
   Graph_Graph54->SetMaximum(2.203552);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.17583);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00180295);
   linear_fit->SetParError(0,0.0002281835);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.4166096);
   linear_fit->SetParError(1,0.08611686);
