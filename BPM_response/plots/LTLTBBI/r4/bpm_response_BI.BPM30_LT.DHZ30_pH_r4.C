...
//=========  (Wed Apr  1 22:34:35 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_4->Range(-1050,2.937464,1050,11.63414);
   ...
   gre->SetPoint(0,-700,10.1685);
   gre->SetPointError(0,0,0.01619729);
   gre->SetPoint(1,-500,9.70606);
   gre->SetPointError(1,0,0.01511755);
   gre->SetPoint(2,-300,8.82596);
   gre->SetPointError(2,0,0.02547111);
   gre->SetPoint(3,-100,8.39512);
   gre->SetPointError(3,0,0.03297238);
   gre->SetPoint(4,100,7.38172);
   gre->SetPointError(4,0,0.07211615);
   gre->SetPoint(5,300,6.94258);
   gre->SetPointError(5,0,0.03843781);
   gre->SetPoint(6,500,6.07476);
   gre->SetPointError(6,0,0.0485461);
   gre->SetPoint(7,700,4.48308);
   gre->SetPointError(7,0,0.09616908);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(3.807132);
   Graph_Graph54->SetMaximum(10.76448);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(260.9725);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003437384);
   linear_fit->SetParError(0,2.7331e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.874808);
   linear_fit->SetParError(1,0.0143707);
