...
//=========  (Wed Apr  1 22:35:06 2015) by ROOT version5.34/21
   ...
   canvas_BI4.BPM50_H_4->Range(-1050,-5.714312,1050,4.975437);
   ...
   gre->SetPoint(0,-700,2.99978);
   gre->SetPointError(0,0,0.1940326);
   gre->SetPoint(1,-500,2.78652);
   gre->SetPointError(1,0,0.1921836);
   gre->SetPoint(2,-300,2.11654);
   gre->SetPointError(2,0,0.09146572);
   gre->SetPoint(3,-100,1.43232);
   gre->SetPointError(3,0,0.3153654);
   gre->SetPoint(4,100,0.96694);
   gre->SetPointError(4,0,0.3841419);
   gre->SetPoint(5,300,0.46582);
   gre->SetPointError(5,0,0.2257503);
   gre->SetPoint(6,500,-0.44078);
   gre->SetPointError(6,0,0.2997621);
   gre->SetPoint(7,700,-3.12882);
   gre->SetPointError(7,0,0.8038666);
   
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph56->SetMinimum(-4.645337);
   Graph_Graph56->SetMaximum(3.906463);
   Graph_Graph56->SetDirectory(0);
   Graph_Graph56->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph56->SetLineColor(ci);
   Graph_Graph56->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.00618);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002986685);
   linear_fit->SetParError(0,0.0002131132);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.177954);
   linear_fit->SetParError(1,0.08578139);
