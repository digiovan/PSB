...
//=========  (Wed Apr  1 22:36:09 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_4->Range(-1050,-1.820025,1050,-1.680289);
   ...
   gre->SetPoint(0,-700,-1.76318);
   gre->SetPointError(0,0,0.006248238);
   gre->SetPoint(1,-500,-1.76302);
   gre->SetPointError(1,0,0.02365784);
   gre->SetPoint(2,-300,-1.74048);
   gre->SetPointError(2,0,0.02260603);
   gre->SetPoint(3,-100,-1.73018);
   gre->SetPointError(3,0,0.02660139);
   gre->SetPoint(4,100,-1.76314);
   gre->SetPointError(4,0,0.006587766);
   gre->SetPoint(5,300,-1.7921);
   gre->SetPointError(5,0,0.004635886);
   gre->SetPoint(6,500,-1.74486);
   gre->SetPointError(6,0,0.009521679);
   gre->SetPoint(7,700,-1.778);
   gre->SetPointError(7,0,0.005945921);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-1.806052);
   Graph_Graph47->SetMaximum(-1.694263);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(31.14354);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.242987e-05);
   linear_fit->SetParError(0,5.702696e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.771749);
   linear_fit->SetParError(1,0.002822981);
