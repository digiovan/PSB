...
//=========  (Wed Apr  1 22:36:25 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_4->Range(-1050,-0.3891191,1050,-0.2430589);
   ...
   gre->SetPoint(0,-700,-0.3224);
   gre->SetPointError(0,0,0.02873121);
   gre->SetPoint(1,-500,-0.31224);
   gre->SetPointError(1,0,0.0137394);
   gre->SetPoint(2,-300,-0.29648);
   gre->SetPointError(2,0,0.008021727);
   gre->SetPoint(3,-100,-0.30794);
   gre->SetPointError(3,0,0.01485462);
   gre->SetPoint(4,100,-0.33906);
   gre->SetPointError(4,0,0.0123528);
   gre->SetPoint(5,300,-0.3605);
   gre->SetPointError(5,0,0.004275744);
   gre->SetPoint(6,500,-0.33434);
   gre->SetPointError(6,0,0.009939094);
   gre->SetPoint(7,700,-0.30916);
   gre->SetPointError(7,0,0.04175772);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","Corr: BI.DVT40 Plane: V Ring: 4",100,-840,840);
   Graph_Graph47->SetMinimum(-0.3745131);
   Graph_Graph47->SetMaximum(-0.2576649);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph47->SetLineColor(ci);
   Graph_Graph47->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.07965);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.453883e-05);
   linear_fit->SetParError(0,1.042761e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3313943);
   linear_fit->SetParError(1,0.003509728);
