...
//=========  (Wed Apr  1 22:36:09 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_4->Range(-1050,-6.376025,1050,-5.928621);
   ...
   gre->SetPoint(0,-700,-6.1213);
   gre->SetPointError(0,0,0.0182086);
   gre->SetPoint(1,-500,-6.15644);
   gre->SetPointError(1,0,0.07437272);
   gre->SetPoint(2,-300,-6.05158);
   gre->SetPointError(2,0,0.04839194);
   gre->SetPoint(3,-100,-6.08644);
   gre->SetPointError(3,0,0.08098715);
   gre->SetPoint(4,100,-6.18804);
   gre->SetPointError(4,0,0.03019572);
   gre->SetPoint(5,300,-6.26558);
   gre->SetPointError(5,0,0.03587749);
   gre->SetPoint(6,500,-6.0572);
   gre->SetPointError(6,0,0.04097429);
   gre->SetPoint(7,700,-6.17064);
   gre->SetPointError(7,0,0.05078026);
   
   TH1F *Graph_Graph51 = new TH1F("Graph_Graph51","Corr: BI.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph51->SetMinimum(-6.331284);
   Graph_Graph51->SetMaximum(-5.973361);
   Graph_Graph51->SetDirectory(0);
   Graph_Graph51->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph51->SetLineColor(ci);
   Graph_Graph51->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.04942);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.257587e-05);
   linear_fit->SetParError(0,2.444632e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.151227);
   linear_fit->SetParError(1,0.01336565);
