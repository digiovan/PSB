...
//=========  (Wed Apr  1 22:35:05 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_4->Range(-1050,-9.545027,1050,-9.007035);
   ...
   gre->SetPoint(0,-700,-9.34872);
   gre->SetPointError(0,0,0.04255933);
   gre->SetPoint(1,-500,-9.3179);
   gre->SetPointError(1,0,0.1374616);
   gre->SetPoint(2,-300,-9.25828);
   gre->SetPointError(2,0,0.007051828);
   gre->SetPoint(3,-100,-9.14452);
   gre->SetPointError(3,0,0.04781962);
   gre->SetPoint(4,100,-9.21474);
   gre->SetPointError(4,0,0.06339501);
   gre->SetPoint(5,300,-9.23596);
   gre->SetPointError(5,0,0.0977021);
   gre->SetPoint(6,500,-9.27454);
   gre->SetPointError(6,0,0.02159049);
   gre->SetPoint(7,700,-9.28432);
   gre->SetPointError(7,0,0.05623659);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LTB.DHZ10 Plane: H Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-9.491228);
   Graph_Graph45->SetMaximum(-9.060834);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.6172);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.764643e-06);
   linear_fit->SetParError(0,2.425976e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.25929);
   linear_fit->SetParError(1,0.008293722);
