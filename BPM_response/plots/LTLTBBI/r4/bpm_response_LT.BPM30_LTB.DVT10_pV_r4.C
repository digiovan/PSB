...
//=========  (Wed Apr  1 22:35:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_4->Range(-1050,-11.5804,1050,-11.0964);
   ...
   gre->SetPoint(0,-700,-11.29972);
   gre->SetPointError(0,0,0.01537352);
   gre->SetPoint(1,-500,-11.29256);
   gre->SetPointError(1,0,0.01219027);
   gre->SetPoint(2,-300,-11.31756);
   gre->SetPointError(2,0,0.03241531);
   gre->SetPoint(3,-100,-11.18922);
   gre->SetPointError(3,0,0.01215482);
   gre->SetPoint(4,100,-11.32686);
   gre->SetPointError(4,0,0.1095845);
   gre->SetPoint(5,300,-11.38712);
   gre->SetPointError(5,0,0.01170703);
   gre->SetPoint(6,500,-11.39624);
   gre->SetPointError(6,0,0.1034901);
   gre->SetPoint(7,700,-11.32362);
   gre->SetPointError(7,0,0.0434432);
   
   TH1F *Graph_Graph45 = new TH1F("Graph_Graph45","Corr: LTB.DVT10 Plane: V Ring: 4",100,-840,840);
   Graph_Graph45->SetMinimum(-11.532);
   Graph_Graph45->SetMaximum(-11.1448);
   Graph_Graph45->SetDirectory(0);
   Graph_Graph45->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph45->SetLineColor(ci);
   Graph_Graph45->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(120.5566);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.899985e-05);
   linear_fit->SetParError(0,1.57511e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.3074);
   linear_fit->SetParError(1,0.006714779);
