...
//=========  (Wed Apr  1 22:34:40 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_4->Range(-1050,-34.1045,1050,25.03622);
   ...
   gre->SetPoint(0,-700,12.42698);
   gre->SetPointError(0,0,0.1537854);
   gre->SetPoint(1,-500,15.06768);
   gre->SetPointError(1,0,0.1117552);
   gre->SetPoint(2,-300,9.63048);
   gre->SetPointError(2,0,0.2040093);
   gre->SetPoint(3,-100,2.75646);
   gre->SetPointError(3,0,0.1760766);
   gre->SetPoint(4,100,-3.55088);
   gre->SetPointError(4,0,0.1615268);
   gre->SetPoint(5,300,-10.13282);
   gre->SetPointError(5,0,0.1298283);
   gre->SetPoint(6,500,-17.57728);
   gre->SetPointError(6,0,0.3853728);
   gre->SetPoint(7,700,-23.89578);
   gre->SetPointError(7,0,0.3519347);
   
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","Corr: LT.DVT30 Plane: V Ring: 4",100,-840,840);
   Graph_Graph54->SetMinimum(-28.19043);
   Graph_Graph54->SetMaximum(19.12215);
   Graph_Graph54->SetDirectory(0);
   Graph_Graph54->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph54->SetLineColor(ci);
   Graph_Graph54->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2227.173);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02743099);
   linear_fit->SetParError(0,0.0001471314);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.20883);
   linear_fit->SetParError(1,0.06371133);
