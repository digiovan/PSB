...
//=========  (Wed Apr  1 22:34:35 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_4->Range(-1050,-3.527274,1050,5.326452);
   ...
   gre->SetPoint(0,-700,-1.98626);
   gre->SetPointError(0,0,0.06539316);
   gre->SetPoint(1,-500,-1.36682);
   gre->SetPointError(1,0,0.0819149);
   gre->SetPoint(2,-300,-0.49336);
   gre->SetPointError(2,0,0.05934343);
   gre->SetPoint(3,-100,0.05648);
   gre->SetPointError(3,0,0.1091203);
   gre->SetPoint(4,100,0.93068);
   gre->SetPointError(4,0,0.1907108);
   gre->SetPoint(5,300,1.70068);
   gre->SetPointError(5,0,0.06096013);
   gre->SetPoint(6,500,2.58464);
   gre->SetPointError(6,0,0.07122749);
   gre->SetPoint(7,700,3.7695);
   gre->SetPointError(7,0,0.0813308);
   
   TH1F *Graph_Graph50 = new TH1F("Graph_Graph50","Corr: LT.DHZ30 Plane: H Ring: 4",100,-840,840);
   Graph_Graph50->SetMinimum(-2.641902);
   Graph_Graph50->SetMaximum(4.441079);
   Graph_Graph50->SetDirectory(0);
   Graph_Graph50->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph50->SetLineColor(ci);
   Graph_Graph50->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(31.97693);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003960312);
   linear_fit->SetParError(0,5.549525e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6685051);
   linear_fit->SetParError(1,0.02682423);
