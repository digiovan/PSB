...
//=========  (Wed Apr  1 22:35:22 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_4->Range(-1050,-6.593183,1050,13.51034);
   ...
   gre->SetPoint(0,-700,10.12908);
   gre->SetPointError(0,0,0.0306725);
   gre->SetPoint(1,-500,7.9481);
   gre->SetPointError(1,0,0.1191727);
   gre->SetPoint(2,-300,6.27046);
   gre->SetPointError(2,0,0.1430621);
   gre->SetPoint(3,-100,4.02986);
   gre->SetPointError(3,0,0.09746308);
   gre->SetPoint(4,100,2.34768);
   gre->SetPointError(4,0,0.2040805);
   gre->SetPoint(5,300,0.70596);
   gre->SetPointError(5,0,0.02013585);
   gre->SetPoint(6,500,-1.07882);
   gre->SetPointError(6,0,0.0460797);
   gre->SetPoint(7,700,-3.2147);
   gre->SetPointError(7,0,0.02789594);
   
   TH1F *Graph_Graph52 = new TH1F("Graph_Graph52","Corr: LTB.DVT20 Plane: V Ring: 4",100,-840,840);
   Graph_Graph52->SetMinimum(-4.582831);
   Graph_Graph52->SetMaximum(11.49999);
   Graph_Graph52->SetDirectory(0);
   Graph_Graph52->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph52->SetLineColor(ci);
   Graph_Graph52->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(51.67539);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00946381);
   linear_fit->SetParError(0,2.76765e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.500036);
   linear_fit->SetParError(1,0.01447404);
