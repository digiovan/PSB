...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-7.998212,1050,-7.303407);
   ...
   gre->SetPoint(0,-700,-7.6534);
   gre->SetPointError(0,0,0.02740699);
   gre->SetPoint(1,-500,-7.7387);
   gre->SetPointError(1,0,0.0500597);
   gre->SetPoint(2,-300,-7.70432);
   gre->SetPointError(2,0,0.07893117);
   gre->SetPoint(3,-100,-7.78254);
   gre->SetPointError(3,0,0.05712926);
   gre->SetPoint(4,100,-7.7265);
   gre->SetPointError(4,0,0.0525558);
   gre->SetPoint(5,300,-7.76002);
   gre->SetPointError(5,0,0.122391);
   gre->SetPoint(6,500,-7.47758);
   gre->SetPointError(6,0,0.0583722);
   gre->SetPoint(7,700,-7.63038);
   gre->SetPointError(7,0,0.05203327);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.928731);
   Graph_Graph32->SetMaximum(-7.372887);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.80568);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.381465e-05);
   linear_fit->SetParError(0,3.403744e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.660228);
   linear_fit->SetParError(1,0.01908124);
