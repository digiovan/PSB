...
//=========  (Wed Apr  1 22:35:52 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-10.23468,1050,1.644892);
   ...
   gre->SetPoint(0,-700,-7.46346);
   gre->SetPointError(0,0,0.7912909);
   gre->SetPoint(1,-500,-5.98008);
   gre->SetPointError(1,0,0.6760444);
   gre->SetPoint(2,-300,-6.81562);
   gre->SetPointError(2,0,0.6480915);
   gre->SetPoint(3,-100,-5.03076);
   gre->SetPointError(3,0,0.2569054);
   gre->SetPoint(4,100,-3.03734);
   gre->SetPointError(4,0,0.8285267);
   gre->SetPoint(5,300,-4.80812);
   gre->SetPointError(5,0,0.5069813);
   gre->SetPoint(6,500,-3.01968);
   gre->SetPointError(6,0,0.5488029);
   gre->SetPoint(7,700,-0.65414);
   gre->SetPointError(7,0,0.319103);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: BI.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-9.046722);
   Graph_Graph41->SetMaximum(0.4569344);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.00199);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004755911);
   linear_fit->SetParError(0,0.0003788304);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.590972);
   linear_fit->SetParError(1,0.1666409);
