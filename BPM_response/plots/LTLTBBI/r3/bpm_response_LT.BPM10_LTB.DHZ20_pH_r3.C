...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.768562,1050,1.956782);
   ...
   gre->SetPoint(0,-700,1.87056);
   gre->SetPointError(0,0,0.03594095);
   gre->SetPoint(1,-500,1.88578);
   gre->SetPointError(1,0,0.0224395);
   gre->SetPoint(2,-300,1.89508);
   gre->SetPointError(2,0,0.03033209);
   gre->SetPoint(3,-100,1.86972);
   gre->SetPointError(3,0,0.01794887);
   gre->SetPoint(4,100,1.84692);
   gre->SetPointError(4,0,0.04698798);
   gre->SetPoint(5,300,1.87994);
   gre->SetPointError(5,0,0.01786908);
   gre->SetPoint(6,500,1.83932);
   gre->SetPointError(6,0,0.023827);
   gre->SetPoint(7,700,1.86154);
   gre->SetPointError(7,0,0.03021637);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.787384);
   Graph_Graph29->SetMaximum(1.93796);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.346093);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.2116e-05);
   linear_fit->SetParError(0,2.107133e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.871921);
   linear_fit->SetParError(1,0.008671483);
