...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-25.08525,1050,16.18344);
   ...
   gre->SetPoint(0,-700,9.17872);
   gre->SetPointError(0,0,0.126602);
   gre->SetPoint(1,-500,6.86594);
   gre->SetPointError(1,0,0.0699339);
   gre->SetPoint(2,-300,0.80454);
   gre->SetPointError(2,0,0.2063558);
   gre->SetPoint(3,-100,-4.53356);
   gre->SetPointError(3,0,0.4291184);
   gre->SetPoint(4,100,-8.74986);
   gre->SetPointError(4,0,0.2420182);
   gre->SetPoint(5,300,-13.07484);
   gre->SetPointError(5,0,0.02652227);
   gre->SetPoint(6,500,-18.08546);
   gre->SetPointError(6,0,0.1216774);
   gre->SetPoint(7,700,-6.68786);
   gre->SetPointError(7,0,1.134273);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-20.95838);
   Graph_Graph42->SetMaximum(12.05657);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(520.2809);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02398269);
   linear_fit->SetParError(0,7.53198e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.869698);
   linear_fit->SetParError(1,0.02685853);
