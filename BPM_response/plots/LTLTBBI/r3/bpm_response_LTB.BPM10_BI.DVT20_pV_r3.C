...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,0.759376,1050,1.064237);
   ...
   gre->SetPoint(0,-700,0.91368);
   gre->SetPointError(0,0,0.02113283);
   gre->SetPoint(1,-500,0.95234);
   gre->SetPointError(1,0,0.03667078);
   gre->SetPoint(2,-300,0.94662);
   gre->SetPointError(2,0,0.01920014);
   gre->SetPoint(3,-100,0.96958);
   gre->SetPointError(3,0,0.03871874);
   gre->SetPoint(4,100,0.94604);
   gre->SetPointError(4,0,0.03791753);
   gre->SetPoint(5,300,0.9779);
   gre->SetPointError(5,0,0.03552673);
   gre->SetPoint(6,500,0.83064);
   gre->SetPointError(6,0,0.02045382);
   gre->SetPoint(7,700,0.90174);
   gre->SetPointError(7,0,0.01836948);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.7898621);
   Graph_Graph34->SetMaximum(1.033751);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.72722);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.176074e-05);
   linear_fit->SetParError(0,1.662413e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.915689);
   linear_fit->SetParError(1,0.008754576);
