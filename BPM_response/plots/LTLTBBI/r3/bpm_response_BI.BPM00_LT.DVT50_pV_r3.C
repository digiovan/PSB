...
//=========  (Wed Apr  1 22:35:00 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-9.808068,1050,8.172903);
   ...
   gre->SetPoint(0,-700,5.15848);
   gre->SetPointError(0,0,0.01759408);
   gre->SetPoint(1,-500,3.35224);
   gre->SetPointError(1,0,0.02743503);
   gre->SetPoint(2,-300,1.62412);
   gre->SetPointError(2,0,0.02000555);
   gre->SetPoint(3,-100,-0.10184);
   gre->SetPointError(3,0,0.03960884);
   gre->SetPoint(4,100,-1.8387);
   gre->SetPointError(4,0,0.07867688);
   gre->SetPoint(5,300,-3.32046);
   gre->SetPointError(5,0,0.01700898);
   gre->SetPoint(6,500,-4.98586);
   gre->SetPointError(6,0,0.01817442);
   gre->SetPoint(7,700,-6.7571);
   gre->SetPointError(7,0,0.05413965);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-8.009971);
   Graph_Graph37->SetMaximum(6.374805);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(64.33678);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008422719);
   linear_fit->SetParError(0,1.734546e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.8121437);
   linear_fit->SetParError(1,0.008326294);
