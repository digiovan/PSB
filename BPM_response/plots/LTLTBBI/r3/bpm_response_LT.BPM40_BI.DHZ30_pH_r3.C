...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-0.4032327,1050,-0.3136177);
   ...
   gre->SetPointError(0,0,0.003031756);
   gre->SetPoint(1,-500,-0.36956);
   gre->SetPointError(1,0,0.003206399);
   gre->SetPoint(2,-300,-0.37322);
   gre->SetPointError(2,0,0.01507687);
   gre->SetPoint(3,-100,-0.33936);
   gre->SetPointError(3,0,0.01080643);
   gre->SetPoint(4,100,-0.34958);
   gre->SetPointError(4,0,0.00579976);
   gre->SetPoint(5,300,-0.3736);
   gre->SetPointError(5,0,0.004008323);
   gre->SetPoint(6,500,-0.36188);
   gre->SetPointError(6,0,0.003761844);
   gre->SetPoint(7,700,-0.34796);
   gre->SetPointError(7,0,0.005982695);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-0.3942712);
   Graph_Graph32->SetMaximum(-0.3225792);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.52924);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.761774e-06);
   linear_fit->SetParError(0,3.026782e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3593608);
   linear_fit->SetParError(1,0.001606334);
