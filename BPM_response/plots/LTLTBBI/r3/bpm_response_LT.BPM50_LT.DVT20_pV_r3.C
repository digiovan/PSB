...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   gre->SetPoint(0,-700,1.67354);
   gre->SetPointError(0,0,0.03729146);
   gre->SetPoint(1,-500,0.47922);
   gre->SetPointError(1,0,0.04350326);
   gre->SetPoint(2,-300,0.38524);
   gre->SetPointError(2,0,0.02186887);
   gre->SetPoint(3,-100,0.32072);
   gre->SetPointError(3,0,0.01882014);
   gre->SetPoint(4,100,0.12878);
   gre->SetPointError(4,0,0.009717501);
   gre->SetPoint(5,300,-0.03002);
   gre->SetPointError(5,0,0.02717968);
   gre->SetPoint(6,500,-0.2686);
   gre->SetPointError(6,0,0.01892537);
   gre->SetPoint(7,700,0.7441);
   gre->SetPointError(7,0,0.006963593);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-0.487361);
   Graph_Graph33->SetMaximum(1.910667);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5069.448);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003431795);
   linear_fit->SetParError(0,1.306827e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.330581);
   linear_fit->SetParError(1,0.006946537);
