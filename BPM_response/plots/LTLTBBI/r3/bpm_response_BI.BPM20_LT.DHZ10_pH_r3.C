...
//=========  (Wed Apr  1 22:34:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,7.700375,1050,9.29244);
   ...
   gre->SetPoint(0,-700,7.98822);
   gre->SetPointError(0,0,0.02250123);
   gre->SetPoint(1,-500,8.37312);
   gre->SetPointError(1,0,0.04367161);
   gre->SetPoint(2,-300,8.47524);
   gre->SetPointError(2,0,0.01585363);
   gre->SetPoint(3,-100,8.41942);
   gre->SetPointError(3,0,0.05126753);
   gre->SetPoint(4,100,8.49666);
   gre->SetPointError(4,0,0.02692114);
   gre->SetPoint(5,300,8.82836);
   gre->SetPointError(5,0,0.04588728);
   gre->SetPoint(6,500,8.99624);
   gre->SetPointError(6,0,0.03085568);
   gre->SetPoint(7,700,8.91002);
   gre->SetPointError(7,0,0.02537123);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(7.859581);
   Graph_Graph39->SetMaximum(9.133233);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(140.9988);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0006251697);
   linear_fit->SetParError(0,2.017967e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.563421);
   linear_fit->SetParError(1,0.009562193);
