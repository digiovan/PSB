...
//=========  (Wed Apr  1 22:34:13 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,-4.093789,1050,7.023412);
   ...
   gre->SetPoint(0,-700,5.11036);
   gre->SetPointError(0,0,0.06018544);
   gre->SetPoint(1,-500,3.4953);
   gre->SetPointError(1,0,0.0241);
   gre->SetPoint(2,-300,2.26498);
   gre->SetPointError(2,0,0.1280501);
   gre->SetPoint(3,-100,1.94788);
   gre->SetPointError(3,0,0.2209714);
   gre->SetPoint(4,100,1.03276);
   gre->SetPointError(4,0,0.08024947);
   gre->SetPoint(5,300,-0.91664);
   gre->SetPointError(5,0,0.07117999);
   gre->SetPoint(6,500,-1.66548);
   gre->SetPointError(6,0,0.1189292);
   gre->SetPoint(7,700,-2.0893);
   gre->SetPointError(7,0,0.1516223);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-2.982069);
   Graph_Graph34->SetMaximum(5.911692);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(174.7679);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005212005);
   linear_fit->SetParError(0,5.901343e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9858265);
   linear_fit->SetParError(1,0.02934813);
