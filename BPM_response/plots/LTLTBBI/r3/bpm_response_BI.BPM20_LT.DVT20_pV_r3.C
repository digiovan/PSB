...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-8.14891,1050,5.240315);
   ...
   gre->SetPoint(0,-700,2.98114);
   gre->SetPointError(0,0,0.02763746);
   gre->SetPoint(1,-500,1.78434);
   gre->SetPointError(1,0,0.1034563);
   gre->SetPoint(2,-300,0.21128);
   gre->SetPointError(2,0,0.03004834);
   gre->SetPoint(3,-100,-1.05518);
   gre->SetPointError(3,0,0.1523444);
   gre->SetPoint(4,100,-2.40984);
   gre->SetPointError(4,0,0.02271206);
   gre->SetPoint(5,300,-3.57908);
   gre->SetPointError(5,0,0.004547539);
   gre->SetPoint(6,500,-4.72742);
   gre->SetPointError(6,0,0.05111435);
   gre->SetPoint(7,700,-5.88798);
   gre->SetPointError(7,0,0.0293928);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-6.809988);
   Graph_Graph39->SetMaximum(3.901392);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(143.5422);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006407266);
   linear_fit->SetParError(0,2.24433e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.651598);
   linear_fit->SetParError(1,0.007328605);
