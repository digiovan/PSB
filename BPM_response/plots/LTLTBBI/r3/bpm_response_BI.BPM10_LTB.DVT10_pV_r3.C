...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,-19.66844,1050,26.62833);
   ...
   gre->SetPoint(0,-700,18.7991);
   gre->SetPointError(0,0,0.1131015);
   gre->SetPoint(1,-500,14.5308);
   gre->SetPointError(1,0,0.05562325);
   gre->SetPoint(2,-300,10.1316);
   gre->SetPointError(2,0,0.07824001);
   gre->SetPoint(3,-100,5.7196);
   gre->SetPointError(3,0,0.1307569);
   gre->SetPoint(4,100,1.551);
   gre->SetPointError(4,0,0.08697892);
   gre->SetPoint(5,300,-2.52958);
   gre->SetPointError(5,0,0.2039456);
   gre->SetPoint(6,500,-7.29144);
   gre->SetPointError(6,0,0.06465066);
   gre->SetPoint(7,700,-11.88374);
   gre->SetPointError(7,0,0.0685752);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-15.03877);
   Graph_Graph38->SetMaximum(21.99865);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.89936);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02189352);
   linear_fit->SetParError(0,5.757812e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.586681);
   linear_fit->SetParError(1,0.02850962);
