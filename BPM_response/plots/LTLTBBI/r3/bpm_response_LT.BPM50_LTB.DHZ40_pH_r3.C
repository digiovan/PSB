...
//=========  (Wed Apr  1 22:35:36 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-1.792426,1050,-1.628564);
   ...
   gre->SetPoint(0,-700,-1.73544);
   gre->SetPointError(0,0,0.01040095);
   gre->SetPoint(1,-500,-1.70268);
   gre->SetPointError(1,0,0.01377296);
   gre->SetPoint(2,-300,-1.7343);
   gre->SetPointError(2,0,0.005765166);
   gre->SetPoint(3,-100,-1.69834);
   gre->SetPointError(3,0,0.01630356);
   gre->SetPoint(4,100,-1.70982);
   gre->SetPointError(4,0,0.01704554);
   gre->SetPoint(5,300,-1.71782);
   gre->SetPointError(5,0,0.02374776);
   gre->SetPoint(6,500,-1.67834);
   gre->SetPointError(6,0,0.02246531);
   gre->SetPoint(7,700,-1.7278);
   gre->SetPointError(7,0,0.03731596);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-1.77604);
   Graph_Graph33->SetMaximum(-1.644951);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.43746);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.709996e-05);
   linear_fit->SetParError(0,1.413394e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.717281);
   linear_fit->SetParError(1,0.005847842);
