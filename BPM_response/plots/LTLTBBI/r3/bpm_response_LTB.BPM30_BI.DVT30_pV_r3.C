...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,2.221383,1050,3.229779);
   ...
   gre->SetPoint(0,-700,2.58162);
   gre->SetPointError(0,0,0.192171);
   gre->SetPoint(1,-500,2.94566);
   gre->SetPointError(1,0,0.0499032);
   gre->SetPoint(2,-300,2.9521);
   gre->SetPointError(2,0,0.03926331);
   gre->SetPoint(3,-100,3.01626);
   gre->SetPointError(3,0,0.04545288);
   gre->SetPoint(4,100,2.85316);
   gre->SetPointError(4,0,0.09713137);
   gre->SetPoint(5,300,2.944);
   gre->SetPointError(5,0,0.03821642);
   gre->SetPoint(6,500,2.99374);
   gre->SetPointError(6,0,0.02084001);
   gre->SetPoint(7,700,2.63456);
   gre->SetPointError(7,0,0.1086603);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(2.322223);
   Graph_Graph36->SetMaximum(3.128939);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.82316);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.587023e-05);
   linear_fit->SetParError(0,3.89049e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.961902);
   linear_fit->SetParError(1,0.016541);
