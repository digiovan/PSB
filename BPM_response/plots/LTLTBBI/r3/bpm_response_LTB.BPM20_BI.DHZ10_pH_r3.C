...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,3.32988,1050,4.202858);
   ...
   gre->SetPoint(0,-700,3.6287);
   gre->SetPointError(0,0,0.06463173);
   gre->SetPoint(1,-500,3.689);
   gre->SetPointError(1,0,0.1195398);
   gre->SetPoint(2,-300,3.8127);
   gre->SetPointError(2,0,0.2446617);
   gre->SetPoint(3,-100,3.63996);
   gre->SetPointError(3,0,0.107918);
   gre->SetPoint(4,100,3.59742);
   gre->SetPointError(4,0,0.1220433);
   gre->SetPoint(5,300,3.69954);
   gre->SetPointError(5,0,0.1303984);
   gre->SetPoint(6,500,3.61048);
   gre->SetPointError(6,0,0.05721093);
   gre->SetPoint(7,700,3.62722);
   gre->SetPointError(7,0,0.07661706);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(3.417178);
   Graph_Graph35->SetMaximum(4.11556);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.175008);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.822239e-05);
   linear_fit->SetParError(0,5.806192e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.634588);
   linear_fit->SetParError(1,0.03174148);
