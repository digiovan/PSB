...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.8910343,1050,1.19583);
   ...
   gre->SetPoint(0,-700,1.07626);
   gre->SetPointError(0,0,0.05056739);
   gre->SetPoint(1,-500,1.07852);
   gre->SetPointError(1,0,0.04970458);
   gre->SetPoint(2,-300,1.13116);
   gre->SetPointError(2,0,0.01387077);
   gre->SetPoint(3,-100,1.10252);
   gre->SetPointError(3,0,0.01949401);
   gre->SetPoint(4,100,1.02868);
   gre->SetPointError(4,0,0.08684642);
   gre->SetPoint(5,300,1.09204);
   gre->SetPointError(5,0,0.02632239);
   gre->SetPoint(6,500,1.0568);
   gre->SetPointError(6,0,0.05384744);
   gre->SetPoint(7,700,1.07984);
   gre->SetPointError(7,0,0.03479501);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.9215139);
   Graph_Graph29->SetMaximum(1.16535);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.261065);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.023206e-05);
   linear_fit->SetParError(0,2.770999e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.10473);
   linear_fit->SetParError(1,0.009754252);
