...
//=========  (Wed Apr  1 22:34:29 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-26.49897,1050,12.86848);
   ...
   gre->SetPoint(0,-700,-19.15852);
   gre->SetPointError(0,0,0.7792072);
   gre->SetPoint(1,-500,-17.19236);
   gre->SetPointError(1,0,0.2924434);
   gre->SetPoint(2,-300,-10.87654);
   gre->SetPointError(2,0,0.3795959);
   gre->SetPoint(3,-100,-8.05504);
   gre->SetPointError(3,0,0.8577674);
   gre->SetPoint(4,100,-4.57692);
   gre->SetPointError(4,0,0.03587237);
   gre->SetPoint(5,300,-1.11496);
   gre->SetPointError(5,0,0.0867409);
   gre->SetPoint(6,500,2.89042);
   gre->SetPointError(6,0,0.3162954);
   gre->SetPoint(7,700,6.20948);
   gre->SetPointError(7,0,0.09775978);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-22.56222);
   Graph_Graph42->SetMaximum(8.931736);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(44.48312);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01821334);
   linear_fit->SetParError(0,0.0001497563);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.445755);
   linear_fit->SetParError(1,0.04085543);
