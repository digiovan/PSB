...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-4.147088,1050,2.199325);
   ...
   gre->SetPoint(0,-700,-3.03698);
   gre->SetPointError(0,0,0.05237269);
   gre->SetPoint(1,-500,-2.43488);
   gre->SetPointError(1,0,0.06838432);
   gre->SetPoint(2,-300,-1.78984);
   gre->SetPointError(2,0,0.04811132);
   gre->SetPoint(3,-100,-1.22308);
   gre->SetPointError(3,0,0.03412456);
   gre->SetPoint(4,100,-0.80016);
   gre->SetPointError(4,0,0.03595562);
   gre->SetPoint(5,300,-0.22112);
   gre->SetPointError(5,0,0.009042507);
   gre->SetPoint(6,500,0.45742);
   gre->SetPointError(6,0,0.0149959);
   gre->SetPoint(7,700,1.08468);
   gre->SetPointError(7,0,0.05690961);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-3.512447);
   Graph_Graph37->SetMaximum(1.564684);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(59.48914);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00287008);
   linear_fit->SetParError(0,3.088155e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.044511);
   linear_fit->SetParError(1,0.01134918);
