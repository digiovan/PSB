...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-0.3872882,1050,-0.3071763);
   ...
   gre->SetPoint(0,-700,-0.34394);
   gre->SetPointError(0,0,0.004641199);
   gre->SetPoint(1,-500,-0.35458);
   gre->SetPointError(1,0,0.01778552);
   gre->SetPoint(2,-300,-0.3535);
   gre->SetPointError(2,0,0.00293365);
   gre->SetPoint(3,-100,-0.33544);
   gre->SetPointError(3,0,0.002322989);
   gre->SetPoint(4,100,-0.36022);
   gre->SetPointError(4,0,0.01371624);
   gre->SetPoint(5,300,-0.3532);
   gre->SetPointError(5,0,0.008096862);
   gre->SetPoint(6,500,-0.32368);
   gre->SetPointError(6,0,0.003151686);
   gre->SetPoint(7,700,-0.34382);
   gre->SetPointError(7,0,0.008140095);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-0.379277);
   Graph_Graph32->SetMaximum(-0.3151875);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(34.97567);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.830971e-05);
   linear_fit->SetParError(0,3.809887e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3385294);
   linear_fit->SetParError(1,0.001442126);
