...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_3->Range(-1050,-6.387978,1050,-5.246084);
   ...
   gre->SetPoint(0,-700,-6.13194);
   gre->SetPointError(0,0,0.06572232);
   gre->SetPoint(1,-500,-6.0436);
   gre->SetPointError(1,0,0.05619091);
   gre->SetPoint(2,-300,-6.00906);
   gre->SetPointError(2,0,0.0654948);
   gre->SetPoint(3,-100,-5.79038);
   gre->SetPointError(3,0,0.06913877);
   gre->SetPoint(4,100,-5.74382);
   gre->SetPointError(4,0,0.08811119);
   gre->SetPoint(5,300,-5.65006);
   gre->SetPointError(5,0,0.05149087);
   gre->SetPoint(6,500,-5.57452);
   gre->SetPointError(6,0,0.03420806);
   gre->SetPoint(7,700,-5.50184);
   gre->SetPointError(7,0,0.06543998);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-6.273789);
   Graph_Graph37->SetMaximum(-5.360274);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.987894);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004692393);
   linear_fit->SetParError(0,4.291891e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.806955);
   linear_fit->SetParError(1,0.0203136);
