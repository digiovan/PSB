...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-6.847955,1050,-6.446725);
   ...
   gre->SetPoint(0,-700,-6.66686);
   gre->SetPointError(0,0,0.03330896);
   gre->SetPoint(1,-500,-6.65796);
   gre->SetPointError(1,0,0.02174046);
   gre->SetPoint(2,-300,-6.66036);
   gre->SetPointError(2,0,0.06882429);
   gre->SetPoint(3,-100,-6.60092);
   gre->SetPointError(3,0,0.03476659);
   gre->SetPoint(4,100,-6.7475);
   gre->SetPointError(4,0,0.02778752);
   gre->SetPoint(5,300,-6.64734);
   gre->SetPointError(5,0,0.1337431);
   gre->SetPoint(6,500,-6.6211);
   gre->SetPointError(6,0,0.03184821);
   gre->SetPoint(7,700,-6.652);
   gre->SetPointError(7,0,0.06869386);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-6.807832);
   Graph_Graph30->SetMaximum(-6.486848);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.2643);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.069231e-06);
   linear_fit->SetParError(0,2.886664e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.663553);
   linear_fit->SetParError(1,0.013129);
