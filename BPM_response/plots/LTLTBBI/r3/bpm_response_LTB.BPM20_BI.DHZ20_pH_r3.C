...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,2.973382,1050,3.97429);
   ...
   gre->SetPoint(0,-700,3.47046);
   gre->SetPointError(0,0,0.09942052);
   gre->SetPoint(1,-500,3.57484);
   gre->SetPointError(1,0,0.07060687);
   gre->SetPoint(2,-300,3.37838);
   gre->SetPointError(2,0,0.2381804);
   gre->SetPoint(3,-100,3.64182);
   gre->SetPointError(3,0,0.1656518);
   gre->SetPoint(4,100,3.6845);
   gre->SetPointError(4,0,0.04010431);
   gre->SetPoint(5,300,3.44608);
   gre->SetPointError(5,0,0.125249);
   gre->SetPoint(6,500,3.528);
   gre->SetPointError(6,0,0.1330986);
   gre->SetPoint(7,700,3.64804);
   gre->SetPointError(7,0,0.08973906);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(3.073472);
   Graph_Graph35->SetMaximum(3.874199);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.301213);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.944047e-05);
   linear_fit->SetParError(0,7.286206e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.618516);
   linear_fit->SetParError(1,0.02862377);
