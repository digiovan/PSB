...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,-6.596487,1050,8.835816);
   ...
   gre->SetPoint(0,-700,-4.01376);
   gre->SetPointError(0,0,0.01067665);
   gre->SetPoint(1,-500,-2.5771);
   gre->SetPointError(1,0,0.00411145);
   gre->SetPoint(2,-300,-1.08714);
   gre->SetPointError(2,0,0.009273645);
   gre->SetPoint(3,-100,0.51706);
   gre->SetPointError(3,0,0.0139713);
   gre->SetPoint(4,100,1.73388);
   gre->SetPointError(4,0,0.0634845);
   gre->SetPoint(5,300,3.17332);
   gre->SetPointError(5,0,0.04697678);
   gre->SetPoint(6,500,4.67358);
   gre->SetPointError(6,0,0.02648847);
   gre->SetPoint(7,700,6.24524);
   gre->SetPointError(7,0,0.01852506);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-5.053257);
   Graph_Graph34->SetMaximum(7.292585);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(146.8392);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.007351495);
   linear_fit->SetParError(0,1.202688e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.110732);
   linear_fit->SetParError(1,0.005957247);
