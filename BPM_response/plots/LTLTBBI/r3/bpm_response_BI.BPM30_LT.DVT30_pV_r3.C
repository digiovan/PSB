...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-35.62147,1050,24.525);
   ...
   gre->SetPoint(0,-700,10.97014);
   gre->SetPointError(0,0,0.05430802);
   gre->SetPoint(1,-500,14.38714);
   gre->SetPointError(1,0,0.1134449);
   gre->SetPoint(2,-300,8.5486);
   gre->SetPointError(2,0,0.1031786);
   gre->SetPoint(3,-100,1.81692);
   gre->SetPointError(3,0,0.08786038);
   gre->SetPoint(4,100,-5.34494);
   gre->SetPointError(4,0,0.6688078);
   gre->SetPoint(5,300,-12.40316);
   gre->SetPointError(5,0,0.198356);
   gre->SetPoint(6,500,-19.39268);
   gre->SetPointError(6,0,0.2734844);
   gre->SetPoint(7,700,-25.11384);
   gre->SetPointError(7,0,0.4832211);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-29.60683);
   Graph_Graph40->SetMaximum(18.51035);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7024.309);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02031253);
   linear_fit->SetParError(0,0.0001178834);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.324236);
   linear_fit->SetParError(1,0.06415824);
