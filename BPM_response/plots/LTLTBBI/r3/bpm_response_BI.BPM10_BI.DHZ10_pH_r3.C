...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-10.1812,1050,2.601699);
   ...
   gre->SetPoint(0,-700,-7.9664);
   gre->SetPointError(0,0,0.08431306);
   gre->SetPoint(1,-500,-6.80784);
   gre->SetPointError(1,0,0.1018128);
   gre->SetPoint(2,-300,-5.75558);
   gre->SetPointError(2,0,0.1531103);
   gre->SetPoint(3,-100,-4.3414);
   gre->SetPointError(3,0,0.1072371);
   gre->SetPoint(4,100,-3.16668);
   gre->SetPointError(4,0,0.1323863);
   gre->SetPoint(5,300,-1.9968);
   gre->SetPointError(5,0,0.09437591);
   gre->SetPoint(6,500,-0.82924);
   gre->SetPointError(6,0,0.02124247);
   gre->SetPoint(7,700,0.33566);
   gre->SetPointError(7,0,0.1355568);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-8.902906);
   Graph_Graph38->SetMaximum(1.32341);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.715663);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005959595);
   linear_fit->SetParError(0,5.58701e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.808019);
   linear_fit->SetParError(1,0.02768449);
