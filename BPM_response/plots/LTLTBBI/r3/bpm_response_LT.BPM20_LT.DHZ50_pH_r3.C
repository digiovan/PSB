...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-8.418818,1050,-7.678776);
   ...
   gre->SetPoint(0,-700,-7.97494);
   gre->SetPointError(0,0,0.02541055);
   gre->SetPoint(1,-500,-8.21836);
   gre->SetPointError(1,0,0.07711814);
   gre->SetPoint(2,-300,-8.03204);
   gre->SetPointError(2,0,0.08095539);
   gre->SetPoint(3,-100,-8.16974);
   gre->SetPointError(3,0,0.04401249);
   gre->SetPoint(4,100,-8.0839);
   gre->SetPointError(4,0,0.03784478);
   gre->SetPoint(5,300,-7.85388);
   gre->SetPointError(5,0,0.05176321);
   gre->SetPoint(6,500,-8.13202);
   gre->SetPointError(6,0,0.070036);
   gre->SetPoint(7,700,-7.95184);
   gre->SetPointError(7,0,0.02107665);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-8.344814);
   Graph_Graph30->SetMaximum(-7.752781);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(42.72145);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.87046e-05);
   linear_fit->SetParError(0,2.261818e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.006082);
   linear_fit->SetParError(1,0.01320257);
