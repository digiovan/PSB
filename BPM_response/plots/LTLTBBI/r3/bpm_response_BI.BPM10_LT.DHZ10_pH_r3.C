...
//=========  (Wed Apr  1 22:34:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-9.45276,1050,1.418649);
   ...
   gre->SetPoint(0,-700,-7.58888);
   gre->SetPointError(0,0,0.05197806);
   gre->SetPoint(1,-500,-6.25518);
   gre->SetPointError(1,0,0.09006529);
   gre->SetPoint(2,-300,-5.08938);
   gre->SetPointError(2,0,0.07468827);
   gre->SetPoint(3,-100,-4.57752);
   gre->SetPointError(3,0,0.06492448);
   gre->SetPoint(4,100,-3.69584);
   gre->SetPointError(4,0,0.2136302);
   gre->SetPoint(5,300,-1.9463);
   gre->SetPointError(5,0,0.1683674);
   gre->SetPoint(6,500,-1.13254);
   gre->SetPointError(6,0,0.06596573);
   gre->SetPoint(7,700,-0.52866);
   gre->SetPointError(7,0,0.1354076);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-8.365619);
   Graph_Graph38->SetMaximum(0.3315081);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(52.49216);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005226172);
   linear_fit->SetParError(0,6.029007e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.837641);
   linear_fit->SetParError(1,0.03040405);
