...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,1.680917,1050,2.721992);
   ...
   gre->SetPoint(0,-700,2.34544);
   gre->SetPointError(0,0,0.03637866);
   gre->SetPoint(1,-500,2.48718);
   gre->SetPointError(1,0,0.04210123);
   gre->SetPoint(2,-300,1.9017);
   gre->SetPointError(2,0,0.04727031);
   gre->SetPoint(3,-100,2.41066);
   gre->SetPointError(3,0,0.02932853);
   gre->SetPoint(4,100,2.37286);
   gre->SetPointError(4,0,0.07457824);
   gre->SetPoint(5,300,2.0558);
   gre->SetPointError(5,0,0.07035056);
   gre->SetPoint(6,500,2.4137);
   gre->SetPointError(6,0,0.1347794);
   gre->SetPoint(7,700,2.3355);
   gre->SetPointError(7,0,0.06505899);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(1.785025);
   Graph_Graph35->SetMaximum(2.617884);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(118.0433);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.753516e-05);
   linear_fit->SetParError(0,4.305379e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.308655);
   linear_fit->SetParError(1,0.01914846);
