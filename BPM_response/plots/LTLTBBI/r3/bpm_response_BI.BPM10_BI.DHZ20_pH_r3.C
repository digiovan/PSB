...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-4.122328,1050,-3.228634);
   ...
   gre->SetPoint(0,-700,-3.62272);
   gre->SetPointError(0,0,0.09592843);
   gre->SetPoint(1,-500,-3.71954);
   gre->SetPointError(1,0,0.05365526);
   gre->SetPoint(2,-300,-3.58906);
   gre->SetPointError(2,0,0.2114771);
   gre->SetPoint(3,-100,-3.87036);
   gre->SetPointError(3,0,0.1030191);
   gre->SetPoint(4,100,-3.8183);
   gre->SetPointError(4,0,0.05084509);
   gre->SetPoint(5,300,-3.6311);
   gre->SetPointError(5,0,0.1426125);
   gre->SetPoint(6,500,-3.59482);
   gre->SetPointError(6,0,0.118263);
   gre->SetPoint(7,700,-3.75144);
   gre->SetPointError(7,0,0.09844331);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-4.032959);
   Graph_Graph38->SetMaximum(-3.318003);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.755885);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.626191e-05);
   linear_fit->SetParError(0,6.891651e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.748132);
   linear_fit->SetParError(1,0.02970061);
