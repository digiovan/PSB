...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-0.5137565,1050,-0.285882);
   ...
   gre->SetPoint(0,-700,-0.37624);
   gre->SetPointError(0,0,0.006890703);
   gre->SetPoint(1,-500,-0.45428);
   gre->SetPointError(1,0,0.006724581);
   gre->SetPoint(2,-300,-0.33552);
   gre->SetPointError(2,0,0.01165895);
   gre->SetPoint(3,-100,-0.44064);
   gre->SetPointError(3,0,0.006324401);
   gre->SetPoint(4,100,-0.46512);
   gre->SetPointError(4,0,0.0106574);
   gre->SetPoint(5,300,-0.37448);
   gre->SetPointError(5,0,0.01432293);
   gre->SetPoint(6,500,-0.45664);
   gre->SetPointError(6,0,0.01077844);
   gre->SetPoint(7,700,-0.39132);
   gre->SetPointError(7,0,0.006784581);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-0.490969);
   Graph_Graph32->SetMaximum(-0.3086694);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(185.4228);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.260802e-06);
   linear_fit->SetParError(0,5.826385e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4168065);
   linear_fit->SetParError(1,0.002922835);
