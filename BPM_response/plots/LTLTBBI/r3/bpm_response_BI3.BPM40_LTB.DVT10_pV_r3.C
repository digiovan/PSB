...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-28.76206,1050,23.89328);
   ...
   gre->SetPoint(0,-700,14.86826);
   gre->SetPointError(0,0,0.2491312);
   gre->SetPoint(1,-500,11.67542);
   gre->SetPointError(1,0,0.09869191);
   gre->SetPoint(2,-300,4.457);
   gre->SetPointError(2,0,0.1329338);
   gre->SetPoint(3,-100,-2.01288);
   gre->SetPointError(3,0,0.4161227);
   gre->SetPoint(4,100,-7.58152);
   gre->SetPointError(4,0,0.2508921);
   gre->SetPoint(5,300,-13.16916);
   gre->SetPointError(5,0,0.1008072);
   gre->SetPoint(6,500,-19.80164);
   gre->SetPointError(6,0,0.1845277);
   gre->SetPoint(7,700,-6.67968);
   gre->SetPointError(7,0,0.1800808);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-23.49652);
   Graph_Graph41->SetMaximum(18.62775);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7534.241);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02432844);
   linear_fit->SetParError(0,0.0001197625);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.351002);
   linear_fit->SetParError(1,0.05320126);
