...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-19.10042,1050,16.47951);
   ...
   gre->SetPoint(0,-700,-12.78884);
   gre->SetPointError(0,0,0.381595);
   gre->SetPoint(1,-500,-9.2657);
   gre->SetPointError(1,0,0.210656);
   gre->SetPoint(2,-300,-6.51274);
   gre->SetPointError(2,0,0.05004322);
   gre->SetPoint(3,-100,-2.87908);
   gre->SetPointError(3,0,0.1629278);
   gre->SetPoint(4,100,0.17432);
   gre->SetPointError(4,0,0.09590965);
   gre->SetPoint(5,300,3.2847);
   gre->SetPointError(5,0,0.1490462);
   gre->SetPoint(6,500,6.38024);
   gre->SetPointError(6,0,0.6640008);
   gre->SetPoint(7,700,10.10648);
   gre->SetPointError(7,0,0.4430391);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LTB.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-15.54243);
   Graph_Graph40->SetMaximum(12.92151);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.21485);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01639064);
   linear_fit->SetParError(0,0.0001714101);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.531202);
   linear_fit->SetParError(1,0.05005847);
