...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,-4.628482,1050,9.047677);
   ...
   gre->SetPoint(0,-700,6.70976);
   gre->SetPointError(0,0,0.05855718);
   gre->SetPoint(1,-500,6.16836);
   gre->SetPointError(1,0,0.1488036);
   gre->SetPoint(2,-300,4.57158);
   gre->SetPointError(2,0,0.07758872);
   gre->SetPoint(3,-100,3.26128);
   gre->SetPointError(3,0,0.207518);
   gre->SetPoint(4,100,1.94218);
   gre->SetPointError(4,0,0.08213123);
   gre->SetPoint(5,300,0.742);
   gre->SetPointError(5,0,0.06779808);
   gre->SetPoint(6,500,-0.3787);
   gre->SetPointError(6,0,0.02504881);
   gre->SetPoint(7,700,-2.2997);
   gre->SetPointError(7,0,0.0494218);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-3.260866);
   Graph_Graph36->SetMaximum(7.680061);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(177.504);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006224611);
   linear_fit->SetParError(0,4.388872e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.584207);
   linear_fit->SetParError(1,0.0229189);
