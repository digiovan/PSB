...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-2.372346,1050,-0.4250434);
   ...
   gre->SetPoint(0,-700,-2.0393);
   gre->SetPointError(0,0,0.008495464);
   gre->SetPoint(1,-500,-1.67598);
   gre->SetPointError(1,0,0.006698662);
   gre->SetPoint(2,-300,-1.81356);
   gre->SetPointError(2,0,0.02939566);
   gre->SetPoint(3,-100,-1.50136);
   gre->SetPointError(3,0,0.01390924);
   gre->SetPoint(4,100,-1.36996);
   gre->SetPointError(4,0,0.01127683);
   gre->SetPoint(5,300,-1.4867);
   gre->SetPointError(5,0,0.04292949);
   gre->SetPoint(6,500,-0.8724);
   gre->SetPointError(6,0,0.1228062);
   gre->SetPoint(7,700,-1.21176);
   gre->SetPointError(7,0,0.02475573);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-2.177616);
   Graph_Graph33->SetMaximum(-0.6197737);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(613.1878);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0006402285);
   linear_fit->SetParError(0,1.273427e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.45598);
   linear_fit->SetParError(1,0.006443507);
