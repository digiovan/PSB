...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,1.038155,1050,1.257381);
   ...
   gre->SetPoint(0,-700,1.15764);
   gre->SetPointError(0,0,0.02426148);
   gre->SetPoint(1,-500,1.15422);
   gre->SetPointError(1,0,0.01844553);
   gre->SetPoint(2,-300,1.11498);
   gre->SetPointError(2,0,0.01197989);
   gre->SetPoint(3,-100,1.18564);
   gre->SetPointError(3,0,0.02902762);
   gre->SetPoint(4,100,1.14536);
   gre->SetPointError(4,0,0.04639139);
   gre->SetPoint(5,300,1.11104);
   gre->SetPointError(5,0,0.03634717);
   gre->SetPoint(6,500,1.16838);
   gre->SetPointError(6,0,0.05246339);
   gre->SetPoint(7,700,1.12682);
   gre->SetPointError(7,0,0.01164283);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.060078);
   Graph_Graph29->SetMaximum(1.235458);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.496516);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-9.881343e-06);
   linear_fit->SetParError(0,1.29547e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.133228);
   linear_fit->SetParError(1,0.006794674);
