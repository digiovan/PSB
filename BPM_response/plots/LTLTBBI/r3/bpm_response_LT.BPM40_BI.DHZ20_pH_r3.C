...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-0.3901217,1050,-0.3310455);
   ...
   gre->SetPoint(0,-700,-0.36526);
   gre->SetPointError(0,0,0.008739525);
   gre->SetPoint(1,-500,-0.37646);
   gre->SetPointError(1,0,0.001709118);
   gre->SetPoint(2,-300,-0.36428);
   gre->SetPointError(2,0,0.01173982);
   gre->SetPoint(3,-100,-0.37408);
   gre->SetPointError(3,0,0.006195669);
   gre->SetPoint(4,100,-0.35504);
   gre->SetPointError(4,0,0.01012189);
   gre->SetPoint(5,300,-0.35096);
   gre->SetPointError(5,0,0.003595201);
   gre->SetPoint(6,500,-0.35254);
   gre->SetPointError(6,0,0.01153992);
   gre->SetPoint(7,700,-0.35506);
   gre->SetPointError(7,0,0.0141685);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-0.3842141);
   Graph_Graph32->SetMaximum(-0.3369531);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.692623);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.703665e-05);
   linear_fit->SetParError(0,4.228574e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3622892);
   linear_fit->SetParError(1,0.001954124);
