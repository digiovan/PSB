...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.284326,1050,2.221122);
   ...
   gre->SetPoint(0,-700,1.88326);
   gre->SetPointError(0,0,0.03251154);
   gre->SetPoint(1,-500,2.00478);
   gre->SetPointError(1,0,0.01179156);
   gre->SetPoint(2,-300,1.89188);
   gre->SetPointError(2,0,0.03243815);
   gre->SetPoint(3,-100,2.05274);
   gre->SetPointError(3,0,0.009454785);
   gre->SetPoint(4,100,2.05022);
   gre->SetPointError(4,0,0.01476949);
   gre->SetPoint(5,300,1.87264);
   gre->SetPointError(5,0,0.03778263);
   gre->SetPoint(6,500,1.64108);
   gre->SetPointError(6,0,0.200621);
   gre->SetPoint(7,700,1.90986);
   gre->SetPointError(7,0,0.014003);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.378006);
   Graph_Graph29->SetMaximum(2.127443);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(105.3352);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.873826e-05);
   linear_fit->SetParError(0,1.413064e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.000021);
   linear_fit->SetParError(1,0.005745604);
