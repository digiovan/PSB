...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,3.998658,1050,9.972593);
   ...
   gre->SetPoint(0,-700,8.7328);
   gre->SetPointError(0,0,0.06960278);
   gre->SetPoint(1,-500,8.959);
   gre->SetPointError(1,0,0.01793728);
   gre->SetPoint(2,-300,8.25722);
   gre->SetPointError(2,0,0.03801981);
   gre->SetPoint(3,-100,8.18254);
   gre->SetPointError(3,0,0.005110218);
   gre->SetPoint(4,100,7.89044);
   gre->SetPointError(4,0,0.02241178);
   gre->SetPoint(5,300,7.34802);
   gre->SetPointError(5,0,0.03427815);
   gre->SetPoint(6,500,5.75836);
   gre->SetPointError(6,0,0.764046);
   gre->SetPoint(7,700,6.58944);
   gre->SetPointError(7,0,0.02709184);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(4.596052);
   Graph_Graph40->SetMaximum(9.3752);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(165.3641);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001884958);
   linear_fit->SetParError(0,2.435834e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.98809);
   linear_fit->SetParError(1,0.005161178);
