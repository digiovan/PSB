...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.9968475,1050,1.23949);
   ...
   gre->SetPoint(0,-700,1.13878);
   gre->SetPointError(0,0,0.06026927);
   gre->SetPoint(1,-500,1.11398);
   gre->SetPointError(1,0,0.07586638);
   gre->SetPoint(2,-300,1.06946);
   gre->SetPointError(2,0,0.03193478);
   gre->SetPoint(3,-100,1.09644);
   gre->SetPointError(3,0,0.03440913);
   gre->SetPoint(4,100,1.16034);
   gre->SetPointError(4,0,0.01579007);
   gre->SetPoint(5,300,1.14964);
   gre->SetPointError(5,0,0.02769421);
   gre->SetPoint(6,500,1.05374);
   gre->SetPointError(6,0,0.01645217);
   gre->SetPoint(7,700,1.09676);
   gre->SetPointError(7,0,0.05101652);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.021112);
   Graph_Graph29->SetMaximum(1.215225);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.2547);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.78518e-05);
   linear_fit->SetParError(0,3.000974e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.120991);
   linear_fit->SetParError(1,0.01091813);
