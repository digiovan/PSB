...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_3->Range(-1050,-6.065119,1050,-5.510629);
   ...
   gre->SetPoint(0,-700,-5.73424);
   gre->SetPointError(0,0,0.0192355);
   gre->SetPoint(1,-500,-5.70632);
   gre->SetPointError(1,0,0.03505794);
   gre->SetPoint(2,-300,-5.77552);
   gre->SetPointError(2,0,0.1716347);
   gre->SetPoint(3,-100,-5.6454);
   gre->SetPointError(3,0,0.04235622);
   gre->SetPoint(4,100,-5.79638);
   gre->SetPointError(4,0,0.07991655);
   gre->SetPoint(5,300,-5.92642);
   gre->SetPointError(5,0,0.04628372);
   gre->SetPoint(6,500,-5.741);
   gre->SetPointError(6,0,0.01177465);
   gre->SetPoint(7,700,-5.79182);
   gre->SetPointError(7,0,0.02663168);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-6.00967);
   Graph_Graph37->SetMaximum(-5.566078);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.49686);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.649893e-05);
   linear_fit->SetParError(0,1.655613e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.741381);
   linear_fit->SetParError(1,0.009144652);
