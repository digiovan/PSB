...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,0.8770601,1050,1.166338);
   ...
   gre->SetPoint(0,-700,0.95368);
   gre->SetPointError(0,0,0.028407);
   gre->SetPoint(1,-500,0.99246);
   gre->SetPointError(1,0,0.04905536);
   gre->SetPoint(2,-300,1.0073);
   gre->SetPointError(2,0,0.02943345);
   gre->SetPoint(3,-100,1.08438);
   gre->SetPointError(3,0,0.03374466);
   gre->SetPoint(4,100,1.01794);
   gre->SetPointError(4,0,0.02985821);
   gre->SetPoint(5,300,1.00428);
   gre->SetPointError(5,0,0.04410045);
   gre->SetPoint(6,500,1.02964);
   gre->SetPointError(6,0,0.04439678);
   gre->SetPoint(7,700,0.98234);
   gre->SetPointError(7,0,0.02079939);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.9059878);
   Graph_Graph34->SetMaximum(1.13741);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.42276);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.732675e-06);
   linear_fit->SetParError(0,2.18625e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.001834);
   linear_fit->SetParError(1,0.0112103);
