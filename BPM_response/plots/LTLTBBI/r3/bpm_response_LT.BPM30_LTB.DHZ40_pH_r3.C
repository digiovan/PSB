...
//=========  (Wed Apr  1 22:35:36 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-9.710616,1050,-9.361532);
   ...
   gre->SetPoint(0,-700,-9.4752);
   gre->SetPointError(0,0,0.03324014);
   gre->SetPoint(1,-500,-9.61764);
   gre->SetPointError(1,0,0.02721377);
   gre->SetPoint(2,-300,-9.5273);
   gre->SetPointError(2,0,0.02344555);
   gre->SetPoint(3,-100,-9.5787);
   gre->SetPointError(3,0,0.04481886);
   gre->SetPoint(4,100,-9.58112);
   gre->SetPointError(4,0,0.01886697);
   gre->SetPoint(5,300,-9.53718);
   gre->SetPointError(5,0,0.03604777);
   gre->SetPoint(6,500,-9.59238);
   gre->SetPointError(6,0,0.06005509);
   gre->SetPoint(7,700,-9.49722);
   gre->SetPointError(7,0,0.07750752);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-9.675707);
   Graph_Graph31->SetMaximum(-9.39644);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.93544);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.711069e-05);
   linear_fit->SetParError(0,3.089737e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.562564);
   linear_fit->SetParError(1,0.01153524);
