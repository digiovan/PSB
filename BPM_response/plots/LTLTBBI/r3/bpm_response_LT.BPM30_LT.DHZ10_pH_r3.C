...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-11.72723,1050,-7.634809);
   ...
   gre->SetPoint(0,-700,-8.34372);
   gre->SetPointError(0,0,0.02683969);
   gre->SetPoint(1,-500,-8.90096);
   gre->SetPointError(1,0,0.01825779);
   gre->SetPoint(2,-300,-9.3852);
   gre->SetPointError(2,0,0.04259187);
   gre->SetPoint(3,-100,-9.53796);
   gre->SetPointError(3,0,0.06350607);
   gre->SetPoint(4,100,-9.9028);
   gre->SetPointError(4,0,0.08368816);
   gre->SetPoint(5,300,-10.5533);
   gre->SetPointError(5,0,0.07196883);
   gre->SetPoint(6,500,-10.76098);
   gre->SetPointError(6,0,0.01773434);
   gre->SetPoint(7,700,-10.98444);
   gre->SetPointError(7,0,0.06072371);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-11.31799);
   Graph_Graph31->SetMaximum(-8.044052);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(57.42542);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001911602);
   linear_fit->SetParError(0,2.060328e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.808139);
   linear_fit->SetParError(1,0.01071882);
