...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-18.0605,1050,10.04379);
   ...
   gre->SetPoint(0,-700,5.15126);
   gre->SetPointError(0,0,0.2084849);
   gre->SetPoint(1,-500,4.36402);
   gre->SetPointError(1,0,0.1619758);
   gre->SetPoint(2,-300,3.62954);
   gre->SetPointError(2,0,0.4997458);
   gre->SetPoint(3,-100,2.37856);
   gre->SetPointError(3,0,0.2347496);
   gre->SetPoint(4,100,-0.99794);
   gre->SetPointError(4,0,0.285354);
   gre->SetPoint(5,300,-4.1856);
   gre->SetPointError(5,0,0.9191581);
   gre->SetPoint(6,500,-10.01232);
   gre->SetPointError(6,0,1.098156);
   gre->SetPoint(7,700,-13.0002);
   gre->SetPointError(7,0,0.3762544);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-15.25007);
   Graph_Graph42->SetMaximum(7.233365);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(310.3226);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01122818);
   linear_fit->SetParError(0,0.0002506523);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.199643);
   linear_fit->SetParError(1,0.1231129);
