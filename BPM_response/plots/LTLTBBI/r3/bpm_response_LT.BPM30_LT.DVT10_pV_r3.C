...
//=========  (Wed Apr  1 22:34:18 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-12.52136,1050,-9.266774);
   ...
   gre->SetPoint(0,-700,-11.8333);
   gre->SetPointError(0,0,0.1456302);
   gre->SetPoint(1,-500,-11.6209);
   gre->SetPointError(1,0,0.01648209);
   gre->SetPoint(2,-300,-11.28476);
   gre->SetPointError(2,0,0.08732137);
   gre->SetPoint(3,-100,-10.84896);
   gre->SetPointError(3,0,0.06615361);
   gre->SetPoint(4,100,-10.67622);
   gre->SetPointError(4,0,0.1750896);
   gre->SetPoint(5,300,-10.53438);
   gre->SetPointError(5,0,0.1220998);
   gre->SetPoint(6,500,-10.26494);
   gre->SetPointError(6,0,0.05375329);
   gre->SetPoint(7,700,-9.86124);
   gre->SetPointError(7,0,0.05203477);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LT.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-12.1959);
   Graph_Graph31->SetMaximum(-9.592233);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.3643);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001432912);
   linear_fit->SetParError(0,3.571199e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.8958);
   linear_fit->SetParError(1,0.01789652);
