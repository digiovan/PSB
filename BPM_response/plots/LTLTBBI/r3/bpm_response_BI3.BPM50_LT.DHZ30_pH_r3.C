...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-0.6954525,1050,7.38389);
   ...
   gre->SetPoint(0,-700,1.06372);
   gre->SetPointError(0,0,0.4126154);
   gre->SetPoint(1,-500,5.09518);
   gre->SetPointError(1,0,0.1287616);
   gre->SetPoint(2,-300,1.87818);
   gre->SetPointError(2,0,0.6957365);
   gre->SetPoint(3,-100,5.90158);
   gre->SetPointError(3,0,0.1357529);
   gre->SetPoint(4,100,1.295);
   gre->SetPointError(4,0,0.2755861);
   gre->SetPoint(5,300,4.89146);
   gre->SetPointError(5,0,0.4420066);
   gre->SetPoint(6,500,2.49888);
   gre->SetPointError(6,0,0.2195576);
   gre->SetPoint(7,700,2.23736);
   gre->SetPointError(7,0,0.2573776);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(0.1124818);
   Graph_Graph42->SetMaximum(6.575956);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(380.8516);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002007125);
   linear_fit->SetParError(0,0.0001816224);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.145172);
   linear_fit->SetParError(1,0.07713469);
