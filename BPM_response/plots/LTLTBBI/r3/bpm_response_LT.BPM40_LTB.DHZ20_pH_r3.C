...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-0.3976864,1050,-0.3079993);
   ...
   gre->SetPoint(0,-700,-0.35898);
   gre->SetPointError(0,0,0.01122976);
   gre->SetPoint(1,-500,-0.34662);
   gre->SetPointError(1,0,0.006217787);
   gre->SetPoint(2,-300,-0.33256);
   gre->SetPointError(2,0,0.009612809);
   gre->SetPoint(3,-100,-0.34068);
   gre->SetPointError(3,0,0.004886163);
   gre->SetPoint(4,100,-0.36424);
   gre->SetPointError(4,0,0.01849859);
   gre->SetPoint(5,300,-0.34992);
   gre->SetPointError(5,0,0.01107784);
   gre->SetPoint(6,500,-0.36052);
   gre->SetPointError(6,0,0.007007217);
   gre->SetPoint(7,700,-0.34122);
   gre->SetPointError(7,0,0.01447821);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-0.3887177);
   Graph_Graph32->SetMaximum(-0.3169681);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.849818);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.364638e-06);
   linear_fit->SetParError(0,7.221353e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3474668);
   linear_fit->SetParError(1,0.002910736);
