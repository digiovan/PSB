...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,6.979378,1050,8.723939);
   ...
   gre->SetPoint(0,-700,7.29882);
   gre->SetPointError(0,0,0.0286819);
   gre->SetPoint(1,-500,7.63542);
   gre->SetPointError(1,0,0.04478619);
   gre->SetPoint(2,-300,7.75734);
   gre->SetPointError(2,0,0.04065304);
   gre->SetPoint(3,-100,7.80154);
   gre->SetPointError(3,0,0.02340023);
   gre->SetPoint(4,100,7.90714);
   gre->SetPointError(4,0,0.02081033);
   gre->SetPoint(5,300,8.28544);
   gre->SetPointError(5,0,0.02334571);
   gre->SetPoint(6,500,8.4123);
   gre->SetPointError(6,0,0.02087845);
   gre->SetPoint(7,700,7.82876);
   gre->SetPointError(7,0,0.06227495);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(7.153834);
   Graph_Graph40->SetMaximum(8.549482);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(193.5762);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0008310777);
   linear_fit->SetParError(0,2.467251e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.919931);
   linear_fit->SetParError(1,0.009715546);
