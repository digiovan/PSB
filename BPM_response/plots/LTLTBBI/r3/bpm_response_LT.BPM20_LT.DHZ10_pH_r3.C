...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-10.06123,1050,-5.856439);
   ...
   gre->SetPoint(0,-700,-6.59496);
   gre->SetPointError(0,0,0.03772207);
   gre->SetPoint(1,-500,-7.08236);
   gre->SetPointError(1,0,0.02976664);
   gre->SetPoint(2,-300,-7.57682);
   gre->SetPointError(2,0,0.04270254);
   gre->SetPoint(3,-100,-7.80522);
   gre->SetPointError(3,0,0.05303802);
   gre->SetPoint(4,100,-8.21864);
   gre->SetPointError(4,0,0.08637437);
   gre->SetPoint(5,300,-8.74624);
   gre->SetPointError(5,0,0.06610505);
   gre->SetPoint(6,500,-9.00762);
   gre->SetPointError(6,0,0.02891885);
   gre->SetPoint(7,700,-9.3026);
   gre->SetPointError(7,0,0.0578345);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-9.640754);
   Graph_Graph30->SetMaximum(-6.276918);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.10256);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001944077);
   linear_fit->SetParError(0,2.991493e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.039988);
   linear_fit->SetParError(1,0.01494816);
