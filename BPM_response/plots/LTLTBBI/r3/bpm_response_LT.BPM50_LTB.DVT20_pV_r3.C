...
//=========  (Wed Apr  1 22:35:20 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_3->Range(-1050,-0.5230674,1050,-0.292497);
   ...
   gre->SetPoint(0,-700,-0.40684);
   gre->SetPointError(0,0,0.03404228);
   gre->SetPoint(1,-500,-0.38638);
   gre->SetPointError(1,0,0.003774592);
   gre->SetPoint(2,-300,-0.45754);
   gre->SetPointError(2,0,0.02709897);
   gre->SetPoint(3,-100,-0.40794);
   gre->SetPointError(3,0,0.02045107);
   gre->SetPoint(4,100,-0.40282);
   gre->SetPointError(4,0,0.05594118);
   gre->SetPoint(5,300,-0.45472);
   gre->SetPointError(5,0,0.02715678);
   gre->SetPoint(6,500,-0.39036);
   gre->SetPointError(6,0,0.05943464);
   gre->SetPoint(7,700,-0.38638);
   gre->SetPointError(7,0,0.02106061);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LTB.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-0.5000103);
   Graph_Graph33->SetMaximum(-0.315554);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.86689);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.097514e-05);
   linear_fit->SetParError(0,1.470324e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3988107);
   linear_fit->SetParError(1,0.00728861);
