...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.810854,1050,1.980949);
   ...
   gre->SetPoint(0,-700,1.9037);
   gre->SetPointError(0,0,0.03457093);
   gre->SetPoint(1,-500,1.87362);
   gre->SetPointError(1,0,0.02207224);
   gre->SetPoint(2,-300,1.86144);
   gre->SetPointError(2,0,0.01395373);
   gre->SetPoint(3,-100,1.90916);
   gre->SetPointError(3,0,0.04344);
   gre->SetPoint(4,100,1.85518);
   gre->SetPointError(4,0,0.01597654);
   gre->SetPoint(5,300,1.87828);
   gre->SetPointError(5,0,0.01252903);
   gre->SetPoint(6,500,1.90796);
   gre->SetPointError(6,0,0.03153405);
   gre->SetPoint(7,700,1.87448);
   gre->SetPointError(7,0,0.01323133);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.827864);
   Graph_Graph29->SetMaximum(1.96394);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.696386);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.4327e-06);
   linear_fit->SetParError(0,1.482997e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.872008);
   linear_fit->SetParError(1,0.006593981);
