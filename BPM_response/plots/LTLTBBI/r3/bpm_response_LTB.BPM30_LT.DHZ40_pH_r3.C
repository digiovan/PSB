...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_3->Range(-1050,-0.86388,1050,2.169301);
   ...
   gre->SetPoint(0,-700,-0.22936);
   gre->SetPointError(0,0,0.1289898);
   gre->SetPoint(1,-500,-0.20378);
   gre->SetPointError(1,0,0.07035792);
   gre->SetPoint(2,-300,0.22304);
   gre->SetPointError(2,0,0.07498165);
   gre->SetPoint(3,-100,0.31866);
   gre->SetPointError(3,0,0.1291837);
   gre->SetPoint(4,100,0.53936);
   gre->SetPointError(4,0,0.1460612);
   gre->SetPoint(5,300,0.99282);
   gre->SetPointError(5,0,0.05891154);
   gre->SetPoint(6,500,0.92644);
   gre->SetPointError(6,0,0.1900656);
   gre->SetPoint(7,700,1.59898);
   gre->SetPointError(7,0,0.06479074);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-0.5605619);
   Graph_Graph36->SetMaximum(1.865983);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.951151);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001398563);
   linear_fit->SetParError(0,6.424978e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5675865);
   linear_fit->SetParError(1,0.03041019);
