...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-7.991594,1050,-7.646597);
   ...
   gre->SetPoint(0,-700,-7.7828);
   gre->SetPointError(0,0,0.03889683);
   gre->SetPoint(1,-500,-7.7877);
   gre->SetPointError(1,0,0.06502628);
   gre->SetPoint(2,-300,-7.791);
   gre->SetPointError(2,0,0.08690384);
   gre->SetPoint(3,-100,-7.90214);
   gre->SetPointError(3,0,0.03195441);
   gre->SetPoint(4,100,-7.80912);
   gre->SetPointError(4,0,0.05617188);
   gre->SetPoint(5,300,-7.81302);
   gre->SetPointError(5,0,0.08984025);
   gre->SetPoint(6,500,-7.84764);
   gre->SetPointError(6,0,0.07643738);
   gre->SetPoint(7,700,-7.85604);
   gre->SetPointError(7,0,0.03871797);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.957094);
   Graph_Graph32->SetMaximum(-7.681096);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.942289);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.423771e-05);
   linear_fit->SetParError(0,3.567324e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.842241);
   linear_fit->SetParError(1,0.01747064);
