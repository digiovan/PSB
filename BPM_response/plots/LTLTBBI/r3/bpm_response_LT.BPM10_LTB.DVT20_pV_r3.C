...
//=========  (Wed Apr  1 22:35:20 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.9512103,1050,1.337022);
   ...
   gre->SetPoint(0,-700,1.11952);
   gre->SetPointError(0,0,0.02913136);
   gre->SetPoint(1,-500,1.1371);
   gre->SetPointError(1,0,0.03624177);
   gre->SetPoint(2,-300,1.03606);
   gre->SetPointError(2,0,0.01193319);
   gre->SetPoint(3,-100,1.06612);
   gre->SetPointError(3,0,0.0193347);
   gre->SetPoint(4,100,1.07954);
   gre->SetPointError(4,0,0.03372148);
   gre->SetPoint(5,300,1.0694);
   gre->SetPointError(5,0,0.0538877);
   gre->SetPoint(6,500,1.16632);
   gre->SetPointError(6,0,0.08990223);
   gre->SetPoint(7,700,1.19754);
   gre->SetPointError(7,0,0.07518041);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LTB.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.9897915);
   Graph_Graph29->SetMaximum(1.298441);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.81057);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.426712e-06);
   linear_fit->SetParError(0,3.525563e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.064223);
   linear_fit->SetParError(1,0.0122304);
