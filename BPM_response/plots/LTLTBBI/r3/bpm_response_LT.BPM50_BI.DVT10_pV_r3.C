...
//=========  (Wed Apr  1 22:35:52 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_3->Range(-1050,-0.4540049,1050,-0.3182159);
   ...
   gre->SetPoint(0,-700,-0.40766);
   gre->SetPointError(0,0,0.02371344);
   gre->SetPoint(1,-500,-0.37948);
   gre->SetPointError(1,0,0.02389011);
   gre->SetPoint(2,-300,-0.39672);
   gre->SetPointError(2,0,0.02645414);
   gre->SetPoint(3,-100,-0.40786);
   gre->SetPointError(3,0,0.0176161);
   gre->SetPoint(4,100,-0.39356);
   gre->SetPointError(4,0,0.01006421);
   gre->SetPoint(5,300,-0.38182);
   gre->SetPointError(5,0,0.006542937);
   gre->SetPoint(6,500,-0.36648);
   gre->SetPointError(6,0,0.02563256);
   gre->SetPoint(7,700,-0.3904);
   gre->SetPointError(7,0,0.02202105);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: BI.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-0.440426);
   Graph_Graph33->SetMaximum(-0.3317948);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.664325);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.925428e-05);
   linear_fit->SetParError(0,1.607693e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3906737);
   linear_fit->SetParError(1,0.005392361);
