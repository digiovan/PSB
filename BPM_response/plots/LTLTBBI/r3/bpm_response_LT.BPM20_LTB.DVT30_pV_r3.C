...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-6.854245,1050,-6.42133);
   ...
   gre->SetPoint(0,-700,-6.67396);
   gre->SetPointError(0,0,0.1081321);
   gre->SetPoint(1,-500,-6.68132);
   gre->SetPointError(1,0,0.08765361);
   gre->SetPoint(2,-300,-6.54718);
   gre->SetPointError(2,0,0.05369771);
   gre->SetPoint(3,-100,-6.63408);
   gre->SetPointError(3,0,0.04415054);
   gre->SetPoint(4,100,-6.67828);
   gre->SetPointError(4,0,0.02420684);
   gre->SetPoint(5,300,-6.72274);
   gre->SetPointError(5,0,0.02837052);
   gre->SetPoint(6,500,-6.57506);
   gre->SetPointError(6,0,0.02131163);
   gre->SetPoint(7,700,-6.6157);
   gre->SetPointError(7,0,0.05749844);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-6.810953);
   Graph_Graph30->SetMaximum(-6.464621);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.96991);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.701551e-05);
   linear_fit->SetParError(0,4.233237e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.652359);
   linear_fit->SetParError(1,0.01604851);
