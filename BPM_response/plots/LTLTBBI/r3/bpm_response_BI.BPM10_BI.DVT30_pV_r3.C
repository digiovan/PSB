...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,3.48918,1050,4.804222);
   ...
   gre->SetPoint(0,-700,4.3319);
   gre->SetPointError(0,0,0.2531481);
   gre->SetPoint(1,-500,3.9057);
   gre->SetPointError(1,0,0.101334);
   gre->SetPoint(2,-300,3.89934);
   gre->SetPointError(2,0,0.05782334);
   gre->SetPoint(3,-100,3.78482);
   gre->SetPointError(3,0,0.07646659);
   gre->SetPoint(4,100,4.05304);
   gre->SetPointError(4,0,0.1853891);
   gre->SetPoint(5,300,3.95812);
   gre->SetPointError(5,0,0.05870395);
   gre->SetPoint(6,500,3.84418);
   gre->SetPointError(6,0,0.03028771);
   gre->SetPoint(7,700,4.32398);
   gre->SetPointError(7,0,0.1461059);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(3.620684);
   Graph_Graph38->SetMaximum(4.672718);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.01029);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.333397e-05);
   linear_fit->SetParError(0,6.210728e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.889912);
   linear_fit->SetParError(1,0.02689797);
