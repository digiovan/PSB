...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-8.059741,1050,-7.605264);
   ...
   gre->SetPoint(0,-700,-7.82888);
   gre->SetPointError(0,0,0.04564953);
   gre->SetPoint(1,-500,-7.76568);
   gre->SetPointError(1,0,0.08466963);
   gre->SetPoint(2,-300,-7.85672);
   gre->SetPointError(2,0,0.02365038);
   gre->SetPoint(3,-100,-7.79404);
   gre->SetPointError(3,0,0.07880422);
   gre->SetPoint(4,100,-7.74142);
   gre->SetPointError(4,0,0.0511653);
   gre->SetPoint(5,300,-7.81992);
   gre->SetPointError(5,0,0.05883799);
   gre->SetPoint(6,500,-7.89546);
   gre->SetPointError(6,0,0.08853448);
   gre->SetPoint(7,700,-7.81568);
   gre->SetPointError(7,0,0.04957378);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-8.014293);
   Graph_Graph30->SetMaximum(-7.650712);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.439092);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.102595e-05);
   linear_fit->SetParError(0,3.979732e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.826835);
   linear_fit->SetParError(1,0.01706241);
