...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.966932,1050,1.268239);
   ...
   gre->SetPoint(0,-700,1.14764);
   gre->SetPointError(0,0,0.0247768);
   gre->SetPoint(1,-500,1.11538);
   gre->SetPointError(1,0,0.01942158);
   gre->SetPoint(2,-300,1.12798);
   gre->SetPointError(2,0,0.05293477);
   gre->SetPoint(3,-100,1.12298);
   gre->SetPointError(3,0,0.03574097);
   gre->SetPoint(4,100,1.20004);
   gre->SetPointError(4,0,0.01798129);
   gre->SetPoint(5,300,1.11528);
   gre->SetPointError(5,0,0.09813013);
   gre->SetPoint(6,500,1.1156);
   gre->SetPointError(6,0,0.02426166);
   gre->SetPoint(7,700,1.10258);
   gre->SetPointError(7,0,0.05239874);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.9970627);
   Graph_Graph29->SetMaximum(1.238108);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.19265);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.025004e-05);
   linear_fit->SetParError(0,2.231551e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.146552);
   linear_fit->SetParError(1,0.009999546);
