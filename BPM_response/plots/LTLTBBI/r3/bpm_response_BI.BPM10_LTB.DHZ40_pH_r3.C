...
//=========  (Wed Apr  1 22:35:36 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-19.44217,1050,8.945663);
   ...
   gre->SetPoint(0,-700,-14.50798);
   gre->SetPointError(0,0,0.2028847);
   gre->SetPoint(1,-500,-11.35224);
   gre->SetPointError(1,0,0.04121199);
   gre->SetPoint(2,-300,-8.72124);
   gre->SetPointError(2,0,0.1221198);
   gre->SetPoint(3,-100,-5.59806);
   gre->SetPointError(3,0,0.08051993);
   gre->SetPoint(4,100,-3.24222);
   gre->SetPointError(4,0,0.00524691);
   gre->SetPoint(5,300,-0.94162);
   gre->SetPointError(5,0,0.1408663);
   gre->SetPoint(6,500,1.71484);
   gre->SetPointError(6,0,0.238908);
   gre->SetPoint(7,700,4.17414);
   gre->SetPointError(7,0,0.04021762);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-16.60339);
   Graph_Graph38->SetMaximum(6.10688);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(179.6619);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.012955);
   linear_fit->SetParError(0,4.60409e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.549428);
   linear_fit->SetParError(1,0.006866586);
