...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.810993,1050,1.992527);
   ...
   gre->SetPoint(0,-700,1.90008);
   gre->SetPointError(0,0,0.0144399);
   gre->SetPoint(1,-500,1.87672);
   gre->SetPointError(1,0,0.01445771);
   gre->SetPoint(2,-300,1.90176);
   gre->SetPointError(2,0,0.0605112);
   gre->SetPoint(3,-100,1.87306);
   gre->SetPointError(3,0,0.01346208);
   gre->SetPoint(4,100,1.87056);
   gre->SetPointError(4,0,0.0109449);
   gre->SetPoint(5,300,1.91376);
   gre->SetPointError(5,0,0.03486561);
   gre->SetPoint(6,500,1.90752);
   gre->SetPointError(6,0,0.03283234);
   gre->SetPoint(7,700,1.88392);
   gre->SetPointError(7,0,0.02716418);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.829147);
   Graph_Graph29->SetMaximum(1.974373);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.431835);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.872558e-06);
   linear_fit->SetParError(0,1.558796e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.87976);
   linear_fit->SetParError(1,0.00651048);
