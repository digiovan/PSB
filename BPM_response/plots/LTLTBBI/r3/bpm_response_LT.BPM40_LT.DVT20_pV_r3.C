...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-15.71091,1050,1.638053);
   ...
   gre->SetPoint(0,-700,-12.77374);
   gre->SetPointError(0,0,0.04567766);
   gre->SetPoint(1,-500,-11.70888);
   gre->SetPointError(1,0,0.1470811);
   gre->SetPoint(2,-300,-9.76094);
   gre->SetPointError(2,0,0.04469904);
   gre->SetPoint(3,-100,-8.03336);
   gre->SetPointError(3,0,0.1417779);
   gre->SetPoint(4,100,-6.33426);
   gre->SetPointError(4,0,0.0462757);
   gre->SetPoint(5,300,-4.84948);
   gre->SetPointError(5,0,0.06074869);
   gre->SetPoint(6,500,-3.43848);
   gre->SetPointError(6,0,0.04617167);
   gre->SetPoint(7,700,-1.3036);
   gre->SetPointError(7,0,0.05015877);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-13.97602);
   Graph_Graph32->SetMaximum(-0.09684358);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(82.74203);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008089599);
   linear_fit->SetParError(0,3.993562e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.23033);
   linear_fit->SetParError(1,0.01940825);
