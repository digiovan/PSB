...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,1.775938,1050,3.311137);
   ...
   gre->SetPoint(0,-700,2.16684);
   gre->SetPointError(0,0,0.1350357);
   gre->SetPoint(1,-500,2.42866);
   gre->SetPointError(1,0,0.1281301);
   gre->SetPoint(2,-300,2.65552);
   gre->SetPointError(2,0,0.009596055);
   gre->SetPoint(3,-100,2.89914);
   gre->SetPointError(3,0,0.07770057);
   gre->SetPoint(4,100,3.00108);
   gre->SetPointError(4,0,0.05419015);
   gre->SetPoint(5,300,2.91314);
   gre->SetPointError(5,0,0.04128787);
   gre->SetPoint(6,500,2.94804);
   gre->SetPointError(6,0,0.05763256);
   gre->SetPoint(7,700,2.93146);
   gre->SetPointError(7,0,0.04981112);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(1.929458);
   Graph_Graph36->SetMaximum(3.157617);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(29.80451);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003844875);
   linear_fit->SetParError(0,3.582734e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.773444);
   linear_fit->SetParError(1,0.01164824);
