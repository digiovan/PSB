...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-3.453641,1050,0.2874359);
   ...
   gre->SetPoint(0,-700,-0.36886);
   gre->SetPointError(0,0,0.03278303);
   gre->SetPoint(1,-500,-0.52402);
   gre->SetPointError(1,0,0.03638218);
   gre->SetPoint(2,-300,-0.84874);
   gre->SetPointError(2,0,0.0124048);
   gre->SetPoint(3,-100,-1.41434);
   gre->SetPointError(3,0,0.02346333);
   gre->SetPoint(4,100,-1.81318);
   gre->SetPointError(4,0,0.02600499);
   gre->SetPoint(5,300,-2.00798);
   gre->SetPointError(5,0,0.0104882);
   gre->SetPoint(6,500,-2.27852);
   gre->SetPointError(6,0,0.03126117);
   gre->SetPoint(7,700,-2.8185);
   gre->SetPointError(7,0,0.01162819);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-3.079533);
   Graph_Graph33->SetMaximum(-0.08667185);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(162.3047);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001874468);
   linear_fit->SetParError(0,1.420861e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.476634);
   linear_fit->SetParError(1,0.006442771);
