...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-8.040918,1050,-7.567884);
   ...
   gre->SetPoint(0,-700,-7.80474);
   gre->SetPointError(0,0,0.01530496);
   gre->SetPoint(1,-500,-7.87448);
   gre->SetPointError(1,0,0.03146484);
   gre->SetPoint(2,-300,-7.79194);
   gre->SetPointError(2,0,0.1225703);
   gre->SetPoint(3,-100,-7.91736);
   gre->SetPointError(3,0,0.04471911);
   gre->SetPoint(4,100,-7.83932);
   gre->SetPointError(4,0,0.04504759);
   gre->SetPoint(5,300,-7.67846);
   gre->SetPointError(5,0,0.03173681);
   gre->SetPoint(6,500,-7.79792);
   gre->SetPointError(6,0,0.005516591);
   gre->SetPoint(7,700,-7.82738);
   gre->SetPointError(7,0,0.01292759);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-7.993615);
   Graph_Graph30->SetMaximum(-7.615188);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(31.53655);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,9.512001e-06);
   linear_fit->SetParError(0,1.19199e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.806786);
   linear_fit->SetParError(1,0.006468226);
