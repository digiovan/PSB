...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-12.7611,1050,5.475697);
   ...
   gre->SetPoint(0,-700,-9.60104);
   gre->SetPointError(0,0,0.1205913);
   gre->SetPoint(1,-500,-7.4701);
   gre->SetPointError(1,0,0.0714527);
   gre->SetPoint(2,-300,-6.37132);
   gre->SetPointError(2,0,0.1332945);
   gre->SetPoint(3,-100,-4.37664);
   gre->SetPointError(3,0,0.1513105);
   gre->SetPoint(4,100,-2.67468);
   gre->SetPointError(4,0,0.09121465);
   gre->SetPoint(5,300,-1.62502);
   gre->SetPointError(5,0,0.2838258);
   gre->SetPoint(6,500,0.93644);
   gre->SetPointError(6,0,0.2015907);
   gre->SetPoint(7,700,2.29252);
   gre->SetPointError(7,0,0.1437109);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-10.93742);
   Graph_Graph38->SetMaximum(3.652017);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.96004);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008317053);
   linear_fit->SetParError(0,9.956032e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.51486);
   linear_fit->SetParError(1,0.04574098);
