...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-5.661344,1050,2.046969);
   ...
   gre->SetPoint(0,-700,-4.34144);
   gre->SetPointError(0,0,0.03518515);
   gre->SetPoint(1,-500,-3.55034);
   gre->SetPointError(1,0,0.07011313);
   gre->SetPoint(2,-300,-2.82074);
   gre->SetPointError(2,0,0.03879185);
   gre->SetPoint(3,-100,-2.04276);
   gre->SetPointError(3,0,0.05798352);
   gre->SetPoint(4,100,-1.39796);
   gre->SetPointError(4,0,0.08574166);
   gre->SetPoint(5,300,-0.66384);
   gre->SetPointError(5,0,0.08286553);
   gre->SetPoint(6,500,-0.2045);
   gre->SetPointError(6,0,0.0648218);
   gre->SetPoint(7,700,0.73112);
   gre->SetPointError(7,0,0.03113039);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-4.890513);
   Graph_Graph39->SetMaximum(1.276138);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.10643);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003580225);
   linear_fit->SetParError(0,3.030267e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.787585);
   linear_fit->SetParError(1,0.01684381);
