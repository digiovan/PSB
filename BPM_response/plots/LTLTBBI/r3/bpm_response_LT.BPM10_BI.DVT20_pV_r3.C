...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.8362973,1050,1.217346);
   ...
   gre->SetPoint(0,-700,1.02696);
   gre->SetPointError(0,0,0.01466498);
   gre->SetPoint(1,-500,1.06638);
   gre->SetPointError(1,0,0.06125421);
   gre->SetPoint(2,-300,1.10832);
   gre->SetPointError(2,0,0.01903909);
   gre->SetPoint(3,-100,1.09308);
   gre->SetPointError(3,0,0.02181909);
   gre->SetPoint(4,100,1.11784);
   gre->SetPointError(4,0,0.0357965);
   gre->SetPoint(5,300,1.12832);
   gre->SetPointError(5,0,0.02551755);
   gre->SetPoint(6,500,0.92926);
   gre->SetPointError(6,0,0.02945467);
   gre->SetPoint(7,700,1.06002);
   gre->SetPointError(7,0,0.01108045);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.8744021);
   Graph_Graph29->SetMaximum(1.179241);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(43.15618);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.196817e-06);
   linear_fit->SetParError(0,1.215156e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.06211);
   linear_fit->SetParError(1,0.006971163);
