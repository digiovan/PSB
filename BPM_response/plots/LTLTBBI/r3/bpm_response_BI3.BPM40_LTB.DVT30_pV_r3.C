...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-9.747121,1050,-0.08081453);
   ...
   gre->SetPoint(0,-700,-7.9118);
   gre->SetPointError(0,0,0.2242701);
   gre->SetPoint(1,-500,-7.13758);
   gre->SetPointError(1,0,0.4224175);
   gre->SetPoint(2,-300,-5.83356);
   gre->SetPointError(2,0,0.2282366);
   gre->SetPoint(3,-100,-5.15124);
   gre->SetPointError(3,0,0.4282673);
   gre->SetPoint(4,100,-4.10954);
   gre->SetPointError(4,0,0.2192444);
   gre->SetPoint(5,300,-3.41804);
   gre->SetPointError(5,0,0.06749743);
   gre->SetPoint(6,500,-2.51374);
   gre->SetPointError(6,0,0.2231782);
   gre->SetPoint(7,700,-1.83144);
   gre->SetPointError(7,0,0.1395743);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-8.780491);
   Graph_Graph41->SetMaximum(-1.047445);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.183258);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004293632);
   linear_fit->SetParError(0,0.0001576483);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.719668);
   linear_fit->SetParError(1,0.06581214);
