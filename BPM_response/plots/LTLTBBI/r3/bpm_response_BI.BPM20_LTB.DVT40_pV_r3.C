...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-10.5752,1050,7.801003);
   ...
   gre->SetPoint(0,-700,4.63476);
   gre->SetPointError(0,0,0.1035415);
   gre->SetPoint(1,-500,2.9032);
   gre->SetPointError(1,0,0.07571477);
   gre->SetPoint(2,-300,1.09556);
   gre->SetPointError(2,0,0.02568727);
   gre->SetPoint(3,-100,-0.63218);
   gre->SetPointError(3,0,0.05413267);
   gre->SetPoint(4,100,-2.18334);
   gre->SetPointError(4,0,0.06871664);
   gre->SetPoint(5,300,-3.9563);
   gre->SetPointError(5,0,0.02546395);
   gre->SetPoint(6,500,-5.5984);
   gre->SetPointError(6,0,0.05006344);
   gre->SetPoint(7,700,-7.47572);
   gre->SetPointError(7,0,0.03678266);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-8.737583);
   Graph_Graph39->SetMaximum(5.963382);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.95388);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008527139);
   linear_fit->SetParError(0,3.604749e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.429126);
   linear_fit->SetParError(1,0.01467981);
