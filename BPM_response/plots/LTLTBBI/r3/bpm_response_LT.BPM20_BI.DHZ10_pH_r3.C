...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-7.933434,1050,-7.639512);
   ...
   gre->SetPoint(0,-700,-7.78406);
   gre->SetPointError(0,0,0.04506326);
   gre->SetPoint(1,-500,-7.794);
   gre->SetPointError(1,0,0.05917436);
   gre->SetPoint(2,-300,-7.7542);
   gre->SetPointError(2,0,0.03788735);
   gre->SetPoint(3,-100,-7.82908);
   gre->SetPointError(3,0,0.05536662);
   gre->SetPoint(4,100,-7.78314);
   gre->SetPointError(4,0,0.09464119);
   gre->SetPoint(5,300,-7.81286);
   gre->SetPointError(5,0,0.03605246);
   gre->SetPoint(6,500,-7.83306);
   gre->SetPointError(6,0,0.02560039);
   gre->SetPoint(7,700,-7.8191);
   gre->SetPointError(7,0,0.03438681);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-7.904041);
   Graph_Graph30->SetMaximum(-7.668904);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.635497);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.285625e-05);
   linear_fit->SetParError(0,3.020815e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.801076);
   linear_fit->SetParError(1,0.01499312);
