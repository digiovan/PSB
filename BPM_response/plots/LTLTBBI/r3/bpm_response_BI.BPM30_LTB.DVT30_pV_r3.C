...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-4.511832,1050,1.939513);
   ...
   gre->SetPoint(0,-700,-3.00488);
   gre->SetPointError(0,0,0.4317281);
   gre->SetPoint(1,-500,-2.24866);
   gre->SetPointError(1,0,0.5270969);
   gre->SetPoint(2,-300,-1.92176);
   gre->SetPointError(2,0,0.2652323);
   gre->SetPoint(3,-100,-1.41088);
   gre->SetPointError(3,0,0.3375393);
   gre->SetPoint(4,100,-0.78774);
   gre->SetPointError(4,0,0.2379968);
   gre->SetPoint(5,300,-0.08368);
   gre->SetPointError(5,0,0.04834397);
   gre->SetPoint(6,500,-0.10206);
   gre->SetPointError(6,0,0.09661924);
   gre->SetPoint(7,700,0.48438);
   gre->SetPointError(7,0,0.3799084);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-3.866698);
   Graph_Graph40->SetMaximum(1.294378);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.38247);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002264974);
   linear_fit->SetParError(0,0.0002220045);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.885847);
   linear_fit->SetParError(1,0.07839187);
