...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,1.024071,1050,16.21276);
   ...
   gre->SetPoint(0,-700,13.64848);
   gre->SetPointError(0,0,0.03283493);
   gre->SetPoint(1,-500,12.09728);
   gre->SetPointError(1,0,0.05573506);
   gre->SetPoint(2,-300,10.50792);
   gre->SetPointError(2,0,0.05406494);
   gre->SetPoint(3,-100,9.08572);
   gre->SetPointError(3,0,0.01412355);
   gre->SetPoint(4,100,7.72304);
   gre->SetPointError(4,0,0.024839);
   gre->SetPoint(5,300,6.2807);
   gre->SetPointError(5,0,0.09505867);
   gre->SetPoint(6,500,5.12512);
   gre->SetPointError(6,0,0.03666679);
   gre->SetPoint(7,700,3.60044);
   gre->SetPointError(7,0,0.04492024);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(2.54294);
   Graph_Graph39->SetMaximum(14.69389);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(126.2278);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007095933);
   linear_fit->SetParError(0,3.093848e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.454546);
   linear_fit->SetParError(1,0.01034616);
