...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.750431,1050,2.104107);
   ...
   gre->SetPoint(0,-700,1.86982);
   gre->SetPointError(0,0,0.06044334);
   gre->SetPoint(1,-500,1.98132);
   gre->SetPointError(1,0,0.0166071);
   gre->SetPoint(2,-300,2.01592);
   gre->SetPointError(2,0,0.01982744);
   gre->SetPoint(3,-100,1.95944);
   gre->SetPointError(3,0,0.009523484);
   gre->SetPoint(4,100,1.95648);
   gre->SetPointError(4,0,0.01765547);
   gre->SetPoint(5,300,1.98194);
   gre->SetPointError(5,0,0.0108615);
   gre->SetPoint(6,500,2.01592);
   gre->SetPointError(6,0,0.02924118);
   gre->SetPoint(7,700,1.91694);
   gre->SetPointError(7,0,0.02506119);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.785798);
   Graph_Graph29->SetMaximum(2.06874);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.18135);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-9.862153e-06);
   linear_fit->SetParError(0,1.758921e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.971501);
   linear_fit->SetParError(1,0.005610583);
