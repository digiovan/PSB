...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-8.019135,1050,-7.637188);
   ...
   gre->SetPoint(0,-700,-7.85258);
   gre->SetPointError(0,0,0.08101938);
   gre->SetPoint(1,-500,-7.78368);
   gre->SetPointError(1,0,0.04613388);
   gre->SetPoint(2,-300,-7.7659);
   gre->SetPointError(2,0,0.02494032);
   gre->SetPoint(3,-100,-7.86998);
   gre->SetPointError(3,0,0.0854971);
   gre->SetPoint(4,100,-7.7488);
   gre->SetPointError(4,0,0.04795456);
   gre->SetPoint(5,300,-7.8028);
   gre->SetPointError(5,0,0.01889601);
   gre->SetPoint(6,500,-7.8433);
   gre->SetPointError(6,0,0.06975017);
   gre->SetPoint(7,700,-7.77356);
   gre->SetPointError(7,0,0.04084962);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-7.98094);
   Graph_Graph30->SetMaximum(-7.675382);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.173955);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.471043e-05);
   linear_fit->SetParError(0,3.353552e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.788351);
   linear_fit->SetParError(1,0.01284254);
