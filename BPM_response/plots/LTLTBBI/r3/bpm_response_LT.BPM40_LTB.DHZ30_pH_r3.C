...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-0.3798293,1050,-0.3150565);
   ...
   gre->SetPoint(0,-700,-0.35864);
   gre->SetPointError(0,0,0.005473411);
   gre->SetPoint(1,-500,-0.34514);
   gre->SetPointError(1,0,0.009101351);
   gre->SetPoint(2,-300,-0.3371);
   gre->SetPointError(2,0,0.005686013);
   gre->SetPoint(3,-100,-0.35168);
   gre->SetPointError(3,0,0.004923174);
   gre->SetPoint(4,100,-0.34194);
   gre->SetPointError(4,0,0.016088);
   gre->SetPoint(5,300,-0.34514);
   gre->SetPointError(5,0,0.01406932);
   gre->SetPoint(6,500,-0.33534);
   gre->SetPointError(6,0,0.007532486);
   gre->SetPoint(7,700,-0.35626);
   gre->SetPointError(7,0,0.01277388);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-0.3733521);
   Graph_Graph32->SetMaximum(-0.3215338);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.18643);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,9.556823e-06);
   linear_fit->SetParError(0,6.283184e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.345733);
   linear_fit->SetParError(1,0.002829072);
