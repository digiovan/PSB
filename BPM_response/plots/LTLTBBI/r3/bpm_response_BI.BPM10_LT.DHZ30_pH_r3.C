...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-13.41673,1050,7.362678);
   ...
   gre->SetPoint(0,-700,3.79532);
   gre->SetPointError(0,0,0.1041238);
   gre->SetPoint(1,-500,1.87374);
   gre->SetPointError(1,0,0.07422228);
   gre->SetPoint(2,-300,-0.94112);
   gre->SetPointError(2,0,0.3344666);
   gre->SetPoint(3,-100,-2.5899);
   gre->SetPointError(3,0,0.1261166);
   gre->SetPoint(4,100,-5.18798);
   gre->SetPointError(4,0,0.06820153);
   gre->SetPoint(5,300,-6.6035);
   gre->SetPointError(5,0,0.1353544);
   gre->SetPoint(6,500,-8.11824);
   gre->SetPointError(6,0,0.100496);
   gre->SetPoint(7,700,-9.88528);
   gre->SetPointError(7,0,0.06821126);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-11.33878);
   Graph_Graph38->SetMaximum(5.284737);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(216.7964);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009840603);
   linear_fit->SetParError(0,6.691707e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.402992);
   linear_fit->SetParError(1,0.03323227);
