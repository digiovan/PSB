...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,-12.15708,1050,17.244);
   ...
   gre->SetPoint(0,-700,12.30918);
   gre->SetPointError(0,0,0.0346438);
   gre->SetPoint(1,-500,9.26172);
   gre->SetPointError(1,0,0.1102368);
   gre->SetPoint(2,-300,6.55392);
   gre->SetPointError(2,0,0.02924201);
   gre->SetPoint(3,-100,3.84222);
   gre->SetPointError(3,0,0.02677399);
   gre->SetPoint(4,100,1.1009);
   gre->SetPointError(4,0,0.16459);
   gre->SetPoint(5,300,-1.57114);
   gre->SetPointError(5,0,0.06347758);
   gre->SetPoint(6,500,-4.5292);
   gre->SetPointError(6,0,0.02020324);
   gre->SetPoint(7,700,-7.16322);
   gre->SetPointError(7,0,0.09367745);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(-9.21697);
   Graph_Graph35->SetMaximum(14.3039);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.65336);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01395058);
   linear_fit->SetParError(0,2.853988e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.452506);
   linear_fit->SetParError(1,0.01262801);
