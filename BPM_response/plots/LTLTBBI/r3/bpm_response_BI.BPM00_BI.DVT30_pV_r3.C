...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-1.068642,1050,-0.7165202);
   ...
   gre->SetPoint(0,-700,-0.8446);
   gre->SetPointError(0,0,0.06939284);
   gre->SetPoint(1,-500,-0.93492);
   gre->SetPointError(1,0,0.03485925);
   gre->SetPoint(2,-300,-0.93086);
   gre->SetPointError(2,0,0.01462449);
   gre->SetPoint(3,-100,-0.98456);
   gre->SetPointError(3,0,0.02539508);
   gre->SetPoint(4,100,-0.87654);
   gre->SetPointError(4,0,0.05687471);
   gre->SetPoint(5,300,-0.91624);
   gre->SetPointError(5,0,0.02087273);
   gre->SetPoint(6,500,-0.95692);
   gre->SetPointError(6,0,0.01090226);
   gre->SetPoint(7,700,-0.8279);
   gre->SetPointError(7,0,0.03700286);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-1.03343);
   Graph_Graph37->SetMaximum(-0.7517324);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.36856);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.842489e-06);
   linear_fit->SetParError(0,1.87855e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.9382088);
   linear_fit->SetParError(1,0.007962765);
