...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-6.788043,1050,-6.089042);
   ...
   gre->SetPoint(0,-700,-6.49592);
   gre->SetPointError(0,0,0.03638183);
   gre->SetPoint(1,-500,-6.62974);
   gre->SetPointError(1,0,0.04180279);
   gre->SetPoint(2,-300,-6.2604);
   gre->SetPointError(2,0,0.05485814);
   gre->SetPoint(3,-100,-6.52478);
   gre->SetPointError(3,0,0.01736088);
   gre->SetPoint(4,100,-6.59418);
   gre->SetPointError(4,0,0.04692483);
   gre->SetPoint(5,300,-6.34254);
   gre->SetPointError(5,0,0.03614595);
   gre->SetPoint(6,500,-6.59968);
   gre->SetPointError(6,0,0.07035407);
   gre->SetPoint(7,700,-6.51818);
   gre->SetPointError(7,0,0.04120128);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-6.718143);
   Graph_Graph30->SetMaximum(-6.158942);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.80427);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.321763e-05);
   linear_fit->SetParError(0,3.229326e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.501667);
   linear_fit->SetParError(1,0.01214789);
