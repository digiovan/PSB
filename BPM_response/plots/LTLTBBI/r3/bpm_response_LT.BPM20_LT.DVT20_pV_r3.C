...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-11.51423,1050,-1.757645);
   ...
   gre->SetPoint(0,-700,-9.87398);
   gre->SetPointError(0,0,0.01415193);
   gre->SetPoint(1,-500,-8.94832);
   gre->SetPointError(1,0,0.1179565);
   gre->SetPoint(2,-300,-7.96748);
   gre->SetPointError(2,0,0.03108586);
   gre->SetPoint(3,-100,-7.06006);
   gre->SetPointError(3,0,0.114471);
   gre->SetPoint(4,100,-6.1382);
   gre->SetPointError(4,0,0.0386758);
   gre->SetPoint(5,300,-5.30448);
   gre->SetPointError(5,0,0.03381055);
   gre->SetPoint(6,500,-4.38688);
   gre->SetPointError(6,0,0.01892574);
   gre->SetPoint(7,700,-3.41834);
   gre->SetPointError(7,0,0.03459794);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-10.53857);
   Graph_Graph30->SetMaximum(-2.733303);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.846586);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004582607);
   linear_fit->SetParError(0,1.680157e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.655884);
   linear_fit->SetParError(1,0.00966053);
