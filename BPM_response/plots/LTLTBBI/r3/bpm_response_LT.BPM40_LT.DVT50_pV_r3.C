...
//=========  (Wed Apr  1 22:34:59 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-7.621163,1050,-7.049285);
   ...
   gre->SetPoint(0,-700,-7.33288);
   gre->SetPointError(0,0,0.07540728);
   gre->SetPoint(1,-500,-7.3728);
   gre->SetPointError(1,0,0.0283463);
   gre->SetPoint(2,-300,-7.24046);
   gre->SetPointError(2,0,0.07771336);
   gre->SetPoint(3,-100,-7.24276);
   gre->SetPointError(3,0,0.09816194);
   gre->SetPoint(4,100,-7.40276);
   gre->SetPointError(4,0,0.1230897);
   gre->SetPoint(5,300,-7.23968);
   gre->SetPointError(5,0,0.05748321);
   gre->SetPoint(6,500,-7.3082);
   gre->SetPointError(6,0,0.05124281);
   gre->SetPoint(7,700,-7.30622);
   gre->SetPointError(7,0,0.1260036);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.563975);
   Graph_Graph32->SetMaximum(-7.106473);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.863914);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.331496e-05);
   linear_fit->SetParError(0,4.575798e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.315151);
   linear_fit->SetParError(1,0.02178605);
