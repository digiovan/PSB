...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,-1.346766,1050,-1.067535);
   ...
   gre->SetPoint(0,-700,-1.24138);
   gre->SetPointError(0,0,0.04760876);
   gre->SetPoint(1,-500,-1.2265);
   gre->SetPointError(1,0,0.03364404);
   gre->SetPoint(2,-300,-1.17378);
   gre->SetPointError(2,0,0.03404398);
   gre->SetPoint(3,-100,-1.15456);
   gre->SetPointError(3,0,0.009766512);
   gre->SetPoint(4,100,-1.17732);
   gre->SetPointError(4,0,0.06324665);
   gre->SetPoint(5,300,-1.1476);
   gre->SetPointError(5,0,0.01134583);
   gre->SetPoint(6,500,-1.21888);
   gre->SetPointError(6,0,0.0251359);
   gre->SetPoint(7,700,-1.27532);
   gre->SetPointError(7,0,0.02490779);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-1.318843);
   Graph_Graph39->SetMaximum(-1.095458);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.77734);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.212383e-05);
   linear_fit->SetParError(0,2.084768e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.166923);
   linear_fit->SetParError(1,0.006753862);
