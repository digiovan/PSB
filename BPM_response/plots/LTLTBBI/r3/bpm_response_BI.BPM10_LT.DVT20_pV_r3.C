...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,-8.676582,1050,16.12252);
   ...
   gre->SetPoint(0,-700,-4.5009);
   gre->SetPointError(0,0,0.04249787);
   gre->SetPoint(1,-500,-2.42712);
   gre->SetPointError(1,0,0.1883849);
   gre->SetPoint(2,-300,0.44874);
   gre->SetPointError(2,0,0.05307456);
   gre->SetPoint(3,-100,2.84712);
   gre->SetPointError(3,0,0.264489);
   gre->SetPoint(4,100,5.34254);
   gre->SetPointError(4,0,0.04195529);
   gre->SetPoint(5,300,7.50062);
   gre->SetPointError(5,0,0.0120689);
   gre->SetPoint(6,500,9.58388);
   gre->SetPointError(6,0,0.07794898);
   gre->SetPoint(7,700,11.93414);
   gre->SetPointError(7,0,0.05519716);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-6.196671);
   Graph_Graph38->SetMaximum(13.64261);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(88.36711);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01184834);
   linear_fit->SetParError(0,3.723632e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.934485);
   linear_fit->SetParError(1,0.01332014);
