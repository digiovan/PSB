...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,-5.83073,1050,7.834582);
   ...
   gre->SetPoint(0,-700,-3.50328);
   gre->SetPointError(0,0,0.04989797);
   gre->SetPoint(1,-500,-2.18718);
   gre->SetPointError(1,0,0.02005437);
   gre->SetPoint(2,-300,-0.8754);
   gre->SetPointError(2,0,0.05406478);
   gre->SetPoint(3,-100,0.4396);
   gre->SetPointError(3,0,0.04021682);
   gre->SetPoint(4,100,1.64334);
   gre->SetPointError(4,0,0.02981391);
   gre->SetPoint(5,300,2.8052);
   gre->SetPointError(5,0,0.08403748);
   gre->SetPoint(6,500,4.18196);
   gre->SetPointError(6,0,0.035276);
   gre->SetPoint(7,700,5.5349);
   gre->SetPointError(7,0,0.02212958);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-4.464199);
   Graph_Graph34->SetMaximum(6.46805);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.969864);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006420004);
   linear_fit->SetParError(0,2.198064e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.020873);
   linear_fit->SetParError(1,0.01123792);
