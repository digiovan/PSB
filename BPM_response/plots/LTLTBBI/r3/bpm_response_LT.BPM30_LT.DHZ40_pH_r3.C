...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-10.81357,1050,-6.244179);
   ...
   gre->SetPoint(0,-700,-9.62308);
   gre->SetPointError(0,0,0.04176304);
   gre->SetPoint(1,-500,-9.96352);
   gre->SetPointError(1,0,0.03189593);
   gre->SetPoint(2,-300,-9.66422);
   gre->SetPointError(2,0,0.07424614);
   gre->SetPoint(3,-100,-9.9934);
   gre->SetPointError(3,0,0.01050467);
   gre->SetPoint(4,100,-10.0342);
   gre->SetPointError(4,0,0.01780777);
   gre->SetPoint(5,300,-9.63296);
   gre->SetPointError(5,0,0.1057761);
   gre->SetPoint(6,500,-8.02026);
   gre->SetPointError(6,0,1.014515);
   gre->SetPoint(7,700,-9.6563);
   gre->SetPointError(7,0,0.03677727);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-10.35663);
   Graph_Graph31->SetMaximum(-6.701118);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(189.2644);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.233262e-05);
   linear_fit->SetParError(0,3.212497e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.961046);
   linear_fit->SetParError(1,0.008503192);
