...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-5.270643,1050,3.361633);
   ...
   gre->SetPoint(0,-700,1.90854);
   gre->SetPointError(0,0,0.01438045);
   gre->SetPoint(1,-500,1.12056);
   gre->SetPointError(1,0,0.006350356);
   gre->SetPoint(2,-300,0.30988);
   gre->SetPointError(2,0,0.01959892);
   gre->SetPoint(3,-100,-0.62584);
   gre->SetPointError(3,0,0.02768636);
   gre->SetPoint(4,100,-1.21716);
   gre->SetPointError(4,0,0.04274543);
   gre->SetPoint(5,300,-2.03768);
   gre->SetPointError(5,0,0.04003634);
   gre->SetPoint(6,500,-2.93392);
   gre->SetPointError(6,0,0.007793393);
   gre->SetPoint(7,700,-3.798);
   gre->SetPointError(7,0,0.03393035);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-4.407415);
   Graph_Graph37->SetMaximum(2.498406);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(33.64134);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004050318);
   linear_fit->SetParError(0,9.014536e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.910179);
   linear_fit->SetParError(1,0.004577428);
