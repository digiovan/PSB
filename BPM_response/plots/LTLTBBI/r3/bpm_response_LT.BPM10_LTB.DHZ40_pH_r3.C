...
//=========  (Wed Apr  1 22:35:36 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.783684,1050,1.946028);
   ...
   gre->SetPoint(0,-700,1.84194);
   gre->SetPointError(0,0,0.01151935);
   gre->SetPoint(1,-500,1.90626);
   gre->SetPointError(1,0,0.01271045);
   gre->SetPoint(2,-300,1.86262);
   gre->SetPointError(2,0,0.02161577);
   gre->SetPoint(3,-100,1.87446);
   gre->SetPointError(3,0,0.02235628);
   gre->SetPoint(4,100,1.89606);
   gre->SetPointError(4,0,0.02048752);
   gre->SetPoint(5,300,1.8683);
   gre->SetPointError(5,0,0.02263265);
   gre->SetPoint(6,500,1.89144);
   gre->SetPointError(6,0,0.02630566);
   gre->SetPoint(7,700,1.8491);
   gre->SetPointError(7,0,0.03835852);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.799919);
   Graph_Graph29->SetMaximum(1.929793);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.2226);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.765864e-05);
   linear_fit->SetParError(0,1.539115e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.878576);
   linear_fit->SetParError(1,0.007861453);
