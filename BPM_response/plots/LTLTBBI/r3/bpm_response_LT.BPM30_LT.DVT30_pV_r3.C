...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-11.40752,1050,-10.00034);
   ...
   gre->SetPoint(0,-700,-11.15296);
   gre->SetPointError(0,0,0.02003232);
   gre->SetPoint(1,-500,-11.11468);
   gre->SetPointError(1,0,0.03335039);
   gre->SetPoint(2,-300,-11.14322);
   gre->SetPointError(2,0,0.02436948);
   gre->SetPoint(3,-100,-10.83288);
   gre->SetPointError(3,0,0.1071491);
   gre->SetPoint(4,100,-10.6261);
   gre->SetPointError(4,0,0.1697633);
   gre->SetPoint(5,300,-10.69304);
   gre->SetPointError(5,0,0.04030453);
   gre->SetPoint(6,500,-10.48426);
   gre->SetPointError(6,0,0.1638649);
   gre->SetPoint(7,700,-10.33332);
   gre->SetPointError(7,0,0.09844943);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-11.2668);
   Graph_Graph31->SetMaximum(-10.14106);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(42.32238);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004609985);
   linear_fit->SetParError(0,3.719343e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.88262);
   linear_fit->SetParError(1,0.01995706);
