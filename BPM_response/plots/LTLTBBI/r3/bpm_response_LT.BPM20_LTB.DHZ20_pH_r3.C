...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-7.94588,1050,-7.601128);
   ...
   gre->SetPoint(0,-700,-7.7881);
   gre->SetPointError(0,0,0.07386237);
   gre->SetPoint(1,-500,-7.83464);
   gre->SetPointError(1,0,0.04939978);
   gre->SetPoint(2,-300,-7.83794);
   gre->SetPointError(2,0,0.0504817);
   gre->SetPoint(3,-100,-7.7977);
   gre->SetPointError(3,0,0.04137669);
   gre->SetPoint(4,100,-7.7561);
   gre->SetPointError(4,0,0.09751307);
   gre->SetPoint(5,300,-7.82608);
   gre->SetPointError(5,0,0.03267974);
   gre->SetPoint(6,500,-7.73212);
   gre->SetPointError(6,0,0.04724652);
   gre->SetPoint(7,700,-7.76656);
   gre->SetPointError(7,0,0.0615657);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-7.911405);
   Graph_Graph30->SetMaximum(-7.635603);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.15555);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.511379e-05);
   linear_fit->SetParError(0,4.267659e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.804435);
   linear_fit->SetParError(1,0.0175198);
