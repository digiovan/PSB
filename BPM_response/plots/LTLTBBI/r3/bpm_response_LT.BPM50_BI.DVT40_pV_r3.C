...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_3->Range(-1050,-0.4664149,1050,-0.2677327);
   ...
   gre->SetPoint(0,-700,-0.39872);
   gre->SetPointError(0,0,0.01945848);
   gre->SetPoint(1,-500,-0.34348);
   gre->SetPointError(1,0,0.01547483);
   gre->SetPoint(2,-300,-0.3329);
   gre->SetPointError(2,0,0.006935914);
   gre->SetPoint(3,-100,-0.40194);
   gre->SetPointError(3,0,0.01443192);
   gre->SetPoint(4,100,-0.4066);
   gre->SetPointError(4,0,0.02670122);
   gre->SetPoint(5,300,-0.37958);
   gre->SetPointError(5,0,0.01627553);
   gre->SetPoint(6,500,-0.34016);
   gre->SetPointError(6,0,0.03931358);
   gre->SetPoint(7,700,-0.3929);
   gre->SetPointError(7,0,0.01475634);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-0.4465467);
   Graph_Graph33->SetMaximum(-0.2876009);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(29.75957);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.740057e-05);
   linear_fit->SetParError(0,1.267366e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3639077);
   linear_fit->SetParError(1,0.005132406);
