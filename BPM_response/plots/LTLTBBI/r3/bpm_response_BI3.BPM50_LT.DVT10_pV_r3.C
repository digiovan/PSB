...
//=========  (Wed Apr  1 22:34:18 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-7.414905,1050,-2.523985);
   ...
   gre->SetPoint(0,-700,-3.65102);
   gre->SetPointError(0,0,0.311882);
   gre->SetPoint(1,-500,-6.09786);
   gre->SetPointError(1,0,0.3558988);
   gre->SetPoint(2,-300,-6.3164);
   gre->SetPointError(2,0,0.2017919);
   gre->SetPoint(3,-100,-6.27054);
   gre->SetPointError(3,0,0.3292115);
   gre->SetPoint(4,100,-6.05432);
   gre->SetPointError(4,0,0.2367489);
   gre->SetPoint(5,300,-5.92);
   gre->SetPointError(5,0,0.3199626);
   gre->SetPoint(6,500,-5.54136);
   gre->SetPointError(6,0,0.07338461);
   gre->SetPoint(7,700,-5.92866);
   gre->SetPointError(7,0,0.08473228);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LT.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-6.925813);
   Graph_Graph42->SetMaximum(-3.013077);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(68.42243);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002286542);
   linear_fit->SetParError(0,0.0001431508);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.633708);
   linear_fit->SetParError(1,0.07958675);
