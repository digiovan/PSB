...
//=========  (Wed Apr  1 22:35:20 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-8.043841,1050,-7.487554);
   ...
   gre->SetPoint(0,-700,-7.7839);
   gre->SetPointError(0,0,0.06625005);
   gre->SetPoint(1,-500,-7.86484);
   gre->SetPointError(1,0,0.01305428);
   gre->SetPoint(2,-300,-7.5935);
   gre->SetPointError(2,0,0.01323188);
   gre->SetPoint(3,-100,-7.6686);
   gre->SetPointError(3,0,0.02654964);
   gre->SetPoint(4,100,-7.69648);
   gre->SetPointError(4,0,0.09076335);
   gre->SetPoint(5,300,-7.70114);
   gre->SetPointError(5,0,0.08425944);
   gre->SetPoint(6,500,-7.8018);
   gre->SetPointError(6,0,0.143939);
   gre->SetPoint(7,700,-7.89308);
   gre->SetPointError(7,0,0.05804609);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.988212);
   Graph_Graph32->SetMaximum(-7.543182);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(202.0086);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001898815);
   linear_fit->SetParError(0,3.761563e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.664592);
   linear_fit->SetParError(1,0.01526531);
