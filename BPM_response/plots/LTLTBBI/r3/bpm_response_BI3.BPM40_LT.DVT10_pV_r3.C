...
//=========  (Wed Apr  1 22:34:18 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-6.232841,1050,0.4941555);
   ...
   gre->SetPoint(0,-700,-0.97772);
   gre->SetPointError(0,0,0.3507094);
   gre->SetPoint(1,-500,-3.15316);
   gre->SetPointError(1,0,0.201012);
   gre->SetPoint(2,-300,-3.64644);
   gre->SetPointError(2,0,0.06812666);
   gre->SetPoint(3,-100,-3.92912);
   gre->SetPointError(3,0,0.2412276);
   gre->SetPoint(4,100,-4.1972);
   gre->SetPointError(4,0,0.3197811);
   gre->SetPoint(5,300,-4.43058);
   gre->SetPointError(5,0,0.3015144);
   gre->SetPoint(6,500,-4.37504);
   gre->SetPointError(6,0,0.0415041);
   gre->SetPoint(7,700,-5.05462);
   gre->SetPointError(7,0,0.057055);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LT.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-5.560141);
   Graph_Graph41->SetMaximum(-0.1785442);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(73.62862);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00135551);
   linear_fit->SetParError(0,7.613536e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.871494);
   linear_fit->SetParError(1,0.04014909);
