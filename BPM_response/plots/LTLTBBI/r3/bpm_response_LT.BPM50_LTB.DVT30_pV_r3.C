...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_3->Range(-1050,-0.5215581,1050,-0.2627281);
   ...
   gre->SetPoint(0,-700,-0.399);
   gre->SetPointError(0,0,0.03409753);
   gre->SetPoint(1,-500,-0.39426);
   gre->SetPointError(1,0,0.04278114);
   gre->SetPoint(2,-300,-0.3899);
   gre->SetPointError(2,0,0.02422844);
   gre->SetPoint(3,-100,-0.42346);
   gre->SetPointError(3,0,0.02476516);
   gre->SetPoint(4,100,-0.34644);
   gre->SetPointError(4,0,0.04057353);
   gre->SetPoint(5,300,-0.38246);
   gre->SetPointError(5,0,0.004412319);
   gre->SetPoint(6,500,-0.46536);
   gre->SetPointError(6,0,0.01305977);
   gre->SetPoint(7,700,-0.43972);
   gre->SetPointError(7,0,0.007576634);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-0.4956751);
   Graph_Graph33->SetMaximum(-0.2886111);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(45.63746);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.238874e-05);
   linear_fit->SetParError(0,1.441655e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3756997);
   linear_fit->SetParError(1,0.006316795);
