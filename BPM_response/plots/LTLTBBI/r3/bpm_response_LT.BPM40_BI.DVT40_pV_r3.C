...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-7.979417,1050,-6.91665);
   ...
   gre->SetPoint(0,-700,-7.66316);
   gre->SetPointError(0,0,0.07363152);
   gre->SetPoint(1,-500,-7.7503);
   gre->SetPointError(1,0,0.04952301);
   gre->SetPoint(2,-300,-7.13926);
   gre->SetPointError(2,0,0.04548184);
   gre->SetPoint(3,-100,-7.75696);
   gre->SetPointError(3,0,0.04532899);
   gre->SetPoint(4,100,-7.62956);
   gre->SetPointError(4,0,0.07623603);
   gre->SetPoint(5,300,-7.3208);
   gre->SetPointError(5,0,0.0608148);
   gre->SetPoint(6,500,-7.64664);
   gre->SetPointError(6,0,0.104728);
   gre->SetPoint(7,700,-7.63794);
   gre->SetPointError(7,0,0.04839235);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.87314);
   Graph_Graph32->SetMaximum(-7.022927);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(140.4499);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.533993e-05);
   linear_fit->SetParError(0,4.490178e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.551615);
   linear_fit->SetParError(1,0.01996476);
