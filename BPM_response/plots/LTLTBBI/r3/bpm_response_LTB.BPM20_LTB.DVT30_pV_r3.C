...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,2.060322,1050,2.739615);
   ...
   gre->SetPoint(0,-700,2.34432);
   gre->SetPointError(0,0,0.1149119);
   gre->SetPoint(1,-500,2.4104);
   gre->SetPointError(1,0,0.190755);
   gre->SetPoint(2,-300,2.42308);
   gre->SetPointError(2,0,0.05937366);
   gre->SetPoint(3,-100,2.383);
   gre->SetPointError(3,0,0.04668407);
   gre->SetPoint(4,100,2.54158);
   gre->SetPointError(4,0,0.08481969);
   gre->SetPoint(5,300,2.50754);
   gre->SetPointError(5,0,0.02464798);
   gre->SetPoint(6,500,2.28652);
   gre->SetPointError(6,0,0.04761199);
   gre->SetPoint(7,700,2.30356);
   gre->SetPointError(7,0,0.1300221);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(2.128252);
   Graph_Graph35->SetMaximum(2.671686);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.65741);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.113455e-05);
   linear_fit->SetParError(0,6.220663e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.441321);
   linear_fit->SetParError(1,0.02117797);
