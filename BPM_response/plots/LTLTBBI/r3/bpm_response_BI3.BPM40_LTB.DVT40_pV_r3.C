...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-26.62935,1050,22.75839);
   ...
   gre->SetPoint(0,-700,-17.79576);
   gre->SetPointError(0,0,0.6023027);
   gre->SetPoint(1,-500,-17.25326);
   gre->SetPointError(1,0,0.7837206);
   gre->SetPoint(2,-300,-12.17078);
   gre->SetPointError(2,0,0.181711);
   gre->SetPoint(3,-100,-6.80776);
   gre->SetPointError(3,0,0.334559);
   gre->SetPoint(4,100,-3.0129);
   gre->SetPointError(4,0,0.2093629);
   gre->SetPoint(5,300,2.55906);
   gre->SetPointError(5,0,0.1169199);
   gre->SetPoint(6,500,7.9925);
   gre->SetPointError(6,0,0.1326251);
   gre->SetPoint(7,700,14.4721);
   gre->SetPointError(7,0,0.0549962);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-21.69058);
   Graph_Graph41->SetMaximum(17.81961);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(246.132);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02700749);
   linear_fit->SetParError(0,0.0001445165);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.701352);
   linear_fit->SetParError(1,0.08622105);
