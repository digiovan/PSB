...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,-13.90841,1050,10.98137);
   ...
   gre->SetPoint(0,-700,-9.747);
   gre->SetPointError(0,0,0.01311383);
   gre->SetPoint(1,-500,-7.2261);
   gre->SetPointError(1,0,0.0276443);
   gre->SetPoint(2,-300,-4.74666);
   gre->SetPointError(2,0,0.03564708);
   gre->SetPoint(3,-100,-2.36266);
   gre->SetPointError(3,0,0.07875766);
   gre->SetPoint(4,100,-0.00108);
   gre->SetPointError(4,0,0.006065429);
   gre->SetPoint(5,300,2.38892);
   gre->SetPointError(5,0,0.01347298);
   gre->SetPoint(6,500,4.61566);
   gre->SetPointError(6,0,0.02502042);
   gre->SetPoint(7,700,6.82288);
   gre->SetPointError(7,0,0.01019025);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-11.41943);
   Graph_Graph39->SetMaximum(8.492389);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(839.885);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01182209);
   linear_fit->SetParError(0,1.103652e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.269705);
   linear_fit->SetParError(1,0.004626128);
