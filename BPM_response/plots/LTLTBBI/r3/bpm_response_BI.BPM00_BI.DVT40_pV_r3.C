...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-1.071647,1050,-0.5815036);
   ...
   gre->SetPoint(0,-700,-0.90106);
   gre->SetPointError(0,0,0.0276116);
   gre->SetPoint(1,-500,-0.97156);
   gre->SetPointError(1,0,0.0183968);
   gre->SetPoint(2,-300,-0.69856);
   gre->SetPointError(2,0,0.03536577);
   gre->SetPoint(3,-100,-0.92832);
   gre->SetPointError(3,0,0.01307846);
   gre->SetPoint(4,100,-0.93244);
   gre->SetPointError(4,0,0.02877791);
   gre->SetPoint(5,300,-0.7632);
   gre->SetPointError(5,0,0.02418972);
   gre->SetPoint(6,500,-0.91048);
   gre->SetPointError(6,0,0.05712609);
   gre->SetPoint(7,700,-0.8939);
   gre->SetPointError(7,0,0.03020228);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-1.022633);
   Graph_Graph37->SetMaximum(-0.630518);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(75.99123);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.738036e-05);
   linear_fit->SetParError(0,2.177384e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.8938939);
   linear_fit->SetParError(1,0.008445433);
