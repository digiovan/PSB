...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-24.92264,1050,-6.353101);
   ...
   gre->SetPoint(0,-700,-20.80366);
   gre->SetPointError(0,0,1.024058);
   gre->SetPoint(1,-500,-20.4072);
   gre->SetPointError(1,0,1.177109);
   gre->SetPoint(2,-300,-17.1485);
   gre->SetPointError(2,0,1.639003);
   gre->SetPoint(3,-100,-15.67668);
   gre->SetPointError(3,0,0.4194666);
   gre->SetPoint(4,100,-16.81238);
   gre->SetPointError(4,0,1.845559);
   gre->SetPoint(5,300,-13.20678);
   gre->SetPointError(5,0,0.8226612);
   gre->SetPoint(6,500,-12.5849);
   gre->SetPointError(6,0,1.142122);
   gre->SetPoint(7,700,-9.84618);
   gre->SetPointError(7,0,0.398155);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-23.06569);
   Graph_Graph41->SetMaximum(-8.210056);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.722518);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.007685968);
   linear_fit->SetParError(0,0.0005430766);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-15.30099);
   linear_fit->SetParError(1,0.2719424);
