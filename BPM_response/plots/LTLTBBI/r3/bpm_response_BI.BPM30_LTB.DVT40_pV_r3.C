...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-27.67086,1050,21.39758);
   ...
   gre->SetPoint(0,-700,8.80358);
   gre->SetPointError(0,0,0.8820062);
   gre->SetPoint(1,-500,12.86078);
   gre->SetPointError(1,0,0.3587268);
   gre->SetPoint(2,-300,7.2902);
   gre->SetPointError(2,0,0.1076011);
   gre->SetPoint(3,-100,1.83978);
   gre->SetPointError(3,0,0.2386723);
   gre->SetPoint(4,100,-3.05596);
   gre->SetPointError(4,0,0.2810404);
   gre->SetPoint(5,300,-8.86216);
   gre->SetPointError(5,0,0.06326206);
   gre->SetPoint(6,500,-13.92276);
   gre->SetPointError(6,0,0.1881091);
   gre->SetPoint(7,700,-19.33998);
   gre->SetPointError(7,0,0.1528072);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-22.76402);
   Graph_Graph40->SetMaximum(16.49074);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(110.9371);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02649869);
   linear_fit->SetParError(0,0.0001509405);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.8347171);
   linear_fit->SetParError(1,0.05586946);
