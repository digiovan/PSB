...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-4.251669,1050,9.696517);
   ...
   gre->SetPoint(0,-700,-1.07462);
   gre->SetPointError(0,0,0.8523515);
   gre->SetPoint(1,-500,3.21396);
   gre->SetPointError(1,0,0.3232446);
   gre->SetPoint(2,-300,5.17768);
   gre->SetPointError(2,0,0.2321962);
   gre->SetPoint(3,-100,3.94812);
   gre->SetPointError(3,0,0.4304672);
   gre->SetPoint(4,100,3.39396);
   gre->SetPointError(4,0,0.5081035);
   gre->SetPoint(5,300,5.7618);
   gre->SetPointError(5,0,0.5456145);
   gre->SetPoint(6,500,5.42906);
   gre->SetPointError(6,0,0.431291);
   gre->SetPoint(7,700,7.08628);
   gre->SetPointError(7,0,0.285539);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-2.856851);
   Graph_Graph41->SetMaximum(8.301698);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(65.40838);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002664601);
   linear_fit->SetParError(0,0.0002831356);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.903342);
   linear_fit->SetParError(1,0.1294108);
