...
//=========  (Wed Apr  1 22:35:20 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-11.42054,1050,-10.52206);
   ...
   gre->SetPoint(0,-700,-10.8862);
   gre->SetPointError(0,0,0.0619213);
   gre->SetPoint(1,-500,-10.98752);
   gre->SetPointError(1,0,0.1120717);
   gre->SetPoint(2,-300,-10.7614);
   gre->SetPointError(2,0,0.01510145);
   gre->SetPoint(3,-100,-10.82556);
   gre->SetPointError(3,0,0.0225568);
   gre->SetPoint(4,100,-10.82898);
   gre->SetPointError(4,0,0.07196513);
   gre->SetPoint(5,300,-10.8083);
   gre->SetPointError(5,0,0.1351654);
   gre->SetPoint(6,500,-10.9713);
   gre->SetPointError(6,0,0.2994903);
   gre->SetPoint(7,700,-11.00714);
   gre->SetPointError(7,0,0.1919034);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LTB.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-11.33069);
   Graph_Graph31->SetMaximum(-10.61191);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.78782);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.448348e-05);
   linear_fit->SetParError(0,7.38704e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.80572);
   linear_fit->SetParError(1,0.02138942);
