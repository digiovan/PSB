...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,0.7309918,1050,1.104959);
   ...
   gre->SetPoint(0,-700,0.87858);
   gre->SetPointError(0,0,0.08526028);
   gre->SetPoint(1,-500,0.94026);
   gre->SetPointError(1,0,0.02747921);
   gre->SetPoint(2,-300,0.92034);
   gre->SetPointError(2,0,0.03702266);
   gre->SetPoint(3,-100,1.00164);
   gre->SetPointError(3,0,0.04099127);
   gre->SetPoint(4,100,0.86152);
   gre->SetPointError(4,0,0.02800497);
   gre->SetPoint(5,300,0.95058);
   gre->SetPointError(5,0,0.02634869);
   gre->SetPoint(6,500,0.9672);
   gre->SetPointError(6,0,0.02248155);
   gre->SetPoint(7,700,0.84628);
   gre->SetPointError(7,0,0.022644);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.7683886);
   Graph_Graph34->SetMaximum(1.067562);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.29015);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.574318e-05);
   linear_fit->SetParError(0,2.433185e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9259552);
   linear_fit->SetParError(1,0.0113795);
