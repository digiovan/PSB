...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-4.236537,1050,-3.313938);
   ...
   gre->SetPoint(0,-700,-3.6771);
   gre->SetPointError(0,0,0.02886827);
   gre->SetPoint(1,-500,-3.61324);
   gre->SetPointError(1,0,0.06444777);
   gre->SetPoint(2,-300,-3.74426);
   gre->SetPointError(2,0,0.2765559);
   gre->SetPoint(3,-100,-3.57564);
   gre->SetPointError(3,0,0.07010187);
   gre->SetPoint(4,100,-3.84206);
   gre->SetPointError(4,0,0.1364384);
   gre->SetPoint(5,300,-4.00762);
   gre->SetPointError(5,0,0.0751505);
   gre->SetPoint(6,500,-3.69582);
   gre->SetPointError(6,0,0.01857186);
   gre->SetPoint(7,700,-3.82194);
   gre->SetPointError(7,0,0.05385521);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-4.144277);
   Graph_Graph38->SetMaximum(-3.406197);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.20672);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.814076e-05);
   linear_fit->SetParError(0,2.628293e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.696514);
   linear_fit->SetParError(1,0.01449813);
