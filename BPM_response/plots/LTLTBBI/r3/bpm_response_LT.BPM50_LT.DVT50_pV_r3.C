...
//=========  (Wed Apr  1 22:34:59 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_3->Range(-1050,-1.414399,1050,1.420114);
   ...
   gre->SetPoint(0,-700,-0.92496);
   gre->SetPointError(0,0,0.01701995);
   gre->SetPoint(1,-500,-0.4963);
   gre->SetPointError(1,0,0.02130582);
   gre->SetPoint(2,-300,-0.16268);
   gre->SetPointError(2,0,0.03075966);
   gre->SetPoint(3,-100,0.11244);
   gre->SetPointError(3,0,0.03715157);
   gre->SetPoint(4,100,0.4417);
   gre->SetPointError(4,0,0.05053996);
   gre->SetPoint(5,300,0.58082);
   gre->SetPointError(5,0,0.02682315);
   gre->SetPoint(6,500,0.75806);
   gre->SetPointError(6,0,0.02438524);
   gre->SetPoint(7,700,0.87888);
   gre->SetPointError(7,0,0.068815);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-1.130947);
   Graph_Graph33->SetMaximum(1.136662);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(91.7605);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001396132);
   linear_fit->SetParError(0,2.019613e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.1351849);
   linear_fit->SetParError(1,0.01049009);
