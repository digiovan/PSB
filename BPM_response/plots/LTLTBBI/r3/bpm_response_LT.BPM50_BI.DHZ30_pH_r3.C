...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-1.76377,1050,-1.600512);
   ...
   gre->SetPoint(0,-700,-1.67616);
   gre->SetPointError(0,0,0.008831332);
   gre->SetPoint(1,-500,-1.6627);
   gre->SetPointError(1,0,0.008054836);
   gre->SetPoint(2,-300,-1.66698);
   gre->SetPointError(2,0,0.03925818);
   gre->SetPoint(3,-100,-1.6445);
   gre->SetPointError(3,0,0.01334067);
   gre->SetPoint(4,100,-1.68312);
   gre->SetPointError(4,0,0.03029391);
   gre->SetPoint(5,300,-1.72224);
   gre->SetPointError(5,0,0.01432039);
   gre->SetPoint(6,500,-1.6669);
   gre->SetPointError(6,0,0.001965799);
   gre->SetPoint(7,700,-1.68524);
   gre->SetPointError(7,0,0.006128955);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-1.747444);
   Graph_Graph33->SetMaximum(-1.616838);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.55275);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.89378e-06);
   linear_fit->SetParError(0,5.357338e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.667887);
   linear_fit->SetParError(1,0.002790943);
