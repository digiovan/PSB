...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-13.40044,1050,10.2359);
   ...
   gre->SetPoint(0,-700,-9.38356);
   gre->SetPointError(0,0,0.07749254);
   gre->SetPoint(1,-500,-6.94102);
   gre->SetPointError(1,0,0.0189361);
   gre->SetPoint(2,-300,-4.72442);
   gre->SetPointError(2,0,0.07041928);
   gre->SetPoint(3,-100,-2.53308);
   gre->SetPointError(3,0,0.1036111);
   gre->SetPoint(4,100,-0.4143);
   gre->SetPointError(4,0,0.04718089);
   gre->SetPoint(5,300,1.61874);
   gre->SetPointError(5,0,0.108555);
   gre->SetPoint(6,500,3.91466);
   gre->SetPointError(6,0,0.03471246);
   gre->SetPoint(7,700,6.26506);
   gre->SetPointError(7,0,0.03144681);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-11.03681);
   Graph_Graph39->SetMaximum(7.872263);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.34273);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01096515);
   linear_fit->SetParError(0,2.593879e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.479549);
   linear_fit->SetParError(1,0.01345215);
