...
//=========  (Wed Apr  1 22:35:00 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-30.31411,1050,22.46481);
   ...
   gre->SetPoint(0,-700,-18.478);
   gre->SetPointError(0,0,0.1264056);
   gre->SetPoint(1,-500,-19.9191);
   gre->SetPointError(1,0,1.598522);
   gre->SetPoint(2,-300,-15.08848);
   gre->SetPointError(2,0,0.09998795);
   gre->SetPoint(3,-100,-6.2326);
   gre->SetPointError(3,0,0.1603164);
   gre->SetPoint(4,100,3.23258);
   gre->SetPointError(4,0,0.3969376);
   gre->SetPoint(5,300,11.06896);
   gre->SetPointError(5,0,0.1063069);
   gre->SetPoint(6,500,8.85648);
   gre->SetPointError(6,0,0.2759004);
   gre->SetPoint(7,700,13.43612);
   gre->SetPointError(7,0,0.2322001);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-25.03622);
   Graph_Graph40->SetMaximum(17.18691);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5250.575);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02902544);
   linear_fit->SetParError(0,0.0001317654);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.965982);
   linear_fit->SetParError(1,0.05657936);
