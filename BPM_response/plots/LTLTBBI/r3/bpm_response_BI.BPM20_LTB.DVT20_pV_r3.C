...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-5.834253,1050,2.702694);
   ...
   gre->SetPoint(0,-700,-4.30104);
   gre->SetPointError(0,0,0.1103884);
   gre->SetPoint(1,-500,-3.44172);
   gre->SetPointError(1,0,0.04265131);
   gre->SetPoint(2,-300,-2.82532);
   gre->SetPointError(2,0,0.009554938);
   gre->SetPoint(3,-100,-1.97026);
   gre->SetPointError(3,0,0.03070223);
   gre->SetPoint(4,100,-1.23794);
   gre->SetPointError(4,0,0.02991738);
   gre->SetPoint(5,300,-0.5196);
   gre->SetPointError(5,0,0.04893647);
   gre->SetPoint(6,500,0.24012);
   gre->SetPointError(6,0,0.1726033);
   gre->SetPoint(7,700,1.15028);
   gre->SetPointError(7,0,0.1295898);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LTB.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-4.980558);
   Graph_Graph39->SetMaximum(1.849);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.14473);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0038775);
   linear_fit->SetParError(0,4.78548e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.647034);
   linear_fit->SetParError(1,0.01422012);
