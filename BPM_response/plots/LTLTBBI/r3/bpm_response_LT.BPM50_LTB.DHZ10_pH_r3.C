...
//=========  (Wed Apr  1 22:35:05 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-1.779237,1050,-1.633045);
   ...
   gre->SetPoint(0,-700,-1.69236);
   gre->SetPointError(0,0,0.02633926);
   gre->SetPoint(1,-500,-1.7265);
   gre->SetPointError(1,0,0.02837143);
   gre->SetPoint(2,-300,-1.69316);
   gre->SetPointError(2,0,0.01306168);
   gre->SetPoint(3,-100,-1.7208);
   gre->SetPointError(3,0,0.02845907);
   gre->SetPoint(4,100,-1.71782);
   gre->SetPointError(4,0,0.008150943);
   gre->SetPoint(5,300,-1.69996);
   gre->SetPointError(5,0,0.01154487);
   gre->SetPoint(6,500,-1.69946);
   gre->SetPointError(6,0,0.04204942);
   gre->SetPoint(7,700,-1.71824);
   gre->SetPointError(7,0,0.006845236);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-1.764618);
   Graph_Graph33->SetMaximum(-1.647664);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.086918);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.28729e-05);
   linear_fit->SetParError(0,1.080119e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.708578);
   linear_fit->SetParError(1,0.005284018);
