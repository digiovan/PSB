...
//=========  (Wed Apr  1 22:35:21 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-15.91796,1050,3.176349);
   ...
   gre->SetPoint(0,-700,-0.15516);
   gre->SetPointError(0,0,0.1491244);
   gre->SetPoint(1,-500,-2.45994);
   gre->SetPointError(1,0,0.2151996);
   gre->SetPoint(2,-300,-4.1031);
   gre->SetPointError(2,0,0.154714);
   gre->SetPoint(3,-100,-5.7716);
   gre->SetPointError(3,0,0.3676843);
   gre->SetPoint(4,100,-6.6326);
   gre->SetPointError(4,0,0.315126);
   gre->SetPoint(5,300,-8.5021);
   gre->SetPointError(5,0,0.1477445);
   gre->SetPoint(6,500,-9.75064);
   gre->SetPointError(6,0,0.6119589);
   gre->SetPoint(7,700,-12.42204);
   gre->SetPointError(7,0,0.3135324);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LTB.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-14.00853);
   Graph_Graph42->SetMaximum(1.266918);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.24542);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008250319);
   linear_fit->SetParError(0,0.0001679017);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.23285);
   linear_fit->SetParError(1,0.07929555);
