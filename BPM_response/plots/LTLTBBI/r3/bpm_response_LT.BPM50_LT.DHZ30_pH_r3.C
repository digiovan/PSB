...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-4.530461,1050,1.287285);
   ...
   gre->SetPoint(0,-700,0.30434);
   gre->SetPointError(0,0,0.013321);
   gre->SetPoint(1,-500,-0.08064);
   gre->SetPointError(1,0,0.005878182);
   gre->SetPoint(2,-300,-0.83796);
   gre->SetPointError(2,0,0.06112104);
   gre->SetPoint(3,-100,-1.17144);
   gre->SetPointError(3,0,0.01683312);
   gre->SetPoint(4,100,-1.93092);
   gre->SetPointError(4,0,0.01044163);
   gre->SetPoint(5,300,-2.29188);
   gre->SetPointError(5,0,0.02715675);
   gre->SetPoint(6,500,-2.8402);
   gre->SetPointError(6,0,0.01241043);
   gre->SetPoint(7,700,-3.54608);
   gre->SetPointError(7,0,0.01475664);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-3.948686);
   Graph_Graph33->SetMaximum(0.7055108);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(393.1394);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002812441);
   linear_fit->SetParError(0,9.089933e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.52762);
   linear_fit->SetParError(1,0.004413751);
