...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,0.8636994,1050,2.942672);
   ...
   gre->SetPoint(0,-700,1.23376);
   gre->SetPointError(0,0,0.02356508);
   gre->SetPoint(1,-500,1.46532);
   gre->SetPointError(1,0,0.01780397);
   gre->SetPoint(2,-300,1.71456);
   gre->SetPointError(2,0,0.02047853);
   gre->SetPoint(3,-100,1.82322);
   gre->SetPointError(3,0,0.02072179);
   gre->SetPoint(4,100,2.03758);
   gre->SetPointError(4,0,0.04449568);
   gre->SetPoint(5,300,2.28646);
   gre->SetPointError(5,0,0.03729792);
   gre->SetPoint(6,500,2.42112);
   gre->SetPointError(6,0,0.01801352);
   gre->SetPoint(7,700,2.56734);
   gre->SetPointError(7,0,0.02883676);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.071597);
   Graph_Graph29->SetMaximum(2.734775);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.05665);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0009524095);
   linear_fit->SetParError(0,1.753255e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.942625);
   linear_fit->SetParError(1,0.008222797);
