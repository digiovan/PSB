...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-25.7505,1050,-6.317207);
   ...
   gre->SetPoint(0,-700,-21.6016);
   gre->SetPointError(0,0,0.9100217);
   gre->SetPoint(1,-500,-19.86112);
   gre->SetPointError(1,0,0.4992944);
   gre->SetPoint(2,-300,-17.66052);
   gre->SetPointError(2,0,1.204711);
   gre->SetPoint(3,-100,-14.88906);
   gre->SetPointError(3,0,0.6802062);
   gre->SetPoint(4,100,-14.98874);
   gre->SetPointError(4,0,1.437621);
   gre->SetPoint(5,300,-16.67598);
   gre->SetPointError(5,0,0.9201781);
   gre->SetPoint(6,500,-13.06164);
   gre->SetPointError(6,0,0.225158);
   gre->SetPoint(7,700,-10.04518);
   gre->SetPointError(7,0,0.4890898);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-23.80717);
   Graph_Graph41->SetMaximum(-8.260537);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.50424);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006954838);
   linear_fit->SetParError(0,0.0004136271);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-16.2208);
   linear_fit->SetParError(1,0.2111824);
