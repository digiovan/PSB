...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-10.22854,1050,-9.380536);
   ...
   gre->SetPoint(0,-700,-9.6871);
   gre->SetPointError(0,0,0.01447107);
   gre->SetPoint(1,-500,-10.01988);
   gre->SetPointError(1,0,0.06732474);
   gre->SetPoint(2,-300,-9.70692);
   gre->SetPointError(2,0,0.06313438);
   gre->SetPoint(3,-100,-9.96392);
   gre->SetPointError(3,0,0.03493307);
   gre->SetPoint(4,100,-9.90744);
   gre->SetPointError(4,0,0.0392493);
   gre->SetPoint(5,300,-9.57258);
   gre->SetPointError(5,0,0.05071058);
   gre->SetPoint(6,500,-9.9146);
   gre->SetPointError(6,0,0.06808939);
   gre->SetPoint(7,700,-9.67758);
   gre->SetPointError(7,0,0.01689056);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-10.14374);
   Graph_Graph31->SetMaximum(-9.465336);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(119.0187);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.036127e-06);
   linear_fit->SetParError(0,1.548702e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.725363);
   linear_fit->SetParError(1,0.009691064);
