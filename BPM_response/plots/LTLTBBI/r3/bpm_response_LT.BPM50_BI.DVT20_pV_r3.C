...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_3->Range(-1050,-0.440864,1050,-0.3275602);
   ...
   gre->SetPoint(0,-700,-0.39406);
   gre->SetPointError(0,0,0.02376242);
   gre->SetPoint(1,-500,-0.3703);
   gre->SetPointError(1,0,0.022483);
   gre->SetPoint(2,-300,-0.38922);
   gre->SetPointError(2,0,0.01104195);
   gre->SetPoint(3,-100,-0.3683);
   gre->SetPointError(3,0,0.02185584);
   gre->SetPoint(4,100,-0.40408);
   gre->SetPointError(4,0,0.01790003);
   gre->SetPoint(5,300,-0.37084);
   gre->SetPointError(5,0,0.01561253);
   gre->SetPoint(6,500,-0.38524);
   gre->SetPointError(6,0,0.01598267);
   gre->SetPoint(7,700,-0.39712);
   gre->SetPointError(7,0,0.006202806);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-0.4295336);
   Graph_Graph33->SetMaximum(-0.3388906);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.22287);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-9.89802e-06);
   linear_fit->SetParError(0,9.656538e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3876924);
   linear_fit->SetParError(1,0.005439256);
