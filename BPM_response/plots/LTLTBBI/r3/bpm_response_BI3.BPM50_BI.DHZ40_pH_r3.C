...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-19.31803,1050,-9.088668);
   ...
   gre->SetPoint(0,-700,-14.90798);
   gre->SetPointError(0,0,0.7818223);
   gre->SetPoint(1,-500,-16.61698);
   gre->SetPointError(1,0,0.9961556);
   gre->SetPoint(2,-300,-15.35018);
   gre->SetPointError(2,0,1.18893);
   gre->SetPoint(3,-100,-13.27806);
   gre->SetPointError(3,0,2.073292);
   gre->SetPoint(4,100,-14.15624);
   gre->SetPointError(4,0,0.8879485);
   gre->SetPoint(5,300,-12.60534);
   gre->SetPointError(5,0,0.7446707);
   gre->SetPoint(6,500,-12.22048);
   gre->SetPointError(6,0,1.426919);
   gre->SetPoint(7,700,-14.21782);
   gre->SetPointError(7,0,2.24149);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-18.29509);
   Graph_Graph42->SetMaximum(-10.1116);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.370843);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00251287);
   linear_fit->SetParError(0,0.0008389864);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-13.95536);
   linear_fit->SetParError(1,0.3810025);
