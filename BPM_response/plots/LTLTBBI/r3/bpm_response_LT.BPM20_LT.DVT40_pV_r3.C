...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-6.833537,1050,-6.409156);
   ...
   gre->SetPoint(0,-700,-6.58146);
   gre->SetPointError(0,0,0.01819461);
   gre->SetPoint(1,-500,-6.59942);
   gre->SetPointError(1,0,0.01879506);
   gre->SetPoint(2,-300,-6.51772);
   gre->SetPointError(2,0,0.02884686);
   gre->SetPoint(3,-100,-6.72348);
   gre->SetPointError(3,0,0.02449667);
   gre->SetPoint(4,100,-6.55746);
   gre->SetPointError(4,0,0.0775739);
   gre->SetPoint(5,300,-6.6184);
   gre->SetPointError(5,0,0.03966195);
   gre->SetPoint(6,500,-6.68764);
   gre->SetPointError(6,0,0.07516656);
   gre->SetPoint(7,700,-6.56424);
   gre->SetPointError(7,0,0.03804867);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-6.791099);
   Graph_Graph30->SetMaximum(-6.451594);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.2958);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.28308e-05);
   linear_fit->SetParError(0,2.411088e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.614659);
   linear_fit->SetParError(1,0.01241433);
