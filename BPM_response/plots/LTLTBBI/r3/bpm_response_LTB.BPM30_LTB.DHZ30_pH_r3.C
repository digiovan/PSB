...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_3->Range(-1050,-9.544588,1050,10.42036);
   ...
   gre->SetPoint(0,-700,-6.16662);
   gre->SetPointError(0,0,0.05047653);
   gre->SetPoint(1,-500,-4.1436);
   gre->SetPointError(1,0,0.0754052);
   gre->SetPoint(2,-300,-2.09376);
   gre->SetPointError(2,0,0.1009266);
   gre->SetPoint(3,-100,-0.1883);
   gre->SetPointError(3,0,0.0390106);
   gre->SetPoint(4,100,1.64584);
   gre->SetPointError(4,0,0.02849718);
   gre->SetPoint(5,300,3.47144);
   gre->SetPointError(5,0,0.163761);
   gre->SetPoint(6,500,5.03922);
   gre->SetPointError(6,0,0.05948305);
   gre->SetPoint(7,700,7.0109);
   gre->SetPointError(7,0,0.08197008);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-7.548093);
   Graph_Graph36->SetMaximum(8.423867);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(66.66904);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00940544);
   linear_fit->SetParError(0,4.945095e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6214849);
   linear_fit->SetParError(1,0.01823022);
