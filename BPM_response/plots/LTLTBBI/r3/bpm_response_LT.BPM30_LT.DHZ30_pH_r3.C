...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-10.42764,1050,-9.192508);
   ...
   gre->SetPoint(0,-700,-10.08082);
   gre->SetPointError(0,0,0.02646191);
   gre->SetPoint(1,-500,-10.2);
   gre->SetPointError(1,0,0.02178308);
   gre->SetPoint(2,-300,-9.88882);
   gre->SetPointError(2,0,0.1306743);
   gre->SetPoint(3,-100,-10.03242);
   gre->SetPointError(3,0,0.02506622);
   gre->SetPoint(4,100,-9.64194);
   gre->SetPointError(4,0,0.029657);
   gre->SetPoint(5,300,-9.76098);
   gre->SetPointError(5,0,0.06635046);
   gre->SetPoint(6,500,-9.64674);
   gre->SetPointError(6,0,0.03815051);
   gre->SetPoint(7,700,-9.4233);
   gre->SetPointError(7,0,0.0249373);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-10.30413);
   Graph_Graph31->SetMaximum(-9.316021);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(106.4841);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0005409983);
   linear_fit->SetParError(0,2.131314e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.845926);
   linear_fit->SetParError(1,0.01072411);
