...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-9.864741,1050,-9.498379);
   ...
   gre->SetPoint(0,-700,-9.66952);
   gre->SetPointError(0,0,0.02962556);
   gre->SetPoint(1,-500,-9.62272);
   gre->SetPointError(1,0,0.03248768);
   gre->SetPoint(2,-300,-9.68156);
   gre->SetPointError(2,0,0.1221208);
   gre->SetPoint(3,-100,-9.62338);
   gre->SetPointError(3,0,0.0330899);
   gre->SetPoint(4,100,-9.59086);
   gre->SetPointError(4,0,0.0185238);
   gre->SetPoint(5,300,-9.6698);
   gre->SetPointError(5,0,0.07955162);
   gre->SetPoint(6,500,-9.6896);
   gre->SetPointError(6,0,0.07169268);
   gre->SetPoint(7,700,-9.6159);
   gre->SetPointError(7,0,0.04753024);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-9.828105);
   Graph_Graph31->SetMaximum(-9.535015);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.146399);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.047496e-05);
   linear_fit->SetParError(0,3.072349e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.616327);
   linear_fit->SetParError(1,0.01248589);
