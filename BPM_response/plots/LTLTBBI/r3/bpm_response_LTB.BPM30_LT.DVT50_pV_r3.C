...
//=========  (Wed Apr  1 22:35:00 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,-11.22897,1050,15.66727);
   ...
   gre->SetPoint(0,-700,-6.6594);
   gre->SetPointError(0,0,0.08686095);
   gre->SetPoint(1,-500,-4.02338);
   gre->SetPointError(1,0,0.02828357);
   gre->SetPoint(2,-300,-1.35658);
   gre->SetPointError(2,0,0.02246095);
   gre->SetPoint(3,-100,1.35788);
   gre->SetPointError(3,0,0.01367088);
   gre->SetPoint(4,100,4.03934);
   gre->SetPointError(4,0,0.04528276);
   gre->SetPoint(5,300,6.30692);
   gre->SetPointError(5,0,0.07277343);
   gre->SetPoint(6,500,8.68076);
   gre->SetPointError(6,0,0.124765);
   gre->SetPoint(7,700,11.14598);
   gre->SetPointError(7,0,0.03858101);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-8.539343);
   Graph_Graph36->SetMaximum(12.97764);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(207.041);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01272615);
   linear_fit->SetParError(0,3.482106e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.532371);
   linear_fit->SetParError(1,0.01081218);
