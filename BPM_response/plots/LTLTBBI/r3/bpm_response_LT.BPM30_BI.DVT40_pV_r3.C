...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-11.16301,1050,-9.804968);
   ...
   gre->SetPoint(0,-700,-10.61858);
   gre->SetPointError(0,0,0.06428557);
   gre->SetPoint(1,-500,-10.83446);
   gre->SetPointError(1,0,0.0879973);
   gre->SetPoint(2,-300,-10.12732);
   gre->SetPointError(2,0,0.09601159);
   gre->SetPoint(3,-100,-10.69018);
   gre->SetPointError(3,0,0.03081509);
   gre->SetPoint(4,100,-10.80784);
   gre->SetPointError(4,0,0.08859952);
   gre->SetPoint(5,300,-10.2663);
   gre->SetPointError(5,0,0.0731097);
   gre->SetPoint(6,500,-10.80482);
   gre->SetPointError(6,0,0.13185);
   gre->SetPoint(7,700,-10.69236);
   gre->SetPointError(7,0,0.07853706);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-11.02721);
   Graph_Graph31->SetMaximum(-9.940772);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(67.62846);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.484942e-05);
   linear_fit->SetParError(0,6.079188e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.63158);
   linear_fit->SetParError(1,0.02249826);
