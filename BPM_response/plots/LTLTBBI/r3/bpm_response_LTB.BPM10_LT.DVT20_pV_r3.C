...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,-2.657883,1050,5.810127);
   ...
   gre->SetPoint(0,-700,4.37468);
   gre->SetPointError(0,0,0.02411214);
   gre->SetPoint(1,-500,3.24758);
   gre->SetPointError(1,0,0.08556203);
   gre->SetPoint(2,-300,2.32476);
   gre->SetPointError(2,0,0.02213529);
   gre->SetPoint(3,-100,1.52476);
   gre->SetPointError(3,0,0.07646816);
   gre->SetPoint(4,100,0.67542);
   gre->SetPointError(4,0,0.02072495);
   gre->SetPoint(5,300,-0.0715);
   gre->SetPointError(5,0,0.0202148);
   gre->SetPoint(6,500,-0.82848);
   gre->SetPointError(6,0,0.02048243);
   gre->SetPoint(7,700,-1.22676);
   gre->SetPointError(7,0,0.01978819);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-1.811082);
   Graph_Graph34->SetMaximum(4.963326);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(601.1933);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003996304);
   linear_fit->SetParError(0,1.873252e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.265106);
   linear_fit->SetParError(1,0.008960308);
