...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_3->Range(-1050,0.1042047,1050,1.043417);
   ...
   gre->SetPoint(0,-700,0.83478);
   gre->SetPointError(0,0,0.05210156);
   gre->SetPoint(1,-500,0.64734);
   gre->SetPointError(1,0,0.1116075);
   gre->SetPoint(2,-300,0.57532);
   gre->SetPointError(2,0,0.05781822);
   gre->SetPoint(3,-100,0.51326);
   gre->SetPointError(3,0,0.1641128);
   gre->SetPoint(4,100,0.4654);
   gre->SetPointError(4,0,0.147603);
   gre->SetPoint(5,300,0.42696);
   gre->SetPointError(5,0,0.06062909);
   gre->SetPoint(6,500,0.36884);
   gre->SetPointError(6,0,0.1080999);
   gre->SetPoint(7,700,0.57646);
   gre->SetPointError(7,0,0.0851897);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(0.198126);
   Graph_Graph36->SetMaximum(0.9494957);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.31618);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002691441);
   linear_fit->SetParError(0,5.581937e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5688788);
   linear_fit->SetParError(1,0.02833433);
