...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,3.222937,1050,11.62112);
   ...
   gre->SetPoint(0,-700,10.15682);
   gre->SetPointError(0,0,0.06460678);
   gre->SetPoint(1,-500,9.63242);
   gre->SetPointError(1,0,0.04481034);
   gre->SetPoint(2,-300,8.84376);
   gre->SetPointError(2,0,0.03167195);
   gre->SetPoint(3,-100,8.41082);
   gre->SetPointError(3,0,0.03241705);
   gre->SetPoint(4,100,7.45516);
   gre->SetPointError(4,0,0.06120394);
   gre->SetPoint(5,300,6.96766);
   gre->SetPointError(5,0,0.02456013);
   gre->SetPoint(6,500,6.10098);
   gre->SetPointError(6,0,0.01834775);
   gre->SetPoint(7,700,4.7041);
   gre->SetPointError(7,0,0.08146488);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(4.062756);
   Graph_Graph40->SetMaximum(10.78131);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(159.4633);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003523893);
   linear_fit->SetParError(0,3.029456e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.89159);
   linear_fit->SetParError(1,0.01246708);
