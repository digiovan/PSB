...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-9.823309,1050,-9.467937);
   ...
   gre->SetPoint(0,-700,-9.66136);
   gre->SetPointError(0,0,0.1006616);
   gre->SetPoint(1,-500,-9.60664);
   gre->SetPointError(1,0,0.04460572);
   gre->SetPoint(2,-300,-9.59212);
   gre->SetPointError(2,0,0.02604212);
   gre->SetPoint(3,-100,-9.68482);
   gre->SetPointError(3,0,0.07925986);
   gre->SetPoint(4,100,-9.58912);
   gre->SetPointError(4,0,0.05751858);
   gre->SetPoint(5,300,-9.6409);
   gre->SetPointError(5,0,0.01782747);
   gre->SetPoint(6,500,-9.6649);
   gre->SetPointError(6,0,0.07151555);
   gre->SetPoint(7,700,-9.58104);
   gre->SetPointError(7,0,0.05387478);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-9.787771);
   Graph_Graph31->SetMaximum(-9.503474);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.84664);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.133543e-05);
   linear_fit->SetParError(0,3.612403e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.620259);
   linear_fit->SetParError(1,0.01304981);
