...
//=========  (Wed Apr  1 22:35:00 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-15.0226,1050,10.96413);
   ...
   gre->SetPoint(0,-700,-10.62822);
   gre->SetPointError(0,0,0.06325984);
   gre->SetPoint(1,-500,-7.91238);
   gre->SetPointError(1,0,0.01027511);
   gre->SetPoint(2,-300,-5.43392);
   gre->SetPointError(2,0,0.02219799);
   gre->SetPoint(3,-100,-2.9278);
   gre->SetPointError(3,0,0.04606028);
   gre->SetPoint(4,100,-0.3555);
   gre->SetPointError(4,0,0.1155849);
   gre->SetPoint(5,300,1.79386);
   gre->SetPointError(5,0,0.03392219);
   gre->SetPoint(6,500,4.0788);
   gre->SetPointError(6,0,0.05459411);
   gre->SetPoint(7,700,6.5757);
   gre->SetPointError(7,0,0.05730913);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-12.42393);
   Graph_Graph39->SetMaximum(8.365458);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(48.34901);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01212675);
   linear_fit->SetParError(0,2.841941e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.844765);
   linear_fit->SetParError(1,0.01322501);
