...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,-2.884209,1050,-2.601261);
   ...
   gre->SetPoint(0,-700,-2.78262);
   gre->SetPointError(0,0,0.03021427);
   gre->SetPoint(1,-500,-2.77792);
   gre->SetPointError(1,0,0.03444807);
   gre->SetPoint(2,-300,-2.69928);
   gre->SetPointError(2,0,0.03065714);
   gre->SetPoint(3,-100,-2.66398);
   gre->SetPointError(3,0,0.01118216);
   gre->SetPoint(4,100,-2.68026);
   gre->SetPointError(4,0,0.0318408);
   gre->SetPoint(5,300,-2.66516);
   gre->SetPointError(5,0,0.0167374);
   gre->SetPoint(6,500,-2.75224);
   gre->SetPointError(6,0,0.02229091);
   gre->SetPoint(7,700,-2.83014);
   gre->SetPointError(7,0,0.006910821);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-2.855914);
   Graph_Graph40->SetMaximum(-2.629556);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(97.21185);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001361838);
   linear_fit->SetParError(0,1.236757e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.714943);
   linear_fit->SetParError(1,0.006909075);
