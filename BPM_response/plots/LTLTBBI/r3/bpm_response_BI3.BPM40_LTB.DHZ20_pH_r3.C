...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-21.09109,1050,10.80492);
   ...
   gre->SetPoint(0,-700,4.4059);
   gre->SetPointError(0,0,0.5372156);
   gre->SetPoint(1,-500,4.09344);
   gre->SetPointError(1,0,0.2443841);
   gre->SetPoint(2,-300,4.77062);
   gre->SetPointError(2,0,0.7183023);
   gre->SetPoint(3,-100,3.541);
   gre->SetPointError(3,0,0.3993123);
   gre->SetPoint(4,100,0.18964);
   gre->SetPointError(4,0,0.50565);
   gre->SetPoint(5,300,-4.54072);
   gre->SetPointError(5,0,1.067947);
   gre->SetPoint(6,500,-11.23084);
   gre->SetPointError(6,0,1.069614);
   gre->SetPoint(7,700,-15.14134);
   gre->SetPointError(7,0,0.6337441);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-17.90148);
   Graph_Graph41->SetMaximum(7.615323);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(241.2903);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0123097);
   linear_fit->SetParError(0,0.000431244);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.323462);
   linear_fit->SetParError(1,0.1975918);
