...
//=========  (Wed Apr  1 22:35:05 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,2.356566,1050,15.09676);
   ...
   gre->SetPoint(0,-700,12.91352);
   gre->SetPointError(0,0,0.05987285);
   gre->SetPoint(1,-500,11.57628);
   gre->SetPointError(1,0,0.02158002);
   gre->SetPoint(2,-300,10.37176);
   gre->SetPointError(2,0,0.02633857);
   gre->SetPoint(3,-100,8.98864);
   gre->SetPointError(3,0,0.02822587);
   gre->SetPoint(4,100,7.83336);
   gre->SetPointError(4,0,0.01931397);
   gre->SetPoint(5,300,6.74846);
   gre->SetPointError(5,0,0.06419467);
   gre->SetPoint(6,500,5.73808);
   gre->SetPointError(6,0,0.07362274);
   gre->SetPoint(7,700,4.52574);
   gre->SetPointError(7,0,0.04580823);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(3.630586);
   Graph_Graph39->SetMaximum(13.82274);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(90.69856);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006036276);
   linear_fit->SetParError(0,3.13882e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.515295);
   linear_fit->SetParError(1,0.01137762);
