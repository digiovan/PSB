...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.912897,1050,1.236211);
   ...
   gre->SetPoint(0,-700,1.06198);
   gre->SetPointError(0,0,0.007247746);
   gre->SetPoint(1,-500,1.10364);
   gre->SetPointError(1,0,0.07868527);
   gre->SetPoint(2,-300,1.04988);
   gre->SetPointError(2,0,0.03013944);
   gre->SetPoint(3,-100,1.06126);
   gre->SetPointError(3,0,0.09447731);
   gre->SetPoint(4,100,1.06198);
   gre->SetPointError(4,0,0.03082587);
   gre->SetPoint(5,300,1.09584);
   gre->SetPointError(5,0,0.02607028);
   gre->SetPoint(6,500,1.10574);
   gre->SetPointError(6,0,0.008659163);
   gre->SetPoint(7,700,1.07604);
   gre->SetPointError(7,0,0.03612923);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.9452284);
   Graph_Graph29->SetMaximum(1.20388);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.68701);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.385814e-05);
   linear_fit->SetParError(0,8.998357e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.084675);
   linear_fit->SetParError(1,0.005396492);
