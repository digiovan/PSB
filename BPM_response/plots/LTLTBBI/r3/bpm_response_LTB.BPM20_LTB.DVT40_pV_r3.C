...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,2.184429,1050,2.775665);
   ...
   gre->SetPoint(0,-700,2.3625);
   gre->SetPointError(0,0,0.07953199);
   gre->SetPoint(1,-500,2.44998);
   gre->SetPointError(1,0,0.1109097);
   gre->SetPoint(2,-300,2.47984);
   gre->SetPointError(2,0,0.04096392);
   gre->SetPoint(3,-100,2.61384);
   gre->SetPointError(3,0,0.06328521);
   gre->SetPoint(4,100,2.51888);
   gre->SetPointError(4,0,0.05754239);
   gre->SetPoint(5,300,2.47102);
   gre->SetPointError(5,0,0.05359872);
   gre->SetPoint(6,500,2.50664);
   gre->SetPointError(6,0,0.06863061);
   gre->SetPoint(7,700,2.40988);
   gre->SetPointError(7,0,0.04237389);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(2.243552);
   Graph_Graph35->SetMaximum(2.716541);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.743094);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.477529e-05);
   linear_fit->SetParError(0,4.545833e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.477745);
   linear_fit->SetParError(1,0.02059919);
