...
//=========  (Wed Apr  1 22:36:19 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-21.15536,1050,-10.88732);
   ...
   gre->SetPoint(0,-700,-18.0578);
   gre->SetPointError(0,0,0.9969583);
   gre->SetPoint(1,-500,-18.65692);
   gre->SetPointError(1,0,0.7870993);
   gre->SetPoint(2,-300,-17.28694);
   gre->SetPointError(2,0,0.8680195);
   gre->SetPoint(3,-100,-15.18336);
   gre->SetPointError(3,0,1.597834);
   gre->SetPoint(4,100,-15.90868);
   gre->SetPointError(4,0,0.6651461);
   gre->SetPoint(5,300,-14.17688);
   gre->SetPointError(5,0,0.6598163);
   gre->SetPoint(6,500,-13.71666);
   gre->SetPointError(6,0,1.118002);
   gre->SetPoint(7,700,-15.10348);
   gre->SetPointError(7,0,1.455555);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-20.12856);
   Graph_Graph41->SetMaximum(-11.91412);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.706076);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003905313);
   linear_fit->SetParError(0,0.0007734806);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-15.99207);
   linear_fit->SetParError(1,0.314444);
