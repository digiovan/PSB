...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,-2.437576,1050,10.19694);
   ...
   gre->SetPoint(0,-700,7.77656);
   gre->SetPointError(0,0,0.3146312);
   gre->SetPoint(1,-500,5.77442);
   gre->SetPointError(1,0,0.1564777);
   gre->SetPoint(2,-300,5.51222);
   gre->SetPointError(2,0,0.1049771);
   gre->SetPoint(3,-100,3.5549);
   gre->SetPointError(3,0,0.2237076);
   gre->SetPoint(4,100,2.42574);
   gre->SetPointError(4,0,0.2814364);
   gre->SetPoint(5,300,2.36336);
   gre->SetPointError(5,0,0.1398357);
   gre->SetPoint(6,500,0.01848);
   gre->SetPointError(6,0,0.2929952);
   gre->SetPoint(7,700,-0.25088);
   gre->SetPointError(7,0,0.08094276);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(-1.174124);
   Graph_Graph35->SetMaximum(8.933493);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(49.30285);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00544572);
   linear_fit->SetParError(0,0.0001040043);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.577404);
   linear_fit->SetParError(1,0.05423056);
