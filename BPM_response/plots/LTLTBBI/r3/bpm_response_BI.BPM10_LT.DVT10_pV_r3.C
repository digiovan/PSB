...
//=========  (Wed Apr  1 22:34:18 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,-1.150193,1050,10.35173);
   ...
   gre->SetPoint(0,-700,8.1792);
   gre->SetPointError(0,0,0.2055864);
   gre->SetPoint(1,-500,6.67452);
   gre->SetPointError(1,0,0.09424506);
   gre->SetPoint(2,-300,5.64902);
   gre->SetPointError(2,0,0.05093871);
   gre->SetPoint(3,-100,4.67862);
   gre->SetPointError(3,0,0.08549339);
   gre->SetPoint(4,100,3.48958);
   gre->SetPointError(4,0,0.1080324);
   gre->SetPoint(5,300,2.26938);
   gre->SetPointError(5,0,0.04951319);
   gre->SetPoint(6,500,1.02384);
   gre->SetPointError(6,0,0.03294199);
   gre->SetPoint(7,700,0.23802);
   gre->SetPointError(7,0,0.02078627);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LT.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(0);
   Graph_Graph38->SetMaximum(9.201542);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(71.16031);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005438795);
   linear_fit->SetParError(0,4.235541e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.967941);
   linear_fit->SetParError(1,0.02458024);
