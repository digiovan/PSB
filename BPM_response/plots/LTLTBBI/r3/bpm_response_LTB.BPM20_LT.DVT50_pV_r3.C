...
//=========  (Wed Apr  1 22:34:59 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,-15.02986,1050,19.25771);
   ...
   gre->SetPoint(0,-700,-9.24528);
   gre->SetPointError(0,0,0.06998123);
   gre->SetPoint(1,-500,-5.89448);
   gre->SetPointError(1,0,0.0125596);
   gre->SetPoint(2,-300,-2.54718);
   gre->SetPointError(2,0,0.05439281);
   gre->SetPoint(3,-100,0.8382);
   gre->SetPointError(3,0,0.05050871);
   gre->SetPoint(4,100,4.26088);
   gre->SetPointError(4,0,0.08987405);
   gre->SetPoint(5,300,7.11976);
   gre->SetPointError(5,0,0.07400937);
   gre->SetPoint(6,500,10.25222);
   gre->SetPointError(6,0,0.08985054);
   gre->SetPoint(7,700,13.44052);
   gre->SetPointError(7,0,0.1025947);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(-11.6011);
   Graph_Graph35->SetMaximum(15.82895);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(45.63268);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01633209);
   linear_fit->SetParError(0,4.69487e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.281199);
   linear_fit->SetParError(1,0.02264538);
