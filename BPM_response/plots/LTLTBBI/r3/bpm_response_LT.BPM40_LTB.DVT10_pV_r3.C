...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-8.038392,1050,-7.497962);
   ...
   gre->SetPoint(0,-700,-7.78438);
   gre->SetPointError(0,0,0.07466077);
   gre->SetPoint(1,-500,-7.71174);
   gre->SetPointError(1,0,0.0551676);
   gre->SetPoint(2,-300,-7.76934);
   gre->SetPointError(2,0,0.09033237);
   gre->SetPoint(3,-100,-7.81708);
   gre->SetPointError(3,0,0.07207227);
   gre->SetPoint(4,100,-7.8805);
   gre->SetPointError(4,0,0.0678202);
   gre->SetPoint(5,300,-7.73436);
   gre->SetPointError(5,0,0.1463267);
   gre->SetPoint(6,500,-7.7785);
   gre->SetPointError(6,0,0.03834249);
   gre->SetPoint(7,700,-7.67358);
   gre->SetPointError(7,0,0.08091311);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.984349);
   Graph_Graph32->SetMaximum(-7.552005);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.742396);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.242981e-06);
   linear_fit->SetParError(0,4.853481e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.772878);
   linear_fit->SetParError(1,0.02308204);
