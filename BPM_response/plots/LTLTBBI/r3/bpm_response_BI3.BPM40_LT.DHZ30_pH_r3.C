...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-0.7655828,1050,10.15542);
   ...
   gre->SetPoint(0,-700,3.8972);
   gre->SetPointError(0,0,0.2190747);
   gre->SetPoint(1,-500,7.34928);
   gre->SetPointError(1,0,0.1651562);
   gre->SetPoint(2,-300,4.24112);
   gre->SetPointError(2,0,0.9166682);
   gre->SetPoint(3,-100,8.24708);
   gre->SetPointError(3,0,0.08817393);
   gre->SetPoint(4,100,2.6867);
   gre->SetPointError(4,0,0.2535357);
   gre->SetPoint(5,300,6.53938);
   gre->SetPointError(5,0,0.4655337);
   gre->SetPoint(6,500,3.6255);
   gre->SetPointError(6,0,0.1858308);
   gre->SetPoint(7,700,1.47794);
   gre->SetPointError(7,0,0.4233554);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(0.3265177);
   Graph_Graph41->SetMaximum(9.063321);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1029.146);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002205744);
   linear_fit->SetParError(0,0.0001864392);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,6.39176);
   linear_fit->SetParError(1,0.06706127);
