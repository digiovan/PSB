...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-9.903277,1050,-4.436953);
   ...
   gre->SetPoint(0,-700,-8.73236);
   gre->SetPointError(0,0,0.2598632);
   gre->SetPoint(1,-500,-8.1434);
   gre->SetPointError(1,0,0.3286891);
   gre->SetPoint(2,-300,-7.09588);
   gre->SetPointError(2,0,0.2367996);
   gre->SetPoint(3,-100,-6.83472);
   gre->SetPointError(3,0,0.342886);
   gre->SetPoint(4,100,-6.13832);
   gre->SetPointError(4,0,0.1923044);
   gre->SetPoint(5,300,-5.9154);
   gre->SetPointError(5,0,0.08288287);
   gre->SetPoint(6,500,-5.63726);
   gre->SetPointError(6,0,0.2863185);
   gre->SetPoint(7,700,-5.43782);
   gre->SetPointError(7,0,0.08981268);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-9.356645);
   Graph_Graph42->SetMaximum(-4.983586);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.0475);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002025932);
   linear_fit->SetParError(0,0.0001419577);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.677735);
   linear_fit->SetParError(1,0.07043602);
