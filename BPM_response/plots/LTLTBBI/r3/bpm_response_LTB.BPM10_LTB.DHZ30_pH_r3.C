...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,1.420807,1050,2.487689);
   ...
   gre->SetPoint(0,-700,2.14822);
   gre->SetPointError(0,0,0.1140151);
   gre->SetPoint(1,-500,1.97826);
   gre->SetPointError(1,0,0.11732);
   gre->SetPoint(2,-300,2.15284);
   gre->SetPointError(2,0,0.09942076);
   gre->SetPoint(3,-100,2.06278);
   gre->SetPointError(3,0,0.03308013);
   gre->SetPoint(4,100,1.91542);
   gre->SetPointError(4,0,0.05593896);
   gre->SetPoint(5,300,2.1981);
   gre->SetPointError(5,0,0.06601146);
   gre->SetPoint(6,500,1.85632);
   gre->SetPointError(6,0,0.2576994);
   gre->SetPoint(7,700,2.04806);
   gre->SetPointError(7,0,0.2618151);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(1.527495);
   Graph_Graph34->SetMaximum(2.381001);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.59838);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.817184e-05);
   linear_fit->SetParError(0,9.812264e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.056175);
   linear_fit->SetParError(1,0.02452029);
