...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_3->Range(-1050,-4.927114,1050,6.220856);
   ...
   gre->SetPoint(0,-700,4.30322);
   gre->SetPointError(0,0,0.05964133);
   gre->SetPoint(1,-500,3.09044);
   gre->SetPointError(1,0,0.07124728);
   gre->SetPoint(2,-300,2.18424);
   gre->SetPointError(2,0,0.07960733);
   gre->SetPoint(3,-100,0.89112);
   gre->SetPointError(3,0,0.1458871);
   gre->SetPoint(4,100,-0.12344);
   gre->SetPointError(4,0,0.1905802);
   gre->SetPoint(5,300,-0.8852);
   gre->SetPointError(5,0,0.07451194);
   gre->SetPoint(6,500,-2.01552);
   gre->SetPointError(6,0,0.08122386);
   gre->SetPoint(7,700,-2.99832);
   gre->SetPointError(7,0,0.07079882);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-3.812317);
   Graph_Graph36->SetMaximum(5.106059);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.440602);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005181123);
   linear_fit->SetParError(0,5.350824e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6036337);
   linear_fit->SetParError(1,0.02856334);
