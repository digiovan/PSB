...
//=========  (Wed Apr  1 22:35:52 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-11.58444,1050,9.878792);
   ...
   gre->SetPoint(0,-700,5.90366);
   gre->SetPointError(0,0,0.3979266);
   gre->SetPoint(1,-500,3.90426);
   gre->SetPointError(1,0,0.09561466);
   gre->SetPoint(2,-300,2.4439);
   gre->SetPointError(2,0,0.2412982);
   gre->SetPoint(3,-100,0.30042);
   gre->SetPointError(3,0,0.2399525);
   gre->SetPoint(4,100,-2.16478);
   gre->SetPointError(4,0,0.1418873);
   gre->SetPoint(5,300,-3.26378);
   gre->SetPointError(5,0,0.128076);
   gre->SetPoint(6,500,-5.68492);
   gre->SetPointError(6,0,0.4023614);
   gre->SetPoint(7,700,-7.93962);
   gre->SetPointError(7,0,0.0676154);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: BI.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-9.438118);
   Graph_Graph40->SetMaximum(7.732469);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(34.45209);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009890366);
   linear_fit->SetParError(0,9.11474e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.915245);
   linear_fit->SetParError(1,0.05011669);
