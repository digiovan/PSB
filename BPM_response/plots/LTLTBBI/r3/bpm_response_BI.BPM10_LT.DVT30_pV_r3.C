...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,-17.95357,1050,25.79495);
   ...
   gre->SetPoint(0,-700,-10.61324);
   gre->SetPointError(0,0,0.04891159);
   gre->SetPoint(1,-500,-6.24796);
   gre->SetPointError(1,0,0.08254469);
   gre->SetPoint(2,-300,-2.2272);
   gre->SetPointError(2,0,0.02854352);
   gre->SetPoint(3,-100,1.95526);
   gre->SetPointError(3,0,0.04914895);
   gre->SetPoint(4,100,6.12952);
   gre->SetPointError(4,0,0.2433898);
   gre->SetPoint(5,300,10.2983);
   gre->SetPointError(5,0,0.06222406);
   gre->SetPoint(6,500,14.53492);
   gre->SetPointError(6,0,0.04600606);
   gre->SetPoint(7,700,18.32726);
   gre->SetPointError(7,0,0.1762724);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-13.57872);
   Graph_Graph38->SetMaximum(21.4201);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.628005);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02089906);
   linear_fit->SetParError(0,4.7179e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.048853);
   linear_fit->SetParError(1,0.01956334);
