...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_3->Range(-1050,-5.956785,1050,-5.453093);
   ...
   gre->SetPoint(0,-700,-5.69722);
   gre->SetPointError(0,0,0.0646308);
   gre->SetPoint(1,-500,-5.7591);
   gre->SetPointError(1,0,0.03344938);
   gre->SetPoint(2,-300,-5.68034);
   gre->SetPointError(2,0,0.1432987);
   gre->SetPoint(3,-100,-5.83564);
   gre->SetPointError(3,0,0.03719595);
   gre->SetPoint(4,100,-5.81868);
   gre->SetPointError(4,0,0.02202719);
   gre->SetPoint(5,300,-5.6873);
   gre->SetPointError(5,0,0.08940182);
   gre->SetPoint(6,500,-5.6786);
   gre->SetPointError(6,0,0.07491795);
   gre->SetPoint(7,700,-5.7735);
   gre->SetPointError(7,0,0.06762075);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-5.906415);
   Graph_Graph37->SetMaximum(-5.503462);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.721522);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.290899e-05);
   linear_fit->SetParError(0,4.361958e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.79172);
   linear_fit->SetParError(1,0.01507393);
