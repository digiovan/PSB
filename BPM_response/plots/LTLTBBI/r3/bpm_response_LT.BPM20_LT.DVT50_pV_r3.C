...
//=========  (Wed Apr  1 22:34:59 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-6.986989,1050,-6.408159);
   ...
   gre->SetPoint(0,-700,-6.57196);
   gre->SetPointError(0,0,0.02543446);
   gre->SetPoint(1,-500,-6.63298);
   gre->SetPointError(1,0,0.04325291);
   gre->SetPoint(2,-300,-6.62952);
   gre->SetPointError(2,0,0.01518907);
   gre->SetPoint(3,-100,-6.64594);
   gre->SetPointError(3,0,0.0503734);
   gre->SetPoint(4,100,-6.79228);
   gre->SetPointError(4,0,0.09823762);
   gre->SetPoint(5,300,-6.58074);
   gre->SetPointError(5,0,0.07392173);
   gre->SetPoint(6,500,-6.58812);
   gre->SetPointError(6,0,0.02514502);
   gre->SetPoint(7,700,-6.57754);
   gre->SetPointError(7,0,0.07290944);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-6.929106);
   Graph_Graph30->SetMaximum(-6.466042);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.117113);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.644327e-06);
   linear_fit->SetParError(0,2.613809e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.611745);
   linear_fit->SetParError(1,0.01174573);
