...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,2.159708,1050,3.188956);
   ...
   gre->SetPoint(0,-700,2.84766);
   gre->SetPointError(0,0,0.01997753);
   gre->SetPoint(1,-500,2.97682);
   gre->SetPointError(1,0,0.02282924);
   gre->SetPoint(2,-300,2.35696);
   gre->SetPointError(2,0,0.02571065);
   gre->SetPoint(3,-100,2.98122);
   gre->SetPointError(3,0,0.02669171);
   gre->SetPoint(4,100,2.9408);
   gre->SetPointError(4,0,0.07661494);
   gre->SetPoint(5,300,2.55604);
   gre->SetPointError(5,0,0.09640469);
   gre->SetPoint(6,500,2.85598);
   gre->SetPointError(6,0,0.1048179);
   gre->SetPoint(7,700,2.85064);
   gre->SetPointError(7,0,0.06513652);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(2.262633);
   Graph_Graph36->SetMaximum(3.086031);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(415.9725);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.974244e-05);
   linear_fit->SetParError(0,3.453961e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.784334);
   linear_fit->SetParError(1,0.01736044);
