...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-15.85999,1050,17.241);
   ...
   gre->SetPoint(0,-700,-5.89976);
   gre->SetPointError(0,0,0.1598901);
   gre->SetPoint(1,-500,-10.17216);
   gre->SetPointError(1,0,0.1709985);
   gre->SetPoint(2,-300,-8.13306);
   gre->SetPointError(2,0,0.3427312);
   gre->SetPoint(3,-100,-5.8197);
   gre->SetPointError(3,0,0.1390598);
   gre->SetPoint(4,100,-2.22814);
   gre->SetPointError(4,0,0.8526476);
   gre->SetPoint(5,300,2.51526);
   gre->SetPointError(5,0,0.1838711);
   gre->SetPoint(6,500,8.13342);
   gre->SetPointError(6,0,0.2656116);
   gre->SetPoint(7,700,11.69842);
   gre->SetPointError(7,0,0.02574428);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-12.54989);
   Graph_Graph41->SetMaximum(13.9309);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2587.697);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01654362);
   linear_fit->SetParError(0,7.957482e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.007701692);
   linear_fit->SetParError(1,0.05391101);
