...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,-14.94923,1050,17.0991);
   ...
   gre->SetPoint(0,-700,-9.42666);
   gre->SetPointError(0,0,0.181183);
   gre->SetPoint(1,-500,-7.16586);
   gre->SetPointError(1,0,0.0586711);
   gre->SetPoint(2,-300,-4.40132);
   gre->SetPointError(2,0,0.1658187);
   gre->SetPoint(3,-100,-0.44914);
   gre->SetPointError(3,0,0.1742185);
   gre->SetPoint(4,100,2.97116);
   gre->SetPointError(4,0,0.05156548);
   gre->SetPoint(5,300,5.59614);
   gre->SetPointError(5,0,0.06404528);
   gre->SetPoint(6,500,8.04482);
   gre->SetPointError(6,0,0.1139284);
   gre->SetPoint(7,700,11.63094);
   gre->SetPointError(7,0,0.1267739);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-11.7444);
   Graph_Graph34->SetMaximum(13.89427);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(175.3199);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01571029);
   linear_fit->SetParError(0,7.750289e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9502818);
   linear_fit->SetParError(1,0.02950696);
