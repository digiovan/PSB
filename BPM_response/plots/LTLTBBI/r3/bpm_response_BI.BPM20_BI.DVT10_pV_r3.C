...
//=========  (Wed Apr  1 22:35:52 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-4.106805,1050,0.5454132);
   ...
   gre->SetPoint(0,-700,-0.32946);
   gre->SetPointError(0,0,0.09950348);
   gre->SetPoint(1,-500,-0.76318);
   gre->SetPointError(1,0,0.01940622);
   gre->SetPoint(2,-300,-1.08142);
   gre->SetPointError(2,0,0.06740609);
   gre->SetPoint(3,-100,-1.53008);
   gre->SetPointError(3,0,0.0682119);
   gre->SetPoint(4,100,-2.07436);
   gre->SetPointError(4,0,0.02504753);
   gre->SetPoint(5,300,-2.30246);
   gre->SetPointError(5,0,0.02535145);
   gre->SetPoint(6,500,-2.82466);
   gre->SetPointError(6,0,0.1045543);
   gre->SetPoint(7,700,-3.31204);
   gre->SetPointError(7,0,0.01939524);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: BI.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-3.641583);
   Graph_Graph39->SetMaximum(0.08019135);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(39.48401);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002107448);
   linear_fit->SetParError(0,2.184178e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.800919);
   linear_fit->SetParError(1,0.01078539);
