...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-8.000265,1050,-7.059495);
   ...
   gre->SetPoint(0,-700,-7.43568);
   gre->SetPointError(0,0,0.2193901);
   gre->SetPoint(1,-500,-7.70366);
   gre->SetPointError(1,0,0.0768071);
   gre->SetPoint(2,-300,-7.7043);
   gre->SetPointError(2,0,0.0573302);
   gre->SetPoint(3,-100,-7.76836);
   gre->SetPointError(3,0,0.07511004);
   gre->SetPoint(4,100,-7.568);
   gre->SetPointError(4,0,0.06963208);
   gre->SetPoint(5,300,-7.69794);
   gre->SetPointError(5,0,0.04256224);
   gre->SetPoint(6,500,-7.71662);
   gre->SetPointError(6,0,0.02638901);
   gre->SetPoint(7,700,-7.47704);
   gre->SetPointError(7,0,0.07345043);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.906188);
   Graph_Graph32->SetMaximum(-7.153572);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.85967);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.235747e-05);
   linear_fit->SetParError(0,5.271471e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.693836);
   linear_fit->SetParError(1,0.02304734);
