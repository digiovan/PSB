...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-2.542484,1050,-0.6573532);
   ...
   gre->SetPoint(0,-700,-1.07908);
   gre->SetPointError(0,0,0.1075383);
   gre->SetPoint(1,-500,-1.18098);
   gre->SetPointError(1,0,0.1335945);
   gre->SetPoint(2,-300,-1.38186);
   gre->SetPointError(2,0,0.0755764);
   gre->SetPoint(3,-100,-1.5273);
   gre->SetPointError(3,0,0.08280891);
   gre->SetPoint(4,100,-1.5814);
   gre->SetPointError(4,0,0.0597329);
   gre->SetPoint(5,300,-1.68516);
   gre->SetPointError(5,0,0.01269995);
   gre->SetPoint(6,500,-1.97906);
   gre->SetPointError(6,0,0.02187463);
   gre->SetPoint(7,700,-2.13068);
   gre->SetPointError(7,0,0.09761575);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-2.353971);
   Graph_Graph39->SetMaximum(-0.8458663);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(37.12394);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0008080662);
   linear_fit->SetParError(0,5.59908e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.485071);
   linear_fit->SetParError(1,0.02035935);
