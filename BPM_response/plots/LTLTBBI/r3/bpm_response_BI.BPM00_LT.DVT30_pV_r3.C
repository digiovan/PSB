...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-6.100749,1050,3.945146);
   ...
   gre->SetPoint(0,-700,-4.3909);
   gre->SetPointError(0,0,0.03553288);
   gre->SetPoint(1,-500,-3.18888);
   gre->SetPointError(1,0,0.04799568);
   gre->SetPoint(2,-300,-2.29226);
   gre->SetPointError(2,0,0.0169171);
   gre->SetPoint(3,-100,-1.37408);
   gre->SetPointError(3,0,0.007919576);
   gre->SetPoint(4,100,-0.46606);
   gre->SetPointError(4,0,0.08918495);
   gre->SetPoint(5,300,0.41182);
   gre->SetPointError(5,0,0.02912939);
   gre->SetPoint(6,500,1.40744);
   gre->SetPointError(6,0,0.02244919);
   gre->SetPoint(7,700,2.22488);
   gre->SetPointError(7,0,0.04595023);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-5.096159);
   Graph_Graph37->SetMaximum(2.940557);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(52.41433);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004655082);
   linear_fit->SetParError(0,2.436655e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.9203058);
   linear_fit->SetParError(1,0.006625562);
