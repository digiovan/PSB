...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,-2.104283,1050,18.93854);
   ...
   gre->SetPoint(0,-700,15.32616);
   gre->SetPointError(0,0,0.0578455);
   gre->SetPoint(1,-500,13.08892);
   gre->SetPointError(1,0,0.07908816);
   gre->SetPoint(2,-300,10.86178);
   gre->SetPointError(2,0,0.06907565);
   gre->SetPoint(3,-100,8.78966);
   gre->SetPointError(3,0,0.03667194);
   gre->SetPoint(4,100,6.77368);
   gre->SetPointError(4,0,0.0300371);
   gre->SetPoint(5,300,4.7733);
   gre->SetPointError(5,0,0.1453725);
   gre->SetPoint(6,500,3.09544);
   gre->SetPointError(6,0,0.04728893);
   gre->SetPoint(7,700,0.96064);
   gre->SetPointError(7,0,0.07917976);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(0);
   Graph_Graph40->SetMaximum(16.83426);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(96.96083);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01014169);
   linear_fit->SetParError(0,4.893283e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.907364);
   linear_fit->SetParError(1,0.01775688);
