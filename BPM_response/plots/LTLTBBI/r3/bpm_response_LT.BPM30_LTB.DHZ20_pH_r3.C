...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-9.666473,1050,-9.386887);
   ...
   gre->SetPoint(0,-700,-9.54062);
   gre->SetPointError(0,0,0.06780183);
   gre->SetPoint(1,-500,-9.56848);
   gre->SetPointError(1,0,0.04539448);
   gre->SetPoint(2,-300,-9.57954);
   gre->SetPointError(2,0,0.03961178);
   gre->SetPoint(3,-100,-9.55194);
   gre->SetPointError(3,0,0.04048874);
   gre->SetPoint(4,100,-9.52668);
   gre->SetPointError(4,0,0.09319563);
   gre->SetPoint(5,300,-9.57012);
   gre->SetPointError(5,0,0.02774243);
   gre->SetPoint(6,500,-9.50142);
   gre->SetPointError(6,0,0.04674911);
   gre->SetPoint(7,700,-9.512);
   gre->SetPointError(7,0,0.06270059);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-9.638515);
   Graph_Graph31->SetMaximum(-9.414845);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.08091);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.093573e-05);
   linear_fit->SetParError(0,3.946302e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.555759);
   linear_fit->SetParError(1,0.01573973);
