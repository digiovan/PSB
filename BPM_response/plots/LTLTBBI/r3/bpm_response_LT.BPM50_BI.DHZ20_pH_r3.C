...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-1.736039,1050,-1.564084);
   ...
   gre->SetPoint(0,-700,-1.65122);
   gre->SetPointError(0,0,0.01358291);
   gre->SetPoint(1,-500,-1.66848);
   gre->SetPointError(1,0,0.01737295);
   gre->SetPoint(2,-300,-1.63972);
   gre->SetPointError(2,0,0.04697706);
   gre->SetPoint(3,-100,-1.66994);
   gre->SetPointError(3,0,0.01057203);
   gre->SetPoint(4,100,-1.69854);
   gre->SetPointError(4,0,0.00883939);
   gre->SetPoint(5,300,-1.65264);
   gre->SetPointError(5,0,0.02045898);
   gre->SetPoint(6,500,-1.66604);
   gre->SetPointError(6,0,0.02048936);
   gre->SetPoint(7,700,-1.69066);
   gre->SetPointError(7,0,0.01121495);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-1.718843);
   Graph_Graph33->SetMaximum(-1.581279);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.478933);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.325014e-05);
   linear_fit->SetParError(0,1.095625e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.67698);
   linear_fit->SetParError(1,0.004820014);
