...
//=========  (Wed Apr  1 22:35:05 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_3->Range(-1050,-9.652904,1050,-3.368396);
   ...
   gre->SetPoint(0,-700,-8.52022);
   gre->SetPointError(0,0,0.08526584);
   gre->SetPoint(1,-500,-7.93462);
   gre->SetPointError(1,0,0.2191096);
   gre->SetPoint(2,-300,-7.18494);
   gre->SetPointError(2,0,0.1135615);
   gre->SetPoint(3,-100,-6.57682);
   gre->SetPointError(3,0,0.07189588);
   gre->SetPoint(4,100,-6.02572);
   gre->SetPointError(4,0,0.06287136);
   gre->SetPoint(5,300,-5.52328);
   gre->SetPointError(5,0,0.1188155);
   gre->SetPoint(6,500,-4.94884);
   gre->SetPointError(6,0,0.04506802);
   gre->SetPoint(7,700,-4.46976);
   gre->SetPointError(7,0,0.05394627);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-9.024453);
   Graph_Graph37->SetMaximum(-3.996847);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.569735);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002842524);
   linear_fit->SetParError(0,5.881143e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.384598);
   linear_fit->SetParError(1,0.02882987);
