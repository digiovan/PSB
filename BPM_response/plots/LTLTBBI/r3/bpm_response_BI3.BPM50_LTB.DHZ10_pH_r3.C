...
//=========  (Wed Apr  1 22:35:05 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-7.483091,1050,5.245708);
   ...
   gre->SetPoint(0,-700,2.79986);
   gre->SetPointError(0,0,0.1983549);
   gre->SetPoint(1,-500,2.5628);
   gre->SetPointError(1,0,0.4723611);
   gre->SetPoint(2,-300,1.99582);
   gre->SetPointError(2,0,0.1483572);
   gre->SetPoint(3,-100,2.51546);
   gre->SetPointError(3,0,0.6087813);
   gre->SetPoint(4,100,1.31114);
   gre->SetPointError(4,0,0.1891471);
   gre->SetPoint(5,300,0.0851);
   gre->SetPointError(5,0,0.2982976);
   gre->SetPoint(6,500,-0.13314);
   gre->SetPointError(6,0,0.807036);
   gre->SetPoint(7,700,-4.68954);
   gre->SetPointError(7,0,0.6720843);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-6.210211);
   Graph_Graph42->SetMaximum(3.972828);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(44.82101);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002867035);
   linear_fit->SetParError(0,0.0002573721);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.109127);
   linear_fit->SetParError(1,0.105821);
