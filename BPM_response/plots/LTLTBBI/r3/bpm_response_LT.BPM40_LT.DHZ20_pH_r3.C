...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-1.487426,1050,0.7067802);
   ...
   gre->SetPoint(0,-700,0.32222);
   gre->SetPointError(0,0,0.01885919);
   gre->SetPoint(1,-500,0.05234);
   gre->SetPointError(1,0,0.008731942);
   gre->SetPoint(2,-300,-0.14396);
   gre->SetPointError(2,0,0.007607305);
   gre->SetPoint(3,-100,-0.27138);
   gre->SetPointError(3,0,0.006244734);
   gre->SetPoint(4,100,-0.46786);
   gre->SetPointError(4,0,0.00927544);
   gre->SetPoint(5,300,-0.75148);
   gre->SetPointError(5,0,0.002210475);
   gre->SetPoint(6,500,-0.9846);
   gre->SetPointError(6,0,0.006048705);
   gre->SetPoint(7,700,-1.11954);
   gre->SetPointError(7,0,0.002184862);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-1.268005);
   Graph_Graph32->SetMaximum(0.4873596);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(339.8458);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0009960557);
   linear_fit->SetParError(0,4.423024e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4351032);
   linear_fit->SetParError(1,0.002266949);
