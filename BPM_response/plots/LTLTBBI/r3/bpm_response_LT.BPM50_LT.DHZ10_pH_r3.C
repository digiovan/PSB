...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-2.271706,1050,-0.9494849);
   ...
   gre->SetPoint(0,-700,-2.0394);
   gre->SetPointError(0,0,0.01193572);
   gre->SetPoint(1,-500,-1.73222);
   gre->SetPointError(1,0,0.01098194);
   gre->SetPoint(2,-300,-1.61008);
   gre->SetPointError(2,0,0.02014683);
   gre->SetPoint(3,-100,-1.69572);
   gre->SetPointError(3,0,0.01748754);
   gre->SetPoint(4,100,-1.58848);
   gre->SetPointError(4,0,0.02829221);
   gre->SetPoint(5,300,-1.2413);
   gre->SetPointError(5,0,0.02513997);
   gre->SetPoint(6,500,-1.19092);
   gre->SetPointError(6,0,0.02106494);
   gre->SetPoint(7,700,-1.24192);
   gre->SetPointError(7,0,0.03635825);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-2.139484);
   Graph_Graph33->SetMaximum(-1.081707);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(248.7704);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0006073966);
   linear_fit->SetParError(0,1.482104e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.524267);
   linear_fit->SetParError(1,0.00748416);
