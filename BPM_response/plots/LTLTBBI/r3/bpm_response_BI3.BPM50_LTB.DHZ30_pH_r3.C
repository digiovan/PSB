...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-19.58324,1050,13.69963);
   ...
   gre->SetPoint(0,-700,7.97726);
   gre->SetPointError(0,0,0.1752268);
   gre->SetPoint(1,-500,4.76318);
   gre->SetPointError(1,0,0.1455308);
   gre->SetPoint(2,-300,4.6782);
   gre->SetPointError(2,0,0.1612222);
   gre->SetPoint(3,-100,2.37952);
   gre->SetPointError(3,0,0.3411261);
   gre->SetPoint(4,100,-0.59552);
   gre->SetPointError(4,0,0.9494733);
   gre->SetPoint(5,300,-6.84408);
   gre->SetPointError(5,0,1.095724);
   gre->SetPoint(6,500,-8.85584);
   gre->SetPointError(6,0,0.5397474);
   gre->SetPoint(7,700,-12.9119);
   gre->SetPointError(7,0,1.124198);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-16.25496);
   Graph_Graph42->SetMaximum(10.37135);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(177.8133);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01177005);
   linear_fit->SetParError(0,0.0003348545);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.1731776);
   linear_fit->SetParError(1,0.1658816);
