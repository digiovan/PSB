...
//=========  (Wed Apr  1 22:34:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_3->Range(-1050,-9.410581,1050,-2.741534);
   ...
   gre->SetPoint(0,-700,-8.23964);
   gre->SetPointError(0,0,0.05943307);
   gre->SetPoint(1,-500,-7.45988);
   gre->SetPointError(1,0,0.06612783);
   gre->SetPoint(2,-300,-6.73404);
   gre->SetPointError(2,0,0.04937781);
   gre->SetPoint(3,-100,-6.44788);
   gre->SetPointError(3,0,0.06055854);
   gre->SetPoint(4,100,-5.8858);
   gre->SetPointError(4,0,0.1925537);
   gre->SetPoint(5,300,-4.81634);
   gre->SetPointError(5,0,0.1499925);
   gre->SetPoint(6,500,-4.3536);
   gre->SetPointError(6,0,0.05021003);
   gre->SetPoint(7,700,-3.95056);
   gre->SetPointError(7,0,0.09751839);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LT.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-8.743676);
   Graph_Graph37->SetMaximum(-3.408438);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.03509);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003109871);
   linear_fit->SetParError(0,5.176438e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.956473);
   linear_fit->SetParError(1,0.02432849);
