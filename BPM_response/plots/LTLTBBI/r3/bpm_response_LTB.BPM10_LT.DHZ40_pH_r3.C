...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,-7.635329,1050,10.23447);
   ...
   gre->SetPoint(0,-700,7.01432);
   gre->SetPointError(0,0,0.2418468);
   gre->SetPoint(1,-500,4.40574);
   gre->SetPointError(1,0,0.09105729);
   gre->SetPoint(2,-300,3.8488);
   gre->SetPointError(2,0,0.1089913);
   gre->SetPoint(3,-100,1.31648);
   gre->SetPointError(3,0,0.07631102);
   gre->SetPoint(4,100,-0.31082);
   gre->SetPointError(4,0,0.1380541);
   gre->SetPoint(5,300,-0.76476);
   gre->SetPointError(5,0,0.2395874);
   gre->SetPoint(6,500,-3.08494);
   gre->SetPointError(6,0,0.3528517);
   gre->SetPoint(7,700,-4.56358);
   gre->SetPointError(7,0,0.09345004);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-5.84835);
   Graph_Graph34->SetMaximum(8.447486);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(91.39268);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007749533);
   linear_fit->SetParError(0,9.65174e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8002461);
   linear_fit->SetParError(1,0.04144009);
