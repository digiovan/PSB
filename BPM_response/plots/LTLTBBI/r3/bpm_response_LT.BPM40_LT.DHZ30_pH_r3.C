...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-1.6078,1050,0.938321);
   ...
   gre->SetPoint(0,-700,-1.17806);
   gre->SetPointError(0,0,0.005386457);
   gre->SetPoint(1,-500,-1.01414);
   gre->SetPointError(1,0,0.01183322);
   gre->SetPoint(2,-300,-0.70766);
   gre->SetPointError(2,0,0.01160235);
   gre->SetPoint(3,-100,-0.57672);
   gre->SetPointError(3,0,0.007699187);
   gre->SetPoint(4,100,-0.2626);
   gre->SetPointError(4,0,0.009004697);
   gre->SetPoint(5,300,-0.07292);
   gre->SetPointError(5,0,0.005593619);
   gre->SetPoint(6,500,0.16704);
   gre->SetPointError(6,0,0.01035171);
   gre->SetPoint(7,700,0.50706);
   gre->SetPointError(7,0,0.006907454);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-1.353188);
   Graph_Graph32->SetMaximum(0.6837088);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(306.1829);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001174041);
   linear_fit->SetParError(0,5.337712e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3879819);
   linear_fit->SetParError(1,0.002668517);
