...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,1.105727,1050,2.120965);
   ...
   gre->SetPoint(0,-700,1.47818);
   gre->SetPointError(0,0,0.1176844);
   gre->SetPoint(1,-500,1.5383);
   gre->SetPointError(1,0,0.1361475);
   gre->SetPoint(2,-300,1.69036);
   gre->SetPointError(2,0,0.2613987);
   gre->SetPoint(3,-100,1.44312);
   gre->SetPointError(3,0,0.1349275);
   gre->SetPoint(4,100,1.4396);
   gre->SetPointError(4,0,0.1646665);
   gre->SetPoint(5,300,1.53586);
   gre->SetPointError(5,0,0.1486263);
   gre->SetPoint(6,500,1.4335);
   gre->SetPointError(6,0,0.04958081);
   gre->SetPoint(7,700,1.45276);
   gre->SetPointError(7,0,0.09293045);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(1.207251);
   Graph_Graph34->SetMaximum(2.019441);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.22713);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.578718e-05);
   linear_fit->SetParError(0,8.000519e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.473743);
   linear_fit->SetParError(1,0.04132996);
