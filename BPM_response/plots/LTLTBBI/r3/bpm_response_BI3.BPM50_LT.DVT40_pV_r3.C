...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-23.87653,1050,9.78897);
   ...
   gre->SetPoint(0,-700,3.91754);
   gre->SetPointError(0,0,0.2605128);
   gre->SetPoint(1,-500,0.27098);
   gre->SetPointError(1,0,0.08610042);
   gre->SetPoint(2,-300,-2.12708);
   gre->SetPointError(2,0,0.5613854);
   gre->SetPoint(3,-100,-5.3153);
   gre->SetPointError(3,0,0.4016724);
   gre->SetPoint(4,100,-7.10162);
   gre->SetPointError(4,0,0.2096433);
   gre->SetPoint(5,300,-9.4518);
   gre->SetPointError(5,0,0.6910894);
   gre->SetPoint(6,500,-12.12516);
   gre->SetPointError(6,0,0.400415);
   gre->SetPoint(7,700,-16.13726);
   gre->SetPointError(7,0,2.128355);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-20.50998);
   Graph_Graph42->SetMaximum(6.42242);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.7654);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01278197);
   linear_fit->SetParError(0,0.0002560593);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.99598);
   linear_fit->SetParError(1,0.1222456);
