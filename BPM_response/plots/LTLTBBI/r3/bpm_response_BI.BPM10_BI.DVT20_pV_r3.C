...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,3.528929,1050,4.531403);
   ...
   gre->SetPoint(0,-700,4.0532);
   gre->SetPointError(0,0,0.03823122);
   gre->SetPoint(1,-500,3.94664);
   gre->SetPointError(1,0,0.1098426);
   gre->SetPoint(2,-300,3.88994);
   gre->SetPointError(2,0,0.05927103);
   gre->SetPoint(3,-100,3.79576);
   gre->SetPointError(3,0,0.09798672);
   gre->SetPoint(4,100,3.91256);
   gre->SetPointError(4,0,0.1092968);
   gre->SetPoint(5,300,3.82392);
   gre->SetPointError(5,0,0.127912);
   gre->SetPoint(6,500,4.27044);
   gre->SetPointError(6,0,0.093884);
   gre->SetPoint(7,700,3.91906);
   gre->SetPointError(7,0,0.04829942);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(3.629176);
   Graph_Graph38->SetMaximum(4.431156);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.10636);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.023786e-05);
   linear_fit->SetParError(0,4.08933e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.970474);
   linear_fit->SetParError(1,0.02386023);
