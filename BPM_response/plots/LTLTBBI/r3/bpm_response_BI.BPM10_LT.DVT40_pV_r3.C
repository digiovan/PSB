...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,-0.7427007,1050,8.119665);
   ...
   gre->SetPoint(0,-700,6.58352);
   gre->SetPointError(0,0,0.0590838);
   gre->SetPoint(1,-500,5.92606);
   gre->SetPointError(1,0,0.03180739);
   gre->SetPoint(2,-300,5.28684);
   gre->SetPointError(2,0,0.04685335);
   gre->SetPoint(3,-100,4.13916);
   gre->SetPointError(3,0,0.07718889);
   gre->SetPoint(4,100,3.92792);
   gre->SetPointError(4,0,0.1738867);
   gre->SetPoint(5,300,3.05064);
   gre->SetPointError(5,0,0.1018063);
   gre->SetPoint(6,500,2.02728);
   gre->SetPointError(6,0,0.0726289);
   gre->SetPoint(7,700,0.9453);
   gre->SetPointError(7,0,0.2109397);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(0.1435359);
   Graph_Graph38->SetMaximum(7.233428);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(32.18779);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003831666);
   linear_fit->SetParError(0,6.025712e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.006206);
   linear_fit->SetParError(1,0.02840039);
