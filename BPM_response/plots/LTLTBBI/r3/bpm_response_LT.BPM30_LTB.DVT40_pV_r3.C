...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-11.25544,1050,-10.61104);
   ...
   gre->SetPoint(0,-700,-10.9961);
   gre->SetPointError(0,0,0.1175766);
   gre->SetPoint(1,-500,-10.92466);
   gre->SetPointError(1,0,0.03028466);
   gre->SetPoint(2,-300,-10.92906);
   gre->SetPointError(2,0,0.06345201);
   gre->SetPoint(3,-100,-11.08358);
   gre->SetPointError(3,0,0.06445792);
   gre->SetPoint(4,100,-10.95122);
   gre->SetPointError(4,0,0.1028328);
   gre->SetPoint(5,300,-10.8201);
   gre->SetPointError(5,0,0.1016589);
   gre->SetPoint(6,500,-11.01242);
   gre->SetPointError(6,0,0.1193682);
   gre->SetPoint(7,700,-10.9398);
   gre->SetPointError(7,0,0.03399414);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-11.191);
   Graph_Graph31->SetMaximum(-10.67548);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.175694);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.551986e-06);
   linear_fit->SetParError(0,3.571598e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.94489);
   linear_fit->SetParError(1,0.01897192);
