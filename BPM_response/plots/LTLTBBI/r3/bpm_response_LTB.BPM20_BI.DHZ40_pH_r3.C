...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,3.179977,1050,3.959093);
   ...
   gre->SetPoint(0,-700,3.55662);
   gre->SetPointError(0,0,0.1948662);
   gre->SetPoint(1,-500,3.61814);
   gre->SetPointError(1,0,0.09532273);
   gre->SetPoint(2,-300,3.60328);
   gre->SetPointError(2,0,0.1048095);
   gre->SetPoint(3,-100,3.45034);
   gre->SetPointError(3,0,0.1405101);
   gre->SetPoint(4,100,3.6826);
   gre->SetPointError(4,0,0.1466401);
   gre->SetPoint(5,300,3.51506);
   gre->SetPointError(5,0,0.04298297);
   gre->SetPoint(6,500,3.52794);
   gre->SetPointError(6,0,0.1286351);
   gre->SetPoint(7,700,3.64774);
   gre->SetPointError(7,0,0.08675936);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(3.257889);
   Graph_Graph35->SetMaximum(3.881181);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.967162);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.75356e-05);
   linear_fit->SetParError(0,8.264907e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.559079);
   linear_fit->SetParError(1,0.03393012);
