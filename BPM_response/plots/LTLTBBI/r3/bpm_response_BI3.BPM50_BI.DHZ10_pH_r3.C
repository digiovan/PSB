...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-17.87099,1050,-8.746513);
   ...
   gre->SetPoint(0,-700,-12.06266);
   gre->SetPointError(0,0,1.795401);
   gre->SetPoint(1,-500,-12.96186);
   gre->SetPointError(1,0,0.8050551);
   gre->SetPoint(2,-300,-14.209);
   gre->SetPointError(2,0,1.672725);
   gre->SetPoint(3,-100,-14.96252);
   gre->SetPointError(3,0,1.310062);
   gre->SetPoint(4,100,-14.92068);
   gre->SetPointError(4,0,1.429563);
   gre->SetPoint(5,300,-15.10952);
   gre->SetPointError(5,0,0.6703937);
   gre->SetPoint(6,500,-14.3007);
   gre->SetPointError(6,0,1.170903);
   gre->SetPoint(7,700,-13.96362);
   gre->SetPointError(7,0,0.6499702);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-16.95854);
   Graph_Graph42->SetMaximum(-9.65896);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.762495);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0009307967);
   linear_fit->SetParError(0,0.0007389197);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-14.00126);
   linear_fit->SetParError(1,0.3670547);
