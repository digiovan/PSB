...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-2.811235,1050,-0.506288);
   ...
   gre->SetPoint(0,-700,-2.41656);
   gre->SetPointError(0,0,0.01051755);
   gre->SetPoint(1,-500,-1.91836);
   gre->SetPointError(1,0,0.01381226);
   gre->SetPoint(2,-300,-1.9684);
   gre->SetPointError(2,0,0.02009981);
   gre->SetPoint(3,-100,-1.53998);
   gre->SetPointError(3,0,0.00678254);
   gre->SetPoint(4,100,-1.34608);
   gre->SetPointError(4,0,0.01665785);
   gre->SetPoint(5,300,-1.38392);
   gre->SetPointError(5,0,0.01582197);
   gre->SetPoint(6,500,-0.92);
   gre->SetPointError(6,0,0.02955409);
   gre->SetPoint(7,700,-0.92196);
   gre->SetPointError(7,0,0.006563263);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-2.580741);
   Graph_Graph33->SetMaximum(-0.7367827);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(865.2732);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0009646543);
   linear_fit->SetParError(0,7.530423e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.552399);
   linear_fit->SetParError(1,0.003831322);
