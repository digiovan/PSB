...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-1.494619,1050,0.8072575);
   ...
   gre->SetPoint(0,-700,-1.103);
   gre->SetPointError(0,0,0.007973158);
   gre->SetPoint(1,-500,-0.9773);
   gre->SetPointError(1,0,0.006337805);
   gre->SetPoint(2,-300,-0.65614);
   gre->SetPointError(2,0,0.007763278);
   gre->SetPoint(3,-100,-0.5198);
   gre->SetPointError(3,0,0.007399449);
   gre->SetPoint(4,100,-0.33106);
   gre->SetPointError(4,0,0.004269294);
   gre->SetPoint(5,300,-0.04604);
   gre->SetPointError(5,0,0.009199163);
   gre->SetPoint(6,500,0.08382);
   gre->SetPointError(6,0,0.01387144);
   gre->SetPoint(7,700,0.41504);
   gre->SetPointError(7,0,0.008571382);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-1.264432);
   Graph_Graph32->SetMaximum(0.5770698);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(313.6586);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001073791);
   linear_fit->SetParError(0,6.366245e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4032198);
   linear_fit->SetParError(1,0.002518321);
