...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-14.4963,1050,13.82277);
   ...
   gre->SetPoint(0,-700,-8.53178);
   gre->SetPointError(0,0,1.244675);
   gre->SetPoint(1,-500,2.8356);
   gre->SetPointError(1,0,0.06890319);
   gre->SetPoint(2,-300,0.5606);
   gre->SetPointError(2,0,0.7289362);
   gre->SetPoint(3,-100,7.18406);
   gre->SetPointError(3,0,0.03247679);
   gre->SetPoint(4,100,8.71962);
   gre->SetPointError(4,0,0.03261011);
   gre->SetPoint(5,300,3.3353);
   gre->SetPointError(5,0,0.5528554);
   gre->SetPoint(6,500,8.00284);
   gre->SetPointError(6,0,1.100088);
   gre->SetPoint(7,700,3.27028);
   gre->SetPointError(7,0,0.05902622);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-11.66439);
   Graph_Graph41->SetMaximum(10.99087);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10612.22);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0007236226);
   linear_fit->SetParError(0,6.910862e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,6.949644);
   linear_fit->SetParError(1,0.02062746);
