...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,2.237629,1050,4.945937);
   ...
   gre->SetPoint(0,-700,3.81316);
   gre->SetPointError(0,0,0.13571);
   gre->SetPoint(1,-500,2.93604);
   gre->SetPointError(1,0,0.2470261);
   gre->SetPoint(2,-300,3.89734);
   gre->SetPointError(2,0,0.1293257);
   gre->SetPoint(3,-100,3.01856);
   gre->SetPointError(3,0,0.2552594);
   gre->SetPoint(4,100,3.1708);
   gre->SetPointError(4,0,0.3841383);
   gre->SetPoint(5,300,4.25304);
   gre->SetPointError(5,0,0.2415122);
   gre->SetPoint(6,500,3.3627);
   gre->SetPointError(6,0,0.2501662);
   gre->SetPoint(7,700,4.1793);
   gre->SetPointError(7,0,0.1676185);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(2.50846);
   Graph_Graph35->SetMaximum(4.675106);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(33.2507);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0002271954);
   linear_fit->SetParError(0,0.0001336291);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.784283);
   linear_fit->SetParError(1,0.0691608);
