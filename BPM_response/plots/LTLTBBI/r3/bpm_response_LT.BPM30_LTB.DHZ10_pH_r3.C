...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-9.80089,1050,-9.365551);
   ...
   gre->SetPoint(0,-700,-9.60192);
   gre->SetPointError(0,0,0.05782445);
   gre->SetPoint(1,-500,-9.53632);
   gre->SetPointError(1,0,0.09821226);
   gre->SetPoint(2,-300,-9.62074);
   gre->SetPointError(2,0,0.01872853);
   gre->SetPoint(3,-100,-9.52602);
   gre->SetPointError(3,0,0.06786721);
   gre->SetPoint(4,100,-9.4933);
   gre->SetPointError(4,0,0.03731077);
   gre->SetPoint(5,300,-9.56752);
   gre->SetPointError(5,0,0.04735926);
   gre->SetPoint(6,500,-9.6392);
   gre->SetPointError(6,0,0.08913315);
   gre->SetPoint(7,700,-9.57674);
   gre->SetPointError(7,0,0.04836155);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-9.757356);
   Graph_Graph31->SetMaximum(-9.409085);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.237331);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.516722e-05);
   linear_fit->SetParError(0,3.901953e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.582545);
   linear_fit->SetParError(1,0.01453049);
