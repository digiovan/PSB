...
//=========  (Wed Apr  1 22:35:36 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-7.939002,1050,-7.62392);
   ...
   gre->SetPoint(0,-700,-7.74032);
   gre->SetPointError(0,0,0.03162749);
   gre->SetPoint(1,-500,-7.86812);
   gre->SetPointError(1,0,0.01836842);
   gre->SetPoint(2,-300,-7.77532);
   gre->SetPointError(2,0,0.03222231);
   gre->SetPoint(3,-100,-7.81042);
   gre->SetPointError(3,0,0.04579536);
   gre->SetPoint(4,100,-7.84138);
   gre->SetPointError(4,0,0.03134082);
   gre->SetPoint(5,300,-7.78022);
   gre->SetPointError(5,0,0.04116563);
   gre->SetPoint(6,500,-7.81602);
   gre->SetPointError(6,0,0.0572195);
   gre->SetPoint(7,700,-7.74232);
   gre->SetPointError(7,0,0.0658867);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-7.907494);
   Graph_Graph30->SetMaximum(-7.655428);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.53688);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.991176e-05);
   linear_fit->SetParError(0,3.037924e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.814197);
   linear_fit->SetParError(1,0.01387674);
