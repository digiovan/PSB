...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,-8.949227,1050,16.31088);
   ...
   gre->SetPoint(0,-700,-4.63998);
   gre->SetPointError(0,0,0.09922863);
   gre->SetPoint(1,-500,-2.94492);
   gre->SetPointError(1,0,0.09652038);
   gre->SetPoint(2,-300,-0.7132);
   gre->SetPointError(2,0,0.2085558);
   gre->SetPoint(3,-100,2.28206);
   gre->SetPointError(3,0,0.317065);
   gre->SetPoint(4,100,4.89752);
   gre->SetPointError(4,0,0.1622252);
   gre->SetPoint(5,300,7.07774);
   gre->SetPointError(5,0,0.124324);
   gre->SetPoint(6,500,9.00716);
   gre->SetPointError(6,0,0.1456772);
   gre->SetPoint(7,700,11.91356);
   gre->SetPointError(7,0,0.187304);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(-6.423216);
   Graph_Graph35->SetMaximum(13.78487);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(42.27466);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01190431);
   linear_fit->SetParError(0,9.981431e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.360276);
   linear_fit->SetParError(1,0.05123838);
