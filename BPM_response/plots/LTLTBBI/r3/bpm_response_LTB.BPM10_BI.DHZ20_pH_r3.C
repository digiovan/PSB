...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,0.6581237,1050,1.832693);
   ...
   gre->SetPoint(0,-700,1.26648);
   gre->SetPointError(0,0,0.1271951);
   gre->SetPoint(1,-500,1.43124);
   gre->SetPointError(1,0,0.09556323);
   gre->SetPoint(2,-300,1.16528);
   gre->SetPointError(2,0,0.3113947);
   gre->SetPoint(3,-100,1.4805);
   gre->SetPointError(3,0,0.1564318);
   gre->SetPoint(4,100,1.5326);
   gre->SetPointError(4,0,0.0628272);
   gre->SetPoint(5,300,1.22656);
   gre->SetPointError(5,0,0.155305);
   gre->SetPoint(6,500,1.33472);
   gre->SetPointError(6,0,0.1742965);
   gre->SetPoint(7,700,1.47654);
   gre->SetPointError(7,0,0.1367044);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.7755806);
   Graph_Graph34->SetMaximum(1.715236);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.567654);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.052466e-05);
   linear_fit->SetParError(0,0.000100296);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.442195);
   linear_fit->SetParError(1,0.04076082);
