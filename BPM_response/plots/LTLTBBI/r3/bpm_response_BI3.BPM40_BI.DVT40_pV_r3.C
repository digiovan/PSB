...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-17.93296,1050,8.773341);
   ...
   gre->SetPoint(0,-700,-12.96056);
   gre->SetPointError(0,0,0.5213462);
   gre->SetPoint(1,-500,-11.38648);
   gre->SetPointError(1,0,0.3060537);
   gre->SetPoint(2,-300,-4.20128);
   gre->SetPointError(2,0,0.470375);
   gre->SetPoint(3,-100,-7.08934);
   gre->SetPointError(3,0,0.2688874);
   gre->SetPoint(4,100,-4.08104);
   gre->SetPointError(4,0,1.08016);
   gre->SetPoint(5,300,1.94856);
   gre->SetPointError(5,0,0.9479763);
   gre->SetPoint(6,500,3.33372);
   gre->SetPointError(6,0,0.6338569);
   gre->SetPoint(7,700,4.01396);
   gre->SetPointError(7,0,0.3083315);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-15.26233);
   Graph_Graph41->SetMaximum(6.102711);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(118.9538);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01250021);
   linear_fit->SetParError(0,0.0003036359);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.546259);
   linear_fit->SetParError(1,0.1451851);
