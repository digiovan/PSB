...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-8.017293,1050,-7.459199);
   ...
   gre->SetPoint(0,-700,-7.77114);
   gre->SetPointError(0,0,0.0494357);
   gre->SetPoint(1,-500,-7.83352);
   gre->SetPointError(1,0,0.09075775);
   gre->SetPoint(2,-300,-7.73096);
   gre->SetPointError(2,0,0.09038434);
   gre->SetPoint(3,-100,-7.60846);
   gre->SetPointError(3,0,0.05624504);
   gre->SetPoint(4,100,-7.80178);
   gre->SetPointError(4,0,0.09636886);
   gre->SetPoint(5,300,-7.8358);
   gre->SetPointError(5,0,0.0770549);
   gre->SetPoint(6,500,-7.68382);
   gre->SetPointError(6,0,0.04499502);
   gre->SetPoint(7,700,-7.73172);
   gre->SetPointError(7,0,0.07704372);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-7.961484);
   Graph_Graph32->SetMaximum(-7.515009);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.34085);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.133083e-05);
   linear_fit->SetParError(0,4.626267e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.727154);
   linear_fit->SetParError(1,0.02289725);
