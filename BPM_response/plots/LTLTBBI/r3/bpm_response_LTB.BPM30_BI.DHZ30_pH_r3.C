...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_3->Range(-1050,0.7370024,1050,0.9195599);
   ...
   gre->SetPoint(0,-700,0.80852);
   gre->SetPointError(0,0,0.003519036);
   gre->SetPoint(1,-500,0.78452);
   gre->SetPointError(1,0,0.008597669);
   gre->SetPoint(2,-300,0.78382);
   gre->SetPointError(2,0,0.01639133);
   gre->SetPoint(3,-100,0.81412);
   gre->SetPointError(3,0,0.01389986);
   gre->SetPoint(4,100,0.86038);
   gre->SetPointError(4,0,0.02875369);
   gre->SetPoint(5,300,0.83058);
   gre->SetPointError(5,0,0.005534173);
   gre->SetPoint(6,500,0.79992);
   gre->SetPointError(6,0,0.004967734);
   gre->SetPoint(7,700,0.82636);
   gre->SetPointError(7,0,0.01071744);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(0.7552582);
   Graph_Graph36->SetMaximum(0.9013042);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(32.41749);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.662845e-06);
   linear_fit->SetParError(0,4.215385e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8106306);
   linear_fit->SetParError(1,0.002406072);
