...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-6.778516,1050,-6.313766);
   ...
   gre->SetPoint(0,-700,-6.44336);
   gre->SetPointError(0,0,0.04792027);
   gre->SetPoint(1,-500,-6.66242);
   gre->SetPointError(1,0,0.03863794);
   gre->SetPoint(2,-300,-6.58144);
   gre->SetPointError(2,0,0.01248613);
   gre->SetPoint(3,-100,-6.65594);
   gre->SetPointError(3,0,0.01527236);
   gre->SetPoint(4,100,-6.50168);
   gre->SetPointError(4,0,0.06483785);
   gre->SetPoint(5,300,-6.53444);
   gre->SetPointError(5,0,0.03622801);
   gre->SetPoint(6,500,-6.62712);
   gre->SetPointError(6,0,0.02260577);
   gre->SetPoint(7,700,-6.45366);
   gre->SetPointError(7,0,0.06243599);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-6.732041);
   Graph_Graph30->SetMaximum(-6.360241);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(40.91551);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.668272e-05);
   linear_fit->SetParError(0,2.564815e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.604193);
   linear_fit->SetParError(1,0.008595278);
