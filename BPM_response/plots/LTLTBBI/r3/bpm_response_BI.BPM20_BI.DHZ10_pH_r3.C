...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,-8.443635,1050,6.132329);
   ...
   gre->SetPoint(0,-700,-6.0018);
   gre->SetPointError(0,0,0.01250774);
   gre->SetPoint(1,-500,-4.64658);
   gre->SetPointError(1,0,0.0443654);
   gre->SetPoint(2,-300,-3.3167);
   gre->SetPointError(2,0,0.08973502);
   gre->SetPoint(3,-100,-1.91096);
   gre->SetPointError(3,0,0.02372944);
   gre->SetPoint(4,100,-0.47648);
   gre->SetPointError(4,0,0.01778418);
   gre->SetPoint(5,300,0.88954);
   gre->SetPointError(5,0,0.04114248);
   gre->SetPoint(6,500,2.29318);
   gre->SetPointError(6,0,0.03735525);
   gre->SetPoint(7,700,3.67284);
   gre->SetPointError(7,0,0.03016153);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-6.986039);
   Graph_Graph39->SetMaximum(4.674732);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.382916);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006905495);
   linear_fit->SetParError(0,1.734861e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.175447);
   linear_fit->SetParError(1,0.009256614);
