...
//=========  (Wed Apr  1 22:35:37 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-13.42351,1050,11.18922);
   ...
   gre->SetPoint(0,-700,6.68492);
   gre->SetPointError(0,0,0.4021798);
   gre->SetPoint(1,-500,5.06646);
   gre->SetPointError(1,0,0.1845919);
   gre->SetPoint(2,-300,3.1927);
   gre->SetPointError(2,0,1.047459);
   gre->SetPoint(3,-100,3.18396);
   gre->SetPointError(3,0,0.4978994);
   gre->SetPoint(4,100,1.90186);
   gre->SetPointError(4,0,0.3880287);
   gre->SetPoint(5,300,-1.05448);
   gre->SetPointError(5,0,0.4406746);
   gre->SetPoint(6,500,-3.5726);
   gre->SetPointError(6,0,0.3769201);
   gre->SetPoint(7,700,-8.0832);
   gre->SetPointError(7,0,1.238189);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-10.96224);
   Graph_Graph41->SetMaximum(8.727949);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(34.40924);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008048612);
   linear_fit->SetParError(0,0.0003152641);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.233384);
   linear_fit->SetParError(1,0.147351);
