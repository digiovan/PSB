...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-5.512171,1050,3.103984);
   ...
   gre->SetPoint(0,-700,-4.06418);
   gre->SetPointError(0,0,0.01196473);
   gre->SetPoint(1,-500,-3.12534);
   gre->SetPointError(1,0,0.05724335);
   gre->SetPoint(2,-300,-2.16406);
   gre->SetPointError(2,0,0.01671295);
   gre->SetPoint(3,-100,-1.33504);
   gre->SetPointError(3,0,0.07134367);
   gre->SetPoint(4,100,-0.47822);
   gre->SetPointError(4,0,0.01453352);
   gre->SetPoint(5,300,0.26848);
   gre->SetPointError(5,0,0.01506354);
   gre->SetPoint(6,500,1.02232);
   gre->SetPointError(6,0,0.03797266);
   gre->SetPoint(7,700,1.64938);
   gre->SetPointError(7,0,0.01857856);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-4.650555);
   Graph_Graph37->SetMaximum(2.242369);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(404.4162);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004178203);
   linear_fit->SetParError(0,1.324771e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.039265);
   linear_fit->SetParError(1,0.006573848);
