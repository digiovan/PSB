...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,-1.209046,1050,10.88142);
   ...
   gre->SetPoint(0,-700,0.57188);
   gre->SetPointError(0,0,0.08295324);
   gre->SetPoint(1,-500,1.7412);
   gre->SetPointError(1,0,0.07800924);
   gre->SetPoint(2,-300,2.85094);
   gre->SetPointError(2,0,0.05616713);
   gre->SetPoint(3,-100,3.88234);
   gre->SetPointError(3,0,0.1107977);
   gre->SetPoint(4,100,5.01836);
   gre->SetPointError(4,0,0.2341277);
   gre->SetPoint(5,300,6.23454);
   gre->SetPointError(5,0,0.0290345);
   gre->SetPoint(6,500,7.52908);
   gre->SetPointError(6,0,0.06478872);
   gre->SetPoint(7,700,8.70778);
   gre->SetPointError(7,0,0.1297309);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(0);
   Graph_Graph35->SetMaximum(9.672369);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.486968);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00572218);
   linear_fit->SetParError(0,5.651892e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.553413);
   linear_fit->SetParError(1,0.02207758);
