...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_3->Range(-1050,-10.47233,1050,12.43486);
   ...
   gre->SetPoint(0,-700,-6.61398);
   gre->SetPointError(0,0,0.04048228);
   gre->SetPoint(1,-500,-4.33278);
   gre->SetPointError(1,0,0.05793242);
   gre->SetPoint(2,-300,-2.1763);
   gre->SetPointError(2,0,0.07751907);
   gre->SetPoint(3,-100,-0.27866);
   gre->SetPointError(3,0,0.04194159);
   gre->SetPoint(4,100,1.77438);
   gre->SetPointError(4,0,0.04676164);
   gre->SetPoint(5,300,4.05246);
   gre->SetPointError(5,0,0.06789595);
   gre->SetPoint(6,500,6.30454);
   gre->SetPointError(6,0,0.02360005);
   gre->SetPoint(7,700,8.54404);
   gre->SetPointError(7,0,0.07295792);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-8.181608);
   Graph_Graph36->SetMaximum(10.14414);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(39.58934);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01075294);
   linear_fit->SetParError(0,3.313934e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8956964);
   linear_fit->SetParError(1,0.01565039);
