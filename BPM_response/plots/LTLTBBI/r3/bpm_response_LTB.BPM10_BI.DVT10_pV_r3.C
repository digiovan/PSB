...
//=========  (Wed Apr  1 22:35:52 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,0.8234501,1050,1.065667);
   ...
   gre->SetPoint(0,-700,0.9102);
   gre->SetPointError(0,0,0.04638049);
   gre->SetPoint(1,-500,0.912);
   gre->SetPointError(1,0,0.04444907);
   gre->SetPoint(2,-300,0.93404);
   gre->SetPointError(2,0,0.05106138);
   gre->SetPoint(3,-100,0.94602);
   gre->SetPointError(3,0,0.03435737);
   gre->SetPoint(4,100,0.9201);
   gre->SetPointError(4,0,0.02651713);
   gre->SetPoint(5,300,0.98222);
   gre->SetPointError(5,0,0.007470631);
   gre->SetPoint(6,500,0.97442);
   gre->SetPointError(6,0,0.05087731);
   gre->SetPoint(7,700,0.94372);
   gre->SetPointError(7,0,0.02842245);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.8476717);
   Graph_Graph34->SetMaximum(1.041445);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.502889);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.526133e-05);
   linear_fit->SetParError(0,2.799843e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.957285);
   linear_fit->SetParError(1,0.009606694);
