...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.764619,1050,2.124053);
   ...
   gre->SetPoint(0,-700,1.90926);
   gre->SetPointError(0,0,0.01230899);
   gre->SetPoint(1,-500,2.03502);
   gre->SetPointError(1,0,0.0291271);
   gre->SetPoint(2,-300,1.94886);
   gre->SetPointError(2,0,0.03694314);
   gre->SetPoint(3,-100,2.01174);
   gre->SetPointError(3,0,0.01352075);
   gre->SetPoint(4,100,1.96896);
   gre->SetPointError(4,0,0.01560331);
   gre->SetPoint(5,300,1.85094);
   gre->SetPointError(5,0,0.02641575);
   gre->SetPoint(6,500,1.99634);
   gre->SetPointError(6,0,0.03431069);
   gre->SetPoint(7,700,1.89118);
   gre->SetPointError(7,0,0.01063384);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.800562);
   Graph_Graph29->SetMaximum(2.088109);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(75.55157);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.082748e-05);
   linear_fit->SetParError(0,1.098293e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.938668);
   linear_fit->SetParError(1,0.005876924);
