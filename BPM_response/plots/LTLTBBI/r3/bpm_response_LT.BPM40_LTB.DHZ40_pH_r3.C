...
//=========  (Wed Apr  1 22:35:36 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_3->Range(-1050,-0.3725219,1050,-0.297135);
   ...
   gre->SetPoint(0,-700,-0.35522);
   gre->SetPointError(0,0,0.004259387);
   gre->SetPoint(1,-500,-0.33236);
   gre->SetPointError(1,0,0.006671942);
   gre->SetPoint(2,-300,-0.34038);
   gre->SetPointError(2,0,0.007111847);
   gre->SetPoint(3,-100,-0.353);
   gre->SetPointError(3,0,0.005218163);
   gre->SetPoint(4,100,-0.33256);
   gre->SetPointError(4,0,0.02286054);
   gre->SetPoint(5,300,-0.3428);
   gre->SetPointError(5,0,0.002902264);
   gre->SetPoint(6,500,-0.3478);
   gre->SetPointError(6,0,0.003746587);
   gre->SetPoint(7,700,-0.35332);
   gre->SetPointError(7,0,0.006637378);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-0.3649832);
   Graph_Graph32->SetMaximum(-0.3046737);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.82558);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.077556e-06);
   linear_fit->SetParError(0,3.722237e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3468446);
   linear_fit->SetParError(1,0.001719556);
