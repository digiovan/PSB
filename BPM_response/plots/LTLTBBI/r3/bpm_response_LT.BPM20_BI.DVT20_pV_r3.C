...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-6.777971,1050,-6.314679);
   ...
   gre->SetPoint(0,-700,-6.52244);
   gre->SetPointError(0,0,0.02155172);
   gre->SetPoint(1,-500,-6.55956);
   gre->SetPointError(1,0,0.08602162);
   gre->SetPoint(2,-300,-6.61596);
   gre->SetPointError(2,0,0.03164541);
   gre->SetPoint(3,-100,-6.58704);
   gre->SetPointError(3,0,0.03359066);
   gre->SetPoint(4,100,-6.61026);
   gre->SetPointError(4,0,0.04443157);
   gre->SetPoint(5,300,-6.64292);
   gre->SetPointError(5,0,0.0578357);
   gre->SetPoint(6,500,-6.42688);
   gre->SetPointError(6,0,0.03498552);
   gre->SetPoint(7,700,-6.60436);
   gre->SetPointError(7,0,0.03002572);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-6.731642);
   Graph_Graph30->SetMaximum(-6.361008);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.42289);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.391897e-05);
   linear_fit->SetParError(0,2.289142e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.559781);
   linear_fit->SetParError(1,0.01221875);
