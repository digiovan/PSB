...
//=========  (Wed Apr  1 22:35:51 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-10.97715,1050,-10.45699);
   ...
   gre->SetPoint(0,-700,-10.68158);
   gre->SetPointError(0,0,0.1379001);
   gre->SetPoint(1,-500,-10.83744);
   gre->SetPointError(1,0,0.04422175);
   gre->SetPoint(2,-300,-10.73616);
   gre->SetPointError(2,0,0.06266912);
   gre->SetPoint(3,-100,-10.74158);
   gre->SetPointError(3,0,0.09703049);
   gre->SetPoint(4,100,-10.72132);
   gre->SetPointError(4,0,0.04904433);
   gre->SetPoint(5,300,-10.87206);
   gre->SetPointError(5,0,0.01839232);
   gre->SetPoint(6,500,-10.73834);
   gre->SetPointError(6,0,0.1336966);
   gre->SetPoint(7,700,-10.68464);
   gre->SetPointError(7,0,0.04866368);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: BI.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-10.92513);
   Graph_Graph31->SetMaximum(-10.509);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.6415);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.720529e-06);
   linear_fit->SetParError(0,4.431236e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.82361);
   linear_fit->SetParError(1,0.01658278);
