...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,-3.416502,1050,6.183399);
   ...
   gre->SetPoint(0,-700,-1.35566);
   gre->SetPointError(0,0,0.07451021);
   gre->SetPoint(1,-500,-1.61814);
   gre->SetPointError(1,0,0.1983787);
   gre->SetPoint(2,-300,0.30426);
   gre->SetPointError(2,0,0.1242446);
   gre->SetPoint(3,-100,0.20526);
   gre->SetPointError(3,0,0.09462101);
   gre->SetPoint(4,100,1.1495);
   gre->SetPointError(4,0,0.2319161);
   gre->SetPoint(5,300,3.0551);
   gre->SetPointError(5,0,0.1949825);
   gre->SetPoint(6,500,2.69178);
   gre->SetPointError(6,0,0.2060231);
   gre->SetPoint(7,700,4.48672);
   gre->SetPointError(7,0,0.09669514);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-2.456512);
   Graph_Graph34->SetMaximum(5.223409);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(116.3659);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004120592);
   linear_fit->SetParError(0,8.088485e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.261435);
   linear_fit->SetParError(1,0.04366005);
