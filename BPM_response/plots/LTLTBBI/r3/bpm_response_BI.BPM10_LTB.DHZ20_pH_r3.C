...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_3->Range(-1050,-11.71907,1050,2.822533);
   ...
   gre->SetPoint(0,-700,-9.19532);
   gre->SetPointError(0,0,0.1001512);
   gre->SetPoint(1,-500,-7.61896);
   gre->SetPointError(1,0,0.1265528);
   gre->SetPoint(2,-300,-6.17198);
   gre->SetPointError(2,0,0.1417381);
   gre->SetPoint(3,-100,-4.98598);
   gre->SetPointError(3,0,0.04298402);
   gre->SetPoint(4,100,-3.71876);
   gre->SetPointError(4,0,0.1359179);
   gre->SetPoint(5,300,-2.39642);
   gre->SetPointError(5,0,0.1625405);
   gre->SetPoint(6,500,-1.14006);
   gre->SetPointError(6,0,0.1232494);
   gre->SetPoint(7,700,0.16922);
   gre->SetPointError(7,0,0.2297117);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-10.26491);
   Graph_Graph38->SetMaximum(1.368372);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.073182);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006656492);
   linear_fit->SetParError(0,0.0001044234);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.354306);
   linear_fit->SetParError(1,0.03492922);
