...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,-1.432461,1050,17.85096);
   ...
   gre->SetPoint(0,-700,14.61326);
   gre->SetPointError(0,0,0.02379374);
   gre->SetPoint(1,-500,12.64722);
   gre->SetPointError(1,0,0.04784649);
   gre->SetPoint(2,-300,10.84574);
   gre->SetPointError(2,0,0.03517818);
   gre->SetPoint(3,-100,9.25108);
   gre->SetPointError(3,0,0.01478821);
   gre->SetPoint(4,100,7.53762);
   gre->SetPointError(4,0,0.03949717);
   gre->SetPoint(5,300,5.6126);
   gre->SetPointError(5,0,0.02598842);
   gre->SetPoint(6,500,3.7139);
   gre->SetPointError(6,0,0.01287542);
   gre->SetPoint(7,700,1.82096);
   gre->SetPointError(7,0,0.03951778);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(0.4958811);
   Graph_Graph39->SetMaximum(15.92261);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(85.53473);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009085275);
   linear_fit->SetParError(0,1.872242e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.281285);
   linear_fit->SetParError(1,0.008085586);
