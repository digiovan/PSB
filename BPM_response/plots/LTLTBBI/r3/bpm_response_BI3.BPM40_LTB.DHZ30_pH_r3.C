...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-22.8642,1050,15.65666);
   ...
   gre->SetPoint(0,-700,9.04314);
   gre->SetPointError(0,0,0.193375);
   gre->SetPoint(1,-500,3.3245);
   gre->SetPointError(1,0,0.5803118);
   gre->SetPoint(2,-300,5.23104);
   gre->SetPointError(2,0,0.7663401);
   gre->SetPoint(3,-100,3.7569);
   gre->SetPointError(3,0,0.4344859);
   gre->SetPoint(4,100,0.23772);
   gre->SetPointError(4,0,0.9704371);
   gre->SetPoint(5,300,-7.54316);
   gre->SetPointError(5,0,1.094909);
   gre->SetPoint(6,500,-10.5202);
   gre->SetPointError(6,0,0.5771121);
   gre->SetPoint(7,700,-15.09664);
   gre->SetPointError(7,0,1.347416);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-19.01211);
   Graph_Graph41->SetMaximum(11.80457);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(125.2178);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01465415);
   linear_fit->SetParError(0,0.0003894083);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.040772);
   linear_fit->SetParError(1,0.2334952);
