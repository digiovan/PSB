...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-5.400421,1050,1.820446);
   ...
   gre->SetPoint(0,-700,-3.5194);
   gre->SetPointError(0,0,0.6775428);
   gre->SetPoint(1,-500,-1.80978);
   gre->SetPointError(1,0,0.2218722);
   gre->SetPoint(2,-300,-1.33326);
   gre->SetPointError(2,0,0.1731294);
   gre->SetPoint(3,-100,-0.74012);
   gre->SetPointError(3,0,0.158213);
   gre->SetPoint(4,100,-0.79884);
   gre->SetPointError(4,0,0.4730484);
   gre->SetPoint(5,300,-0.15924);
   gre->SetPointError(5,0,0.1124839);
   gre->SetPoint(6,500,0.53962);
   gre->SetPointError(6,0,0.07734839);
   gre->SetPoint(7,700,-0.3296);
   gre->SetPointError(7,0,0.4147319);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-4.678334);
   Graph_Graph40->SetMaximum(1.09836);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.20456);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002258758);
   linear_fit->SetParError(0,0.0001575441);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.68376);
   linear_fit->SetParError(1,0.06574179);
