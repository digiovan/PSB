...
//=========  (Wed Apr  1 22:35:26 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,4.06496,1050,4.968949);
   ...
   gre->SetPoint(0,-700,4.6531);
   gre->SetPointError(0,0,0.08121896);
   gre->SetPoint(1,-500,4.52068);
   gre->SetPointError(1,0,0.08594709);
   gre->SetPoint(2,-300,4.7115);
   gre->SetPointError(2,0,0.07384731);
   gre->SetPoint(3,-100,4.53306);
   gre->SetPointError(3,0,0.02098604);
   gre->SetPoint(4,100,4.39672);
   gre->SetPointError(4,0,0.0403153);
   gre->SetPoint(5,300,4.72732);
   gre->SetPointError(5,0,0.09096436);
   gre->SetPoint(6,500,4.43272);
   gre->SetPointError(6,0,0.2170949);
   gre->SetPoint(7,700,4.5833);
   gre->SetPointError(7,0,0.1935668);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(4.155359);
   Graph_Graph35->SetMaximum(4.87855);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.39804);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001598066);
   linear_fit->SetParError(0,8.109035e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.514762);
   linear_fit->SetParError(1,0.01846361);
