...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,-9.561318,1050,16.76113);
   ...
   gre->SetPoint(0,-700,-5.07546);
   gre->SetPointError(0,0,0.09878272);
   gre->SetPoint(1,-500,-3.04226);
   gre->SetPointError(1,0,0.1393926);
   gre->SetPoint(2,-300,0.23328);
   gre->SetPointError(2,0,0.2247376);
   gre->SetPoint(3,-100,1.88876);
   gre->SetPointError(3,0,0.2179278);
   gre->SetPoint(4,100,5.08826);
   gre->SetPointError(4,0,0.3277922);
   gre->SetPoint(5,300,7.07376);
   gre->SetPointError(5,0,0.1195108);
   gre->SetPoint(6,500,9.33378);
   gre->SetPointError(6,0,0.08290206);
   gre->SetPoint(7,700,12.2521);
   gre->SetPointError(7,0,0.1219579);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(-6.929073);
   Graph_Graph35->SetMaximum(14.12889);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.40089);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01224035);
   linear_fit->SetParError(0,8.509756e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.386219);
   linear_fit->SetParError(1,0.0457614);
