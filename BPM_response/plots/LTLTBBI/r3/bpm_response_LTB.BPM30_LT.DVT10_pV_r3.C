...
//=========  (Wed Apr  1 22:34:18 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,-4.81894,1050,8.793027);
   ...
   gre->SetPoint(0,-700,-2.36904);
   gre->SetPointError(0,0,0.1812384);
   gre->SetPoint(1,-500,-0.35208);
   gre->SetPointError(1,0,0.1319252);
   gre->SetPoint(2,-300,0.85768);
   gre->SetPointError(2,0,0.01145829);
   gre->SetPoint(3,-100,2.00716);
   gre->SetPointError(3,0,0.08611335);
   gre->SetPoint(4,100,3.28798);
   gre->SetPointError(4,0,0.03960803);
   gre->SetPoint(5,300,4.55894);
   gre->SetPointError(5,0,0.02711624);
   gre->SetPoint(6,500,5.90096);
   gre->SetPointError(6,0,0.05373504);
   gre->SetPoint(7,700,6.49948);
   gre->SetPointError(7,0,0.0248862);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LT.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-3.457743);
   Graph_Graph36->SetMaximum(7.431831);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(191.7824);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005811853);
   linear_fit->SetParError(0,2.429071e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.617206);
   linear_fit->SetParError(1,0.009281985);
