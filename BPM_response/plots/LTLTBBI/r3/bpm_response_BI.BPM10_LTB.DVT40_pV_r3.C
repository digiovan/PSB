...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,-10.63683,1050,17.57688);
   ...
   gre->SetPoint(0,-700,-5.71384);
   gre->SetPointError(0,0,0.2207074);
   gre->SetPoint(1,-500,-3.04996);
   gre->SetPointError(1,0,0.169838);
   gre->SetPoint(2,-300,-0.27662);
   gre->SetPointError(2,0,0.03371904);
   gre->SetPoint(3,-100,2.30008);
   gre->SetPointError(3,0,0.09948846);
   gre->SetPoint(4,100,4.72534);
   gre->SetPointError(4,0,0.0873718);
   gre->SetPoint(5,300,7.3927);
   gre->SetPointError(5,0,0.05762772);
   gre->SetPoint(6,500,9.93924);
   gre->SetPointError(6,0,0.09564259);
   gre->SetPoint(7,700,12.83496);
   gre->SetPointError(7,0,0.03963358);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(-7.815461);
   Graph_Graph38->SetMaximum(14.75551);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.8432);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01308354);
   linear_fit->SetParError(0,4.842491e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.599654);
   linear_fit->SetParError(1,0.02223103);
