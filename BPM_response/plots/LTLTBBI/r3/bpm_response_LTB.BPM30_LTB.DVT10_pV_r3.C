...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,-12.47591,1050,16.85991);
   ...
   gre->SetPoint(0,-700,-7.50666);
   gre->SetPointError(0,0,0.07994246);
   gre->SetPoint(1,-500,-4.45456);
   gre->SetPointError(1,0,0.03921203);
   gre->SetPoint(2,-300,-1.40644);
   gre->SetPointError(2,0,0.08058785);
   gre->SetPoint(3,-100,1.56888);
   gre->SetPointError(3,0,0.07400506);
   gre->SetPoint(4,100,4.20698);
   gre->SetPointError(4,0,0.07201242);
   gre->SetPoint(5,300,6.59498);
   gre->SetPointError(5,0,0.1156713);
   gre->SetPoint(6,500,9.36826);
   gre->SetPointError(6,0,0.07583508);
   gre->SetPoint(7,700,11.88106);
   gre->SetPointError(7,0,0.0895475);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-9.542323);
   Graph_Graph36->SetMaximum(13.92633);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(93.6355);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01387096);
   linear_fit->SetParError(0,5.579201e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.539587);
   linear_fit->SetParError(1,0.02589158);
