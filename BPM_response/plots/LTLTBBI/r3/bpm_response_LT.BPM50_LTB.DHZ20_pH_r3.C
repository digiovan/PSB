...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_3->Range(-1050,-1.767886,1050,-1.665932);
   ...
   gre->SetPoint(0,-700,-1.70238);
   gre->SetPointError(0,0,0.01945592);
   gre->SetPoint(1,-500,-1.71406);
   gre->SetPointError(1,0,0.0194032);
   gre->SetPoint(2,-300,-1.70994);
   gre->SetPointError(2,0,0.01316077);
   gre->SetPoint(3,-100,-1.71404);
   gre->SetPointError(3,0,0.004284238);
   gre->SetPoint(4,100,-1.71526);
   gre->SetPointError(4,0,0.02164294);
   gre->SetPoint(5,300,-1.71136);
   gre->SetPointError(5,0,0.01555288);
   gre->SetPoint(6,500,-1.72366);
   gre->SetPointError(6,0,0.01370504);
   gre->SetPoint(7,700,-1.73132);
   gre->SetPointError(7,0,0.01957392);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-1.757691);
   Graph_Graph33->SetMaximum(-1.676127);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(0.5091918);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.463241e-05);
   linear_fit->SetParError(0,1.315118e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.715269);
   linear_fit->SetParError(1,0.003614986);
