...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,-5.642035,1050,11.02361);
   ...
   gre->SetPoint(0,-700,8.22092);
   gre->SetPointError(0,0,0.02508428);
   gre->SetPoint(1,-500,6.71208);
   gre->SetPointError(1,0,0.155808);
   gre->SetPoint(2,-300,4.84866);
   gre->SetPointError(2,0,0.0488947);
   gre->SetPoint(3,-100,3.2196);
   gre->SetPointError(3,0,0.1645732);
   gre->SetPoint(4,100,1.58328);
   gre->SetPointError(4,0,0.05721794);
   gre->SetPoint(5,300,0.12236);
   gre->SetPointError(5,0,0.02445956);
   gre->SetPoint(6,500,-1.29254);
   gre->SetPointError(6,0,0.02546204);
   gre->SetPoint(7,700,-2.82524);
   gre->SetPointError(7,0,0.03918724);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(-3.97547);
   Graph_Graph35->SetMaximum(9.357047);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(66.73991);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007935002);
   linear_fit->SetParError(0,2.464974e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.603068);
   linear_fit->SetParError(1,0.01279341);
