...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,0.8425145,1050,2.113985);
   ...
   gre->SetPoint(0,-700,1.34556);
   gre->SetPointError(0,0,0.06229201);
   gre->SetPoint(1,-500,1.3324);
   gre->SetPointError(1,0,0.07441683);
   gre->SetPoint(2,-300,1.39272);
   gre->SetPointError(2,0,0.3230597);
   gre->SetPoint(3,-100,1.14286);
   gre->SetPointError(3,0,0.08843376);
   gre->SetPoint(4,100,1.48268);
   gre->SetPointError(4,0,0.2303214);
   gre->SetPoint(5,300,1.79226);
   gre->SetPointError(5,0,0.1098133);
   gre->SetPoint(6,500,1.34988);
   gre->SetPointError(6,0,0.02407256);
   gre->SetPoint(7,700,1.42714);
   gre->SetPointError(7,0,0.05431335);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.9696615);
   Graph_Graph34->SetMaximum(1.986838);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.61382);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.55344e-05);
   linear_fit->SetParError(0,4.380698e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.348704);
   linear_fit->SetParError(1,0.02334488);
