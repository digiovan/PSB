...
//=========  (Wed Apr  1 22:35:36 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,3.983083,1050,4.940285);
   ...
   gre->SetPoint(0,-700,4.63218);
   gre->SetPointError(0,0,0.1048378);
   gre->SetPoint(1,-500,4.39832);
   gre->SetPointError(1,0,0.0670768);
   gre->SetPoint(2,-300,4.67388);
   gre->SetPointError(2,0,0.1068715);
   gre->SetPoint(3,-100,4.42922);
   gre->SetPointError(3,0,0.0521624);
   gre->SetPoint(4,100,4.39038);
   gre->SetPointError(4,0,0.07455681);
   gre->SetPoint(5,300,4.5026);
   gre->SetPointError(5,0,0.05580597);
   gre->SetPoint(6,500,4.30646);
   gre->SetPointError(6,0,0.1638435);
   gre->SetPoint(7,700,4.60092);
   gre->SetPointError(7,0,0.1604364);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LTB.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(4.078803);
   Graph_Graph35->SetMaximum(4.844565);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.81687);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.51451e-05);
   linear_fit->SetParError(0,7.755389e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.466189);
   linear_fit->SetParError(1,0.02762829);
