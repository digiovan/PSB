...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-13.63116,1050,11.33775);
   ...
   gre->SetPoint(0,-700,-9.37604);
   gre->SetPointError(0,0,0.09363109);
   gre->SetPoint(1,-500,-7.13724);
   gre->SetPointError(1,0,0.08724497);
   gre->SetPoint(2,-300,-5.31594);
   gre->SetPointError(2,0,0.2026052);
   gre->SetPoint(3,-100,-2.202);
   gre->SetPointError(3,0,0.3079024);
   gre->SetPoint(4,100,-1.22858);
   gre->SetPointError(4,0,0.3713436);
   gre->SetPoint(5,300,1.06374);
   gre->SetPointError(5,0,0.3184337);
   gre->SetPoint(6,500,3.84762);
   gre->SetPointError(6,0,0.2476499);
   gre->SetPoint(7,700,6.48522);
   gre->SetPointError(7,0,0.6910474);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-11.13426);
   Graph_Graph40->SetMaximum(8.840861);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.39291);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01086623);
   linear_fit->SetParError(0,0.0001702116);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.754683);
   linear_fit->SetParError(1,0.09437167);
