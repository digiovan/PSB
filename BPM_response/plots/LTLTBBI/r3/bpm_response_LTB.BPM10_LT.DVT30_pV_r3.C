...
//=========  (Wed Apr  1 22:34:39 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,0.02234403,1050,2.773804);
   ...
   gre->SetPoint(0,-700,2.29538);
   gre->SetPointError(0,0,0.01984718);
   gre->SetPoint(1,-500,1.6184);
   gre->SetPointError(1,0,0.07121999);
   gre->SetPoint(2,-300,1.4335);
   gre->SetPointError(2,0,0.01315546);
   gre->SetPoint(3,-100,1.24828);
   gre->SetPointError(3,0,0.01460022);
   gre->SetPoint(4,100,1.0158);
   gre->SetPointError(4,0,0.09252548);
   gre->SetPoint(5,300,0.84866);
   gre->SetPointError(5,0,0.03860324);
   gre->SetPoint(6,500,0.57264);
   gre->SetPointError(6,0,0.02666499);
   gre->SetPoint(7,700,0.50828);
   gre->SetPointError(7,0,0.02735932);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LT.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.29749);
   Graph_Graph34->SetMaximum(2.498658);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(310.3921);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001238793);
   linear_fit->SetParError(0,1.949332e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.177095);
   linear_fit->SetParError(1,0.008153624);
