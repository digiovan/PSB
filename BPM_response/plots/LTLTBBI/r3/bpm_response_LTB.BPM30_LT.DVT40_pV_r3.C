...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_3->Range(-1050,-2.557328,1050,8.276001);
   ...
   gre->SetPoint(0,-700,6.44174);
   gre->SetPointError(0,0,0.02870629);
   gre->SetPoint(1,-500,5.29392);
   gre->SetPointError(1,0,0.06089668);
   gre->SetPoint(2,-300,4.07794);
   gre->SetPointError(2,0,0.03248515);
   gre->SetPoint(3,-100,3.28292);
   gre->SetPointError(3,0,0.03051969);
   gre->SetPoint(4,100,2.04942);
   gre->SetPointError(4,0,0.1366023);
   gre->SetPoint(5,300,1.17788);
   gre->SetPointError(5,0,0.03436291);
   gre->SetPoint(6,500,0.17278);
   gre->SetPointError(6,0,0.1088263);
   gre->SetPoint(7,700,-0.59174);
   gre->SetPointError(7,0,0.1600333);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph36->SetMinimum(-1.473995);
   Graph_Graph36->SetMaximum(7.192668);
   Graph_Graph36->SetDirectory(0);
   Graph_Graph36->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph36->SetLineColor(ci);
   Graph_Graph36->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.66581);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005207626);
   linear_fit->SetParError(0,3.974657e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.711857);
   linear_fit->SetParError(1,0.01747224);
