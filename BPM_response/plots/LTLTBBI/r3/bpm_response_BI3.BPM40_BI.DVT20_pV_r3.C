...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-19.11219,1050,9.055168);
   ...
   gre->SetPoint(0,-700,4.02316);
   gre->SetPointError(0,0,0.3374489);
   gre->SetPoint(1,-500,0.98624);
   gre->SetPointError(1,0,0.426651);
   gre->SetPoint(2,-300,-1.0587);
   gre->SetPointError(2,0,0.8962786);
   gre->SetPoint(3,-100,-4.55954);
   gre->SetPointError(3,0,0.406667);
   gre->SetPoint(4,100,-6.26748);
   gre->SetPointError(4,0,1.082);
   gre->SetPoint(5,300,-7.39912);
   gre->SetPointError(5,0,1.196327);
   gre->SetPoint(6,500,-9.438);
   gre->SetPointError(6,0,0.6560318);
   gre->SetPoint(7,700,-13.53168);
   gre->SetPointError(7,0,0.8859471);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-16.29545);
   Graph_Graph41->SetMaximum(6.238432);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.62649);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01199541);
   linear_fit->SetParError(0,0.0004469023);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.793895);
   linear_fit->SetParError(1,0.2307943);
