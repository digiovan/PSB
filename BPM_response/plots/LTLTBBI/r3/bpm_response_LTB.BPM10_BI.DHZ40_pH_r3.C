...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,0.9240642,1050,1.82973);
   ...
   gre->SetPoint(0,-700,1.37302);
   gre->SetPointError(0,0,0.2453901);
   gre->SetPoint(1,-500,1.47054);
   gre->SetPointError(1,0,0.116543);
   gre->SetPoint(2,-300,1.44554);
   gre->SetPointError(2,0,0.1287123);
   gre->SetPoint(3,-100,1.25842);
   gre->SetPointError(3,0,0.1834115);
   gre->SetPoint(4,100,1.53938);
   gre->SetPointError(4,0,0.1394054);
   gre->SetPoint(5,300,1.34668);
   gre->SetPointError(5,0,0.05916404);
   gre->SetPoint(6,500,1.31138);
   gre->SetPointError(6,0,0.1722132);
   gre->SetPoint(7,700,1.48888);
   gre->SetPointError(7,0,0.08871285);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(1.014631);
   Graph_Graph34->SetMaximum(1.739163);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.155611);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.49682e-06);
   linear_fit->SetParError(0,9.742347e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.406611);
   linear_fit->SetParError(1,0.04251939);
