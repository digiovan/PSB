...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-20.70827,1050,-1.078074);
   ...
   gre->SetPoint(0,-700,-17.40278);
   gre->SetPointError(0,0,0.03379274);
   gre->SetPoint(1,-500,-15.5325);
   gre->SetPointError(1,0,0.2037806);
   gre->SetPoint(2,-300,-13.5458);
   gre->SetPointError(2,0,0.07055285);
   gre->SetPoint(3,-100,-11.77378);
   gre->SetPointError(3,0,0.2078479);
   gre->SetPoint(4,100,-9.8644);
   gre->SetPointError(4,0,0.07884493);
   gre->SetPoint(5,300,-8.19406);
   gre->SetPointError(5,0,0.06765845);
   gre->SetPoint(6,500,-6.37432);
   gre->SetPointError(6,0,0.03142022);
   gre->SetPoint(7,700,-4.42372);
   gre->SetPointError(7,0,0.073946);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-18.74525);
   Graph_Graph31->SetMaximum(-3.041094);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.51947);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00919779);
   linear_fit->SetParError(0,3.498048e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.93466);
   linear_fit->SetParError(1,0.01925229);
