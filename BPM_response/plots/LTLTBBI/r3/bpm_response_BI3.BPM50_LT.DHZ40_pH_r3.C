...
//=========  (Wed Apr  1 22:34:45 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-6.112473,1050,8.457103);
   ...
   gre->SetPoint(0,-700,4.27872);
   gre->SetPointError(0,0,0.0893215);
   gre->SetPoint(1,-500,4.78548);
   gre->SetPointError(1,0,0.3048068);
   gre->SetPoint(2,-300,1.68918);
   gre->SetPointError(2,0,0.3117723);
   gre->SetPoint(3,-100,5.69074);
   gre->SetPointError(3,0,0.3381007);
   gre->SetPoint(4,100,5.69282);
   gre->SetPointError(4,0,0.329208);
   gre->SetPoint(5,300,-0.38702);
   gre->SetPointError(5,0,0.4210981);
   gre->SetPoint(6,500,3.58918);
   gre->SetPointError(6,0,0.4207461);
   gre->SetPoint(7,700,-3.32844);
   gre->SetPointError(7,0,0.35577);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-4.655515);
   Graph_Graph42->SetMaximum(7.000146);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(402.8003);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002841456);
   linear_fit->SetParError(0,0.0001807561);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.476665);
   linear_fit->SetParError(1,0.112422);
