...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_3->Range(-1050,1.767116,1050,2.007712);
   ...
   gre->SetPoint(0,-700,1.894);
   gre->SetPointError(0,0,0.01035311);
   gre->SetPoint(1,-500,1.90654);
   gre->SetPointError(1,0,0.01162476);
   gre->SetPoint(2,-300,1.87988);
   gre->SetPointError(2,0,0.05148842);
   gre->SetPoint(3,-100,1.94784);
   gre->SetPointError(3,0,0.01977255);
   gre->SetPoint(4,100,1.90572);
   gre->SetPointError(4,0,0.02247861);
   gre->SetPoint(5,300,1.8249);
   gre->SetPointError(5,0,0.01768446);
   gre->SetPoint(6,500,1.87978);
   gre->SetPointError(6,0,0.008644567);
   gre->SetPoint(7,700,1.9034);
   gre->SetPointError(7,0,0.004881334);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(1.791176);
   Graph_Graph29->SetMaximum(1.983652);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(29.92246);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.437807e-07);
   linear_fit->SetParError(0,6.763916e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.897169);
   linear_fit->SetParError(1,0.004184978);
