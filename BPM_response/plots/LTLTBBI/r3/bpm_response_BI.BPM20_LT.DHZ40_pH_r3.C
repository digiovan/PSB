...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,5.306246,1050,9.454575);
   ...
   gre->SetPoint(0,-700,8.37004);
   gre->SetPointError(0,0,0.07387621);
   gre->SetPoint(1,-500,8.74312);
   gre->SetPointError(1,0,0.02006718);
   gre->SetPoint(2,-300,8.45824);
   gre->SetPointError(2,0,0.02441972);
   gre->SetPoint(3,-100,8.59946);
   gre->SetPointError(3,0,0.01702334);
   gre->SetPoint(4,100,8.61728);
   gre->SetPointError(4,0,0.01217197);
   gre->SetPoint(5,300,8.4406);
   gre->SetPointError(5,0,0.05346928);
   gre->SetPoint(6,500,6.91112);
   gre->SetPointError(6,0,0.9134858);
   gre->SetPoint(7,700,8.43788);
   gre->SetPointError(7,0,0.03488248);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(5.721079);
   Graph_Graph39->SetMaximum(9.039742);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(107.2219);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001303652);
   linear_fit->SetParError(0,2.720947e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.592803);
   linear_fit->SetParError(1,0.008115142);
