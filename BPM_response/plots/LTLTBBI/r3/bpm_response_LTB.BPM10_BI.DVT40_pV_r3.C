...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_3->Range(-1050,0.6078641,1050,1.115659);
   ...
   gre->SetPoint(0,-700,0.90854);
   gre->SetPointError(0,0,0.03234395);
   gre->SetPoint(1,-500,0.9871);
   gre->SetPointError(1,0,0.02646891);
   gre->SetPoint(2,-300,0.71752);
   gre->SetPointError(2,0,0.02502338);
   gre->SetPoint(3,-100,0.93926);
   gre->SetPointError(3,0,0.01927273);
   gre->SetPoint(4,100,0.91206);
   gre->SetPointError(4,0,0.04155311);
   gre->SetPoint(5,300,0.77534);
   gre->SetPointError(5,0,0.02434519);
   gre->SetPoint(6,500,0.95758);
   gre->SetPointError(6,0,0.07344677);
   gre->SetPoint(7,700,0.9037);
   gre->SetPointError(7,0,0.03073668);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(0.6586436);
   Graph_Graph34->SetMaximum(1.06488);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(87.04317);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.768375e-05);
   linear_fit->SetParError(0,2.450199e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8735206);
   linear_fit->SetParError(1,0.01006577);
