...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,1.853009,1050,2.724878);
   ...
   gre->SetPoint(0,-700,2.18546);
   gre->SetPointError(0,0,0.1871394);
   gre->SetPoint(1,-500,2.42172);
   gre->SetPointError(1,0,0.05106406);
   gre->SetPoint(2,-300,2.39468);
   gre->SetPointError(2,0,0.06261378);
   gre->SetPoint(3,-100,2.52678);
   gre->SetPointError(3,0,0.05278635);
   gre->SetPoint(4,100,2.28424);
   gre->SetPointError(4,0,0.06363532);
   gre->SetPoint(5,300,2.43396);
   gre->SetPointError(5,0,0.05541152);
   gre->SetPoint(6,500,2.48004);
   gre->SetPointError(6,0,0.03151181);
   gre->SetPoint(7,700,2.16552);
   gre->SetPointError(7,0,0.0724122);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(1.940196);
   Graph_Graph35->SetMaximum(2.637691);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.34731);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.039433e-05);
   linear_fit->SetParError(0,4.73698e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.424757);
   linear_fit->SetParError(1,0.02029698);
