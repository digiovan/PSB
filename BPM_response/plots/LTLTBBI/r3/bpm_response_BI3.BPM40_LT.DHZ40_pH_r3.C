...
//=========  (Wed Apr  1 22:34:44 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_H_3->Range(-1050,-4.786056,1050,10.78998);
   ...
   gre->SetPoint(0,-700,4.46152);
   gre->SetPointError(0,0,0.2631958);
   gre->SetPoint(1,-500,7.23486);
   gre->SetPointError(1,0,0.2715553);
   gre->SetPoint(2,-300,2.83012);
   gre->SetPointError(2,0,0.5981542);
   gre->SetPoint(3,-100,7.9633);
   gre->SetPointError(3,0,0.2306707);
   gre->SetPoint(4,100,7.60316);
   gre->SetPointError(4,0,0.2443942);
   gre->SetPoint(5,300,1.38644);
   gre->SetPointError(5,0,0.576459);
   gre->SetPoint(6,500,4.1017);
   gre->SetPointError(6,0,0.5937196);
   gre->SetPoint(7,700,-1.8291);
   gre->SetPointError(7,0,0.3609504);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LT.DHZ40 Plane: H Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-3.228453);
   Graph_Graph41->SetMaximum(9.232373);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(598.7914);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003030021);
   linear_fit->SetParError(0,0.000262615);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,5.236591);
   linear_fit->SetParError(1,0.1168619);
