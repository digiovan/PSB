...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_3->Range(-1050,3.125987,1050,4.138841);
   ...
   gre->SetPoint(0,-700,3.53088);
   gre->SetPointError(0,0,0.0414173);
   gre->SetPoint(1,-500,3.49296);
   gre->SetPointError(1,0,0.06275308);
   gre->SetPoint(2,-300,3.54858);
   gre->SetPointError(2,0,0.2537843);
   gre->SetPoint(3,-100,3.3903);
   gre->SetPointError(3,0,0.06862996);
   gre->SetPoint(4,100,3.67634);
   gre->SetPointError(4,0,0.1873721);
   gre->SetPoint(5,300,3.88764);
   gre->SetPointError(5,0,0.0823922);
   gre->SetPoint(6,500,3.53238);
   gre->SetPointError(6,0,0.02068779);
   gre->SetPoint(7,700,3.61362);
   gre->SetPointError(7,0,0.04365683);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(3.227272);
   Graph_Graph35->SetMaximum(4.037556);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.82474);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.196904e-05);
   linear_fit->SetParError(0,3.239401e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.53613);
   linear_fit->SetParError(1,0.01757561);
