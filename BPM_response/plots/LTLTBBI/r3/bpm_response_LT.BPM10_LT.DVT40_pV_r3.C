...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.9208045,1050,1.244103);
   ...
   gre->SetPoint(0,-700,1.05626);
   gre->SetPointError(0,0,0.02261719);
   gre->SetPoint(1,-500,1.0616);
   gre->SetPointError(1,0,0.003225149);
   gre->SetPoint(2,-300,0.9966);
   gre->SetPointError(2,0,0.0219123);
   gre->SetPoint(3,-100,1.16456);
   gre->SetPointError(3,0,0.0256603);
   gre->SetPoint(4,100,1.02988);
   gre->SetPointError(4,0,0.04851901);
   gre->SetPoint(5,300,1.1097);
   gre->SetPointError(5,0,0.02988139);
   gre->SetPoint(6,500,1.11994);
   gre->SetPointError(6,0,0.04230436);
   gre->SetPoint(7,700,1.04736);
   gre->SetPointError(7,0,0.0264071);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.9531344);
   Graph_Graph29->SetMaximum(1.211774);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(28.49214);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.091036e-05);
   linear_fit->SetParError(0,1.634945e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.071848);
   linear_fit->SetParError(1,0.008148967);
