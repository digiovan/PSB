...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_3->Range(-1050,-15.02968,1050,3.834083);
   ...
   gre->SetPoint(0,-700,0.53056);
   gre->SetPointError(0,0,0.1595634);
   gre->SetPoint(1,-500,-1.0108);
   gre->SetPointError(1,0,0.1116251);
   gre->SetPoint(2,-300,-2.78622);
   gre->SetPointError(2,0,0.04513281);
   gre->SetPoint(3,-100,-5.07874);
   gre->SetPointError(3,0,0.07225338);
   gre->SetPoint(4,100,-7.05186);
   gre->SetPointError(4,0,0.1669636);
   gre->SetPoint(5,300,-8.66626);
   gre->SetPointError(5,0,0.05097115);
   gre->SetPoint(6,500,-10.1142);
   gre->SetPointError(6,0,0.09626176);
   gre->SetPoint(7,700,-11.83788);
   gre->SetPointError(7,0,0.04783633);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-13.1433);
   Graph_Graph37->SetMaximum(1.947707);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(86.35144);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009041192);
   linear_fit->SetParError(0,5.524946e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.67991);
   linear_fit->SetParError(1,0.02498555);
