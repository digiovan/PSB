...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_3->Range(-1050,-8.600361,1050,-6.160032);
   ...
   gre->SetPoint(0,-700,-8.16948);
   gre->SetPointError(0,0,0.02415985);
   gre->SetPoint(1,-500,-7.8458);
   gre->SetPointError(1,0,0.0170249);
   gre->SetPoint(2,-300,-7.49968);
   gre->SetPointError(2,0,0.03398868);
   gre->SetPoint(3,-100,-7.53286);
   gre->SetPointError(3,0,0.02649185);
   gre->SetPoint(4,100,-7.07038);
   gre->SetPointError(4,0,0.1506806);
   gre->SetPoint(5,300,-7.03962);
   gre->SetPointError(5,0,0.08423244);
   gre->SetPoint(6,500,-6.8542);
   gre->SetPointError(6,0,0.04582736);
   gre->SetPoint(7,700,-6.59486);
   gre->SetPointError(7,0,0.02810608);
   
   TH1F *Graph_Graph32 = new TH1F("Graph_Graph32","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph32->SetMinimum(-8.356328);
   Graph_Graph32->SetMaximum(-6.404065);
   Graph_Graph32->SetDirectory(0);
   Graph_Graph32->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph32->SetLineColor(ci);
   Graph_Graph32->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(49.22178);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001065666);
   linear_fit->SetParError(0,2.207936e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.345674);
   linear_fit->SetParError(1,0.01150394);
