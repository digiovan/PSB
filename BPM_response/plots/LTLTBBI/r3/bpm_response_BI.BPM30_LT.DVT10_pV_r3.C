...
//=========  (Wed Apr  1 22:34:18 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-12.24363,1050,7.460361);
   ...
   gre->SetPoint(0,-700,-8.53342);
   gre->SetPointError(0,0,0.4262152);
   gre->SetPoint(1,-500,-5.87836);
   gre->SetPointError(1,0,0.1639277);
   gre->SetPoint(2,-300,-4.28334);
   gre->SetPointError(2,0,0.1623459);
   gre->SetPoint(3,-100,-2.77562);
   gre->SetPointError(3,0,0.2208401);
   gre->SetPoint(4,100,-0.90674);
   gre->SetPointError(4,0,0.2722115);
   gre->SetPoint(5,300,1.03378);
   gre->SetPointError(5,0,0.1523288);
   gre->SetPoint(6,500,2.83282);
   gre->SetPointError(6,0,0.06260037);
   gre->SetPoint(7,700,4.13838);
   gre->SetPointError(7,0,0.03798142);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-10.27323);
   Graph_Graph40->SetMaximum(5.489961);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.2281);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008410517);
   linear_fit->SetParError(0,9.662865e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.657722);
   linear_fit->SetParError(1,0.05976153);
