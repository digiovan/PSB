...
//=========  (Wed Apr  1 22:34:59 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.9446446,1050,1.34039);
   ...
   gre->SetPoint(0,-700,1.03962);
   gre->SetPointError(0,0,0.02084233);
   gre->SetPoint(1,-500,1.09684);
   gre->SetPointError(1,0,0.02992524);
   gre->SetPoint(2,-300,1.07228);
   gre->SetPointError(2,0,0.02559046);
   gre->SetPoint(3,-100,1.10064);
   gre->SetPointError(3,0,0.03231066);
   gre->SetPoint(4,100,1.2219);
   gre->SetPointError(4,0,0.05253262);
   gre->SetPoint(5,300,1.0667);
   gre->SetPointError(5,0,0.04817609);
   gre->SetPoint(6,500,1.08996);
   gre->SetPointError(6,0,0.03274139);
   gre->SetPoint(7,700,1.06472);
   gre->SetPointError(7,0,0.05411783);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: LT.DVT50 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.9842191);
   Graph_Graph29->SetMaximum(1.300816);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.945487);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.691693e-05);
   linear_fit->SetParError(0,2.526625e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.086522);
   linear_fit->SetParError(1,0.01264679);
