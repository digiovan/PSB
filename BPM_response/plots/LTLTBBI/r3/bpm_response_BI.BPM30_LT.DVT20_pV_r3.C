...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-24.32627,1050,18.67641);
   ...
   gre->SetPoint(0,-700,5.82582);
   gre->SetPointError(0,0,0.298259);
   gre->SetPoint(1,-500,11.16974);
   gre->SetPointError(1,0,0.3395518);
   gre->SetPoint(2,-300,5.36728);
   gre->SetPointError(2,0,0.1140729);
   gre->SetPoint(3,-100,0.70514);
   gre->SetPointError(3,0,0.6252015);
   gre->SetPoint(4,100,-4.348);
   gre->SetPointError(4,0,0.111797);
   gre->SetPoint(5,300,-8.632);
   gre->SetPointError(5,0,0.05201601);
   gre->SetPoint(6,500,-12.74954);
   gre->SetPointError(6,0,0.1836191);
   gre->SetPoint(7,700,-17.03858);
   gre->SetPointError(7,0,0.1205802);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LT.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-20.02601);
   Graph_Graph40->SetMaximum(14.37614);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(703.6568);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02115057);
   linear_fit->SetParError(0,0.0001327819);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.188075);
   linear_fit->SetParError(1,0.04945369);
