...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_3->Range(-1050,-13.54839,1050,18.21393);
   ...
   gre->SetPoint(0,-700,-8.16696);
   gre->SetPointError(0,0,0.08771274);
   gre->SetPoint(1,-500,-5.0474);
   gre->SetPointError(1,0,0.03448393);
   gre->SetPoint(2,-300,-1.9304);
   gre->SetPointError(2,0,0.09506198);
   gre->SetPoint(3,-100,1.1324);
   gre->SetPointError(3,0,0.06668048);
   gre->SetPoint(4,100,3.986);
   gre->SetPointError(4,0,0.04619643);
   gre->SetPoint(5,300,6.7511);
   gre->SetPointError(5,0,0.1517206);
   gre->SetPoint(6,500,9.88412);
   gre->SetPointError(6,0,0.06333675);
   gre->SetPoint(7,700,12.88532);
   gre->SetPointError(7,0,0.03488715);
   
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph35->SetMinimum(-10.37216);
   Graph_Graph35->SetMaximum(15.0377);
   Graph_Graph35->SetDirectory(0);
   Graph_Graph35->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph35->SetLineColor(ci);
   Graph_Graph35->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.0206);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01494175);
   linear_fit->SetParError(0,3.659263e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.446926);
   linear_fit->SetParError(1,0.01876263);
