...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Corr: LTB.DVT10 Plane: V Ring: 3");
   gre->SetFillColor(1);
   ...
   gre->SetPoint(0,-700,-0.3907);
   gre->SetPointError(0,0,0.02728703);
   gre->SetPoint(1,-500,-0.42038);
   gre->SetPointError(1,0,0.01127065);
   gre->SetPoint(2,-300,-0.42622);
   gre->SetPointError(2,0,0.04108003);
   gre->SetPoint(3,-100,-0.36382);
   gre->SetPointError(3,0,0.04285021);
   gre->SetPoint(4,100,-0.35704);
   gre->SetPointError(4,0,0.01914348);
   gre->SetPoint(5,300,-0.41714);
   gre->SetPointError(5,0,0.03771922);
   gre->SetPoint(6,500,-0.41302);
   gre->SetPointError(6,0,0.0195187);
   gre->SetPoint(7,700,-0.40998);
   gre->SetPointError(7,0,0.01284554);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph33->SetMinimum(-0.4819331);
   Graph_Graph33->SetMaximum(-0.3063368);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph33->SetLineColor(ci);
   Graph_Graph33->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.880474);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.45795e-06);
   linear_fit->SetParError(0,1.253652e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4061152);
   linear_fit->SetParError(1,0.006691368);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *text = pt->AddText("Corr: LTB.DVT10 Plane: V Ring: 3");
   pt->Draw();
