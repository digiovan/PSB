...
//=========  (Wed Apr  1 22:35:57 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,-16.53537,1050,10.42734);
   ...
   gre->SetPoint(0,-700,-12.0161);
   gre->SetPointError(0,0,0.0254882);
   gre->SetPoint(1,-500,-9.29542);
   gre->SetPointError(1,0,0.045367);
   gre->SetPoint(2,-300,-6.59288);
   gre->SetPointError(2,0,0.03435651);
   gre->SetPoint(3,-100,-3.94616);
   gre->SetPointError(3,0,0.07045801);
   gre->SetPoint(4,100,-1.42674);
   gre->SetPointError(4,0,0.02802936);
   gre->SetPoint(5,300,1.15856);
   gre->SetPointError(5,0,0.005926111);
   gre->SetPoint(6,500,3.53438);
   gre->SetPointError(6,0,0.02384327);
   gre->SetPoint(7,700,5.92172);
   gre->SetPointError(7,0,0.01183589);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: BI.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-13.8391);
   Graph_Graph40->SetMaximum(7.73107);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(859.8819);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01270011);
   linear_fit->SetParError(0,1.703419e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.737718);
   linear_fit->SetParError(1,0.007206568);
