...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-18.2499,1050,-8.096373);
   ...
   gre->SetPoint(0,-700,-15.5709);
   gre->SetPointError(0,0,0.9867485);
   gre->SetPoint(1,-500,-15.25596);
   gre->SetPointError(1,0,0.4512657);
   gre->SetPoint(2,-300,-14.19414);
   gre->SetPointError(2,0,1.675787);
   gre->SetPoint(3,-100,-12.50906);
   gre->SetPointError(3,0,0.7354646);
   gre->SetPoint(4,100,-13.5573);
   gre->SetPointError(4,0,1.766498);
   gre->SetPoint(5,300,-14.98198);
   gre->SetPointError(5,0,1.193139);
   gre->SetPoint(6,500,-13.49548);
   gre->SetPointError(6,0,0.2780421);
   gre->SetPoint(7,700,-10.50696);
   gre->SetPointError(7,0,0.7183318);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-17.23455);
   Graph_Graph42->SetMaximum(-9.111726);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.03919);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00200017);
   linear_fit->SetParError(0,0.0004406252);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-14.06444);
   linear_fit->SetParError(1,0.2207087);
