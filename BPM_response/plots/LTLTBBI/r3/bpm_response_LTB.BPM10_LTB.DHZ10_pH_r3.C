...
//=========  (Wed Apr  1 22:35:05 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_3->Range(-1050,-2.328879,1050,5.551683);
   ...
   gre->SetPoint(0,-700,-0.84478);
   gre->SetPointError(0,0,0.170672);
   gre->SetPoint(1,-500,0.17328);
   gre->SetPointError(1,0,0.2678127);
   gre->SetPoint(2,-300,0.71464);
   gre->SetPointError(2,0,0.04030383);
   gre->SetPoint(3,-100,1.66886);
   gre->SetPointError(3,0,0.1223535);
   gre->SetPoint(4,100,2.3995);
   gre->SetPointError(4,0,0.1552663);
   gre->SetPoint(5,300,2.94416);
   gre->SetPointError(5,0,0.094048);
   gre->SetPoint(6,500,3.29398);
   gre->SetPointError(6,0,0.252944);
   gre->SetPoint(7,700,4.17356);
   gre->SetPointError(7,0,0.06469607);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Corr: LTB.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph34->SetMinimum(-1.540823);
   Graph_Graph34->SetMaximum(4.763627);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph34->SetLineColor(ci);
   Graph_Graph34->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.31638);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003491462);
   linear_fit->SetParError(0,6.935895e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.788186);
   linear_fit->SetParError(1,0.02962581);
