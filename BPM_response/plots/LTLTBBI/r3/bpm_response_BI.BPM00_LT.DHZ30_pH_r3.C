...
//=========  (Wed Apr  1 22:34:34 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_3->Range(-1050,-9.902994,1050,-0.9739369);
   ...
   gre->SetPoint(0,-700,-2.52024);
   gre->SetPointError(0,0,0.05812689);
   gre->SetPoint(1,-500,-3.33214);
   gre->SetPointError(1,0,0.07082588);
   gre->SetPoint(2,-300,-4.69618);
   gre->SetPointError(2,0,0.2155799);
   gre->SetPoint(3,-100,-5.39574);
   gre->SetPointError(3,0,0.08969583);
   gre->SetPoint(4,100,-6.64512);
   gre->SetPointError(4,0,0.08716426);
   gre->SetPoint(5,300,-7.12932);
   gre->SetPointError(5,0,0.09420988);
   gre->SetPoint(6,500,-7.73156);
   gre->SetPointError(6,0,0.08385923);
   gre->SetPoint(7,700,-8.36722);
   gre->SetPointError(7,0,0.0475976);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LT.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-9.010088);
   Graph_Graph37->SetMaximum(-1.866843);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(92.73423);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004215102);
   linear_fit->SetParError(0,4.69144e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.599298);
   linear_fit->SetParError(1,0.02629055);
