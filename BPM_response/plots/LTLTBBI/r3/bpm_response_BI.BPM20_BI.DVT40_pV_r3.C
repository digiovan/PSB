...
//=========  (Wed Apr  1 22:36:24 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_3->Range(-1050,-2.483628,1050,-1.512101);
   ...
   gre->SetPoint(0,-700,-1.8497);
   gre->SetPointError(0,0,0.02893926);
   gre->SetPoint(1,-500,-1.72106);
   gre->SetPointError(1,0,0.01796587);
   gre->SetPoint(2,-300,-2.28866);
   gre->SetPointError(2,0,0.03304721);
   gre->SetPoint(3,-100,-1.72412);
   gre->SetPointError(3,0,0.03303762);
   gre->SetPoint(4,100,-1.7397);
   gre->SetPointError(4,0,0.0656775);
   gre->SetPoint(5,300,-2.14642);
   gre->SetPointError(5,0,0.06008304);
   gre->SetPoint(6,500,-1.85724);
   gre->SetPointError(6,0,0.1066862);
   gre->SetPoint(7,700,-1.85032);
   gre->SetPointError(7,0,0.05342987);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-2.386476);
   Graph_Graph39->SetMaximum(-1.609254);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(258.813);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001068188);
   linear_fit->SetParError(0,3.357321e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.877638);
   linear_fit->SetParError(1,0.01632588);
