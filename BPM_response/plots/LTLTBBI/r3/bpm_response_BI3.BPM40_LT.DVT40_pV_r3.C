...
//=========  (Wed Apr  1 22:34:50 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-22.35503,1050,13.54681);
   ...
   gre->SetPoint(0,-700,7.3998);
   gre->SetPointError(0,0,0.1633656);
   gre->SetPoint(1,-500,3.56514);
   gre->SetPointError(1,0,0.05889423);
   gre->SetPoint(2,-300,0.6725);
   gre->SetPointError(2,0,0.4777588);
   gre->SetPoint(3,-100,-3.10052);
   gre->SetPointError(3,0,0.4193239);
   gre->SetPoint(4,100,-5.16262);
   gre->SetPointError(4,0,0.2879936);
   gre->SetPoint(5,300,-8.04426);
   gre->SetPointError(5,0,0.5332058);
   gre->SetPoint(6,500,-11.31994);
   gre->SetPointError(6,0,0.3541386);
   gre->SetPoint(7,700,-14.7409);
   gre->SetPointError(7,0,1.630495);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: LT.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-18.76485);
   Graph_Graph41->SetMaximum(9.956622);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.59863);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01530001);
   linear_fit->SetParError(0,0.0002415727);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.980198);
   linear_fit->SetParError(1,0.123154);
