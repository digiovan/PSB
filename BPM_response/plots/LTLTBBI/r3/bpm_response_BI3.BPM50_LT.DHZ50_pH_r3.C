...
//=========  (Wed Apr  1 22:34:55 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_H_3->Range(-1050,-14.32463,1050,10.29691);
   ...
   gre->SetPoint(0,-700,-9.136);
   gre->SetPointError(0,0,1.085043);
   gre->SetPoint(1,-500,2.9735);
   gre->SetPointError(1,0,0.04337004);
   gre->SetPoint(2,-300,-0.51024);
   gre->SetPointError(2,0,0.7261486);
   gre->SetPoint(3,-100,5.46314);
   gre->SetPointError(3,0,0.05685477);
   gre->SetPoint(4,100,6.11222);
   gre->SetPointError(4,0,0.0810962);
   gre->SetPoint(5,300,1.96374);
   gre->SetPointError(5,0,0.3455524);
   gre->SetPoint(6,500,4.73358);
   gre->SetPointError(6,0,1.165957);
   gre->SetPoint(7,700,3.3131);
   gre->SetPointError(7,0,0.158483);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LT.DHZ50 Plane: H Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-11.86248);
   Graph_Graph42->SetMaximum(7.834752);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1278.832);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002922409);
   linear_fit->SetParError(0,0.0001011239);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.862285);
   linear_fit->SetParError(1,0.03939547);
