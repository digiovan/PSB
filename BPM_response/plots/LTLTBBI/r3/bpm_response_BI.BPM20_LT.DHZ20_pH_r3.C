...
//=========  (Wed Apr  1 22:34:23 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,6.108698,1050,10.73408);
   ...
   gre->SetPoint(0,-700,9.90818);
   gre->SetPointError(0,0,0.05500525);
   gre->SetPoint(1,-500,9.68484);
   gre->SetPointError(1,0,0.03020751);
   gre->SetPoint(2,-300,9.24236);
   gre->SetPointError(2,0,0.03357924);
   gre->SetPoint(3,-100,8.70706);
   gre->SetPointError(3,0,0.0206658);
   gre->SetPoint(4,100,8.25856);
   gre->SetPointError(4,0,0.0152973);
   gre->SetPoint(5,300,7.99692);
   gre->SetPointError(5,0,0.03434125);
   gre->SetPoint(6,500,7.71542);
   gre->SetPointError(6,0,0.02921421);
   gre->SetPoint(7,700,6.9169);
   gre->SetPointError(7,0,0.03730424);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: LT.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(6.571237);
   Graph_Graph39->SetMaximum(10.27154);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(126.5882);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002091534);
   linear_fit->SetParError(0,2.792281e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.535909);
   linear_fit->SetParError(1,0.009332618);
