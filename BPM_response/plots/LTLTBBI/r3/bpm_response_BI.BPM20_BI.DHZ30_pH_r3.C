...
//=========  (Wed Apr  1 22:36:08 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_3->Range(-1050,-1.337779,1050,-1.081837);
   ...
   gre->SetPoint(0,-700,-1.24594);
   gre->SetPointError(0,0,0.003285382);
   gre->SetPoint(1,-500,-1.18924);
   gre->SetPointError(1,0,0.01617896);
   gre->SetPoint(2,-300,-1.16706);
   gre->SetPointError(2,0,0.03095528);
   gre->SetPoint(3,-100,-1.1414);
   gre->SetPointError(3,0,0.0169057);
   gre->SetPoint(4,100,-1.2149);
   gre->SetPointError(4,0,0.04600197);
   gre->SetPoint(5,300,-1.25324);
   gre->SetPointError(5,0,0.02132043);
   gre->SetPoint(6,500,-1.19634);
   gre->SetPointError(6,0,0.006104879);
   gre->SetPoint(7,700,-1.28256);
   gre->SetPointError(7,0,0.01256214);
   
   TH1F *Graph_Graph39 = new TH1F("Graph_Graph39","Corr: BI.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph39->SetMinimum(-1.312185);
   Graph_Graph39->SetMaximum(-1.107432);
   Graph_Graph39->SetDirectory(0);
   Graph_Graph39->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph39->SetLineColor(ci);
   Graph_Graph39->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(85.83803);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.456716e-05);
   linear_fit->SetParError(0,5.060656e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.224291);
   linear_fit->SetParError(1,0.003251581);
