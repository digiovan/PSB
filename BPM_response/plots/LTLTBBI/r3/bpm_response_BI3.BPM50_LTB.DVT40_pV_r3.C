...
//=========  (Wed Apr  1 22:35:42 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-23.14903,1050,14.60867);
   ...
   gre->SetPoint(0,-700,-10.9974);
   gre->SetPointError(0,0,0.7012749);
   gre->SetPoint(1,-500,-16.16416);
   gre->SetPointError(1,0,0.691919);
   gre->SetPoint(2,-300,-12.10446);
   gre->SetPointError(2,0,0.1579175);
   gre->SetPoint(3,-100,-7.9163);
   gre->SetPointError(3,0,0.4217234);
   gre->SetPoint(4,100,-5.52498);
   gre->SetPointError(4,0,0.1563319);
   gre->SetPoint(5,300,-1.0282);
   gre->SetPointError(5,0,0.1350694);
   gre->SetPoint(6,500,3.10388);
   gre->SetPointError(6,0,0.1217005);
   gre->SetPoint(7,700,8.23964);
   gre->SetPointError(7,0,0.07608038);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: LTB.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-19.37326);
   Graph_Graph42->SetMaximum(10.8329);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(337.731);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02033925);
   linear_fit->SetParError(0,0.0001481304);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.461188);
   linear_fit->SetParError(1,0.07982825);
