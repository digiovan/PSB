...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_3->Range(-1050,-8.983177,1050,6.657711);
   ...
   gre->SetPoint(0,-700,4.00778);
   gre->SetPointError(0,0,0.04311596);
   gre->SetPoint(1,-500,2.47362);
   gre->SetPointError(1,0,0.01004891);
   gre->SetPoint(2,-300,1.01162);
   gre->SetPointError(2,0,0.02679941);
   gre->SetPoint(3,-100,-0.39186);
   gre->SetPointError(3,0,0.04089867);
   gre->SetPoint(4,100,-1.76414);
   gre->SetPointError(4,0,0.02507207);
   gre->SetPoint(5,300,-3.14616);
   gre->SetPointError(5,0,0.07155463);
   gre->SetPoint(6,500,-4.7325);
   gre->SetPointError(6,0,0.02454217);
   gre->SetPoint(7,700,-6.34892);
   gre->SetPointError(7,0,0.02744259);
   
   TH1F *Graph_Graph37 = new TH1F("Graph_Graph37","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph37->SetMinimum(-7.419088);
   Graph_Graph37->SetMaximum(5.093622);
   Graph_Graph37->SetDirectory(0);
   Graph_Graph37->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph37->SetLineColor(ci);
   Graph_Graph37->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(52.00675);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007262601);
   linear_fit->SetParError(0,1.790856e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.144123);
   linear_fit->SetParError(1,0.008602297);
