...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-11.23977,1050,-10.51203);
   ...
   gre->SetPoint(0,-700,-10.8644);
   gre->SetPointError(0,0,0.0440043);
   gre->SetPoint(1,-500,-10.90246);
   gre->SetPointError(1,0,0.03597047);
   gre->SetPoint(2,-300,-10.91048);
   gre->SetPointError(2,0,0.1183523);
   gre->SetPoint(3,-100,-10.76036);
   gre->SetPointError(3,0,0.05178259);
   gre->SetPoint(4,100,-11.04214);
   gre->SetPointError(4,0,0.05023052);
   gre->SetPoint(5,300,-10.8759);
   gre->SetPointError(5,0,0.2425824);
   gre->SetPoint(6,500,-10.83294);
   gre->SetPointError(6,0,0.07021071);
   gre->SetPoint(7,700,-10.87552);
   gre->SetPointError(7,0,0.1234816);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-11.167);
   Graph_Graph31->SetMaximum(-10.5848);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(16.45555);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.954926e-05);
   linear_fit->SetParError(0,5.074168e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.89376);
   linear_fit->SetParError(1,0.02409769);
