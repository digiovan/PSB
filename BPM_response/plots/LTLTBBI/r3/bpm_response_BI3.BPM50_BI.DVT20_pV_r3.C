...
//=========  (Wed Apr  1 22:36:03 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM50_V_3->Range(-1050,-18.0985,1050,1.191679);
   ...
   gre->SetPoint(0,-700,-2.28028);
   gre->SetPointError(0,0,0.2569284);
   gre->SetPoint(1,-500,-4.5536);
   gre->SetPointError(1,0,0.4778094);
   gre->SetPoint(2,-300,-5.59958);
   gre->SetPointError(2,0,1.081348);
   gre->SetPoint(3,-100,-8.6598);
   gre->SetPointError(3,0,0.6410498);
   gre->SetPoint(4,100,-9.29282);
   gre->SetPointError(4,0,1.271653);
   gre->SetPoint(5,300,-9.65348);
   gre->SetPointError(5,0,1.587985);
   gre->SetPoint(6,500,-11.0018);
   gre->SetPointError(6,0,0.94845);
   gre->SetPoint(7,700,-14.24926);
   gre->SetPointError(7,0,0.6342123);
   
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph42->SetMinimum(-16.16948);
   Graph_Graph42->SetMaximum(-0.7373396);
   Graph_Graph42->SetDirectory(0);
   Graph_Graph42->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph42->SetLineColor(ci);
   Graph_Graph42->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.752479);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008350145);
   linear_fit->SetParError(0,0.0004119907);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.308564);
   linear_fit->SetParError(1,0.2507032);
