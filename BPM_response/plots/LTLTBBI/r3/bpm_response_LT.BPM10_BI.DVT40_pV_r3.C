...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.6641547,1050,1.247377);
   ...
   gre->SetPoint(0,-700,1.0218);
   gre->SetPointError(0,0,0.01832994);
   gre->SetPoint(1,-500,1.1252);
   gre->SetPointError(1,0,0.0249731);
   gre->SetPoint(2,-300,0.78718);
   gre->SetPointError(2,0,0.02582162);
   gre->SetPoint(3,-100,1.04552);
   gre->SetPointError(3,0,0.01275076);
   gre->SetPoint(4,100,1.0616);
   gre->SetPointError(4,0,0.03559743);
   gre->SetPoint(5,300,0.87838);
   gre->SetPointError(5,0,0.02675288);
   gre->SetPoint(6,500,1.08104);
   gre->SetPointError(6,0,0.05533313);
   gre->SetPoint(7,700,1.02908);
   gre->SetPointError(7,0,0.03965597);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: BI.DVT40 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.7224769);
   Graph_Graph29->SetMaximum(1.189055);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(129.7044);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.414284e-05);
   linear_fit->SetParError(0,2.204965e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.003445);
   linear_fit->SetParError(1,0.00903578);
