...
//=========  (Wed Apr  1 22:35:16 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,-4.176502,1050,19.24071);
   ...
   gre->SetPoint(0,-700,15.29222);
   gre->SetPointError(0,0,0.04562217);
   gre->SetPoint(1,-500,12.92646);
   gre->SetPointError(1,0,0.0748519);
   gre->SetPoint(2,-300,10.7357);
   gre->SetPointError(2,0,0.06832947);
   gre->SetPoint(3,-100,8.78958);
   gre->SetPointError(3,0,0.02124925);
   gre->SetPoint(4,100,6.70188);
   gre->SetPointError(4,0,0.04048136);
   gre->SetPoint(5,300,4.37982);
   gre->SetPointError(5,0,0.06878055);
   gre->SetPoint(6,500,2.07338);
   gre->SetPointError(6,0,0.04749049);
   gre->SetPoint(7,700,-0.20612);
   gre->SetPointError(7,0,0.06751296);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LTB.DHZ20 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-1.83478);
   Graph_Graph40->SetMaximum(16.89899);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(45.64312);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01097333);
   linear_fit->SetParError(0,4.244183e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.652297);
   linear_fit->SetParError(1,0.01491879);
