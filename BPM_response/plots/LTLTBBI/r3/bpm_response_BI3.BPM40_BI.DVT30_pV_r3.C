...
//=========  (Wed Apr  1 22:36:13 2015) by ROOT version5.34/21
   ...
   canvas_BI3.BPM40_V_3->Range(-1050,-9.470382,1050,4.266203);
   ...
   gre->SetPoint(0,-700,-5.09932);
   gre->SetPointError(0,0,1.618716);
   gre->SetPoint(1,-500,-6.84722);
   gre->SetPointError(1,0,0.333731);
   gre->SetPoint(2,-300,-6.48992);
   gre->SetPointError(2,0,0.1626874);
   gre->SetPoint(3,-100,-5.2836);
   gre->SetPointError(3,0,0.7560697);
   gre->SetPoint(4,100,-3.85834);
   gre->SetPointError(4,0,0.9946873);
   gre->SetPoint(5,300,-3.09784);
   gre->SetPointError(5,0,0.3150016);
   gre->SetPoint(6,500,-2.67222);
   gre->SetPointError(6,0,0.1483319);
   gre->SetPoint(7,700,1.09776);
   gre->SetPointError(7,0,0.8790118);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","Corr: BI.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph41->SetMinimum(-8.096723);
   Graph_Graph41->SetMaximum(2.892544);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph41->SetLineColor(ci);
   Graph_Graph41->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.37948);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004713969);
   linear_fit->SetParError(0,0.000237474);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.895481);
   linear_fit->SetParError(1,0.09957217);
