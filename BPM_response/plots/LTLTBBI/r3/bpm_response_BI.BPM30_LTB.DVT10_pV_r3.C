...
//=========  (Wed Apr  1 22:35:10 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_3->Range(-1050,-29.81875,1050,23.39138);
   ...
   gre->SetPoint(0,-700,-19.69376);
   gre->SetPointError(0,0,1.256632);
   gre->SetPoint(1,-500,-20.49382);
   gre->SetPointError(1,0,0.05405927);
   gre->SetPoint(2,-300,-12.84984);
   gre->SetPointError(2,0,0.2973847);
   gre->SetPoint(3,-100,-4.81882);
   gre->SetPointError(3,0,0.4589132);
   gre->SetPoint(4,100,3.13738);
   gre->SetPointError(4,0,0.1941499);
   gre->SetPoint(5,300,10.50832);
   gre->SetPointError(5,0,0.3485092);
   gre->SetPoint(6,500,11.78726);
   gre->SetPointError(6,0,0.9093288);
   gre->SetPoint(7,700,14.1875);
   gre->SetPointError(7,0,0.3355265);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: LTB.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-24.49773);
   Graph_Graph40->SetMaximum(18.07037);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(778.0334);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.03422709);
   linear_fit->SetParError(0,0.00019461);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.191822);
   linear_fit->SetParError(1,0.09319352);
