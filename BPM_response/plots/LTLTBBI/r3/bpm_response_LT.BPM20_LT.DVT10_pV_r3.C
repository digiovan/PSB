...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_3->Range(-1050,-8.921428,1050,-4.418273);
   ...
   gre->SetPoint(0,-700,-8.07974);
   gre->SetPointError(0,0,0.09116198);
   gre->SetPoint(1,-500,-7.71716);
   gre->SetPointError(1,0,0.01256521);
   gre->SetPoint(2,-300,-7.26224);
   gre->SetPointError(2,0,0.0490371);
   gre->SetPoint(3,-100,-6.76898);
   gre->SetPointError(3,0,0.03310857);
   gre->SetPoint(4,100,-6.39824);
   gre->SetPointError(4,0,0.09605283);
   gre->SetPoint(5,300,-6.0665);
   gre->SetPointError(5,0,0.05821716);
   gre->SetPoint(6,500,-5.68102);
   gre->SetPointError(6,0,0.02198201);
   gre->SetPoint(7,700,-5.19064);
   gre->SetPointError(7,0,0.02184155);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LT.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-8.471112);
   Graph_Graph30->SetMaximum(-4.868588);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.85847);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00207576);
   linear_fit->SetParError(0,1.767648e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.668911);
   linear_fit->SetParError(1,0.009082821);
