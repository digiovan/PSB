...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_3->Range(-1050,-9.743242,1050,-9.471595);
   ...
   gre->SetPoint(0,-700,-9.60516);
   gre->SetPointError(0,0,0.04736384);
   gre->SetPoint(1,-500,-9.59664);
   gre->SetPointError(1,0,0.0552001);
   gre->SetPoint(2,-300,-9.5649);
   gre->SetPointError(2,0,0.04803076);
   gre->SetPoint(3,-100,-9.63318);
   gre->SetPointError(3,0,0.06317405);
   gre->SetPoint(4,100,-9.61058);
   gre->SetPointError(4,0,0.08738779);
   gre->SetPoint(5,300,-9.61526);
   gre->SetPointError(5,0,0.03882361);
   gre->SetPoint(6,500,-9.64222);
   gre->SetPointError(6,0,0.01245569);
   gre->SetPoint(7,700,-9.61292);
   gre->SetPointError(7,0,0.04982033);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-9.716078);
   Graph_Graph31->SetMaximum(-9.498759);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.635108);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.251772e-05);
   linear_fit->SetParError(0,2.929057e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.616696);
   linear_fit->SetParError(1,0.01443982);
