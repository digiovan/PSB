...
//=========  (Wed Apr  1 22:35:51 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_3->Range(-1050,0.9521337,1050,1.17384);
   ...
   gre->SetPoint(0,-700,1.03478);
   gre->SetPointError(0,0,0.04569528);
   gre->SetPoint(1,-500,1.06736);
   gre->SetPointError(1,0,0.04147803);
   gre->SetPoint(2,-300,1.07262);
   gre->SetPointError(2,0,0.0413217);
   gre->SetPoint(3,-100,1.07538);
   gre->SetPointError(3,0,0.04900749);
   gre->SetPoint(4,100,1.05044);
   gre->SetPointError(4,0,0.03879139);
   gre->SetPoint(5,300,1.13054);
   gre->SetPointError(5,0,0.006348689);
   gre->SetPoint(6,500,1.09042);
   gre->SetPointError(6,0,0.04546806);
   gre->SetPoint(7,700,1.07676);
   gre->SetPointError(7,0,0.008404371);
   
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Corr: BI.DVT10 Plane: V Ring: 3",100,-840,840);
   Graph_Graph29->SetMinimum(0.9743043);
   Graph_Graph29->SetMaximum(1.151669);
   Graph_Graph29->SetDirectory(0);
   Graph_Graph29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph29->SetLineColor(ci);
   Graph_Graph29->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(30.36483);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.199328e-05);
   linear_fit->SetParError(0,1.817212e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.120217);
   linear_fit->SetParError(1,0.008730103);
