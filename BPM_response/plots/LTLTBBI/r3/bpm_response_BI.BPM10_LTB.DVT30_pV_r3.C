...
//=========  (Wed Apr  1 22:35:31 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_3->Range(-1050,0.5005454,1050,7.152446);
   ...
   gre->SetPoint(0,-700,5.86306);
   gre->SetPointError(0,0,0.180736);
   gre->SetPoint(1,-500,5.15794);
   gre->SetPointError(1,0,0.2327238);
   gre->SetPoint(2,-300,4.6209);
   gre->SetPointError(2,0,0.1057815);
   gre->SetPoint(3,-100,4.07078);
   gre->SetPointError(3,0,0.1122033);
   gre->SetPoint(4,100,3.42708);
   gre->SetPointError(4,0,0.1157374);
   gre->SetPoint(5,300,2.78176);
   gre->SetPointError(5,0,0.02592732);
   gre->SetPoint(6,500,2.42588);
   gre->SetPointError(6,0,0.04118669);
   gre->SetPoint(7,700,1.8024);
   gre->SetPointError(7,0,0.1932045);
   
   TH1F *Graph_Graph38 = new TH1F("Graph_Graph38","Corr: LTB.DVT30 Plane: V Ring: 3",100,-840,840);
   Graph_Graph38->SetMinimum(1.165735);
   Graph_Graph38->SetMaximum(6.487256);
   Graph_Graph38->SetDirectory(0);
   Graph_Graph38->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph38->SetLineColor(ci);
   Graph_Graph38->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.97205);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0027917);
   linear_fit->SetParError(0,9.204105e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.689951);
   linear_fit->SetParError(1,0.03382172);
