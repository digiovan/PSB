...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_3->Range(-1050,-11.13122,1050,-10.29187);
   ...
   gre->SetPoint(0,-700,-10.67126);
   gre->SetPointError(0,0,0.02534062);
   gre->SetPoint(1,-500,-10.72786);
   gre->SetPointError(1,0,0.1342437);
   gre->SetPoint(2,-300,-10.80332);
   gre->SetPointError(2,0,0.06634793);
   gre->SetPoint(3,-100,-10.77848);
   gre->SetPointError(3,0,0.06547735);
   gre->SetPoint(4,100,-10.79008);
   gre->SetPointError(4,0,0.06709386);
   gre->SetPoint(5,300,-10.86518);
   gre->SetPointError(5,0,0.1261458);
   gre->SetPoint(6,500,-10.50426);
   gre->SetPointError(6,0,0.07250136);
   gre->SetPoint(7,700,-10.82456);
   gre->SetPointError(7,0,0.0585042);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","Corr: BI.DVT20 Plane: V Ring: 3",100,-840,840);
   Graph_Graph31->SetMinimum(-11.04728);
   Graph_Graph31->SetMaximum(-10.3758);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph31->SetLineColor(ci);
   Graph_Graph31->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.81556);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.766438e-05);
   linear_fit->SetParError(0,3.694331e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.72753);
   linear_fit->SetParError(1,0.02190112);
