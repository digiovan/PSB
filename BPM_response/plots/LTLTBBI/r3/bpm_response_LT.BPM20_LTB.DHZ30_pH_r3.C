...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_3->Range(-1050,-7.959701,1050,-7.554779);
   ...
   gre->SetPoint(0,-700,-7.70366);
   gre->SetPointError(0,0,0.07721684);
   gre->SetPoint(1,-500,-7.79644);
   gre->SetPointError(1,0,0.05224231);
   gre->SetPoint(2,-300,-7.76364);
   gre->SetPointError(2,0,0.0231669);
   gre->SetPoint(3,-100,-7.74392);
   gre->SetPointError(3,0,0.01020546);
   gre->SetPoint(4,100,-7.80606);
   gre->SetPointError(4,0,0.04495336);
   gre->SetPoint(5,300,-7.75506);
   gre->SetPointError(5,0,0.05813239);
   gre->SetPoint(6,500,-7.7977);
   gre->SetPointError(6,0,0.09437746);
   gre->SetPoint(7,700,-7.75724);
   gre->SetPointError(7,0,0.1349738);
   
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Corr: LTB.DHZ30 Plane: H Ring: 3",100,-840,840);
   Graph_Graph30->SetMinimum(-7.919209);
   Graph_Graph30->SetMaximum(-7.595271);
   Graph_Graph30->SetDirectory(0);
   Graph_Graph30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph30->SetLineColor(ci);
   Graph_Graph30->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.641009);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.207428e-06);
   linear_fit->SetParError(0,5.507552e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.751875);
   linear_fit->SetParError(1,0.01107618);
