...
//=========  (Wed Apr  1 22:35:47 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_3->Range(-1050,-9.277995,1050,3.901397);
   ...
   gre->SetPoint(0,-700,-7.04432);
   gre->SetPointError(0,0,0.0371099);
   gre->SetPoint(1,-500,-5.82686);
   gre->SetPointError(1,0,0.03920725);
   gre->SetPoint(2,-300,-4.6104);
   gre->SetPointError(2,0,0.0914673);
   gre->SetPoint(3,-100,-3.37602);
   gre->SetPointError(3,0,0.01837559);
   gre->SetPoint(4,100,-2.06348);
   gre->SetPointError(4,0,0.009719826);
   gre->SetPoint(5,300,-0.83726);
   gre->SetPointError(5,0,0.04263587);
   gre->SetPoint(6,500,0.45076);
   gre->SetPointError(6,0,0.03041777);
   gre->SetPoint(7,700,1.69414);
   gre->SetPointError(7,0,0.01069138);
   
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","Corr: BI.DHZ10 Plane: H Ring: 3",100,-840,840);
   Graph_Graph40->SetMinimum(-7.960056);
   Graph_Graph40->SetMaximum(2.583458);
   Graph_Graph40->SetDirectory(0);
   Graph_Graph40->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph40->SetLineColor(ci);
   Graph_Graph40->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.08929);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006277506);
   linear_fit->SetParError(0,1.691864e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.700342);
   linear_fit->SetParError(1,0.007703938);
