...
//=========  (Wed Apr  1 22:35:34 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,6.143908,1050,9.908817);
   ...
   gre->SetPoint(0,-700,9.2339);
   gre->SetPointError(0,0,0.04743218);
   gre->SetPoint(1,-500,8.85804);
   gre->SetPointError(1,0,0.07907973);
   gre->SetPoint(2,-300,8.43004);
   gre->SetPointError(2,0,0.08562061);
   gre->SetPoint(3,-100,8.03762);
   gre->SetPointError(3,0,0.03375699);
   gre->SetPoint(4,100,7.83104);
   gre->SetPointError(4,0,0.03334221);
   gre->SetPoint(5,300,7.49372);
   gre->SetPointError(5,0,0.03016352);
   gre->SetPoint(6,500,7.22574);
   gre->SetPointError(6,0,0.05972853);
   gre->SetPoint(7,700,6.87548);
   gre->SetPointError(7,0,0.1040868);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LTB.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(6.520399);
   Graph_Graph12->SetMaximum(9.532326);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.06583);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001662556);
   linear_fit->SetParError(0,4.47528e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.980474);
   linear_fit->SetParError(1,0.01587551);
