...
//=========  (Wed Apr  1 22:34:42 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,-0.1847498,1050,13.45339);
   ...
   gre->SetPoint(0,-700,5.87364);
   gre->SetPointError(0,0,0.4485077);
   gre->SetPoint(1,-500,10.8869);
   gre->SetPointError(1,0,0.2934705);
   gre->SetPoint(2,-300,7.06006);
   gre->SetPointError(2,0,0.2247124);
   gre->SetPoint(3,-100,10.03842);
   gre->SetPointError(3,0,0.04298134);
   gre->SetPoint(4,100,8.93552);
   gre->SetPointError(4,0,0.07900027);
   gre->SetPoint(5,300,5.103);
   gre->SetPointError(5,0,0.3167645);
   gre->SetPoint(6,500,4.7549);
   gre->SetPointError(6,0,0.6452991);
   gre->SetPoint(7,700,2.40606);
   gre->SetPointError(7,0,0.3177857);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LT.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(1.179065);
   Graph_Graph13->SetMaximum(12.08958);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(752.6193);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004725961);
   linear_fit->SetParError(0,0.0002347795);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,9.270853);
   linear_fit->SetParError(1,0.03854118);
