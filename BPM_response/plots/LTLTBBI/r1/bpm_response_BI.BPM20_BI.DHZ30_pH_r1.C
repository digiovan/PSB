...
//=========  (Wed Apr  1 22:36:06 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,-1.091931,1050,-0.9226809);
   ...
   gre->SetPoint(0,-700,-1.05692);
   gre->SetPointError(0,0,0.006802945);
   gre->SetPoint(1,-500,-1.01852);
   gre->SetPointError(1,0,0.007164893);
   gre->SetPoint(2,-300,-0.98766);
   gre->SetPointError(2,0,0.01723373);
   gre->SetPoint(3,-100,-0.97142);
   gre->SetPointError(3,0,0.0147766);
   gre->SetPoint(4,100,-1.00724);
   gre->SetPointError(4,0,0.05635071);
   gre->SetPoint(5,300,-1.01858);
   gre->SetPointError(5,0,0.01481497);
   gre->SetPoint(6,500,-1.03142);
   gre->SetPointError(6,0,0.02056948);
   gre->SetPoint(7,700,-1.03732);
   gre->SetPointError(7,0,0.004253362);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: BI.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-1.075006);
   Graph_Graph11->SetMaximum(-0.9396059);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(42.91644);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.586844e-08);
   linear_fit->SetParError(0,4.885631e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.032643);
   linear_fit->SetParError(1,0.003064839);
