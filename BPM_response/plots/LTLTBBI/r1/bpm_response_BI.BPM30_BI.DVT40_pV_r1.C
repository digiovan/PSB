...
//=========  (Wed Apr  1 22:36:22 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-5.707687,1050,-1.877524);
   ...
   gre->SetPoint(0,-700,-3.5822);
   gre->SetPointError(0,0,0.2437373);
   gre->SetPoint(1,-500,-3.43336);
   gre->SetPointError(1,0,0.2508869);
   gre->SetPoint(2,-300,-4.82482);
   gre->SetPointError(2,0,0.2445063);
   gre->SetPoint(3,-100,-3.05412);
   gre->SetPointError(3,0,0.1681195);
   gre->SetPoint(4,100,-3.09766);
   gre->SetPointError(4,0,0.3233244);
   gre->SetPoint(5,300,-4.45244);
   gre->SetPointError(5,0,0.3008861);
   gre->SetPoint(6,500,-3.33108);
   gre->SetPointError(6,0,0.358778);
   gre->SetPoint(7,700,-2.8787);
   gre->SetPointError(7,0,0.3628154);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: BI.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-5.32467);
   Graph_Graph12->SetMaximum(-2.26054);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(49.08493);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003048492);
   linear_fit->SetParError(0,0.0002293087);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.523464);
   linear_fit->SetParError(1,0.09522686);
