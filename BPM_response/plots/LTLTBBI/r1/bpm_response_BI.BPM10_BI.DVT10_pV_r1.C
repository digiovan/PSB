...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_1->Range(-1050,-1.158165,1050,10.78788);
   ...
   gre->SetPoint(0,-700,0.93358);
   gre->SetPointError(0,0,0.1007375);
   gre->SetPoint(1,-500,2.15916);
   gre->SetPointError(1,0,0.08455351);
   gre->SetPoint(2,-300,3.12404);
   gre->SetPointError(2,0,0.1634251);
   gre->SetPoint(3,-100,4.5265);
   gre->SetPointError(3,0,0.1351561);
   gre->SetPoint(4,100,5.42368);
   gre->SetPointError(4,0,0.1405414);
   gre->SetPoint(5,300,6.5839);
   gre->SetPointError(5,0,0.05110855);
   gre->SetPoint(6,500,7.82326);
   gre->SetPointError(6,0,0.1819185);
   gre->SetPoint(7,700,8.74138);
   gre->SetPointError(7,0,0.05549197);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: BI.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(0.03643956);
   Graph_Graph10->SetMaximum(9.593275);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.532808);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005542392);
   linear_fit->SetParError(0,6.316689e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.900066);
   linear_fit->SetParError(1,0.03209049);
