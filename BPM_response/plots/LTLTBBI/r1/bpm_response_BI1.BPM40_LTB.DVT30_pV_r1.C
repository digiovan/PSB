...
//=========  (Wed Apr  1 22:35:29 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_V_1->Range(-1050,-10.36774,1050,-0.1612258);
   ...
   gre->SetPoint(0,-700,-8.15054);
   gre->SetPointError(0,0,0.5161177);
   gre->SetPoint(1,-500,-6.72402);
   gre->SetPointError(1,0,0.1440527);
   gre->SetPoint(2,-300,-5.77972);
   gre->SetPointError(2,0,0.1287255);
   gre->SetPoint(3,-100,-5.43226);
   gre->SetPointError(3,0,0.1968592);
   gre->SetPoint(4,100,-3.86696);
   gre->SetPointError(4,0,0.07877298);
   gre->SetPoint(5,300,-3.57954);
   gre->SetPointError(5,0,0.4573453);
   gre->SetPoint(6,500,-2.58238);
   gre->SetPointError(6,0,0.1291328);
   gre->SetPoint(7,700,-2.04118);
   gre->SetPointError(7,0,0.1788677);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LTB.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-9.347092);
   Graph_Graph13->SetMaximum(-1.181878);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.23424);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004089405);
   linear_fit->SetParError(0,0.0001404404);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.535132);
   linear_fit->SetParError(1,0.05090306);
