...
//=========  (Wed Apr  1 22:35:55 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-8.564716,1050,-3.258162);
   ...
   gre->SetPoint(0,-700,-7.17976);
   gre->SetPointError(0,0,0.1827579);
   gre->SetPoint(1,-500,-7.41896);
   gre->SetPointError(1,0,0.2613301);
   gre->SetPoint(2,-300,-6.40958);
   gre->SetPointError(2,0,0.1436855);
   gre->SetPoint(3,-100,-5.71088);
   gre->SetPointError(3,0,0.2398986);
   gre->SetPoint(4,100,-7.10544);
   gre->SetPointError(4,0,0.4701922);
   gre->SetPoint(5,300,-6.43918);
   gre->SetPointError(5,0,0.2328188);
   gre->SetPoint(6,500,-5.24092);
   gre->SetPointError(6,0,0.644551);
   gre->SetPoint(7,700,-4.5543);
   gre->SetPointError(7,0,0.4117126);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: BI.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-8.03406);
   Graph_Graph14->SetMaximum(-3.788817);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(28.62743);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001343915);
   linear_fit->SetParError(0,0.0002221172);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.204734);
   linear_fit->SetParError(1,0.09885527);
