...
//=========  (Wed Apr  1 22:36:22 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-19.25859,1050,5.09603);
   ...
   gre->SetPoint(0,-700,-13.79432);
   gre->SetPointError(0,0,1.405167);
   gre->SetPoint(1,-500,-9.3275);
   gre->SetPointError(1,0,1.694564);
   gre->SetPoint(2,-300,-3.08062);
   gre->SetPointError(2,0,0.8801897);
   gre->SetPoint(3,-100,-5.53166);
   gre->SetPointError(3,0,0.3048679);
   gre->SetPoint(4,100,-4.19122);
   gre->SetPointError(4,0,0.6015529);
   gre->SetPoint(5,300,0.04738);
   gre->SetPointError(5,0,0.9895469);
   gre->SetPoint(6,500,-1.1569);
   gre->SetPointError(6,0,0.7037151);
   gre->SetPoint(7,700,-0.44834);
   gre->SetPointError(7,0,0.528356);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: BI.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-16.82313);
   Graph_Graph14->SetMaximum(2.660568);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(36.03692);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006811771);
   linear_fit->SetParError(0,0.0006042041);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.645988);
   linear_fit->SetParError(1,0.2193782);
