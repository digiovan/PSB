...
//=========  (Wed Apr  1 22:34:47 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_1->Range(-1050,-6.301251,1050,1.822969);
   ...
   gre->SetPoint(0,-700,-4.87462);
   gre->SetPointError(0,0,0.07259463);
   gre->SetPoint(1,-500,-4.17878);
   gre->SetPointError(1,0,0.07934206);
   gre->SetPoint(2,-300,-3.31274);
   gre->SetPointError(2,0,0.09164735);
   gre->SetPoint(3,-100,-2.54746);
   gre->SetPointError(3,0,0.04271308);
   gre->SetPoint(4,100,-1.9412);
   gre->SetPointError(4,0,0.1029543);
   gre->SetPoint(5,300,-1.29074);
   gre->SetPointError(5,0,0.03467734);
   gre->SetPoint(6,500,-0.61762);
   gre->SetPointError(6,0,0.02408292);
   gre->SetPoint(7,700,0.45834);
   gre->SetPointError(7,0,0.01059246);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LT.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-5.488829);
   Graph_Graph11->SetMaximum(1.010547);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(167.9715);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003883605);
   linear_fit->SetParError(0,3.066248e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.307322);
   linear_fit->SetParError(1,0.01937626);
