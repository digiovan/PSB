...
//=========  (Wed Apr  1 22:35:03 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,2.552537,1050,15.23821);
   ...
   gre->SetPoint(0,-700,13.0748);
   gre->SetPointError(0,0,0.04913511);
   gre->SetPoint(1,-500,11.72916);
   gre->SetPointError(1,0,0.0588484);
   gre->SetPoint(2,-300,10.55168);
   gre->SetPointError(2,0,0.01226776);
   gre->SetPoint(3,-100,9.2122);
   gre->SetPointError(3,0,0.02513502);
   gre->SetPoint(4,100,8.01338);
   gre->SetPointError(4,0,0.01528434);
   gre->SetPoint(5,300,6.9262);
   gre->SetPointError(5,0,0.05586193);
   gre->SetPoint(6,500,5.93182);
   gre->SetPointError(6,0,0.05080722);
   gre->SetPoint(7,700,4.7057);
   gre->SetPointError(7,0,0.0388831);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LTB.DHZ10 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(3.821105);
   Graph_Graph11->SetMaximum(13.96965);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(122.0099);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00601934);
   linear_fit->SetParError(0,2.832764e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.708336);
   linear_fit->SetParError(1,0.008719983);
