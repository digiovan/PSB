...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_V_1->Range(-1050,-18.50416,1050,16.35267);
   ...
   gre->SetPoint(0,-700,-10.59122);
   gre->SetPointError(0,0,0.4807259);
   gre->SetPoint(1,-500,-12.56142);
   gre->SetPointError(1,0,0.1332654);
   gre->SetPoint(2,-300,-9.68664);
   gre->SetPointError(2,0,0.4534036);
   gre->SetPoint(3,-100,-6.30732);
   gre->SetPointError(3,0,0.0715284);
   gre->SetPoint(4,100,-2.5957);
   gre->SetPointError(4,0,0.244144);
   gre->SetPoint(5,300,2.49696);
   gre->SetPointError(5,0,0.07117499);
   gre->SetPoint(6,500,6.50858);
   gre->SetPointError(6,0,0.1924601);
   gre->SetPoint(7,700,10.35596);
   gre->SetPointError(7,0,0.1872425);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LT.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-15.01847);
   Graph_Graph13->SetMaximum(12.86699);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(371.2593);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01947633);
   linear_fit->SetParError(0,0.0001362131);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.644597);
   linear_fit->SetParError(1,0.04474023);
