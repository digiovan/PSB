...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-13.82998,1050,7.937089);
   ...
   gre->SetPoint(0,-700,4.12018);
   gre->SetPointError(0,0,0.1890636);
   gre->SetPoint(1,-500,1.8028);
   gre->SetPointError(1,0,0.1505414);
   gre->SetPoint(2,-300,0.1393);
   gre->SetPointError(2,0,0.3821843);
   gre->SetPoint(3,-100,-2.51864);
   gre->SetPointError(3,0,0.3667156);
   gre->SetPoint(4,100,-4.26036);
   gre->SetPointError(4,0,0.3010816);
   gre->SetPoint(5,300,-6.16554);
   gre->SetPointError(5,0,0.1515575);
   gre->SetPoint(6,500,-8.6741);
   gre->SetPointError(6,0,0.3533579);
   gre->SetPoint(7,700,-10.08464);
   gre->SetPointError(7,0,0.117496);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: BI.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-11.65327);
   Graph_Graph12->SetMaximum(5.760382);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.07203);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01006302);
   linear_fit->SetParError(0,0.0001247482);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.127878);
   linear_fit->SetParError(1,0.06860244);
