...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,-9.257046,1050,4.051917);
   ...
   gre->SetPoint(0,-700,-7.00152);
   gre->SetPointError(0,0,0.03736576);
   gre->SetPoint(1,-500,-5.76246);
   gre->SetPointError(1,0,0.04053092);
   gre->SetPoint(2,-300,-4.52466);
   gre->SetPointError(2,0,0.05790422);
   gre->SetPoint(3,-100,-3.27484);
   gre->SetPointError(3,0,0.0209066);
   gre->SetPoint(4,100,-1.97848);
   gre->SetPointError(4,0,0.02906831);
   gre->SetPoint(5,300,-0.747);
   gre->SetPointError(5,0,0.04187916);
   gre->SetPoint(6,500,0.56854);
   gre->SetPointError(6,0,0.01177625);
   gre->SetPoint(7,700,1.81274);
   gre->SetPointError(7,0,0.02101645);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: BI.DHZ10 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-7.92615);
   Graph_Graph12->SetMaximum(2.721021);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.762477);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006334457);
   linear_fit->SetParError(0,2.096581e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.610288);
   linear_fit->SetParError(1,0.01012102);
