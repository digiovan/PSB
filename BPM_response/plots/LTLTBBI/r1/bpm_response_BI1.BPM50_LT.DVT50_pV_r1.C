...
//=========  (Wed Apr  1 22:34:58 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-24.62202,1050,17.81633);
   ...
   gre->SetPoint(0,-700,10.18718);
   gre->SetPointError(0,0,0.5560944);
   gre->SetPoint(1,-500,7.61082);
   gre->SetPointError(1,0,0.3379277);
   gre->SetPoint(2,-300,4.337);
   gre->SetPointError(2,0,0.2215662);
   gre->SetPoint(3,-100,-1.30844);
   gre->SetPointError(3,0,0.2414611);
   gre->SetPoint(4,100,-6.66558);
   gre->SetPointError(4,0,0.03253371);
   gre->SetPoint(5,300,-12.35562);
   gre->SetPointError(5,0,0.1256336);
   gre->SetPoint(6,500,-17.09002);
   gre->SetPointError(6,0,0.4589405);
   gre->SetPoint(7,700,-15.22312);
   gre->SetPointError(7,0,1.765513);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LT.DVT50 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-20.37818);
   Graph_Graph14->SetMaximum(13.5725);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(99.77322);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02547047);
   linear_fit->SetParError(0,0.0002822075);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.152242);
   linear_fit->SetParError(1,0.04085492);
