...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_V_1->Range(-1050,-9.914414,1050,1.723231);
   ...
   gre->SetPoint(0,-700,-7.6065);
   gre->SetPointError(0,0,0.3683065);
   gre->SetPoint(1,-500,-6.6392);
   gre->SetPointError(1,0,0.5984299);
   gre->SetPoint(2,-300,-5.42532);
   gre->SetPointError(2,0,0.3315132);
   gre->SetPoint(3,-100,-3.80574);
   gre->SetPointError(3,0,0.7920548);
   gre->SetPoint(4,100,-2.99538);
   gre->SetPointError(4,0,0.2939794);
   gre->SetPoint(5,300,-2.75406);
   gre->SetPointError(5,0,0.2958306);
   gre->SetPoint(6,500,-0.69704);
   gre->SetPointError(6,0,0.0976899);
   gre->SetPoint(7,700,-0.38824);
   gre->SetPointError(7,0,0.1718634);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: BI.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-8.75065);
   Graph_Graph13->SetMaximum(0.5594664);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.83423);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005430505);
   linear_fit->SetParError(0,0.0002168166);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.666814);
   linear_fit->SetParError(1,0.1124336);
