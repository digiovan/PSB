...
//=========  (Wed Apr  1 22:34:16 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-15.15552,1050,6.744709);
   ...
   gre->SetPoint(0,-700,-11.26182);
   gre->SetPointError(0,0,0.2436609);
   gre->SetPoint(1,-500,-8.79068);
   gre->SetPointError(1,0,0.1181852);
   gre->SetPoint(2,-300,-7.0477);
   gre->SetPointError(2,0,0.1770277);
   gre->SetPoint(3,-100,-5.46944);
   gre->SetPointError(3,0,0.1499308);
   gre->SetPoint(4,100,-2.75164);
   gre->SetPointError(4,0,0.3764388);
   gre->SetPoint(5,300,-1.10162);
   gre->SetPointError(5,0,0.1174935);
   gre->SetPoint(6,500,1.23902);
   gre->SetPointError(6,0,0.4367692);
   gre->SetPoint(7,700,2.68874);
   gre->SetPointError(7,0,0.4059309);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-12.9655);
   Graph_Graph12->SetMaximum(4.554686);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.65741);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.009810436);
   linear_fit->SetParError(0,0.000166066);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.094654);
   linear_fit->SetParError(1,0.06597045);
