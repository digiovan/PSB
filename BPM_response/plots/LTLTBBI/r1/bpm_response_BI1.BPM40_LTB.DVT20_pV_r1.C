...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_V_1->Range(-1050,-14.54166,1050,6.305622);
   ...
   gre->SetPoint(0,-700,2.6393);
   gre->SetPointError(0,0,0.1917745);
   gre->SetPoint(1,-500,0.39714);
   gre->SetPointError(1,0,0.1964078);
   gre->SetPoint(2,-300,-1.61114);
   gre->SetPointError(2,0,0.2847226);
   gre->SetPoint(3,-100,-3.38092);
   gre->SetPointError(3,0,0.07531831);
   gre->SetPoint(4,100,-5.79422);
   gre->SetPointError(4,0,0.8134345);
   gre->SetPoint(5,300,-7.14268);
   gre->SetPointError(5,0,0.2904586);
   gre->SetPoint(6,500,-9.27216);
   gre->SetPointError(6,0,0.3611631);
   gre->SetPoint(7,700,-10.86778);
   gre->SetPointError(7,0,0.1993353);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LTB.DVT20 Plane: V Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-12.45693);
   Graph_Graph13->SetMaximum(4.220893);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.524879);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009592691);
   linear_fit->SetParError(0,0.0001684255);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.313624);
   linear_fit->SetParError(1,0.06119305);
