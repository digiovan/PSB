...
//=========  (Wed Apr  1 22:36:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-7.724532,1050,-0.8546367);
   ...
   gre->SetPoint(0,-700,-6.05596);
   gre->SetPointError(0,0,0.5235896);
   gre->SetPoint(1,-500,-4.31048);
   gre->SetPointError(1,0,0.03502126);
   gre->SetPoint(2,-300,-3.93364);
   gre->SetPointError(2,0,0.3525068);
   gre->SetPoint(3,-100,-3.8137);
   gre->SetPointError(3,0,0.09025854);
   gre->SetPoint(4,100,-3.0724);
   gre->SetPointError(4,0,0.2393897);
   gre->SetPoint(5,300,-2.74984);
   gre->SetPointError(5,0,0.1787945);
   gre->SetPoint(6,500,-2.3521);
   gre->SetPointError(6,0,0.1439758);
   gre->SetPoint(7,700,-2.3207);
   gre->SetPointError(7,0,0.3210807);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: BI.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-7.037543);
   Graph_Graph12->SetMaximum(-1.541626);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.02116);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001835374);
   linear_fit->SetParError(0,0.0001062268);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.416399);
   linear_fit->SetParError(1,0.04928119);
