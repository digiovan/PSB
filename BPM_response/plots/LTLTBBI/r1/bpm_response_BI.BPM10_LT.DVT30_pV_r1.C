...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_1->Range(-1050,-17.49308,1050,26.91443);
   ...
   gre->SetPoint(0,-700,-9.98836);
   gre->SetPointError(0,0,0.1034714);
   gre->SetPoint(1,-500,-5.46722);
   gre->SetPointError(1,0,0.03117596);
   gre->SetPoint(2,-300,-1.44748);
   gre->SetPointError(2,0,0.04347797);
   gre->SetPoint(3,-100,2.795);
   gre->SetPointError(3,0,0.1094104);
   gre->SetPoint(4,100,7.0215);
   gre->SetPointError(4,0,0.05050615);
   gre->SetPoint(5,300,11.52892);
   gre->SetPointError(5,0,0.1132307);
   gre->SetPoint(6,500,15.43796);
   gre->SetPointError(6,0,0.06341378);
   gre->SetPoint(7,700,19.3369);
   gre->SetPointError(7,0,0.1762752);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LT.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(-13.05233);
   Graph_Graph10->SetMaximum(22.47368);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.66137);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02095899);
   linear_fit->SetParError(0,5.554512e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.942846);
   linear_fit->SetParError(1,0.02337765);
