...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-10.5587,1050,-2.381013);
   ...
   gre->SetPoint(0,-700,-8.497);
   gre->SetPointError(0,0,0.6987498);
   gre->SetPoint(1,-500,-8.08136);
   gre->SetPointError(1,0,0.2411095);
   gre->SetPoint(2,-300,-7.63656);
   gre->SetPointError(2,0,0.2061323);
   gre->SetPoint(3,-100,-5.8055);
   gre->SetPointError(3,0,0.2451569);
   gre->SetPoint(4,100,-5.77274);
   gre->SetPointError(4,0,0.2799229);
   gre->SetPoint(5,300,-8.32424);
   gre->SetPointError(5,0,0.6668186);
   gre->SetPoint(6,500,-4.90158);
   gre->SetPointError(6,0,0.1694093);
   gre->SetPoint(7,700,-4.03192);
   gre->SetPointError(7,0,0.2879596);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: BI.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-9.740929);
   Graph_Graph14->SetMaximum(-3.198781);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(36.15662);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003129403);
   linear_fit->SetParError(0,0.0002138682);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.369674);
   linear_fit->SetParError(1,0.09217511);
