...
//=========  (Wed Apr  1 22:34:21 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,7.009835,1050,8.931185);
   ...
   gre->SetPoint(0,-700,7.3571);
   gre->SetPointError(0,0,0.02703993);
   gre->SetPoint(1,-500,7.61306);
   gre->SetPointError(1,0,0.08246993);
   gre->SetPoint(2,-300,7.72316);
   gre->SetPointError(2,0,0.02527996);
   gre->SetPoint(3,-100,7.90666);
   gre->SetPointError(3,0,0.01899456);
   gre->SetPoint(4,100,8.1201);
   gre->SetPointError(4,0,0.0142791);
   gre->SetPoint(5,300,8.37244);
   gre->SetPointError(5,0,0.02636898);
   gre->SetPoint(6,500,8.56824);
   gre->SetPointError(6,0,0.04271973);
   gre->SetPoint(7,700,8.05088);
   gre->SetPointError(7,0,0.05935964);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(7.20197);
   Graph_Graph12->SetMaximum(8.73905);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(121.1159);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.000894749);
   linear_fit->SetParError(0,2.753716e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.01267);
   linear_fit->SetParError(1,0.008799269);
