...
//=========  (Wed Apr  1 22:34:58 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_1->Range(-1050,-15.7153,1050,10.63457);
   ...
   gre->SetPoint(0,-700,-11.19264);
   gre->SetPointError(0,0,0.131019);
   gre->SetPoint(1,-500,-8.65846);
   gre->SetPointError(1,0,0.06644218);
   gre->SetPoint(2,-300,-6.00326);
   gre->SetPointError(2,0,0.02696002);
   gre->SetPoint(3,-100,-3.5466);
   gre->SetPointError(3,0,0.04001921);
   gre->SetPoint(4,100,-1.0869);
   gre->SetPointError(4,0,0.07586979);
   gre->SetPoint(5,300,1.31132);
   gre->SetPointError(5,0,0.02547402);
   gre->SetPoint(6,500,3.6368);
   gre->SetPointError(6,0,0.06839327);
   gre->SetPoint(7,700,6.11704);
   gre->SetPointError(7,0,0.1258811);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LT.DVT50 Plane: V Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-13.08032);
   Graph_Graph11->SetMaximum(7.999579);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.4184);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01224037);
   linear_fit->SetParError(0,4.767104e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.364109);
   linear_fit->SetParError(1,0.0152915);
