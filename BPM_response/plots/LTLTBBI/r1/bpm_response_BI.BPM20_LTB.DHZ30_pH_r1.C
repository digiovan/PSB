...
//=========  (Wed Apr  1 22:35:24 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,1.110019,1050,16.46643);
   ...
   gre->SetPoint(0,-700,13.84056);
   gre->SetPointError(0,0,0.06646741);
   gre->SetPoint(1,-500,12.25682);
   gre->SetPointError(1,0,0.0615541);
   gre->SetPoint(2,-300,10.72552);
   gre->SetPointError(2,0,0.05545472);
   gre->SetPoint(3,-100,9.24004);
   gre->SetPointError(3,0,0.02810047);
   gre->SetPoint(4,100,7.91808);
   gre->SetPointError(4,0,0.0247908);
   gre->SetPoint(5,300,6.4777);
   gre->SetPointError(5,0,0.08724767);
   gre->SetPoint(6,500,5.30644);
   gre->SetPointError(6,0,0.02235351);
   gre->SetPoint(7,700,3.7568);
   gre->SetPointError(7,0,0.08737936);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LTB.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(2.64566);
   Graph_Graph11->SetMaximum(14.93079);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(73.45064);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006888275);
   linear_fit->SetParError(0,3.75401e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.668778);
   linear_fit->SetParError(1,0.01383679);
