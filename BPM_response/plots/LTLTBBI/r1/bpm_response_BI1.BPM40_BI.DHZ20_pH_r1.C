...
//=========  (Wed Apr  1 22:35:55 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,-18.38379,1050,0.4763139);
   ...
   gre->SetPoint(0,-700,-15.08804);
   gre->SetPointError(0,0,0.1524003);
   gre->SetPoint(1,-500,-13.84826);
   gre->SetPointError(1,0,0.2858624);
   gre->SetPoint(2,-300,-11.4294);
   gre->SetPointError(2,0,0.1806381);
   gre->SetPoint(3,-100,-9.27798);
   gre->SetPointError(3,0,0.180946);
   gre->SetPoint(4,100,-8.97234);
   gre->SetPointError(4,0,0.4090249);
   gre->SetPoint(5,300,-7.1907);
   gre->SetPointError(5,0,0.2508848);
   gre->SetPoint(6,500,-4.94782);
   gre->SetPointError(6,0,0.5841371);
   gre->SetPoint(7,700,-3.0715);
   gre->SetPointError(7,0,0.4044629);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: BI.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-16.49778);
   Graph_Graph13->SetMaximum(-1.409697);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.75574);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008419512);
   linear_fit->SetParError(0,0.0002087468);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.084823);
   linear_fit->SetParError(1,0.09792901);
