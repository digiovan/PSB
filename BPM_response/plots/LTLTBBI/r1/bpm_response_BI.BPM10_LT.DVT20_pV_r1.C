...
//=========  (Wed Apr  1 22:34:26 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_1->Range(-1050,-8.268365,1050,17.09866);
   ...
   gre->SetPoint(0,-700,-3.83696);
   gre->SetPointError(0,0,0.2035677);
   gre->SetPoint(1,-500,-1.60618);
   gre->SetPointError(1,0,0.08731889);
   gre->SetPoint(2,-300,1.29508);
   gre->SetPointError(2,0,0.1067306);
   gre->SetPoint(3,-100,3.94324);
   gre->SetPointError(3,0,0.09225683);
   gre->SetPoint(4,100,6.299);
   gre->SetPointError(4,0,0.1012878);
   gre->SetPoint(5,300,8.31768);
   gre->SetPointError(5,0,0.04412636);
   gre->SetPoint(6,500,10.45184);
   gre->SetPointError(6,0,0.208482);
   gre->SetPoint(7,700,12.80196);
   gre->SetPointError(7,0,0.06885951);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LT.DVT20 Plane: V Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(-5.731662);
   Graph_Graph10->SetMaximum(14.56195);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(70.1803);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01183489);
   linear_fit->SetParError(0,7.537879e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.731989);
   linear_fit->SetParError(1,0.03145926);
