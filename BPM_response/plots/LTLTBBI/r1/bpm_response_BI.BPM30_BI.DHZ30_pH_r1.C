...
//=========  (Wed Apr  1 22:36:06 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,-4.346699,1050,-1.095031);
   ...
   gre->SetPoint(0,-700,-3.7996);
   gre->SetPointError(0,0,0.005154234);
   gre->SetPoint(1,-500,-3.4457);
   gre->SetPointError(1,0,0.02470309);
   gre->SetPoint(2,-300,-3.0777);
   gre->SetPointError(2,0,0.02847014);
   gre->SetPoint(3,-100,-2.74036);
   gre->SetPointError(3,0,0.02210258);
   gre->SetPoint(4,100,-2.46402);
   gre->SetPointError(4,0,0.02371374);
   gre->SetPoint(5,300,-2.19012);
   gre->SetPointError(5,0,0.003559488);
   gre->SetPoint(6,500,-1.93768);
   gre->SetPointError(6,0,0.008491792);
   gre->SetPoint(7,700,-1.6567);
   gre->SetPointError(7,0,0.01972459);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: BI.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-4.021532);
   Graph_Graph12->SetMaximum(-1.420198);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(107.8149);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001586084);
   linear_fit->SetParError(0,5.710538e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.678031);
   linear_fit->SetParError(1,0.00268276);
