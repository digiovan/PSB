...
//=========  (Wed Apr  1 22:34:53 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-5.171379,1050,9.904877);
   ...
   gre->SetPoint(0,-700,-1.82534);
   gre->SetPointError(0,0,0.83333);
   gre->SetPoint(1,-500,3.97602);
   gre->SetPointError(1,0,0.09334452);
   gre->SetPoint(2,-300,1.8673);
   gre->SetPointError(2,0,0.2910091);
   gre->SetPoint(3,-100,6.26642);
   gre->SetPointError(3,0,0.07052007);
   gre->SetPoint(4,100,7.08494);
   gre->SetPointError(4,0,0.1765263);
   gre->SetPoint(5,300,3.8114);
   gre->SetPointError(5,0,0.5452412);
   gre->SetPoint(6,500,7.32574);
   gre->SetPointError(6,0,0.06642713);
   gre->SetPoint(7,700,0.28474);
   gre->SetPointError(7,0,0.8235047);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LT.DHZ50 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-3.663754);
   Graph_Graph14->SetMaximum(8.397251);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(413.0539);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003105073);
   linear_fit->SetParError(0,0.0001064653);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,5.944808);
   linear_fit->SetParError(1,0.04159766);
