...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,-13.74413,1050,-4.830939);
   ...
   gre->SetPoint(0,-700,-11.68496);
   gre->SetPointError(0,0,0.5736351);
   gre->SetPoint(1,-500,-11.2787);
   gre->SetPointError(1,0,0.1822526);
   gre->SetPoint(2,-300,-10.43904);
   gre->SetPointError(2,0,0.2198783);
   gre->SetPoint(3,-100,-8.82408);
   gre->SetPointError(3,0,0.2228943);
   gre->SetPoint(4,100,-8.55146);
   gre->SetPointError(4,0,0.3011972);
   gre->SetPoint(5,300,-10.21748);
   gre->SetPointError(5,0,0.4499591);
   gre->SetPoint(6,500,-7.49278);
   gre->SetPointError(6,0,0.07609156);
   gre->SetPoint(7,700,-6.51982);
   gre->SetPointError(7,0,0.20335);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: BI.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-12.85281);
   Graph_Graph13->SetMaximum(-5.722257);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(37.61791);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003601143);
   linear_fit->SetParError(0,0.000150612);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.256423);
   linear_fit->SetParError(1,0.07260974);
