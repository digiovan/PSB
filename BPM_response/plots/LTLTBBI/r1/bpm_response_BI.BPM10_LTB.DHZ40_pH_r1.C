...
//=========  (Wed Apr  1 22:35:34 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_1->Range(-1050,-17.58612,1050,10.24019);
   ...
   gre->SetPoint(0,-700,-12.899);
   gre->SetPointError(0,0,0.04939788);
   gre->SetPoint(1,-500,-10.37366);
   gre->SetPointError(1,0,0.07561336);
   gre->SetPoint(2,-300,-7.557);
   gre->SetPointError(2,0,0.08562356);
   gre->SetPoint(3,-100,-4.57798);
   gre->SetPointError(3,0,0.3122141);
   gre->SetPoint(4,100,-2.21838);
   gre->SetPointError(4,0,0.08933463);
   gre->SetPoint(5,300,-0.06744);
   gre->SetPointError(5,0,0.1604462);
   gre->SetPoint(6,500,3.01176);
   gre->SetPointError(6,0,0.1707031);
   gre->SetPoint(7,700,5.43196);
   gre->SetPointError(7,0,0.1705119);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LTB.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(-14.80348);
   Graph_Graph10->SetMaximum(7.457559);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.40047);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01319065);
   linear_fit->SetParError(0,7.919698e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.67213);
   linear_fit->SetParError(1,0.04321448);
