...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,0.2955586,1050,11.53357);
   ...
   gre->SetPoint(0,-700,7.37616);
   gre->SetPointError(0,0,0.07092265);
   gre->SetPoint(1,-500,8.59552);
   gre->SetPointError(1,0,0.1698069);
   gre->SetPoint(2,-300,6.76262);
   gre->SetPointError(2,0,0.1104377);
   gre->SetPoint(3,-100,9.59226);
   gre->SetPointError(3,0,0.06830702);
   gre->SetPoint(4,100,6.62418);
   gre->SetPointError(4,0,0.2729502);
   gre->SetPoint(5,300,9.22244);
   gre->SetPointError(5,0,0.1120474);
   gre->SetPoint(6,500,8.46964);
   gre->SetPointError(6,0,0.289334);
   gre->SetPoint(7,700,2.5841);
   gre->SetPointError(7,0,0.4155397);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LT.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(1.41936);
   Graph_Graph13->SetMaximum(10.40977);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(819.1498);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001534413);
   linear_fit->SetParError(0,0.0001084276);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.696589);
   linear_fit->SetParError(1,0.04860603);
