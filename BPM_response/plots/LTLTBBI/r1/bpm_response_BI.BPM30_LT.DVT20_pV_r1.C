...
//=========  (Wed Apr  1 22:34:26 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-26.42243,1050,16.27384);
   ...
   gre->SetPoint(0,-700,4.51038);
   gre->SetPointError(0,0,0.2252255);
   gre->SetPoint(1,-500,8.99396);
   gre->SetPointError(1,0,0.1638368);
   gre->SetPoint(2,-300,3.40206);
   gre->SetPointError(2,0,0.2145294);
   gre->SetPoint(3,-100,-1.85582);
   gre->SetPointError(3,0,0.1671645);
   gre->SetPoint(4,100,-6.46348);
   gre->SetPointError(4,0,0.2290054);
   gre->SetPoint(5,300,-10.74826);
   gre->SetPointError(5,0,0.05585646);
   gre->SetPoint(6,500,-14.9847);
   gre->SetPointError(6,0,0.4537024);
   gre->SetPoint(7,700,-19.18632);
   gre->SetPointError(7,0,0.1200663);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DVT20 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-22.1528);
   Graph_Graph12->SetMaximum(12.00422);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1029.337);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0209782);
   linear_fit->SetParError(0,0.0001249521);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.364569);
   linear_fit->SetParError(1,0.0502761);
