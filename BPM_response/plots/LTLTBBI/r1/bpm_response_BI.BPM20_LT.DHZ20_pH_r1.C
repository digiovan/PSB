...
//=========  (Wed Apr  1 22:34:21 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,6.390295,1050,10.79163);
   ...
   gre->SetPoint(0,-700,10.047);
   gre->SetPointError(0,0,0.01107361);
   gre->SetPoint(1,-500,9.81328);
   gre->SetPointError(1,0,0.04359384);
   gre->SetPoint(2,-300,9.34864);
   gre->SetPointError(2,0,0.04484995);
   gre->SetPoint(3,-100,8.8537);
   gre->SetPointError(3,0,0.01970706);
   gre->SetPoint(4,100,8.47674);
   gre->SetPointError(4,0,0.01196693);
   gre->SetPoint(5,300,8.18172);
   gre->SetPointError(5,0,0.04913876);
   gre->SetPoint(6,500,7.87286);
   gre->SetPointError(6,0,0.05556829);
   gre->SetPoint(7,700,7.14412);
   gre->SetPointError(7,0,0.02026929);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LT.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(6.830428);
   Graph_Graph11->SetMaximum(10.3515);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(70.15232);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002024443);
   linear_fit->SetParError(0,1.420304e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.653905);
   linear_fit->SetParError(1,0.007167139);
