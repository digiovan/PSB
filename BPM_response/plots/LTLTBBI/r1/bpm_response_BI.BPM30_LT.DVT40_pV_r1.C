...
//=========  (Wed Apr  1 22:34:47 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-15.52803,1050,8.031837);
   ...
   gre->SetPoint(0,-700,-11.30674);
   gre->SetPointError(0,0,0.2946432);
   gre->SetPoint(1,-500,-9.3935);
   gre->SetPointError(1,0,0.3251207);
   gre->SetPoint(2,-300,-6.92136);
   gre->SetPointError(2,0,0.331805);
   gre->SetPoint(3,-100,-4.72152);
   gre->SetPointError(3,0,0.1576485);
   gre->SetPoint(4,100,-3.10802);
   gre->SetPointError(4,0,0.344781);
   gre->SetPoint(5,300,-1.38654);
   gre->SetPointError(5,0,0.1510693);
   gre->SetPoint(6,500,0.49046);
   gre->SetPointError(6,0,0.1355056);
   gre->SetPoint(7,700,4.05096);
   gre->SetPointError(7,0,0.05423307);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-13.17204);
   Graph_Graph12->SetMaximum(5.675851);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(118.8024);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01119225);
   linear_fit->SetParError(0,0.0001259466);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.986858);
   linear_fit->SetParError(1,0.0770467);
