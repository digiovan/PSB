...
//=========  (Wed Apr  1 22:34:16 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_1->Range(-1050,-1.272836,1050,11.45552);
   ...
   gre->SetPoint(0,-700,9.24232);
   gre->SetPointError(0,0,0.0866966);
   gre->SetPoint(1,-500,7.8062);
   gre->SetPointError(1,0,0.01587246);
   gre->SetPoint(2,-300,6.72504);
   gre->SetPointError(2,0,0.05309765);
   gre->SetPoint(3,-100,5.7567);
   gre->SetPointError(3,0,0.0638702);
   gre->SetPoint(4,100,4.26544);
   gre->SetPointError(4,0,0.1767769);
   gre->SetPoint(5,300,3.27008);
   gre->SetPointError(5,0,0.05924335);
   gre->SetPoint(6,500,1.80258);
   gre->SetPointError(6,0,0.2000084);
   gre->SetPoint(7,700,0.98942);
   gre->SetPointError(7,0,0.1971111);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LT.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(0);
   Graph_Graph10->SetMaximum(10.18269);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.25979);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005680964);
   linear_fit->SetParError(0,6.024432e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.986279);
   linear_fit->SetParError(1,0.02852628);
