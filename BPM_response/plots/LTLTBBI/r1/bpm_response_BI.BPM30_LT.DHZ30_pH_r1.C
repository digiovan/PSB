...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,3.508974,1050,11.57018);
   ...
   gre->SetPoint(0,-700,10.19056);
   gre->SetPointError(0,0,0.03608265);
   gre->SetPoint(1,-500,9.68922);
   gre->SetPointError(1,0,0.05863563);
   gre->SetPoint(2,-300,8.9174);
   gre->SetPointError(2,0,0.05270568);
   gre->SetPoint(3,-100,8.42774);
   gre->SetPointError(3,0,0.02349663);
   gre->SetPoint(4,100,7.62686);
   gre->SetPointError(4,0,0.04806123);
   gre->SetPoint(5,300,7.04374);
   gre->SetPointError(5,0,0.01219898);
   gre->SetPoint(6,500,6.28224);
   gre->SetPointError(6,0,0.02854593);
   gre->SetPoint(7,700,4.94212);
   gre->SetPointError(7,0,0.08961226);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(4.315094);
   Graph_Graph12->SetMaximum(10.76406);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(113.4069);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003306278);
   linear_fit->SetParError(0,2.881791e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.009677);
   linear_fit->SetParError(1,0.01022223);
