...
//=========  (Wed Apr  1 22:35:55 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,-13.71831,1050,11.17889);
   ...
   gre->SetPoint(0,-700,-9.55302);
   gre->SetPointError(0,0,0.01575474);
   gre->SetPoint(1,-500,-7.01676);
   gre->SetPointError(1,0,0.01932879);
   gre->SetPoint(2,-300,-4.5572);
   gre->SetPointError(2,0,0.04746941);
   gre->SetPoint(3,-100,-2.14272);
   gre->SetPointError(3,0,0.07307778);
   gre->SetPoint(4,100,0.19486);
   gre->SetPointError(4,0,0.01073971);
   gre->SetPoint(5,300,2.57986);
   gre->SetPointError(5,0,0.0143815);
   gre->SetPoint(6,500,4.80282);
   gre->SetPointError(6,0,0.0331339);
   gre->SetPoint(7,700,7.00604);
   gre->SetPointError(7,0,0.02331615);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: BI.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-11.22859);
   Graph_Graph11->SetMaximum(8.689169);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(290.9292);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01195355);
   linear_fit->SetParError(0,1.519108e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.071612);
   linear_fit->SetParError(1,0.006512581);
