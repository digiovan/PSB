...
//=========  (Wed Apr  1 22:35:34 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_1->Range(-1050,-0.1374903,1050,1.237412);
   ...
   gre->SetPoint(0,-700,0.2315);
   gre->SetPointError(0,0,0.09722047);
   gre->SetPoint(1,-500,0.53484);
   gre->SetPointError(1,0,0.1196942);
   gre->SetPoint(2,-300,0.57324);
   gre->SetPointError(2,0,0.1046264);
   gre->SetPoint(3,-100,0.63078);
   gre->SetPointError(3,0,0.3718148);
   gre->SetPoint(4,100,0.5382);
   gre->SetPointError(4,0,0.08965761);
   gre->SetPoint(5,300,0.7883);
   gre->SetPointError(5,0,0.1112553);
   gre->SetPoint(6,500,0.08662);
   gre->SetPointError(6,0,0.05729682);
   gre->SetPoint(7,700,0.4465);
   gre->SetPointError(7,0,0.1187351);
   
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","Corr: LTB.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph6->SetMinimum(0);
   Graph_Graph6->SetMaximum(1.099922);
   Graph_Graph6->SetDirectory(0);
   Graph_Graph6->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph6->SetLineColor(ci);
   Graph_Graph6->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(46.59251);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001477777);
   linear_fit->SetParError(0,7.353179e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.3771785);
   linear_fit->SetParError(1,0.03529855);
