...
//=========  (Wed Apr  1 22:36:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_1->Range(-1050,-2.935617,1050,-2.167912);
   ...
   gre->SetPoint(0,-700,-2.68982);
   gre->SetPointError(0,0,0.1178464);
   gre->SetPoint(1,-500,-2.38954);
   gre->SetPointError(1,0,0.01184861);
   gre->SetPoint(2,-300,-2.39226);
   gre->SetPointError(2,0,0.09639721);
   gre->SetPoint(3,-100,-2.45042);
   gre->SetPointError(3,0,0.02540777);
   gre->SetPoint(4,100,-2.41054);
   gre->SetPointError(4,0,0.05415704);
   gre->SetPoint(5,300,-2.44118);
   gre->SetPointError(5,0,0.04425074);
   gre->SetPoint(6,500,-2.44242);
   gre->SetPointError(6,0,0.03901045);
   gre->SetPoint(7,700,-2.53918);
   gre->SetPointError(7,0,0.06525293);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: BI.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-2.858847);
   Graph_Graph11->SetMaximum(-2.244682);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.732711);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.237426e-05);
   linear_fit->SetParError(0,2.826309e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.431575);
   linear_fit->SetParError(1,0.01279049);
