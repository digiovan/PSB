...
//=========  (Wed Apr  1 22:36:00 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-9.847473,1050,2.782672);
   ...
   gre->SetPoint(0,-700,-7.67132);
   gre->SetPointError(0,0,0.07112904);
   gre->SetPoint(1,-500,-5.7546);
   gre->SetPointError(1,0,0.03920938);
   gre->SetPoint(2,-300,-5.15116);
   gre->SetPointError(2,0,0.1468031);
   gre->SetPoint(3,-100,-3.53772);
   gre->SetPointError(3,0,0.4811576);
   gre->SetPoint(4,100,-2.55562);
   gre->SetPointError(4,0,0.116217);
   gre->SetPoint(5,300,-1.58184);
   gre->SetPointError(5,0,0.2074574);
   gre->SetPoint(6,500,-0.4717);
   gre->SetPointError(6,0,0.4519796);
   gre->SetPoint(7,700,0.50606);
   gre->SetPointError(7,0,0.1715879);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: BI.DVT20 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-8.584459);
   Graph_Graph12->SetMaximum(1.519658);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(102.7192);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005704294);
   linear_fit->SetParError(0,0.0001002125);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.12093);
   linear_fit->SetParError(1,0.05253032);
