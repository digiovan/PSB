...
//=========  (Wed Apr  1 22:35:39 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-31.10873,1050,19.17988);
   ...
   gre->SetPoint(0,-700,6.29354);
   gre->SetPointError(0,0,0.04254332);
   gre->SetPoint(1,-500,10.75874);
   gre->SetPointError(1,0,0.03970332);
   gre->SetPoint(2,-300,5.3331);
   gre->SetPointError(2,0,0.1786319);
   gre->SetPoint(3,-100,-0.82106);
   gre->SetPointError(3,0,0.3080278);
   gre->SetPoint(4,100,-5.47612);
   gre->SetPointError(4,0,0.117956);
   gre->SetPoint(5,300,-11.5639);
   gre->SetPointError(5,0,0.08864027);
   gre->SetPoint(6,500,-16.4752);
   gre->SetPointError(6,0,0.143028);
   gre->SetPoint(7,700,-22.23812);
   gre->SetPointError(7,0,0.4891775);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LTB.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-26.07987);
   Graph_Graph12->SetMaximum(14.15102);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22545.56);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01942454);
   linear_fit->SetParError(0,7.439612e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.218739);
   linear_fit->SetParError(1,0.04140349);
