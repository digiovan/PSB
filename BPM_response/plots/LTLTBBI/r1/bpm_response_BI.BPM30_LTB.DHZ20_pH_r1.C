...
//=========  (Wed Apr  1 22:35:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,-3.989851,1050,19.181);
   ...
   gre->SetPoint(0,-700,15.22722);
   gre->SetPointError(0,0,0.09196822);
   gre->SetPoint(1,-500,13.04018);
   gre->SetPointError(1,0,0.07585595);
   gre->SetPoint(2,-300,10.87824);
   gre->SetPointError(2,0,0.09291656);
   gre->SetPoint(3,-100,8.93976);
   gre->SetPointError(3,0,0.02111366);
   gre->SetPoint(4,100,6.8513);
   gre->SetPointError(4,0,0.02761776);
   gre->SetPoint(5,300,4.5499);
   gre->SetPointError(5,0,0.07246775);
   gre->SetPoint(6,500,2.2533);
   gre->SetPointError(6,0,0.03613866);
   gre->SetPoint(7,700,-0.0493);
   gre->SetPointError(7,0,0.07874296);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LTB.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-1.672766);
   Graph_Graph12->SetMaximum(16.86391);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(60.48246);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01094041);
   linear_fit->SetParError(0,4.867299e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.823412);
   linear_fit->SetParError(1,0.01424257);
