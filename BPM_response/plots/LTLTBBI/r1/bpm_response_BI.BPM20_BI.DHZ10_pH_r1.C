...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,-8.279227,1050,6.410124);
   ...
   gre->SetPoint(0,-700,-5.79738);
   gre->SetPointError(0,0,0.03362198);
   gre->SetPoint(1,-500,-4.4442);
   gre->SetPointError(1,0,0.01623269);
   gre->SetPoint(2,-300,-3.07998);
   gre->SetPointError(2,0,0.03912848);
   gre->SetPoint(3,-100,-1.70658);
   gre->SetPointError(3,0,0.0155009);
   gre->SetPoint(4,100,-0.2834);
   gre->SetPointError(4,0,0.03769145);
   gre->SetPoint(5,300,1.07124);
   gre->SetPointError(5,0,0.044597);
   gre->SetPoint(6,500,2.51214);
   gre->SetPointError(6,0,0.006727806);
   gre->SetPoint(7,700,3.93644);
   gre->SetPointError(7,0,0.02545892);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: BI.DHZ10 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-6.810292);
   Graph_Graph11->SetMaximum(4.941189);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.61454);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006969271);
   linear_fit->SetParError(0,1.368568e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.9739882);
   linear_fit->SetParError(1,0.006528672);
