...
//=========  (Wed Apr  1 22:35:55 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_1->Range(-1050,-2.924295,1050,-2.144772);
   ...
   gre->SetPoint(0,-700,-2.53396);
   gre->SetPointError(0,0,0.06484087);
   gre->SetPoint(1,-500,-2.51454);
   gre->SetPointError(1,0,0.09693093);
   gre->SetPoint(2,-300,-2.57142);
   gre->SetPointError(2,0,0.1816986);
   gre->SetPoint(3,-100,-2.35356);
   gre->SetPointError(3,0,0.07886777);
   gre->SetPoint(4,100,-2.74284);
   gre->SetPointError(4,0,0.03874263);
   gre->SetPoint(5,300,-2.59572);
   gre->SetPointError(5,0,0.03501471);
   gre->SetPoint(6,500,-2.60922);
   gre->SetPointError(6,0,0.1851546);
   gre->SetPoint(7,700,-2.65042);
   gre->SetPointError(7,0,0.07399276);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: BI.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(-2.846343);
   Graph_Graph10->SetMaximum(-2.222724);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.85502);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001032048);
   linear_fit->SetParError(0,5.728092e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.606417);
   linear_fit->SetParError(1,0.02185037);
