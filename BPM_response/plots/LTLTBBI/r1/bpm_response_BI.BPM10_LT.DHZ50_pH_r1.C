...
//=========  (Wed Apr  1 22:34:52 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_1->Range(-1050,-10.5695,1050,4.631998);
   ...
   gre->SetPoint(0,-700,1.88742);
   gre->SetPointError(0,0,0.2109952);
   gre->SetPoint(1,-500,0.90892);
   gre->SetPointError(1,0,0.04033668);
   gre->SetPoint(2,-300,-0.8358);
   gre->SetPointError(2,0,0.0527326);
   gre->SetPoint(3,-100,-1.87236);
   gre->SetPointError(3,0,0.05969125);
   gre->SetPoint(4,100,-3.4118);
   gre->SetPointError(4,0,0.08339345);
   gre->SetPoint(5,300,-4.98458);
   gre->SetPointError(5,0,0.08044897);
   gre->SetPoint(6,500,-5.8232);
   gre->SetPointError(6,0,0.1138158);
   gre->SetPoint(7,700,-7.79762);
   gre->SetPointError(7,0,0.2382934);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LT.DHZ50 Plane: H Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(-9.049346);
   Graph_Graph10->SetMaximum(3.111848);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(50.93865);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007011703);
   linear_fit->SetParError(0,7.649693e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.698639);
   linear_fit->SetParError(1,0.02918244);
