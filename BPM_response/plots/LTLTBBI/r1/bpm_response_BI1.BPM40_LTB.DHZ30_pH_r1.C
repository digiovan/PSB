...
//=========  (Wed Apr  1 22:35:24 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,-13.4542,1050,12.64913);
   ...
   gre->SetPoint(0,-700,3.6537);
   gre->SetPointError(0,0,1.027954);
   gre->SetPoint(1,-500,0.13434);
   gre->SetPointError(1,0,0.3001595);
   gre->SetPoint(2,-300,5.96632);
   gre->SetPointError(2,0,0.519741);
   gre->SetPoint(3,-100,7.41208);
   gre->SetPointError(3,0,0.8864988);
   gre->SetPoint(4,100,3.76776);
   gre->SetPointError(4,0,0.1808596);
   gre->SetPoint(5,300,-0.9738);
   gre->SetPointError(5,0,0.2679768);
   gre->SetPoint(6,500,-4.68964);
   gre->SetPointError(6,0,1.188455);
   gre->SetPoint(7,700,-8.44248);
   gre->SetPointError(7,0,0.6611609);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LTB.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-10.84386);
   Graph_Graph13->SetMaximum(10.0388);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(560.8818);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003374477);
   linear_fit->SetParError(0,0.0003954568);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.880742);
   linear_fit->SetParError(1,0.1249586);
