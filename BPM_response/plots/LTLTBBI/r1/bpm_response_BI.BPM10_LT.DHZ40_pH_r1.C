...
//=========  (Wed Apr  1 22:34:42 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_1->Range(-1050,-11.76755,1050,6.48372);
   ...
   gre->SetPoint(0,-700,-8.57914);
   gre->SetPointError(0,0,0.14653);
   gre->SetPoint(1,-500,-6.6091);
   gre->SetPointError(1,0,0.1150212);
   gre->SetPoint(2,-300,-5.34394);
   gre->SetPointError(2,0,0.1062475);
   gre->SetPoint(3,-100,-3.4919);
   gre->SetPointError(3,0,0.2134852);
   gre->SetPoint(4,100,-1.67418);
   gre->SetPointError(4,0,0.2348879);
   gre->SetPoint(5,300,-0.36396);
   gre->SetPointError(5,0,0.05016472);
   gre->SetPoint(6,500,1.9098);
   gre->SetPointError(6,0,0.3035451);
   gre->SetPoint(7,700,3.26914);
   gre->SetPointError(7,0,0.1727017);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LT.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(-9.942421);
   Graph_Graph10->SetMaximum(4.658593);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.79705);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008188372);
   linear_fit->SetParError(0,9.936729e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.756964);
   linear_fit->SetParError(1,0.03869015);
