...
//=========  (Wed Apr  1 22:35:24 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,-2.098593,1050,18.88733);
   ...
   gre->SetPoint(0,-700,15.26614);
   gre->SetPointError(0,0,0.08467553);
   gre->SetPoint(1,-500,13.0759);
   gre->SetPointError(1,0,0.07034021);
   gre->SetPoint(2,-300,10.99544);
   gre->SetPointError(2,0,0.08608694);
   gre->SetPoint(3,-100,8.84538);
   gre->SetPointError(3,0,0.02531217);
   gre->SetPoint(4,100,6.94308);
   gre->SetPointError(4,0,0.02287155);
   gre->SetPoint(5,300,4.94156);
   gre->SetPointError(5,0,0.1359321);
   gre->SetPoint(6,500,3.20856);
   gre->SetPointError(6,0,0.04980252);
   gre->SetPoint(7,700,1.06342);
   gre->SetPointError(7,0,0.09186025);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LTB.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(0);
   Graph_Graph12->SetMaximum(16.78874);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(60.15492);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009906465);
   linear_fit->SetParError(0,5.526594e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.951622);
   linear_fit->SetParError(1,0.01491313);
