...
//=========  (Wed Apr  1 22:36:16 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,-1.162144,1050,-0.8793195);
   ...
   gre->SetPoint(0,-700,-1.06772);
   gre->SetPointError(0,0,0.04728689);
   gre->SetPoint(1,-500,-1.01322);
   gre->SetPointError(1,0,0.03919542);
   gre->SetPoint(2,-300,-0.99852);
   gre->SetPointError(2,0,0.01016161);
   gre->SetPoint(3,-100,-0.95968);
   gre->SetPointError(3,0,0.03322304);
   gre->SetPoint(4,100,-1.01224);
   gre->SetPointError(4,0,0.05540999);
   gre->SetPoint(5,300,-1.02244);
   gre->SetPointError(5,0,0.02982977);
   gre->SetPoint(6,500,-1.02374);
   gre->SetPointError(6,0,0.0165757);
   gre->SetPoint(7,700,-1.06918);
   gre->SetPointError(7,0,0.0381376);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: BI.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-1.133862);
   Graph_Graph11->SetMaximum(-0.907602);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.094479);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.938968e-05);
   linear_fit->SetParError(0,1.976209e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.010279);
   linear_fit->SetParError(1,0.007644961);
