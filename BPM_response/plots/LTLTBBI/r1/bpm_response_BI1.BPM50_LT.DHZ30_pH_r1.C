...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-0.03189082,1050,7.958107);
   ...
   gre->SetPoint(0,-700,3.76008);
   gre->SetPointError(0,0,0.133822);
   gre->SetPoint(1,-500,5.33346);
   gre->SetPointError(1,0,0.07010203);
   gre->SetPoint(2,-300,3.17916);
   gre->SetPointError(2,0,0.07637179);
   gre->SetPoint(3,-100,6.40882);
   gre->SetPointError(3,0,0.07783507);
   gre->SetPoint(4,100,3.50738);
   gre->SetPointError(4,0,0.3717631);
   gre->SetPoint(5,300,6.50876);
   gre->SetPointError(5,0,0.1176804);
   gre->SetPoint(6,500,6.2167);
   gre->SetPointError(6,0,0.2612014);
   gre->SetPoint(7,700,1.60576);
   gre->SetPointError(7,0,0.3059845);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LT.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(0.767109);
   Graph_Graph14->SetMaximum(7.159107);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1185.015);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001450846);
   linear_fit->SetParError(0,0.0001205927);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,5.353466);
   linear_fit->SetParError(1,0.04795314);
