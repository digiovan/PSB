...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-8.887611,1050,-3.855479);
   ...
   gre->SetPoint(0,-700,-5.6571);
   gre->SetPointError(0,0,0.2843111);
   gre->SetPoint(1,-500,-4.90262);
   gre->SetPointError(1,0,0.2084527);
   gre->SetPoint(2,-300,-5.88638);
   gre->SetPointError(2,0,0.210186);
   gre->SetPoint(3,-100,-6.516);
   gre->SetPointError(3,0,0.429354);
   gre->SetPoint(4,100,-5.92232);
   gre->SetPointError(4,0,0.127585);
   gre->SetPoint(5,300,-7.61552);
   gre->SetPointError(5,0,0.4334022);
   gre->SetPoint(6,500,-7.24154);
   gre->SetPointError(6,0,0.1587184);
   gre->SetPoint(7,700,-6.65846);
   gre->SetPointError(7,0,0.4309831);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: BI.DHZ10 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-8.384398);
   Graph_Graph14->SetMaximum(-4.358692);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(31.65564);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001627208);
   linear_fit->SetParError(0,0.0001907712);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.120445);
   linear_fit->SetParError(1,0.0756488);
