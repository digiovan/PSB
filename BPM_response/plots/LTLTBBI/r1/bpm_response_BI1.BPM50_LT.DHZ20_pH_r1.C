...
//=========  (Wed Apr  1 22:34:21 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-0.1492378,1050,8.643173);
   ...
   gre->SetPoint(0,-700,2.40888);
   gre->SetPointError(0,0,0.1379549);
   gre->SetPoint(1,-500,3.14838);
   gre->SetPointError(1,0,0.05127816);
   gre->SetPoint(2,-300,4.45282);
   gre->SetPointError(2,0,0.1079923);
   gre->SetPoint(3,-100,3.84714);
   gre->SetPointError(3,0,0.1644563);
   gre->SetPoint(4,100,3.96116);
   gre->SetPointError(4,0,0.2437042);
   gre->SetPoint(5,300,6.89104);
   gre->SetPointError(5,0,0.2867315);
   gre->SetPoint(6,500,6.07512);
   gre->SetPointError(6,0,0.1250752);
   gre->SetPoint(7,700,1.89618);
   gre->SetPointError(7,0,0.5800159);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LT.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(0.7300034);
   Graph_Graph14->SetMaximum(7.763932);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(158.0696);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002797011);
   linear_fit->SetParError(0,0.0001152076);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.604016);
   linear_fit->SetParError(1,0.05483951);
