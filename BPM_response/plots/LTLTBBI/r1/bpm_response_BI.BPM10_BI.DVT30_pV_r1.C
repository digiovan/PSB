...
//=========  (Wed Apr  1 22:36:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_1->Range(-1050,4.547031,1050,5.838969);
   ...
   gre->SetPoint(0,-700,5.42864);
   gre->SetPointError(0,0,0.1950058);
   gre->SetPoint(1,-500,4.9093);
   gre->SetPointError(1,0,0.03167637);
   gre->SetPoint(2,-300,4.93994);
   gre->SetPointError(2,0,0.1775862);
   gre->SetPoint(3,-100,4.98202);
   gre->SetPointError(3,0,0.0497078);
   gre->SetPoint(4,100,4.9926);
   gre->SetPointError(4,0,0.08882878);
   gre->SetPoint(5,300,5.01718);
   gre->SetPointError(5,0,0.07241972);
   gre->SetPoint(6,500,4.99938);
   gre->SetPointError(6,0,0.07804849);
   gre->SetPoint(7,700,5.16238);
   gre->SetPointError(7,0,0.07424722);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: BI.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(4.676225);
   Graph_Graph10->SetMaximum(5.709775);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.356894);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001384873);
   linear_fit->SetParError(0,5.141558e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.992104);
   linear_fit->SetParError(1,0.02279882);
