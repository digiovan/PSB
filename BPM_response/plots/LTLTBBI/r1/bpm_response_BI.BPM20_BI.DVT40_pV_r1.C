...
//=========  (Wed Apr  1 22:36:22 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_1->Range(-1050,-2.968137,1050,-2.036626);
   ...
   gre->SetPoint(0,-700,-2.48308);
   gre->SetPointError(0,0,0.0509422);
   gre->SetPoint(1,-500,-2.4382);
   gre->SetPointError(1,0,0.06080681);
   gre->SetPoint(2,-300,-2.76136);
   gre->SetPointError(2,0,0.05152488);
   gre->SetPoint(3,-100,-2.34418);
   gre->SetPointError(3,0,0.049232);
   gre->SetPoint(4,100,-2.34964);
   gre->SetPointError(4,0,0.08596576);
   gre->SetPoint(5,300,-2.67486);
   gre->SetPointError(5,0,0.06439948);
   gre->SetPoint(6,500,-2.40634);
   gre->SetPointError(6,0,0.08540546);
   gre->SetPoint(7,700,-2.28106);
   gre->SetPointError(7,0,0.08918185);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: BI.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-2.874986);
   Graph_Graph11->SetMaximum(-2.129777);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(52.6133);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.233306e-05);
   linear_fit->SetParError(0,5.23249e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.485347);
   linear_fit->SetParError(1,0.02330285);
