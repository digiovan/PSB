...
//=========  (Wed Apr  1 22:36:06 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_1->Range(-1050,-3.227526,1050,-2.182676);
   ...
   gre->SetPoint(0,-700,-2.56934);
   gre->SetPointError(0,0,0.03468415);
   gre->SetPoint(1,-500,-2.4867);
   gre->SetPointError(1,0,0.1298821);
   gre->SetPoint(2,-300,-2.58714);
   gre->SetPointError(2,0,0.1866263);
   gre->SetPoint(3,-100,-2.59932);
   gre->SetPointError(3,0,0.07824833);
   gre->SetPoint(4,100,-2.71288);
   gre->SetPointError(4,0,0.3405043);
   gre->SetPoint(5,300,-2.65434);
   gre->SetPointError(5,0,0.1039484);
   gre->SetPoint(6,500,-2.54528);
   gre->SetPointError(6,0,0.112748);
   gre->SetPoint(7,700,-2.47664);
   gre->SetPointError(7,0,0.1090402);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: BI.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(-3.123041);
   Graph_Graph10->SetMaximum(-2.287161);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.16021);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.076695e-06);
   linear_fit->SetParError(0,5.747121e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.566605);
   linear_fit->SetParError(1,0.03486833);
