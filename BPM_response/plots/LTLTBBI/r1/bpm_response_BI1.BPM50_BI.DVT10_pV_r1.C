...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-10.09046,1050,-0.08924219);
   ...
   gre->SetPoint(0,-700,-8.1612);
   gre->SetPointError(0,0,0.2623906);
   gre->SetPoint(1,-500,-6.99588);
   gre->SetPointError(1,0,0.7148016);
   gre->SetPoint(2,-300,-6.32774);
   gre->SetPointError(2,0,0.5754371);
   gre->SetPoint(3,-100,-4.90726);
   gre->SetPointError(3,0,1.100392);
   gre->SetPoint(4,100,-4.14242);
   gre->SetPointError(4,0,0.3066105);
   gre->SetPoint(5,300,-4.87612);
   gre->SetPointError(5,0,0.5983395);
   gre->SetPoint(6,500,-1.95336);
   gre->SetPointError(6,0,0.1746921);
   gre->SetPoint(7,700,-2.1527);
   gre->SetPointError(7,0,0.3965881);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: BI.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-9.090339);
   Graph_Graph14->SetMaximum(-1.089364);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.65592);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004896343);
   linear_fit->SetParError(0,0.0002356406);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.701737);
   linear_fit->SetParError(1,0.1220464);
