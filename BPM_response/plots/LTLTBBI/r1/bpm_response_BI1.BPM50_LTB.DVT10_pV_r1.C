...
//=========  (Wed Apr  1 22:35:08 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-22.97366,1050,14.5632);
   ...
   gre->SetPoint(0,-700,7.99668);
   gre->SetPointError(0,0,0.3103794);
   gre->SetPoint(1,-500,6.25932);
   gre->SetPointError(1,0,0.03164162);
   gre->SetPoint(2,-300,2.67944);
   gre->SetPointError(2,0,0.2015658);
   gre->SetPoint(3,-100,-2.29502);
   gre->SetPointError(3,0,0.300128);
   gre->SetPoint(4,100,-6.42452);
   gre->SetPointError(4,0,0.2305944);
   gre->SetPoint(5,300,-11.73276);
   gre->SetPointError(5,0,0.3937952);
   gre->SetPoint(6,500,-16.55664);
   gre->SetPointError(6,0,0.1608788);
   gre->SetPoint(7,700,-13.44466);
   gre->SetPointError(7,0,0.6598416);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LTB.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-19.21998);
   Graph_Graph14->SetMaximum(10.80952);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(225.2636);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02195806);
   linear_fit->SetParError(0,0.0001384083);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.734495);
   linear_fit->SetParError(1,0.06806046);
