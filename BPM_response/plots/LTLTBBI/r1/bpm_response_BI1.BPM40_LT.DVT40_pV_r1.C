...
//=========  (Wed Apr  1 22:34:47 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_V_1->Range(-1050,-21.69748,1050,11.40111);
   ...
   gre->SetPoint(0,-700,5.77528);
   gre->SetPointError(0,0,0.1093998);
   gre->SetPoint(1,-500,2.7642);
   gre->SetPointError(1,0,0.04392931);
   gre->SetPoint(2,-300,-0.50088);
   gre->SetPointError(2,0,0.1517132);
   gre->SetPoint(3,-100,-3.39104);
   gre->SetPointError(3,0,0.1067479);
   gre->SetPoint(4,100,-5.97878);
   gre->SetPointError(4,0,0.1996205);
   gre->SetPoint(5,300,-8.02784);
   gre->SetPointError(5,0,0.7195055);
   gre->SetPoint(6,500,-11.25356);
   gre->SetPointError(6,0,0.4588564);
   gre->SetPoint(7,700,-15.8999);
   gre->SetPointError(7,0,0.2811443);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LT.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-18.38762);
   Graph_Graph13->SetMaximum(8.091252);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.56756);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0151283);
   linear_fit->SetParError(0,0.0001456274);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.814107);
   linear_fit->SetParError(1,0.07067372);
