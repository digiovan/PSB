...
//=========  (Wed Apr  1 22:35:34 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-5.297321,1050,6.237766);
   ...
   gre->SetPoint(0,-700,2.55604);
   gre->SetPointError(0,0,0.2835599);
   gre->SetPoint(1,-500,3.35044);
   gre->SetPointError(1,0,0.06359081);
   gre->SetPoint(2,-300,4.13376);
   gre->SetPointError(2,0,0.1814912);
   gre->SetPoint(3,-100,3.27528);
   gre->SetPointError(3,0,0.9532336);
   gre->SetPoint(4,100,2.1);
   gre->SetPointError(4,0,0.1531737);
   gre->SetPoint(5,300,-0.25006);
   gre->SetPointError(5,0,1.317121);
   gre->SetPoint(6,500,-0.07878);
   gre->SetPointError(6,0,0.1910922);
   gre->SetPoint(7,700,-2.92872);
   gre->SetPointError(7,0,0.4460868);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LTB.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-4.143813);
   Graph_Graph14->SetMaximum(5.084257);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(136.0927);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003147866);
   linear_fit->SetParError(0,0.0001557225);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.865906);
   linear_fit->SetParError(1,0.07292793);
