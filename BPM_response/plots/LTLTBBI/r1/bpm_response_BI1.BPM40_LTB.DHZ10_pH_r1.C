...
//=========  (Wed Apr  1 22:35:03 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,-2.251626,1050,8.896081);
   ...
   gre->SetPoint(0,-700,4.6144);
   gre->SetPointError(0,0,0.6900748);
   gre->SetPoint(1,-500,6.46802);
   gre->SetPointError(1,0,0.2993056);
   gre->SetPoint(2,-300,6.49654);
   gre->SetPointError(2,0,0.3180308);
   gre->SetPoint(3,-100,6.80712);
   gre->SetPointError(3,0,0.2310096);
   gre->SetPoint(4,100,5.0242);
   gre->SetPointError(4,0,1.10188);
   gre->SetPoint(5,300,3.73326);
   gre->SetPointError(5,0,0.1967854);
   gre->SetPoint(6,500,2.5485);
   gre->SetPointError(6,0,0.7993554);
   gre->SetPoint(7,700,-0.23014);
   gre->SetPointError(7,0,0.163535);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LTB.DHZ10 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-1.136855);
   Graph_Graph13->SetMaximum(7.78131);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(137.5627);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006091557);
   linear_fit->SetParError(0,0.0002178753);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.735882);
   linear_fit->SetParError(1,0.1070349);
