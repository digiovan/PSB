...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-21.5985,1050,13.60648);
   ...
   gre->SetPoint(0,-700,-15.5534);
   gre->SetPointError(0,0,0.1776044);
   gre->SetPoint(1,-500,-12.3183);
   gre->SetPointError(1,0,0.1173451);
   gre->SetPoint(2,-300,-8.59488);
   gre->SetPointError(2,0,0.1515968);
   gre->SetPoint(3,-100,-5.7063);
   gre->SetPointError(3,0,0.1284558);
   gre->SetPoint(4,100,-1.61942);
   gre->SetPointError(4,0,0.325185);
   gre->SetPoint(5,300,0.8811);
   gre->SetPointError(5,0,0.3485362);
   gre->SetPoint(6,500,4.39416);
   gre->SetPointError(6,0,0.1973642);
   gre->SetPoint(7,700,7.61068);
   gre->SetPointError(7,0,0.1283035);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LTB.DVT20 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-18.078);
   Graph_Graph12->SetMaximum(10.08598);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.2228);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0165602);
   linear_fit->SetParError(0,0.0001161728);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.930137);
   linear_fit->SetParError(1,0.05699614);
