...
//=========  (Wed Apr  1 22:35:29 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_1->Range(-1050,1.590126,1050,8.017624);
   ...
   gre->SetPoint(0,-700,6.82388);
   gre->SetPointError(0,0,0.122494);
   gre->SetPoint(1,-500,6.31942);
   gre->SetPointError(1,0,0.1346617);
   gre->SetPoint(2,-300,5.60638);
   gre->SetPointError(2,0,0.07989816);
   gre->SetPoint(3,-100,4.92192);
   gre->SetPointError(3,0,0.08617575);
   gre->SetPoint(4,100,4.5576);
   gre->SetPointError(4,0,0.165819);
   gre->SetPoint(5,300,3.91746);
   gre->SetPointError(5,0,0.1452645);
   gre->SetPoint(6,500,3.13734);
   gre->SetPointError(6,0,0.02486);
   gre->SetPoint(7,700,2.69652);
   gre->SetPointError(7,0,0.03514412);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LTB.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(2.232876);
   Graph_Graph10->SetMaximum(7.374874);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(16.8322);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002974483);
   linear_fit->SetParError(0,5.540096e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.684474);
   linear_fit->SetParError(1,0.03017769);
