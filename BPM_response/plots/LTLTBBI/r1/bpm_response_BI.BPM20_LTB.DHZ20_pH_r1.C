...
//=========  (Wed Apr  1 22:35:13 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,-1.267122,1050,18.06027);
   ...
   gre->SetPoint(0,-700,14.78442);
   gre->SetPointError(0,0,0.05461574);
   gre->SetPoint(1,-500,12.8432);
   gre->SetPointError(1,0,0.03204304);
   gre->SetPoint(2,-300,11.03656);
   gre->SetPointError(2,0,0.04480613);
   gre->SetPoint(3,-100,9.48384);
   gre->SetPointError(3,0,0.02173563);
   gre->SetPoint(4,100,7.71284);
   gre->SetPointError(4,0,0.01856615);
   gre->SetPoint(5,300,5.83846);
   gre->SetPointError(5,0,0.0202443);
   gre->SetPoint(6,500,3.95464);
   gre->SetPointError(6,0,0.011659);
   gre->SetPoint(7,700,2.01542);
   gre->SetPointError(7,0,0.06131009);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LTB.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(0.6656173);
   Graph_Graph11->SetMaximum(16.12753);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(115.6526);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009026349);
   linear_fit->SetParError(0,2.334398e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.504544);
   linear_fit->SetParError(1,0.009320023);
