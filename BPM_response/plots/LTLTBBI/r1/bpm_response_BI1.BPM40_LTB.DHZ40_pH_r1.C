...
//=========  (Wed Apr  1 22:35:34 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,-4.83333,1050,10.78103);
   ...
   gre->SetPoint(0,-700,6.56584);
   gre->SetPointError(0,0,0.2801145);
   gre->SetPoint(1,-500,7.11722);
   gre->SetPointError(1,0,0.1028553);
   gre->SetPoint(2,-300,8.02916);
   gre->SetPointError(2,0,0.1494756);
   gre->SetPoint(3,-100,6.55824);
   gre->SetPointError(3,0,0.7469173);
   gre->SetPoint(4,100,5.15822);
   gre->SetPointError(4,0,0.172771);
   gre->SetPoint(5,300,2.09728);
   gre->SetPointError(5,0,1.372124);
   gre->SetPoint(6,500,1.48974);
   gre->SetPointError(6,0,0.2091209);
   gre->SetPoint(7,700,-1.92918);
   gre->SetPointError(7,0,0.3017565);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LTB.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-3.271894);
   Graph_Graph13->SetMaximum(9.219593);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(310.5276);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005782485);
   linear_fit->SetParError(0,0.0001681416);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.698457);
   linear_fit->SetParError(1,0.07609117);
