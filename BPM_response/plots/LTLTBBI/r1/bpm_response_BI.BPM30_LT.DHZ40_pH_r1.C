...
//=========  (Wed Apr  1 22:34:42 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,3.915745,1050,10.09093);
   ...
   gre->SetPoint(0,-700,8.99634);
   gre->SetPointError(0,0,0.06539591);
   gre->SetPoint(1,-500,9.0257);
   gre->SetPointError(1,0,0.0353702);
   gre->SetPoint(2,-300,8.38538);
   gre->SetPointError(2,0,0.02920105);
   gre->SetPoint(3,-100,8.30718);
   gre->SetPointError(3,0,0.01551246);
   gre->SetPoint(4,100,7.94664);
   gre->SetPointError(4,0,0.01148384);
   gre->SetPoint(5,300,7.43036);
   gre->SetPointError(5,0,0.01620891);
   gre->SetPoint(6,500,5.68924);
   gre->SetPointError(6,0,0.7442969);
   gre->SetPoint(7,700,6.71878);
   gre->SetPointError(7,0,0.02595254);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(4.533264);
   Graph_Graph12->SetMaximum(9.473415);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(175.5194);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001845505);
   linear_fit->SetParError(0,2.605389e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.066157);
   linear_fit->SetParError(1,0.007532296);
