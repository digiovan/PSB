...
//=========  (Wed Apr  1 22:34:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,7.944732,1050,9.446601);
   ...
   gre->SetPoint(0,-700,8.21882);
   gre->SetPointError(0,0,0.02377646);
   gre->SetPoint(1,-500,8.50724);
   gre->SetPointError(1,0,0.06290062);
   gre->SetPoint(2,-300,8.58804);
   gre->SetPointError(2,0,0.008237671);
   gre->SetPoint(3,-100,8.57952);
   gre->SetPointError(3,0,0.007099173);
   gre->SetPoint(4,100,8.67188);
   gre->SetPointError(4,0,0.03989645);
   gre->SetPoint(5,300,8.94908);
   gre->SetPointError(5,0,0.02201387);
   gre->SetPoint(6,500,9.16472);
   gre->SetPointError(6,0,0.03156914);
   gre->SetPoint(7,700,9.06228);
   gre->SetPointError(7,0,0.0283693);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LT.DHZ10 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(8.094919);
   Graph_Graph11->SetMaximum(9.296414);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(194.7569);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0005770638);
   linear_fit->SetParError(0,1.917537e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.69449);
   linear_fit->SetParError(1,0.005571204);
