...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_1->Range(-1050,-37.91451,1050,23.44016);
   ...
   gre->SetPoint(0,-700,9.94474);
   gre->SetPointError(0,0,0.1333299);
   gre->SetPoint(1,-500,13.12942);
   gre->SetPointError(1,0,0.08496138);
   gre->SetPoint(2,-300,6.96342);
   gre->SetPointError(2,0,0.09006753);
   gre->SetPoint(3,-100,-0.0773);
   gre->SetPointError(3,0,0.2280819);
   gre->SetPoint(4,100,-7.64446);
   gre->SetPointError(4,0,0.1805019);
   gre->SetPoint(5,300,-15.75224);
   gre->SetPointError(5,0,0.2261308);
   gre->SetPoint(6,500,-22.1648);
   gre->SetPointError(6,0,0.1802127);
   gre->SetPoint(7,700,-26.23048);
   gre->SetPointError(7,0,1.458252);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(-31.77904);
   Graph_Graph12->SetMaximum(17.30469);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4384.415);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.03032378);
   linear_fit->SetParError(0,0.0001452169);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.127817);
   linear_fit->SetParError(1,0.06483472);
