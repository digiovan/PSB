...
//=========  (Wed Apr  1 22:34:11 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_1->Range(-1050,7.529915,1050,8.528322);
   ...
   gre->SetPoint(0,-700,8.16666);
   gre->SetPointError(0,0,0.0245847);
   gre->SetPoint(1,-500,8.3308);
   gre->SetPointError(1,0,0.03112127);
   gre->SetPoint(2,-300,8.2556);
   gre->SetPointError(2,0,0.00729577);
   gre->SetPoint(3,-100,8.00082);
   gre->SetPointError(3,0,0.02270821);
   gre->SetPoint(4,100,7.92996);
   gre->SetPointError(4,0,0.03709291);
   gre->SetPoint(5,300,8.0198);
   gre->SetPointError(5,0,0.01268581);
   gre->SetPoint(6,500,7.97286);
   gre->SetPointError(6,0,0.009728403);
   gre->SetPoint(7,700,7.73018);
   gre->SetPointError(7,0,0.03386363);
   
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Corr: LT.DHZ10 Plane: H Ring: 1",100,-840,840);
   Graph_Graph12->SetMinimum(7.629756);
   Graph_Graph12->SetMaximum(8.428482);
   Graph_Graph12->SetDirectory(0);
   Graph_Graph12->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph12->SetLineColor(ci);
   Graph_Graph12->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(171.6664);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0003305701);
   linear_fit->SetParError(0,1.248843e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.121522);
   linear_fit->SetParError(1,0.004892589);
