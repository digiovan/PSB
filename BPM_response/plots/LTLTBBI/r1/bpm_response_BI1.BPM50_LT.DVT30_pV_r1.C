...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-14.37564,1050,13.33697);
   ...
   gre->SetPoint(0,-700,-5.8081);
   gre->SetPointError(0,0,0.5368373);
   gre->SetPoint(1,-500,-9.67578);
   gre->SetPointError(1,0,0.08108829);
   gre->SetPoint(2,-300,-8.02658);
   gre->SetPointError(2,0,0.4129196);
   gre->SetPoint(3,-100,-5.84346);
   gre->SetPointError(3,0,0.1162001);
   gre->SetPoint(4,100,-3.03362);
   gre->SetPointError(4,0,0.4261354);
   gre->SetPoint(5,300,1.64808);
   gre->SetPointError(5,0,0.1355669);
   gre->SetPoint(6,500,4.79758);
   gre->SetPointError(6,0,0.1822019);
   gre->SetPoint(7,700,8.57468);
   gre->SetPointError(7,0,0.1435197);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LT.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-11.60438);
   Graph_Graph14->SetMaximum(10.56571);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(478.2397);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01471701);
   linear_fit->SetParError(0,0.0001147074);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.721819);
   linear_fit->SetParError(1,0.05213106);
