...
//=========  (Wed Apr  1 22:35:24 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-11.03358,1050,7.894964);
   ...
   gre->SetPoint(0,-700,2.01748);
   gre->SetPointError(0,0,0.8239079);
   gre->SetPoint(1,-500,-0.09808);
   gre->SetPointError(1,0,0.3630175);
   gre->SetPoint(2,-300,1.80622);
   gre->SetPointError(2,0,0.5817754);
   gre->SetPoint(3,-100,3.8809);
   gre->SetPointError(3,0,0.859307);
   gre->SetPoint(4,100,1.15758);
   gre->SetPointError(4,0,0.1883525);
   gre->SetPoint(5,300,-1.98718);
   gre->SetPointError(5,0,0.4210626);
   gre->SetPoint(6,500,-4.45472);
   gre->SetPointError(6,0,1.396441);
   gre->SetPoint(7,700,-6.91044);
   gre->SetPointError(7,0,0.9683796);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LTB.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-9.140722);
   Graph_Graph14->SetMaximum(6.00211);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(121.4847);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002321538);
   linear_fit->SetParError(0,0.0004802191);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.4882073);
   linear_fit->SetParError(1,0.1432205);
