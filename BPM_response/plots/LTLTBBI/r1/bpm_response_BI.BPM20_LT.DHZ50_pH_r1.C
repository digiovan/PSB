...
//=========  (Wed Apr  1 22:34:52 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,4.43127,1050,12.74548);
   ...
   gre->SetPoint(0,-700,5.84008);
   gre->SetPointError(0,0,0.02310903);
   gre->SetPoint(1,-500,6.8281);
   gre->SetPointError(1,0,0.01674676);
   gre->SetPoint(2,-300,7.443);
   gre->SetPointError(2,0,0.03128844);
   gre->SetPoint(3,-100,8.41682);
   gre->SetPointError(3,0,0.02058846);
   gre->SetPoint(4,100,9.14704);
   gre->SetPointError(4,0,0.0472455);
   gre->SetPoint(5,300,9.72316);
   gre->SetPointError(5,0,0.02779349);
   gre->SetPoint(6,500,10.68932);
   gre->SetPointError(6,0,0.02222946);
   gre->SetPoint(7,700,11.33604);
   gre->SetPointError(7,0,0.0237366);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LT.DHZ50 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(5.26269);
   Graph_Graph11->SetMaximum(11.91406);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(132.8527);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003869501);
   linear_fit->SetParError(0,1.72557e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.694266);
   linear_fit->SetParError(1,0.008422449);
