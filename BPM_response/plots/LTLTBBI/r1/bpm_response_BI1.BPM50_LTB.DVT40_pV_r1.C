...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-30.86693,1050,15.62214);
   ...
   gre->SetPoint(0,-700,-22.74452);
   gre->SetPointError(0,0,0.3742298);
   gre->SetPoint(1,-500,-15.19778);
   gre->SetPointError(1,0,0.6923432);
   gre->SetPoint(2,-300,-10.66644);
   gre->SetPointError(2,0,0.1936405);
   gre->SetPoint(3,-100,-6.25516);
   gre->SetPointError(3,0,0.4512305);
   gre->SetPoint(4,100,-3.50862);
   gre->SetPointError(4,0,0.1291172);
   gre->SetPoint(5,300,0.70132);
   gre->SetPointError(5,0,0.09943009);
   gre->SetPoint(6,500,4.68486);
   gre->SetPointError(6,0,0.4545441);
   gre->SetPoint(7,700,7.7629);
   gre->SetPointError(7,0,0.1110621);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LTB.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-26.21802);
   Graph_Graph14->SetMaximum(10.97323);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(137.2022);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01949421);
   linear_fit->SetParError(0,0.0001706816);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.473078);
   linear_fit->SetParError(1,0.07602404);
