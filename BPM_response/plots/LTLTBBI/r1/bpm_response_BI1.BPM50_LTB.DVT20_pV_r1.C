...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-12.89081,1050,4.8004);
   ...
   gre->SetPoint(0,-700,1.56426);
   gre->SetPointError(0,0,0.2876059);
   gre->SetPoint(1,-500,-0.42212);
   gre->SetPointError(1,0,0.3902829);
   gre->SetPoint(2,-300,-2.19958);
   gre->SetPointError(2,0,0.4359255);
   gre->SetPoint(3,-100,-3.6584);
   gre->SetPointError(3,0,0.2499957);
   gre->SetPoint(4,100,-5.85236);
   gre->SetPointError(4,0,1.025321);
   gre->SetPoint(5,300,-6.74392);
   gre->SetPointError(5,0,0.2821373);
   gre->SetPoint(6,500,-8.57052);
   gre->SetPointError(6,0,0.4886034);
   gre->SetPoint(7,700,-9.77164);
   gre->SetPointError(7,0,0.1706311);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LTB.DVT20 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-11.12168);
   Graph_Graph14->SetMaximum(3.03128);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.198866);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007954502);
   linear_fit->SetParError(0,0.0002010315);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.304303);
   linear_fit->SetParError(1,0.1093604);
