...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_V_1->Range(-1050,-15.60407,1050,5.3601);
   ...
   gre->SetPoint(0,-700,1.26562);
   gre->SetPointError(0,0,0.6004511);
   gre->SetPoint(1,-500,-1.44904);
   gre->SetPointError(1,0,0.4290477);
   gre->SetPoint(2,-300,-2.77932);
   gre->SetPointError(2,0,0.6150812);
   gre->SetPoint(3,-100,-3.82482);
   gre->SetPointError(3,0,0.4853922);
   gre->SetPoint(4,100,-6.72146);
   gre->SetPointError(4,0,0.547467);
   gre->SetPoint(5,300,-7.49386);
   gre->SetPointError(5,0,1.245261);
   gre->SetPoint(6,500,-8.71918);
   gre->SetPointError(6,0,1.249977);
   gre->SetPoint(7,700,-11.14458);
   gre->SetPointError(7,0,0.9654636);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: BI.DVT20 Plane: V Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(-13.50766);
   Graph_Graph14->SetMaximum(3.263683);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.142976);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008467957);
   linear_fit->SetParError(0,0.0005877675);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.241279);
   linear_fit->SetParError(1,0.2504588);
