...
//=========  (Wed Apr  1 22:34:31 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_1->Range(-1050,2.997492,1050,14.01259);
   ...
   gre->SetPoint(0,-700,12.171);
   gre->SetPointError(0,0,0.005742062);
   gre->SetPoint(1,-500,11.27414);
   gre->SetPointError(1,0,0.02473066);
   gre->SetPoint(2,-300,10.07442);
   gre->SetPointError(2,0,0.02242323);
   gre->SetPoint(3,-100,9.20962);
   gre->SetPointError(3,0,0.02946395);
   gre->SetPoint(4,100,8.1267);
   gre->SetPointError(4,0,0.03238257);
   gre->SetPoint(5,300,7.21768);
   gre->SetPointError(5,0,0.025993);
   gre->SetPoint(6,500,6.29832);
   gre->SetPointError(6,0,0.0215214);
   gre->SetPoint(7,700,4.90642);
   gre->SetPointError(7,0,0.07307777);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: LT.DHZ30 Plane: H Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(4.099002);
   Graph_Graph11->SetMaximum(12.91108);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(78.57471);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004955096);
   linear_fit->SetParError(0,1.391076e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.701504);
   linear_fit->SetParError(1,0.008875041);
