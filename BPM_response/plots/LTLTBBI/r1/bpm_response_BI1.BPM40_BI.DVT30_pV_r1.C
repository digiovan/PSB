...
//=========  (Wed Apr  1 22:36:11 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_V_1->Range(-1050,-8.283206,1050,2.419543);
   ...
   gre->SetPoint(0,-700,-5.77802);
   gre->SetPointError(0,0,0.7213941);
   gre->SetPoint(1,-500,-5.51664);
   gre->SetPointError(1,0,0.3956571);
   gre->SetPoint(2,-300,-5.15878);
   gre->SetPointError(2,0,0.4034329);
   gre->SetPoint(3,-100,-3.1884);
   gre->SetPointError(3,0,0.08986724);
   gre->SetPoint(4,100,-3.53608);
   gre->SetPointError(4,0,0.351619);
   gre->SetPoint(5,300,-2.13836);
   gre->SetPointError(5,0,0.3787997);
   gre->SetPoint(6,500,-1.6001);
   gre->SetPointError(6,0,0.5522758);
   gre->SetPoint(7,700,-0.12106);
   gre->SetPointError(7,0,0.7568118);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: BI.DVT30 Plane: V Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(-7.212931);
   Graph_Graph13->SetMaximum(1.349268);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.56387);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003796385);
   linear_fit->SetParError(0,0.0004208811);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.983296);
   linear_fit->SetParError(1,0.08665599);
