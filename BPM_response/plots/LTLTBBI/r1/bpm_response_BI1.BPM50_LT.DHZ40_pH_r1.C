...
//=========  (Wed Apr  1 22:34:42 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM50_H_1->Range(-1050,-1.016943,1050,9.152487);
   ...
   gre->SetPoint(0,-700,2.77618);
   gre->SetPointError(0,0,0.3562713);
   gre->SetPoint(1,-500,7.1274);
   gre->SetPointError(1,0,0.2837041);
   gre->SetPoint(2,-300,3.69776);
   gre->SetPointError(2,0,0.2015137);
   gre->SetPoint(3,-100,6.65812);
   gre->SetPointError(3,0,0.08011445);
   gre->SetPoint(4,100,6.296);
   gre->SetPointError(4,0,0.1528123);
   gre->SetPoint(5,300,2.39784);
   gre->SetPointError(5,0,0.3479805);
   gre->SetPoint(6,500,3.54798);
   gre->SetPointError(6,0,0.4602664);
   gre->SetPoint(7,700,0.54514);
   gre->SetPointError(7,0,0.3784298);
   
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","Corr: LT.DHZ40 Plane: H Ring: 1",100,-840,840);
   Graph_Graph14->SetMinimum(0);
   Graph_Graph14->SetMaximum(8.135544);
   Graph_Graph14->SetDirectory(0);
   Graph_Graph14->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph14->SetLineColor(ci);
   Graph_Graph14->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(596.4388);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001686474);
   linear_fit->SetParError(0,0.000259151);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,5.745089);
   linear_fit->SetParError(1,0.06487454);
