...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_1->Range(-1050,-4.658008,1050,0.01453095);
   ...
   gre->SetPoint(0,-700,-0.81528);
   gre->SetPointError(0,0,0.05105439);
   gre->SetPoint(1,-500,-1.31364);
   gre->SetPointError(1,0,0.04510599);
   gre->SetPoint(2,-300,-1.66136);
   gre->SetPointError(2,0,0.09740576);
   gre->SetPoint(3,-100,-2.2527);
   gre->SetPointError(3,0,0.08530132);
   gre->SetPoint(4,100,-2.58792);
   gre->SetPointError(4,0,0.07980786);
   gre->SetPoint(5,300,-3.01794);
   gre->SetPointError(5,0,0.03843963);
   gre->SetPoint(6,500,-3.55796);
   gre->SetPointError(6,0,0.09588627);
   gre->SetPoint(7,700,-3.84938);
   gre->SetPointError(7,0,0.02987169);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","Corr: BI.DVT10 Plane: V Ring: 1",100,-840,840);
   Graph_Graph11->SetMinimum(-4.190754);
   Graph_Graph11->SetMaximum(-0.452723);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph11->SetLineColor(ci);
   Graph_Graph11->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.894221);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002148659);
   linear_fit->SetParError(0,3.366041e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.364812);
   linear_fit->SetParError(1,0.01849603);
