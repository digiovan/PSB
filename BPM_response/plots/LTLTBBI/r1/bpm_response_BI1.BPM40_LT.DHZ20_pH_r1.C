...
//=========  (Wed Apr  1 22:34:21 2015) by ROOT version5.34/21
   ...
   canvas_BI1.BPM40_H_1->Range(-1050,0.3238121,1050,12.71102);
   ...
   gre->SetPoint(0,-700,3.87538);
   gre->SetPointError(0,0,0.08442229);
   gre->SetPoint(1,-500,4.7929);
   gre->SetPointError(1,0,0.1642774);
   gre->SetPoint(2,-300,6.48298);
   gre->SetPointError(2,0,0.09999364);
   gre->SetPoint(3,-100,6.85296);
   gre->SetPointError(3,0,0.1032619);
   gre->SetPoint(4,100,7.5362);
   gre->SetPointError(4,0,0.2603881);
   gre->SetPoint(5,300,10.30892);
   gre->SetPointError(5,0,0.3375689);
   gre->SetPoint(6,500,8.78916);
   gre->SetPointError(6,0,0.1856044);
   gre->SetPoint(7,700,3.1989);
   gre->SetPointError(7,0,0.8105524);
   
   TH1F *Graph_Graph13 = new TH1F("Graph_Graph13","Corr: LT.DHZ20 Plane: H Ring: 1",100,-840,840);
   Graph_Graph13->SetMinimum(1.562533);
   Graph_Graph13->SetMaximum(11.4723);
   Graph_Graph13->SetDirectory(0);
   Graph_Graph13->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph13->SetLineColor(ci);
   Graph_Graph13->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(162.1511);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004421);
   linear_fit->SetParError(0,0.0001372089);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.236569);
   linear_fit->SetParError(1,0.06549643);
