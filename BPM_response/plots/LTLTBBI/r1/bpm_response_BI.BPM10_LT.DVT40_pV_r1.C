...
//=========  (Wed Apr  1 22:34:47 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_1->Range(-1050,0.5850926,1050,8.927665);
   ...
   gre->SetPoint(0,-700,7.42084);
   gre->SetPointError(0,0,0.1163959);
   gre->SetPoint(1,-500,6.84828);
   gre->SetPointError(1,0,0.1552365);
   gre->SetPoint(2,-300,5.98332);
   gre->SetPointError(2,0,0.1928329);
   gre->SetPoint(3,-100,5.2139);
   gre->SetPointError(3,0,0.08407137);
   gre->SetPoint(4,100,4.68392);
   gre->SetPointError(4,0,0.1775861);
   gre->SetPoint(5,300,4.01544);
   gre->SetPointError(5,0,0.08969546);
   gre->SetPoint(6,500,3.42768);
   gre->SetPointError(6,0,0.04068491);
   gre->SetPoint(7,700,2.00804);
   gre->SetPointError(7,0,0.03251868);
   
   TH1F *Graph_Graph10 = new TH1F("Graph_Graph10","Corr: LT.DVT40 Plane: V Ring: 1",100,-840,840);
   Graph_Graph10->SetMinimum(1.41935);
   Graph_Graph10->SetMaximum(8.093407);
   Graph_Graph10->SetDirectory(0);
   Graph_Graph10->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph10->SetLineColor(ci);
   Graph_Graph10->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(166.8383);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003925768);
   linear_fit->SetParError(0,6.199587e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.986081);
   linear_fit->SetParError(1,0.03614583);
