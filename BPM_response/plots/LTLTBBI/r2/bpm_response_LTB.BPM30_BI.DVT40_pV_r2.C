...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,1.874523,1050,2.886044);
   ...
   gre->SetPoint(0,-700,2.42096);
   gre->SetPointError(0,0,0.07214222);
   gre->SetPoint(1,-500,2.55278);
   gre->SetPointError(1,0,0.07835901);
   gre->SetPoint(2,-300,2.09218);
   gre->SetPointError(2,0,0.04907047);
   gre->SetPoint(3,-100,2.66832);
   gre->SetPointError(3,0,0.02225425);
   gre->SetPoint(4,100,2.64906);
   gre->SetPointError(4,0,0.06839689);
   gre->SetPoint(5,300,2.19818);
   gre->SetPointError(5,0,0.08076714);
   gre->SetPoint(6,500,2.4461);
   gre->SetPointError(6,0,0.1186156);
   gre->SetPoint(7,700,2.55082);
   gre->SetPointError(7,0,0.05416666);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(1.975675);
   Graph_Graph22->SetMaximum(2.784892);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(137.6306);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.341566e-05);
   linear_fit->SetParError(0,5.117612e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.550374);
   linear_fit->SetParError(1,0.01698648);
