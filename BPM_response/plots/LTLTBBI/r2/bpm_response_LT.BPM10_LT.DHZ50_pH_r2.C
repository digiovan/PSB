...
//=========  (Wed Apr  1 22:34:53 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.886178,1050,2.213391);
   ...
   gre->SetPoint(0,-700,2.02502);
   gre->SetPointError(0,0,0.008126397);
   gre->SetPoint(1,-500,2.11984);
   gre->SetPointError(1,0,0.009833743);
   gre->SetPoint(2,-300,2.07648);
   gre->SetPointError(2,0,0.02775809);
   gre->SetPoint(3,-100,2.1462);
   gre->SetPointError(3,0,0.01265557);
   gre->SetPoint(4,100,2.09756);
   gre->SetPointError(4,0,0.04665151);
   gre->SetPoint(5,300,1.96298);
   gre->SetPointError(5,0,0.02226662);
   gre->SetPoint(6,500,2.12468);
   gre->SetPointError(6,0,0.03066327);
   gre->SetPoint(7,700,1.98028);
   gre->SetPointError(7,0,0.01645398);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LT.DHZ50 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.918899);
   Graph_Graph15->SetMaximum(2.18067);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(145.6981);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.802274e-05);
   linear_fit->SetParError(0,1.101744e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.060249);
   linear_fit->SetParError(1,0.006125912);
