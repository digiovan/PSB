...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.6557092,1050,1.049993);
   ...
   gre->SetPoint(0,-700,0.92176);
   gre->SetPointError(0,0,0.03346526);
   gre->SetPoint(1,-500,0.76954);
   gre->SetPointError(1,0,0.04811671);
   gre->SetPoint(2,-300,0.90934);
   gre->SetPointError(2,0,0.01464891);
   gre->SetPoint(3,-100,0.88228);
   gre->SetPointError(3,0,0.0697341);
   gre->SetPoint(4,100,0.91194);
   gre->SetPointError(4,0,0.07233945);
   gre->SetPoint(5,300,0.9227);
   gre->SetPointError(5,0,0.01315821);
   gre->SetPoint(6,500,0.86212);
   gre->SetPointError(6,0,0.09953368);
   gre->SetPoint(7,700,0.80736);
   gre->SetPointError(7,0,0.02995663);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.6951377);
   Graph_Graph15->SetMaximum(1.010565);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.34771);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.628534e-05);
   linear_fit->SetParError(0,2.207466e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9025839);
   linear_fit->SetParError(1,0.008663925);
