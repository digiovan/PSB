...
//=========  (Wed Apr  1 22:35:51 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-11.81099,1050,-1.801457);
   ...
   gre->SetPoint(0,-700,-8.97558);
   gre->SetPointError(0,0,1.167158);
   gre->SetPoint(1,-500,-9.70896);
   gre->SetPointError(1,0,0.1425289);
   gre->SetPoint(2,-300,-7.47676);
   gre->SetPointError(2,0,1.307078);
   gre->SetPoint(3,-100,-7.86136);
   gre->SetPointError(3,0,0.5971176);
   gre->SetPoint(4,100,-6.51458);
   gre->SetPointError(4,0,0.5263941);
   gre->SetPoint(5,300,-5.7749);
   gre->SetPointError(5,0,0.3450797);
   gre->SetPoint(6,500,-4.21506);
   gre->SetPointError(6,0,0.1688124);
   gre->SetPoint(7,700,-3.90438);
   gre->SetPointError(7,0,0.434667);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-10.81004);
   Graph_Graph28->SetMaximum(-2.802411);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.041293);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005282447);
   linear_fit->SetParError(0,0.0002004617);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.034748);
   linear_fit->SetParError(1,0.09728685);
