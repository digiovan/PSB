...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-5.341697,1050,3.197911);
   ...
   gre->SetPoint(0,-700,-3.89608);
   gre->SetPointError(0,0,0.02234859);
   gre->SetPoint(1,-500,-3.00486);
   gre->SetPointError(1,0,0.03745213);
   gre->SetPoint(2,-300,-2.00676);
   gre->SetPointError(2,0,0.03263789);
   gre->SetPoint(3,-100,-1.13102);
   gre->SetPointError(3,0,0.02610759);
   gre->SetPoint(4,100,-0.3292);
   gre->SetPointError(4,0,0.005934567);
   gre->SetPoint(5,300,0.41916);
   gre->SetPointError(5,0,0.02038482);
   gre->SetPoint(6,500,1.15886);
   gre->SetPointError(6,0,0.030955);
   gre->SetPoint(7,700,1.76048);
   gre->SetPointError(7,0,0.01416303);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-4.487736);
   Graph_Graph23->SetMaximum(2.34395);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(633.6116);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003950887);
   linear_fit->SetParError(0,1.628436e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.789513);
   linear_fit->SetParError(1,0.005311304);
