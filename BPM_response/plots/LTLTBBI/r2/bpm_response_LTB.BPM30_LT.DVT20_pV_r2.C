...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,-5.052025,1050,8.775554);
   ...
   gre->SetPoint(0,-700,6.40248);
   gre->SetPointError(0,0,0.06847749);
   gre->SetPoint(1,-500,5.8844);
   gre->SetPointError(1,0,0.04894767);
   gre->SetPoint(2,-300,4.31634);
   gre->SetPointError(2,0,0.0438359);
   gre->SetPoint(3,-100,2.9108);
   gre->SetPointError(3,0,0.08368074);
   gre->SetPoint(4,100,1.68404);
   gre->SetPointError(4,0,0.07011557);
   gre->SetPoint(5,300,0.4133);
   gre->SetPointError(5,0,0.09785865);
   gre->SetPoint(6,500,-0.71152);
   gre->SetPointError(6,0,0.05631197);
   gre->SetPoint(7,700,-2.64072);
   gre->SetPointError(7,0,0.1067084);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-3.669267);
   Graph_Graph22->SetMaximum(7.392796);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(114.6787);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006444425);
   linear_fit->SetParError(0,5.290164e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.370729);
   linear_fit->SetParError(1,0.02334465);
