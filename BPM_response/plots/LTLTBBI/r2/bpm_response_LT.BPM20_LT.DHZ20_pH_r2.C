...
//=========  (Wed Apr  1 22:34:21 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-14.35685,1050,-1.888229);
   ...
   gre->SetPoint(0,-700,-12.26164);
   gre->SetPointError(0,0,0.01710412);
   gre->SetPoint(1,-500,-11.25388);
   gre->SetPointError(1,0,0.06536187);
   gre->SetPoint(2,-300,-10.1836);
   gre->SetPointError(2,0,0.03275289);
   gre->SetPoint(3,-100,-8.8613);
   gre->SetPointError(3,0,0.01652033);
   gre->SetPoint(4,100,-7.79658);
   gre->SetPointError(4,0,0.02860579);
   gre->SetPoint(5,300,-6.5398);
   gre->SetPointError(5,0,0.02332177);
   gre->SetPoint(6,500,-5.28584);
   gre->SetPointError(6,0,0.03508013);
   gre->SetPoint(7,700,-3.9884);
   gre->SetPointError(7,0,0.02206802);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-13.10999);
   Graph_Graph16->SetMaximum(-3.135091);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(136.7703);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005878016);
   linear_fit->SetParError(0,1.764398e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.239258);
   linear_fit->SetParError(1,0.008436674);
