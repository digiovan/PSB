...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,-9.955569,1050,14.32666);
   ...
   gre->SetPoint(0,-700,-5.84344);
   gre->SetPointError(0,0,0.06509146);
   gre->SetPoint(1,-500,-3.23896);
   gre->SetPointError(1,0,0.1280247);
   gre->SetPoint(2,-300,-0.79826);
   gre->SetPointError(2,0,0.07212436);
   gre->SetPoint(3,-100,1.59656);
   gre->SetPointError(3,0,0.05315327);
   gre->SetPoint(4,100,3.43374);
   gre->SetPointError(4,0,0.0781294);
   gre->SetPoint(5,300,5.88308);
   gre->SetPointError(5,0,0.05862861);
   gre->SetPoint(6,500,7.985);
   gre->SetPointError(6,0,0.06737676);
   gre->SetPoint(7,700,10.25078);
   gre->SetPointError(7,0,0.02883935);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-7.527347);
   Graph_Graph22->SetMaximum(11.89843);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(79.69201);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01126976);
   linear_fit->SetParError(0,4.05639e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.408597);
   linear_fit->SetParError(1,0.02232107);
