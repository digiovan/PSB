...
//=========  (Wed Apr  1 22:35:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-1.685395,1050,-1.541081);
   ...
   gre->SetPoint(0,-700,-1.61858);
   gre->SetPointError(0,0,0.01369546);
   gre->SetPoint(1,-500,-1.62158);
   gre->SetPointError(1,0,0.02016663);
   gre->SetPoint(2,-300,-1.63138);
   gre->SetPointError(2,0,0.02996253);
   gre->SetPoint(3,-100,-1.61834);
   gre->SetPointError(3,0,0.01054093);
   gre->SetPoint(4,100,-1.61252);
   gre->SetPointError(4,0,0.01229677);
   gre->SetPoint(5,300,-1.59058);
   gre->SetPointError(5,0,0.01427338);
   gre->SetPoint(6,500,-1.59542);
   gre->SetPointError(6,0,0.03028673);
   gre->SetPoint(7,700,-1.6459);
   gre->SetPointError(7,0,0.0150824);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.670963);
   Graph_Graph19->SetMaximum(-1.555512);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.998601);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.782907e-06);
   linear_fit->SetParError(0,1.255273e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.616805);
   linear_fit->SetParError(1,0.005354276);
