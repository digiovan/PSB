...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-3.3502,1050,0.3515976);
   ...
   gre->SetPoint(0,-700,-0.27762);
   gre->SetPointError(0,0,0.01225141);
   gre->SetPoint(1,-500,-0.42822);
   gre->SetPointError(1,0,0.007505573);
   gre->SetPoint(2,-300,-0.74758);
   gre->SetPointError(2,0,0.01199774);
   gre->SetPoint(3,-100,-1.32964);
   gre->SetPointError(3,0,0.0196545);
   gre->SetPoint(4,100,-1.68092);
   gre->SetPointError(4,0,0.02727884);
   gre->SetPoint(5,300,-1.911);
   gre->SetPointError(5,0,0.009998655);
   gre->SetPoint(6,500,-2.22018);
   gre->SetPointError(6,0,0.01845174);
   gre->SetPoint(7,700,-2.72582);
   gre->SetPointError(7,0,0.007413317);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-2.98002);
   Graph_Graph19->SetMaximum(-0.01858211);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(417.9231);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001845001);
   linear_fit->SetParError(0,7.276725e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.398323);
   linear_fit->SetParError(1,0.003883191);
