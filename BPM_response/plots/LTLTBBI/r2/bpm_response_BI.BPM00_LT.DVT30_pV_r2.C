...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-5.890553,1050,4.135455);
   ...
   gre->SetPoint(0,-700,-4.1703);
   gre->SetPointError(0,0,0.04925149);
   gre->SetPoint(1,-500,-3.02762);
   gre->SetPointError(1,0,0.007732065);
   gre->SetPoint(2,-300,-2.08752);
   gre->SetPointError(2,0,0.06445895);
   gre->SetPoint(3,-100,-1.23074);
   gre->SetPointError(3,0,0.06366506);
   gre->SetPoint(4,100,-0.29202);
   gre->SetPointError(4,0,0.0449538);
   gre->SetPoint(5,300,0.69082);
   gre->SetPointError(5,0,0.05700159);
   gre->SetPoint(6,500,1.57348);
   gre->SetPointError(6,0,0.01189094);
   gre->SetPoint(7,700,2.39234);
   gre->SetPointError(7,0,0.07211358);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-4.887952);
   Graph_Graph23->SetMaximum(3.132854);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.9782);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004606656);
   linear_fit->SetParError(0,1.366602e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.7305953);
   linear_fit->SetParError(1,0.006768544);
