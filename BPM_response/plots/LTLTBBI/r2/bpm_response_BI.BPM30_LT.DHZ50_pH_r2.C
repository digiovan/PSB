...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,1.982461,1050,13.69631);
   ...
   gre->SetPoint(0,-700,3.9616);
   gre->SetPointError(0,0,0.02683134);
   gre->SetPoint(1,-500,5.2772);
   gre->SetPointError(1,0,0.03322024);
   gre->SetPoint(2,-300,6.23164);
   gre->SetPointError(2,0,0.02093645);
   gre->SetPoint(3,-100,7.56972);
   gre->SetPointError(3,0,0.01003598);
   gre->SetPoint(4,100,8.63752);
   gre->SetPointError(4,0,0.0667606);
   gre->SetPoint(5,300,9.45884);
   gre->SetPointError(5,0,0.03056095);
   gre->SetPoint(6,500,10.77532);
   gre->SetPointError(6,0,0.04192531);
   gre->SetPoint(7,700,11.70448);
   gre->SetPointError(7,0,0.03952066);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LT.DHZ50 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(3.153845);
   Graph_Graph26->SetMaximum(12.52492);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(265.9448);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005542836);
   linear_fit->SetParError(0,2.560803e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.029664);
   linear_fit->SetParError(1,0.008252212);
