...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_2->Range(-1050,-30.80463,1050,21.2221);
   ...
   gre->SetPoint(0,-700,-18.9132);
   gre->SetPointError(0,0,0.7140834);
   gre->SetPoint(1,-500,-21.89556);
   gre->SetPointError(1,0,0.2379515);
   gre->SetPoint(2,-300,-14.90218);
   gre->SetPointError(2,0,0.2563947);
   gre->SetPoint(3,-100,-6.37362);
   gre->SetPointError(3,0,0.1327787);
   gre->SetPoint(4,100,1.21176);
   gre->SetPointError(4,0,0.2813304);
   gre->SetPoint(5,300,9.60318);
   gre->SetPointError(5,0,0.1315816);
   gre->SetPoint(6,500,10.22222);
   gre->SetPointError(6,0,0.6744944);
   gre->SetPoint(7,700,12.34006);
   gre->SetPointError(7,0,0.2109137);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-25.60196);
   Graph_Graph26->SetMaximum(16.01942);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1930.311);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0307952);
   linear_fit->SetParError(0,0.0002085226);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.234704);
   linear_fit->SetParError(1,0.07509142);
