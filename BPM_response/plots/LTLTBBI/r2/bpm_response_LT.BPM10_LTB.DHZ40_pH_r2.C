...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.908829,1050,2.081693);
   ...
   gre->SetPoint(0,-700,2.01878);
   gre->SetPointError(0,0,0.007030681);
   gre->SetPoint(1,-500,1.97744);
   gre->SetPointError(1,0,0.02924237);
   gre->SetPoint(2,-300,2.00466);
   gre->SetPointError(2,0,0.004021274);
   gre->SetPoint(3,-100,1.9664);
   gre->SetPointError(3,0,0.02875997);
   gre->SetPoint(4,100,2.00526);
   gre->SetPointError(4,0,0.03407274);
   gre->SetPoint(5,300,1.99108);
   gre->SetPointError(5,0,0.03856962);
   gre->SetPoint(6,500,2.01258);
   gre->SetPointError(6,0,0.03252566);
   gre->SetPoint(7,700,2.02642);
   gre->SetPointError(7,0,0.02646279);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.926116);
   Graph_Graph15->SetMaximum(2.064407);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.951786);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.313371e-05);
   linear_fit->SetParError(0,1.355273e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.002642);
   linear_fit->SetParError(1,0.005907583);
