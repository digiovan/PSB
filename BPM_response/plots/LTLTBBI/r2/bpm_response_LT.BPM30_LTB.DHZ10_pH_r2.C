...
//=========  (Wed Apr  1 22:35:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-10.0603,1050,-9.618164);
   ...
   gre->SetPoint(0,-700,-9.81824);
   gre->SetPointError(0,0,0.03686657);
   gre->SetPoint(1,-500,-9.81268);
   gre->SetPointError(1,0,0.0427841);
   gre->SetPoint(2,-300,-9.77518);
   gre->SetPointError(2,0,0.04543716);
   gre->SetPoint(3,-100,-9.8165);
   gre->SetPointError(3,0,0.008741849);
   gre->SetPoint(4,100,-9.8172);
   gre->SetPointError(4,0,0.007147268);
   gre->SetPoint(5,300,-9.89034);
   gre->SetPointError(5,0,0.02644622);
   gre->SetPoint(6,500,-9.92856);
   gre->SetPointError(6,0,0.05805184);
   gre->SetPoint(7,700,-9.73516);
   gre->SetPointError(7,0,0.0433066);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.01609);
   Graph_Graph17->SetMaximum(-9.662378);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.25238);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.80827e-05);
   linear_fit->SetParError(0,2.753092e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.81858);
   linear_fit->SetParError(1,0.005244713);
