...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-8.407668,1050,5.018204);
   ...
   gre->SetPoint(0,-700,2.71508);
   gre->SetPointError(0,0,0.06547879);
   gre->SetPoint(1,-500,1.52304);
   gre->SetPointError(1,0,0.01983931);
   gre->SetPoint(2,-300,-0.09828);
   gre->SetPointError(2,0,0.05336499);
   gre->SetPoint(3,-100,-1.45756);
   gre->SetPointError(3,0,0.04870219);
   gre->SetPoint(4,100,-2.68324);
   gre->SetPointError(4,0,0.01273126);
   gre->SetPoint(5,300,-3.8712);
   gre->SetPointError(5,0,0.0261223);
   gre->SetPoint(6,500,-5.01018);
   gre->SetPointError(6,0,0.06738184);
   gre->SetPoint(7,700,-6.12694);
   gre->SetPointError(7,0,0.04308287);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-7.065081);
   Graph_Graph25->SetMaximum(3.675617);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(244.3067);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.006624367);
   linear_fit->SetParError(0,2.775856e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.928277);
   linear_fit->SetParError(1,0.009151749);
