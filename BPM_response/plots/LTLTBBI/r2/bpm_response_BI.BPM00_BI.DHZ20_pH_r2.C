...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-5.693318,1050,-5.017286);
   ...
   gre->SetPoint(0,-700,-5.26926);
   gre->SetPointError(0,0,0.04971743);
   gre->SetPoint(1,-500,-5.29826);
   gre->SetPointError(1,0,0.02355974);
   gre->SetPoint(2,-300,-5.2942);
   gre->SetPointError(2,0,0.1642416);
   gre->SetPoint(3,-100,-5.36168);
   gre->SetPointError(3,0,0.02807333);
   gre->SetPoint(4,100,-5.49508);
   gre->SetPointError(4,0,0.08556618);
   gre->SetPoint(5,300,-5.28222);
   gre->SetPointError(5,0,0.1309168);
   gre->SetPoint(6,500,-5.34582);
   gre->SetPointError(6,0,0.118301);
   gre->SetPoint(7,700,-5.38622);
   gre->SetPointError(7,0,0.05526907);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-5.625715);
   Graph_Graph23->SetMaximum(-5.08489);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.220013);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-9.464168e-05);
   linear_fit->SetParError(0,4.105856e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.352774);
   linear_fit->SetParError(1,0.01867658);
