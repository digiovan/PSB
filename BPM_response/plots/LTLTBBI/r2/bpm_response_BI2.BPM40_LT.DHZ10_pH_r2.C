...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-0.4062306,1050,12.08393);
   ...
   gre->SetPoint(0,-700,3.6238);
   gre->SetPointError(0,0,0.6148355);
   gre->SetPoint(1,-500,9.18672);
   gre->SetPointError(1,0,0.2478624);
   gre->SetPoint(2,-300,9.62474);
   gre->SetPointError(2,0,0.3774949);
   gre->SetPoint(3,-100,3.12798);
   gre->SetPointError(3,0,0.5710149);
   gre->SetPoint(4,100,2.6384);
   gre->SetPointError(4,0,0.483914);
   gre->SetPoint(5,300,8.87716);
   gre->SetPointError(5,0,0.07565038);
   gre->SetPoint(6,500,6.75036);
   gre->SetPointError(6,0,0.495836);
   gre->SetPoint(7,700,2.13618);
   gre->SetPointError(7,0,0.4607174);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(0.8427853);
   Graph_Graph27->SetMaximum(10.83491);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(541.9343);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.000205632);
   linear_fit->SetParError(0,0.0002543627);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.513297);
   linear_fit->SetParError(1,0.08658843);
