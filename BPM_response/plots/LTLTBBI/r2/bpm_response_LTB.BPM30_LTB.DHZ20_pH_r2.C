...
//=========  (Wed Apr  1 22:35:14 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,-10.43938,1050,12.29722);
   ...
   gre->SetPoint(0,-700,-6.60878);
   gre->SetPointError(0,0,0.04117018);
   gre->SetPoint(1,-500,-4.35778);
   gre->SetPointError(1,0,0.04469534);
   gre->SetPoint(2,-300,-2.2381);
   gre->SetPointError(2,0,0.08314732);
   gre->SetPoint(3,-100,-0.3287);
   gre->SetPointError(3,0,0.03339007);
   gre->SetPoint(4,100,1.73782);
   gre->SetPointError(4,0,0.04484354);
   gre->SetPoint(5,300,4.01814);
   gre->SetPointError(5,0,0.08711816);
   gre->SetPoint(6,500,6.23804);
   gre->SetPointError(6,0,0.03235533);
   gre->SetPoint(7,700,8.43922);
   gre->SetPointError(7,0,0.06856359);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-8.165724);
   Graph_Graph22->SetMaximum(10.02356);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(42.81513);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01067181);
   linear_fit->SetParError(0,3.547881e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8420614);
   linear_fit->SetParError(1,0.01596991);
