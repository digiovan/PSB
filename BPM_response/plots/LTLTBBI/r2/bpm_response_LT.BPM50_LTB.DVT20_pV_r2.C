...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-0.5592585,1050,-0.4228727);
   ...
   gre->SetPoint(0,-700,-0.46974);
   gre->SetPointError(0,0,0.01470547);
   gre->SetPoint(1,-500,-0.48582);
   gre->SetPointError(1,0,0.02412313);
   gre->SetPoint(2,-300,-0.4834);
   gre->SetPointError(2,0,0.006954624);
   gre->SetPoint(3,-100,-0.48936);
   gre->SetPointError(3,0,0.02889635);
   gre->SetPoint(4,100,-0.46376);
   gre->SetPointError(4,0,0.01815634);
   gre->SetPoint(5,300,-0.49622);
   gre->SetPointError(5,0,0.0190443);
   gre->SetPoint(6,500,-0.4921);
   gre->SetPointError(6,0,0.02952735);
   gre->SetPoint(7,700,-0.50972);
   gre->SetPointError(7,0,0.02680755);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-0.5456199);
   Graph_Graph19->SetMaximum(-0.4365113);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.377169);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.687073e-05);
   linear_fit->SetParError(0,1.547496e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4861662);
   linear_fit->SetParError(1,0.006173101);
