...
//=========  (Wed Apr  1 22:34:58 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-1.444419,1050,1.339524);
   ...
   gre->SetPoint(0,-700,-0.96682);
   gre->SetPointError(0,0,0.01360842);
   gre->SetPoint(1,-500,-0.54592);
   gre->SetPointError(1,0,0.01712128);
   gre->SetPoint(2,-300,-0.21994);
   gre->SetPointError(2,0,0.01318479);
   gre->SetPoint(3,-100,0.07602);
   gre->SetPointError(3,0,0.01771955);
   gre->SetPoint(4,100,0.28424);
   gre->SetPointError(4,0,0.01542794);
   gre->SetPoint(5,300,0.53532);
   gre->SetPointError(5,0,0.01250046);
   gre->SetPoint(6,500,0.69886);
   gre->SetPointError(6,0,0.02598683);
   gre->SetPoint(7,700,0.86922);
   gre->SetPointError(7,0,0.006313844);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DVT50 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.166025);
   Graph_Graph19->SetMaximum(1.06113);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(436.0844);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001214819);
   linear_fit->SetParError(0,8.392302e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.06240074);
   linear_fit->SetParError(1,0.004714231);
