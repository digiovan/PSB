...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_2->Range(-1050,-36.45015,1050,23.95013);
   ...
   gre->SetPoint(0,-700,10.63512);
   gre->SetPointError(0,0,0.1718966);
   gre->SetPoint(1,-500,13.78282);
   gre->SetPointError(1,0,0.1005984);
   gre->SetPoint(2,-300,7.35724);
   gre->SetPointError(2,0,0.1612323);
   gre->SetPoint(3,-100,0.8433);
   gre->SetPointError(3,0,0.1349717);
   gre->SetPoint(4,100,-6.74724);
   gre->SetPointError(4,0,0.3428928);
   gre->SetPoint(5,300,-14.52534);
   gre->SetPointError(5,0,0.1270574);
   gre->SetPoint(6,500,-20.73284);
   gre->SetPointError(6,0,0.1751833);
   gre->SetPoint(7,700,-24.92552);
   gre->SetPointError(7,0,1.457914);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-30.41012);
   Graph_Graph26->SetMaximum(17.9101);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2667.075);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.03125877);
   linear_fit->SetParError(0,0.0001407729);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.894971);
   linear_fit->SetParError(1,0.0597351);
