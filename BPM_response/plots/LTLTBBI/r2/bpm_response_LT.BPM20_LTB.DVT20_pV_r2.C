...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-6.502996,1050,-6.194935);
   ...
   gre->SetPoint(0,-700,-6.3403);
   gre->SetPointError(0,0,0.03812225);
   gre->SetPoint(1,-500,-6.32716);
   gre->SetPointError(1,0,0.05097029);
   gre->SetPoint(2,-300,-6.28394);
   gre->SetPointError(2,0,0.03766157);
   gre->SetPoint(3,-100,-6.31842);
   gre->SetPointError(3,0,0.04225696);
   gre->SetPoint(4,100,-6.31024);
   gre->SetPointError(4,0,0.009555304);
   gre->SetPoint(5,300,-6.35462);
   gre->SetPointError(5,0,0.05461815);
   gre->SetPoint(6,500,-6.296);
   gre->SetPointError(6,0,0.03685565);
   gre->SetPoint(7,700,-6.35292);
   gre->SetPointError(7,0,0.09873269);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-6.47219);
   Graph_Graph16->SetMaximum(-6.225741);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.065837);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.352131e-05);
   linear_fit->SetParError(0,3.443886e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.31241);
   linear_fit->SetParError(1,0.008477373);
