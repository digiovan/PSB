...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,2.463654,1050,15.20688);
   ...
   gre->SetPoint(0,-700,13.01728);
   gre->SetPointError(0,0,0.06572577);
   gre->SetPoint(1,-500,11.6856);
   gre->SetPointError(1,0,0.02790936);
   gre->SetPoint(2,-300,10.4294);
   gre->SetPointError(2,0,0.02529841);
   gre->SetPoint(3,-100,9.16178);
   gre->SetPointError(3,0,0.01318962);
   gre->SetPoint(4,100,7.96854);
   gre->SetPointError(4,0,0.02845985);
   gre->SetPoint(5,300,6.8803);
   gre->SetPointError(5,0,0.06152001);
   gre->SetPoint(6,500,5.87152);
   gre->SetPointError(6,0,0.06152868);
   gre->SetPoint(7,700,4.61642);
   gre->SetPointError(7,0,0.02889561);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(3.737976);
   Graph_Graph25->SetMaximum(13.93255);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(82.23882);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005879212);
   linear_fit->SetParError(0,2.791896e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.63234);
   linear_fit->SetParError(1,0.00934842);
