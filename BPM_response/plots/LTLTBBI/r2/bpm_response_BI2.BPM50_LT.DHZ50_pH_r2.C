...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-13.56427,1050,8.550452);
   ...
   gre->SetPoint(0,-700,-9.06938);
   gre->SetPointError(0,0,0.8090997);
   gre->SetPoint(1,-500,1.8018);
   gre->SetPointError(1,0,0.2120518);
   gre->SetPoint(2,-300,-4.5629);
   gre->SetPointError(2,0,0.4126338);
   gre->SetPoint(3,-100,4.05312);
   gre->SetPointError(3,0,0.04520797);
   gre->SetPoint(4,100,4.55612);
   gre->SetPointError(4,0,0.3085453);
   gre->SetPoint(5,300,-1.9824);
   gre->SetPointError(5,0,0.2086524);
   gre->SetPoint(6,500,4.3264);
   gre->SetPointError(6,0,0.2081251);
   gre->SetPoint(7,700,0.57028);
   gre->SetPointError(7,0,0.5933108);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DHZ50 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-11.35279);
   Graph_Graph28->SetMaximum(6.33898);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1568.032);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0004990781);
   linear_fit->SetParError(0,0.0002350441);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.571883);
   linear_fit->SetParError(1,0.04485871);
