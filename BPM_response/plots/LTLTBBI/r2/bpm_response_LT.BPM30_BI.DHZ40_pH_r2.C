...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-10.23101,1050,-9.678032);
   ...
   gre->SetPoint(0,-700,-10.03228);
   gre->SetPointError(0,0,0.1065705);
   gre->SetPoint(1,-500,-10.018);
   gre->SetPointError(1,0,0.06309294);
   gre->SetPoint(2,-300,-9.81112);
   gre->SetPointError(2,0,0.04092446);
   gre->SetPoint(3,-100,-9.9501);
   gre->SetPointError(3,0,0.03948421);
   gre->SetPoint(4,100,-9.87882);
   gre->SetPointError(4,0,0.02415619);
   gre->SetPoint(5,300,-9.84186);
   gre->SetPointError(5,0,0.04127581);
   gre->SetPoint(6,500,-9.92172);
   gre->SetPointError(6,0,0.07425349);
   gre->SetPoint(7,700,-9.87062);
   gre->SetPointError(7,0,0.07696477);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.17572);
   Graph_Graph17->SetMaximum(-9.73333);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.11831);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.694357e-05);
   linear_fit->SetParError(0,5.267667e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.889909);
   linear_fit->SetParError(1,0.01545761);
