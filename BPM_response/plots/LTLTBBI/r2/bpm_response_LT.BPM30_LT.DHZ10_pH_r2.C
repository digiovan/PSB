...
//=========  (Wed Apr  1 22:34:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-11.95545,1050,-8.075129);
   ...
   gre->SetPoint(0,-700,-8.75294);
   gre->SetPointError(0,0,0.03109107);
   gre->SetPoint(1,-500,-9.204);
   gre->SetPointError(1,0,0.02135501);
   gre->SetPoint(2,-300,-9.6737);
   gre->SetPointError(2,0,0.1007783);
   gre->SetPoint(3,-100,-9.74272);
   gre->SetPointError(3,0,0.05524453);
   gre->SetPoint(4,100,-10.12558);
   gre->SetPointError(4,0,0.01806461);
   gre->SetPoint(5,300,-10.74974);
   gre->SetPointError(5,0,0.02549166);
   gre->SetPoint(6,500,-11.11726);
   gre->SetPointError(6,0,0.04628376);
   gre->SetPoint(7,700,-11.28066);
   gre->SetPointError(7,0,0.02806949);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-11.56742);
   Graph_Graph17->SetMaximum(-8.463161);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(102.3111);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001810973);
   linear_fit->SetParError(0,2.25018e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.05211);
   linear_fit->SetParError(1,0.01000367);
