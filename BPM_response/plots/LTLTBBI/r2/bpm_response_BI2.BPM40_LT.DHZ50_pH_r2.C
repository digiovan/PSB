...
//=========  (Wed Apr  1 22:34:54 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-11.67016,1050,14.85918);
   ...
   gre->SetPoint(0,-700,-6.3598);
   gre->SetPointError(0,0,0.8888059);
   gre->SetPoint(1,-500,4.37346);
   gre->SetPointError(1,0,0.1737609);
   gre->SetPoint(2,-300,0.1683);
   gre->SetPointError(2,0,0.3091441);
   gre->SetPoint(3,-100,8.79998);
   gre->SetPointError(3,0,0.02933136);
   gre->SetPoint(4,100,9.96914);
   gre->SetPointError(4,0,0.2639626);
   gre->SetPoint(5,300,1.66266);
   gre->SetPointError(5,0,0.407895);
   gre->SetPoint(6,500,10.19918);
   gre->SetPointError(6,0,0.2384415);
   gre->SetPoint(7,700,3.80778);
   gre->SetPointError(7,0,0.7226872);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LT.DHZ50 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-9.017229);
   Graph_Graph27->SetMaximum(12.20624);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1631.782);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005358979);
   linear_fit->SetParError(0,0.0002559448);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,9.116217);
   linear_fit->SetParError(1,0.03799736);
