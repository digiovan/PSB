...
//=========  (Wed Apr  1 22:35:14 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-10.07553,1050,-9.622672);
   ...
   gre->SetPoint(0,-700,-9.8491);
   gre->SetPointError(0,0,0.1509521);
   gre->SetPoint(1,-500,-9.85524);
   gre->SetPointError(1,0,0.05363307);
   gre->SetPoint(2,-300,-9.91086);
   gre->SetPointError(2,0,0.05032153);
   gre->SetPoint(3,-100,-9.86748);
   gre->SetPointError(3,0,0.05809747);
   gre->SetPoint(4,100,-9.76394);
   gre->SetPointError(4,0,0.05736052);
   gre->SetPoint(5,300,-9.90362);
   gre->SetPointError(5,0,0.03573312);
   gre->SetPoint(6,500,-9.78588);
   gre->SetPointError(6,0,0.0622141);
   gre->SetPoint(7,700,-9.90426);
   gre->SetPointError(7,0,0.0467732);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.03024);
   Graph_Graph17->SetMaximum(-9.667958);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.39536);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.642666e-06);
   linear_fit->SetParError(0,4.644241e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.868128);
   linear_fit->SetParError(1,0.01950677);
