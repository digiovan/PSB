...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,1.718585,1050,2.277313);
   ...
   gre->SetPoint(0,-700,1.85572);
   gre->SetPointError(0,0,0.04082756);
   gre->SetPoint(1,-500,2.00858);
   gre->SetPointError(1,0,0.0501991);
   gre->SetPoint(2,-300,1.98982);
   gre->SetPointError(2,0,0.02823464);
   gre->SetPoint(3,-100,2.08824);
   gre->SetPointError(3,0,0.05370986);
   gre->SetPoint(4,100,2.02578);
   gre->SetPointError(4,0,0.09405855);
   gre->SetPoint(5,300,2.08642);
   gre->SetPointError(5,0,0.03821823);
   gre->SetPoint(6,500,1.91412);
   gre->SetPointError(6,0,0.1024133);
   gre->SetPoint(7,700,2.1244);
   gre->SetPointError(7,0,0.05979184);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(1.774458);
   Graph_Graph21->SetMaximum(2.22144);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.508564);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001568002);
   linear_fit->SetParError(0,3.930633e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.029864);
   linear_fit->SetParError(1,0.01733266);
