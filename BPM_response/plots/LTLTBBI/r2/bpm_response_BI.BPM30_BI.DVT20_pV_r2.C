...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_2->Range(-1050,-8.869642,1050,4.108707);
   ...
   gre->SetPoint(0,-700,-6.5504);
   gre->SetPointError(0,0,0.1561835);
   gre->SetPoint(1,-500,-4.89308);
   gre->SetPointError(1,0,0.1089544);
   gre->SetPoint(2,-300,-3.97604);
   gre->SetPointError(2,0,0.06555791);
   gre->SetPoint(3,-100,-2.54104);
   gre->SetPointError(3,0,0.1804542);
   gre->SetPoint(4,100,-1.64096);
   gre->SetPointError(4,0,0.2404902);
   gre->SetPoint(5,300,-0.53778);
   gre->SetPointError(5,0,0.09157413);
   gre->SetPoint(6,500,0.1136);
   gre->SetPointError(6,0,0.5080129);
   gre->SetPoint(7,700,1.66544);
   gre->SetPointError(7,0,0.2802091);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-7.571807);
   Graph_Graph26->SetMaximum(2.810872);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.91087);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005705339);
   linear_fit->SetParError(0,0.0001252603);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.234948);
   linear_fit->SetParError(1,0.04828706);
