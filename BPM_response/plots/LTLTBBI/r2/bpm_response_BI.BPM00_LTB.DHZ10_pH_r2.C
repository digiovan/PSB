...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-9.340128,1050,-3.126473);
   ...
   gre->SetPoint(0,-700,-8.24472);
   gre->SetPointError(0,0,0.05979841);
   gre->SetPoint(1,-500,-7.5699);
   gre->SetPointError(1,0,0.04646942);
   gre->SetPoint(2,-300,-6.96298);
   gre->SetPointError(2,0,0.1590169);
   gre->SetPoint(3,-100,-6.17812);
   gre->SetPointError(3,0,0.03472258);
   gre->SetPoint(4,100,-5.58812);
   gre->SetPointError(4,0,0.05506384);
   gre->SetPoint(5,300,-5.07086);
   gre->SetPointError(5,0,0.09747454);
   gre->SetPoint(6,500,-4.55124);
   gre->SetPointError(6,0,0.01161995);
   gre->SetPoint(7,700,-4.2427);
   gre->SetPointError(7,0,0.0806181);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-8.718762);
   Graph_Graph23->SetMaximum(-3.747838);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(44.98558);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002942967);
   linear_fit->SetParError(0,3.10997e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.018242);
   linear_fit->SetParError(1,0.01489732);
