...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-0.3725265,1050,-0.297301);
   ...
   gre->SetPoint(0,-700,-0.34444);
   gre->SetPointError(0,0,0.01155489);
   gre->SetPoint(1,-500,-0.34992);
   gre->SetPointError(1,0,0.005632959);
   gre->SetPoint(2,-300,-0.34858);
   gre->SetPointError(2,0,0.006918447);
   gre->SetPoint(3,-100,-0.32896);
   gre->SetPointError(3,0,0.01912143);
   gre->SetPoint(4,100,-0.34024);
   gre->SetPointError(4,0,0.01974895);
   gre->SetPoint(5,300,-0.3232);
   gre->SetPointError(5,0,0.005042553);
   gre->SetPoint(6,500,-0.33494);
   gre->SetPointError(6,0,0.01889713);
   gre->SetPoint(7,700,-0.32238);
   gre->SetPointError(7,0,0.008057841);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.365004);
   Graph_Graph18->SetMaximum(-0.3048235);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.268603);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.532582e-05);
   linear_fit->SetParError(0,6.301979e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3356455);
   linear_fit->SetParError(1,0.002859553);
