...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_V_2->Range(-1050,-28.58588,1050,22.03386);
   ...
   gre->SetPoint(0,-700,-16.44494);
   gre->SetPointError(0,0,1.379775);
   gre->SetPoint(1,-500,-19.74744);
   gre->SetPointError(1,0,0.4018122);
   gre->SetPoint(2,-300,-14.9176);
   gre->SetPointError(2,0,0.05873812);
   gre->SetPoint(3,-100,-9.45028);
   gre->SetPointError(3,0,0.1912689);
   gre->SetPoint(4,100,-4.38356);
   gre->SetPointError(4,0,0.05517771);
   gre->SetPoint(5,300,1.99106);
   gre->SetPointError(5,0,0.160868);
   gre->SetPoint(6,500,7.47518);
   gre->SetPointError(6,0,0.1537709);
   gre->SetPoint(7,700,13.38134);
   gre->SetPointError(7,0,0.2158989);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-23.5239);
   Graph_Graph27->SetMaximum(16.97189);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(135.7742);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02754809);
   linear_fit->SetParError(0,0.0001338656);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.79303);
   linear_fit->SetParError(1,0.03646813);
