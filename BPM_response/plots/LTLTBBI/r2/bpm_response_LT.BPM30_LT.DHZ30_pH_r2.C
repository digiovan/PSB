...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-10.9406,1050,-9.277286);
   ...
   gre->SetPoint(0,-700,-10.36168);
   gre->SetPointError(0,0,0.09427287);
   gre->SetPoint(1,-500,-10.56744);
   gre->SetPointError(1,0,0.09594346);
   gre->SetPoint(2,-300,-10.16524);
   gre->SetPointError(2,0,0.08232592);
   gre->SetPoint(3,-100,-10.25578);
   gre->SetPointError(3,0,0.01688543);
   gre->SetPoint(4,100,-9.91024);
   gre->SetPointError(4,0,0.0174458);
   gre->SetPoint(5,300,-9.94682);
   gre->SetPointError(5,0,0.04531718);
   gre->SetPoint(6,500,-9.84416);
   gre->SetPointError(6,0,0.05859257);
   gre->SetPoint(7,700,-9.62092);
   gre->SetPointError(7,0,0.06641436);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.77427);
   Graph_Graph17->SetMaximum(-9.443618);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(85.27871);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0007666055);
   linear_fit->SetParError(0,5.106247e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.09355);
   linear_fit->SetParError(1,0.01117638);
