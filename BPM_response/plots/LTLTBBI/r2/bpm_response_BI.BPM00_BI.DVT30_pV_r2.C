...
//=========  (Wed Apr  1 22:36:12 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-0.88152,1050,-0.4603435);
   ...
   gre->SetPoint(0,-700,-0.59206);
   gre->SetPointError(0,0,0.06152044);
   gre->SetPoint(1,-500,-0.77112);
   gre->SetPointError(1,0,0.01130426);
   gre->SetPoint(2,-300,-0.78068);
   gre->SetPointError(2,0,0.02067238);
   gre->SetPoint(3,-100,-0.7861);
   gre->SetPointError(3,0,0.02522393);
   gre->SetPoint(4,100,-0.74968);
   gre->SetPointError(4,0,0.01470439);
   gre->SetPoint(5,300,-0.76148);
   gre->SetPointError(5,0,0.02926012);
   gre->SetPoint(6,500,-0.77978);
   gre->SetPointError(6,0,0.02895723);
   gre->SetPoint(7,700,-0.67856);
   gre->SetPointError(7,0,0.02847875);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-0.8394024);
   Graph_Graph23->SetMaximum(-0.5024611);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(16.7774);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.076768e-05);
   linear_fit->SetParError(0,1.822884e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.7563717);
   linear_fit->SetParError(1,0.00743731);
