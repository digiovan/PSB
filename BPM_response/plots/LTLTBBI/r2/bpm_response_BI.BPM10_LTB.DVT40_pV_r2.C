...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,-9.928732,1050,18.03311);
   ...
   gre->SetPoint(0,-700,-5.08952);
   gre->SetPointError(0,0,0.1789053);
   gre->SetPoint(1,-500,-2.48188);
   gre->SetPointError(1,0,0.2553591);
   gre->SetPoint(2,-300,0.39506);
   gre->SetPointError(2,0,0.08475033);
   gre->SetPoint(3,-100,3.015);
   gre->SetPointError(3,0,0.09526829);
   gre->SetPoint(4,100,5.2044);
   gre->SetPointError(4,0,0.1552839);
   gre->SetPoint(5,300,8.2562);
   gre->SetPointError(5,0,0.02380742);
   gre->SetPoint(6,500,10.52224);
   gre->SetPointError(6,0,0.09119883);
   gre->SetPoint(7,700,13.31976);
   gre->SetPointError(7,0,0.05303923);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-7.132548);
   Graph_Graph24->SetMaximum(15.23692);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.42881);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01298542);
   linear_fit->SetParError(0,7.623069e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.307568);
   linear_fit->SetParError(1,0.02988819);
