...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-6.123132,1050,1.761184);
   ...
   gre->SetPoint(0,-700,-4.7674);
   gre->SetPointError(0,0,0.04167963);
   gre->SetPoint(1,-500,-3.91668);
   gre->SetPointError(1,0,0.02290085);
   gre->SetPoint(2,-300,-3.24218);
   gre->SetPointError(2,0,0.01688093);
   gre->SetPoint(3,-100,-2.43596);
   gre->SetPointError(3,0,0.05057736);
   gre->SetPoint(4,100,-1.77612);
   gre->SetPointError(4,0,0.07405888);
   gre->SetPoint(5,300,-1.03784);
   gre->SetPointError(5,0,0.02623074);
   gre->SetPoint(6,500,-0.4556);
   gre->SetPointError(6,0,0.1216449);
   gre->SetPoint(7,700,0.37594);
   gre->SetPointError(7,0,0.07119113);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-5.334701);
   Graph_Graph25->SetMaximum(0.9727522);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.88798);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003640123);
   linear_fit->SetParError(0,3.289926e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.13671);
   linear_fit->SetParError(1,0.01315672);
