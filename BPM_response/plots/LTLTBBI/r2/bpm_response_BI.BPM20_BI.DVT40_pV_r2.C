...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-2.777574,1050,-1.798992);
   ...
   gre->SetPoint(0,-700,-2.24666);
   gre->SetPointError(0,0,0.06046628);
   gre->SetPoint(1,-500,-2.09128);
   gre->SetPointError(1,0,0.05787051);
   gre->SetPoint(2,-300,-2.53854);
   gre->SetPointError(2,0,0.07593659);
   gre->SetPoint(3,-100,-2.02996);
   gre->SetPointError(3,0,0.0214198);
   gre->SetPoint(4,100,-2.06152);
   gre->SetPointError(4,0,0.09943112);
   gre->SetPoint(5,300,-2.50164);
   gre->SetPointError(5,0,0.06965713);
   gre->SetPoint(6,500,-2.30782);
   gre->SetPointError(6,0,0.1550587);
   gre->SetPoint(7,700,-2.13722);
   gre->SetPointError(7,0,0.05197385);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-2.679715);
   Graph_Graph25->SetMaximum(-1.89685);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(84.42779);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.936667e-05);
   linear_fit->SetParError(0,4.772535e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.118447);
   linear_fit->SetParError(1,0.01690882);
