...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.6378602,1050,1.026805);
   ...
   gre->SetPoint(0,-700,0.84928);
   gre->SetPointError(0,0,0.02029376);
   gre->SetPoint(1,-500,0.86344);
   gre->SetPointError(1,0,0.0154508);
   gre->SetPoint(2,-300,0.85462);
   gre->SetPointError(2,0,0.04706221);
   gre->SetPoint(3,-100,0.90554);
   gre->SetPointError(3,0,0.04233982);
   gre->SetPoint(4,100,0.8618);
   gre->SetPointError(4,0,0.0164886);
   gre->SetPoint(5,300,0.78158);
   gre->SetPointError(5,0,0.07889576);
   gre->SetPoint(6,500,0.87282);
   gre->SetPointError(6,0,0.05619091);
   gre->SetPoint(7,700,0.8852);
   gre->SetPointError(7,0,0.07678058);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.6767546);
   Graph_Graph15->SetMaximum(0.9879102);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.503106);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,9.363352e-06);
   linear_fit->SetParError(0,2.507969e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8637266);
   linear_fit->SetParError(1,0.01146302);
