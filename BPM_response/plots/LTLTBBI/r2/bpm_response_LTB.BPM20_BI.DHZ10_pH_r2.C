...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,2.324374,1050,3.456228);
   ...
   gre->SetPoint(0,-700,2.88294);
   gre->SetPointError(0,0,0.04799254);
   gre->SetPoint(1,-500,3.06502);
   gre->SetPointError(1,0,0.03965154);
   gre->SetPoint(2,-300,3.03044);
   gre->SetPointError(2,0,0.02514124);
   gre->SetPoint(3,-100,2.92344);
   gre->SetPointError(3,0,0.06258708);
   gre->SetPoint(4,100,3.03694);
   gre->SetPointError(4,0,0.1614952);
   gre->SetPoint(5,300,3.02738);
   gre->SetPointError(5,0,0.2402059);
   gre->SetPoint(6,500,2.92148);
   gre->SetPointError(6,0,0.1328615);
   gre->SetPoint(7,700,2.58986);
   gre->SetPointError(7,0,0.07684396);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(2.437559);
   Graph_Graph21->SetMaximum(3.343043);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.87958);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0001986273);
   linear_fit->SetParError(0,5.56355e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.923249);
   linear_fit->SetParError(1,0.02444667);
