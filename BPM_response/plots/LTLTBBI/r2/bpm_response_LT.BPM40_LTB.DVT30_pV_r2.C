...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_2->Range(-1050,-7.662583,1050,-7.15421);
   ...
   gre->SetPoint(0,-700,-7.4311);
   gre->SetPointError(0,0,0.07046084);
   gre->SetPoint(1,-500,-7.48708);
   gre->SetPointError(1,0,0.09077389);
   gre->SetPoint(2,-300,-7.38814);
   gre->SetPointError(2,0,0.03578028);
   gre->SetPoint(3,-100,-7.46364);
   gre->SetPointError(3,0,0.03368898);
   gre->SetPoint(4,100,-7.29636);
   gre->SetPointError(4,0,0.05742092);
   gre->SetPoint(5,300,-7.44564);
   gre->SetPointError(5,0,0.04180162);
   gre->SetPoint(6,500,-7.39628);
   gre->SetPointError(6,0,0.03293827);
   gre->SetPoint(7,700,-7.51024);
   gre->SetPointError(7,0,0.01936323);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-7.611745);
   Graph_Graph18->SetMaximum(-7.205048);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(16.24051);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.463185e-05);
   linear_fit->SetParError(0,2.915776e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.430891);
   linear_fit->SetParError(1,0.01540392);
