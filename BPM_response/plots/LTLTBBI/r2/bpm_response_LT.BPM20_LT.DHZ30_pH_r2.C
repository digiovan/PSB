...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-8.694037,1050,-7.996583);
   ...
   gre->SetPoint(0,-700,-8.22392);
   gre->SetPointError(0,0,0.1110949);
   gre->SetPoint(1,-500,-8.48052);
   gre->SetPointError(1,0,0.09727431);
   gre->SetPoint(2,-300,-8.239);
   gre->SetPointError(2,0,0.05554817);
   gre->SetPoint(3,-100,-8.37934);
   gre->SetPointError(3,0,0.0135851);
   gre->SetPoint(4,100,-8.22108);
   gre->SetPointError(4,0,0.01341671);
   gre->SetPoint(5,300,-8.27694);
   gre->SetPointError(5,0,0.05171366);
   gre->SetPoint(6,500,-8.31062);
   gre->SetPointError(6,0,0.08274016);
   gre->SetPoint(7,700,-8.2589);
   gre->SetPointError(7,0,0.0514003);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.624291);
   Graph_Graph16->SetMaximum(-8.066328);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(53.45706);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0002153108);
   linear_fit->SetParError(0,4.68638e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.3014);
   linear_fit->SetParError(1,0.009038921);
