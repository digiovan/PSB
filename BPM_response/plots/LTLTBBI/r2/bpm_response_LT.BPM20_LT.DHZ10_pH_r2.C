...
//=========  (Wed Apr  1 22:34:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-10.21763,1050,-6.272587);
   ...
   gre->SetPoint(0,-700,-6.95858);
   gre->SetPointError(0,0,0.02848607);
   gre->SetPoint(1,-500,-7.34438);
   gre->SetPointError(1,0,0.04063905);
   gre->SetPoint(2,-300,-7.8284);
   gre->SetPointError(2,0,0.08664738);
   gre->SetPoint(3,-100,-7.99598);
   gre->SetPointError(3,0,0.05836852);
   gre->SetPoint(4,100,-8.39028);
   gre->SetPointError(4,0,0.01912495);
   gre->SetPoint(5,300,-8.92852);
   gre->SetPointError(5,0,0.03274603);
   gre->SetPoint(6,500,-9.32092);
   gre->SetPointError(6,0,0.03993334);
   gre->SetPoint(7,700,-9.55396);
   gre->SetPointError(7,0,0.006161279);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-9.823124);
   Graph_Graph16->SetMaximum(-6.667091);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.43182);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001859334);
   linear_fit->SetParError(0,1.577291e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.255028);
   linear_fit->SetParError(1,0.01026914);
