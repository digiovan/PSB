...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-22.8968,1050,8.158101);
   ...
   gre->SetPoint(0,-700,2.81586);
   gre->SetPointError(0,0,0.1664244);
   gre->SetPoint(1,-500,-1.27068);
   gre->SetPointError(1,0,0.2777588);
   gre->SetPoint(2,-300,-6.1773);
   gre->SetPointError(2,0,0.2793412);
   gre->SetPoint(3,-100,-8.78752);
   gre->SetPointError(3,0,0.1671467);
   gre->SetPoint(4,100,-10.3334);
   gre->SetPointError(4,0,0.7936675);
   gre->SetPoint(5,300,-13.07596);
   gre->SetPointError(5,0,0.9056102);
   gre->SetPoint(6,500,-15.26996);
   gre->SetPointError(6,0,0.4252594);
   gre->SetPoint(7,700,-17.39206);
   gre->SetPointError(7,0,0.3289209);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-19.79131);
   Graph_Graph28->SetMaximum(5.052611);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(206.6914);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01518692);
   linear_fit->SetParError(0,0.0002183679);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.961222);
   linear_fit->SetParError(1,0.1085503);
