...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,0.09740123,1050,0.957505);
   ...
   gre->SetPoint(0,-700,0.77082);
   gre->SetPointError(0,0,0.04333438);
   gre->SetPoint(1,-500,0.61906);
   gre->SetPointError(1,0,0.1083633);
   gre->SetPoint(2,-300,0.52616);
   gre->SetPointError(2,0,0.06757136);
   gre->SetPoint(3,-100,0.47074);
   gre->SetPointError(3,0,0.151608);
   gre->SetPoint(4,100,0.42114);
   gre->SetPointError(4,0,0.1338119);
   gre->SetPoint(5,300,0.40392);
   gre->SetPointError(5,0,0.07011936);
   gre->SetPoint(6,500,0.34838);
   gre->SetPointError(6,0,0.1076281);
   gre->SetPoint(7,700,0.53122);
   gre->SetPointError(7,0,0.08204551);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(0.1834116);
   Graph_Graph22->SetMaximum(0.8714946);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.675024);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.000254829);
   linear_fit->SetParError(0,5.256495e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5416153);
   linear_fit->SetParError(1,0.02890643);
