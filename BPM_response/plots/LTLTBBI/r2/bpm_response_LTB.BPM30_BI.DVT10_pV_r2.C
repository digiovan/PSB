...
//=========  (Wed Apr  1 22:35:51 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,2.240423,1050,2.832667);
   ...
   gre->SetPoint(0,-700,2.6534);
   gre->SetPointError(0,0,0.04063469);
   gre->SetPoint(1,-500,2.41702);
   gre->SetPointError(1,0,0.07788933);
   gre->SetPoint(2,-300,2.64708);
   gre->SetPointError(2,0,0.04321257);
   gre->SetPoint(3,-100,2.62762);
   gre->SetPointError(3,0,0.09807592);
   gre->SetPoint(4,100,2.64138);
   gre->SetPointError(4,0,0.07362669);
   gre->SetPoint(5,300,2.70518);
   gre->SetPointError(5,0,0.02877954);
   gre->SetPoint(6,500,2.56562);
   gre->SetPointError(6,0,0.1584455);
   gre->SetPoint(7,700,2.5235);
   gre->SetPointError(7,0,0.04314882);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(2.299648);
   Graph_Graph22->SetMaximum(2.773442);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.81926);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.247908e-05);
   linear_fit->SetParError(0,3.608576e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.636601);
   linear_fit->SetParError(1,0.01723636);
