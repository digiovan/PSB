...
//=========  (Wed Apr  1 22:36:22 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,0.4939601,1050,0.8955767);
   ...
   gre->SetPoint(0,-700,0.67722);
   gre->SetPointError(0,0,0.0287705);
   gre->SetPoint(1,-500,0.75936);
   gre->SetPointError(1,0,0.06405485);
   gre->SetPoint(2,-300,0.59194);
   gre->SetPointError(2,0,0.03104376);
   gre->SetPoint(3,-100,0.7981);
   gre->SetPointError(3,0,0.0215071);
   gre->SetPoint(4,100,0.77626);
   gre->SetPointError(4,0,0.0523806);
   gre->SetPoint(5,300,0.58934);
   gre->SetPointError(5,0,0.02836702);
   gre->SetPoint(6,500,0.70298);
   gre->SetPointError(6,0,0.06861706);
   gre->SetPoint(7,700,0.74778);
   gre->SetPointError(7,0,0.02267117);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.5341218);
   Graph_Graph20->SetMaximum(0.855415);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.35498);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.571975e-05);
   linear_fit->SetParError(0,2.310962e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.70724);
   linear_fit->SetParError(1,0.0109506);
