...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,1.396105,1050,2.361867);
   ...
   gre->SetPoint(0,-700,1.87346);
   gre->SetPointError(0,0,0.06897257);
   gre->SetPoint(1,-500,2.04676);
   gre->SetPointError(1,0,0.10949);
   gre->SetPoint(2,-300,1.61854);
   gre->SetPointError(2,0,0.06147503);
   gre->SetPoint(3,-100,2.14222);
   gre->SetPointError(3,0,0.03446517);
   gre->SetPoint(4,100,2.10878);
   gre->SetPointError(4,0,0.09212666);
   gre->SetPoint(5,300,1.67358);
   gre->SetPointError(5,0,0.06950054);
   gre->SetPoint(6,500,1.93642);
   gre->SetPointError(6,0,0.1289808);
   gre->SetPoint(7,700,2.02984);
   gre->SetPointError(7,0,0.04820129);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(1.492681);
   Graph_Graph21->SetMaximum(2.265291);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(80.57824);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.053974e-05);
   linear_fit->SetParError(0,4.996447e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.976148);
   linear_fit->SetParError(1,0.02127892);
