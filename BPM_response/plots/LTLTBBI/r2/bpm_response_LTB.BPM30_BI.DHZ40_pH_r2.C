...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,0.7030794,1050,0.8649983);
   ...
   gre->SetPoint(0,-700,0.81484);
   gre->SetPointError(0,0,0.01005609);
   gre->SetPoint(1,-500,0.75254);
   gre->SetPointError(1,0,0.02127093);
   gre->SetPoint(2,-300,0.748);
   gre->SetPointError(2,0,0.01506382);
   gre->SetPoint(3,-100,0.76526);
   gre->SetPointError(3,0,0.02147284);
   gre->SetPoint(4,100,0.77598);
   gre->SetPointError(4,0,0.04591414);
   gre->SetPoint(5,300,0.75668);
   gre->SetPointError(5,0,0.01037781);
   gre->SetPoint(6,500,0.80726);
   gre->SetPointError(6,0,0.03075182);
   gre->SetPoint(7,700,0.7872);
   gre->SetPointError(7,0,0.01507501);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(0.7192713);
   Graph_Graph22->SetMaximum(0.8488064);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.18904);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.255224e-05);
   linear_fit->SetParError(0,1.066654e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7765319);
   linear_fit->SetParError(1,0.005520182);
