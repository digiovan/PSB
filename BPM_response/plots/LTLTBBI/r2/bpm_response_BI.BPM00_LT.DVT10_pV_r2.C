...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-1.888806,1050,0.2903888);
   ...
   gre->SetPoint(0,-700,-0.10958);
   gre->SetPointError(0,0,0.03676964);
   gre->SetPoint(1,-500,-0.29822);
   gre->SetPointError(1,0,0.009691731);
   gre->SetPoint(2,-300,-0.47106);
   gre->SetPointError(2,0,0.0521208);
   gre->SetPoint(3,-100,-0.62854);
   gre->SetPointError(3,0,0.04380479);
   gre->SetPoint(4,100,-0.83382);
   gre->SetPointError(4,0,0.05594229);
   gre->SetPoint(5,300,-1.06582);
   gre->SetPointError(5,0,0.007227315);
   gre->SetPoint(6,500,-1.21896);
   gre->SetPointError(6,0,0.06857137);
   gre->SetPoint(7,700,-1.49354);
   gre->SetPointError(7,0,0.0320669);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-1.670887);
   Graph_Graph23->SetMaximum(0.07246929);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.191338);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0009647514);
   linear_fit->SetParError(0,1.372474e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.7775522);
   linear_fit->SetParError(1,0.005516055);
