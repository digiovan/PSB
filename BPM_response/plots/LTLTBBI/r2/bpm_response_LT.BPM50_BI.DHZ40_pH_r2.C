...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-1.652952,1050,-1.463973);
   ...
   gre->SetPoint(0,-700,-1.5536);
   gre->SetPointError(0,0,0.04561885);
   gre->SetPoint(1,-500,-1.52052);
   gre->SetPointError(1,0,0.02505076);
   gre->SetPoint(2,-300,-1.59398);
   gre->SetPointError(2,0,0.01564268);
   gre->SetPoint(3,-100,-1.56034);
   gre->SetPointError(3,0,0.02513985);
   gre->SetPoint(4,100,-1.58942);
   gre->SetPointError(4,0,0.006498273);
   gre->SetPoint(5,300,-1.59506);
   gre->SetPointError(5,0,0.01429387);
   gre->SetPoint(6,500,-1.56224);
   gre->SetPointError(6,0,0.02089651);
   gre->SetPoint(7,700,-1.59268);
   gre->SetPointError(7,0,0.0287754);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.634054);
   Graph_Graph19->SetMaximum(-1.482871);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.152214);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.370563e-05);
   linear_fit->SetParError(0,1.967229e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.582801);
   linear_fit->SetParError(1,0.00527152);
