...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-0.7446468,1050,2.021166);
   ...
   gre->SetPoint(0,-700,1.5538);
   gre->SetPointError(0,0,0.006396805);
   gre->SetPoint(1,-500,0.41064);
   gre->SetPointError(1,0,0.03181936);
   gre->SetPoint(2,-300,0.35904);
   gre->SetPointError(2,0,0.01694729);
   gre->SetPoint(3,-100,0.23046);
   gre->SetPointError(3,0,0.0160624);
   gre->SetPoint(4,100,0.10216);
   gre->SetPointError(4,0,0.01913851);
   gre->SetPoint(5,300,-0.05728);
   gre->SetPointError(5,0,0.009448055);
   gre->SetPoint(6,500,-0.26756);
   gre->SetPointError(6,0,0.01611808);
   gre->SetPoint(7,700,0.8043);
   gre->SetPointError(7,0,0.02566942);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-0.4680656);
   Graph_Graph19->SetMaximum(1.744584);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5224.783);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001412695);
   linear_fit->SetParError(0,8.995741e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.4380434);
   linear_fit->SetParError(1,0.004878104);
