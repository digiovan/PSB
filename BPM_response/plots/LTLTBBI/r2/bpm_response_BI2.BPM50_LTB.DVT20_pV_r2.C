...
//=========  (Wed Apr  1 22:35:20 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-18.01169,1050,3.620958);
   ...
   gre->SetPoint(0,-700,-0.28936);
   gre->SetPointError(0,0,0.3048773);
   gre->SetPoint(1,-500,-2.53512);
   gre->SetPointError(1,0,0.3519403);
   gre->SetPoint(2,-300,-3.64552);
   gre->SetPointError(2,0,0.2446876);
   gre->SetPoint(3,-100,-5.66182);
   gre->SetPointError(3,0,0.5166266);
   gre->SetPoint(4,100,-7.05052);
   gre->SetPointError(4,0,0.9119821);
   gre->SetPoint(5,300,-8.0794);
   gre->SetPointError(5,0,0.7888933);
   gre->SetPoint(6,500,-10.4551);
   gre->SetPointError(6,0,0.4224431);
   gre->SetPoint(7,700,-12.79654);
   gre->SetPointError(7,0,1.609706);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-15.84842);
   Graph_Graph28->SetMaximum(1.457694);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.136253);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008299707);
   linear_fit->SetParError(0,0.0003804202);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.257871);
   linear_fit->SetParError(1,0.1784314);
