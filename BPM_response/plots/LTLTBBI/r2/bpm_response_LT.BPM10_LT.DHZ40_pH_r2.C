...
//=========  (Wed Apr  1 22:34:42 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.386614,1050,2.337305);
   ...
   gre->SetPoint(0,-700,2.03732);
   gre->SetPointError(0,0,0.01900578);
   gre->SetPoint(1,-500,2.0933);
   gre->SetPointError(1,0,0.006690395);
   gre->SetPoint(2,-300,1.97784);
   gre->SetPointError(2,0,0.05138261);
   gre->SetPoint(3,-100,2.07496);
   gre->SetPointError(3,0,0.03010498);
   gre->SetPoint(4,100,2.13566);
   gre->SetPointError(4,0,0.04319678);
   gre->SetPoint(5,300,2.05912);
   gre->SetPointError(5,0,0.01406212);
   gre->SetPoint(6,500,1.73568);
   gre->SetPointError(6,0,0.1906178);
   gre->SetPoint(7,700,2.016);
   gre->SetPointError(7,0,0.006491396);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.481683);
   Graph_Graph15->SetMaximum(2.242236);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.68197);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.479927e-05);
   linear_fit->SetParError(0,7.32063e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.0585);
   linear_fit->SetParError(1,0.004275566);
