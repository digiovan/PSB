...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-7.384186,1050,-3.633117);
   ...
   gre->SetPoint(0,-700,-5.90284);
   gre->SetPointError(0,0,0.3406624);
   gre->SetPoint(1,-500,-6.1581);
   gre->SetPointError(1,0,0.6009075);
   gre->SetPoint(2,-300,-4.67964);
   gre->SetPointError(2,0,0.4213448);
   gre->SetPoint(3,-100,-6.04766);
   gre->SetPointError(3,0,0.3360343);
   gre->SetPoint(4,100,-5.62608);
   gre->SetPointError(4,0,0.8047446);
   gre->SetPoint(5,300,-6.29882);
   gre->SetPointError(5,0,0.3188332);
   gre->SetPoint(6,500,-6.04676);
   gre->SetPointError(6,0,0.4669886);
   gre->SetPoint(7,700,-5.15428);
   gre->SetPointError(7,0,0.1612516);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-7.009079);
   Graph_Graph28->SetMaximum(-4.008224);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.30243);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004403001);
   linear_fit->SetParError(0,0.0002225306);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.657132);
   linear_fit->SetParError(1,0.1275995);
