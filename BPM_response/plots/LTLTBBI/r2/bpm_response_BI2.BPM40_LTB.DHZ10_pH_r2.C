...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-10.18836,1050,6.25903);
   ...
   gre->SetPoint(0,-700,1.0548);
   gre->SetPointError(0,0,0.5481073);
   gre->SetPoint(1,-500,1.87152);
   gre->SetPointError(1,0,1.355742);
   gre->SetPoint(2,-300,1.97884);
   gre->SetPointError(2,0,1.538959);
   gre->SetPoint(3,-100,0.39888);
   gre->SetPointError(3,0,0.3889759);
   gre->SetPoint(4,100,0.50102);
   gre->SetPointError(4,0,0.5706608);
   gre->SetPoint(5,300,-0.4742);
   gre->SetPointError(5,0,1.081208);
   gre->SetPoint(6,500,-1.20006);
   gre->SetPointError(6,0,1.144029);
   gre->SetPoint(7,700,-6.25546);
   gre->SetPointError(7,0,1.191666);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-8.543618);
   Graph_Graph27->SetMaximum(4.614291);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.32394);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00286436);
   linear_fit->SetParError(0,0.0006620677);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.1089909);
   linear_fit->SetParError(1,0.2600687);
