...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,0.4367119,1050,1.711244);
   ...
   gre->SetPoint(0,-700,1.43856);
   gre->SetPointError(0,0,0.0602616);
   gre->SetPoint(1,-500,1.11698);
   gre->SetPointError(1,0,0.01687243);
   gre->SetPoint(2,-300,1.0687);
   gre->SetPointError(2,0,0.01801106);
   gre->SetPoint(3,-100,0.92692);
   gre->SetPointError(3,0,0.03167008);
   gre->SetPoint(4,100,0.91778);
   gre->SetPointError(4,0,0.05741191);
   gre->SetPoint(5,300,0.87534);
   gre->SetPointError(5,0,0.008156458);
   gre->SetPoint(6,500,0.73308);
   gre->SetPointError(6,0,0.08394611);
   gre->SetPoint(7,700,0.9394);
   gre->SetPointError(7,0,0.02308975);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.5641651);
   Graph_Graph20->SetMaximum(1.58379);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(77.8797);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002596551);
   linear_fit->SetParError(0,1.749851e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9756664);
   linear_fit->SetParError(1,0.006621222);
