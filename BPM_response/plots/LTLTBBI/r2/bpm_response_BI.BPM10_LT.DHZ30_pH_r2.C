...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-13.00247,1050,7.996822);
   ...
   gre->SetPoint(0,-700,4.34798);
   gre->SetPointError(0,0,0.1489602);
   gre->SetPoint(1,-500,2.82588);
   gre->SetPointError(1,0,0.2679735);
   gre->SetPoint(2,-300,-0.30928);
   gre->SetPointError(2,0,0.1741347);
   gre->SetPoint(3,-100,-2.05838);
   gre->SetPointError(3,0,0.153308);
   gre->SetPoint(4,100,-4.68584);
   gre->SetPointError(4,0,0.0998496);
   gre->SetPoint(5,300,-6.05862);
   gre->SetPointError(5,0,0.075028);
   gre->SetPoint(6,500,-7.8017);
   gre->SetPointError(6,0,0.137591);
   gre->SetPoint(7,700,-9.37592);
   gre->SetPointError(7,0,0.1266665);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-10.90254);
   Graph_Graph24->SetMaximum(5.896893);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(90.27495);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009852778);
   linear_fit->SetParError(0,0.0001137027);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.05158);
   linear_fit->SetParError(1,0.04688089);
