...
//=========  (Wed Apr  1 22:35:14 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-0.3615767,1050,-0.2891801);
   ...
   gre->SetPoint(0,-700,-0.31892);
   gre->SetPointError(0,0,0.01767384);
   gre->SetPoint(1,-500,-0.31406);
   gre->SetPointError(1,0,0.006986604);
   gre->SetPoint(2,-300,-0.31094);
   gre->SetPointError(2,0,0.002677256);
   gre->SetPoint(3,-100,-0.31212);
   gre->SetPointError(3,0,0.007961974);
   gre->SetPoint(4,100,-0.33922);
   gre->SetPointError(4,0,0.01029058);
   gre->SetPoint(5,300,-0.31936);
   gre->SetPointError(5,0,0.002198194);
   gre->SetPoint(6,500,-0.33524);
   gre->SetPointError(6,0,0.0131169);
   gre->SetPoint(7,700,-0.31024);
   gre->SetPointError(7,0,0.002731076);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.354337);
   Graph_Graph18->SetMaximum(-0.2964197);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.30991);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-9.698006e-07);
   linear_fit->SetParError(0,3.427642e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3147967);
   linear_fit->SetParError(1,0.001520098);
