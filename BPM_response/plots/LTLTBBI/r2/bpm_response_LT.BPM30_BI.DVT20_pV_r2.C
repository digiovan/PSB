...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.56701,1050,-9.785585);
   ...
   gre->SetPoint(0,-700,-10.111);
   gre->SetPointError(0,0,0.05364454);
   gre->SetPoint(1,-500,-10.17076);
   gre->SetPointError(1,0,0.09329682);
   gre->SetPoint(2,-300,-10.1738);
   gre->SetPointError(2,0,0.06849348);
   gre->SetPoint(3,-100,-10.20442);
   gre->SetPointError(3,0,0.04826613);
   gre->SetPoint(4,100,-10.25882);
   gre->SetPointError(4,0,0.1779521);
   gre->SetPoint(5,300,-10.26782);
   gre->SetPointError(5,0,0.04863354);
   gre->SetPoint(6,500,-10.01058);
   gre->SetPointError(6,0,0.09475718);
   gre->SetPoint(7,700,-10.28836);
   gre->SetPointError(7,0,0.1247827);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.48887);
   Graph_Graph17->SetMaximum(-9.863728);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.236878);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.174158e-05);
   linear_fit->SetParError(0,5.753341e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.19516);
   linear_fit->SetParError(1,0.02471595);
