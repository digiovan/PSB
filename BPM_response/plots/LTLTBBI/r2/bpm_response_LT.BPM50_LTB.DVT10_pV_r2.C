...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-0.5455287,1050,-0.3919314);
   ...
   gre->SetPoint(0,-700,-0.45538);
   gre->SetPointError(0,0,0.003619149);
   gre->SetPoint(1,-500,-0.47322);
   gre->SetPointError(1,0,0.01946561);
   gre->SetPoint(2,-300,-0.48938);
   gre->SetPointError(2,0,0.01682891);
   gre->SetPoint(3,-100,-0.44128);
   gre->SetPointError(3,0,0.02374909);
   gre->SetPoint(4,100,-0.49684);
   gre->SetPointError(4,0,0.02308914);
   gre->SetPoint(5,300,-0.48582);
   gre->SetPointError(5,0,0.01242501);
   gre->SetPoint(6,500,-0.4553);
   gre->SetPointError(6,0,0.03508659);
   gre->SetPoint(7,700,-0.47254);
   gre->SetPointError(7,0,0.02210188);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-0.530169);
   Graph_Graph19->SetMaximum(-0.4072911);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.321241);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.365595e-05);
   linear_fit->SetParError(0,9.179264e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4730019);
   linear_fit->SetParError(1,0.005956403);
