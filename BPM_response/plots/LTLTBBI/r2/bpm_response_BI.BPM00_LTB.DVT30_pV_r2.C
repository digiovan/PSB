...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-3.877051,1050,2.26916);
   ...
   gre->SetPoint(0,-700,-2.8298);
   gre->SetPointError(0,0,0.02288243);
   gre->SetPoint(1,-500,-2.25942);
   gre->SetPointError(1,0,0.05973104);
   gre->SetPoint(2,-300,-1.6201);
   gre->SetPointError(2,0,0.0118936);
   gre->SetPoint(3,-100,-1.08456);
   gre->SetPointError(3,0,0.03564666);
   gre->SetPoint(4,100,-0.5354);
   gre->SetPointError(4,0,0.02384642);
   gre->SetPoint(5,300,-0.04864);
   gre->SetPointError(5,0,0.01516357);
   gre->SetPoint(6,500,0.63332);
   gre->SetPointError(6,0,0.03419718);
   gre->SetPoint(7,700,1.21222);
   gre->SetPointError(7,0,0.0325711);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-3.26243);
   Graph_Graph23->SetMaximum(1.654538);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(44.11381);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002788248);
   linear_fit->SetParError(0,1.936661e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.8200965);
   linear_fit->SetParError(1,0.007558787);
