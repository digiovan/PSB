...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,6.099119,1050,9.79496);
   ...
   gre->SetPoint(0,-700,9.1109);
   gre->SetPointError(0,0,0.06808649);
   gre->SetPoint(1,-500,8.73206);
   gre->SetPointError(1,0,0.0885047);
   gre->SetPoint(2,-300,8.34098);
   gre->SetPointError(2,0,0.08888897);
   gre->SetPoint(3,-100,7.98124);
   gre->SetPointError(3,0,0.02541218);
   gre->SetPoint(4,100,7.72858);
   gre->SetPointError(4,0,0.0334114);
   gre->SetPoint(5,300,7.43818);
   gre->SetPointError(5,0,0.02441402);
   gre->SetPoint(6,500,7.1689);
   gre->SetPointError(6,0,0.0753545);
   gre->SetPoint(7,700,6.81298);
   gre->SetPointError(7,0,0.09788769);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(6.468703);
   Graph_Graph26->SetMaximum(9.425376);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.45916);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001551147);
   linear_fit->SetParError(0,5.031613e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.882704);
   linear_fit->SetParError(1,0.01476577);
