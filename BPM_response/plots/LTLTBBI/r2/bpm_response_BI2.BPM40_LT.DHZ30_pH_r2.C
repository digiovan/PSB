...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-5.033292,1050,12.69578);
   ...
   gre->SetPoint(0,-700,4.5823);
   gre->SetPointError(0,0,0.7398532);
   gre->SetPoint(1,-500,8.50534);
   gre->SetPointError(1,0,0.120565);
   gre->SetPoint(2,-300,5.06698);
   gre->SetPointError(2,0,0.4193991);
   gre->SetPoint(3,-100,9.5722);
   gre->SetPointError(3,0,0.1687314);
   gre->SetPoint(4,100,3.16034);
   gre->SetPointError(4,0,0.2500668);
   gre->SetPoint(5,300,7.52396);
   gre->SetPointError(5,0,0.3252754);
   gre->SetPoint(6,500,4.91002);
   gre->SetPointError(6,0,1.451105);
   gre->SetPoint(7,700,-1.36044);
   gre->SetPointError(7,0,0.7180074);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-3.260385);
   Graph_Graph27->SetMaximum(10.92287);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(555.0856);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.00363014);
   linear_fit->SetParError(0,0.0002850185);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,6.844053);
   linear_fit->SetParError(1,0.1107649);
