...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,-9.236237,1050,3.960487);
   ...
   gre->SetPoint(0,-700,-7.01564);
   gre->SetPointError(0,0,0.02114331);
   gre->SetPoint(1,-500,-5.765);
   gre->SetPointError(1,0,0.03448402);
   gre->SetPoint(2,-300,-4.56524);
   gre->SetPointError(2,0,0.06375076);
   gre->SetPoint(3,-100,-3.3134);
   gre->SetPointError(3,0,0.01619127);
   gre->SetPoint(4,100,-2.00514);
   gre->SetPointError(4,0,0.02941391);
   gre->SetPoint(5,300,-0.76056);
   gre->SetPointError(5,0,0.03355091);
   gre->SetPoint(6,500,0.51234);
   gre->SetPointError(6,0,0.008325162);
   gre->SetPoint(7,700,1.73676);
   gre->SetPointError(7,0,0.02427249);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-7.916565);
   Graph_Graph26->SetMaximum(2.640814);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.86548);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006289722);
   linear_fit->SetParError(0,1.523698e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.641484);
   linear_fit->SetParError(1,0.007354953);
