...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,0.6938986,1050,1.0029);
   ...
   gre->SetPoint(0,-700,0.77748);
   gre->SetPointError(0,0,0.02701736);
   gre->SetPoint(1,-500,0.80146);
   gre->SetPointError(1,0,0.0428944);
   gre->SetPoint(2,-300,0.86498);
   gre->SetPointError(2,0,0.08641958);
   gre->SetPoint(3,-100,0.8288);
   gre->SetPointError(3,0,0.02120747);
   gre->SetPoint(4,100,0.76976);
   gre->SetPointError(4,0,0.02436121);
   gre->SetPoint(5,300,0.81968);
   gre->SetPointError(5,0,0.0385181);
   gre->SetPoint(6,500,0.78294);
   gre->SetPointError(6,0,0.006613126);
   gre->SetPoint(7,700,0.79352);
   gre->SetPointError(7,0,0.0343072);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(0.7247987);
   Graph_Graph22->SetMaximum(0.9719997);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.851161);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.514849e-05);
   linear_fit->SetParError(0,1.786629e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7925717);
   linear_fit->SetParError(1,0.008612648);
