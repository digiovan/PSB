...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-9.766444,1050,7.060389);
   ...
   gre->SetPoint(0,-700,0.03022);
   gre->SetPointError(0,0,0.2399185);
   gre->SetPoint(1,-500,3.53402);
   gre->SetPointError(1,0,0.5346872);
   gre->SetPoint(2,-300,-1.41764);
   gre->SetPointError(2,0,0.1673353);
   gre->SetPoint(3,-100,3.7073);
   gre->SetPointError(3,0,0.1331343);
   gre->SetPoint(4,100,4.0481);
   gre->SetPointError(4,0,0.2078171);
   gre->SetPoint(5,300,-1.62716);
   gre->SetPointError(5,0,0.3945717);
   gre->SetPoint(6,500,2.03014);
   gre->SetPointError(6,0,0.1999502);
   gre->SetPoint(7,700,-6.13424);
   gre->SetPointError(7,0,0.8277318);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-8.083761);
   Graph_Graph28->SetMaximum(5.377706);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(864.0331);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001748335);
   linear_fit->SetParError(0,0.0002234958);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.883272);
   linear_fit->SetParError(1,0.07866539);
