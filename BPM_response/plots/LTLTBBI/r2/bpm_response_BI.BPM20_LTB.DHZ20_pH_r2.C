...
//=========  (Wed Apr  1 22:35:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,-1.301322,1050,17.97219);
   ...
   gre->SetPoint(0,-700,14.71682);
   gre->SetPointError(0,0,0.0431205);
   gre->SetPoint(1,-500,12.74796);
   gre->SetPointError(1,0,0.02723935);
   gre->SetPoint(2,-300,10.9739);
   gre->SetPointError(2,0,0.04036364);
   gre->SetPoint(3,-100,9.37972);
   gre->SetPointError(3,0,0.02597);
   gre->SetPoint(4,100,7.62794);
   gre->SetPointError(4,0,0.0225662);
   gre->SetPoint(5,300,5.73368);
   gre->SetPointError(5,0,0.06537387);
   gre->SetPoint(6,500,3.83004);
   gre->SetPointError(6,0,0.008787335);
   gre->SetPoint(7,700,1.96646);
   gre->SetPointError(7,0,0.05552923);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(0.6260298);
   Graph_Graph25->SetMaximum(16.04484);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(110.8875);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009042179);
   linear_fit->SetParError(0,1.99848e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.368663);
   linear_fit->SetParError(1,0.009183147);
