...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,-3.798567,1050,7.647933);
   ...
   gre->SetPoint(0,-700,-1.79734);
   gre->SetPointError(0,0,0.09347702);
   gre->SetPoint(1,-500,-0.73446);
   gre->SetPointError(1,0,0.06042704);
   gre->SetPoint(2,-300,0.3842);
   gre->SetPointError(2,0,0.03480626);
   gre->SetPoint(3,-100,1.41928);
   gre->SetPointError(3,0,0.08268761);
   gre->SetPoint(4,100,2.56058);
   gre->SetPointError(4,0,0.0278345);
   gre->SetPoint(5,300,3.44634);
   gre->SetPointError(5,0,0.09682052);
   gre->SetPoint(6,500,4.47148);
   gre->SetPointError(6,0,0.1206825);
   gre->SetPoint(7,700,5.60614);
   gre->SetPointError(7,0,0.1340426);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-2.653917);
   Graph_Graph21->SetMaximum(6.503283);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.455116);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005341109);
   linear_fit->SetParError(0,6.370305e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.984154);
   linear_fit->SetParError(1,0.01939927);
