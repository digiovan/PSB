...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-8.254751,1050,-2.843743);
   ...
   gre->SetPoint(0,-700,-4.13594);
   gre->SetPointError(0,0,0.390362);
   gre->SetPoint(1,-500,-5.9069);
   gre->SetPointError(1,0,0.6576441);
   gre->SetPoint(2,-300,-5.70062);
   gre->SetPointError(2,0,0.2143035);
   gre->SetPoint(3,-100,-5.20624);
   gre->SetPointError(3,0,0.4468437);
   gre->SetPoint(4,100,-5.75278);
   gre->SetPointError(4,0,0.1895075);
   gre->SetPoint(5,300,-6.53776);
   gre->SetPointError(5,0,0.1944008);
   gre->SetPoint(6,500,-5.55204);
   gre->SetPointError(6,0,0.5814378);
   gre->SetPoint(7,700,-7.06942);
   gre->SetPointError(7,0,0.283496);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-7.71365);
   Graph_Graph28->SetMaximum(-3.384844);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.23263);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001604018);
   linear_fit->SetParError(0,0.0002610645);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.841941);
   linear_fit->SetParError(1,0.09948174);
