...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.7701651,1050,0.9760244);
   ...
   gre->SetPoint(0,-700,0.88876);
   gre->SetPointError(0,0,0.008007559);
   gre->SetPoint(1,-500,0.87728);
   gre->SetPointError(1,0,0.02531206);
   gre->SetPoint(2,-300,0.84668);
   gre->SetPointError(2,0,0.02881755);
   gre->SetPoint(3,-100,0.84332);
   gre->SetPointError(3,0,0.03884503);
   gre->SetPoint(4,100,0.86064);
   gre->SetPointError(4,0,0.02591297);
   gre->SetPoint(5,300,0.86812);
   gre->SetPointError(5,0,0.05881927);
   gre->SetPoint(6,500,0.8482);
   gre->SetPointError(6,0,0.03471011);
   gre->SetPoint(7,700,0.87832);
   gre->SetPointError(7,0,0.06339452);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.790751);
   Graph_Graph15->SetMaximum(0.9554385);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1.724947);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.425927e-05);
   linear_fit->SetParError(0,1.931111e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.862712);
   linear_fit->SetParError(1,0.01204848);
