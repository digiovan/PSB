...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-8.386804,1050,-7.877994);
   ...
   gre->SetPoint(0,-700,-8.10416);
   gre->SetPointError(0,0,0.02124275);
   gre->SetPoint(1,-500,-8.05056);
   gre->SetPointError(1,0,0.02326432);
   gre->SetPoint(2,-300,-8.13944);
   gre->SetPointError(2,0,0.08256732);
   gre->SetPoint(3,-100,-8.11606);
   gre->SetPointError(3,0,0.05129341);
   gre->SetPoint(4,100,-8.02572);
   gre->SetPointError(4,0,0.06292441);
   gre->SetPoint(5,300,-8.06966);
   gre->SetPointError(5,0,0.09545462);
   gre->SetPoint(6,500,-8.1108);
   gre->SetPointError(6,0,0.04370839);
   gre->SetPoint(7,700,-8.25872);
   gre->SetPointError(7,0,0.04328236);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.335923);
   Graph_Graph16->SetMaximum(-7.928875);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.32642);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.863715e-05);
   linear_fit->SetParError(0,2.680483e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.120957);
   linear_fit->SetParError(1,0.01534492);
