...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_2->Range(-1050,-14.28933,1050,6.763109);
   ...
   gre->SetPoint(0,-700,-10.5181);
   gre->SetPointError(0,0,0.2624921);
   gre->SetPoint(1,-500,-7.44736);
   gre->SetPointError(1,0,0.2315993);
   gre->SetPoint(2,-300,-6.0959);
   gre->SetPointError(2,0,0.3024776);
   gre->SetPoint(3,-100,-4.27884);
   gre->SetPointError(3,0,0.2034561);
   gre->SetPoint(4,100,-2.20552);
   gre->SetPointError(4,0,0.4169341);
   gre->SetPoint(5,300,-0.05938);
   gre->SetPointError(5,0,0.1123672);
   gre->SetPoint(6,500,1.53436);
   gre->SetPointError(6,0,0.4306269);
   gre->SetPoint(7,700,3.04408);
   gre->SetPointError(7,0,0.2102883);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-12.18409);
   Graph_Graph26->SetMaximum(4.657864);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.34549);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.009566177);
   linear_fit->SetParError(0,0.0001799368);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.150888);
   linear_fit->SetParError(1,0.07633541);
