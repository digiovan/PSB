...
//=========  (Wed Apr  1 22:36:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-6.421196,1050,-6.026372);
   ...
   gre->SetPoint(0,-700,-6.15998);
   gre->SetPointError(0,0,0.06780432);
   gre->SetPoint(1,-500,-6.3251);
   gre->SetPointError(1,0,0.01668823);
   gre->SetPoint(2,-300,-6.2836);
   gre->SetPointError(2,0,0.01787468);
   gre->SetPoint(3,-100,-6.31122);
   gre->SetPointError(3,0,0.0253671);
   gre->SetPoint(4,100,-6.32446);
   gre->SetPointError(4,0,0.0306101);
   gre->SetPoint(5,300,-6.31192);
   gre->SetPointError(5,0,0.03776605);
   gre->SetPoint(6,500,-6.3188);
   gre->SetPointError(6,0,0.03659197);
   gre->SetPoint(7,700,-6.24934);
   gre->SetPointError(7,0,0.02983111);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-6.381714);
   Graph_Graph16->SetMaximum(-6.065854);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.76349);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.86117e-05);
   linear_fit->SetParError(0,2.287706e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.29903);
   linear_fit->SetParError(1,0.009546831);
