...
//=========  (Wed Apr  1 22:36:06 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,2.425312,1050,3.465895);
   ...
   gre->SetPoint(0,-700,2.94592);
   gre->SetPointError(0,0,0.0943808);
   gre->SetPoint(1,-500,2.95464);
   gre->SetPointError(1,0,0.05502438);
   gre->SetPoint(2,-300,2.99742);
   gre->SetPointError(2,0,0.08812874);
   gre->SetPoint(3,-100,2.67634);
   gre->SetPointError(3,0,0.07759725);
   gre->SetPoint(4,100,2.84916);
   gre->SetPointError(4,0,0.1545312);
   gre->SetPoint(5,300,3.11514);
   gre->SetPointError(5,0,0.1773245);
   gre->SetPoint(6,500,2.90268);
   gre->SetPointError(6,0,0.06299574);
   gre->SetPoint(7,700,2.87802);
   gre->SetPointError(7,0,0.1634273);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(2.529371);
   Graph_Graph21->SetMaximum(3.361837);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.82199);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.87597e-05);
   linear_fit->SetParError(0,6.751651e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.896983);
   linear_fit->SetParError(1,0.03122981);
