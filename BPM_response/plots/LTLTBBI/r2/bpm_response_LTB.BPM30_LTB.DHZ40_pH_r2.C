...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,0.01049733,1050,1.20219);
   ...
   gre->SetPoint(0,-700,0.28014);
   gre->SetPointError(0,0,0.07102716);
   gre->SetPoint(1,-500,0.39554);
   gre->SetPointError(1,0,0.0703378);
   gre->SetPoint(2,-300,0.55684);
   gre->SetPointError(2,0,0.1179195);
   gre->SetPoint(3,-100,0.66564);
   gre->SetPointError(3,0,0.02977836);
   gre->SetPoint(4,100,0.7025);
   gre->SetPointError(4,0,0.03834027);
   gre->SetPoint(5,300,0.7787);
   gre->SetPointError(5,0,0.06557772);
   gre->SetPoint(6,500,0.8099);
   gre->SetPointError(6,0,0.06935007);
   gre->SetPoint(7,700,0.9293);
   gre->SetPointError(7,0,0.07427484);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(0.1296666);
   Graph_Graph22->SetMaximum(1.083021);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.495136);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004251265);
   linear_fit->SetParError(0,5.472316e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6631141);
   linear_fit->SetParError(1,0.01856347);
