...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,0.1539048,1050,0.7920816);
   ...
   gre->SetPoint(0,-700,0.4697);
   gre->SetPointError(0,0,0.0935978);
   gre->SetPoint(1,-500,0.36842);
   gre->SetPointError(1,0,0.05683423);
   gre->SetPoint(2,-300,0.40108);
   gre->SetPointError(2,0,0.06750851);
   gre->SetPoint(3,-100,0.43182);
   gre->SetPointError(3,0,0.1715524);
   gre->SetPoint(4,100,0.49156);
   gre->SetPointError(4,0,0.1536916);
   gre->SetPoint(5,300,0.4837);
   gre->SetPointError(5,0,0.1037003);
   gre->SetPoint(6,500,0.49074);
   gre->SetPointError(6,0,0.05146327);
   gre->SetPoint(7,700,0.62562);
   gre->SetPointError(7,0,0.06009879);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(0.2177225);
   Graph_Graph22->SetMaximum(0.7282639);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.41527);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001421483);
   linear_fit->SetParError(0,5.103783e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.4628087);
   linear_fit->SetParError(1,0.02639263);
