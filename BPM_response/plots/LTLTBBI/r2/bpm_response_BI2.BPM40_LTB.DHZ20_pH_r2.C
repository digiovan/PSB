...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-19.93382,1050,12.25624);
   ...
   gre->SetPoint(0,-700,6.73302);
   gre->SetPointError(0,0,0.1582054);
   gre->SetPoint(1,-500,3.942);
   gre->SetPointError(1,0,0.6388053);
   gre->SetPoint(2,-300,3.59086);
   gre->SetPointError(2,0,0.6234011);
   gre->SetPoint(3,-100,2.23042);
   gre->SetPointError(3,0,0.7348893);
   gre->SetPoint(4,100,-0.1398);
   gre->SetPointError(4,0,0.287822);
   gre->SetPoint(5,300,-4.10218);
   gre->SetPointError(5,0,0.366821);
   gre->SetPoint(6,500,-10.07504);
   gre->SetPointError(6,0,1.222227);
   gre->SetPoint(7,700,-13.31368);
   gre->SetPointError(7,0,1.255132);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-16.71482);
   Graph_Graph27->SetMaximum(9.037229);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(65.59094);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01029499);
   linear_fit->SetParError(0,0.0002915582);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.330056);
   linear_fit->SetParError(1,0.1651755);
