...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-1.654524,1050,-1.46282);
   ...
   gre->SetPoint(0,-700,-1.55028);
   gre->SetPointError(0,0,0.01248149);
   gre->SetPoint(1,-500,-1.5836);
   gre->SetPointError(1,0,0.006368165);
   gre->SetPoint(2,-300,-1.56678);
   gre->SetPointError(2,0,0.01680431);
   gre->SetPoint(3,-100,-1.57306);
   gre->SetPointError(3,0,0.01943139);
   gre->SetPoint(4,100,-1.57812);
   gre->SetPointError(4,0,0.02983726);
   gre->SetPoint(5,300,-1.58244);
   gre->SetPointError(5,0,0.0401332);
   gre->SetPoint(6,500,-1.57008);
   gre->SetPointError(6,0,0.02006173);
   gre->SetPoint(7,700,-1.50928);
   gre->SetPointError(7,0,0.01450908);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.635353);
   Graph_Graph19->SetMaximum(-1.481991);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.94982);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.31967e-05);
   linear_fit->SetParError(0,1.062659e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.559039);
   linear_fit->SetParError(1,0.005562391);
