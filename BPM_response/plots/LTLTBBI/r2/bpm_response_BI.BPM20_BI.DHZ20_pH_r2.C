...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,-13.75839,1050,11.07369);
   ...
   gre->SetPoint(0,-700,-9.61138);
   gre->SetPointError(0,0,0.00832698);
   gre->SetPoint(1,-500,-7.07556);
   gre->SetPointError(1,0,0.01774758);
   gre->SetPoint(2,-300,-4.61632);
   gre->SetPointError(2,0,0.05337838);
   gre->SetPoint(3,-100,-2.2632);
   gre->SetPointError(3,0,0.05129729);
   gre->SetPoint(4,100,0.10454);
   gre->SetPointError(4,0,0.01210551);
   gre->SetPoint(5,300,2.48912);
   gre->SetPointError(5,0,0.05228446);
   gre->SetPoint(6,500,4.71674);
   gre->SetPointError(6,0,0.01945911);
   gre->SetPoint(7,700,6.9223);
   gre->SetPointError(7,0,0.012712);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-11.27518);
   Graph_Graph25->SetMaximum(8.590484);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(422.6116);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01186434);
   linear_fit->SetParError(0,9.60195e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.245857);
   linear_fit->SetParError(1,0.005601638);
