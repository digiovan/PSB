...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-4.185055,1050,4.566137);
   ...
   gre->SetPoint(0,-700,-2.43646);
   gre->SetPointError(0,0,0.2900627);
   gre->SetPoint(1,-500,1.18924);
   gre->SetPointError(1,0,0.2251347);
   gre->SetPoint(2,-300,2.3388);
   gre->SetPointError(2,0,0.2929465);
   gre->SetPoint(3,-100,-1.11018);
   gre->SetPointError(3,0,0.5737157);
   gre->SetPoint(4,100,-0.63524);
   gre->SetPointError(4,0,0.3977647);
   gre->SetPoint(5,300,2.24132);
   gre->SetPointError(5,0,0.5434508);
   gre->SetPoint(6,500,2.54418);
   gre->SetPointError(6,0,0.4471455);
   gre->SetPoint(7,700,2.92536);
   gre->SetPointError(7,0,0.1822452);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-3.309935);
   Graph_Graph28->SetMaximum(3.691018);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(154.0151);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002357569);
   linear_fit->SetParError(0,0.000188674);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.263386);
   linear_fit->SetParError(1,0.1049729);
