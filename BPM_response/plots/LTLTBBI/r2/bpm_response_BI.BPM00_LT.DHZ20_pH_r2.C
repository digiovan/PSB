...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-14.60438,1050,3.95008);
   ...
   gre->SetPoint(0,-700,0.80836);
   gre->SetPointError(0,0,0.04931061);
   gre->SetPoint(1,-500,-0.7152);
   gre->SetPointError(1,0,0.03555286);
   gre->SetPoint(2,-300,-2.4029);
   gre->SetPointError(2,0,0.07461003);
   gre->SetPoint(3,-100,-4.78622);
   gre->SetPointError(3,0,0.09792724);
   gre->SetPoint(4,100,-6.65274);
   gre->SetPointError(4,0,0.1210103);
   gre->SetPoint(5,300,-8.26548);
   gre->SetPointError(5,0,0.01011641);
   gre->SetPoint(6,500,-9.90888);
   gre->SetPointError(6,0,0.07081508);
   gre->SetPoint(7,700,-11.46386);
   gre->SetPointError(7,0,0.04810703);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-12.74893);
   Graph_Graph23->SetMaximum(2.094634);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(159.6392);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.009171934);
   linear_fit->SetParError(0,3.168529e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.480534);
   linear_fit->SetParError(1,0.01143801);
