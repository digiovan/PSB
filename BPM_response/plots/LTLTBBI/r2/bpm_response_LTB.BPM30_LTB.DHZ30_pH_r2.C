...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,-9.55213,1050,10.36703);
   ...
   gre->SetPoint(0,-700,-6.17344);
   gre->SetPointError(0,0,0.05883071);
   gre->SetPoint(1,-500,-4.17632);
   gre->SetPointError(1,0,0.06463446);
   gre->SetPoint(2,-300,-2.14462);
   gre->SetPointError(2,0,0.09282524);
   gre->SetPoint(3,-100,-0.19362);
   gre->SetPointError(3,0,0.02000868);
   gre->SetPoint(4,100,1.59322);
   gre->SetPointError(4,0,0.03164239);
   gre->SetPoint(5,300,3.4212);
   gre->SetPointError(5,0,0.1563264);
   gre->SetPoint(6,500,4.98176);
   gre->SetPointError(6,0,0.05738109);
   gre->SetPoint(7,700,6.94934);
   gre->SetPointError(7,0,0.09782768);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-7.560215);
   Graph_Graph22->SetMaximum(8.375112);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(89.92695);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.009297348);
   linear_fit->SetParError(0,5.257113e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.6446652);
   linear_fit->SetParError(1,0.01507915);
