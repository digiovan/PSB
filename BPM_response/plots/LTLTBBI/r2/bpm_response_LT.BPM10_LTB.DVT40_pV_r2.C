...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.6691011,1050,1.072164);
   ...
   gre->SetPoint(0,-700,0.89916);
   gre->SetPointError(0,0,0.04143143);
   gre->SetPoint(1,-500,0.92428);
   gre->SetPointError(1,0,0.08070646);
   gre->SetPoint(2,-300,0.88064);
   gre->SetPointError(2,0,0.018074);
   gre->SetPoint(3,-100,0.85664);
   gre->SetPointError(3,0,0.032622);
   gre->SetPoint(4,100,0.93112);
   gre->SetPointError(4,0,0.06741113);
   gre->SetPoint(5,300,0.76136);
   gre->SetPointError(5,0,0.02508183);
   gre->SetPoint(6,500,0.91468);
   gre->SetPointError(6,0,0.03645212);
   gre->SetPoint(7,700,0.9012);
   gre->SetPointError(7,0,0.01639846);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.7094073);
   Graph_Graph15->SetMaximum(1.031857);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.93767);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.879131e-06);
   linear_fit->SetParError(0,2.037848e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8720072);
   linear_fit->SetParError(1,0.01020743);
