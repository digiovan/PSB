...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-0.02187696,1050,1.086699);
   ...
   gre->SetPoint(0,-700,0.42698);
   gre->SetPointError(0,0,0.2640943);
   gre->SetPoint(1,-500,0.33734);
   gre->SetPointError(1,0,0.1650654);
   gre->SetPoint(2,-300,0.77338);
   gre->SetPointError(2,0,0.1054812);
   gre->SetPoint(3,-100,0.52474);
   gre->SetPointError(3,0,0.1495043);
   gre->SetPoint(4,100,0.77914);
   gre->SetPointError(4,0,0.0848061);
   gre->SetPoint(5,300,0.75738);
   gre->SetPointError(5,0,0.1048352);
   gre->SetPoint(6,500,0.62192);
   gre->SetPointError(6,0,0.1328803);
   gre->SetPoint(7,700,0.71792);
   gre->SetPointError(7,0,0.1840162);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.08898062);
   Graph_Graph20->SetMaximum(0.9758413);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.758652);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001537983);
   linear_fit->SetParError(0,0.0001279232);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.678462);
   linear_fit->SetParError(1,0.04530483);
