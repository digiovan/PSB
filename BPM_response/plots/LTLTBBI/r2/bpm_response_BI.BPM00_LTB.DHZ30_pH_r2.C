...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-18.91707,1050,5.906166);
   ...
   gre->SetPoint(0,-700,-14.68732);
   gre->SetPointError(0,0,0.09254669);
   gre->SetPoint(1,-500,-12.06658);
   gre->SetPointError(1,0,0.05093725);
   gre->SetPoint(2,-300,-9.3975);
   gre->SetPointError(2,0,0.2412972);
   gre->SetPoint(3,-100,-6.9533);
   gre->SetPointError(3,0,0.03603459);
   gre->SetPoint(4,100,-4.64566);
   gre->SetPointError(4,0,0.0572266);
   gre->SetPoint(5,300,-2.67464);
   gre->SetPointError(5,0,0.1641266);
   gre->SetPoint(6,500,-0.46592);
   gre->SetPointError(6,0,0.1350435);
   gre->SetPoint(7,700,1.67396);
   gre->SetPointError(7,0,0.09499915);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-16.43475);
   Graph_Graph23->SetMaximum(3.423842);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(128.0268);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01179524);
   linear_fit->SetParError(0,6.856909e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.987646);
   linear_fit->SetParError(1,0.02490858);
