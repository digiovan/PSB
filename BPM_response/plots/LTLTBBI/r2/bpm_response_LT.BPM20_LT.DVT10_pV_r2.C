...
//=========  (Wed Apr  1 22:34:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-8.510046,1050,-4.162174);
   ...
   gre->SetPoint(0,-700,-7.72916);
   gre->SetPointError(0,0,0.05624053);
   gre->SetPoint(1,-500,-7.44918);
   gre->SetPointError(1,0,0.01310126);
   gre->SetPoint(2,-300,-6.99616);
   gre->SetPointError(2,0,0.06013629);
   gre->SetPoint(3,-100,-6.5432);
   gre->SetPointError(3,0,0.04611826);
   gre->SetPoint(4,100,-6.06606);
   gre->SetPointError(4,0,0.02883299);
   gre->SetPoint(5,300,-5.79518);
   gre->SetPointError(5,0,0.01979355);
   gre->SetPoint(6,500,-5.3149);
   gre->SetPointError(6,0,0.09014794);
   gre->SetPoint(7,700,-4.90592);
   gre->SetPointError(7,0,0.0191008);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.075259);
   Graph_Graph16->SetMaximum(-4.596961);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.03329);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00210361);
   linear_fit->SetParError(0,1.755509e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.381741);
   linear_fit->SetParError(1,0.00861957);
