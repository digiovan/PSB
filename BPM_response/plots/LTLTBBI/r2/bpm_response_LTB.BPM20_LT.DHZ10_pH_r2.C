...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,-0.826554,1050,7.438985);
   ...
   gre->SetPoint(0,-700,5.82916);
   gre->SetPointError(0,0,0.2190647);
   gre->SetPoint(1,-500,4.6987);
   gre->SetPointError(1,0,0.1247598);
   gre->SetPoint(2,-300,3.79224);
   gre->SetPointError(2,0,0.08770252);
   gre->SetPoint(3,-100,3.64476);
   gre->SetPointError(3,0,0.2035112);
   gre->SetPoint(4,100,2.92446);
   gre->SetPointError(4,0,0.2661404);
   gre->SetPoint(5,300,1.48788);
   gre->SetPointError(5,0,0.1177614);
   gre->SetPoint(6,500,0.6332);
   gre->SetPointError(6,0,0.1263126);
   gre->SetPoint(7,700,0.48846);
   gre->SetPointError(7,0,0.08230067);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(0);
   Graph_Graph21->SetMaximum(6.612431);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(34.15186);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003637152);
   linear_fit->SetParError(0,8.986972e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.833073);
   linear_fit->SetParError(1,0.04475192);
