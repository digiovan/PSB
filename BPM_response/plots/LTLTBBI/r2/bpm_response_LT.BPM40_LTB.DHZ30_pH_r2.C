...
//=========  (Wed Apr  1 22:35:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-0.34188,1050,-0.2911839);
   ...
   gre->SetPoint(0,-700,-0.3233);
   gre->SetPointError(0,0,0.001374341);
   gre->SetPoint(1,-500,-0.31746);
   gre->SetPointError(1,0,0.003220248);
   gre->SetPoint(2,-300,-0.30464);
   gre->SetPointError(2,0,0.004441473);
   gre->SetPoint(3,-100,-0.31358);
   gre->SetPointError(3,0,0.01394673);
   gre->SetPoint(4,100,-0.32306);
   gre->SetPointError(4,0,0.009587278);
   gre->SetPoint(5,300,-0.31996);
   gre->SetPointError(5,0,0.006177785);
   gre->SetPoint(6,500,-0.31708);
   gre->SetPointError(6,0,0.0117577);
   gre->SetPoint(7,700,-0.32726);
   gre->SetPointError(7,0,0.006170628);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.3368104);
   Graph_Graph18->SetMaximum(-0.2962535);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.29328);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.917589e-06);
   linear_fit->SetParError(0,3.356466e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3196209);
   linear_fit->SetParError(1,0.0021382);
