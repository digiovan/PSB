...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-4.696096,1050,0.3869329);
   ...
   gre->SetPoint(0,-700,-3.78462);
   gre->SetPointError(0,0,0.06430463);
   gre->SetPoint(1,-500,-3.09538);
   gre->SetPointError(1,0,0.04499453);
   gre->SetPoint(2,-300,-2.74558);
   gre->SetPointError(2,0,0.07939099);
   gre->SetPoint(3,-100,-2.32536);
   gre->SetPointError(3,0,0.05671882);
   gre->SetPoint(4,100,-1.83062);
   gre->SetPointError(4,0,0.1018457);
   gre->SetPoint(5,300,-1.31404);
   gre->SetPointError(5,0,0.02562508);
   gre->SetPoint(6,500,-0.9285);
   gre->SetPointError(6,0,0.1138606);
   gre->SetPoint(7,700,-0.51168);
   gre->SetPointError(7,0,0.0514414);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-4.187793);
   Graph_Graph25->SetMaximum(-0.12137);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.32243);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002289454);
   linear_fit->SetParError(0,4.156406e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.035019);
   linear_fit->SetParError(1,0.01780536);
