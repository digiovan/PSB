...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,-0.008126039,1050,8.581346);
   ...
   gre->SetPoint(0,-700,7.05094);
   gre->SetPointError(0,0,0.09882696);
   gre->SetPoint(1,-500,6.23966);
   gre->SetPointError(1,0,0.1954733);
   gre->SetPoint(2,-300,5.78502);
   gre->SetPointError(2,0,0.1480211);
   gre->SetPoint(3,-100,4.87634);
   gre->SetPointError(3,0,0.08023718);
   gre->SetPoint(4,100,4.31274);
   gre->SetPointError(4,0,0.08150493);
   gre->SetPoint(5,300,3.7527);
   gre->SetPointError(5,0,0.04332854);
   gre->SetPoint(6,500,2.78774);
   gre->SetPointError(6,0,0.08111925);
   gre->SetPoint(7,700,1.5736);
   gre->SetPointError(7,0,0.1501474);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(0.8508212);
   Graph_Graph24->SetMaximum(7.722398);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.22247);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003492855);
   linear_fit->SetParError(0,8.213608e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.660474);
   linear_fit->SetParError(1,0.03093872);
