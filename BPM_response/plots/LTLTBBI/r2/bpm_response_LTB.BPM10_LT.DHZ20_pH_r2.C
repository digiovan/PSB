...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-15.14936,1050,16.07776);
   ...
   gre->SetPoint(0,-700,-9.91764);
   gre->SetPointError(0,0,0.02720138);
   gre->SetPoint(1,-500,-7.76816);
   gre->SetPointError(1,0,0.1926723);
   gre->SetPoint(2,-300,-5.09126);
   gre->SetPointError(2,0,0.0976809);
   gre->SetPoint(3,-100,-1.04594);
   gre->SetPointError(3,0,0.08116246);
   gre->SetPoint(4,100,2.08576);
   gre->SetPointError(4,0,0.09266547);
   gre->SetPoint(5,300,4.8547);
   gre->SetPointError(5,0,0.09963752);
   gre->SetPoint(6,500,7.61314);
   gre->SetPointError(6,0,0.1006239);
   gre->SetPoint(7,700,10.81918);
   gre->SetPointError(7,0,0.05406298);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-12.02665);
   Graph_Graph20->SetMaximum(12.95505);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(143.1758);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01479774);
   linear_fit->SetParError(0,3.824816e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.3813617);
   linear_fit->SetParError(1,0.02372741);
