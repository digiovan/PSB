...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-4.401364,1050,-3.420621);
   ...
   gre->SetPoint(0,-700,-4.15782);
   gre->SetPointError(0,0,0.05395001);
   gre->SetPoint(1,-500,-4.05414);
   gre->SetPointError(1,0,0.06225128);
   gre->SetPoint(2,-300,-4.04238);
   gre->SetPointError(2,0,0.1955266);
   gre->SetPoint(3,-100,-3.72796);
   gre->SetPointError(3,0,0.04123706);
   gre->SetPoint(4,100,-3.68402);
   gre->SetPointError(4,0,0.05580963);
   gre->SetPoint(5,300,-3.69218);
   gre->SetPointError(5,0,0.1081019);
   gre->SetPoint(6,500,-3.6417);
   gre->SetPointError(6,0,0.0339324);
   gre->SetPoint(7,700,-4.04846);
   gre->SetPointError(7,0,0.1109169);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-4.303289);
   Graph_Graph24->SetMaximum(-3.518695);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.05164);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003514047);
   linear_fit->SetParError(0,4.454258e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.811026);
   linear_fit->SetParError(1,0.01981352);
