...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.7150411,1050,1.074701);
   ...
   gre->SetPoint(0,-700,0.81612);
   gre->SetPointError(0,0,0.04113567);
   gre->SetPoint(1,-500,0.9868);
   gre->SetPointError(1,0,0.02795743);
   gre->SetPoint(2,-300,0.83554);
   gre->SetPointError(2,0,0.01175279);
   gre->SetPoint(3,-100,0.84916);
   gre->SetPointError(3,0,0.03960926);
   gre->SetPoint(4,100,0.88734);
   gre->SetPointError(4,0,0.01499206);
   gre->SetPoint(5,300,0.86532);
   gre->SetPointError(5,0,0.03430242);
   gre->SetPoint(6,500,0.93772);
   gre->SetPointError(6,0,0.02589652);
   gre->SetPoint(7,700,0.90108);
   gre->SetPointError(7,0,0.00519727);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.751007);
   Graph_Graph15->SetMaximum(1.038735);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(32.06358);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.919774e-05);
   linear_fit->SetParError(0,1.049265e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8744075);
   linear_fit->SetParError(1,0.006396066);
