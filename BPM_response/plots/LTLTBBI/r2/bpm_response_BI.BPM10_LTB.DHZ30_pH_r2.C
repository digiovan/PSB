...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-18.02544,1050,9.199289);
   ...
   gre->SetPoint(0,-700,-13.3324);
   gre->SetPointError(0,0,0.1555846);
   gre->SetPoint(1,-500,-10.55652);
   gre->SetPointError(1,0,0.0469307);
   gre->SetPoint(2,-300,-7.63248);
   gre->SetPointError(2,0,0.3482928);
   gre->SetPoint(3,-100,-4.95006);
   gre->SetPointError(3,0,0.04037041);
   gre->SetPoint(4,100,-2.34066);
   gre->SetPointError(4,0,0.06890698);
   gre->SetPoint(5,300,-0.28966);
   gre->SetPointError(5,0,0.1577223);
   gre->SetPoint(6,500,2.32158);
   gre->SetPointError(6,0,0.1888918);
   gre->SetPoint(7,700,4.56912);
   gre->SetPointError(7,0,0.09271379);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-15.30297);
   Graph_Graph24->SetMaximum(6.476816);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(117.4692);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0128931);
   linear_fit->SetParError(0,7.328592e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.89254);
   linear_fit->SetParError(1,0.02733259);
