...
//=========  (Wed Apr  1 22:35:24 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-8.353666,1050,-7.76374);
   ...
   gre->SetPoint(0,-700,-7.94964);
   gre->SetPointError(0,0,0.08757905);
   gre->SetPoint(1,-500,-8.0328);
   gre->SetPointError(1,0,0.04842618);
   gre->SetPoint(2,-300,-8.19324);
   gre->SetPointError(2,0,0.0621048);
   gre->SetPoint(3,-100,-8.13996);
   gre->SetPointError(3,0,0.05818258);
   gre->SetPoint(4,100,-8.09476);
   gre->SetPointError(4,0,0.0387491);
   gre->SetPoint(5,300,-8.0314);
   gre->SetPointError(5,0,0.04620563);
   gre->SetPoint(6,500,-8.15932);
   gre->SetPointError(6,0,0.04730013);
   gre->SetPoint(7,700,-7.9515);
   gre->SetPointError(7,0,0.01436217);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.294673);
   Graph_Graph16->SetMaximum(-7.822733);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.59229);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001224911);
   linear_fit->SetParError(0,2.90049e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.057123);
   linear_fit->SetParError(1,0.01746103);
