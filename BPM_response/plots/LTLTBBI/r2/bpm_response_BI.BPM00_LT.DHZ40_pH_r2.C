...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-11.44014,1050,0.5966562);
   ...
   gre->SetPoint(0,-700,-9.39108);
   gre->SetPointError(0,0,0.04293129);
   gre->SetPoint(1,-500,-8.12056);
   gre->SetPointError(1,0,0.05785782);
   gre->SetPoint(2,-300,-7.40254);
   gre->SetPointError(2,0,0.1460038);
   gre->SetPoint(3,-100,-6.04134);
   gre->SetPointError(3,0,0.1607283);
   gre->SetPoint(4,100,-4.84662);
   gre->SetPointError(4,0,0.08815574);
   gre->SetPoint(5,300,-3.9157);
   gre->SetPointError(5,0,0.04506735);
   gre->SetPoint(6,500,-1.81258);
   gre->SetPointError(6,0,0.2970919);
   gre->SetPoint(7,700,-1.49086);
   gre->SetPointError(7,0,0.08138266);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-10.23646);
   Graph_Graph23->SetMaximum(-0.6070239);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(25.28085);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.00553978);
   linear_fit->SetParError(0,4.860518e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.48163);
   linear_fit->SetParError(1,0.0254139);
