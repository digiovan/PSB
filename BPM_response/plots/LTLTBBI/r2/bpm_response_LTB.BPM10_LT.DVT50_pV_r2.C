...
//=========  (Wed Apr  1 22:34:58 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,-8.002898,1050,9.642951);
   ...
   gre->SetPoint(0,-700,-5.02814);
   gre->SetPointError(0,0,0.03378349);
   gre->SetPoint(1,-500,-3.29394);
   gre->SetPointError(1,0,0.01456694);
   gre->SetPoint(2,-300,-1.577);
   gre->SetPointError(2,0,0.01867265);
   gre->SetPoint(3,-100,0.1328);
   gre->SetPointError(3,0,0.01829093);
   gre->SetPoint(4,100,1.72278);
   gre->SetPointError(4,0,0.03600228);
   gre->SetPoint(5,300,3.35846);
   gre->SetPointError(5,0,0.02047203);
   gre->SetPoint(6,500,4.85342);
   gre->SetPointError(6,0,0.02568652);
   gre->SetPoint(7,700,6.68106);
   gre->SetPointError(7,0,0.02091587);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DVT50 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-6.238313);
   Graph_Graph20->SetMaximum(7.878366);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(78.36942);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008271791);
   linear_fit->SetParError(0,1.674839e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8696766);
   linear_fit->SetParError(1,0.007424658);
