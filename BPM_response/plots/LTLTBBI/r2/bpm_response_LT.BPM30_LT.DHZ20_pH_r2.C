...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-16.01421,1050,-3.769302);
   ...
   gre->SetPoint(0,-700,-13.94796);
   gre->SetPointError(0,0,0.02542836);
   gre->SetPoint(1,-500,-13.0188);
   gre->SetPointError(1,0,0.04596991);
   gre->SetPoint(2,-300,-12.0047);
   gre->SetPointError(2,0,0.04004957);
   gre->SetPoint(3,-100,-10.6144);
   gre->SetPointError(3,0,0.01674914);
   gre->SetPoint(4,100,-9.53816);
   gre->SetPointError(4,0,0.03108904);
   gre->SetPoint(5,300,-8.39038);
   gre->SetPointError(5,0,0.02852924);
   gre->SetPoint(6,500,-7.17516);
   gre->SetPointError(6,0,0.0319602);
   gre->SetPoint(7,700,-5.82654);
   gre->SetPointError(7,0,0.01642084);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-14.78972);
   Graph_Graph17->SetMaximum(-4.993792);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(150.7338);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005861277);
   linear_fit->SetParError(0,1.846652e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.01594);
   linear_fit->SetParError(1,0.009036198);
