...
//=========  (Wed Apr  1 22:35:29 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.7778397,1050,1.030414);
   ...
   gre->SetPoint(0,-700,0.87162);
   gre->SetPointError(0,0,0.007852345);
   gre->SetPoint(1,-500,0.92026);
   gre->SetPointError(1,0,0.04024226);
   gre->SetPoint(2,-300,0.85634);
   gre->SetPointError(2,0,0.01831952);
   gre->SetPoint(3,-100,0.93696);
   gre->SetPointError(3,0,0.009104379);
   gre->SetPoint(4,100,0.85542);
   gre->SetPointError(4,0,0.03522926);
   gre->SetPoint(5,300,0.96614);
   gre->SetPointError(5,0,0.0221784);
   gre->SetPoint(6,500,0.85944);
   gre->SetPointError(6,0,0.03950455);
   gre->SetPoint(7,700,0.92698);
   gre->SetPointError(7,0,0.0161603);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.8030972);
   Graph_Graph15->SetMaximum(1.005157);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(28.29923);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.138268e-05);
   linear_fit->SetParError(0,1.109081e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9143246);
   linear_fit->SetParError(1,0.005800079);
