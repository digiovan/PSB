...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-18.3219,1050,-4.006967);
   ...
   gre->SetPoint(0,-700,-15.57224);
   gre->SetPointError(0,0,0.3638374);
   gre->SetPoint(1,-500,-14.50848);
   gre->SetPointError(1,0,0.6530949);
   gre->SetPoint(2,-300,-13.2519);
   gre->SetPointError(2,0,1.890516);
   gre->SetPoint(3,-100,-12.06958);
   gre->SetPointError(3,0,0.3927914);
   gre->SetPoint(4,100,-11.31772);
   gre->SetPointError(4,0,0.6611324);
   gre->SetPoint(5,300,-11.03364);
   gre->SetPointError(5,0,1.678399);
   gre->SetPoint(6,500,-9.09402);
   gre->SetPointError(6,0,1.200119);
   gre->SetPoint(7,700,-7.46462);
   gre->SetPointError(7,0,1.071831);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-16.89041);
   Graph_Graph27->SetMaximum(-5.43846);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(0.7558439);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005563663);
   linear_fit->SetParError(0,0.0005452073);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.6631);
   linear_fit->SetParError(1,0.2677451);
