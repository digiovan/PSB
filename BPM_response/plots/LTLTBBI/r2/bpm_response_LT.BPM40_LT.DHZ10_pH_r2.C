...
//=========  (Wed Apr  1 22:34:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-0.7455632,1050,0.03161423);
   ...
   gre->SetPoint(0,-700,-0.5757);
   gre->SetPointError(0,0,0.01490072);
   gre->SetPoint(1,-500,-0.61162);
   gre->SetPointError(1,0,0.004413616);
   gre->SetPoint(2,-300,-0.52574);
   gre->SetPointError(2,0,0.003201402);
   gre->SetPoint(3,-100,-0.40238);
   gre->SetPointError(3,0,0.01546334);
   gre->SetPoint(4,100,-0.32778);
   gre->SetPointError(4,0,0.007481168);
   gre->SetPoint(5,300,-0.34892);
   gre->SetPointError(5,0,0.002496613);
   gre->SetPoint(6,500,-0.24318);
   gre->SetPointError(6,0,0.01575913);
   gre->SetPoint(7,700,-0.10374);
   gre->SetPointError(7,0,0.005824656);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.6678454);
   Graph_Graph18->SetMaximum(-0.04610352);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(435.3367);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003535182);
   linear_fit->SetParError(0,4.327568e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4272128);
   linear_fit->SetParError(1,0.001653552);
