...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,1.625451,1050,2.441794);
   ...
   gre->SetPoint(0,-700,1.99142);
   gre->SetPointError(0,0,0.1578692);
   gre->SetPoint(1,-500,2.09212);
   gre->SetPointError(1,0,0.1761211);
   gre->SetPoint(2,-300,2.04624);
   gre->SetPointError(2,0,0.06402422);
   gre->SetPoint(3,-100,2.06048);
   gre->SetPointError(3,0,0.08900079);
   gre->SetPoint(4,100,2.19042);
   gre->SetPointError(4,0,0.1153172);
   gre->SetPoint(5,300,1.80482);
   gre->SetPointError(5,0,0.04331173);
   gre->SetPoint(6,500,2.08482);
   gre->SetPointError(6,0,0.05983586);
   gre->SetPoint(7,700,1.96198);
   gre->SetPointError(7,0,0.05095542);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(1.707085);
   Graph_Graph21->SetMaximum(2.36016);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.45546);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.51498e-05);
   linear_fit->SetParError(0,6.42965e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.985093);
   linear_fit->SetParError(1,0.02938258);
