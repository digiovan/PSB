...
//=========  (Wed Apr  1 22:36:12 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-2.798589,1050,-1.862893);
   ...
   gre->SetPoint(0,-700,-2.5006);
   gre->SetPointError(0,0,0.1420398);
   gre->SetPoint(1,-500,-2.0735);
   gre->SetPointError(1,0,0.02011735);
   gre->SetPoint(2,-300,-2.1034);
   gre->SetPointError(2,0,0.03107153);
   gre->SetPoint(3,-100,-2.0794);
   gre->SetPointError(3,0,0.06055794);
   gre->SetPoint(4,100,-2.13378);
   gre->SetPointError(4,0,0.04221801);
   gre->SetPoint(5,300,-2.07558);
   gre->SetPointError(5,0,0.04336231);
   gre->SetPoint(6,500,-2.07332);
   gre->SetPointError(6,0,0.04613242);
   gre->SetPoint(7,700,-2.2938);
   gre->SetPointError(7,0,0.09277353);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-2.70502);
   Graph_Graph25->SetMaximum(-1.956462);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.77948);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.598086e-05);
   linear_fit->SetParError(0,3.638055e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.099308);
   linear_fit->SetParError(1,0.01523451);
