...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,6.284983,1050,10.85825);
   ...
   gre->SetPoint(0,-700,10.0465);
   gre->SetPointError(0,0,0.04953541);
   gre->SetPoint(1,-500,9.73022);
   gre->SetPointError(1,0,0.02954756);
   gre->SetPoint(2,-300,9.35102);
   gre->SetPointError(2,0,0.01039751);
   gre->SetPoint(3,-100,8.80982);
   gre->SetPointError(3,0,0.02263112);
   gre->SetPoint(4,100,8.36472);
   gre->SetPointError(4,0,0.01384863);
   gre->SetPoint(5,300,8.098);
   gre->SetPointError(5,0,0.01511416);
   gre->SetPoint(6,500,7.78388);
   gre->SetPointError(6,0,0.02820515);
   gre->SetPoint(7,700,7.0633);
   gre->SetPointError(7,0,0.01610641);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(6.742309);
   Graph_Graph25->SetMaximum(10.40092);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(174.4124);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002185158);
   linear_fit->SetParError(0,1.596671e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.664836);
   linear_fit->SetParError(1,0.006084329);
