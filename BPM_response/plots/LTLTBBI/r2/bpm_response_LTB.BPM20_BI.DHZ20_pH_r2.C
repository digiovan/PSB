...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,2.261786,1050,3.343448);
   ...
   gre->SetPoint(0,-700,2.7788);
   gre->SetPointError(0,0,0.04536507);
   gre->SetPoint(1,-500,2.79312);
   gre->SetPointError(1,0,0.03928923);
   gre->SetPoint(2,-300,2.73416);
   gre->SetPointError(2,0,0.2920972);
   gre->SetPoint(3,-100,2.95518);
   gre->SetPointError(3,0,0.09380204);
   gre->SetPoint(4,100,3.0833);
   gre->SetPointError(4,0,0.07987116);
   gre->SetPoint(5,300,2.84196);
   gre->SetPointError(5,0,0.2380559);
   gre->SetPoint(6,500,2.93942);
   gre->SetPointError(6,0,0.16394);
   gre->SetPoint(7,700,3.03176);
   gre->SetPointError(7,0,0.0669901);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(2.369952);
   Graph_Graph21->SetMaximum(3.235282);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.93314);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0002099461);
   linear_fit->SetParError(0,5.090373e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.921384);
   linear_fit->SetParError(1,0.02831202);
