...
//=========  (Wed Apr  1 22:36:12 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,0.4829528,1050,0.920008);
   ...
   gre->SetPoint(0,-700,0.62504);
   gre->SetPointError(0,0,0.06924471);
   gre->SetPoint(1,-500,0.77724);
   gre->SetPointError(1,0,0.01515495);
   gre->SetPoint(2,-300,0.78766);
   gre->SetPointError(2,0,0.02992325);
   gre->SetPoint(3,-100,0.81154);
   gre->SetPointError(3,0,0.03562542);
   gre->SetPoint(4,100,0.72842);
   gre->SetPointError(4,0,0.01578979);
   gre->SetPoint(5,300,0.76966);
   gre->SetPointError(5,0,0.03078573);
   gre->SetPoint(6,500,0.76388);
   gre->SetPointError(6,0,0.04714071);
   gre->SetPoint(7,700,0.68788);
   gre->SetPointError(7,0,0.04094447);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.5266583);
   Graph_Graph20->SetMaximum(0.8763024);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.8544);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-4.401526e-05);
   linear_fit->SetParError(0,2.433751e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7520568);
   linear_fit->SetParError(1,0.009305128);
