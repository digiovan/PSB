...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.63985,1050,-10.01281);
   ...
   gre->SetPoint(0,-700,-10.32188);
   gre->SetPointError(0,0,0.06786961);
   gre->SetPoint(1,-500,-10.436);
   gre->SetPointError(1,0,0.09934231);
   gre->SetPoint(2,-300,-10.27458);
   gre->SetPointError(2,0,0.02810205);
   gre->SetPoint(3,-100,-10.46678);
   gre->SetPointError(3,0,0.02039627);
   gre->SetPoint(4,100,-10.25788);
   gre->SetPointError(4,0,0.07327702);
   gre->SetPoint(5,300,-10.44854);
   gre->SetPointError(5,0,0.04297097);
   gre->SetPoint(6,500,-10.28376);
   gre->SetPointError(6,0,0.1664423);
   gre->SetPoint(7,700,-10.43664);
   gre->SetPointError(7,0,0.06913624);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.57714);
   Graph_Graph17->SetMaximum(-10.07552);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(31.57719);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.000127864);
   linear_fit->SetParError(0,5.090285e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.41063);
   linear_fit->SetParError(1,0.01501754);
