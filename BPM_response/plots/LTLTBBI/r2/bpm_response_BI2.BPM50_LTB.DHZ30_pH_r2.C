...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-6.185389,1050,6.286876);
   ...
   gre->SetPoint(0,-700,3.59804);
   gre->SetPointError(0,0,0.6101248);
   gre->SetPoint(1,-500,2.26046);
   gre->SetPointError(1,0,0.194215);
   gre->SetPoint(2,-300,1.1723);
   gre->SetPointError(2,0,0.3628291);
   gre->SetPoint(3,-100,0.41032);
   gre->SetPointError(3,0,0.3195095);
   gre->SetPoint(4,100,-1.23648);
   gre->SetPointError(4,0,0.1203825);
   gre->SetPoint(5,300,-3.5076);
   gre->SetPointError(5,0,0.5990785);
   gre->SetPoint(6,500,-3.5911);
   gre->SetPointError(6,0,0.3088005);
   gre->SetPoint(7,700,-2.93264);
   gre->SetPointError(7,0,0.8708714);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-4.938163);
   Graph_Graph28->SetMaximum(5.039649);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.898589);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005843055);
   linear_fit->SetParError(0,0.0002797336);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.617196);
   linear_fit->SetParError(1,0.08817327);
