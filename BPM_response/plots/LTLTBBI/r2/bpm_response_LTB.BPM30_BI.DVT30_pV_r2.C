...
//=========  (Wed Apr  1 22:36:12 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,1.862771,1050,2.847925);
   ...
   gre->SetPoint(0,-700,2.1763);
   gre->SetPointError(0,0,0.1493364);
   gre->SetPoint(1,-500,2.64406);
   gre->SetPointError(1,0,0.02238338);
   gre->SetPoint(2,-300,2.57934);
   gre->SetPointError(2,0,0.01851152);
   gre->SetPoint(3,-100,2.62122);
   gre->SetPointError(3,0,0.05287);
   gre->SetPoint(4,100,2.53272);
   gre->SetPointError(4,0,0.03038926);
   gre->SetPoint(5,300,2.61482);
   gre->SetPointError(5,0,0.04709225);
   gre->SetPoint(6,500,2.6241);
   gre->SetPointError(6,0,0.05963247);
   gre->SetPoint(7,700,2.38582);
   gre->SetPointError(7,0,0.1134365);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(1.961287);
   Graph_Graph22->SetMaximum(2.749409);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.12263);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.205432e-05);
   linear_fit->SetParError(0,3.971415e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.578778);
   linear_fit->SetParError(1,0.01439338);
