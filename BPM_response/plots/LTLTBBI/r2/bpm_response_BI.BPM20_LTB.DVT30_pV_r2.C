...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-2.711571,1050,-1.164745);
   ...
   gre->SetPoint(0,-700,-1.4607);
   gre->SetPointError(0,0,0.0381504);
   gre->SetPoint(1,-500,-1.55936);
   gre->SetPointError(1,0,0.1238394);
   gre->SetPoint(2,-300,-1.72568);
   gre->SetPointError(2,0,0.02871701);
   gre->SetPoint(3,-100,-1.81796);
   gre->SetPointError(3,0,0.056784);
   gre->SetPoint(4,100,-2.03836);
   gre->SetPointError(4,0,0.03794707);
   gre->SetPoint(5,300,-2.0265);
   gre->SetPointError(5,0,0.03742779);
   gre->SetPoint(6,500,-2.29448);
   gre->SetPointError(6,0,0.05186834);
   gre->SetPoint(7,700,-2.40984);
   gre->SetPointError(7,0,0.04392672);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-2.556888);
   Graph_Graph25->SetMaximum(-1.319428);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.494197);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0006620473);
   linear_fit->SetParError(0,3.36718e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.918973);
   linear_fit->SetParError(1,0.01479781);
