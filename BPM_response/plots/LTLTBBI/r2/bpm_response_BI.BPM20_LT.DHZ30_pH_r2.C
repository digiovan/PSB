...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,2.853143,1050,14.02665);
   ...
   gre->SetPoint(0,-700,12.14024);
   gre->SetPointError(0,0,0.02415637);
   gre->SetPoint(1,-500,11.2166);
   gre->SetPointError(1,0,0.01098535);
   gre->SetPoint(2,-300,10.01262);
   gre->SetPointError(2,0,0.06382848);
   gre->SetPoint(3,-100,9.17332);
   gre->SetPointError(3,0,0.02855234);
   gre->SetPoint(4,100,8.02854);
   gre->SetPointError(4,0,0.0361181);
   gre->SetPoint(5,300,7.1792);
   gre->SetPointError(5,0,0.01826179);
   gre->SetPoint(6,500,6.16346);
   gre->SetPointError(6,0,0.01509797);
   gre->SetPoint(7,700,4.79424);
   gre->SetPointError(7,0,0.07884647);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(3.970493);
   Graph_Graph25->SetMaximum(12.9093);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.47185);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005046004);
   linear_fit->SetParError(0,1.553919e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.671354);
   linear_fit->SetParError(1,0.007326971);
