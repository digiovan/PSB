...
//=========  (Wed Apr  1 22:34:28 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-33.56105,1050,12.61934);
   ...
   gre->SetPoint(0,-700,-24.89936);
   gre->SetPointError(0,0,0.9649591);
   gre->SetPoint(1,-500,-21.05562);
   gre->SetPointError(1,0,0.698096);
   gre->SetPoint(2,-300,-15.53864);
   gre->SetPointError(2,0,0.7170374);
   gre->SetPoint(3,-100,-11.99906);
   gre->SetPointError(3,0,0.2930669);
   gre->SetPoint(4,100,-8.01732);
   gre->SetPointError(4,0,0.4125761);
   gre->SetPoint(5,300,-2.82048);
   gre->SetPointError(5,0,0.2693686);
   gre->SetPoint(6,500,1.15226);
   gre->SetPointError(6,0,0.4186145);
   gre->SetPoint(7,700,4.73628);
   gre->SetPointError(7,0,0.1863241);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-28.94301);
   Graph_Graph28->SetMaximum(8.001296);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.79696);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02103433);
   linear_fit->SetParError(0,0.0003178269);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.764821);
   linear_fit->SetParError(1,0.1609198);
