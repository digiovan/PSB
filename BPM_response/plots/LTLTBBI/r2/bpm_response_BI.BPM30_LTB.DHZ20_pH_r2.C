...
//=========  (Wed Apr  1 22:35:15 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,-4.070228,1050,19.16253);
   ...
   gre->SetPoint(0,-700,15.26592);
   gre->SetPointError(0,0,0.02448693);
   gre->SetPoint(1,-500,12.94826);
   gre->SetPointError(1,0,0.04139089);
   gre->SetPoint(2,-300,10.84154);
   gre->SetPointError(2,0,0.07184798);
   gre->SetPoint(3,-100,8.86692);
   gre->SetPointError(3,0,0.02063399);
   gre->SetPoint(4,100,6.77474);
   gre->SetPointError(4,0,0.02849699);
   gre->SetPoint(5,300,4.46884);
   gre->SetPointError(5,0,0.07099663);
   gre->SetPoint(6,500,2.18226);
   gre->SetPointError(6,0,0.03174093);
   gre->SetPoint(7,700,-0.1165);
   gre->SetPointError(7,0,0.08160105);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-1.746952);
   Graph_Graph26->SetMaximum(16.83926);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(82.99412);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01081978);
   linear_fit->SetParError(0,2.852848e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,7.716853);
   linear_fit->SetParError(1,0.01223969);
