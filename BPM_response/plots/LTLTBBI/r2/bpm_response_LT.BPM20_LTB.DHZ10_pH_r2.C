...
//=========  (Wed Apr  1 22:35:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-8.262862,1050,-7.796643);
   ...
   gre->SetPoint(0,-700,-8.00586);
   gre->SetPointError(0,0,0.02345777);
   gre->SetPoint(1,-500,-7.99536);
   gre->SetPointError(1,0,0.05173535);
   gre->SetPoint(2,-300,-7.98982);
   gre->SetPointError(2,0,0.045309);
   gre->SetPoint(3,-100,-8.0073);
   gre->SetPointError(3,0,0.01400203);
   gre->SetPoint(4,100,-8.01646);
   gre->SetPointError(4,0,0.01528835);
   gre->SetPoint(5,300,-8.10044);
   gre->SetPointError(5,0,0.0352729);
   gre->SetPoint(6,500,-8.13274);
   gre->SetPointError(6,0,0.05241903);
   gre->SetPoint(7,700,-7.9346);
   gre->SetPointError(7,0,0.06025405);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.21624);
   Graph_Graph16->SetMaximum(-7.843265);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.58055);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.869588e-05);
   linear_fit->SetParError(0,2.737137e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.019562);
   linear_fit->SetParError(1,0.00887649);
