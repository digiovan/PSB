...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,-5.907457,1050,10.5954);
   ...
   gre->SetPoint(0,-700,7.8003);
   gre->SetPointError(0,0,0.04462212);
   gre->SetPoint(1,-500,6.45888);
   gre->SetPointError(1,0,0.01921049);
   gre->SetPoint(2,-300,4.61396);
   gre->SetPointError(2,0,0.03862775);
   gre->SetPoint(3,-100,2.85118);
   gre->SetPointError(3,0,0.06175583);
   gre->SetPoint(4,100,1.31768);
   gre->SetPointError(4,0,0.06344724);
   gre->SetPoint(5,300,-0.18632);
   gre->SetPointError(5,0,0.08507523);
   gre->SetPoint(6,500,-1.60216);
   gre->SetPointError(6,0,0.06038999);
   gre->SetPoint(7,700,-3.07906);
   gre->SetPointError(7,0,0.07792109);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-4.257171);
   Graph_Graph21->SetMaximum(8.945112);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(98.01202);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008063862);
   linear_fit->SetParError(0,3.997416e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.332275);
   linear_fit->SetParError(1,0.01923433);
