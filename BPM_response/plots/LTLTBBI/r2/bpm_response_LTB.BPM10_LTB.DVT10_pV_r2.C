...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,-5.93678,1050,7.689015);
   ...
   gre->SetPoint(0,-700,-3.66042);
   gre->SetPointError(0,0,0.005394136);
   gre->SetPoint(1,-500,-2.34432);
   gre->SetPointError(1,0,0.02573884);
   gre->SetPoint(2,-300,-1.07274);
   gre->SetPointError(2,0,0.03107883);
   gre->SetPoint(3,-100,0.20058);
   gre->SetPointError(3,0,0.004928389);
   gre->SetPoint(4,100,1.30978);
   gre->SetPointError(4,0,0.0328965);
   gre->SetPoint(5,300,2.63234);
   gre->SetPointError(5,0,0.02327016);
   gre->SetPoint(6,500,4.07744);
   gre->SetPointError(6,0,0.05500573);
   gre->SetPoint(7,700,5.36626);
   gre->SetPointError(7,0,0.05178928);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-4.5742);
   Graph_Graph20->SetMaximum(6.326436);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(59.99565);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006406842);
   linear_fit->SetParError(0,1.088805e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8299771);
   linear_fit->SetParError(1,0.005138255);
