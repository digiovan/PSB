...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,-8.33974,1050,16.59803);
   ...
   gre->SetPoint(0,-700,-4.06598);
   gre->SetPointError(0,0,0.1174647);
   gre->SetPoint(1,-500,-2.0283);
   gre->SetPointError(1,0,0.03574651);
   gre->SetPoint(2,-300,0.94056);
   gre->SetPointError(2,0,0.07049976);
   gre->SetPoint(3,-100,3.4953);
   gre->SetPointError(3,0,0.09762677);
   gre->SetPoint(4,100,5.81286);
   gre->SetPointError(4,0,0.04305834);
   gre->SetPoint(5,300,7.97162);
   gre->SetPointError(5,0,0.08608557);
   gre->SetPoint(6,500,10.054);
   gre->SetPointError(6,0,0.07564053);
   gre->SetPoint(7,700,12.36856);
   gre->SetPointError(7,0,0.0731742);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-5.845963);
   Graph_Graph24->SetMaximum(14.10425);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(185.496);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01214218);
   linear_fit->SetParError(0,5.097835e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.271515);
   linear_fit->SetParError(1,0.02183503);
