...
//=========  (Wed Apr  1 22:35:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-0.3511404,1050,-0.2916621);
   ...
   gre->SetPoint(0,-700,-0.32602);
   gre->SetPointError(0,0,0.009147515);
   gre->SetPoint(1,-500,-0.32828);
   gre->SetPointError(1,0,0.005855426);
   gre->SetPoint(2,-300,-0.32826);
   gre->SetPointError(2,0,0.003418752);
   gre->SetPoint(3,-100,-0.32254);
   gre->SetPointError(3,0,0.01868733);
   gre->SetPoint(4,100,-0.33098);
   gre->SetPointError(4,0,0.004088022);
   gre->SetPoint(5,300,-0.33278);
   gre->SetPointError(5,0,0.007370437);
   gre->SetPoint(6,500,-0.30712);
   gre->SetPointError(6,0,0.005544882);
   gre->SetPoint(7,700,-0.3247);
   gre->SetPointError(7,0,0.007390822);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.3451926);
   Graph_Graph18->SetMaximum(-0.2976099);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(11.58161);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.651477e-06);
   linear_fit->SetParError(0,5.002159e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3258575);
   linear_fit->SetParError(1,0.001972971);
