...
//=========  (Wed Apr  1 22:35:51 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,-1.196959,1050,10.77263);
   ...
   gre->SetPoint(0,-700,0.41794);
   gre->SetPointError(0,0,0.06033596);
   gre->SetPoint(1,-500,1.80354);
   gre->SetPointError(1,0,0.1095665);
   gre->SetPoint(2,-300,2.58192);
   gre->SetPointError(2,0,0.06207189);
   gre->SetPoint(3,-100,3.84568);
   gre->SetPointError(3,0,0.110383);
   gre->SetPoint(4,100,4.96028);
   gre->SetPointError(4,0,0.04961088);
   gre->SetPoint(5,300,5.98576);
   gre->SetPointError(5,0,0.01229149);
   gre->SetPoint(6,500,7.3943);
   gre->SetPointError(6,0,0.221088);
   gre->SetPoint(7,700,8.66958);
   gre->SetPointError(7,0,0.06808619);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(0);
   Graph_Graph24->SetMaximum(9.575672);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(52.45926);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005639401);
   linear_fit->SetParError(0,4.703131e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.317936);
   linear_fit->SetParError(1,0.0157269);
