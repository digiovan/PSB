...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-12.36505,1050,0.8191843);
   ...
   gre->SetPoint(0,-700,-5.60536);
   gre->SetPointError(0,0,1.887663);
   gre->SetPoint(1,-500,-6.77436);
   gre->SetPointError(1,0,0.450462);
   gre->SetPoint(2,-300,-6.63832);
   gre->SetPointError(2,0,0.3693128);
   gre->SetPoint(3,-100,-8.39612);
   gre->SetPointError(3,0,1.771559);
   gre->SetPoint(4,100,-5.76036);
   gre->SetPointError(4,0,0.6455216);
   gre->SetPoint(5,300,-1.87458);
   gre->SetPointError(5,0,0.3358616);
   gre->SetPoint(6,500,-3.58756);
   gre->SetPointError(6,0,0.8472245);
   gre->SetPoint(7,700,-1.43704);
   gre->SetPointError(7,0,0.05885164);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-11.04663);
   Graph_Graph28->SetMaximum(-0.4992393);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(32.99989);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004665937);
   linear_fit->SetParError(0,0.0002472914);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.689466);
   linear_fit->SetParError(1,0.1677946);
