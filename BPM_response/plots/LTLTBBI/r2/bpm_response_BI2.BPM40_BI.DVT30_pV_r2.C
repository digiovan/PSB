...
//=========  (Wed Apr  1 22:36:12 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_V_2->Range(-1050,-14.87222,1050,2.786594);
   ...
   gre->SetPoint(0,-700,-7.39172);
   gre->SetPointError(0,0,1.751471);
   gre->SetPoint(1,-500,-11.71444);
   gre->SetPointError(1,0,0.214644);
   gre->SetPoint(2,-300,-8.971);
   gre->SetPointError(2,0,0.455662);
   gre->SetPoint(3,-100,-9.03764);
   gre->SetPointError(3,0,1.200418);
   gre->SetPoint(4,100,-5.91854);
   gre->SetPointError(4,0,0.2423398);
   gre->SetPoint(5,300,-5.22852);
   gre->SetPointError(5,0,0.3601747);
   gre->SetPoint(6,500,-4.25364);
   gre->SetPointError(6,0,0.225783);
   gre->SetPoint(7,700,-1.46794);
   gre->SetPointError(7,0,1.311399);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-13.10634);
   Graph_Graph27->SetMaximum(1.020713);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(34.48666);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.007466491);
   linear_fit->SetParError(0,0.0002881645);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.502422);
   linear_fit->SetParError(1,0.117644);
