...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,-2.078173,1050,6.730545);
   ...
   gre->SetPoint(0,-700,-0.55482);
   gre->SetPointError(0,0,0.05523307);
   gre->SetPoint(1,-500,0.21642);
   gre->SetPointError(1,0,0.1249789);
   gre->SetPoint(2,-300,0.8953);
   gre->SetPointError(2,0,0.09975389);
   gre->SetPoint(3,-100,1.77622);
   gre->SetPointError(3,0,0.01898205);
   gre->SetPoint(4,100,2.46342);
   gre->SetPointError(4,0,0.03886437);
   gre->SetPoint(5,300,3.13536);
   gre->SetPointError(5,0,0.02416202);
   gre->SetPoint(6,500,4.10498);
   gre->SetPointError(6,0,0.0636969);
   gre->SetPoint(7,700,5.18186);
   gre->SetPointError(7,0,0.08056508);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-1.197301);
   Graph_Graph21->SetMaximum(5.849673);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(57.44095);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003772245);
   linear_fit->SetParError(0,4.464898e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.10987);
   linear_fit->SetParError(1,0.01298746);
