...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-1.676117,1050,-1.529569);
   ...
   gre->SetPoint(0,-700,-1.60006);
   gre->SetPointError(0,0,0.004020695);
   gre->SetPoint(1,-500,-1.62074);
   gre->SetPointError(1,0,0.03095217);
   gre->SetPoint(2,-300,-1.58438);
   gre->SetPointError(2,0,0.004740284);
   gre->SetPoint(3,-100,-1.62118);
   gre->SetPointError(3,0,0.02596076);
   gre->SetPoint(4,100,-1.58804);
   gre->SetPointError(4,0,0.01574036);
   gre->SetPoint(5,300,-1.61554);
   gre->SetPointError(5,0,0.0349498);
   gre->SetPoint(6,500,-1.57106);
   gre->SetPointError(6,0,0.01706611);
   gre->SetPoint(7,700,-1.60438);
   gre->SetPointError(7,0,0.03663754);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.661462);
   Graph_Graph19->SetMaximum(-1.544224);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.453741);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.961583e-05);
   linear_fit->SetParError(0,9.621921e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.584415);
   linear_fit->SetParError(1,0.005311128);
