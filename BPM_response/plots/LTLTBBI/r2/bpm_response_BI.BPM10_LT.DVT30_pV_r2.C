...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,-17.38754,1050,26.41405);
   ...
   gre->SetPoint(0,-700,-9.9835);
   gre->SetPointError(0,0,0.1037711);
   gre->SetPoint(1,-500,-5.8235);
   gre->SetPointError(1,0,0.06242879);
   gre->SetPoint(2,-300,-1.63648);
   gre->SetPointError(2,0,0.1167326);
   gre->SetPoint(3,-100,2.3935);
   gre->SetPointError(3,0,0.1196849);
   gre->SetPoint(4,100,6.70676);
   gre->SetPointError(4,0,0.1165048);
   gre->SetPoint(5,300,11.09924);
   gre->SetPointError(5,0,0.1222391);
   gre->SetPoint(6,500,15.02008);
   gre->SetPointError(6,0,0.07890016);
   gre->SetPoint(7,700,18.83394);
   gre->SetPointError(7,0,0.2798471);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-13.00738);
   Graph_Graph24->SetMaximum(22.03389);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.683846);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.02086179);
   linear_fit->SetParError(0,7.998575e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.610069);
   linear_fit->SetParError(1,0.03673318);
