...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-0.3486484,1050,-0.2913116);
   ...
   gre->SetPoint(0,-700,-0.31306);
   gre->SetPointError(0,0,0.009726781);
   gre->SetPoint(1,-500,-0.3163);
   gre->SetPointError(1,0,0.003574966);
   gre->SetPoint(2,-300,-0.32466);
   gre->SetPointError(2,0,0.01123669);
   gre->SetPoint(3,-100,-0.33386);
   gre->SetPointError(3,0,0.005196227);
   gre->SetPoint(4,100,-0.31998);
   gre->SetPointError(4,0,0.01911229);
   gre->SetPoint(5,300,-0.31602);
   gre->SetPointError(5,0,0.008384346);
   gre->SetPoint(6,500,-0.32218);
   gre->SetPointError(6,0,0.006711254);
   gre->SetPoint(7,700,-0.30522);
   gre->SetPointError(7,0,0.003753066);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.3429147);
   Graph_Graph18->SetMaximum(-0.2970453);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.10397);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.206459e-06);
   linear_fit->SetParError(0,3.868999e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.316861);
   linear_fit->SetParError(1,0.002034785);
