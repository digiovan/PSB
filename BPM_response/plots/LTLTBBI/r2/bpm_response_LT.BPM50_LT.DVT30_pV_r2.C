...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-17.17285,1050,19.00623);
   ...
   gre->SetPoint(0,-700,-11.12126);
   gre->SetPointError(0,0,0.02174343);
   gre->SetPoint(1,-500,-8.64228);
   gre->SetPointError(1,0,0.01238379);
   gre->SetPoint(2,-300,-5.0958);
   gre->SetPointError(2,0,0.0477947);
   gre->SetPoint(3,-100,-1.54412);
   gre->SetPointError(3,0,0.02358462);
   gre->SetPoint(4,100,1.85748);
   gre->SetPointError(4,0,0.007518008);
   gre->SetPoint(5,300,5.30868);
   gre->SetPointError(5,0,0.04491694);
   gre->SetPoint(6,500,8.92894);
   gre->SetPointError(6,0,0.01599462);
   gre->SetPoint(7,700,12.91946);
   gre->SetPointError(7,0,0.05692024);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-13.55494);
   Graph_Graph19->SetMaximum(15.38832);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1752.337);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01720288);
   linear_fit->SetParError(0,1.572112e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.1826467);
   linear_fit->SetParError(1,0.005500704);
