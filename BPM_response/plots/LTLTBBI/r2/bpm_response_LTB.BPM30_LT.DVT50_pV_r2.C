...
//=========  (Wed Apr  1 22:34:58 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,-11.52666,1050,15.37629);
   ...
   gre->SetPoint(0,-700,-6.9637);
   gre->SetPointError(0,0,0.07913673);
   gre->SetPoint(1,-500,-4.3471);
   gre->SetPointError(1,0,0.08914132);
   gre->SetPoint(2,-300,-1.63954);
   gre->SetPointError(2,0,0.02977306);
   gre->SetPoint(3,-100,1.01634);
   gre->SetPointError(3,0,0.06130246);
   gre->SetPoint(4,100,3.48986);
   gre->SetPointError(4,0,0.07723313);
   gre->SetPoint(5,300,5.9701);
   gre->SetPointError(5,0,0.04218178);
   gre->SetPoint(6,500,8.22294);
   gre->SetPointError(6,0,0.1194489);
   gre->SetPoint(7,700,10.86528);
   gre->SetPointError(7,0,0.02718727);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LT.DVT50 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-8.836367);
   Graph_Graph22->SetMaximum(12.686);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.04766);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01256918);
   linear_fit->SetParError(0,3.442574e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.110556);
   linear_fit->SetParError(1,0.01710926);
