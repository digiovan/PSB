...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-9.315541,1050,3.680739);
   ...
   gre->SetPoint(0,-700,-7.0968);
   gre->SetPointError(0,0,0.05269407);
   gre->SetPoint(1,-500,-6.15854);
   gre->SetPointError(1,0,0.05031837);
   gre->SetPoint(2,-300,-4.95938);
   gre->SetPointError(2,0,0.04189686);
   gre->SetPoint(3,-100,-3.59118);
   gre->SetPointError(3,0,0.07795577);
   gre->SetPoint(4,100,-2.6158);
   gre->SetPointError(4,0,0.1243336);
   gre->SetPoint(5,300,-1.34152);
   gre->SetPointError(5,0,0.2120577);
   gre->SetPoint(6,500,-0.11902);
   gre->SetPointError(6,0,0.1857389);
   gre->SetPoint(7,700,1.43268);
   gre->SetPointError(7,0,0.08201255);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-8.015913);
   Graph_Graph24->SetMaximum(2.381111);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(32.29295);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006088611);
   linear_fit->SetParError(0,6.139064e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.031922);
   linear_fit->SetParError(1,0.02971325);
