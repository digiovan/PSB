...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-1.465066,1050,0.8212223);
   ...
   gre->SetPoint(0,-700,-1.07856);
   gre->SetPointError(0,0,0.005458247);
   gre->SetPoint(1,-500,-0.9505);
   gre->SetPointError(1,0,0.01492416);
   gre->SetPoint(2,-300,-0.63946);
   gre->SetPointError(2,0,0.01409527);
   gre->SetPoint(3,-100,-0.53232);
   gre->SetPointError(3,0,0.0149604);
   gre->SetPoint(4,100,-0.34372);
   gre->SetPointError(4,0,0.007641718);
   gre->SetPoint(5,300,-0.00812);
   gre->SetPointError(5,0,0.007778759);
   gre->SetPoint(6,500,0.09834);
   gre->SetPointError(6,0,0.008915528);
   gre->SetPoint(7,700,0.4308);
   gre->SetPointError(7,0,0.009374175);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-1.236437);
   Graph_Graph18->SetMaximum(0.5925934);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(291.8621);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001040373);
   linear_fit->SetParError(0,5.974949e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3699153);
   linear_fit->SetParError(1,0.003107502);
