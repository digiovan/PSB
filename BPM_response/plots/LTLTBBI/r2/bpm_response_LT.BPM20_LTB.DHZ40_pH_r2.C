...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-8.239937,1050,-7.877187);
   ...
   gre->SetPoint(0,-700,-8.12902);
   gre->SetPointError(0,0,0.01618589);
   gre->SetPoint(1,-500,-8.0415);
   gre->SetPointError(1,0,0.06804091);
   gre->SetPoint(2,-300,-8.10398);
   gre->SetPointError(2,0,0.007916803);
   gre->SetPoint(3,-100,-7.99992);
   gre->SetPointError(3,0,0.06227468);
   gre->SetPoint(4,100,-8.09872);
   gre->SetPointError(4,0,0.0631514);
   gre->SetPoint(5,300,-8.0793);
   gre->SetPointError(5,0,0.08077993);
   gre->SetPoint(6,500,-8.08916);
   gre->SetPointError(6,0,0.06136597);
   gre->SetPoint(7,700,-8.12164);
   gre->SetPointError(7,0,0.05783848);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.203662);
   Graph_Graph16->SetMaximum(-7.913462);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.807527);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.405195e-05);
   linear_fit->SetParError(0,2.932877e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.094884);
   linear_fit->SetParError(1,0.01206838);
