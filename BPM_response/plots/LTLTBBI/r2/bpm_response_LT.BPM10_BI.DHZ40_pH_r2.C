...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.87613,1050,2.17685);
   ...
   gre->SetPoint(0,-700,2.07544);
   gre->SetPointError(0,0,0.0512899);
   gre->SetPoint(1,-500,2.03474);
   gre->SetPointError(1,0,0.03112337);
   gre->SetPoint(2,-300,1.94268);
   gre->SetPointError(2,0,0.01642969);
   gre->SetPoint(3,-100,2.01724);
   gre->SetPointError(3,0,0.01119134);
   gre->SetPoint(4,100,1.98158);
   gre->SetPointError(4,0,0.01558554);
   gre->SetPoint(5,300,1.96292);
   gre->SetPointError(5,0,0.02025356);
   gre->SetPoint(6,500,2.01898);
   gre->SetPointError(6,0,0.03889385);
   gre->SetPoint(7,700,1.99094);
   gre->SetPointError(7,0,0.04071713);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.906202);
   Graph_Graph15->SetMaximum(2.146778);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(21.15779);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.728167e-05);
   linear_fit->SetParError(0,2.541077e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.99125);
   linear_fit->SetParError(1,0.006981141);
