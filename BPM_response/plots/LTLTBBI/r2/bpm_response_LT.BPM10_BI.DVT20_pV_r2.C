...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.6416782,1050,1.014849);
   ...
   gre->SetPoint(0,-700,0.7284);
   gre->SetPointError(0,0,0.0245266);
   gre->SetPoint(1,-500,0.82982);
   gre->SetPointError(1,0,0.01832785);
   gre->SetPoint(2,-300,0.81904);
   gre->SetPointError(2,0,0.01933308);
   gre->SetPoint(3,-100,0.88054);
   gre->SetPointError(3,0,0.04048931);
   gre->SetPoint(4,100,0.84768);
   gre->SetPointError(4,0,0.05911618);
   gre->SetPoint(5,300,0.86154);
   gre->SetPointError(5,0,0.02929876);
   gre->SetPoint(6,500,0.78042);
   gre->SetPointError(6,0,0.04963597);
   gre->SetPoint(7,700,0.90932);
   gre->SetPointError(7,0,0.04333401);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.6789953);
   Graph_Graph15->SetMaximum(0.9775321);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.37222);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,7.893476e-05);
   linear_fit->SetParError(0,2.469745e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8395227);
   linear_fit->SetParError(1,0.01160114);
