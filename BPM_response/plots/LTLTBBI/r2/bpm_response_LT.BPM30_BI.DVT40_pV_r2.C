...
//=========  (Wed Apr  1 22:36:22 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.70917,1050,-9.523323);
   ...
   gre->SetPoint(0,-700,-10.1596);
   gre->SetPointError(0,0,0.05605759);
   gre->SetPoint(1,-500,-10.3897);
   gre->SetPointError(1,0,0.0385708);
   gre->SetPoint(2,-300,-9.84884);
   gre->SetPointError(2,0,0.1278755);
   gre->SetPoint(3,-100,-10.41034);
   gre->SetPointError(3,0,0.04078452);
   gre->SetPoint(4,100,-10.34092);
   gre->SetPointError(4,0,0.170611);
   gre->SetPoint(5,300,-9.83608);
   gre->SetPointError(5,0,0.08487428);
   gre->SetPoint(6,500,-10.00086);
   gre->SetPointError(6,0,0.1968938);
   gre->SetPoint(7,700,-10.20752);
   gre->SetPointError(7,0,0.04111025);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.59059);
   Graph_Graph17->SetMaximum(-9.641908);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(60.34477);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001000307);
   linear_fit->SetParError(0,3.972933e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.26415);
   linear_fit->SetParError(1,0.02040772);
