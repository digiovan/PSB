...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-4.793101,1050,6.17117);
   ...
   gre->SetPoint(0,-700,-2.16116);
   gre->SetPointError(0,0,0.8045625);
   gre->SetPoint(1,-500,3.04344);
   gre->SetPointError(1,0,0.05629322);
   gre->SetPoint(2,-300,-0.85788);
   gre->SetPointError(2,0,0.073063);
   gre->SetPoint(3,-100,4.15518);
   gre->SetPointError(3,0,0.1886114);
   gre->SetPoint(4,100,-1.20656);
   gre->SetPointError(4,0,0.163412);
   gre->SetPoint(5,300,3.43174);
   gre->SetPointError(5,0,0.308988);
   gre->SetPoint(6,500,2.00572);
   gre->SetPointError(6,0,1.050689);
   gre->SetPoint(7,700,-1.82642);
   gre->SetPointError(7,0,0.3866608);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-3.696674);
   Graph_Graph28->SetMaximum(5.074743);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1828.23);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004396819);
   linear_fit->SetParError(0,0.000183953);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.01967394);
   linear_fit->SetParError(1,0.07646486);
