...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-11.98614,1050,6.117538);
   ...
   gre->SetPoint(0,-700,-8.87184);
   gre->SetPointError(0,0,0.09702036);
   gre->SetPoint(1,-500,-6.9486);
   gre->SetPointError(1,0,0.07210772);
   gre->SetPoint(2,-300,-5.95372);
   gre->SetPointError(2,0,0.2027655);
   gre->SetPoint(3,-100,-3.83512);
   gre->SetPointError(3,0,0.1838118);
   gre->SetPoint(4,100,-2.01162);
   gre->SetPointError(4,0,0.1555377);
   gre->SetPoint(5,300,-0.75888);
   gre->SetPointError(5,0,0.05352846);
   gre->SetPoint(6,500,1.47254);
   gre->SetPointError(6,0,0.1447819);
   gre->SetPoint(7,700,2.9758);
   gre->SetPointError(7,0,0.124458);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-10.17577);
   Graph_Graph24->SetMaximum(4.30717);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(38.87351);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008178084);
   linear_fit->SetParError(0,7.495394e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.039578);
   linear_fit->SetParError(1,0.03419849);
