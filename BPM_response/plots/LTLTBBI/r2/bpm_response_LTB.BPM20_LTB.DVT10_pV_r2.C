...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,-13.73578,1050,17.88709);
   ...
   gre->SetPoint(0,-700,-8.43644);
   gre->SetPointError(0,0,0.02886442);
   gre->SetPoint(1,-500,-5.36898);
   gre->SetPointError(1,0,0.04088438);
   gre->SetPoint(2,-300,-2.33184);
   gre->SetPointError(2,0,0.0532605);
   gre->SetPoint(3,-100,0.6903);
   gre->SetPointError(3,0,0.008469005);
   gre->SetPoint(4,100,3.3807);
   gre->SetPointError(4,0,0.05961731);
   gre->SetPoint(5,300,6.42484);
   gre->SetPointError(5,0,0.03930775);
   gre->SetPoint(6,500,9.65958);
   gre->SetPointError(6,0,0.07501693);
   gre->SetPoint(7,700,12.51516);
   gre->SetPointError(7,0,0.101447);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-10.5735);
   Graph_Graph21->SetMaximum(14.7248);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(83.98974);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01498612);
   linear_fit->SetParError(0,3.611704e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.160922);
   linear_fit->SetParError(1,0.008949095);
