...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_2->Range(-1050,-15.27221,1050,2.042851);
   ...
   gre->SetPoint(0,-700,-12.36724);
   gre->SetPointError(0,0,0.0191249);
   gre->SetPoint(1,-500,-11.5028);
   gre->SetPointError(1,0,0.08588702);
   gre->SetPoint(2,-300,-9.57946);
   gre->SetPointError(2,0,0.04510649);
   gre->SetPoint(3,-100,-7.71614);
   gre->SetPointError(3,0,0.05393128);
   gre->SetPoint(4,100,-6.02338);
   gre->SetPointError(4,0,0.02905602);
   gre->SetPoint(5,300,-4.59154);
   gre->SetPointError(5,0,0.06507061);
   gre->SetPoint(6,500,-3.1044);
   gre->SetPointError(6,0,0.08821472);
   gre->SetPoint(7,700,-0.98186);
   gre->SetPointError(7,0,0.1388678);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-13.5407);
   Graph_Graph18->SetMaximum(0.3113451);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(136.1932);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.007881643);
   linear_fit->SetParError(0,3.42939e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.90453);
   linear_fit->SetParError(1,0.01830603);
