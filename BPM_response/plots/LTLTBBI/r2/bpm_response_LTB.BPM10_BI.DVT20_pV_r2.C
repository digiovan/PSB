...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,0.6029401,1050,0.8640853);
   ...
   gre->SetPoint(0,-700,0.66904);
   gre->SetPointError(0,0,0.0225757);
   gre->SetPoint(1,-500,0.72038);
   gre->SetPointError(1,0,0.02814914);
   gre->SetPoint(2,-300,0.72444);
   gre->SetPointError(2,0,0.01693333);
   gre->SetPoint(3,-100,0.77526);
   gre->SetPointError(3,0,0.02488462);
   gre->SetPoint(4,100,0.72506);
   gre->SetPointError(4,0,0.05860074);
   gre->SetPoint(5,300,0.7784);
   gre->SetPointError(5,0,0.02171957);
   gre->SetPoint(6,500,0.69036);
   gre->SetPointError(6,0,0.04301866);
   gre->SetPoint(7,700,0.78314);
   gre->SetPointError(7,0,0.03742109);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.6290546);
   Graph_Graph20->SetMaximum(0.8379708);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(8.74689);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.955809e-05);
   linear_fit->SetParError(0,2.2237e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7436131);
   linear_fit->SetParError(1,0.00970814);
