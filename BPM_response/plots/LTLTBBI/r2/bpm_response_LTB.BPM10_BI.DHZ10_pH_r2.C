...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-0.1309205,1050,1.178284);
   ...
   gre->SetPoint(0,-700,0.52546);
   gre->SetPointError(0,0,0.05944582);
   gre->SetPoint(1,-500,0.74286);
   gre->SetPointError(1,0,0.02809466);
   gre->SetPoint(2,-300,0.6343);
   gre->SetPointError(2,0,0.0787735);
   gre->SetPoint(3,-100,0.5378);
   gre->SetPointError(3,0,0.08595115);
   gre->SetPoint(4,100,0.73302);
   gre->SetPointError(4,0,0.1978734);
   gre->SetPoint(5,300,0.67314);
   gre->SetPointError(5,0,0.2825981);
   gre->SetPoint(6,500,0.57286);
   gre->SetPointError(6,0,0.1616412);
   gre->SetPoint(7,700,0.1197);
   gre->SetPointError(7,0,0.08021864);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0);
   Graph_Graph20->SetMaximum(1.047364);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.23876);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0003466735);
   linear_fit->SetParError(0,5.965621e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5145626);
   linear_fit->SetParError(1,0.03092204);
