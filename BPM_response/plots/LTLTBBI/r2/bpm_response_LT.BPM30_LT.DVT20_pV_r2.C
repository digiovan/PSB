...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-20.2391,1050,-0.8233828);
   ...
   gre->SetPoint(0,-700,-16.89746);
   gre->SetPointError(0,0,0.1056912);
   gre->SetPoint(1,-500,-15.27232);
   gre->SetPointError(1,0,0.04975151);
   gre->SetPoint(2,-300,-12.95264);
   gre->SetPointError(2,0,0.0701772);
   gre->SetPoint(3,-100,-11.22816);
   gre->SetPointError(3,0,0.1229261);
   gre->SetPoint(4,100,-9.37212);
   gre->SetPointError(4,0,0.01436069);
   gre->SetPoint(5,300,-7.6191);
   gre->SetPointError(5,0,0.04599147);
   gre->SetPoint(6,500,-5.9032);
   gre->SetPointError(6,0,0.08492558);
   gre->SetPoint(7,700,-4.09176);
   gre->SetPointError(7,0,0.03242337);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-18.29753);
   Graph_Graph17->SetMaximum(-2.764955);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(96.55132);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.009132407);
   linear_fit->SetParError(0,4.056154e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.34481);
   linear_fit->SetParError(1,0.01316346);
