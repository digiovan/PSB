...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_2->Range(-1050,-29.67969,1050,20.44981);
   ...
   gre->SetPoint(0,-700,7.15792);
   gre->SetPointError(0,0,0.2144204);
   gre->SetPoint(1,-500,11.7151);
   gre->SetPointError(1,0,0.3797935);
   gre->SetPoint(2,-300,5.9365);
   gre->SetPointError(2,0,0.1139928);
   gre->SetPoint(3,-100,0.42706);
   gre->SetPointError(3,0,0.1138704);
   gre->SetPoint(4,100,-4.24606);
   gre->SetPointError(4,0,0.3235908);
   gre->SetPoint(5,300,-11.12434);
   gre->SetPointError(5,0,0.1704221);
   gre->SetPoint(6,500,-15.54086);
   gre->SetPointError(6,0,0.2369963);
   gre->SetPoint(7,700,-21.05556);
   gre->SetPointError(7,0,0.2692117);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-24.66674);
   Graph_Graph26->SetMaximum(15.43686);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1373.388);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.02335405);
   linear_fit->SetParError(0,0.0001740765);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.798215);
   linear_fit->SetParError(1,0.06360849);
