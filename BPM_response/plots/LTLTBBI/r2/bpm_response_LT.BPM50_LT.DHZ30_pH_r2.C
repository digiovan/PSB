...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-4.485807,1050,1.398917);
   ...
   gre->SetPoint(0,-700,0.40198);
   gre->SetPointError(0,0,0.01614972);
   gre->SetPoint(1,-500,0.06742);
   gre->SetPointError(1,0,0.05185765);
   gre->SetPoint(2,-300,-0.73418);
   gre->SetPointError(2,0,0.03479729);
   gre->SetPoint(3,-100,-1.08);
   gre->SetPointError(3,0,0.0103545);
   gre->SetPoint(4,100,-1.83128);
   gre->SetPointError(4,0,0.007625562);
   gre->SetPoint(5,300,-2.23264);
   gre->SetPointError(5,0,0.0127837);
   gre->SetPoint(6,500,-2.77238);
   gre->SetPointError(6,0,0.01155102);
   gre->SetPoint(7,700,-3.47206);
   gre->SetPointError(7,0,0.03295985);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-3.897335);
   Graph_Graph19->SetMaximum(0.8104447);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(338.2584);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002709585);
   linear_fit->SetParError(0,1.434843e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.468487);
   linear_fit->SetParError(1,0.004813336);
