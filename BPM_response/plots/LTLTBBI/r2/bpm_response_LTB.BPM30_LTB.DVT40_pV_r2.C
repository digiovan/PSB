...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,1.398206,1050,3.003376);
   ...
   gre->SetPoint(0,-700,1.78706);
   gre->SetPointError(0,0,0.1213256);
   gre->SetPoint(1,-500,2.08368);
   gre->SetPointError(1,0,0.1693301);
   gre->SetPoint(2,-300,2.25722);
   gre->SetPointError(2,0,0.0328219);
   gre->SetPoint(3,-100,2.46336);
   gre->SetPointError(3,0,0.07784527);
   gre->SetPoint(4,100,2.6713);
   gre->SetPointError(4,0,0.06454805);
   gre->SetPoint(5,300,2.35194);
   gre->SetPointError(5,0,0.05778648);
   gre->SetPoint(6,500,2.53676);
   gre->SetPointError(6,0,0.08066985);
   gre->SetPoint(7,700,2.47902);
   gre->SetPointError(7,0,0.07968551);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(1.558723);
   Graph_Graph22->SetMaximum(2.842859);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(35.38596);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0003408567);
   linear_fit->SetParError(0,6.080923e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.365584);
   linear_fit->SetParError(1,0.02217349);
