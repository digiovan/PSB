...
//=========  (Wed Apr  1 22:35:08 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.7916296,1050,1.075014);
   ...
   gre->SetPoint(0,-700,0.9723);
   gre->SetPointError(0,0,0.029953);
   gre->SetPoint(1,-500,0.89728);
   gre->SetPointError(1,0,0.0180124);
   gre->SetPoint(2,-300,0.90618);
   gre->SetPointError(2,0,0.04101186);
   gre->SetPoint(3,-100,0.90258);
   gre->SetPointError(3,0,0.04144437);
   gre->SetPoint(4,100,0.87972);
   gre->SetPointError(4,0,0.04085978);
   gre->SetPoint(5,300,0.91424);
   gre->SetPointError(5,0,0.01735147);
   gre->SetPoint(6,500,1.0083);
   gre->SetPointError(6,0,0.01948288);
   gre->SetPoint(7,700,0.93494);
   gre->SetPointError(7,0,0.02616131);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.819968);
   Graph_Graph15->SetMaximum(1.046675);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.41561);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.65589e-05);
   linear_fit->SetParError(0,1.824829e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9312364);
   linear_fit->SetParError(1,0.008717288);
