...
//=========  (Wed Apr  1 22:36:22 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-0.5068649,1050,-0.2574927);
   ...
   gre->SetPoint(0,-700,-0.441);
   gre->SetPointError(0,0,0.004094596);
   gre->SetPoint(1,-500,-0.41762);
   gre->SetPointError(1,0,0.03126313);
   gre->SetPoint(2,-300,-0.30244);
   gre->SetPointError(2,0,0.003385243);
   gre->SetPoint(3,-100,-0.44462);
   gre->SetPointError(3,0,0.01083209);
   gre->SetPoint(4,100,-0.44866);
   gre->SetPointError(4,0,0.0166429);
   gre->SetPoint(5,300,-0.37526);
   gre->SetPointError(5,0,0.02867008);
   gre->SetPoint(6,500,-0.43196);
   gre->SetPointError(6,0,0.01780599);
   gre->SetPoint(7,700,-0.44374);
   gre->SetPointError(7,0,0.0120891);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-0.4819277);
   Graph_Graph19->SetMaximum(-0.2824299);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(787.1803);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.169962e-05);
   linear_fit->SetParError(0,7.232258e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.354941);
   linear_fit->SetParError(1,0.003568899);
