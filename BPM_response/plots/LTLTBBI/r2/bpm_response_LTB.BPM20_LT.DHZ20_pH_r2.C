...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,-9.360621,1050,15.57928);
   ...
   gre->SetPoint(0,-700,-5.1293);
   gre->SetPointError(0,0,0.07467095);
   gre->SetPoint(1,-500,-3.4451);
   gre->SetPointError(1,0,0.2552959);
   gre->SetPoint(2,-300,-1.30736);
   gre->SetPointError(2,0,0.1512936);
   gre->SetPoint(3,-100,1.78456);
   gre->SetPointError(3,0,0.2552945);
   gre->SetPoint(4,100,4.20576);
   gre->SetPointError(4,0,0.2210822);
   gre->SetPoint(5,300,6.4696);
   gre->SetPointError(5,0,0.1730318);
   gre->SetPoint(6,500,8.66234);
   gre->SetPointError(6,0,0.1746131);
   gre->SetPoint(7,700,11.28464);
   gre->SetPointError(7,0,0.1379884);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-6.866631);
   Graph_Graph21->SetMaximum(13.08529);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(32.38633);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01170046);
   linear_fit->SetParError(0,9.30206e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.909542);
   linear_fit->SetParError(1,0.05410988);
