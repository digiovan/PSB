...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,-1.939576,1050,5.953575);
   ...
   gre->SetPoint(0,-700,-0.52706);
   gre->SetPointError(0,0,0.09699109);
   gre->SetPoint(1,-500,0.4152);
   gre->SetPointError(1,0,0.03722389);
   gre->SetPoint(2,-300,1.0839);
   gre->SetPointError(2,0,0.02798773);
   gre->SetPoint(3,-100,1.66592);
   gre->SetPointError(3,0,0.04345393);
   gre->SetPoint(4,100,2.475);
   gre->SetPointError(4,0,0.1037049);
   gre->SetPoint(5,300,3.31082);
   gre->SetPointError(5,0,0.02537682);
   gre->SetPoint(6,500,3.9655);
   gre->SetPointError(6,0,0.1803325);
   gre->SetPoint(7,700,4.59946);
   gre->SetPointError(7,0,0.03858962);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-1.150261);
   Graph_Graph21->SetMaximum(5.16426);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.96372);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003591281);
   linear_fit->SetParError(0,3.474152e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.161747);
   linear_fit->SetParError(1,0.01418092);
