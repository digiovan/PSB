...
//=========  (Wed Apr  1 22:35:14 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-1.681393,1050,-1.538608);
   ...
   gre->SetPoint(0,-700,-1.6155);
   gre->SetPointError(0,0,0.04209514);
   gre->SetPoint(1,-500,-1.6222);
   gre->SetPointError(1,0,0.02267805);
   gre->SetPoint(2,-300,-1.59212);
   gre->SetPointError(2,0,0.01852319);
   gre->SetPoint(3,-100,-1.59724);
   gre->SetPointError(3,0,0.03483432);
   gre->SetPoint(4,100,-1.62556);
   gre->SetPointError(4,0,0.01024465);
   gre->SetPoint(5,300,-1.59338);
   gre->SetPointError(5,0,0.01802862);
   gre->SetPoint(6,500,-1.61862);
   gre->SetPointError(6,0,0.02270277);
   gre->SetPoint(7,700,-1.61012);
   gre->SetPointError(7,0,0.009933383);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.667114);
   Graph_Graph19->SetMaximum(-1.552887);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.456909);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.640019e-06);
   linear_fit->SetParError(0,1.416937e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.612967);
   linear_fit->SetParError(1,0.006671582);
