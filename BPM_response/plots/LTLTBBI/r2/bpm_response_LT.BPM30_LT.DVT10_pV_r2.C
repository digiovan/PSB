...
//=========  (Wed Apr  1 22:34:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-11.72247,1050,-8.826312);
   ...
   gre->SetPoint(0,-700,-11.1412);
   gre->SetPointError(0,0,0.09858116);
   gre->SetPoint(1,-500,-11.15682);
   gre->SetPointError(1,0,0.01158573);
   gre->SetPoint(2,-300,-10.77688);
   gre->SetPointError(2,0,0.102952);
   gre->SetPoint(3,-100,-10.46382);
   gre->SetPointError(3,0,0.07073705);
   gre->SetPoint(4,100,-10.04024);
   gre->SetPointError(4,0,0.05820146);
   gre->SetPoint(5,300,-9.99644);
   gre->SetPointError(5,0,0.0302624);
   gre->SetPoint(6,500,-9.62538);
   gre->SetPointError(6,0,0.1518042);
   gre->SetPoint(7,700,-9.34734);
   gre->SetPointError(7,0,0.03833391);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-11.43286);
   Graph_Graph17->SetMaximum(-9.115929);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.48263);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001498579);
   linear_fit->SetParError(0,2.60726e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.3985);
   linear_fit->SetParError(1,0.01271662);
