...
//=========  (Wed Apr  1 22:35:51 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-1.270887,1050,-0.2159329);
   ...
   gre->SetPoint(0,-700,-1.07008);
   gre->SetPointError(0,0,0.02498122);
   gre->SetPoint(1,-500,-0.91288);
   gre->SetPointError(1,0,0.03463702);
   gre->SetPoint(2,-300,-0.93474);
   gre->SetPointError(2,0,0.008998886);
   gre->SetPoint(3,-100,-0.81444);
   gre->SetPointError(3,0,0.03569907);
   gre->SetPoint(4,100,-0.75462);
   gre->SetPointError(4,0,0.01968154);
   gre->SetPoint(5,300,-0.70018);
   gre->SetPointError(5,0,0.005612347);
   gre->SetPoint(6,500,-0.53372);
   gre->SetPointError(6,0,0.07372879);
   gre->SetPoint(7,700,-0.41552);
   gre->SetPointError(7,0,0.02376146);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-1.165391);
   Graph_Graph23->SetMaximum(-0.3214283);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(37.93882);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0004011733);
   linear_fit->SetParError(0,1.378474e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.8098312);
   linear_fit->SetParError(1,0.004653647);
