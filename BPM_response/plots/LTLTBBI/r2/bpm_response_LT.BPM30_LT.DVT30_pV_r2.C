...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.98512,1050,-9.381997);
   ...
   gre->SetPoint(0,-700,-10.6873);
   gre->SetPointError(0,0,0.03063673);
   gre->SetPoint(1,-500,-10.51788);
   gre->SetPointError(1,0,0.04793713);
   gre->SetPoint(2,-300,-10.35588);
   gre->SetPointError(2,0,0.06352047);
   gre->SetPoint(3,-100,-10.48226);
   gre->SetPointError(3,0,0.09134998);
   gre->SetPoint(4,100,-10.25524);
   gre->SetPointError(4,0,0.1240311);
   gre->SetPoint(5,300,-9.91306);
   gre->SetPointError(5,0,0.2492193);
   gre->SetPoint(6,500,-10.03392);
   gre->SetPointError(6,0,0.1354087);
   gre->SetPoint(7,700,-9.94484);
   gre->SetPointError(7,0,0.295655);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.82481);
   Graph_Graph17->SetMaximum(-9.54231);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(6.46927);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0005572543);
   linear_fit->SetParError(0,7.52899e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.27839);
   linear_fit->SetParError(1,0.04359486);
