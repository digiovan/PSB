...
//=========  (Wed Apr  1 22:34:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-2.123896,1050,-0.8240133);
   ...
   gre->SetPoint(0,-700,-1.89008);
   gre->SetPointError(0,0,0.01716885);
   gre->SetPoint(1,-500,-1.62048);
   gre->SetPointError(1,0,0.004784015);
   gre->SetPoint(2,-300,-1.509);
   gre->SetPointError(2,0,0.04270145);
   gre->SetPoint(3,-100,-1.6063);
   gre->SetPointError(3,0,0.02329199);
   gre->SetPoint(4,100,-1.5068);
   gre->SetPointError(4,0,0.01803516);
   gre->SetPoint(5,300,-1.15608);
   gre->SetPointError(5,0,0.02456402);
   gre->SetPoint(6,500,-1.06634);
   gre->SetPointError(6,0,0.0256796);
   gre->SetPoint(7,700,-1.13388);
   gre->SetPointError(7,0,0.02921872);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.993908);
   Graph_Graph19->SetMaximum(-0.9540016);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(250.8287);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.000461222);
   linear_fit->SetParError(0,1.39561e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.410707);
   linear_fit->SetParError(1,0.006869814);
