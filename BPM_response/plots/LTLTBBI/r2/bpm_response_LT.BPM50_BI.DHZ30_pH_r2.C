...
//=========  (Wed Apr  1 22:36:06 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-1.673695,1050,-1.471554);
   ...
   gre->SetPoint(0,-700,-1.57798);
   gre->SetPointError(0,0,0.02439181);
   gre->SetPoint(1,-500,-1.57602);
   gre->SetPointError(1,0,0.00606736);
   gre->SetPoint(2,-300,-1.58074);
   gre->SetPointError(2,0,0.01703775);
   gre->SetPoint(3,-100,-1.5236);
   gre->SetPointError(3,0,0.01835618);
   gre->SetPoint(4,100,-1.54988);
   gre->SetPointError(4,0,0.01918327);
   gre->SetPoint(5,300,-1.60676);
   gre->SetPointError(5,0,0.03324506);
   gre->SetPoint(6,500,-1.56718);
   gre->SetPointError(6,0,0.0078939);
   gre->SetPoint(7,700,-1.5687);
   gre->SetPointError(7,0,0.03245561);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.653481);
   Graph_Graph19->SetMaximum(-1.491768);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(9.360605);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,9.09861e-06);
   linear_fit->SetParError(0,9.245557e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.569032);
   linear_fit->SetParError(1,0.004379926);
