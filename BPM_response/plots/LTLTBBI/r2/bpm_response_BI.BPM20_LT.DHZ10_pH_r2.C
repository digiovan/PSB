...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,7.855433,1050,9.383179);
   ...
   gre->SetPoint(0,-700,8.12858);
   gre->SetPointError(0,0,0.0185225);
   gre->SetPoint(1,-500,8.46116);
   gre->SetPointError(1,0,0.04587962);
   gre->SetPoint(2,-300,8.55618);
   gre->SetPointError(2,0,0.0331771);
   gre->SetPoint(3,-100,8.49924);
   gre->SetPointError(3,0,0.02765854);
   gre->SetPoint(4,100,8.60622);
   gre->SetPointError(4,0,0.02387094);
   gre->SetPoint(5,300,8.89282);
   gre->SetPointError(5,0,0.02334224);
   gre->SetPoint(6,500,9.1016);
   gre->SetPointError(6,0,0.02695491);
   gre->SetPoint(7,700,9.0374);
   gre->SetPointError(7,0,0.04105383);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(8.008208);
   Graph_Graph25->SetMaximum(9.230405);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(80.39529);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0007101763);
   linear_fit->SetParError(0,2.043614e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.644012);
   linear_fit->SetParError(1,0.009591205);
