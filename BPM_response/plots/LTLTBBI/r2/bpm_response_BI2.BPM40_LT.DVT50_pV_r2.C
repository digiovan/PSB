...
//=========  (Wed Apr  1 22:34:59 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_V_2->Range(-1050,-34.08716,1050,25.93188);
   ...
   gre->SetPoint(0,-700,15.7482);
   gre->SetPointError(0,0,0.1805035);
   gre->SetPoint(1,-500,12.82318);
   gre->SetPointError(1,0,0.208611);
   gre->SetPoint(2,-300,6.30268);
   gre->SetPointError(2,0,0.07835494);
   gre->SetPoint(3,-100,-2.23704);
   gre->SetPointError(3,0,0.1260217);
   gre->SetPoint(4,100,-9.51554);
   gre->SetPointError(4,0,0.1912346);
   gre->SetPoint(5,300,-17.32174);
   gre->SetPointError(5,0,0.4616592);
   gre->SetPoint(6,500,-23.91284);
   gre->SetPointError(6,0,0.1711493);
   gre->SetPoint(7,700,-7.6636);
   gre->SetPointError(7,0,1.984983);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LT.DVT50 Plane: V Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-28.08526);
   Graph_Graph27->SetMaximum(19.92997);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(775.9154);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.03509289);
   linear_fit->SetParError(0,0.0001752769);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.313924);
   linear_fit->SetParError(1,0.06351553);
