...
//=========  (Wed Apr  1 22:35:08 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-6.561448,1050,-6.22429);
   ...
   gre->SetPoint(0,-700,-6.44216);
   gre->SetPointError(0,0,0.01373335);
   gre->SetPoint(1,-500,-6.37606);
   gre->SetPointError(1,0,0.03714002);
   gre->SetPoint(2,-300,-6.3804);
   gre->SetPointError(2,0,0.05920195);
   gre->SetPoint(3,-100,-6.3609);
   gre->SetPointError(3,0,0.0635431);
   gre->SetPoint(4,100,-6.32928);
   gre->SetPointError(4,0,0.04879664);
   gre->SetPoint(5,300,-6.35576);
   gre->SetPointError(5,0,0.02310222);
   gre->SetPoint(6,500,-6.4847);
   gre->SetPointError(6,0,0.02055517);
   gre->SetPoint(7,700,-6.40756);
   gre->SetPointError(7,0,0.03662521);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-6.527732);
   Graph_Graph16->SetMaximum(-6.258006);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.19611);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.654335e-06);
   linear_fit->SetParError(0,1.656702e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.422726);
   linear_fit->SetParError(1,0.009503126);
