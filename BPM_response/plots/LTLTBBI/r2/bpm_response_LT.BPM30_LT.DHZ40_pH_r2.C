...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-11.16813,1050,-6.45474);
   ...
   gre->SetPoint(0,-700,-10.0115);
   gre->SetPointError(0,0,0.034596);
   gre->SetPoint(1,-500,-10.19742);
   gre->SetPointError(1,0,0.02446767);
   gre->SetPoint(2,-300,-9.87348);
   gre->SetPointError(2,0,0.1030283);
   gre->SetPoint(3,-100,-10.17414);
   gre->SetPointError(3,0,0.0420524);
   gre->SetPoint(4,100,-10.29474);
   gre->SetPointError(4,0,0.08782299);
   gre->SetPoint(5,300,-10.0519);
   gre->SetPointError(5,0,0.02640723);
   gre->SetPoint(6,500,-8.24686);
   gre->SetPointError(6,0,1.006555);
   gre->SetPoint(7,700,-9.97354);
   gre->SetPointError(7,0,0.01423043);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.69679);
   Graph_Graph17->SetMaximum(-6.926079);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(45.95574);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001231992);
   linear_fit->SetParError(0,1.890535e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.07254);
   linear_fit->SetParError(1,0.01119693);
