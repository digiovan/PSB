...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,-1.222323,1050,-0.9705851);
   ...
   gre->SetPoint(0,-700,-1.15334);
   gre->SetPointError(0,0,0.02702683);
   gre->SetPoint(1,-500,-1.0621);
   gre->SetPointError(1,0,0.03308556);
   gre->SetPoint(2,-300,-1.05656);
   gre->SetPointError(2,0,0.02239005);
   gre->SetPoint(3,-100,-1.04504);
   gre->SetPointError(3,0,0.03249853);
   gre->SetPoint(4,100,-1.08424);
   gre->SetPointError(4,0,0.05876311);
   gre->SetPoint(5,300,-1.06546);
   gre->SetPointError(5,0,0.005389076);
   gre->SetPoint(6,500,-1.12714);
   gre->SetPointError(6,0,0.02111172);
   gre->SetPoint(7,700,-1.1596);
   gre->SetPointError(7,0,0.01123479);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-1.197149);
   Graph_Graph25->SetMaximum(-0.9957589);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(58.85091);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.43165e-05);
   linear_fit->SetParError(0,1.544511e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.068643);
   linear_fit->SetParError(1,0.006410602);
