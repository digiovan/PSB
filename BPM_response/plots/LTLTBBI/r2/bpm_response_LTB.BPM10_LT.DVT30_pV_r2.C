...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,-0.08644402,1050,2.484279);
   ...
   gre->SetPoint(0,-700,2.03472);
   gre->SetPointError(0,0,0.02110485);
   gre->SetPoint(1,-500,1.43104);
   gre->SetPointError(1,0,0.04821319);
   gre->SetPoint(2,-300,1.20072);
   gre->SetPointError(2,0,0.09106309);
   gre->SetPoint(3,-100,1.06388);
   gre->SetPointError(3,0,0.04769112);
   gre->SetPoint(4,100,0.85854);
   gre->SetPointError(4,0,0.02310416);
   gre->SetPoint(5,300,0.62382);
   gre->SetPointError(5,0,0.05239459);
   gre->SetPoint(6,500,0.41534);
   gre->SetPointError(6,0,0.02257938);
   gre->SetPoint(7,700,0.36058);
   gre->SetPointError(7,0,0.01857023);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.1706283);
   Graph_Graph20->SetMaximum(2.227206);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(143.605);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001189467);
   linear_fit->SetParError(0,1.830349e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.084287);
   linear_fit->SetParError(1,0.01016229);
