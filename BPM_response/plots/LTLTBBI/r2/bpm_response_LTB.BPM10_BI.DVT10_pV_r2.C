...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,0.5934269,1050,0.9004187);
   ...
   gre->SetPoint(0,-700,0.79656);
   gre->SetPointError(0,0,0.05269336);
   gre->SetPoint(1,-500,0.68406);
   gre->SetPointError(1,0,0.03946781);
   gre->SetPoint(2,-300,0.78198);
   gre->SetPointError(2,0,0.01341632);
   gre->SetPoint(3,-100,0.78398);
   gre->SetPointError(3,0,0.06003548);
   gre->SetPoint(4,100,0.78768);
   gre->SetPointError(4,0,0.03704421);
   gre->SetPoint(5,300,0.81602);
   gre->SetPointError(5,0,0.02412572);
   gre->SetPoint(6,500,0.7362);
   gre->SetPointError(6,0,0.08997219);
   gre->SetPoint(7,700,0.705);
   gre->SetPointError(7,0,0.03598779);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.6241261);
   Graph_Graph20->SetMaximum(0.8697195);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.71415);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.911048e-06);
   linear_fit->SetParError(0,2.776788e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7757187);
   linear_fit->SetParError(1,0.01033869);
