...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,0.658844,1050,0.9304854);
   ...
   gre->SetPoint(0,-700,0.75844);
   gre->SetPointError(0,0,0.03543228);
   gre->SetPoint(1,-500,0.83344);
   gre->SetPointError(1,0,0.05177182);
   gre->SetPoint(2,-300,0.75194);
   gre->SetPointError(2,0,0.02746361);
   gre->SetPoint(3,-100,0.8145);
   gre->SetPointError(3,0,0.02444648);
   gre->SetPoint(4,100,0.74988);
   gre->SetPointError(4,0,0.0457624);
   gre->SetPoint(5,300,0.82612);
   gre->SetPointError(5,0,0.01268476);
   gre->SetPoint(6,500,0.75016);
   gre->SetPointError(6,0,0.02529339);
   gre->SetPoint(7,700,0.80946);
   gre->SetPointError(7,0,0.02662522);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.6860082);
   Graph_Graph20->SetMaximum(0.9033212);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(13.40479);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.579884e-05);
   linear_fit->SetParError(0,2.319294e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7965711);
   linear_fit->SetParError(1,0.009385822);
