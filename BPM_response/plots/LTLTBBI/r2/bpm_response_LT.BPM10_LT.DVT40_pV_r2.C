...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_V_2->Range(-1050,0.7082262,1050,1.037059);
   ...
   gre->SetPoint(0,-700,0.84926);
   gre->SetPointError(0,0,0.05379594);
   gre->SetPoint(1,-500,0.92862);
   gre->SetPointError(1,0,0.05363348);
   gre->SetPoint(2,-300,0.842);
   gre->SetPointError(2,0,0.07896835);
   gre->SetPoint(3,-100,0.90404);
   gre->SetPointError(3,0,0.01017832);
   gre->SetPoint(4,100,0.9069);
   gre->SetPointError(4,0,0.02946854);
   gre->SetPoint(5,300,0.85482);
   gre->SetPointError(5,0,0.03300643);
   gre->SetPoint(6,500,0.8879);
   gre->SetPointError(6,0,0.02714943);
   gre->SetPoint(7,700,0.8405);
   gre->SetPointError(7,0,0.01115659);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(0.7411095);
   Graph_Graph15->SetMaximum(1.004176);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(5.958047);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-6.532733e-05);
   linear_fit->SetParError(0,1.696159e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.8926253);
   linear_fit->SetParError(1,0.007876747);
