...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-6.09719,1050,2.156256);
   ...
   gre->SetPoint(0,-700,-4.65294);
   gre->SetPointError(0,0,0.06867543);
   gre->SetPoint(1,-500,-3.81796);
   gre->SetPointError(1,0,0.1106381);
   gre->SetPoint(2,-300,-3.17966);
   gre->SetPointError(2,0,0.0867712);
   gre->SetPoint(3,-100,-2.35834);
   gre->SetPointError(3,0,0.04859787);
   gre->SetPoint(4,100,-1.73412);
   gre->SetPointError(4,0,0.05417191);
   gre->SetPoint(5,300,-1.1189);
   gre->SetPointError(5,0,0.02194393);
   gre->SetPoint(6,500,-0.2428);
   gre->SetPointError(6,0,0.04723555);
   gre->SetPoint(7,700,0.6951);
   gre->SetPointError(7,0,0.08558195);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-5.271845);
   Graph_Graph25->SetMaximum(1.330912);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(34.67941);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003580937);
   linear_fit->SetParError(0,5.125651e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.121789);
   linear_fit->SetParError(1,0.01864589);
