...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-3.566398,1050,-2.664383);
   ...
   gre->SetPoint(0,-700,-3.07942);
   gre->SetPointError(0,0,0.0836789);
   gre->SetPoint(1,-500,-3.10088);
   gre->SetPointError(1,0,0.08549277);
   gre->SetPoint(2,-300,-3.17342);
   gre->SetPointError(2,0,0.06923108);
   gre->SetPoint(3,-100,-2.86);
   gre->SetPointError(3,0,0.04528156);
   gre->SetPoint(4,100,-2.98074);
   gre->SetPointError(4,0,0.1439241);
   gre->SetPoint(5,300,-3.254);
   gre->SetPointError(5,0,0.1620619);
   gre->SetPoint(6,500,-3.04448);
   gre->SetPointError(6,0,0.06368355);
   gre->SetPoint(7,700,-2.9758);
   gre->SetPointError(7,0,0.1513115);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-3.476196);
   Graph_Graph24->SetMaximum(-2.754584);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.49153);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,5.03479e-05);
   linear_fit->SetParError(0,6.968915e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.004569);
   linear_fit->SetParError(1,0.02777111);
