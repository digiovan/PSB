...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,-6.732615,1050,8.618705);
   ...
   gre->SetPoint(0,-700,-4.13612);
   gre->SetPointError(0,0,0.03794179);
   gre->SetPoint(1,-500,-2.6608);
   gre->SetPointError(1,0,0.06435503);
   gre->SetPoint(2,-300,-1.22408);
   gre->SetPointError(2,0,0.06128702);
   gre->SetPoint(3,-100,0.2737);
   gre->SetPointError(3,0,0.0120697);
   gre->SetPoint(4,100,1.60728);
   gre->SetPointError(4,0,0.0215285);
   gre->SetPoint(5,300,2.90308);
   gre->SetPointError(5,0,0.01574916);
   gre->SetPoint(6,500,4.45894);
   gre->SetPointError(6,0,0.03124405);
   gre->SetPoint(7,700,6.0268);
   gre->SetPointError(7,0,0.03335157);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-5.197483);
   Graph_Graph20->SetMaximum(7.083573);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(131.6184);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.007041381);
   linear_fit->SetParError(0,2.593815e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.9142223);
   linear_fit->SetParError(1,0.008091191);
