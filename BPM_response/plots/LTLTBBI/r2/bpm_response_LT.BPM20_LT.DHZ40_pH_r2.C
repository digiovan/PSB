...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-9.169619,1050,-5.375552);
   ...
   gre->SetPoint(0,-700,-8.26314);
   gre->SetPointError(0,0,0.03756687);
   gre->SetPoint(1,-500,-8.3734);
   gre->SetPointError(1,0,0.01870332);
   gre->SetPoint(2,-300,-8.13264);
   gre->SetPointError(2,0,0.1049354);
   gre->SetPoint(3,-100,-8.32796);
   gre->SetPointError(3,0,0.05241845);
   gre->SetPoint(4,100,-8.45756);
   gre->SetPointError(4,0,0.0797146);
   gre->SetPoint(5,300,-8.312);
   gre->SetPointError(5,0,0.03275367);
   gre->SetPoint(6,500,-6.80836);
   gre->SetPointError(6,0,0.8004632);
   gre->SetPoint(7,700,-8.20782);
   gre->SetPointError(7,0,0.009256665);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.790212);
   Graph_Graph16->SetMaximum(-5.754959);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.75162);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001137904);
   linear_fit->SetParError(0,1.511187e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.292464);
   linear_fit->SetParError(1,0.009674082);
