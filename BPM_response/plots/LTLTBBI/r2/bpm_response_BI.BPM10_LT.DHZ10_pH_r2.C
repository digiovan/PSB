...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-8.520939,1050,2.071806);
   ...
   gre->SetPoint(0,-700,-6.69322);
   gre->SetPointError(0,0,0.0622615);
   gre->SetPoint(1,-500,-5.5503);
   gre->SetPointError(1,0,0.03683909);
   gre->SetPoint(2,-300,-4.37844);
   gre->SetPointError(2,0,0.2375558);
   gre->SetPoint(3,-100,-4.17978);
   gre->SetPointError(3,0,0.2007464);
   gre->SetPoint(4,100,-3.18734);
   gre->SetPointError(4,0,0.1225801);
   gre->SetPoint(5,300,-1.42248);
   gre->SetPointError(5,0,0.1095672);
   gre->SetPoint(6,500,-0.32432);
   gre->SetPointError(6,0,0.1137823);
   gre->SetPoint(7,700,0.1605);
   gre->SetPointError(7,0,0.1458481);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-7.461664);
   Graph_Graph24->SetMaximum(1.012531);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(47.2885);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004989675);
   linear_fit->SetParError(0,6.966315e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.112838);
   linear_fit->SetParError(1,0.03664882);
