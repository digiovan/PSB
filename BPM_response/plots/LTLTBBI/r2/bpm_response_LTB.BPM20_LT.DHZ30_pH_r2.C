...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,-10.25132,1050,16.33901);
   ...
   gre->SetPoint(0,-700,-5.59724);
   gre->SetPointError(0,0,0.2223546);
   gre->SetPoint(1,-500,-3.91);
   gre->SetPointError(1,0,0.1663464);
   gre->SetPoint(2,-300,-0.38668);
   gre->SetPointError(2,0,0.1642147);
   gre->SetPoint(3,-100,1.38802);
   gre->SetPointError(3,0,0.1702896);
   gre->SetPoint(4,100,4.53232);
   gre->SetPointError(4,0,0.2859117);
   gre->SetPoint(5,300,6.64242);
   gre->SetPointError(5,0,0.1473191);
   gre->SetPoint(6,500,9.02302);
   gre->SetPointError(6,0,0.1228825);
   gre->SetPoint(7,700,11.81556);
   gre->SetPointError(7,0,0.09172871);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-7.592283);
   Graph_Graph21->SetMaximum(13.67998);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(27.59203);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01262445);
   linear_fit->SetParError(0,0.0001101395);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.894868);
   linear_fit->SetParError(1,0.05763786);
