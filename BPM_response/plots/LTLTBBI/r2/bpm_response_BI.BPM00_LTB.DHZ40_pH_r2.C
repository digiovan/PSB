...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-14.95445,1050,2.383006);
   ...
   gre->SetPoint(0,-700,-11.97418);
   gre->SetPointError(0,0,0.09069046);
   gre->SetPoint(1,-500,-10.20134);
   gre->SetPointError(1,0,0.05780437);
   gre->SetPoint(2,-300,-8.37496);
   gre->SetPointError(2,0,0.1111975);
   gre->SetPoint(3,-100,-6.68114);
   gre->SetPointError(3,0,0.08104358);
   gre->SetPoint(4,100,-5.1296);
   gre->SetPointError(4,0,0.07769039);
   gre->SetPoint(5,300,-3.77144);
   gre->SetPointError(5,0,0.1711618);
   gre->SetPoint(6,500,-2.14158);
   gre->SetPointError(6,0,0.1456954);
   gre->SetPoint(7,700,-0.5892);
   gre->SetPointError(7,0,0.08263075);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-13.2207);
   Graph_Graph23->SetMaximum(0.6492609);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(24.48282);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008105814);
   linear_fit->SetParError(0,6.782063e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.096773);
   linear_fit->SetParError(1,0.03188288);
