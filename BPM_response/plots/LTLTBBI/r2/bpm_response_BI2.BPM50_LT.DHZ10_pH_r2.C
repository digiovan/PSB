...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-5.130546,1050,6.886835);
   ...
   gre->SetPoint(0,-700,-0.52622);
   gre->SetPointError(0,0,0.471097);
   gre->SetPoint(1,-500,4.24722);
   gre->SetPointError(1,0,0.1989097);
   gre->SetPoint(2,-300,4.49788);
   gre->SetPointError(2,0,0.3860585);
   gre->SetPoint(3,-100,-1.68508);
   gre->SetPointError(3,0,0.5237237);
   gre->SetPoint(4,100,-2.55814);
   gre->SetPointError(4,0,0.5261689);
   gre->SetPoint(5,300,3.81338);
   gre->SetPointError(5,0,0.05836958);
   gre->SetPoint(6,500,1.61828);
   gre->SetPointError(6,0,0.6554137);
   gre->SetPoint(7,700,-2.76002);
   gre->SetPointError(7,0,0.3676287);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-3.928807);
   Graph_Graph28->SetMaximum(5.685097);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(648.5925);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0003412006);
   linear_fit->SetParError(0,0.0002088715);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.598181);
   linear_fit->SetParError(1,0.07076352);
