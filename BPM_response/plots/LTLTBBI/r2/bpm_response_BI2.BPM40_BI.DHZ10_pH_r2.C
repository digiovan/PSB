...
//=========  (Wed Apr  1 22:35:46 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-14.31837,1050,-7.701223);
   ...
   gre->SetPoint(0,-700,-12.0862);
   gre->SetPointError(0,0,0.5237244);
   gre->SetPoint(1,-500,-11.83518);
   gre->SetPointError(1,0,0.2631337);
   gre->SetPoint(2,-300,-10.90776);
   gre->SetPointError(2,0,0.9937759);
   gre->SetPoint(3,-100,-12.28282);
   gre->SetPointError(3,0,0.8134899);
   gre->SetPoint(4,100,-12.22776);
   gre->SetPointError(4,0,0.9670811);
   gre->SetPoint(5,300,-11.94504);
   gre->SetPointError(5,0,1.270472);
   gre->SetPoint(6,500,-11.32132);
   gre->SetPointError(6,0,0.4124834);
   gre->SetPoint(7,700,-9.32496);
   gre->SetPointError(7,0,0.520879);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-13.65666);
   Graph_Graph27->SetMaximum(-8.362938);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.57398);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001201716);
   linear_fit->SetParError(0,0.0003485153);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-11.31925);
   linear_fit->SetParError(1,0.1836219);
