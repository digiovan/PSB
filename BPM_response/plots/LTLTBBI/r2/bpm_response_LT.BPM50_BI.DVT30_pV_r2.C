...
//=========  (Wed Apr  1 22:36:12 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-0.5027409,1050,-0.2445065);
   ...
   gre->SetPoint(0,-700,-0.33018);
   gre->SetPointError(0,0,0.04263444);
   gre->SetPoint(1,-500,-0.44956);
   gre->SetPointError(1,0,0.0101418);
   gre->SetPoint(2,-300,-0.42408);
   gre->SetPointError(2,0,0.02520475);
   gre->SetPoint(3,-100,-0.4097);
   gre->SetPointError(3,0,0.01120212);
   gre->SetPoint(4,100,-0.43588);
   gre->SetPointError(4,0,0.005058931);
   gre->SetPoint(5,300,-0.43716);
   gre->SetPointError(5,0,0.01293817);
   gre->SetPoint(6,500,-0.44094);
   gre->SetPointError(6,0,0.01249938);
   gre->SetPoint(7,700,-0.38744);
   gre->SetPointError(7,0,0.04436466);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-0.4769174);
   Graph_Graph19->SetMaximum(-0.2703299);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.7425);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.273981e-06);
   linear_fit->SetParError(0,1.336975e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4339235);
   linear_fit->SetParError(1,0.003767444);
