...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,2.435267,1050,3.31364);
   ...
   gre->SetPoint(0,-700,2.82478);
   gre->SetPointError(0,0,0.1969746);
   gre->SetPoint(1,-500,2.71294);
   gre->SetPointError(1,0,0.1312778);
   gre->SetPoint(2,-300,3.06448);
   gre->SetPointError(2,0,0.08530388);
   gre->SetPoint(3,-100,2.85942);
   gre->SetPointError(3,0,0.1106499);
   gre->SetPoint(4,100,3.07778);
   gre->SetPointError(4,0,0.0894643);
   gre->SetPoint(5,300,3.04958);
   gre->SetPointError(5,0,0.07547594);
   gre->SetPoint(6,500,2.984);
   gre->SetPointError(6,0,0.09794092);
   gre->SetPoint(7,700,3.03632);
   gre->SetPointError(7,0,0.130583);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(2.523104);
   Graph_Graph21->SetMaximum(3.225803);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.024922);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001363815);
   linear_fit->SetParError(0,9.659734e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.982578);
   linear_fit->SetParError(1,0.03695767);
