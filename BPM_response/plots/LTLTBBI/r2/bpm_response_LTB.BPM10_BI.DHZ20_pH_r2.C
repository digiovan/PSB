...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-0.1227906,1050,1.105116);
   ...
   gre->SetPoint(0,-700,0.39158);
   gre->SetPointError(0,0,0.04226099);
   gre->SetPoint(1,-500,0.43344);
   gre->SetPointError(1,0,0.05505326);
   gre->SetPoint(2,-300,0.38354);
   gre->SetPointError(2,0,0.3711034);
   gre->SetPoint(3,-100,0.59612);
   gre->SetPointError(3,0,0.09823529);
   gre->SetPoint(4,100,0.77422);
   gre->SetPointError(4,0,0.1199334);
   gre->SetPoint(5,300,0.47788);
   gre->SetPointError(5,0,0.2994462);
   gre->SetPoint(6,500,0.59228);
   gre->SetPointError(6,0,0.225262);
   gre->SetPoint(7,700,0.7008);
   gre->SetPointError(7,0,0.09981324);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0);
   Graph_Graph20->SetMaximum(0.9823251);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.351111);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0002530601);
   linear_fit->SetParError(0,6.691254e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5736287);
   linear_fit->SetParError(1,0.03929396);
