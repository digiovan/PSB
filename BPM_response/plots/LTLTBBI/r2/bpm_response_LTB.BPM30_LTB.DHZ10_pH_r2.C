...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,-6.690083,1050,7.341577);
   ...
   gre->SetPoint(0,-700,-4.27612);
   gre->SetPointError(0,0,0.07535267);
   gre->SetPoint(1,-500,-2.84674);
   gre->SetPointError(1,0,0.05450563);
   gre->SetPoint(2,-300,-1.45234);
   gre->SetPointError(2,0,0.07071359);
   gre->SetPoint(3,-100,-0.01442);
   gre->SetPointError(3,0,0.02977286);
   gre->SetPoint(4,100,1.29592);
   gre->SetPointError(4,0,0.05380703);
   gre->SetPoint(5,300,2.50116);
   gre->SetPointError(5,0,0.09126961);
   gre->SetPoint(6,500,3.6194);
   gre->SetPointError(6,0,0.05790446);
   gre->SetPoint(7,700,4.95514);
   gre->SetPointError(7,0,0.04782683);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-5.286917);
   Graph_Graph22->SetMaximum(5.938411);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(48.16682);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.006472581);
   linear_fit->SetParError(0,4.465315e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.519035);
   linear_fit->SetParError(1,0.01815415);
