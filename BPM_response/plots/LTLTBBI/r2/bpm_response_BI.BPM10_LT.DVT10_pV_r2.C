...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,-1.237916,1050,11.14125);
   ...
   gre->SetPoint(0,-700,8.98936);
   gre->SetPointError(0,0,0.07843883);
   gre->SetPoint(1,-500,7.30838);
   gre->SetPointError(1,0,0.03381343);
   gre->SetPoint(2,-300,6.29274);
   gre->SetPointError(2,0,0.1100895);
   gre->SetPoint(3,-100,5.24566);
   gre->SetPointError(3,0,0.08630463);
   gre->SetPoint(4,100,4.04438);
   gre->SetPointError(4,0,0.1447163);
   gre->SetPoint(5,300,2.75214);
   gre->SetPointError(5,0,0.06070033);
   gre->SetPoint(6,500,1.67732);
   gre->SetPointError(6,0,0.2334372);
   gre->SetPoint(7,700,0.78608);
   gre->SetPointError(7,0,0.0735901);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(0);
   Graph_Graph24->SetMaximum(9.90333);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(52.82252);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005656288);
   linear_fit->SetParError(0,5.32867e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.577573);
   linear_fit->SetParError(1,0.02612886);
