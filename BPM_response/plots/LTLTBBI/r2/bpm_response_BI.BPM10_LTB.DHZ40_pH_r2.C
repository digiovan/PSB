...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-18.27791,1050,9.874515);
   ...
   gre->SetPoint(0,-700,-13.49378);
   gre->SetPointError(0,0,0.09206128);
   gre->SetPoint(1,-500,-10.76062);
   gre->SetPointError(1,0,0.09276637);
   gre->SetPoint(2,-300,-7.87104);
   gre->SetPointError(2,0,0.09843369);
   gre->SetPoint(3,-100,-5.07334);
   gre->SetPointError(3,0,0.1162656);
   gre->SetPoint(4,100,-2.49476);
   gre->SetPointError(4,0,0.1099309);
   gre->SetPoint(5,300,-0.23544);
   gre->SetPointError(5,0,0.2215011);
   gre->SetPoint(6,500,2.47312);
   gre->SetPointError(6,0,0.1831426);
   gre->SetPoint(7,700,5.05404);
   gre->SetPointError(7,0,0.1284033);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-15.46267);
   Graph_Graph24->SetMaximum(7.059272);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.89252);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01330067);
   linear_fit->SetParError(0,9.217551e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-4.023297);
   linear_fit->SetParError(1,0.04382055);
