...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.82758,1050,-9.924601);
   ...
   gre->SetPoint(0,-700,-10.4265);
   gre->SetPointError(0,0,0.08397651);
   gre->SetPoint(1,-500,-10.44732);
   gre->SetPointError(1,0,0.2297641);
   gre->SetPoint(2,-300,-10.33056);
   gre->SetPointError(2,0,0.03043393);
   gre->SetPoint(3,-100,-10.32216);
   gre->SetPointError(3,0,0.02809662);
   gre->SetPoint(4,100,-10.45668);
   gre->SetPointError(4,0,0.1413515);
   gre->SetPoint(5,300,-10.13584);
   gre->SetPointError(5,0,0.06074207);
   gre->SetPoint(6,500,-10.33592);
   gre->SetPointError(6,0,0.08891293);
   gre->SetPoint(7,700,-10.39856);
   gre->SetPointError(7,0,0.06671149);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.73728);
   Graph_Graph17->SetMaximum(-10.0149);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.81659);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.761543e-05);
   linear_fit->SetParError(0,5.499584e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.31881);
   linear_fit->SetParError(1,0.01826448);
