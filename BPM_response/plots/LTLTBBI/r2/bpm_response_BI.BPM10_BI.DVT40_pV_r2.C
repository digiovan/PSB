...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,3.922291,1050,5.589877);
   ...
   gre->SetPoint(0,-700,4.70066);
   gre->SetPointError(0,0,0.09394123);
   gre->SetPoint(1,-500,4.4552);
   gre->SetPointError(1,0,0.1185999);
   gre->SetPoint(2,-300,5.19704);
   gre->SetPointError(2,0,0.1149056);
   gre->SetPoint(3,-100,4.34924);
   gre->SetPointError(3,0,0.03500488);
   gre->SetPoint(4,100,4.38782);
   gre->SetPointError(4,0,0.1875981);
   gre->SetPoint(5,300,5.15086);
   gre->SetPointError(5,0,0.14186);
   gre->SetPoint(6,500,4.81392);
   gre->SetPointError(6,0,0.265114);
   gre->SetPoint(7,700,4.50992);
   gre->SetPointError(7,0,0.07455963);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(4.089049);
   Graph_Graph24->SetMaximum(5.423118);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(82.52354);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-3.181954e-05);
   linear_fit->SetParError(0,7.427601e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.487051);
   linear_fit->SetParError(1,0.02749157);
