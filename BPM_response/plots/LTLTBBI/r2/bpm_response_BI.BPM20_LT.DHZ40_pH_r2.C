...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,5.312212,1050,9.542872);
   ...
   gre->SetPoint(0,-700,8.5389);
   gre->SetPointError(0,0,0.07340149);
   gre->SetPoint(1,-500,8.81306);
   gre->SetPointError(1,0,0.02470228);
   gre->SetPoint(2,-300,8.52756);
   gre->SetPointError(2,0,0.02536072);
   gre->SetPoint(3,-100,8.73232);
   gre->SetPointError(3,0,0.01729848);
   gre->SetPoint(4,100,8.73664);
   gre->SetPointError(4,0,0.0215252);
   gre->SetPoint(5,300,8.51248);
   gre->SetPointError(5,0,0.01065076);
   gre->SetPoint(6,500,6.93032);
   gre->SetPointError(6,0,0.9129978);
   gre->SetPoint(7,700,8.5709);
   gre->SetPointError(7,0,0.04252102);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(5.735278);
   Graph_Graph25->SetMaximum(9.119806);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(151.3324);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.000247658);
   linear_fit->SetParError(0,2.471384e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.629795);
   linear_fit->SetParError(1,0.007675584);
