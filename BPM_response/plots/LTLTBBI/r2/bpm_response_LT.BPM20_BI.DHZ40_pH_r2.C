...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_H_2->Range(-1050,-8.429432,1050,-7.79293);
   ...
   gre->SetPoint(0,-700,-8.21562);
   gre->SetPointError(0,0,0.1077286);
   gre->SetPoint(1,-500,-8.14238);
   gre->SetPointError(1,0,0.06206752);
   gre->SetPoint(2,-300,-7.93408);
   gre->SetPointError(2,0,0.0350662);
   gre->SetPoint(3,-100,-8.09192);
   gre->SetPointError(3,0,0.03473511);
   gre->SetPoint(4,100,-8.03202);
   gre->SetPointError(4,0,0.03128759);
   gre->SetPoint(5,300,-7.98664);
   gre->SetPointError(5,0,0.04195639);
   gre->SetPoint(6,500,-8.08032);
   gre->SetPointError(6,0,0.07670532);
   gre->SetPoint(7,700,-8.0242);
   gre->SetPointError(7,0,0.07476445);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-8.365782);
   Graph_Graph16->SetMaximum(-7.85658);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(18.08761);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.926662e-05);
   linear_fit->SetParError(0,5.131293e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-8.030618);
   linear_fit->SetParError(1,0.01596536);
