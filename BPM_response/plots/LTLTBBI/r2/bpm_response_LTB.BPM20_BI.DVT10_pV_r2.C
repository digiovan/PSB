...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,1.70626,1050,2.366716);
   ...
   gre->SetPoint(0,-700,2.13768);
   gre->SetPointError(0,0,0.0674227);
   gre->SetPoint(1,-500,1.89766);
   gre->SetPointError(1,0,0.08132352);
   gre->SetPoint(2,-300,2.11376);
   gre->SetPointError(2,0,0.03017461);
   gre->SetPoint(3,-100,2.13008);
   gre->SetPointError(3,0,0.1265605);
   gre->SetPoint(4,100,2.12862);
   gre->SetPointError(4,0,0.09393877);
   gre->SetPoint(5,300,2.18652);
   gre->SetPointError(5,0,0.0454742);
   gre->SetPoint(6,500,2.02742);
   gre->SetPointError(6,0,0.1695481);
   gre->SetPoint(7,700,1.9726);
   gre->SetPointError(7,0,0.06359722);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(1.772306);
   Graph_Graph21->SetMaximum(2.300671);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.5965);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.28605e-05);
   linear_fit->SetParError(0,5.001437e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.101217);
   linear_fit->SetParError(1,0.02086459);
