...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-1.644984,1050,-1.446854);
   ...
   gre->SetPoint(0,-700,-1.53176);
   gre->SetPointError(0,0,0.006811375);
   gre->SetPoint(1,-500,-1.5365);
   gre->SetPointError(1,0,0.007071035);
   gre->SetPoint(2,-300,-1.53552);
   gre->SetPointError(2,0,0.05564446);
   gre->SetPoint(3,-100,-1.5651);
   gre->SetPointError(3,0,0.01270702);
   gre->SetPoint(4,100,-1.58774);
   gre->SetPointError(4,0,0.01125038);
   gre->SetPoint(5,300,-1.56368);
   gre->SetPointError(5,0,0.04792699);
   gre->SetPoint(6,500,-1.5656);
   gre->SetPointError(6,0,0.0246469);
   gre->SetPoint(7,700,-1.59882);
   gre->SetPointError(7,0,0.01314206);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-1.625171);
   Graph_Graph19->SetMaximum(-1.466667);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.000054);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-5.149508e-05);
   linear_fit->SetParError(0,8.856403e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.566736);
   linear_fit->SetParError(1,0.004833926);
