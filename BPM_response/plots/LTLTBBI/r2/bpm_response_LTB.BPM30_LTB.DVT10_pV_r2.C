...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,-12.53997,1050,16.2838);
   ...
   gre->SetPoint(0,-700,-7.6989);
   gre->SetPointError(0,0,0.03711099);
   gre->SetPoint(1,-500,-4.74446);
   gre->SetPointError(1,0,0.04164427);
   gre->SetPoint(2,-300,-1.81336);
   gre->SetPointError(2,0,0.03996775);
   gre->SetPoint(3,-100,1.16352);
   gre->SetPointError(3,0,0.01959026);
   gre->SetPoint(4,100,3.6734);
   gre->SetPointError(4,0,0.04414817);
   gre->SetPoint(5,300,6.26636);
   gre->SetPointError(5,0,0.03638005);
   gre->SetPoint(6,500,9.0457);
   gre->SetPointError(6,0,0.04648133);
   gre->SetPoint(7,700,11.41454);
   gre->SetPointError(7,0,0.06530156);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-9.657596);
   Graph_Graph22->SetMaximum(13.40143);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(353.4602);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0137754);
   linear_fit->SetParError(0,3.458847e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.29598);
   linear_fit->SetParError(1,0.0127703);
