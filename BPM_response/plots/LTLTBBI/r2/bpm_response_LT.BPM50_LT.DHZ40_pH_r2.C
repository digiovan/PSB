...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_H_2->Range(-1050,-2.248393,1050,-0.3463688);
   ...
   gre->SetPoint(0,-700,-1.91542);
   gre->SetPointError(0,0,0.01596883);
   gre->SetPoint(1,-500,-1.59772);
   gre->SetPointError(1,0,0.02543236);
   gre->SetPoint(2,-300,-1.73968);
   gre->SetPointError(2,0,0.0404782);
   gre->SetPoint(3,-100,-1.41802);
   gre->SetPointError(3,0,0.0205998);
   gre->SetPoint(4,100,-1.2626);
   gre->SetPointError(4,0,0.03777042);
   gre->SetPoint(5,300,-1.33926);
   gre->SetPointError(5,0,0.009933488);
   gre->SetPoint(6,500,-0.7814);
   gre->SetPointError(6,0,0.1180271);
   gre->SetPoint(7,700,-1.10276);
   gre->SetPointError(7,0,0.03178308);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-2.05819);
   Graph_Graph19->SetMaximum(-0.5365713);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(121.6213);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0005381268);
   linear_fit->SetParError(0,1.620466e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.472481);
   linear_fit->SetParError(1,0.007013619);
