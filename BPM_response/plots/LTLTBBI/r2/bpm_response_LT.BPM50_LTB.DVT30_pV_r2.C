...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-0.5266663,1050,-0.4171162);
   ...
   gre->SetPoint(0,-700,-0.48604);
   gre->SetPointError(0,0,0.01328593);
   gre->SetPoint(1,-500,-0.45744);
   gre->SetPointError(1,0,0.009431302);
   gre->SetPoint(2,-300,-0.49866);
   gre->SetPointError(2,0,0.006798156);
   gre->SetPoint(3,-100,-0.46792);
   gre->SetPointError(3,0,0.03254546);
   gre->SetPoint(4,100,-0.46042);
   gre->SetPointError(4,0,0.01826256);
   gre->SetPoint(5,300,-0.45774);
   gre->SetPointError(5,0,0.01253621);
   gre->SetPoint(6,500,-0.49546);
   gre->SetPointError(6,0,0.01294798);
   gre->SetPoint(7,700,-0.4577);
   gre->SetPointError(7,0,0.006394223);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-0.5157113);
   Graph_Graph19->SetMaximum(-0.4280712);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.31364);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.721134e-05);
   linear_fit->SetParError(0,6.876738e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4752704);
   linear_fit->SetParError(1,0.00359139);
