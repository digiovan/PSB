...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,-19.07849,1050,21.90434);
   ...
   gre->SetPoint(0,-700,15.05232);
   gre->SetPointError(0,0,0.021552);
   gre->SetPoint(1,-500,11.7781);
   gre->SetPointError(1,0,0.128075);
   gre->SetPoint(2,-300,8.06332);
   gre->SetPointError(2,0,0.0507726);
   gre->SetPoint(3,-100,4.31578);
   gre->SetPointError(3,0,0.01132826);
   gre->SetPoint(4,100,0.35204);
   gre->SetPointError(4,0,0.01557344);
   gre->SetPoint(5,300,-3.94044);
   gre->SetPointError(5,0,0.02326267);
   gre->SetPoint(6,500,-7.96496);
   gre->SetPointError(6,0,0.1205669);
   gre->SetPoint(7,700,-12.03878);
   gre->SetPointError(7,0,0.2092385);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-14.98021);
   Graph_Graph22->SetMaximum(17.80606);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(1181.84);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01881898);
   linear_fit->SetParError(0,2.776612e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.222822);
   linear_fit->SetParError(1,0.008153084);
