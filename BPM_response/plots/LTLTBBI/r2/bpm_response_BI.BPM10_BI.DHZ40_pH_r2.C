...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-3.47982,1050,-2.600362);
   ...
   gre->SetPoint(0,-700,-2.94516);
   gre->SetPointError(0,0,0.1587874);
   gre->SetPoint(1,-500,-2.84508);
   gre->SetPointError(1,0,0.09814152);
   gre->SetPoint(2,-300,-3.23798);
   gre->SetPointError(2,0,0.09468011);
   gre->SetPoint(3,-100,-3.04568);
   gre->SetPointError(3,0,0.07148164);
   gre->SetPoint(4,100,-3.24828);
   gre->SetPointError(4,0,0.06430957);
   gre->SetPoint(5,300,-3.19596);
   gre->SetPointError(5,0,0.09210848);
   gre->SetPoint(6,500,-3.1561);
   gre->SetPointError(6,0,0.1220731);
   gre->SetPoint(7,700,-3.1969);
   gre->SetPointError(7,0,0.1363435);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-3.391874);
   Graph_Graph24->SetMaximum(-2.688308);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.45069);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002338025);
   linear_fit->SetParError(0,9.384639e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.130874);
   linear_fit->SetParError(1,0.03276879);
