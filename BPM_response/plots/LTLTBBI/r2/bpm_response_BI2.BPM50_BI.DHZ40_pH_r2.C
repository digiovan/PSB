...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-9.089494,1050,-2.283499);
   ...
   gre->SetPoint(0,-700,-6.97516);
   gre->SetPointError(0,0,0.9800014);
   gre->SetPoint(1,-500,-5.87302);
   gre->SetPointError(1,0,0.3566896);
   gre->SetPoint(2,-300,-5.9698);
   gre->SetPointError(2,0,0.7223159);
   gre->SetPoint(3,-100,-6.488);
   gre->SetPointError(3,0,0.2931365);
   gre->SetPoint(4,100,-5.89494);
   gre->SetPointError(4,0,0.2066135);
   gre->SetPoint(5,300,-4.41632);
   gre->SetPointError(5,0,0.9984885);
   gre->SetPoint(6,500,-5.3305);
   gre->SetPointError(6,0,1.317138);
   gre->SetPoint(7,700,-4.91376);
   gre->SetPointError(7,0,0.3744853);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-8.408894);
   Graph_Graph28->SetMaximum(-2.964099);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.394106);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001034844);
   linear_fit->SetParError(0,0.0003867932);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.909071);
   linear_fit->SetParError(1,0.1357755);
