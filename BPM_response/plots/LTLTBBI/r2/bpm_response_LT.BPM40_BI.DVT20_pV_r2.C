...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_2->Range(-1050,-7.581144,1050,-6.934072);
   ...
   gre->SetPoint(0,-700,-7.17744);
   gre->SetPointError(0,0,0.1076435);
   gre->SetPoint(1,-500,-7.20448);
   gre->SetPointError(1,0,0.07228786);
   gre->SetPoint(2,-300,-7.26132);
   gre->SetPointError(2,0,0.01650023);
   gre->SetPoint(3,-100,-7.3859);
   gre->SetPointError(3,0,0.01701302);
   gre->SetPoint(4,100,-7.25398);
   gre->SetPointError(4,0,0.09287262);
   gre->SetPoint(5,300,-7.38884);
   gre->SetPointError(5,0,0.04702507);
   gre->SetPoint(6,500,-7.16674);
   gre->SetPointError(6,0,0.1248229);
   gre->SetPoint(7,700,-7.36754);
   gre->SetPointError(7,0,0.1057586);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-7.516437);
   Graph_Graph18->SetMaximum(-6.998779);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(22.47853);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002051165);
   linear_fit->SetParError(0,5.514322e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.353825);
   linear_fit->SetParError(1,0.01443548);
