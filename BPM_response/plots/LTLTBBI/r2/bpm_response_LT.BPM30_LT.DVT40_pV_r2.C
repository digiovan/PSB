...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.84864,1050,-9.857045);
   ...
   gre->SetPoint(0,-700,-10.36426);
   gre->SetPointError(0,0,0.08637972);
   gre->SetPoint(1,-500,-10.53728);
   gre->SetPointError(1,0,0.1460927);
   gre->SetPoint(2,-300,-10.18554);
   gre->SetPointError(2,0,0.1632293);
   gre->SetPoint(3,-100,-10.37772);
   gre->SetPointError(3,0,0.09529107);
   gre->SetPoint(4,100,-10.30944);
   gre->SetPointError(4,0,0.0553408);
   gre->SetPoint(5,300,-10.2424);
   gre->SetPointError(5,0,0.1365532);
   gre->SetPoint(6,500,-10.32122);
   gre->SetPointError(6,0,0.06072257);
   gre->SetPoint(7,700,-10.28314);
   gre->SetPointError(7,0,0.07427205);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.74948);
   Graph_Graph17->SetMaximum(-9.956204);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(3.101028);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,6.773106e-05);
   linear_fit->SetParError(0,6.723876e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.333);
   linear_fit->SetParError(1,0.03098519);
