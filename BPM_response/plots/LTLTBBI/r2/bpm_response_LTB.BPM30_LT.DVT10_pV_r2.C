...
//=========  (Wed Apr  1 22:34:17 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,-5.137056,1050,8.423477);
   ...
   gre->SetPoint(0,-700,-2.80412);
   gre->SetPointError(0,0,0.07284712);
   gre->SetPoint(1,-500,-0.69854);
   gre->SetPointError(1,0,0.04238447);
   gre->SetPoint(2,-300,0.45734);
   gre->SetPointError(2,0,0.01918208);
   gre->SetPoint(3,-100,1.62894);
   gre->SetPointError(3,0,0.04387408);
   gre->SetPoint(4,100,2.94304);
   gre->SetPointError(4,0,0.0739287);
   gre->SetPoint(5,300,4.3139);
   gre->SetPointError(5,0,0.06389115);
   gre->SetPoint(6,500,5.4946);
   gre->SetPointError(6,0,0.1784004);
   gre->SetPoint(7,700,6.14984);
   gre->SetPointError(7,0,0.0135481);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-3.781003);
   Graph_Graph22->SetMaximum(7.067424);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(233.0361);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.005765698);
   linear_fit->SetParError(0,2.009707e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.143847);
   linear_fit->SetParError(1,0.01140064);
