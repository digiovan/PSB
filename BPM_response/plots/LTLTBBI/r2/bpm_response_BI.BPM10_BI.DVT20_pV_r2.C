...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,4.19037,1050,5.017124);
   ...
   gre->SetPoint(0,-700,4.76406);
   gre->SetPointError(0,0,0.08374703);
   gre->SetPoint(1,-500,4.56122);
   gre->SetPointError(1,0,0.03983612);
   gre->SetPoint(2,-300,4.599);
   gre->SetPointError(2,0,0.02760459);
   gre->SetPoint(3,-100,4.42718);
   gre->SetPointError(3,0,0.09901752);
   gre->SetPoint(4,100,4.53078);
   gre->SetPointError(4,0,0.1491397);
   gre->SetPoint(5,300,4.45982);
   gre->SetPointError(5,0,0.05911546);
   gre->SetPoint(6,500,4.68632);
   gre->SetPointError(6,0,0.1930116);
   gre->SetPoint(7,700,4.46722);
   gre->SetPointError(7,0,0.1208945);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(4.273046);
   Graph_Graph24->SetMaximum(4.934449);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.437576);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.000154147);
   linear_fit->SetParError(0,6.41926e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,4.533875);
   linear_fit->SetParError(1,0.02551764);
