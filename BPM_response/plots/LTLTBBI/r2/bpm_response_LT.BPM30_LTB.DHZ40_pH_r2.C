...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-10.0319,1050,-9.676399);
   ...
   gre->SetPoint(0,-700,-9.91162);
   gre->SetPointError(0,0,0.0205083);
   gre->SetPoint(1,-500,-9.8411);
   gre->SetPointError(1,0,0.08114864);
   gre->SetPoint(2,-300,-9.89366);
   gre->SetPointError(2,0,0.0206148);
   gre->SetPoint(3,-100,-9.78994);
   gre->SetPointError(3,0,0.05429114);
   gre->SetPoint(4,100,-9.90914);
   gre->SetPointError(4,0,0.06183998);
   gre->SetPoint(5,300,-9.8701);
   gre->SetPointError(5,0,0.06958345);
   gre->SetPoint(6,500,-9.91424);
   gre->SetPointError(6,0,0.05033212);
   gre->SetPoint(7,700,-9.89886);
   gre->SetPointError(7,0,0.07378984);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-9.99635);
   Graph_Graph17->SetMaximum(-9.711949);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.901001);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.704017e-05);
   linear_fit->SetParError(0,3.249482e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.889287);
   linear_fit->SetParError(1,0.01656051);
