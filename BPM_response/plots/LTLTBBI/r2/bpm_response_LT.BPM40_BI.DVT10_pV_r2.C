...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_2->Range(-1050,-7.648028,1050,-6.969952);
   ...
   gre->SetPoint(0,-700,-7.36908);
   gre->SetPointError(0,0,0.05711815);
   gre->SetPoint(1,-500,-7.16764);
   gre->SetPointError(1,0,0.08467554);
   gre->SetPoint(2,-300,-7.37872);
   gre->SetPointError(2,0,0.04433553);
   gre->SetPoint(3,-100,-7.34922);
   gre->SetPointError(3,0,0.05739202);
   gre->SetPoint(4,100,-7.4129);
   gre->SetPointError(4,0,0.04319561);
   gre->SetPoint(5,300,-7.4888);
   gre->SetPointError(5,0,0.04621528);
   gre->SetPoint(6,500,-7.2832);
   gre->SetPointError(6,0,0.1996009);
   gre->SetPoint(7,700,-7.21826);
   gre->SetPointError(7,0,0.06269222);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-7.58022);
   Graph_Graph18->SetMaximum(-7.037759);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.44671);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.151618e-05);
   linear_fit->SetParError(0,4.940789e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-7.373305);
   linear_fit->SetParError(1,0.01989892);
