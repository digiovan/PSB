...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_V_2->Range(-1050,1.830171,1050,2.327065);
   ...
   gre->SetPoint(0,-700,1.97972);
   gre->SetPointError(0,0,0.06399165);
   gre->SetPoint(1,-500,2.1364);
   gre->SetPointError(1,0,0.1078497);
   gre->SetPoint(2,-300,2.0169);
   gre->SetPointError(2,0,0.06202454);
   gre->SetPoint(3,-100,2.14316);
   gre->SetPointError(3,0,0.04195325);
   gre->SetPoint(4,100,2.01242);
   gre->SetPointError(4,0,0.09943314);
   gre->SetPoint(5,300,2.17714);
   gre->SetPointError(5,0,0.03484285);
   gre->SetPoint(6,500,1.98332);
   gre->SetPointError(6,0,0.05616184);
   gre->SetPoint(7,700,2.06562);
   gre->SetPointError(7,0,0.06908367);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(1.879861);
   Graph_Graph21->SetMaximum(2.277376);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.82392);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.566319e-05);
   linear_fit->SetParError(0,4.939807e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.091342);
   linear_fit->SetParError(1,0.01998868);
