...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-1.446722,1050,0.6992672);
   ...
   gre->SetPoint(0,-700,0.33668);
   gre->SetPointError(0,0,0.004922283);
   gre->SetPoint(1,-500,0.05728);
   gre->SetPointError(1,0,0.01085684);
   gre->SetPoint(2,-300,-0.13888);
   gre->SetPointError(2,0,0.006357541);
   gre->SetPoint(3,-100,-0.26698);
   gre->SetPointError(3,0,0.009021251);
   gre->SetPoint(4,100,-0.46072);
   gre->SetPointError(4,0,0.01358895);
   gre->SetPoint(5,300,-0.72966);
   gre->SetPointError(5,0,0.005411253);
   gre->SetPoint(6,500,-0.97456);
   gre->SetPointError(6,0,0.009562476);
   gre->SetPoint(7,700,-1.0861);
   gre->SetPointError(7,0,0.002957277);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-1.232123);
   Graph_Graph18->SetMaximum(0.4846682);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(240.3405);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001004433);
   linear_fit->SetParError(0,3.65695e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3967781);
   linear_fit->SetParError(1,0.002145145);
