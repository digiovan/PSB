...
//=========  (Wed Apr  1 22:35:20 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_V_2->Range(-1050,-17.90434,1050,7.729591);
   ...
   gre->SetPoint(0,-700,3.28306);
   gre->SetPointError(0,0,0.1742093);
   gre->SetPoint(1,-500,0.48438);
   gre->SetPointError(1,0,0.1769433);
   gre->SetPoint(2,-300,-2.50356);
   gre->SetPointError(2,0,0.03004197);
   gre->SetPoint(3,-100,-4.75346);
   gre->SetPointError(3,0,0.2272356);
   gre->SetPoint(4,100,-7.44134);
   gre->SetPointError(4,0,0.4015219);
   gre->SetPoint(5,300,-9.38938);
   gre->SetPointError(5,0,0.3345373);
   gre->SetPoint(6,500,-11.09892);
   gre->SetPointError(6,0,0.1309963);
   gre->SetPoint(7,700,-13.43728);
   gre->SetPointError(7,0,0.1947376);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-15.34095);
   Graph_Graph27->SetMaximum(5.166198);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(78.62437);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01126415);
   linear_fit->SetParError(0,0.0001179207);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.809373);
   linear_fit->SetParError(1,0.04049904);
