...
//=========  (Wed Apr  1 22:36:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.51792,1050,-9.574023);
   ...
   gre->SetPoint(0,-700,-9.88788);
   gre->SetPointError(0,0,0.1565409);
   gre->SetPoint(1,-500,-10.2849);
   gre->SetPointError(1,0,0.02223557);
   gre->SetPoint(2,-300,-10.23288);
   gre->SetPointError(2,0,0.03893695);
   gre->SetPoint(3,-100,-10.27094);
   gre->SetPointError(3,0,0.0648125);
   gre->SetPoint(4,100,-10.2959);
   gre->SetPointError(4,0,0.0647034);
   gre->SetPoint(5,300,-10.25666);
   gre->SetPointError(5,0,0.05318588);
   gre->SetPoint(6,500,-10.29472);
   gre->SetPointError(6,0,0.05528918);
   gre->SetPoint(7,700,-10.12564);
   gre->SetPointError(7,0,0.08150084);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: BI.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.42353);
   Graph_Graph17->SetMaximum(-9.668413);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("BI.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.45151);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.275143e-05);
   linear_fit->SetParError(0,4.108124e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.2597);
   linear_fit->SetParError(1,0.01803773);
