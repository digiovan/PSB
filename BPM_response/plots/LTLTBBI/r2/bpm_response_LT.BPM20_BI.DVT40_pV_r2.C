...
//=========  (Wed Apr  1 22:36:22 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-6.542967,1050,-5.947708);
   ...
   gre->SetPoint(0,-700,-6.23588);
   gre->SetPointError(0,0,0.02647938);
   gre->SetPoint(1,-500,-6.3659);
   gre->SetPointError(1,0,0.0366451);
   gre->SetPoint(2,-300,-6.12826);
   gre->SetPointError(2,0,0.06179323);
   gre->SetPoint(3,-100,-6.3705);
   gre->SetPointError(3,0,0.02201215);
   gre->SetPoint(4,100,-6.35518);
   gre->SetPointError(4,0,0.08857757);
   gre->SetPoint(5,300,-6.09946);
   gre->SetPointError(5,0,0.04734134);
   gre->SetPoint(6,500,-6.15606);
   gre->SetPointError(6,0,0.1091418);
   gre->SetPoint(7,700,-6.27918);
   gre->SetPointError(7,0,0.02957997);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-6.483442);
   Graph_Graph16->SetMaximum(-6.007234);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(46.88123);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.133888e-05);
   linear_fit->SetParError(0,2.598499e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.289243);
   linear_fit->SetParError(1,0.01289883);
