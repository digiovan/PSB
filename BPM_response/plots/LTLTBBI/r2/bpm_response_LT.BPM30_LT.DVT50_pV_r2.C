...
//=========  (Wed Apr  1 22:34:58 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.77353,1050,-9.963147);
   ...
   gre->SetPoint(0,-700,-10.125);
   gre->SetPointError(0,0,0.02678954);
   gre->SetPoint(1,-500,-10.25802);
   gre->SetPointError(1,0,0.1524965);
   gre->SetPoint(2,-300,-10.34256);
   gre->SetPointError(2,0,0.09873443);
   gre->SetPoint(3,-100,-10.33922);
   gre->SetPointError(3,0,0.06250522);
   gre->SetPoint(4,100,-10.24106);
   gre->SetPointError(4,0,0.05981219);
   gre->SetPoint(5,300,-10.4487);
   gre->SetPointError(5,0,0.04967839);
   gre->SetPoint(6,500,-10.3158);
   gre->SetPointError(6,0,0.03884949);
   gre->SetPoint(7,700,-10.51754);
   gre->SetPointError(7,0,0.120926);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DVT50 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.69249);
   Graph_Graph17->SetMaximum(-10.04418);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.83493);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002038055);
   linear_fit->SetParError(0,3.413939e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.2828);
   linear_fit->SetParError(1,0.018509);
