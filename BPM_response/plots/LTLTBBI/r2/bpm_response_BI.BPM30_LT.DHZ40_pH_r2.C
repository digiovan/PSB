...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,3.912177,1050,10.01618);
   ...
   gre->SetPoint(0,-700,8.8756);
   gre->SetPointError(0,0,0.07656956);
   gre->SetPoint(1,-500,8.9711);
   gre->SetPointError(1,0,0.02774503);
   gre->SetPoint(2,-300,8.3077);
   gre->SetPointError(2,0,0.02852773);
   gre->SetPoint(3,-100,8.27692);
   gre->SetPointError(3,0,0.04237648);
   gre->SetPoint(4,100,7.94502);
   gre->SetPointError(4,0,0.01351017);
   gre->SetPoint(5,300,7.35194);
   gre->SetPointError(5,0,0.02393247);
   gre->SetPoint(6,500,5.6938);
   gre->SetPointError(6,0,0.7642896);
   gre->SetPoint(7,700,6.67492);
   gre->SetPointError(7,0,0.03955433);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(4.522577);
   Graph_Graph26->SetMaximum(9.405778);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(207.0786);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001747836);
   linear_fit->SetParError(0,3.100212e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.020734);
   linear_fit->SetParError(1,0.00952635);
