...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-6.592544,1050,-6.124282);
   ...
   gre->SetPoint(0,-700,-6.39208);
   gre->SetPointError(0,0,0.05297846);
   gre->SetPoint(1,-500,-6.39762);
   gre->SetPointError(1,0,0.1168807);
   gre->SetPoint(2,-300,-6.3432);
   gre->SetPointError(2,0,0.01664665);
   gre->SetPoint(3,-100,-6.32586);
   gre->SetPointError(3,0,0.03689379);
   gre->SetPoint(4,100,-6.41518);
   gre->SetPointError(4,0,0.07777402);
   gre->SetPoint(5,300,-6.22954);
   gre->SetPointError(5,0,0.02721455);
   gre->SetPoint(6,500,-6.3598);
   gre->SetPointError(6,0,0.05989323);
   gre->SetPoint(7,700,-6.39152);
   gre->SetPointError(7,0,0.03562824);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-6.545718);
   Graph_Graph16->SetMaximum(-6.171108);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.40762);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.015435e-05);
   linear_fit->SetParError(0,3.030143e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.329583);
   linear_fit->SetParError(1,0.01173917);
