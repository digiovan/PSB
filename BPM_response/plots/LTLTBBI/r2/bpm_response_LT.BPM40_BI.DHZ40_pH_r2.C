...
//=========  (Wed Apr  1 22:36:17 2015) by ROOT version5.34/21
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Corr: BI.DHZ40 Plane: H Ring: 2");
   gre->SetFillColor(1);
   ...
   gre->SetPoint(0,-700,-0.3188);
   gre->SetPointError(0,0,0.005324415);
   gre->SetPoint(1,-500,-0.35);
   gre->SetPointError(1,0,0.006885891);
   gre->SetPoint(2,-300,-0.34664);
   gre->SetPointError(2,0,0.009315086);
   gre->SetPoint(3,-100,-0.3378);
   gre->SetPointError(3,0,0.006803619);
   gre->SetPoint(4,100,-0.34634);
   gre->SetPointError(4,0,0.004301382);
   gre->SetPoint(5,300,-0.34308);
   gre->SetPointError(5,0,0.00528768);
   gre->SetPoint(6,500,-0.3344);
   gre->SetPointError(6,0,0.007938157);
   gre->SetPoint(7,700,-0.33056);
   gre->SetPointError(7,0,0.007849611);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.3612269);
   Graph_Graph18->SetMaximum(-0.3091346);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.20531);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.822687e-06);
   linear_fit->SetParError(0,5.04112e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3387951);
   linear_fit->SetParError(1,0.002178756);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *text = pt->AddText("Corr: BI.DHZ40 Plane: H Ring: 2");
   pt->Draw();
