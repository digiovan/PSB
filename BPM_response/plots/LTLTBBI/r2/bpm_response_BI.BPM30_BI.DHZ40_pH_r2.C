...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,-2.841993,1050,-2.527358);
   ...
   gre->SetPoint(0,-700,-2.76532);
   gre->SetPointError(0,0,0.02423394);
   gre->SetPoint(1,-500,-2.682);
   gre->SetPointError(1,0,0.02811096);
   gre->SetPoint(2,-300,-2.62444);
   gre->SetPointError(2,0,0.013722);
   gre->SetPoint(3,-100,-2.61286);
   gre->SetPointError(3,0,0.03306296);
   gre->SetPoint(4,100,-2.63958);
   gre->SetPointError(4,0,0.04820362);
   gre->SetPoint(5,300,-2.6496);
   gre->SetPointError(5,0,0.01155495);
   gre->SetPoint(6,500,-2.69982);
   gre->SetPointError(6,0,0.0347211);
   gre->SetPoint(7,700,-2.7512);
   gre->SetPointError(7,0,0.004841787);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-2.81053);
   Graph_Graph26->SetMaximum(-2.558821);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(76.58166);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-8.524478e-05);
   linear_fit->SetParError(0,1.026257e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.682031);
   linear_fit->SetParError(1,0.00638062);
