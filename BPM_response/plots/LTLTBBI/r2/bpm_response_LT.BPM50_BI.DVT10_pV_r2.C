...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-0.4951555,1050,-0.3612748);
   ...
   gre->SetPoint(0,-700,-0.42464);
   gre->SetPointError(0,0,0.04105175);
   gre->SetPoint(1,-500,-0.4286);
   gre->SetPointError(1,0,0.00424327);
   gre->SetPoint(2,-300,-0.43188);
   gre->SetPointError(2,0,0.01295947);
   gre->SetPoint(3,-100,-0.45114);
   gre->SetPointError(3,0,0.02170203);
   gre->SetPoint(4,100,-0.44516);
   gre->SetPointError(4,0,0.01341567);
   gre->SetPoint(5,300,-0.44296);
   gre->SetPointError(5,0,0.006450282);
   gre->SetPoint(6,500,-0.44414);
   gre->SetPointError(6,0,0.02507089);
   gre->SetPoint(7,700,-0.4563);
   gre->SetPointError(7,0,0.01249896);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-0.4817674);
   Graph_Graph19->SetMaximum(-0.3746629);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(0.7404455);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.038778e-05);
   linear_fit->SetParError(0,7.537963e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.4389513);
   linear_fit->SetParError(1,0.003381578);
