...
//=========  (Wed Apr  1 22:34:16 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_V_2->Range(-1050,-13.02529,1050,0.2389486);
   ...
   gre->SetPoint(0,-700,-2.04822);
   gre->SetPointError(0,0,0.07646204);
   gre->SetPoint(1,-500,-4.0313);
   gre->SetPointError(1,0,0.0176367);
   gre->SetPoint(2,-300,-5.17178);
   gre->SetPointError(2,0,0.02361783);
   gre->SetPoint(3,-100,-6.1665);
   gre->SetPointError(3,0,0.07610187);
   gre->SetPoint(4,100,-7.56108);
   gre->SetPointError(4,0,0.09779157);
   gre->SetPoint(5,300,-8.84514);
   gre->SetPointError(5,0,0.03368823);
   gre->SetPoint(6,500,-10.12578);
   gre->SetPointError(6,0,0.1496484);
   gre->SetPoint(7,700,-10.78244);
   gre->SetPointError(7,0,0.03214401);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: LT.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-11.69887);
   Graph_Graph18->SetMaximum(-1.087475);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("LT.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(187.4578);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005786549);
   linear_fit->SetParError(0,2.688315e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.896484);
   linear_fit->SetParError(1,0.0126072);
