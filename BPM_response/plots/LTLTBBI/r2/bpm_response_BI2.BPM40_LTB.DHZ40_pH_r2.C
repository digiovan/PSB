...
//=========  (Wed Apr  1 22:35:35 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-12.68276,1050,9.57605);
   ...
   gre->SetPoint(0,-700,5.70254);
   gre->SetPointError(0,0,0.1637079);
   gre->SetPoint(1,-500,1.75932);
   gre->SetPointError(1,0,0.6690308);
   gre->SetPoint(2,-300,2.1382);
   gre->SetPointError(2,0,1.128942);
   gre->SetPoint(3,-100,0.76064);
   gre->SetPointError(3,0,1.176994);
   gre->SetPoint(4,100,0.7959);
   gre->SetPointError(4,0,0.6911944);
   gre->SetPoint(5,300,-1.5868);
   gre->SetPointError(5,0,1.745455);
   gre->SetPoint(6,500,-4.19502);
   gre->SetPointError(6,0,0.8085124);
   gre->SetPoint(7,700,-7.72064);
   gre->SetPointError(7,0,1.252322);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LTB.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-10.45688);
   Graph_Graph27->SetMaximum(7.350169);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LTB.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(20.083);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.008100016);
   linear_fit->SetParError(0,0.0004551989);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.04512786);
   linear_fit->SetParError(1,0.2987893);
