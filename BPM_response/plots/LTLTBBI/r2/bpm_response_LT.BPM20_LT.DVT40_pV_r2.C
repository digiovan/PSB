...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-6.611426,1050,-6.101824);
   ...
   gre->SetPoint(0,-700,-6.36848);
   gre->SetPointError(0,0,0.04862577);
   gre->SetPoint(1,-500,-6.4524);
   gre->SetPointError(1,0,0.07409191);
   gre->SetPoint(2,-300,-6.27774);
   gre->SetPointError(2,0,0.09098267);
   gre->SetPoint(3,-100,-6.36928);
   gre->SetPointError(3,0,0.03982174);
   gre->SetPoint(4,100,-6.3513);
   gre->SetPointError(4,0,0.02963696);
   gre->SetPoint(5,300,-6.30068);
   gre->SetPointError(5,0,0.0665417);
   gre->SetPoint(6,500,-6.33932);
   gre->SetPointError(6,0,0.0333471);
   gre->SetPoint(7,700,-6.32964);
   gre->SetPointError(7,0,0.02609447);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-6.560465);
   Graph_Graph16->SetMaximum(-6.152784);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.638883);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.882056e-05);
   linear_fit->SetParError(0,3.20127e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.355161);
   linear_fit->SetParError(1,0.01584141);
