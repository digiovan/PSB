...
//=========  (Wed Apr  1 22:35:03 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.866871,1050,2.093717);
   ...
   gre->SetPoint(0,-700,1.96604);
   gre->SetPointError(0,0,0.01332089);
   gre->SetPoint(1,-500,1.95496);
   gre->SetPointError(1,0,0.02442832);
   gre->SetPoint(2,-300,1.96604);
   gre->SetPointError(2,0,0.02261962);
   gre->SetPoint(3,-100,1.97062);
   gre->SetPointError(3,0,0.006221337);
   gre->SetPoint(4,100,1.9675);
   gre->SetPointError(4,0,0.01419238);
   gre->SetPoint(5,300,2.00798);
   gre->SetPointError(5,0,0.02069075);
   gre->SetPoint(6,500,2.02884);
   gre->SetPointError(6,0,0.02706934);
   gre->SetPoint(7,700,1.9387);
   gre->SetPointError(7,0,0.0340215);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.889555);
   Graph_Graph15->SetMaximum(2.071032);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(7.407256);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.182019e-05);
   linear_fit->SetParError(0,1.587301e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.974697);
   linear_fit->SetParError(1,0.005117424);
