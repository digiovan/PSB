...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,3.316478,1050,4.341755);
   ...
   gre->SetPoint(0,-700,4.01342);
   gre->SetPointError(0,0,0.1574551);
   gre->SetPoint(1,-500,3.92506);
   gre->SetPointError(1,0,0.05004992);
   gre->SetPoint(2,-300,3.78308);
   gre->SetPointError(2,0,0.1956843);
   gre->SetPoint(3,-100,3.803);
   gre->SetPointError(3,0,0.1075839);
   gre->SetPoint(4,100,3.64196);
   gre->SetPointError(4,0,0.0701018);
   gre->SetPoint(5,300,4.02548);
   gre->SetPointError(5,0,0.08245112);
   gre->SetPoint(6,500,3.5919);
   gre->SetPointError(6,0,0.1045425);
   gre->SetPoint(7,700,4.04896);
   gre->SetPointError(7,0,0.03198484);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(3.419006);
   Graph_Graph21->SetMaximum(4.239227);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(37.58035);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0001182731);
   linear_fit->SetParError(0,4.534313e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.910875);
   linear_fit->SetParError(1,0.02583178);
