...
//=========  (Wed Apr  1 22:35:30 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_V_2->Range(-1050,-8.39732,1050,-0.4620406);
   ...
   gre->SetPoint(0,-700,-5.63268);
   gre->SetPointError(0,0,0.2129297);
   gre->SetPoint(1,-500,-6.03562);
   gre->SetPointError(1,0,0.3494618);
   gre->SetPoint(2,-300,-6.30098);
   gre->SetPointError(2,0,0.1623903);
   gre->SetPoint(3,-100,-6.76614);
   gre->SetPointError(3,0,0.3086334);
   gre->SetPoint(4,100,-6.373);
   gre->SetPointError(4,0,0.124231);
   gre->SetPoint(5,300,-5.09758);
   gre->SetPointError(5,0,0.3468908);
   gre->SetPoint(6,500,-3.48044);
   gre->SetPointError(6,0,0.3210672);
   gre->SetPoint(7,700,-1.97182);
   gre->SetPointError(7,0,0.1872328);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LTB.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-7.603792);
   Graph_Graph27->SetMaximum(-1.255569);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LTB.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(250.1213);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002638717);
   linear_fit->SetParError(0,0.0001711129);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.441037);
   linear_fit->SetParError(1,0.07256729);
