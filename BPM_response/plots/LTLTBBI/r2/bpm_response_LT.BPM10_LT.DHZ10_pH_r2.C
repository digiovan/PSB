...
//=========  (Wed Apr  1 22:34:11 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.048811,1050,3.014442);
   ...
   gre->SetPoint(0,-700,1.3887);
   gre->SetPointError(0,0,0.01228382);
   gre->SetPoint(1,-500,1.58214);
   gre->SetPointError(1,0,0.02285693);
   gre->SetPoint(2,-300,1.82056);
   gre->SetPointError(2,0,0.03359454);
   gre->SetPoint(3,-100,1.91394);
   gre->SetPointError(3,0,0.02869923);
   gre->SetPoint(4,100,2.10388);
   gre->SetPointError(4,0,0.01162885);
   gre->SetPoint(5,300,2.36984);
   gre->SetPointError(5,0,0.007221794);
   gre->SetPoint(6,500,2.56526);
   gre->SetPointError(6,0,0.01329279);
   gre->SetPoint(7,700,2.67996);
   gre->SetPointError(7,0,0.006876941);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.245374);
   Graph_Graph15->SetMaximum(2.817879);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(71.10838);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0009306668);
   linear_fit->SetParError(0,9.03391e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.053735);
   linear_fit->SetParError(1,0.004708981);
