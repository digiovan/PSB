...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_H_2->Range(-1050,0.7124093,1050,0.8467879);
   ...
   gre->SetPoint(0,-700,0.75394);
   gre->SetPointError(0,0,0.00572562);
   gre->SetPoint(1,-500,0.7653);
   gre->SetPointError(1,0,0.009161089);
   gre->SetPoint(2,-300,0.75986);
   gre->SetPointError(2,0,0.02505429);
   gre->SetPoint(3,-100,0.75594);
   gre->SetPointError(3,0,0.009233762);
   gre->SetPoint(4,100,0.78262);
   gre->SetPointError(4,0,0.03145143);
   gre->SetPoint(5,300,0.7945);
   gre->SetPointError(5,0,0.01590351);
   gre->SetPoint(6,500,0.77524);
   gre->SetPointError(6,0,0.0214657);
   gre->SetPoint(7,700,0.80726);
   gre->SetPointError(7,0,0.01713148);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(0.7258471);
   Graph_Graph22->SetMaximum(0.8333501);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.654737);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.869651e-05);
   linear_fit->SetParError(0,9.156853e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7732522);
   linear_fit->SetParError(1,0.005125138);
