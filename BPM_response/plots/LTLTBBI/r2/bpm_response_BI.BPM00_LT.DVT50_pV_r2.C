...
//=========  (Wed Apr  1 22:34:59 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-9.701405,1050,8.420243);
   ...
   gre->SetPoint(0,-700,5.36816);
   gre->SetPointError(0,0,0.0318079);
   gre->SetPoint(1,-500,3.5697);
   gre->SetPointError(1,0,0.01630165);
   gre->SetPoint(2,-300,1.79794);
   gre->SetPointError(2,0,0.03024813);
   gre->SetPoint(3,-100,0.06564);
   gre->SetPointError(3,0,0.01900457);
   gre->SetPoint(4,100,-1.51452);
   gre->SetPointError(4,0,0.02246501);
   gre->SetPoint(5,300,-3.16756);
   gre->SetPointError(5,0,0.01573464);
   gre->SetPoint(6,500,-4.77592);
   gre->SetPointError(6,0,0.02195274);
   gre->SetPoint(7,700,-6.65638);
   gre->SetPointError(7,0,0.02475065);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DVT50 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-7.88924);
   Graph_Graph23->SetMaximum(6.608078);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DVT50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(96.66303);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0084423);
   linear_fit->SetParError(0,1.755781e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.6656088);
   linear_fit->SetParError(1,0.007394442);
