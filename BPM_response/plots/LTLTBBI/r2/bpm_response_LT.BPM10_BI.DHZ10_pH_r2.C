...
//=========  (Wed Apr  1 22:35:45 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.912517,1050,2.167506);
   ...
   gre->SetPoint(0,-700,2.0197);
   gre->SetPointError(0,0,0.01328505);
   gre->SetPoint(1,-500,1.99892);
   gre->SetPointError(1,0,0.0154129);
   gre->SetPoint(2,-300,2.05206);
   gre->SetPointError(2,0,0.04143642);
   gre->SetPoint(3,-100,2.03444);
   gre->SetPointError(3,0,0.02261838);
   gre->SetPoint(4,100,1.9847);
   gre->SetPointError(4,0,0.02968514);
   gre->SetPoint(5,300,2.01344);
   gre->SetPointError(5,0,0.03953365);
   gre->SetPoint(6,500,2.02546);
   gre->SetPointError(6,0,0.01874757);
   gre->SetPoint(7,700,2.10716);
   gre->SetPointError(7,0,0.01784769);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: BI.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.938016);
   Graph_Graph15->SetMaximum(2.142007);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("BI.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(15.12041);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,4.339791e-05);
   linear_fit->SetParError(0,1.301289e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.035395);
   linear_fit->SetParError(1,0.007225502);
