...
//=========  (Wed Apr  1 22:35:51 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-4.605306,1050,0.3007261);
   ...
   gre->SetPoint(0,-700,-0.5495);
   gre->SetPointError(0,0,0.03255407);
   gre->SetPoint(1,-500,-1.1224);
   gre->SetPointError(1,0,0.05964024);
   gre->SetPoint(2,-300,-1.35048);
   gre->SetPointError(2,0,0.05414451);
   gre->SetPoint(3,-100,-1.8708);
   gre->SetPointError(3,0,0.06671506);
   gre->SetPoint(4,100,-2.2985);
   gre->SetPointError(4,0,0.02569094);
   gre->SetPoint(5,300,-2.64076);
   gre->SetPointError(5,0,0.0109945);
   gre->SetPoint(6,500,-3.2424);
   gre->SetPointError(6,0,0.1328266);
   gre->SetPoint(7,700,-3.74888);
   gre->SetPointError(7,0,0.03875387);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-4.114703);
   Graph_Graph25->SetMaximum(-0.1898771);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(54.92885);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.002138899);
   linear_fit->SetParError(0,2.804313e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.033527);
   linear_fit->SetParError(1,0.01031954);
