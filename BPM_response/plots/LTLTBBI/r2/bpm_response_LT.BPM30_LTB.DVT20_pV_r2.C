...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.6346,1050,-10.06915);
   ...
   gre->SetPoint(0,-700,-10.30174);
   gre->SetPointError(0,0,0.07376392);
   gre->SetPoint(1,-500,-10.2864);
   gre->SetPointError(1,0,0.1146464);
   gre->SetPoint(2,-300,-10.23062);
   gre->SetPointError(2,0,0.06723214);
   gre->SetPoint(3,-100,-10.27984);
   gre->SetPointError(3,0,0.07718955);
   gre->SetPoint(4,100,-10.26412);
   gre->SetPointError(4,0,0.02469215);
   gre->SetPoint(5,300,-10.36992);
   gre->SetPointError(5,0,0.101435);
   gre->SetPoint(6,500,-10.23788);
   gre->SetPointError(6,0,0.05444504);
   gre->SetPoint(7,700,-10.36658);
   gre->SetPointError(7,0,0.1737792);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.57806);
   Graph_Graph17->SetMaximum(-10.12569);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.1893);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.248757e-05);
   linear_fit->SetParError(0,6.327748e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.26787);
   linear_fit->SetParError(1,0.01929706);
