...
//=========  (Wed Apr  1 22:35:50 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_V_2->Range(-1050,-10.58238,1050,-9.915744);
   ...
   gre->SetPoint(0,-700,-10.33502);
   gre->SetPointError(0,0,0.08707888);
   gre->SetPoint(1,-500,-10.1032);
   gre->SetPointError(1,0,0.07634944);
   gre->SetPoint(2,-300,-10.36064);
   gre->SetPointError(2,0,0.1106349);
   gre->SetPoint(3,-100,-10.2545);
   gre->SetPointError(3,0,0.1798193);
   gre->SetPoint(4,100,-10.3215);
   gre->SetPointError(4,0,0.09975778);
   gre->SetPoint(5,300,-10.46042);
   gre->SetPointError(5,0,0.007888638);
   gre->SetPoint(6,500,-10.2519);
   gre->SetPointError(6,0,0.1737075);
   gre->SetPoint(7,700,-10.10938);
   gre->SetPointError(7,0,0.03615769);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: BI.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.51572);
   Graph_Graph17->SetMaximum(-9.982408);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("BI.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(112.5098);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.379813e-05);
   linear_fit->SetParError(0,4.977195e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-10.46342);
   linear_fit->SetParError(1,0.01665046);
