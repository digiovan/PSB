...
//=========  (Wed Apr  1 22:34:37 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM20_V_2->Range(-1050,-6.639412,1050,-5.963872);
   ...
   gre->SetPoint(0,-700,-6.31534);
   gre->SetPointError(0,0,0.02926489);
   gre->SetPoint(1,-500,-6.31838);
   gre->SetPointError(1,0,0.02281509);
   gre->SetPoint(2,-300,-6.28228);
   gre->SetPointError(2,0,0.0383188);
   gre->SetPoint(3,-100,-6.3976);
   gre->SetPointError(3,0,0.0517219);
   gre->SetPoint(4,100,-6.3231);
   gre->SetPointError(4,0,0.05354225);
   gre->SetPoint(5,300,-6.20054);
   gre->SetPointError(5,0,0.1240778);
   gre->SetPoint(6,500,-6.34776);
   gre->SetPointError(6,0,0.07705817);
   gre->SetPoint(7,700,-6.37402);
   gre->SetPointError(7,0,0.1528022);
   
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph16->SetMinimum(-6.571858);
   Graph_Graph16->SetMaximum(-6.031426);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph16->SetLineColor(ci);
   Graph_Graph16->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(4.218344);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-2.120865e-05);
   linear_fit->SetParError(0,4.606035e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.3272);
   linear_fit->SetParError(1,0.02300813);
