...
//=========  (Wed Apr  1 22:34:53 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_H_2->Range(-1050,-11.00449,1050,4.061274);
   ...
   gre->SetPoint(0,-700,1.46076);
   gre->SetPointError(0,0,0.08955246);
   gre->SetPoint(1,-500,0.69974);
   gre->SetPointError(1,0,0.1189038);
   gre->SetPoint(2,-300,-1.22214);
   gre->SetPointError(2,0,0.1394101);
   gre->SetPoint(3,-100,-2.00288);
   gre->SetPointError(3,0,0.1941757);
   gre->SetPoint(4,100,-3.6889);
   gre->SetPointError(4,0,0.3270131);
   gre->SetPoint(5,300,-5.63184);
   gre->SetPointError(5,0,0.05392296);
   gre->SetPoint(6,500,-6.09316);
   gre->SetPointError(6,0,0.1607832);
   gre->SetPoint(7,700,-8.43312);
   gre->SetPointError(7,0,0.06041242);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LT.DHZ50 Plane: H Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-9.497917);
   Graph_Graph24->SetMaximum(2.554697);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(66.70817);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007205293);
   linear_fit->SetParError(0,6.648459e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.347744);
   linear_fit->SetParError(1,0.03488732);
