...
//=========  (Wed Apr  1 22:35:40 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,0.550971,1050,0.9767487);
   ...
   gre->SetPoint(0,-700,0.76142);
   gre->SetPointError(0,0,0.08500419);
   gre->SetPoint(1,-500,0.8069);
   gre->SetPointError(1,0,0.09236412);
   gre->SetPoint(2,-300,0.77438);
   gre->SetPointError(2,0,0.0454827);
   gre->SetPoint(3,-100,0.77656);
   gre->SetPointError(3,0,0.05145558);
   gre->SetPoint(4,100,0.83482);
   gre->SetPointError(4,0,0.07096573);
   gre->SetPoint(5,300,0.64018);
   gre->SetPointError(5,0,0.01824602);
   gre->SetPoint(6,500,0.80898);
   gre->SetPointError(6,0,0.02804228);
   gre->SetPoint(7,700,0.74008);
   gre->SetPointError(7,0,0.02063021);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.5935488);
   Graph_Graph20->SetMaximum(0.9341709);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(36.5221);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.964356e-06);
   linear_fit->SetParError(0,3.423023e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.7215825);
   linear_fit->SetParError(1,0.01668231);
