...
//=========  (Wed Apr  1 22:36:06 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM40_H_2->Range(-1050,-0.3647478,1050,-0.2942061);
   ...
   gre->SetPoint(0,-700,-0.33738);
   gre->SetPointError(0,0,0.00274633);
   gre->SetPoint(1,-500,-0.33648);
   gre->SetPointError(1,0,0.005309229);
   gre->SetPoint(2,-300,-0.3479);
   gre->SetPointError(2,0,0.005090875);
   gre->SetPoint(3,-100,-0.33586);
   gre->SetPointError(3,0,0.008294652);
   gre->SetPoint(4,100,-0.33298);
   gre->SetPointError(4,0,0.009032021);
   gre->SetPoint(5,300,-0.33154);
   gre->SetPointError(5,0,0.0027379);
   gre->SetPoint(6,500,-0.32692);
   gre->SetPointError(6,0,0.003746343);
   gre->SetPoint(7,700,-0.31104);
   gre->SetPointError(7,0,0.00507692);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph18->SetMinimum(-0.3576937);
   Graph_Graph18->SetMaximum(-0.3012603);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph18->SetLineColor(ci);
   Graph_Graph18->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.76945);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.212422e-05);
   linear_fit->SetParError(0,2.821614e-06);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.3321685);
   linear_fit->SetParError(1,0.001452687);
