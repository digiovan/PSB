...
//=========  (Wed Apr  1 22:34:33 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,3.29446,1050,11.67069);
   ...
   gre->SetPoint(0,-700,10.23052);
   gre->SetPointError(0,0,0.0441323);
   gre->SetPoint(1,-500,9.63164);
   gre->SetPointError(1,0,0.03746065);
   gre->SetPoint(2,-300,8.87094);
   gre->SetPointError(2,0,0.06431603);
   gre->SetPoint(3,-100,8.41786);
   gre->SetPointError(3,0,0.01435872);
   gre->SetPoint(4,100,7.53922);
   gre->SetPointError(4,0,0.05864879);
   gre->SetPoint(5,300,6.99198);
   gre->SetPointError(5,0,0.01930068);
   gre->SetPoint(6,500,6.17472);
   gre->SetPointError(6,0,0.04263972);
   gre->SetPoint(7,700,4.79366);
   gre->SetPointError(7,0,0.1031617);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(4.132083);
   Graph_Graph26->SetMaximum(10.83307);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(125.5225);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.003433309);
   linear_fit->SetParError(0,3.284289e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.006378);
   linear_fit->SetParError(1,0.01003676);
