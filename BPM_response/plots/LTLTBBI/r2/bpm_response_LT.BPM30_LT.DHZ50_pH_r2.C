...
//=========  (Wed Apr  1 22:34:53 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM30_H_2->Range(-1050,-10.5187,1050,-9.670939);
   ...
   gre->SetPoint(0,-700,-9.9723);
   gre->SetPointError(0,0,0.01419331);
   gre->SetPoint(1,-500,-10.26856);
   gre->SetPointError(1,0,0.02989009);
   gre->SetPoint(2,-300,-10.08636);
   gre->SetPointError(2,0,0.0469156);
   gre->SetPoint(3,-100,-10.33824);
   gre->SetPointError(3,0,0.03916399);
   gre->SetPoint(4,100,-10.20714);
   gre->SetPointError(4,0,0.1140506);
   gre->SetPoint(5,300,-9.85326);
   gre->SetPointError(5,0,0.04102818);
   gre->SetPoint(6,500,-10.2906);
   gre->SetPointError(6,0,0.06162879);
   gre->SetPoint(7,700,-9.89312);
   gre->SetPointError(7,0,0.01452395);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","Corr: LT.DHZ50 Plane: H Ring: 2",100,-840,840);
   Graph_Graph17->SetMinimum(-10.43392);
   Graph_Graph17->SetMaximum(-9.755715);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph17->SetLineColor(ci);
   Graph_Graph17->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(218.3628);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,8.35899e-05);
   linear_fit->SetParError(0,1.390157e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-9.989995);
   linear_fit->SetParError(1,0.00884049);
