...
//=========  (Wed Apr  1 22:35:24 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,0.4525294,1050,1.771122);
   ...
   gre->SetPoint(0,-700,1.3358);
   gre->SetPointError(0,0,0.215557);
   gre->SetPoint(1,-500,1.213);
   gre->SetPointError(1,0,0.07676569);
   gre->SetPoint(2,-300,0.98666);
   gre->SetPointError(2,0,0.2486492);
   gre->SetPoint(3,-100,1.1414);
   gre->SetPointError(3,0,0.1498865);
   gre->SetPoint(4,100,0.96698);
   gre->SetPointError(4,0,0.07747903);
   gre->SetPoint(5,300,1.31212);
   gre->SetPointError(5,0,0.06870467);
   gre->SetPoint(6,500,0.8011);
   gre->SetPointError(6,0,0.1288051);
   gre->SetPoint(7,700,1.39064);
   gre->SetPointError(7,0,0.02864228);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.5843887);
   Graph_Graph20->SetMaximum(1.639263);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(33.3009);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0002158399);
   linear_fit->SetParError(0,5.719712e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.204152);
   linear_fit->SetParError(1,0.03433112);
