...
//=========  (Wed Apr  1 22:34:27 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_V_2->Range(-1050,-2.738894,1050,5.513087);
   ...
   gre->SetPoint(0,-700,4.12594);
   gre->SetPointError(0,0,0.01181642);
   gre->SetPoint(1,-500,3.11178);
   gre->SetPointError(1,0,0.02563032);
   gre->SetPoint(2,-300,2.21522);
   gre->SetPointError(2,0,0.01769714);
   gre->SetPoint(3,-100,1.31492);
   gre->SetPointError(3,0,0.02475912);
   gre->SetPoint(4,100,0.53954);
   gre->SetPointError(4,0,0.03012529);
   gre->SetPoint(5,300,-0.21202);
   gre->SetPointError(5,0,0.03417265);
   gre->SetPoint(6,500,-0.96574);
   gre->SetPointError(6,0,0.02871054);
   gre->SetPoint(7,700,-1.3261);
   gre->SetPointError(7,0,0.03746396);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-1.913696);
   Graph_Graph20->SetMaximum(4.687888);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(413.0935);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004192833);
   linear_fit->SetParError(0,1.75598e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.096069);
   linear_fit->SetParError(1,0.009352853);
