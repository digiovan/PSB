...
//=========  (Wed Apr  1 22:34:49 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_V_2->Range(-1050,-14.70453,1050,9.408061);
   ...
   gre->SetPoint(0,-700,-10.43822);
   gre->SetPointError(0,0,0.2475412);
   gre->SetPoint(1,-500,-7.99796);
   gre->SetPointError(1,0,0.4347571);
   gre->SetPoint(2,-300,-6.30614);
   gre->SetPointError(2,0,0.3278403);
   gre->SetPoint(3,-100,-3.9459);
   gre->SetPointError(3,0,0.1810682);
   gre->SetPoint(4,100,-2.28088);
   gre->SetPointError(4,0,0.1799701);
   gre->SetPoint(5,300,-0.56704);
   gre->SetPointError(5,0,0.09427553);
   gre->SetPoint(6,500,2.0804);
   gre->SetPointError(6,0,0.2103243);
   gre->SetPoint(7,700,4.99556);
   gre->SetPointError(7,0,0.3937361);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(-12.29327);
   Graph_Graph26->SetMaximum(6.996802);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(26.66482);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01004975);
   linear_fit->SetParError(0,0.0001995119);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.317287);
   linear_fit->SetParError(1,0.07111042);
