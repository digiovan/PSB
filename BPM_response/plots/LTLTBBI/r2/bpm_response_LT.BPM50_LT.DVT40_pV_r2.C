...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM50_V_2->Range(-1050,-17.43974,1050,17.70341);
   ...
   gre->SetPoint(0,-700,-11.55698);
   gre->SetPointError(0,0,0.02557162);
   gre->SetPoint(1,-500,-8.1966);
   gre->SetPointError(1,0,0.01149294);
   gre->SetPoint(2,-300,-4.76294);
   gre->SetPointError(2,0,0.03511589);
   gre->SetPoint(3,-100,-1.43024);
   gre->SetPointError(3,0,0.005261825);
   gre->SetPoint(4,100,1.69986);
   gre->SetPointError(4,0,0.02527881);
   gre->SetPoint(5,300,4.7545);
   gre->SetPointError(5,0,0.01641962);
   gre->SetPoint(6,500,8.23546);
   gre->SetPointError(6,0,0.01563022);
   gre->SetPoint(7,700,11.83514);
   gre->SetPointError(7,0,0.01107781);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph19->SetMinimum(-13.92543);
   Graph_Graph19->SetMaximum(14.18909);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph19->SetLineColor(ci);
   Graph_Graph19->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(987.2873);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01653601);
   linear_fit->SetParError(0,1.088477e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.1587597);
   linear_fit->SetParError(1,0.003967317);
