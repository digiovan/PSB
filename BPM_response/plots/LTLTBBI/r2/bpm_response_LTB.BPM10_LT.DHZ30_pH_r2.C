...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-13.31118,1050,14.04589);
   ...
   gre->SetPoint(0,-700,-8.5537);
   gre->SetPointError(0,0,0.1979654);
   gre->SetPoint(1,-500,-6.92808);
   gre->SetPointError(1,0,0.2601859);
   gre->SetPoint(2,-300,-3.16042);
   gre->SetPointError(2,0,0.151385);
   gre->SetPoint(3,-100,-1.22664);
   gre->SetPointError(3,0,0.03304766);
   gre->SetPoint(4,100,2.18566);
   gre->SetPointError(4,0,0.1151399);
   gre->SetPoint(5,300,4.16654);
   gre->SetPointError(5,0,0.1080506);
   gre->SetPoint(6,500,6.57776);
   gre->SetPointError(6,0,0.07356207);
   gre->SetPoint(7,700,9.37416);
   gre->SetPointError(7,0,0.1122169);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-10.57547);
   Graph_Graph20->SetMaximum(11.31018);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(73.23519);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01303779);
   linear_fit->SetParError(0,9.090744e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.16205);
   linear_fit->SetParError(1,0.02669373);
