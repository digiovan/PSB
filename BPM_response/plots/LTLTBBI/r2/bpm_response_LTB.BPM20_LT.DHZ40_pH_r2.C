...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM20_H_2->Range(-1050,-3.075566,1050,9.425297);
   ...
   gre->SetPoint(0,-700,7.02136);
   gre->SetPointError(0,0,0.3204596);
   gre->SetPoint(1,-500,5.30282);
   gre->SetPointError(1,0,0.09749002);
   gre->SetPoint(2,-300,5.07458);
   gre->SetPointError(2,0,0.1436842);
   gre->SetPoint(3,-100,3.08738);
   gre->SetPointError(3,0,0.2007476);
   gre->SetPoint(4,100,1.83936);
   gre->SetPointError(4,0,0.4352003);
   gre->SetPoint(5,300,1.49602);
   gre->SetPointError(5,0,0.1359683);
   gre->SetPoint(6,500,-0.47706);
   gre->SetPointError(6,0,0.2587269);
   gre->SetPoint(7,700,-0.90614);
   gre->SetPointError(7,0,0.08594876);
   
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph21->SetMinimum(-1.82548);
   Graph_Graph21->SetMaximum(8.17521);
   Graph_Graph21->SetDirectory(0);
   Graph_Graph21->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph21->SetLineColor(ci);
   Graph_Graph21->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(38.66632);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.005368193);
   linear_fit->SetParError(0,9.707367e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.860034);
   linear_fit->SetParError(1,0.05119615);
