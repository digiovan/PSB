...
//=========  (Wed Apr  1 22:35:25 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-24.22313,1050,17.44686);
   ...
   gre->SetPoint(0,-700,10.221);
   gre->SetPointError(0,0,0.2808638);
   gre->SetPoint(1,-500,6.42728);
   gre->SetPointError(1,0,0.1505641);
   gre->SetPoint(2,-300,3.7547);
   gre->SetPointError(2,0,0.5240438);
   gre->SetPoint(3,-100,2.45768);
   gre->SetPointError(3,0,1.232322);
   gre->SetPoint(4,100,0.55828);
   gre->SetPointError(4,0,0.8365425);
   gre->SetPoint(5,300,-6.8595);
   gre->SetPointError(5,0,1.297882);
   gre->SetPoint(6,500,-10.16252);
   gre->SetPointError(6,0,0.6871932);
   gre->SetPoint(7,700,-16.47152);
   gre->SetPointError(7,0,0.8066136);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LTB.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-20.05613);
   Graph_Graph27->SetMaximum(13.27986);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LTB.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(43.46933);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.01705647);
   linear_fit->SetParError(0,0.0004162115);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.904472);
   linear_fit->SetParError(1,0.2215875);
