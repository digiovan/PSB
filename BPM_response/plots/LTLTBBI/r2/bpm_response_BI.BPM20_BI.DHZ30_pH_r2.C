...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_H_2->Range(-1050,-1.242629,1050,-0.9386109);
   ...
   gre->SetPoint(0,-700,-1.12078);
   gre->SetPointError(0,0,0.02286164);
   gre->SetPoint(1,-500,-1.09786);
   gre->SetPointError(1,0,0.003968787);
   gre->SetPoint(2,-300,-1.05836);
   gre->SetPointError(2,0,0.0174982);
   gre->SetPoint(3,-100,-1.00262);
   gre->SetPointError(3,0,0.01333936);
   gre->SetPoint(4,100,-1.04534);
   gre->SetPointError(4,0,0.04011254);
   gre->SetPoint(5,300,-1.11016);
   gre->SetPointError(5,0,0.02048375);
   gre->SetPoint(6,500,-1.08818);
   gre->SetPointError(6,0,0.01467207);
   gre->SetPoint(7,700,-1.16146);
   gre->SetPointError(7,0,0.03049943);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-1.212227);
   Graph_Graph25->SetMaximum(-0.9690128);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(57.38502);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,1.698239e-05);
   linear_fit->SetParError(0,1.142507e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.084333);
   linear_fit->SetParError(1,0.005475767);
