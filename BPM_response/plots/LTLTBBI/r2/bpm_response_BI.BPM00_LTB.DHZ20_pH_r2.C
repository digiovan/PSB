...
//=========  (Wed Apr  1 22:35:14 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-15.04324,1050,3.394116);
   ...
   gre->SetPoint(0,-700,-11.86564);
   gre->SetPointError(0,0,0.1047088);
   gre->SetPoint(1,-500,-9.9761);
   gre->SetPointError(1,0,0.0827185);
   gre->SetPoint(2,-300,-8.15486);
   gre->SetPointError(2,0,0.1022922);
   gre->SetPoint(3,-100,-6.5901);
   gre->SetPointError(3,0,0.1278339);
   gre->SetPoint(4,100,-5.09854);
   gre->SetPointError(4,0,0.03841012);
   gre->SetPoint(5,300,-3.222);
   gre->SetPointError(5,0,0.06630655);
   gre->SetPoint(6,500,-1.61946);
   gre->SetPointError(6,0,0.1141521);
   gre->SetPoint(7,700,0.26176);
   gre->SetPointError(7,0,0.05946307);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-13.19951);
   Graph_Graph23->SetMaximum(1.55038);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(23.01211);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.008551051);
   linear_fit->SetParError(0,6.309581e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.833583);
   linear_fit->SetParError(1,0.02571058);
