...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-16.70096,1050,10.78011);
   ...
   gre->SetPoint(0,-700,-2.21652);
   gre->SetPointError(0,0,0.748852);
   gre->SetPoint(1,-500,-11.32406);
   gre->SetPointError(1,0,0.1339672);
   gre->SetPoint(2,-300,-11.75788);
   gre->SetPointError(2,0,0.3629009);
   gre->SetPoint(3,-100,-11.41556);
   gre->SetPointError(3,0,0.6439534);
   gre->SetPoint(4,100,-7.48956);
   gre->SetPointError(4,0,0.5249221);
   gre->SetPoint(5,300,-1.298);
   gre->SetPointError(5,0,0.3192591);
   gre->SetPoint(6,500,1.71776);
   gre->SetPointError(6,0,0.1205346);
   gre->SetPoint(7,700,5.47502);
   gre->SetPointError(7,0,0.7249146);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-13.95285);
   Graph_Graph28->SetMaximum(8.032006);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(437.4177);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01286645);
   linear_fit->SetParError(0,0.0001709799);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.000932);
   linear_fit->SetParError(1,0.08162666);
