...
//=========  (Wed Apr  1 22:34:48 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-5.076171,1050,3.556883);
   ...
   gre->SetPoint(0,-700,2.07096);
   gre->SetPointError(0,0,0.04708032);
   gre->SetPoint(1,-500,1.222);
   gre->SetPointError(1,0,0.0576379);
   gre->SetPoint(2,-300,0.48438);
   gre->SetPointError(2,0,0.0628639);
   gre->SetPoint(3,-100,-0.38474);
   gre->SetPointError(3,0,0.03867152);
   gre->SetPoint(4,100,-1.102);
   gre->SetPointError(4,0,0.04276869);
   gre->SetPoint(5,300,-1.81416);
   gre->SetPointError(5,0,0.02768141);
   gre->SetPoint(6,500,-2.6988);
   gre->SetPointError(6,0,0.02203547);
   gre->SetPoint(7,700,-3.6111);
   gre->SetPointError(7,0,0.0262283);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-4.212865);
   Graph_Graph23->SetMaximum(2.693577);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(31.52411);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004009951);
   linear_fit->SetParError(0,2.921808e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.7179781);
   linear_fit->SetParError(1,0.0142568);
