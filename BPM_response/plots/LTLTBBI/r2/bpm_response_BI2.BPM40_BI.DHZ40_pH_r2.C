...
//=========  (Wed Apr  1 22:36:18 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-16.86692,1050,-7.449765);
   ...
   gre->SetPoint(0,-700,-13.23914);
   gre->SetPointError(0,0,2.058253);
   gre->SetPoint(1,-500,-12.841);
   gre->SetPointError(1,0,0.7322726);
   gre->SetPoint(2,-300,-13.7222);
   gre->SetPointError(2,0,0.7430003);
   gre->SetPoint(3,-100,-11.11828);
   gre->SetPointError(3,0,0.6138045);
   gre->SetPoint(4,100,-12.00776);
   gre->SetPointError(4,0,0.2793839);
   gre->SetPoint(5,300,-12.63238);
   gre->SetPointError(5,0,0.5477645);
   gre->SetPoint(6,500,-9.68266);
   gre->SetPointError(6,0,0.6633698);
   gre->SetPoint(7,700,-10.55296);
   gre->SetPointError(7,0,1.331701);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: BI.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-15.9252);
   Graph_Graph27->SetMaximum(-8.39148);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("BI.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.67297);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.002187713);
   linear_fit->SetParError(0,0.000725128);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-12.11484);
   linear_fit->SetParError(1,0.2051053);
