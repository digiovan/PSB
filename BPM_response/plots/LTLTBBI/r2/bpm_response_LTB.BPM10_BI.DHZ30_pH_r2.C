...
//=========  (Wed Apr  1 22:36:06 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-0.03575205,1050,1.25251);
   ...
   gre->SetPoint(0,-700,0.63876);
   gre->SetPointError(0,0,0.1195329);
   gre->SetPoint(1,-500,0.62288);
   gre->SetPointError(1,0,0.06544458);
   gre->SetPoint(2,-300,0.6916);
   gre->SetPointError(2,0,0.1067196);
   gre->SetPoint(3,-100,0.2818);
   gre->SetPointError(3,0,0.1028416);
   gre->SetPoint(4,100,0.48146);
   gre->SetPointError(4,0,0.1805155);
   gre->SetPoint(5,300,0.80838);
   gre->SetPointError(5,0,0.22942);
   gre->SetPoint(6,500,0.54832);
   gre->SetPointError(6,0,0.06185184);
   gre->SetPoint(7,700,0.50402);
   gre->SetPointError(7,0,0.2047105);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(0.0930742);
   Graph_Graph20->SetMaximum(1.123684);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(10.68462);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-7.37733e-05);
   linear_fit->SetParError(0,7.493978e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.5600223);
   linear_fit->SetParError(1,0.03515003);
