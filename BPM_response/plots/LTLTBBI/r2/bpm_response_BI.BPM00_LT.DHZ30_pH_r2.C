...
//=========  (Wed Apr  1 22:34:32 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-9.69339,1050,-0.5630395);
   ...
   gre->SetPoint(0,-700,-2.19);
   gre->SetPointError(0,0,0.1052354);
   gre->SetPoint(1,-500,-2.77874);
   gre->SetPointError(1,0,0.1787042);
   gre->SetPoint(2,-300,-4.30746);
   gre->SetPointError(2,0,0.09164612);
   gre->SetPoint(3,-100,-5.07412);
   gre->SetPointError(3,0,0.119404);
   gre->SetPoint(4,100,-6.32224);
   gre->SetPointError(4,0,0.110861);
   gre->SetPoint(5,300,-6.82672);
   gre->SetPointError(5,0,0.06180836);
   gre->SetPoint(6,500,-7.52946);
   gre->SetPointError(6,0,0.07688332);
   gre->SetPoint(7,700,-8.08272);
   gre->SetPointError(7,0,0.08894454);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LT.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-8.780355);
   Graph_Graph23->SetMaximum(-1.476075);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LT.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(52.9362);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004253863);
   linear_fit->SetParError(0,7.624963e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.437245);
   linear_fit->SetParError(1,0.03429605);
