...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM10_V_2->Range(-1050,-18.82581,1050,26.3178);
   ...
   gre->SetPoint(0,-700,18.76702);
   gre->SetPointError(0,0,0.02684724);
   gre->SetPoint(1,-500,14.9238);
   gre->SetPointError(1,0,0.0482037);
   gre->SetPoint(2,-300,10.6718);
   gre->SetPointError(2,0,0.0716115);
   gre->SetPoint(3,-100,6.34084);
   gre->SetPointError(3,0,0.02826881);
   gre->SetPoint(4,100,2.442);
   gre->SetPointError(4,0,0.1066432);
   gre->SetPoint(5,300,-2.06468);
   gre->SetPointError(5,0,0.06573995);
   gre->SetPoint(6,500,-6.90764);
   gre->SetPointError(6,0,0.02812379);
   gre->SetPoint(7,700,-11.23986);
   gre->SetPointError(7,0,0.06201553);
   
   TH1F *Graph_Graph24 = new TH1F("Graph_Graph24","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph24->SetMinimum(-14.31145);
   Graph_Graph24->SetMaximum(21.80344);
   Graph_Graph24->SetDirectory(0);
   Graph_Graph24->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph24->SetLineColor(ci);
   Graph_Graph24->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(275.3888);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0214314);
   linear_fit->SetParError(0,2.842096e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,3.978378);
   linear_fit->SetParError(1,0.0142423);
