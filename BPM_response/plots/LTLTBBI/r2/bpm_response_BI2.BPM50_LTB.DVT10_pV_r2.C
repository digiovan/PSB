...
//=========  (Wed Apr  1 22:35:09 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-16.1747,1050,9.098779);
   ...
   gre->SetPoint(0,-700,4.60702);
   gre->SetPointError(0,0,0.1191881);
   gre->SetPoint(1,-500,4.52226);
   gre->SetPointError(1,0,0.3642715);
   gre->SetPoint(2,-300,0.28028);
   gre->SetPointError(2,0,0.180751);
   gre->SetPoint(3,-100,-4.7571);
   gre->SetPointError(3,0,0.533334);
   gre->SetPoint(4,100,-8.57114);
   gre->SetPointError(4,0,0.4856258);
   gre->SetPoint(5,300,-10.56642);
   gre->SetPointError(5,0,1.396036);
   gre->SetPoint(6,500,-6.75728);
   gre->SetPointError(6,0,1.482515);
   gre->SetPoint(7,700,-1.5566);
   gre->SetPointError(7,0,0.6855712);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LTB.DVT10 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-13.64735);
   Graph_Graph28->SetMaximum(6.57143);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LTB.DVT10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(326.7444);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0101811);
   linear_fit->SetParError(0,0.00031665);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-2.610427);
   linear_fit->SetParError(1,0.1842255);
