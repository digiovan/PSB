...
//=========  (Wed Apr  1 22:35:04 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-2.786373,1050,4.987027);
   ...
   gre->SetPoint(0,-700,-1.4293);
   gre->SetPointError(0,0,0.06150619);
   gre->SetPoint(1,-500,-0.62454);
   gre->SetPointError(1,0,0.1267209);
   gre->SetPoint(2,-300,0.22958);
   gre->SetPointError(2,0,0.1192948);
   gre->SetPoint(3,-100,0.84498);
   gre->SetPointError(3,0,0.05426391);
   gre->SetPoint(4,100,1.52782);
   gre->SetPointError(4,0,0.02074899);
   gre->SetPoint(5,300,2.04508);
   gre->SetPointError(5,0,0.1412808);
   gre->SetPoint(6,500,2.50006);
   gre->SetPointError(6,0,0.1612181);
   gre->SetPoint(7,700,3.60842);
   gre->SetPointError(7,0,0.08304007);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LTB.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-2.009033);
   Graph_Graph20->SetMaximum(4.209687);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LTB.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(14.10526);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003564531);
   linear_fit->SetParError(0,6.197192e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.157627);
   linear_fit->SetParError(1,0.0175217);
