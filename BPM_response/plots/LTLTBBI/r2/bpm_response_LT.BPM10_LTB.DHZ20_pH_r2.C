...
//=========  (Wed Apr  1 22:35:14 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.889031,1050,2.098405);
   ...
   gre->SetPoint(0,-700,1.99568);
   gre->SetPointError(0,0,0.06782914);
   gre->SetPoint(1,-500,1.99408);
   gre->SetPointError(1,0,0.02784053);
   gre->SetPoint(2,-300,2.01028);
   gre->SetPointError(2,0,0.02456522);
   gre->SetPoint(3,-100,1.99684);
   gre->SetPointError(3,0,0.0261364);
   gre->SetPoint(4,100,1.94964);
   gre->SetPointError(4,0,0.02571307);
   gre->SetPoint(5,300,2.028);
   gre->SetPointError(5,0,0.01408976);
   gre->SetPoint(6,500,1.955);
   gre->SetPointError(6,0,0.02334785);
   gre->SetPoint(7,700,2.01892);
   gre->SetPointError(7,0,0.0330775);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: LTB.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.909969);
   Graph_Graph15->SetMaximum(2.077467);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("LTB.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.05129);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,2.82268e-06);
   linear_fit->SetParError(0,2.396905e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,1.999887);
   linear_fit->SetParError(1,0.009009756);
