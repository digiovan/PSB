...
//=========  (Wed Apr  1 22:34:38 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_V_2->Range(-1050,-18.16163,1050,15.77608);
   ...
   gre->SetPoint(0,-700,-5.6957);
   gre->SetPointError(0,0,0.5961611);
   gre->SetPoint(1,-500,-12.41676);
   gre->SetPointError(1,0,0.08858114);
   gre->SetPoint(2,-300,-10.93708);
   gre->SetPointError(2,0,0.2361264);
   gre->SetPoint(3,-100,-8.38804);
   gre->SetPointError(3,0,0.3017447);
   gre->SetPoint(4,100,-3.57046);
   gre->SetPointError(4,0,0.3062324);
   gre->SetPoint(5,300,2.63768);
   gre->SetPointError(5,0,0.09045288);
   gre->SetPoint(6,500,6.55106);
   gre->SetPointError(6,0,0.08547709);
   gre->SetPoint(7,700,9.45388);
   gre->SetPointError(7,0,0.6659181);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LT.DVT30 Plane: V Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-14.76786);
   Graph_Graph27->SetMaximum(12.38231);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LT.DVT30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(597.0928);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.01890356);
   linear_fit->SetParError(0,0.0001128975);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-3.14712);
   linear_fit->SetParError(1,0.04905052);
