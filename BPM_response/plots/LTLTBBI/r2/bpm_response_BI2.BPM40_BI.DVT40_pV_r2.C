...
//=========  (Wed Apr  1 22:36:23 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_V_2->Range(-1050,-18.36078,1050,8.390027);
   ...
   gre->SetPoint(0,-700,-11.51516);
   gre->SetPointError(0,0,0.565329);
   gre->SetPoint(1,-500,-13.71712);
   gre->SetPointError(1,0,0.1851925);
   gre->SetPoint(2,-300,-8.36068);
   gre->SetPointError(2,0,0.7244158);
   gre->SetPoint(3,-100,-9.8521);
   gre->SetPointError(3,0,0.1727188);
   gre->SetPoint(4,100,-5.49862);
   gre->SetPointError(4,0,0.4138496);
   gre->SetPoint(5,300,0.38232);
   gre->SetPointError(5,0,0.3227921);
   gre->SetPoint(6,500,0.97136);
   gre->SetPointError(6,0,0.7624808);
   gre->SetPoint(7,700,2.89032);
   gre->SetPointError(7,0,1.041239);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: BI.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(-15.6857);
   Graph_Graph27->SetMaximum(5.714946);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("BI.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(272.223);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0140365);
   linear_fit->SetParError(0,0.0003481239);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-6.825388);
   linear_fit->SetParError(1,0.125408);
