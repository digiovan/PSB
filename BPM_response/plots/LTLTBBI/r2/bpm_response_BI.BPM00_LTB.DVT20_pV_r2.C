...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_V_2->Range(-1050,-2.557442,1050,0.7759814);
   ...
   gre->SetPoint(0,-700,0.20424);
   gre->SetPointError(0,0,0.01617093);
   gre->SetPoint(1,-500,-0.07642);
   gre->SetPointError(1,0,0.01526944);
   gre->SetPoint(2,-300,-0.37468);
   gre->SetPointError(2,0,0.02226194);
   gre->SetPoint(3,-100,-0.65766);
   gre->SetPointError(3,0,0.03822653);
   gre->SetPoint(4,100,-0.9709);
   gre->SetPointError(4,0,0.009448029);
   gre->SetPoint(5,300,-1.2822);
   gre->SetPointError(5,0,0.05309519);
   gre->SetPoint(6,500,-1.58808);
   gre->SetPointError(6,0,0.05665232);
   gre->SetPoint(7,700,-1.93336);
   gre->SetPointError(7,0,0.06851102);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-2.224099);
   Graph_Graph23->SetMaximum(0.4426391);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.109372);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.001484739);
   linear_fit->SetParError(0,1.898438e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-0.8243717);
   linear_fit->SetParError(1,0.007380579);
