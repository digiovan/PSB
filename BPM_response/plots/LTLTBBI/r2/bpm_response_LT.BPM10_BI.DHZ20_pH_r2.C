...
//=========  (Wed Apr  1 22:35:55 2015) by ROOT version5.34/21
   ...
   canvas_LT.BPM10_H_2->Range(-1050,1.899756,1050,2.095235);
   ...
   gre->SetPoint(0,-700,2.03054);
   gre->SetPointError(0,0,0.009288106);
   gre->SetPoint(1,-500,2.01196);
   gre->SetPointError(1,0,0.01085522);
   gre->SetPoint(2,-300,2.00878);
   gre->SetPointError(2,0,0.05271333);
   gre->SetPoint(3,-100,2.02758);
   gre->SetPointError(3,0,0.02211382);
   gre->SetPoint(4,100,1.97406);
   gre->SetPointError(4,0,0.04172396);
   gre->SetPoint(5,300,2.02832);
   gre->SetPointError(5,0,0.03326261);
   gre->SetPoint(6,500,2.0112);
   gre->SetPointError(6,0,0.05145495);
   gre->SetPoint(7,700,2.00324);
   gre->SetPointError(7,0,0.0210963);
   
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph15->SetMinimum(1.919304);
   Graph_Graph15->SetMaximum(2.075687);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph15->SetLineColor(ci);
   Graph_Graph15->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.700214);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-1.58197e-05);
   linear_fit->SetParError(0,1.424676e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.013914);
   linear_fit->SetParError(1,0.008351999);
