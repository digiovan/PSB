...
//=========  (Wed Apr  1 22:35:56 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_H_2->Range(-1050,-7.724926,1050,-1.920497);
   ...
   gre->SetPoint(0,-700,-3.79792);
   gre->SetPointError(0,0,0.9100178);
   gre->SetPoint(1,-500,-4.31288);
   gre->SetPointError(1,0,0.8541994);
   gre->SetPoint(2,-300,-4.29342);
   gre->SetPointError(2,0,0.8312941);
   gre->SetPoint(3,-100,-5.2413);
   gre->SetPointError(3,0,0.1056925);
   gre->SetPoint(4,100,-6.20542);
   gre->SetPointError(4,0,0.4418955);
   gre->SetPoint(5,300,-5.83818);
   gre->SetPointError(5,0,0.3188954);
   gre->SetPoint(6,500,-6.43496);
   gre->SetPointError(6,0,0.3225611);
   gre->SetPoint(7,700,-5.38208);
   gre->SetPointError(7,0,0.1885624);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: BI.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-7.144483);
   Graph_Graph28->SetMaximum(-2.50094);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("BI.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(17.81724);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0006132948);
   linear_fit->SetParError(0,0.0002418634);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.31927);
   linear_fit->SetParError(1,0.08736438);
