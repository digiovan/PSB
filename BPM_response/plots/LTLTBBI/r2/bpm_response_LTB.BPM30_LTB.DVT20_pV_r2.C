...
//=========  (Wed Apr  1 22:35:19 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,-8.396605,1050,11.97653);
   ...
   gre->SetPoint(0,-700,-4.88122);
   gre->SetPointError(0,0,0.1198633);
   gre->SetPoint(1,-500,-2.78334);
   gre->SetPointError(1,0,0.03625881);
   gre->SetPoint(2,-300,-0.66514);
   gre->SetPointError(2,0,0.0205643);
   gre->SetPoint(3,-100,1.40092);
   gre->SetPointError(3,0,0.05651674);
   gre->SetPoint(4,100,3.31998);
   gre->SetPointError(4,0,0.025688);
   gre->SetPoint(5,300,4.85562);
   gre->SetPointError(5,0,0.08709112);
   gre->SetPoint(6,500,6.53002);
   gre->SetPointError(6,0,0.08631006);
   gre->SetPoint(7,700,8.46084);
   gre->SetPointError(7,0,0.1201633);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(-6.359292);
   Graph_Graph22->SetMaximum(9.939212);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(128.7137);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.009700005);
   linear_fit->SetParError(0,5.026895e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.223364);
   linear_fit->SetParError(1,0.01587942);
