...
//=========  (Wed Apr  1 22:34:43 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-8.318558,1050,9.272598);
   ...
   gre->SetPoint(0,-700,6.09638);
   gre->SetPointError(0,0,0.2443583);
   gre->SetPoint(1,-500,3.81042);
   gre->SetPointError(1,0,0.03842812);
   gre->SetPoint(2,-300,3.2932);
   gre->SetPointError(2,0,0.2074717);
   gre->SetPoint(3,-100,0.7825);
   gre->SetPointError(3,0,0.04565156);
   gre->SetPoint(4,100,-1.00416);
   gre->SetPointError(4,0,0.3368038);
   gre->SetPoint(5,300,-1.89112);
   gre->SetPointError(5,0,0.0609603);
   gre->SetPoint(6,500,-3.74146);
   gre->SetPointError(6,0,0.3330556);
   gre->SetPoint(7,700,-5.28924);
   gre->SetPointError(7,0,0.09745857);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DHZ40 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-6.559442);
   Graph_Graph20->SetMaximum(7.513482);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DHZ40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(53.02614);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.007431942);
   linear_fit->SetParError(0,6.672157e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.1270468);
   linear_fit->SetParError(1,0.02711904);
