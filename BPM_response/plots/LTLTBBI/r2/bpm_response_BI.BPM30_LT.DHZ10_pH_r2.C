...
//=========  (Wed Apr  1 22:34:12 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM30_H_2->Range(-1050,7.506534,1050,8.552565);
   ...
   gre->SetPoint(0,-700,8.08256);
   gre->SetPointError(0,0,0.01946403);
   gre->SetPoint(1,-500,8.3392);
   gre->SetPointError(1,0,0.03902673);
   gre->SetPoint(2,-300,8.21418);
   gre->SetPointError(2,0,0.01733785);
   gre->SetPoint(3,-100,7.95758);
   gre->SetPointError(3,0,0.05429238);
   gre->SetPoint(4,100,7.87866);
   gre->SetPointError(4,0,0.02370552);
   gre->SetPoint(5,300,7.98866);
   gre->SetPointError(5,0,0.03519014);
   gre->SetPoint(6,500,7.96872);
   gre->SetPointError(6,0,0.03207689);
   gre->SetPoint(7,700,7.71964);
   gre->SetPointError(7,0,0.03876776);
   
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","Corr: LT.DHZ10 Plane: H Ring: 2",100,-840,840);
   Graph_Graph26->SetMinimum(7.611137);
   Graph_Graph26->SetMaximum(8.447962);
   Graph_Graph26->SetDirectory(0);
   Graph_Graph26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph26->SetLineColor(ci);
   Graph_Graph26->GetXaxis()->SetTitle("LT.DHZ10, Kick [#murad]");
   ...
   linear_fit->SetChisquare(149.3201);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.0002511164);
   linear_fit->SetParError(0,2.172652e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,8.021068);
   linear_fit->SetParError(1,0.01010498);
