...
//=========  (Wed Apr  1 22:36:02 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-10.73992,1050,1.239663);
   ...
   gre->SetPoint(0,-700,-1.43648);
   gre->SetPointError(0,0,0.6795469);
   gre->SetPoint(1,-500,-3.8424);
   gre->SetPointError(1,0,0.2003338);
   gre->SetPoint(2,-300,-4.84012);
   gre->SetPointError(2,0,0.529346);
   gre->SetPoint(3,-100,-5.73448);
   gre->SetPointError(3,0,0.6993438);
   gre->SetPoint(4,100,-7.30688);
   gre->SetPointError(4,0,1.34604);
   gre->SetPoint(5,300,-8.31408);
   gre->SetPointError(5,0,0.4292391);
   gre->SetPoint(6,500,-5.27138);
   gre->SetPointError(6,0,1.066249);
   gre->SetPoint(7,700,-5.15654);
   gre->SetPointError(7,0,1.192041);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-9.541958);
   Graph_Graph28->SetMaximum(0.0417055);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(29.09406);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,-0.004345459);
   linear_fit->SetParError(0,0.0004599869);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.965715);
   linear_fit->SetParError(1,0.213719);
