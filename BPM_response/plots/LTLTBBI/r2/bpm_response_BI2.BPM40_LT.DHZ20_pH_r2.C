...
//=========  (Wed Apr  1 22:34:22 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM40_H_2->Range(-1050,-0.1398809,1050,8.570994);
   ...
   gre->SetPoint(0,-700,1.54784);
   gre->SetPointError(0,0,0.2359083);
   gre->SetPoint(1,-500,4.9966);
   gre->SetPointError(1,0,0.1271482);
   gre->SetPoint(2,-300,6.6619);
   gre->SetPointError(2,0,0.2287175);
   gre->SetPoint(3,-100,4.3932);
   gre->SetPointError(3,0,0.5814775);
   gre->SetPoint(4,100,4.36224);
   gre->SetPointError(4,0,0.6170873);
   gre->SetPoint(5,300,6.34);
   gre->SetPointError(5,0,0.7791818);
   gre->SetPoint(6,500,5.04654);
   gre->SetPointError(6,0,0.5929525);
   gre->SetPoint(7,700,4.47312);
   gre->SetPointError(7,0,0.3101216);
   
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","Corr: LT.DHZ20 Plane: H Ring: 2",100,-840,840);
   Graph_Graph27->SetMinimum(0.7312067);
   Graph_Graph27->SetMaximum(7.699907);
   Graph_Graph27->SetDirectory(0);
   Graph_Graph27->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph27->SetLineColor(ci);
   Graph_Graph27->GetXaxis()->SetTitle("LT.DHZ20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(245.0648);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.0009950888);
   linear_fit->SetParError(0,0.0002322008);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,5.02347);
   linear_fit->SetParError(1,0.1202004);
