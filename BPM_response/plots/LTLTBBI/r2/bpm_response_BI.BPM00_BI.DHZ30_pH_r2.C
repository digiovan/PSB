...
//=========  (Wed Apr  1 22:36:07 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM00_H_2->Range(-1050,-5.662015,1050,-5.091806);
   ...
   gre->SetPoint(0,-700,-5.39054);
   gre->SetPointError(0,0,0.0503066);
   gre->SetPoint(1,-500,-5.38384);
   gre->SetPointError(1,0,0.05575105);
   gre->SetPoint(2,-300,-5.4323);
   gre->SetPointError(2,0,0.04603579);
   gre->SetPoint(3,-100,-5.23202);
   gre->SetPointError(3,0,0.03000557);
   gre->SetPoint(4,100,-5.30074);
   gre->SetPointError(4,0,0.08102768);
   gre->SetPoint(5,300,-5.4656);
   gre->SetPointError(5,0,0.1013803);
   gre->SetPoint(6,500,-5.34078);
   gre->SetPointError(6,0,0.03204566);
   gre->SetPoint(7,700,-5.2766);
   gre->SetPointError(7,0,0.08975885);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Corr: BI.DHZ30 Plane: H Ring: 2",100,-840,840);
   Graph_Graph23->SetMinimum(-5.604994);
   Graph_Graph23->SetMaximum(-5.148827);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph23->SetLineColor(ci);
   Graph_Graph23->GetXaxis()->SetTitle("BI.DHZ30, Kick [#murad]");
   ...
   linear_fit->SetChisquare(19.37928);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,3.904118e-05);
   linear_fit->SetParError(0,3.950526e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-5.327392);
   linear_fit->SetParError(1,0.01657738);
