...
//=========  (Wed Apr  1 22:34:53 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM10_H_2->Range(-1050,-3.981985,1050,5.464413);
   ...
   gre->SetPoint(0,-700,-2.14692);
   gre->SetPointError(0,0,0.06554303);
   gre->SetPoint(1,-500,-2.3377);
   gre->SetPointError(1,0,0.06988491);
   gre->SetPoint(2,-300,-0.6359);
   gre->SetPointError(2,0,0.1244619);
   gre->SetPoint(3,-100,-0.83328);
   gre->SetPointError(3,0,0.1132909);
   gre->SetPoint(4,100,0.30926);
   gre->SetPointError(4,0,0.1774455);
   gre->SetPoint(5,300,2.24144);
   gre->SetPointError(5,0,0.1228186);
   gre->SetPoint(6,500,1.77716);
   gre->SetPointError(6,0,0.13715);
   gre->SetPoint(7,700,3.80878);
   gre->SetPointError(7,0,0.08123373);
   
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Corr: LT.DHZ50 Plane: H Ring: 2",100,-840,840);
   Graph_Graph20->SetMinimum(-3.037345);
   Graph_Graph20->SetMaximum(4.519774);
   Graph_Graph20->SetDirectory(0);
   Graph_Graph20->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph20->SetLineColor(ci);
   Graph_Graph20->GetXaxis()->SetTitle("LT.DHZ50, Kick [#murad]");
   ...
   linear_fit->SetChisquare(258.4637);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.004357756);
   linear_fit->SetParError(0,6.39552e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.3870195);
   linear_fit->SetParError(1,0.03508535);
