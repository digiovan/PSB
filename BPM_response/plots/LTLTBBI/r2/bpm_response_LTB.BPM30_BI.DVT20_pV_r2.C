...
//=========  (Wed Apr  1 22:36:01 2015) by ROOT version5.34/21
   ...
   canvas_LTB.BPM30_V_2->Range(-1050,2.24299,1050,2.786097);
   ...
   gre->SetPoint(0,-700,2.37556);
   gre->SetPointError(0,0,0.04205216);
   gre->SetPoint(1,-500,2.54924);
   gre->SetPointError(1,0,0.02974453);
   gre->SetPoint(2,-300,2.51456);
   gre->SetPointError(2,0,0.01849579);
   gre->SetPoint(3,-100,2.61246);
   gre->SetPointError(3,0,0.04772445);
   gre->SetPoint(4,100,2.55698);
   gre->SetPointError(4,0,0.05203124);
   gre->SetPoint(5,300,2.57894);
   gre->SetPointError(5,0,0.02644888);
   gre->SetPoint(6,500,2.46372);
   gre->SetPointError(6,0,0.118969);
   gre->SetPoint(7,700,2.63828);
   gre->SetPointError(7,0,0.05729901);
   
   TH1F *Graph_Graph22 = new TH1F("Graph_Graph22","Corr: BI.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph22->SetMinimum(2.297301);
   Graph_Graph22->SetMaximum(2.731786);
   Graph_Graph22->SetDirectory(0);
   Graph_Graph22->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph22->SetLineColor(ci);
   Graph_Graph22->GetXaxis()->SetTitle("BI.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(12.48863);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.000115523);
   linear_fit->SetParError(0,3.265263e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,2.55331);
   linear_fit->SetParError(1,0.01288637);
