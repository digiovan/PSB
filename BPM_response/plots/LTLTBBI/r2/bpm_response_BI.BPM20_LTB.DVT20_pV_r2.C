...
//=========  (Wed Apr  1 22:35:20 2015) by ROOT version5.34/21
   ...
   canvas_BI.BPM20_V_2->Range(-1050,-6.14314,1050,2.181142);
   ...
   gre->SetPoint(0,-700,-4.70194);
   gre->SetPointError(0,0,0.05381938);
   gre->SetPoint(1,-500,-3.92624);
   gre->SetPointError(1,0,0.02549519);
   gre->SetPoint(2,-300,-3.10938);
   gre->SetPointError(2,0,0.03523758);
   gre->SetPoint(3,-100,-2.36966);
   gre->SetPointError(3,0,0.05986083);
   gre->SetPoint(4,100,-1.58568);
   gre->SetPointError(4,0,0.02124845);
   gre->SetPoint(5,300,-0.85852);
   gre->SetPointError(5,0,0.08767671);
   gre->SetPoint(6,500,-0.13574);
   gre->SetPointError(6,0,0.09460357);
   gre->SetPoint(7,700,0.68974);
   gre->SetPointError(7,0,0.1040217);
   
   TH1F *Graph_Graph25 = new TH1F("Graph_Graph25","Corr: LTB.DVT20 Plane: V Ring: 2",100,-840,840);
   Graph_Graph25->SetMinimum(-5.310711);
   Graph_Graph25->SetMaximum(1.348714);
   Graph_Graph25->SetDirectory(0);
   Graph_Graph25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph25->SetLineColor(ci);
   Graph_Graph25->GetXaxis()->SetTitle("LTB.DVT20, Kick [#murad]");
   ...
   linear_fit->SetChisquare(2.425401);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.003864439);
   linear_fit->SetParError(0,4.118574e-05);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,-1.980858);
   linear_fit->SetParError(1,0.01504401);
