...
//=========  (Wed Apr  1 22:35:41 2015) by ROOT version5.34/21
   ...
   canvas_BI2.BPM50_V_2->Range(-1050,-14.2769,1050,11.40078);
   ...
   gre->SetPoint(0,-700,-0.30026);
   gre->SetPointError(0,0,0.1488305);
   gre->SetPoint(1,-500,-3.6485);
   gre->SetPointError(1,0,0.7180169);
   gre->SetPoint(2,-300,-8.99252);
   gre->SetPointError(2,0,1.00477);
   gre->SetPoint(3,-100,-5.8654);
   gre->SetPointError(3,0,0.6019569);
   gre->SetPoint(4,100,-3.92224);
   gre->SetPointError(4,0,0.6039088);
   gre->SetPoint(5,300,-1.99774);
   gre->SetPointError(5,0,0.1932074);
   gre->SetPoint(6,500,1.84842);
   gre->SetPointError(6,0,0.3062418);
   gre->SetPoint(7,700,6.82614);
   gre->SetPointError(7,0,0.2950231);
   
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","Corr: LTB.DVT40 Plane: V Ring: 2",100,-840,840);
   Graph_Graph28->SetMinimum(-11.70914);
   Graph_Graph28->SetMaximum(8.833008);
   Graph_Graph28->SetDirectory(0);
   Graph_Graph28->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph28->SetLineColor(ci);
   Graph_Graph28->GetXaxis()->SetTitle("LTB.DVT40, Kick [#murad]");
   ...
   linear_fit->SetChisquare(798.6638);
   linear_fit->SetNDF(6);
   ...
   linear_fit->SetParameter(0,0.001977108);
   linear_fit->SetParError(0,0.0001762934);
   linear_fit->SetParLimits(0,0,0);
   linear_fit->SetParameter(1,0.1053078);
   linear_fit->SetParError(1,0.1007112);
